import { _ as _sfc_main$1, a as _sfc_main$2, b as _sfc_main$a } from "../chunks/PageCard-ClQ5nvIh.min.js";
import { _ as _sfc_main$9 } from "../chunks/Separator-DL2CTyeG.min.js";
import { e as useBusyStore, f as cloneDeep, g as useToast, u as useSettingsStore, h as useAppConfig, a as _sfc_main$3, c as _sfc_main$5, i as _sfc_main$6, _ as _sfc_main$7, v as version$1, j as _sfc_main$8 } from "./dashboard-DFjbSBbe.js";
import { _ as _sfc_main$4 } from "../chunks/FormField-CM8zfsCf.min.js";
import { v as vModelRadio } from "../chunks/runtime-dom.esm-bundler-CDtJyD_r.min.js";
import { d as defineStore, a as useApi } from "./worker-BNiBfqYd.js";
import { g as get } from "../chunks/get-DXxw6yUY.min.js";
import { V as ref, ac as computed, m as defineComponent, ae as reactive, w as watch, a4 as onBeforeMount, _ as createElementBlock, X as createBlock, j as createVNode, Y as withCtx, aj as normalizeClass, u as unref, F as Fragment, a3 as createTextVNode, a2 as toDisplayString, ak as createSlots, Z as createBaseVNode, al as withDirectives, a1 as openBlock } from "../chunks/runtime-core.esm-bundler-hRyeZ98I.min.js";
import { v as version } from "../chunks/package-CEcllWIE.min.js";
...
const _hoisted_1 = { class: "flex flex-row gap-4 my-2" };
const _hoisted_2 = { class: "flex items-center gap-2" };
const _hoisted_3 = { class: "text-(--ui-text-muted)" };
const _hoisted_4 = { class: "grid grid-cols-2 gap-3" };
const _hoisted_5 = { class: "flex items-center justify-center rounded-md p-3 font-semibold flex-1 bg-(--ui-bg-accented) hover:ring-(--ui-text)/50 hover:ring-1 has-checked:bg-[#0073e0] has-checked:text-white" };
const _hoisted_6 = { class: "flex items-center justify-center rounded-md p-3 font-semibold flex-1 bg-(--ui-bg-accented) hover:ring-(--ui-text)/50 hover:ring-1 has-checked:bg-[#0073e0] has-checked:text-white" };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        _ctx.window.windpress._via_wp_org ? (openBlock(), createBlock(_component_UPageCard, {
          ...
          _: 1
        }, 8, ["title"])) : (openBlock(), createBlock(_component_UPageCard, {
          key: 1,
          title: "License",
          description: "",
          class: normalizeClass([unref(licenseStore).isActivated ? "from-(--ui-primary)/10" : "from-(--ui-warning)/10", "bg-gradient-to-tl from-5% to-(--ui-bg)"])
        }, {
          default: withCtx(() => [
                      ...
                      createVNode(_component_UTooltip, {
                        ...
                        default: withCtx(() => [
                          createVNode(_component_UButton, {
                            ...
                            default: withCtx(() => [
                              unref(licenseStore).isActivated ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    ...
                    createBaseVNode("div", _hoisted_4, [
                      createBaseVNode("label", _hoisted_5, [
                        withDirectives(createBaseVNode("input", {
                          ...
                          [vModelRadio, unref(settingsStore).virtualOptions("general.tailwindcss.version", 4).value]
                        ]),

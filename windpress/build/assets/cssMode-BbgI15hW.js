import { a as e, c as t, f as n, h as r, p as i } from "./toggleHighContrast-CKTWexjN.js";
import { t as a } from "./workers-C9WvSAft.js";
...
(function(e2) {
  ...
  function n2(e3) {
    var _a;
    let t3 = e3;
    return B.defined(t3) && p.is(t3.range) && B.string(t3.message) && (B.number(t3.severity) || B.undefined(t3.severity)) && (B.integer(t3.code) || B.string(t3.code) || B.undefined(t3.code)) && (B.undefined(t3.codeDescription) || B.string((_a = t3.codeDescription) == null ? void 0 : _a.href)) && (B.string(t3.source) || B.undefined(t3.source)) && (B.undefined(t3.relatedInformation) || B.typedArray(t3.relatedInformation, _.is));
  }
  e2.is = n2;
})(y || (y = {}));
var b;

...
function t() {
  return { __proto__: null, "./oxide_parser_bg.js": { __proto__: null, __wbg___wbindgen_string_get_b0ca35b86a603356: function(e2, t2) {
  ...
  }, __wbg___wbindgen_throw_344f42d3211c4765: function(e2, t2) {
    throw Error(o(e2, t2));
  }, __wbg_from_13e323c65fc8f464: function(e2) {
    return n(Array.from(l(e2)));
  }, __wbg_get_507a50627bffa49b: function(e2, t2) {
    let r2 = l(e2)[t2 >>> 0];
    return n(r2);
  }, __wbg_isArray_0677c962b281d01a: function(e2) {
    return Array.isArray(l(e2));
  }, __wbg_length_370319915dc99107: function(e2) {
    return l(e2).length;
  }, __wbg_new_32b398fb48b6d94a: function() {
    return n([]);
  }, __wbg_new_with_length_f8cbc3a5b9ff9368: function(e2) {
    return n(Array(e2 >>> 0));
  }, __wbg_set_8a16b38e4805b298: function(e2, t2, n2) {
    l(e2)[t2 >>> 0] = m(n2);
...
async function T(e2) {
  if (x !== void 0) return x;
  e2 !== void 0 && (Object.getPrototypeOf(e2) === Object.prototype ? { module_or_path: e2 } = e2 : console.warn(`using deprecated parameters for the initialization function; pass a single object instead`)), e2 === void 0 && (e2 = new URL(`` + new URL(`oxide_parser_bg-BUF7_u-F.wasm`, import.meta.url).href, `` + import.meta.url));
  let n2 = t();

...
`).querySelector(`#windpressoxygen-plc-class-sort`);
  ...
  t([
    ...
    e2[0] !== t2[0] && n(() => {
      ...
      t3.model !== void 0 && (t3.model[`custom-attributes`] === void 0 && h.addCustomAttribute(`plainclass`, ``), y.value = ((_b = (_a = t3.model[`custom-attributes`]) == null ? void 0 : _a.find((e4) => e4.name === `plainclass`)) == null ? void 0 : _b.value) || ``, j());
    }), e2[0] && e2[1] && n(() => {

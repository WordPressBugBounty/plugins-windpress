import { t as e } from "./log-DRYhwGjy.js";
import { t } from "./api-3yDUayxW.js";
import { n } from "./index.browser-DL6dchOu.js";
import { t as r } from "./get-zOKxY8EX.js";
import { t as i } from "./preload-helper-Cb81DA_d.js";
import { n as a } from "./base64-DYxoxXqt.js";
import { t as o } from "./dist-BfP5fEsB.js";
let mn;
let __tla = (async () => {
  var s = [
    [
  ...
  var u = {
    entityList: c
  }, d = 1114111, f = /&#([0-9]+);/g, p = new RegExp("&#x(\\p{AHex}+);", "gu"), m = /* @__PURE__ */ new WeakMap();
  function h(e2, t2 = {}) {
    let { entityList: n2 } = {
      ...u,
      ...t2
  ...
  var _ = /* @__PURE__ */ Symbol.for(`yaml.alias`), v = /* @__PURE__ */ Symbol.for(`yaml.document`), y = /* @__PURE__ */ Symbol.for(`yaml.map`), b = /* @__PURE__ */ Symbol.for(`yaml.pair`), x = /* @__PURE__ */ Symbol.for(`yaml.scalar`), S = /* @__PURE__ */ Symbol.for(`yaml.seq`), C = /* @__PURE__ */ Symbol.for(`yaml.node.type`), w = (e2) => !!e2 && typeof e2 == `object` && e2[C] === _, T = (e2) => !!e2 && typeof e2 == `object` && e2[C] === v, E = (e2) => !!e2 && typeof e2 == `object` && e2[C] === y, D = (e2) => !!e2 && typeof e2 == `object` && e2[C] === b, O = (e2) => !!e2 && typeof e2 == `object` && e2[C] === x, ee = (e2) => !!e2 && typeof e2 == `object` && e2[C] === S;
  function k(e2) {
  ...
  var te = (e2) => (O(e2) || k(e2)) && !!e2.anchor, j = /* @__PURE__ */ Symbol(`break visit`), ne = /* @__PURE__ */ Symbol(`skip children`), M = /* @__PURE__ */ Symbol(`remove node`);
  function N(e2, t2) {
    let n2 = ie(t2);
  ...
  function P(e2, t2, n2, r2) {
    ...
    if (A(i2) || D(i2)) return oe(e2, r2, i2), P(e2, i2, n2, r2);
    if (typeof i2 != `symbol`) {
      if (k(t2)) {
  ...
  async function F(e2, t2, n2, r2) {
    ...
    if (A(i2) || D(i2)) return oe(e2, r2, i2), F(e2, i2, n2, r2);
    if (typeof i2 != `symbol`) {
      if (k(t2)) {
        r2 = Object.freeze(r2.concat(t2));
        for (let e3 = 0; e3 < t2.items.length; ++e3) {
  ...
  function ae(e2, t2, n2, r2) {
    ...
    if (E(t2)) return (_a = n2.Map) == null ? void 0 : _a.call(n2, e2, t2, r2);
    if (ee(t2)) return (_b = n2.Seq) == null ? void 0 : _b.call(n2, e2, t2, r2);
    if (D(t2)) return (_c = n2.Pair) == null ? void 0 : _c.call(n2, e2, t2, r2);
    if (O(t2)) return (_d = n2.Scalar) == null ? void 0 : _d.call(n2, e2, t2, r2);
    if (w(t2)) return (_e2 = n2.Alias) == null ? void 0 : _e2.call(n2, e2, t2, r2);
  }
  ...
  var se = {
    ...
    "{": `%7B`,
    "}": `%7D`
  }, ce = (e2) => e2.replace(/[!,[\]{}]/g, (e3) => se[e3]), le = class e2 {
    constructor(t2, n2) {
...
`);
  ...
  function pe(e2, t2) {
    ...
    return {
      ...
      setAnchors: () => {
        for (let e3 of n2) {
          let t3 = r2.get(e3);
          if (typeof t3 == `object` && t3.anchor && (O(t3.node) || k(t3.node))) t3.node.anchor = t3.anchor;
          else {
  ...
  var me = class {
    ...
    toJS(e2, { mapAsMap: t2, maxAliasCount: n2, onAnchor: r2, reviver: i2 } = {}) {
      ...
      return typeof i2 == `function` ? I(i2, {
        "": o2
      }, ``, o2) : o2;
    }
  }, he = class extends me {
    ...
    resolve(e2, t2) {
      let n2;
      (t2 == null ? void 0 : t2.aliasResolveCache) ? n2 = t2.aliasResolveCache : (n2 = [], N(e2, {
        Node: (e3, t3) => {
    ...
    toJSON(e2, t2) {
      ...
      let o2 = n2.get(a2);
      if (o2 || (o2 = (L(a2, null, t2), n2.get(a2))), (o2 == null ? void 0 : o2.res) === void 0) throw ReferenceError(`This should not happen: Alias anchor was not resolved?`);
      if (i2 >= 0 && (o2.count += 1, o2.aliasCount === 0 && (o2.aliasCount = ge(r2, a2, n2)), o2.count * o2.aliasCount > i2)) throw ReferenceError(`Excessive alias count indicates a resource exhaustion attack`);
      return o2.res;
    }
    toString(e2, t2, n2) {
      let r2 = `*${this.source}`;
      if (e2) {
        if (ue(this.source), e2.options.verifyAliasOrder && !e2.anchors.has(this.source)) {
          let e3 = `Unresolved alias (the anchor must be set before the alias): ${this.source}`;
          throw Error(e3);
        }
  ...
  function ge(e2, t2, n2) {
    if (w(t2)) {
      ...
      let r2 = ge(e2, t2.key, n2), i2 = ge(e2, t2.value, n2);
      return Math.max(r2, i2);
    }
    return 1;
  }
  var _e = (e2) => !e2 || typeof e2 != `function` && typeof e2 != `object`, R = class extends me {
    constructor(e2) {
      super(x), this.value = e2;
    }
    toJSON(e2, t2) {
      return (t2 == null ? void 0 : t2.keep) ? this.value : L(this.value, e2, t2);
    }
    toString() {
      return String(this.value);
    }
  };
  R.BLOCK_FOLDED = `BLOCK_FOLDED`, R.BLOCK_LITERAL = `BLOCK_LITERAL`, R.PLAIN = `PLAIN`, R.QUOTE_DOUBLE = `QUOTE_DOUBLE`, R.QUOTE_SINGLE = `QUOTE_SINGLE`;
  ...
  function z(e2, t2, n2) {
    ...
    if (D(e2)) {
      let t3 = (_b = (_a = n2.schema[y]).createNode) == null ? void 0 : _b.call(_a, n2.schema, null, n2);
    ...
    if (r2 && e2 && typeof e2 == `object`) {
      if (c2 = s2.get(e2), c2) return c2.anchor ?? (c2.anchor = i2(e2)), new he(c2.anchor);
      c2 = {
        anchor: null,
        node: null
      }, s2.set(e2, c2);
    }
    (t2 == null ? void 0 : t2.startsWith(`!!`)) && (t2 = ve + t2.slice(2));
    let l2 = ye(e2, t2, o2.tags);
    if (!l2) {
    ...
    let u2 = (l2 == null ? void 0 : l2.createNode) ? l2.createNode(n2.schema, e2, n2) : typeof ((_c = l2 == null ? void 0 : l2.nodeClass) == null ? void 0 : _c.from) == `function` ? l2.nodeClass.from(n2.schema, e2, n2) : new R(e2);
  ...
  var B = (e2) => e2 == null || typeof e2 == `object` && !!e2[Symbol.iterator]().next().done, xe = class extends me {
    constructor(e2, t2) {
    ...
    clone(e2) {
      ...
      return e2 && (t2.schema = e2), t2.items = t2.items.map((t3) => A(t3) || D(t3) ? t3.clone(e2) : t3), this.range && (t2.range = this.range.slice()), t2;
    }
    addIn(e2, t2) {
      if (B(e2)) this.add(t2);
      else {
    ...
    getIn(e2, t2) {
      let [n2, ...r2] = e2, i2 = this.get(n2, true);
      return r2.length === 0 ? !t2 && O(i2) ? i2.value : i2 : k(i2) ? i2.getIn(r2, t2) : void 0;
    }
    hasAllNullValues(e2) {
...
|$)`, `g`);
  ...
  function Pe({ comment: e2, type: t2, value: n2 }, r2, i2, a2) {
    ...
    let l2 = r2.indent || (r2.forceBlockIndent || ke(n2) ? `  ` : ``), u2 = o2 === `literal` ? true : o2 === `folded` || t2 === R.BLOCK_FOLDED ? false : t2 === R.BLOCK_LITERAL ? true : !Ae(n2, c2, l2.length);
    if (!n2) return u2 ? `|
` : `>
`;
    let d2, f2;
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g, `$1$2`).replace(/\n+/g, `$&${l2}`), i3 = false, a3 = Oe(r2, true);
      o2 !== `folded` && t2 !== R.BLOCK_FOLDED && (a3.onOverflow = () => {
        i3 = true;
      });
...
`) ? U(a2, t2) : Pe(e2, t2, n2, r2);
    if (!s2 && !u2 && i2 !== R.PLAIN && a2.includes(`
...
${c2}`);
  ...
  function Ie(e2, t2, n2, r2) {
    ...
    s2 !== R.QUOTE_DOUBLE && /[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(o2.value) && (s2 = R.QUOTE_DOUBLE);
    let c2 = (e3) => {
      switch (e3) {
        case R.BLOCK_FOLDED:
  ...
  function ze(e2, t2, { anchors: n2, doc: r2 }) {
    ...
    let i2 = [], a2 = (O(e2) || k(e2)) && e2.anchor;
    a2 && ue(a2) && (n2.add(a2), i2.push(`&${a2}`));
  ...
  function W(e2, t2, n2, r2) {
    ...
    let s2 = typeof i2.stringify == `function` ? i2.stringify(a2, t2, n2, r2) : O(a2) ? Ie(a2, t2, n2, r2) : a2.toString(t2, n2, r2);
...
${t2.indent}${s2}` : s2;
  ...
  function Be({ key: e2, value: t2 }, n2, r2, i2) {
    ...
    let p2 = !d2 && (!e2 || f2 && t2 == null && !n2.inFlow || k(e2) || (O(e2) ? e2.type === R.BLOCK_FOLDED || e2.type === R.BLOCK_LITERAL : typeof e2 == `object`));
    n2 = Object.assign({}, n2, {
      allNullValues: false,
...
${s2}:`) : (g2 = `${g2}:`, f2 && (g2 += H(g2, n2.indent, l2(f2))));
    let _2, v2, y2;
    A(t2) ? (_2 = !!t2.spaceBefore, v2 = t2.commentBefore, y2 = t2.comment) : (_2 = false, v2 = null, y2 = null, t2 && typeof t2 == `object` && (t2 = o2.createNode(t2))), n2.implicitKey = false, !p2 && !f2 && O(t2) && (n2.indentAtStart = g2.length + 1), h2 = false, !u2 && c2.length >= 2 && !n2.inFlow && !p2 && ee(t2) && !t2.flow && !t2.tag && !t2.anchor && (n2.indent = n2.indent.substring(2));
...
`) && (S2 = ``);
  ...
  var He = `<<`, G = {
    ...
    test: /^<<$/,
    resolve: () => Object.assign(new R(Symbol(He)), {
      addToJSMap: We
    }),
    stringify: () => He
  }, Ue = (e2, t2) => (G.identify(t2) || O(t2) && (!t2.type || t2.type === R.PLAIN) && G.identify(t2.value)) && (e2 == null ? void 0 : e2.doc.schema.tags.some((e3) => e3.tag === G.tag && e3.default));
  function We(e2, t2, n2) {
    if (n2 = e2 && w(n2) ? n2.resolve(e2.doc) : n2, ee(n2)) for (let r2 of n2.items) Ge(e2, t2, r2);
    else if (Array.isArray(n2)) for (let r2 of n2) Ge(e2, t2, r2);
    else Ge(e2, t2, n2);
  }
  function Ge(e2, t2, n2) {
    let r2 = e2 && w(n2) ? n2.resolve(e2.doc) : n2;
    if (!E(r2)) throw Error(`Merge sources must be maps or map aliases`);
  ...
  function Je(e2, t2, n2) {
    return new K(z(e2, void 0, n2), z(t2, void 0, n2));
  }
  var K = class e2 {
    ...
    toJSON(e3, t2) {
      return Ke(t2, (t2 == null ? void 0 : t2.mapAsMap) ? /* @__PURE__ */ new Map() : {}, this);
    }
    toString(e3, t2, n2) {
      return (e3 == null ? void 0 : e3.doc) ? Be(this, e3, t2, n2) : JSON.stringify(this);
    }
  };
  function Ye(e2, t2, n2) {
    return (t2.inFlow ?? e2.flow ? Ze : Xe)(e2, t2, n2);
  }
  function Xe({ comment: e2, items: t2 }, n2, { blockItemPrefix: r2, flowChars: i2, itemIndent: a2, onChompKeep: o2, onComment: s2 }) {
    ...
    for (let e3 = 0; e3 < t2.length; ++e3) {
      ...
      if (A(i3)) !d2 && i3.spaceBefore && f2.push(``), Qe(n2, f2, i3.commentBefore, d2), i3.comment && (o3 = i3.comment);
      else if (D(i3)) {
        let e4 = A(i3.key) ? i3.key : null;
        e4 && (!d2 && e4.spaceBefore && f2.push(``), Qe(n2, f2, e4.commentBefore, d2));
      }
      d2 = false;
...
` + V(l2(e2), c2), s2 && s2()) : d2 && o2 && o2(), p2;
  ...
  function Ze({ items: e2 }, t2, { flowChars: n2, itemIndent: r2 }) {
    ...
    for (let n3 = 0; n3 < e2.length; ++n3) {
      ...
      if (A(i3)) i3.spaceBefore && d2.push(``), Qe(t2, d2, i3.commentBefore, false), i3.comment && (a3 = i3.comment);
      else if (D(i3)) {
        let e3 = A(i3.key) ? i3.key : null;
        e3 && (e3.spaceBefore && d2.push(``), Qe(t2, d2, e3.commentBefore, false), e3.comment && (l2 = true));
...
${i2}${p2}`;
  ...
  function Qe({ indent: e2, options: { commentString: t2 } }, n2, r2, i2) {
  ...
  var J = class extends xe {
    ...
    static from(e2, t2, n2) {
      let { keepUndefined: r2, replacer: i2 } = n2, a2 = new this(e2), o2 = (e3, o3) => {
        ...
        (o3 !== void 0 || r2) && a2.items.push(Je(e3, o3, n2));
      };
    ...
    add(e2, t2) {
      ...
      if (r2) {
        ...
        O(r2.value) && _e(n2.value) ? r2.value.value = n2.value : r2.value = n2.value;
      } else if (i2) {
    ...
    get(e2, t2) {
      var _a;
      let n2 = (_a = q(this.items, e2)) == null ? void 0 : _a.value;
      return (!t2 && O(n2) ? n2.value : n2) ?? void 0;
    }
    has(e2) {
    ...
    toJSON(e2, t2, n2) {
      ...
      for (let e3 of this.items) Ke(t2, r2, e3);
      return r2;
    }
    toString(e2, t2, n2) {
    ...
    resolve(e2, t2) {
      return E(e2) || t2(`Expected a mapping for this tag`), e2;
    },
    ...
    set(e2, t2) {
      ...
      let r2 = this.items[n2];
      O(r2) && _e(t2) ? r2.value = t2 : this.items[n2] = t2;
    }
    toJSON(e2, t2) {
      let n2 = [];
      (t2 == null ? void 0 : t2.onCreate) && t2.onCreate(n2);
      let r2 = 0;
      for (let e3 of this.items) n2.push(L(e3, String(r2++), t2));
      return n2;
    }
    toString(e2, t2, n2) {
      return e2 ? Ye(this, e2, {
        blockItemPrefix: `- `,
        flowChars: {
          start: `[`,
          end: `]`
  ...
  var X = {
    ...
    resolve(e2, t2) {
      return ee(e2) || t2(`Expected a sequence for this tag`), e2;
    },
    createNode: (e2, t2, n2) => $e.from(e2, t2, n2)
  }, tt = {
    ...
    test: /^(?:~|[Nn]ull|NULL)?$/,
    resolve: () => new R(null),
    stringify: ({ source: e2 }, t2) => typeof e2 == `string` && nt.test.test(e2) ? e2 : t2.options.nullStr
  }, rt = {
    identify: (e2) => typeof e2 == `boolean`,
    default: true,
    tag: `tag:yaml.org,2002:bool`,
    test: /^(?:[Tt]rue|TRUE|[Ff]alse|FALSE)$/,
    resolve: (e2) => new R(e2[0] === `t` || e2[0] === `T`),
    stringify({ source: e2, value: t2 }, n2) {
      return e2 && rt.test.test(e2) && t2 === (e2[0] === `t` || e2[0] === `T`) ? e2 : t2 ? n2.options.trueStr : n2.options.falseStr;
    }
  };
  ...
  var it = {
    ...
    test: /^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,
    resolve(e2) {
      let t2 = new R(parseFloat(e2)), n2 = e2.indexOf(`.`);
      return n2 !== -1 && e2[e2.length - 1] === `0` && (t2.minFractionDigits = e2.length - n2 - 1), t2;
    },
    stringify: Z
  }, st = (e2) => typeof e2 == `bigint` || Number.isInteger(e2), ct = (e2, t2, n2, { intAsBigInt: r2 }) => r2 ? BigInt(e2) : parseInt(e2.substring(t2), n2);
  function lt(e2, t2, n2) {
    let { value: r2 } = e2;
    return st(r2) && r2 >= 0 ? n2 + r2.toString(t2) : Z(e2);
  }
  var ut = {
    identify: (e2) => st(e2) && e2 >= 0,
    default: true,
    tag: `tag:yaml.org,2002:int`,
    format: `OCT`,
    test: /^0o[0-7]+$/,
    resolve: (e2, t2, n2) => ct(e2, 2, 8, n2),
    stringify: (e2) => lt(e2, 8, `0o`)
  }, dt = {
    identify: st,
    default: true,
    tag: `tag:yaml.org,2002:int`,
    test: /^[-+]?[0-9]+$/,
    resolve: (e2, t2, n2) => ct(e2, 0, 10, n2),
    stringify: Z
  }, ft = {
    identify: (e2) => st(e2) && e2 >= 0,
    default: true,
    ...
    format: `HEX`,
    test: /^0x[0-9a-fA-F]+$/,
    resolve: (e2, t2, n2) => ct(e2, 2, 16, n2),
    stringify: (e2) => lt(e2, 16, `0x`)
  }, pt = [
    Y,
    X,
    tt,
  ...
  var ht = ({ value: e2 }) => JSON.stringify(e2), gt = [
    {
      identify: (e2) => typeof e2 == `string`,
      default: true,
      tag: `tag:yaml.org,2002:str`,
    ...
    },
    {
      ...
      stringify: ({ value: e2 }) => mt(e2) ? e2.toString() : JSON.stringify(e2)
    },
    {
      identify: (e2) => typeof e2 == `number`,
      default: true,
    ...
    stringify({ comment: e2, type: t2, value: n2 }, r2, i2, a2) {
      ...
      if (t2 ?? (t2 = R.BLOCK_LITERAL), t2 !== R.QUOTE_DOUBLE) {
...
` : ` `);
  ...
  function yt(e2, t2) {
    if (ee(e2)) for (let n2 = 0; n2 < e2.items.length; ++n2) {
      let r2 = e2.items[n2];
      if (!D(r2)) {
        if (E(r2)) {
          r2.items.length > 1 && t2(`Each pair must have its own sequence indicator`);
          let e3 = r2.items[0] || new K(new R(null));
...
${t3.comment}` : r2.comment;
  ...
  function bt(e2, t2, n2) {
    let { replacer: r2 } = n2, i2 = new $e(e2);
  ...
  var xt = {
    ...
    toJSON(e3, t2) {
      ...
      for (let e4 of this.items) {
        let r2, i2;
        if (D(e4) ? (r2 = L(e4.key, ``, t2), i2 = L(e4.value, r2, t2)) : r2 = L(e4, ``, t2), n2.has(r2)) throw Error(`Ordered maps must not include duplicate keys`);
        n2.set(r2, i2);
      }
      return n2;
    }
    static from(e3, t2, n2) {
      let r2 = bt(e3, t2, n2), i2 = new this();
      return i2.items = r2.items, i2;
    }
  };
  St.tag = `tag:yaml.org,2002:omap`;
  var Ct = {
    collection: `seq`,
    ...
    resolve(e2, t2) {
      ...
      return Object.assign(new St(), n2);
    },
    createNode: (e2, t2, n2) => St.from(e2, t2, n2)
  };
  function wt({ value: e2, source: t2 }, n2) {
    return t2 && (e2 ? Tt : Et).test.test(t2) ? t2 : e2 ? n2.options.trueStr : n2.options.falseStr;
  }
  var Tt = {
    identify: (e2) => e2 === true,
    default: true,
    ...
    test: /^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,
    resolve(e2) {
      let t2 = new R(parseFloat(e2.replace(/_/g, ``))), n2 = e2.indexOf(`.`);
      if (n2 !== -1) {
    ...
    stringify: Z
  }, At = (e2) => typeof e2 == `bigint` || Number.isInteger(e2);
  function jt(e2, t2, n2, { intAsBigInt: r2 }) {
    let i2 = e2[0];
  ...
  var Nt = {
    ...
    format: `BIN`,
    test: /^[-+]?0b[0-1_]+$/,
    resolve: (e2, t2, n2) => jt(e2, 2, 2, n2),
    stringify: (e2) => Mt(e2, 2, `0b`)
  }, Pt = {
    identify: At,
    default: true,
    tag: `tag:yaml.org,2002:int`,
    format: `OCT`,
    test: /^[-+]?0[0-7_]+$/,
    resolve: (e2, t2, n2) => jt(e2, 1, 8, n2),
    stringify: (e2) => Mt(e2, 8, `0`)
  }, Ft = {
    identify: At,
    default: true,
    tag: `tag:yaml.org,2002:int`,
    test: /^[-+]?[0-9][0-9_]*$/,
    resolve: (e2, t2, n2) => jt(e2, 0, 10, n2),
    stringify: Z
  }, It = {
    identify: At,
    default: true,
    ...
    format: `HEX`,
    test: /^[-+]?0x[0-9a-fA-F_]+$/,
    resolve: (e2, t2, n2) => jt(e2, 2, 16, n2),
    stringify: (e2) => Mt(e2, 16, `0x`)
  }, Lt = class e2 extends J {
    constructor(t2) {
      super(t2), this.tag = e2.tag;
    }
    add(e3) {
      let t2;
      t2 = D(e3) ? e3 : e3 && typeof e3 == `object` && `key` in e3 && `value` in e3 && e3.value === null ? new K(e3.key, null) : new K(e3, null), q(this.items, t2.key) || this.items.push(t2);
    }
    get(e3, t2) {
    ...
    static from(e3, t2, n2) {
      ...
      if (t2 && Symbol.iterator in Object(t2)) for (let e4 of t2) typeof r2 == `function` && (e4 = r2.call(t2, e4, e4)), i2.items.push(Je(e4, null, n2));
      return i2;
    }
  };
  Lt.tag = `tag:yaml.org,2002:set`;
  var Rt = {
    collection: `map`,
    ...
    createNode: (e2, t2, n2) => Lt.from(e2, t2, n2),
    resolve(e2, t2) {
      if (E(e2)) {
        if (e2.hasAllNullValues(true)) return Object.assign(new Lt(), e2);
  ...
  var Vt = {
    ...
    resolve: (e2, t2, { intAsBigInt: n2 }) => zt(e2, n2),
    stringify: Bt
  }, Ht = {
    identify: (e2) => typeof e2 == `number`,
    default: true,
  ...
  function Jt(e2, t2, n2) {
    ...
    if (!i2) if (Array.isArray(e2)) i2 = [];
      ...
      let e3 = Array.from(Gt.keys()).filter((e4) => e4 !== `yaml11`).map((e4) => JSON.stringify(e4)).join(`, `);
    ...
    return n2 && (i2 = i2.concat(G)), i2.reduce((e3, t3) => {
      let n3 = typeof t3 == `string` ? Kt[t3] : t3;
      if (!n3) {
        let e4 = JSON.stringify(t3), n4 = Object.keys(Kt).map((e5) => JSON.stringify(e5)).join(`, `);
        throw Error(`Unknown custom tag ${e4}; use one of ${n4}`);
      }
      return e3.includes(n3) || e3.push(n3), e3;
    }, []);
  }
  var Yt = (e2, t2) => e2.key < t2.key ? -1 : e2.key > t2.key ? 1 : 0, Xt = class e2 {
    constructor({ compat: e3, customTags: t2, merge: n2, resolveKnownTags: r2, schema: i2, sortMapEntries: a2, toStringDefaults: o2 }) {
      this.compat = Array.isArray(e3) ? Jt(e3, `compat`) : e3 ? Jt(null, e3) : null, this.name = typeof i2 == `string` && i2 || `core`, this.knownTags = r2 ? qt : {}, this.tags = Jt(t2, this.name, n2), this.toStringOptions = o2 ?? null, Object.defineProperty(this, y, {
        value: Y
      }), Object.defineProperty(this, x, {
        value: tt
      }), Object.defineProperty(this, S, {
        value: X
      }), this.sortMapEntries = typeof a2 == `function` ? a2 : a2 === true ? Yt : null;
    }
    clone() {
...
`;
  ...
  var Qt = class e2 {
    constructor(e3, t2, n2) {
      ...
      this.options = i2;
      let { version: a2 } = i2;
      (n2 == null ? void 0 : n2._directives) ? (this.directives = n2._directives.atDocument(), this.directives.yaml.explicit && (a2 = this.directives.yaml.version)) : this.directives = new le({
        version: a2
    ...
    createAlias(e3, t2) {
      if (!e3.anchor) {
        let n2 = de(this);
        e3.anchor = !t2 || n2.has(t2) ? fe(t2 || `a`, n2) : t2;
      }
      return new he(e3.anchor);
    }
    createNode(e3, t2, n2) {
      let r2;
      ...
      let { aliasDuplicateObjects: i2, anchorPrefix: a2, flow: o2, keepUndefined: s2, onTagObj: c2, tag: l2 } = n2 ?? {}, { onAnchor: u2, setAnchors: d2, sourceObjects: f2 } = pe(this, a2 || `a`), p2 = {
    ...
    getIn(e3, t2) {
      return B(e3) ? !t2 && O(this.contents) ? this.contents.value : this.contents : k(this.contents) ? this.contents.getIn(e3, t2) : void 0;
    }
    has(e3) {
    ...
    setSchema(e3, t2 = {}) {
      ...
      switch (e3) {
        case `1.1`:
          this.directives ? this.directives.yaml.version = `1.1` : this.directives = new le({
            version: `1.1`
          }), n2 = {
        ...
        case `1.2`:
        case `next`:
          this.directives ? this.directives.yaml.version = e3 : this.directives = new le({
            version: e3
          }), n2 = {
      ...
      else if (n2) this.schema = new Xt(Object.assign(n2, t2));
  ...
  var $t = /* @__PURE__ */ Symbol(`break visit`), en = /* @__PURE__ */ Symbol(`skip children`), tn = /* @__PURE__ */ Symbol(`remove item`);
  function $(e2, t2) {
    `type` in e2 && e2.type === `document` && (e2 = {
      start: e2.start,
      value: e2.value
    }), nn(Object.freeze([]), e2, t2);
  }
  $.BREAK = $t, $.SKIP = en, $.REMOVE = tn, $.itemAtPath = (e2, t2) => {
    let n2 = e2;
    for (let [e3, r2] of t2) {
    ...
    for (let i2 of [
      ...
      if (a2 && `items` in a2) {
        for (let t3 = 0; t3 < a2.items.length; ++t3) {
          let r3 = nn(Object.freeze(e2.concat([
            [
              i2,
              t3
            ]
          ...
          else if (r3 === $t) return $t;
          else r3 === tn && (a2.items.splice(t3, 1), --t3);
        }
  ...
  function rn(e2, t2, n2) {
    ...
    return T(e2) && !r2 ? e2.toString(n2) : new Qt(e2, r2, n2).toString(n2);
  }
  function an(e2) {
  ...
  function on(e2, t2) {
    let n2, r2 = () => {
      ...
      return r3.onupgradeneeded = () => r3.result.createObjectStore(t2), n2 = an(r3), n2.then((e3) => {
  ...
  var sn;
  function cn() {
    return sn || (sn = on(`keyval-store`, `keyval`)), sn;
  }
  function ln(e2, t2 = cn()) {
    return t2(`readonly`, (t3) => an(t3.get(e2)));
  }
  function un(e2, t2, n2 = cn()) {
    return n2(`readwrite`, (n3) => (n3.put(t2, e2), an(n3.transaction)));
  }
  var dn = on(`windpress-cache-store`, `provider-cache`);
  async function fn(s2 = {}) {
    let c2 = t(), l2 = e();
    l2.add({
    ...
    async function y2(e2) {
      ...
      try {
        do {
          ...
          r2.push(...o2.contents), t2 = ((_b = o2.metadata) == null ? void 0 : _b.next_batch) || false, l2.update(i2, {
            type: `info`,
            message: `${a2} - done`
          });
        } while (t2 !== false);
    ...
    let x2 = v2.map((e2) => {
      ...
      return e2.type === `json` && (t2 = rn(JSON.parse(t2))), h(t2);
    ...
    if (u2.tailwindcss_version === 4) {
      let { compile: e2, getCandidates: t2, optimize: n2, loadSource: r2 } = await i(async () => {
        let { compile: e3, getCandidates: t3, optimize: n3, loadSource: r3 } = await import("./tailwindcss-CWOrU34n.js").then(async (m3) => {
          await m3.__tla;
          return m3;
        });
        return {
      ...
      let { build: e2, optimize: t2 } = await i(async () => {
        let { build: e3, optimize: t3 } = await import("./tailwindcss-v3-BftSpQDZ.js").then(async (m3) => {
          await m3.__tla;
          return m3;
        });
        return {
  ...
  mn = async function() {
    `locks` in navigator ? navigator.locks.request(`task_lock`, {
      mode: `exclusive`
    }, (e2) => (console.log(`Lock acquired. Starting worker.`), pn(), new Promise(() => {
    }))).catch(() => {
      console.log(`Failed to acquire lock. Worker already running in another tab.`);
    }) : (console.log(`Locks API not supported in this browser. Starting worker without lock.`), pn());
  };
})();
export {
  __tla,

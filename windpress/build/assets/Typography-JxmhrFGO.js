import { D as e, E as t, Ht as n, J as r, Lt as i, On as a, Tn as o, Wt as s, Zn as c, _ as l, b as u, bt as d, ct as f, er as p, et as m, g as h, it as g, k as _, mt as v, o as y, qt as b, rt as x, tr as S, v as C, vn as w, xn as T, xt as E, y as D } from "./runtime-core.esm-bundler-Ci9kEgM7.js";
import { c as O, l as k } from "./vue.runtime.esm-bundler-CWCE91rd.js";
import { C as A, O as j, R as M, S as N, X as P, _ as F, b as I, t as ee, x as te, y as ne } from "./Button-CzGEASGR.js";
import { A as L, b as R, m as z, v as B } from "./dist-D5YmEqpM.js";
import { i as re } from "./vue-router-Ds7Bu_8X.js";
import { b as V, t as ie, v as H, y as U } from "./Tooltip-CmrGYuQV.js";
import { W, f as G } from "./namespaced-DmrIZId-.js";
import { t as ae } from "./useOverlay-D6IDAxlU.js";
import { n as K, t as oe } from "./FluidCalculatorSlideover-DCecaGNy.js";
import { n as q, t as se } from "./Tree-B0rB3fqE.js";
import { n as ce } from "./useToast-BvjG-lga.js";
import { t as J } from "./Badge-Dw196kvM.js";
import { n as le } from "./index.browser-BEODCD8T.js";
import { n as ue, t as de } from "./DashboardNavbar-BjpmTDcR.js";
import { n as Y, r as X, t as Z } from "./WizardTreeItem-_60OpT8s.js";
var [Q, fe] = j(`TabsRoot`), pe = _({ __name: `TabsRoot`, props: { defaultValue: { type: null, required: false }, orientation: { type: String, required: false, default: `horizontal` }, dir: { type: String, required: false }, activationMode: { type: String, required: false, default: `automatic` }, modelValue: { type: null, required: false }, unmountOnHide: { type: Boolean, required: false, default: true }, asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, emits: [`update:modelValue`], setup(e2, { emit: t2 }) {
  let n2 = e2, r2 = t2, { orientation: i2, unmountOnHide: s2, dir: c2 } = o(n2), l2 = W(c2);
  V();
  ...
  return fe({ modelValue: u2, changeModelValue: (e3) => {
    u2.value = e3;
  }, orientation: i2, dir: l2, unmountOnHide: s2, activationMode: n2.activationMode, baseId: U(void 0, `reka-tabs`), tabsList: d2, contentIds: f2, registerContent: (e3) => {
    f2.value = /* @__PURE__ */ new Set([...f2.value, e3]);
  }, unregisterContent: (e3) => {
    let t3 = new Set(f2.value);
    t3.delete(e3), f2.value = t3;
  } }), (e3, t3) => (v(), C(a(A), { dir: a(l2), "data-orientation": a(i2), "as-child": e3.asChild, as: e3.as }, { default: b(() => [E(e3.$slots, `default`, { modelValue: a(u2) })]), _: 3 }, 8, [`dir`, `data-orientation`, `as-child`, `as`]));
} });
function $(e2, t2) {
...
var he = _({ __name: `TabsContent`, props: { value: { type: [String, Number], required: true }, forceMount: { type: Boolean, required: false }, asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, setup(t2) {
  let n2 = t2, { forwardRef: r2 } = V(), i2 = Q(), o2 = h(() => $(i2.baseId, n2.value)), s2 = h(() => me(i2.baseId, n2.value)), c2 = h(() => n2.value === i2.modelValue.value), l2 = w(c2.value);
  return f(() => {
  ...
  }), B(h(() => [i2.tabsList.value, ...l2.value]), u2);
  function u2() {
    let e3 = i2.tabsList.value?.querySelector(`[role="tab"][data-state="active"]`);
    e3 && (i2.orientation.value === `horizontal` ? c2.value = { size: e3.offsetWidth, position: e3.offsetLeft } : c2.value = { size: e3.offsetHeight, position: e3.offsetTop });
  }
  return (e3, t3) => a(o2) && typeof c2.value.size == `number` ? (v(), C(a(A), m({ key: 0 }, r2, { style: { "--reka-tabs-indicator-size": `${c2.value.size}px`, "--reka-tabs-indicator-position": `${c2.value.position}px` } }), { default: b(() => [E(e3.$slots, `default`)]), _: 3 }, 16, [`style`])) : D(`v-if`, true);
  ...
  let { loop: n2 } = o(t2), { forwardRef: r2, currentElement: i2 } = V(), s2 = Q();
  return s2.tabsList = i2, (t3, i3) => (v(), C(a(G), { "as-child": ``, orientation: a(s2).orientation.value, dir: a(s2).dir.value, loop: a(n2) }, { default: b(() => [e(a(A), { ref: a(r2), role: `tablist`, "as-child": t3.asChild, as: t3.as, "aria-orientation": a(s2).orientation.value }, { default: b(() => [E(t3.$slots, `default`)]), _: 3 }, 8, [`as-child`, `as`, `aria-orientation`])]), _: 3 }, 8, [`orientation`, `dir`, `loop`]));
  ...
  let n2 = t2, { forwardRef: r2 } = V(), i2 = Q(), o2 = h(() => $(i2.baseId, n2.value)), s2 = h(() => i2.contentIds.value.has(n2.value) ? me(i2.baseId, n2.value) : void 0), c2 = h(() => n2.value === i2.modelValue.value);
  return (t3, n3) => (v(), C(a(q), { "as-child": ``, focusable: !t3.disabled, active: c2.value }, { default: b(() => [e(a(A), { id: o2.value, ref: a(r2), role: `tab`, type: t3.as === `button` ? `button` : void 0, as: t3.as, "as-child": t3.asChild, "aria-selected": c2.value ? `true` : `false`, "aria-controls": s2.value, "data-state": c2.value ? `active` : `inactive`, disabled: t3.disabled, "data-disabled": t3.disabled ? `` : void 0, "data-orientation": a(i2).orientation.value, onMousedown: n3[0] || (n3[0] = k((e2) => {
  ...
  let s2 = n2, l2 = o2, f2 = i(), p2 = N(`tabs`, s2), g2 = P(), _2 = te(L(p2, `as`, `unmountOnHide`), l2), x2 = h(() => I({ extend: I(ye), ...g2.ui?.tabs || {} })({ color: p2.color, variant: p2.variant, size: p2.size, orientation: p2.orientation })), T2 = w([]);
  function O2(e2, t2) {
    T2.value[e2] = t2;
  }
  return r2({ triggersRef: T2 }), (n3, r3) => (v(), C(a(pe), m(a(_2), { "model-value": a(p2).modelValue, "default-value": a(p2).defaultValue, orientation: a(p2).orientation, "activation-mode": a(p2).activationMode, "data-slot": `root`, class: x2.value.root({ class: [a(p2).ui?.root, a(p2).class] }) }), { default: b(() => [e(a(_e), { "data-slot": `list`, class: c(x2.value.list({ class: a(p2).ui?.list })) }, { default: b(() => [e(a(ge), { "data-slot": `indicator`, class: c(x2.value.indicator({ class: a(p2).ui?.indicator })) }, null, 8, [`class`]), E(n3.$slots, `list-leading`), (v(true), u(y, null, d(a(p2).items, (e2, r4) => (v(), C(a(ve), { key: a(M)(e2, a(p2).valueKey) ?? r4, ref_for: true, ref: (e3) => O2(r4, e3), value: a(M)(e2, a(p2).valueKey) ?? String(r4), disabled: e2.disabled, "data-slot": `trigger`, class: c(x2.value.trigger({ class: [a(p2).ui?.trigger, e2.ui?.trigger] })) }, { default: b(() => [E(n3.$slots, `leading`, { item: e2, index: r4, ui: x2.value }, () => [e2.icon ? (v(), C(ne, { key: 0, name: e2.icon, "data-slot": `leadingIcon`, class: c(x2.value.leadingIcon({ class: [a(p2).ui?.leadingIcon, e2.ui?.leadingIcon] })) }, null, 8, [`name`, `class`])) : e2.avatar ? (v(), C(F, m({ key: 1, size: e2.ui?.leadingAvatarSize || a(p2).ui?.leadingAvatarSize || x2.value.leadingAvatarSize() }, { ref_for: true }, e2.avatar, { "data-slot": `leadingAvatar`, class: x2.value.leadingAvatar({ class: [a(p2).ui?.leadingAvatar, e2.ui?.leadingAvatar] }) }), null, 16, [`size`, `class`])) : D(``, true)]), a(M)(e2, a(p2).labelKey) || f2.default ? (v(), u(`span`, { key: 0, "data-slot": `label`, class: c(x2.value.label({ class: [a(p2).ui?.label, e2.ui?.label] })) }, [E(n3.$slots, `default`, { item: e2, index: r4 }, () => [t(S(a(M)(e2, a(p2).labelKey)), 1)])], 2)) : D(``, true), E(n3.$slots, `trailing`, { item: e2, index: r4, ui: x2.value }, () => [e2.badge || e2.badge === 0 ? (v(), C(J, m({ key: 0, color: `neutral`, variant: `outline`, size: e2.ui?.trailingBadgeSize || a(p2).ui?.trailingBadgeSize || x2.value.trailingBadgeSize() }, { ref_for: true }, typeof e2.badge == `string` || typeof e2.badge == `number` ? { label: e2.badge } : e2.badge, { "data-slot": `trailingBadge`, class: x2.value.trailingBadge({ class: [a(p2).ui?.trailingBadge, e2.ui?.trailingBadge] }) }), null, 16, [`size`, `class`])) : D(``, true)])]), _: 2 }, 1032, [`value`, `disabled`, `class`]))), 128)), E(n3.$slots, `list-trailing`)]), _: 3 }, 8, [`class`]), a(p2).content ? (v(true), u(y, { key: 0 }, d(a(p2).items, (e2, r4) => (v(), C(a(he), { key: a(M)(e2, a(p2).valueKey) ?? r4, value: a(M)(e2, a(p2).valueKey) ?? String(r4), "data-slot": `content`, class: c(x2.value.content({ class: [a(p2).ui?.content, e2.ui?.content, e2.class] })) }, { default: b(() => [E(n3.$slots, e2.slot || `content`, { item: e2, index: r4, ui: x2.value }, () => [t(S(e2.content), 1)])]), _: 2 }, 1032, [`value`, `class`]))), 128)) : D(``, true)]), _: 3 }, 16, [`model-value`, `default-value`, `orientation`, `activation-mode`, `class`]));
  ...
  let o2 = ae(), s2 = ce(), c2 = r(`theme`), d2 = w(`text`), { expandedTree: f2, items: p2, updateThemeFromItems: m2, findItemByUid: h2, addChild: g2, addNext: _2, deleteItem: y2, initializeItems: T2, findOrCreateItemByKey: E2 } = X(`text`, c2), { shouldBeDimmed: O2, wasRecentlyMoved: k2, isDescendantOf: A2 } = Y(p2, m2, h2), { expandedTree: j2, items: M2, updateThemeFromItems: N2, findItemByUid: P2, addChild: F2, addNext: I2, deleteItem: te2, initializeItems: L2 } = X(`font`, c2), { shouldBeDimmed: R2, wasRecentlyMoved: z2, isDescendantOf: B2 } = Y(M2, N2, P2);
  ...
  function pe2(e2) {
    ...
    for (let t3 = 1; t3 <= e2.stepsSmaller; t3++) {
      ...
      n2.push({ key: r3, value: K(i4, a2, e2.minViewport, e2.maxViewport) });
    }
    n2.push({ key: `base`, value: K(e2.minSize, e2.maxSize, e2.minViewport, e2.maxViewport) });
  ...
  async function $2() {
    ...
    pe2(e2), s2.add({ title: wp.i18n.__(`Generated`, `windpress`), description: wp.i18n.__(`Fluid spacing have been generated successfully.`, `windpress`), icon: `lucide:wand-sparkles`, color: `success` });
  }
  return x(() => {
    T2(), L2();
  }), re((e2, t2, n2) => {

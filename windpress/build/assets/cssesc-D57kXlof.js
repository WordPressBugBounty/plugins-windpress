...
import { a as s, c, i as l, t as u } from "./lib-COJH7Mqf.js";
...
`)) {
      ...
      block(e3, t3) {
        let n3 = e3.raws, r3 = n3.between === void 0 ? this.raw(e3, `between`, `beforeOpen`) : n3.between;
        this.builder(i2(t3 + r3) + `{`, e3, `start`);
        let a3;
        e3.nodes && e3.nodes.length ? (this.body(e3), a3 = n3.after === void 0 ? this.raw(e3, `after`) : n3.after) : a3 = n3.after === void 0 ? this.raw(e3, `after`, `emptyBody`) : n3.after, a3 && this.builder(i2(a3)), this.builder(`}`, e3, `end`);
      }
      body(e3) {
        ...
        for (let e4 = 0; e4 < t3.length; e4++) {
          let o3 = t3[e4], s3 = o3.raws.before;
          s3 === void 0 && (s3 = this.raw(o3, `before`)), s3 && this.builder(a3 ? s3 : i2(s3)), this.stringify(o3, n3 !== e4 || r3);
        }
      }
      comment(e3) {
        let t3 = e3.raws, n3 = t3.left === void 0 ? this.raw(e3, `left`, `commentLeft`) : t3.left, r3 = t3.right === void 0 ? this.raw(e3, `right`, `commentRight`) : t3.right;
        this.builder(i2(`/*` + n3 + e3.text + r3 + `*/`), e3);
      }
      decl(e3, t3) {
        let n3 = e3.raws, r3 = n3.between === void 0 ? this.raw(e3, `between`, `colon`) : n3.between, a3 = e3.prop + r3 + this.rawValue(e3, `value`);
...
`), t3 = o3.length - i2) : t3 += o3.length, s2 && c2 !== `start`) {
  ...
  G = n(((e2, t2) => {
    var n2 = O(), r2 = U(), i2 = W(), a2 = M(), o2 = class {
      constructor(e3 = []) {
        this.version = `8.5.13`, this.plugins = this.normalize(e3);
      }
      normalize(e3) {
        let t3 = [];

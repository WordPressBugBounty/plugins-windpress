...
let requireLib, requirePathBrowserify, requireHasown, path, encodeBase64, requirePostcss, getDefaultExportFromCjs, requirePicocolors_browser, isValidUrl, requireSafeBuffer, commonjsGlobal, loadModule, requireStreamBrowserify, requireInherits_browser, requireDist$1, postcss, requireString_decoder, requireSourceMapGenerator, requireEvents, requireUtil$2, requireBrowser, requireCssesc, importLocalModule, decodeBase64;
let __tla = (async () => {
  ...
  requireSourceMapGenerator = function() {
  ...
  const require$$6 = getAugmentedNamespace(__viteBrowserExternal$1);
  var cssSyntaxError;
...
export {
  ...
  requirePicocolors_browser as h,
  isValidUrl as i,
  requireSafeBuffer as j,
  commonjsGlobal as k,
  loadModule as l,
  requireStreamBrowserify as m,
  requireInherits_browser as n,
  requireDist$1 as o,
  postcss as p,
  requireString_decoder as q,
  requireSourceMapGenerator as r,
  requireEvents as s,
  requireUtil$2 as t,
  requireBrowser as u,
  requireCssesc as v,
  importLocalModule as w,
  decodeBase64 as x
};

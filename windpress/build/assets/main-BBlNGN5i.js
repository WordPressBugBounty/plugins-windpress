import { Ct as e, D as t, E as n, Ht as r, J as i, On as a, St as o, Yt as s, Zn as c, _ as l, b as u, bt as d, ct as f, er as p, l as m, mt as h, o as g, qt as _, tr as v, v as y, vn as b, xt as x, y as S } from "./runtime-core.esm-bundler-Twwq1XF8.js";
import { S as ee, i as te, t as ne } from "./runtime-dom.esm-bundler-Owfape5M.js";
import { y as C } from "./dist-ChpmCc7n.js";
import { t as w } from "./set-4UwbVlC4.js";
import { t as T } from "./vfs-DGZNrgMJ.js";
import { c as E, i as D } from "./intellisense-BqSPmEm7.js";
import "./tailwindcss-CdApilZd.js";
import { t as O } from "./logger-CvF98D4V.js";
import { t as k } from "./_plugin-vue_export-helper-BDNMzG2s.js";
import { a as re, i as ie, n as ae, r as oe, t as se } from "./chevron-right-BCavwTU8.js";
import { i as ce, t as A } from "./constant-DpZqgQ1m.js";
var j = { id: `windpressoxygen-variable-app-header`, class: `header-container cursor:grab bb:1|solid|$(gray200)` }, M = { class: `header-content flex gap:10 align-items:center fg:var(dark)` }, N = { class: `header-logo flex align-items:center px:12 py:2` }, P = { class: `header-title text-transform:none font:medium text:center flex-grow:1 gap:10 align-items:center cursor:default px:12 py:2` }, F = k({ __name: `PanelHeader`, setup(c2) {
  let d2 = i(`variableApp`), p2 = i(`isOpen`);
  function m2() {
    let e2 = d2.querySelector(`#windpressoxygen-variable-app-header`), t2 = b(false), n2 = 0, i2 = 0;
    r(t2, (t3) => {
      t3 ? (document.body.style.userSelect = `none`, A.querySelector(`div.v-application--wrap`).style.pointerEvents = `none`, e2.style.cursor = `grabbing`) : (document.body.style.removeProperty(`user-select`), A.querySelector(`div.v-application--wrap`).style.removeProperty(`pointer-events`), e2.style.cursor = `grab`);
    });
    let a2 = (r2) => {
      t2.value = true;
  ...
  return f(() => {
    ...
    let c3 = o(`inline-svg`), d3 = oe, f2 = e(`tooltip`);
    return h(), u(`div`, j, [l(`div`, M, [l(`div`, N, [t(c3, { src: a(ae), class: `inline-svg fill:current font:24` }, null, 8, [`src`])]), s((h(), u(`div`, P, [...i2[1] || (i2[1] = [n(` WindPress `, -1)])])), [[f2, { placement: `top`, content: `v${r2.windpressoxygen._version}` }]]), s((h(), u(`button`, { class: `header-exit flex align-items:center py:10 px:12 fg:$(blue600):hover bg:$(blue50):hover`, onClick: i2[0] || (i2[0] = (e2) => p2.value = !a(p2)) }, [t(d3, { class: `iconify font:16` })])), [[f2, { placement: `top`, content: `Close` }]])])]);
  };
} }, [[`__scopeId`, `data-v-0ce84985`]]), I = { class: `header-slot flex-grow:1` }, L = { key: 0, class: `expansion-panel__body` }, R = k({ __name: `ExpansionPanel`, props: { namespace: { type: String, required: true }, name: { type: String, required: true } }, setup(e2, { expose: n2 }) {
  let r2 = e2, i2 = b(null), o2 = C(`windpressoxygen-variable-app.ui.expansion-panels.${r2.namespace}`, { [`${r2.name}`]: false }, void 0, { mergeDefaults: true });
  function s2(e3) {
...
} }, [[`__scopeId`, `data-v-89e59a66`]]), le = { class: `{m:10;pb:15}>div` }, ue = { class: `variable-section-title font:14 my:10` }, de = { key: 0, class: `variable-section-items default-color` }, fe = [`onClick`, `onMouseenter`], pe = [`onClick`, `onMouseenter`], me = k({ __name: `ColorVariableItems`, props: { variableItems: { type: Object, required: true } }, setup(t2) {
  return (n2, r2) => {
    let i2 = e(`tooltip`);
...
} }, [[`__scopeId`, `data-v-840ff6c9`]]), he = { id: `windpressoxygen-variable-app-body`, class: `var-body rel w:full h:full overflow-y:scroll! bb:1|solid|$(gray200)>div:not(:last-child)` }, ge = 1e3, _e = k({ __name: `PanelBody`, setup(e2) {
  ...
  async function d2() {
    let e3 = await D(await E({ volume: T(ce.contentWindow.document.querySelector(`script#windpress\\:vfs[type="text/plain"]`).textContent) })), t2 = c2.querySelector(`style#windpressoxygen-variable-app-body-style`);
...
} }, [[`__scopeId`, `data-v-a99a334f`]]), ve = k({ __name: `App`, setup(e2) {
  let n2 = i(`isOpen`), r2 = b(null);
  function o2() {
    A.classList.contains(`theme--light`) ? (r2.value.classList.add(`theme--light`), r2.value.classList.remove(`theme--dark`)) : A.classList.contains(`theme--dark`) && (r2.value.classList.add(`theme--dark`), r2.value.classList.remove(`theme--light`));
  }
  return new MutationObserver((e3) => {
    e3.forEach((e4) => {
      e4.attributeName === `class` && o2();
    });
  }).observe(A, { attributes: true, attributeFilter: [`class`], childList: false, subtree: false }), f(() => {
    o2();
  }), (e3, i2) => s((h(), u(`div`, { id: `windpressoxygen-variable-app-container`, ref_key: `containerRef`, ref: r2, class: `v-application flex flex:column w:full h:full` }, [t(F), (h(), y(m, null, { default: _(() => [t(_e)]), _: 1 }))], 512)), [[ee, a(n2)]]);
} }, [[`__scopeId`, `data-v-fef28b28`]]);
function ye({ selector: e2, callback: t2, options: n2 }) {
  let r2 = new MutationObserver(t2), i2 = document.querySelector(e2);
  if (!i2) {
    O(`Target not found for selector: ${e2}`, { module: `variable-picker`, type: `error` });
    return;
  }
...
G.id = `windpressoxygen-variable-app`, A.appendChild(G);
var K = b(false), q = b(null), J = b(null), be = b(0), Y = te(ve);
Y.config.globalProperties.windpressoxygen = window.windpressoxygen, Y.provide(`variableApp`, G), Y.provide(`isOpen`, K), Y.provide(`focusedInput`, q), Y.provide(`tempInputValue`, J), Y.provide(`recentVariableSelectionTimestamp`, be), Y.use(ie, { container: `#windpressoxygen-variable-app` }), Y.component(`InlineSvg`, re), Y.mount(`#windpressoxygen-variable-app`);
function X(e2) {
  ...
  setTimeout(() => {
    ...
    xe.includedFields.forEach((t2) => {
      (typeof t2 == `string` ? [...document.querySelectorAll(t2)] : [...document.querySelectorAll(t2.selector)].filter((e3) => t2.hasChild.some((t3) => e3.querySelector(t3)))).forEach((t3) => {
        ...
        n2?.getAttribute(`windpressoxygen-variable-app`) !== `listened` && (n2?.removeEventListener(`click`, X), n2?.addEventListener(`click`, X), n2?.removeEventListener(`focus`, Z), n2?.addEventListener(`focus`, Z), n2?.setAttribute(`windpressoxygen-variable-app`, `listened`), e2 = true);
      });
...
}), O(`Module loaded!`, { module: `variable-picker` });

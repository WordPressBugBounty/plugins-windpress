...
import { __tla as __tla_0 } from "./cssesc-BlGGmlzH.js";
import "./build-DvOg9atY.js";
import "./vfs-DziqLF6T.js";
import "./intellisense-CtRsPNrz.js";
let l, c, Je;
let __tla = Promise.all([
  ...
  c = async function(e2) {
    if (!o) return s || (s = (async () => {
      try {
        let t2 = await n(() => import("./oxide_parser-VXY35DVq-C8iMF5Ww.js").then(async (m2) => {
          await m2.__tla;
          return m2;
        }), [], import.meta.url);
  ...
  var pe = 1024 * 64, E = (e2) => {
    ...
    get depth() {
      var _a3;
      return (((_a3 = __privateGet(this, _i)) == null ? void 0 : _a3.depth) ?? -1) + 1;
    }
    [/* @__PURE__ */ Symbol.for(`nodejs.util.inspect.custom`)]() {
      ...
      return {
        ...
        parent: (_a3 = __privateGet(this, _i)) == null ? void 0 : _a3.id,
        depth: this.depth,
    ...
    toJSON() {
      ...
      return this.isStart() && !this.type && e2.unshift([]), this.isEnd() && (this === __privateGet(this, _e2) || __privateGet(__privateGet(this, _e2), _s) && ((_a3 = __privateGet(this, _i)) == null ? void 0 : _a3.type) === `!`) && e2.push({}), e2;
    }
    isStart() {
      var _a3;
      if (__privateGet(this, _e2) === this) return true;
      if (!((_a3 = __privateGet(this, _i)) == null ? void 0 : _a3.isStart())) return false;
    ...
    isEnd() {
      var _a3, _b2, _c2;
      if (__privateGet(this, _e2) === this || ((_a3 = __privateGet(this, _i)) == null ? void 0 : _a3.type) === `!`) return true;
      if (!((_b2 = __privateGet(this, _i)) == null ? void 0 : _b2.isEnd())) return false;
      if (!this.type) return (_c2 = __privateGet(this, _i)) == null ? void 0 : _c2.isEnd();
    ...
    toRegExpSource(e2) {
      ...
      if (__privateGet(this, _e2) === this && (__privateMethod(this, _H_instances, x_fn).call(this), __privateMethod(this, _H_instances, d_fn).call(this)), !N(this)) {
        let n3 = this.isStart() && this.isEnd() && !__privateGet(this, _r).some((e3) => typeof e3 != `string`), r3 = __privateGet(this, _r).map((t3) => {
          var _a4;
          let [r4, i4, a4, o3] = typeof t3 == `string` ? __privateMethod(_a4 = A, _H_static, C_fn).call(_a4, t3, __privateGet(this, _t), n3) : t3.toRegExpSource(e2);
        ...
        let a3 = ``;
        return this.isEnd() && __privateGet(__privateGet(this, _e2), _s) && ((_a3 = __privateGet(this, _i)) == null ? void 0 : _a3.type) === `!` && (a3 = `(?:$|\\/)`), [
          i3 + r3 + a3,
          k(r3),
    ...
    var _a3;
    return !!((_a3 = t2.get(this.type)) == null ? void 0 : _a3.includes(e2));
  }, g_fn = function(e2, t2) {
    ...
    var _a3;
    return !!((_a3 = L.get(this.type)) == null ? void 0 : _a3.has(e2));
  }, y_fn = function(e2) {
    ...
    let t2 = L.get(this.type), n2 = __privateGet(e2, _r)[0], r2 = t2 == null ? void 0 : t2.get(n2.type);
    if (!r2) return false;
  ...
  var Q = /[?*]|[+@!]\(.*?\)|\[|\]/, We = (e2) => e2.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, `\\$&`), $ = (_b = class {
    ...
    match(e2, t2 = this.partial) {
      ...
      for (let e3 = 0; e3 < i2.length; e3++) {
        let o2 = i2[e3], s2 = r2;
        if (n2.matchBase && o2.length === 1 && (s2 = [
          a2
        ]), this.matchOne(s2, o2, t2)) return n2.flipNegate ? true : !this.negate;
      }

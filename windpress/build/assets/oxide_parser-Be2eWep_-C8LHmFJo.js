...
function t() {
  return { __proto__: null, "./oxide_parser_bg.js": { __proto__: null, __wbg___wbindgen_string_get_72bdf95d3ae505b1: function(e2, t2) {
  ...
  }, __wbg___wbindgen_throw_1506f2235d1bdba0: function(e2, t2) {
    throw Error(o(e2, t2));
  }, __wbg_from_d300fe49deab18f5: function(e2) {
    return n(Array.from(l(e2)));
  }, __wbg_get_2b48c7d0d006a781: function(e2, t2) {
    let r2 = l(e2)[t2 >>> 0];
    return n(r2);
  }, __wbg_isArray_67c2c9c4313f4448: function(e2) {
    return Array.isArray(l(e2));
  }, __wbg_length_66f1a4b2e9026940: function(e2) {
    return l(e2).length;
  }, __wbg_new_d90091b82fdf5b91: function() {
    return n([]);
  }, __wbg_new_with_length_690552eb9e6aeac9: function(e2) {
    return n(Array(e2 >>> 0));
  }, __wbg_set_dca99999bba88a9a: function(e2, t2, n2) {
    l(e2)[t2 >>> 0] = m(n2);
...
async function T(e2) {
  if (x !== void 0) return x;
  e2 !== void 0 && (Object.getPrototypeOf(e2) === Object.prototype ? { module_or_path: e2 } = e2 : console.warn(`using deprecated parameters for the initialization function; pass a single object instead`)), e2 === void 0 && (e2 = new URL(`` + new URL(`oxide_parser_bg-B0xOEYtF.wasm`, import.meta.url).href, `` + import.meta.url));
  let n2 = t();

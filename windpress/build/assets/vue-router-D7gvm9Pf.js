import { B as e, Ht as t, J as n, On as r, ft as i, g as a, gn as o, gt as s, k as c, nt as l, ot as u, tt as d, vn as f, xn as ee, yn as p } from "./runtime-core.esm-bundler-D9h95518.js";
...
function qe(e2) {
  ...
  for (; s2 < e2.length; ) switch (c2 = e2[s2++], n2) {
    case Q.Static:
      c2 === `\\` ? (r2 = n2, n2 = Q.EscapeNext) : c2 === `/` ? (l2 && d2(), o2()) : c2 === `:` ? (d2(), n2 = Q.Param) : f2();
      break;
    case Q.EscapeNext:
      f2(), n2 = r2;
      break;

import { $n as e, B as t, D as n, Dn as r, E as i, Gt as a, Ht as o, J as s, L as c, Lt as l, On as u, Q as d, Tn as f, Ut as p, Xt as m, b as h, bt as g, ct as _, er as v, et as y, fn as b, ft as x, g as S, gn as C, gt as w, h as T, k as E, mt as D, o as O, pn as k, qt as A, rt as j, tr as M, tt as N, un as P, v as F, vn as I, wt as L, xn as R, xt as z, y as B, z as V } from "./runtime-core.esm-bundler-CahM68iJ.js";
import { c as H, l as U } from "./vue.runtime.esm-bundler-B0iyRCM8.js";
import { C as W, H as ee, S as te, T as G, U as ne, x as K } from "./Button-DpvhuBJO.js";
import { C as re, E as ie, N as ae, P as oe, S as se, T as ce, b as q, f as le, g as ue, j as de, k as fe, o as pe, w as me } from "./dist-BKF-Yqo1.js";
import { S as he, _ as ge, b as _e, c as ve, f as ye, g as J, h as be, l as xe, o as Se, p as Ce, s as we, u as Te, v as Y, w as Ee, y as X } from "./Tooltip-CZRNrufK.js";
import { n as Z, r as De, t as Oe } from "./VisuallyHiddenInput-D4UqkOgw.js";
function ke(e2, t2, n2) {
  let r2 = e2.findIndex((e3) => ee(e3, t2)), i2 = e2.findIndex((e3) => ee(e3, n2));
  if (r2 === -1 || i2 === -1) return [];
...
function je(e2, t2, n2, r2 = {}) {
  ...
  let b2 = null;
  return v2 || _2 ? b2 = Me(y2, t2, { goForward: _2 ? m2 : c2 === `ltr` ? d2 : f2, loop: s2 }) : h2 ? b2 = y2.at(0) || null : g2 && (b2 = y2.at(-1) || null), u2 && (b2 == null ? void 0 : b2.focus()), b2;
}
...
var Ne = me(() => {
  let e2 = I(/* @__PURE__ */ new Map()), t2 = I(), n2 = S(() => {
    ...
    document.body.style.paddingRight = ``, document.body.style.marginRight = ``, document.body.style.pointerEvents = ``, document.documentElement.style.removeProperty(`--scrollbar-width`), document.body.style.overflow = t2.value ?? ``, ie && (i2 == null ? void 0 : i2()), t2.value = void 0;
  };
  return o(n2, (e3, o2) => {
    var _a;
    if (!ce) return;
    ...
    let s2 = window.innerWidth - document.documentElement.clientWidth, c2 = { padding: s2, margin: 0 }, l2 = ((_a = r2.scrollBody) == null ? void 0 : _a.value) ? typeof r2.scrollBody.value == `object` ? ne({ padding: r2.scrollBody.value.padding === true ? s2 : r2.scrollBody.value.padding, margin: r2.scrollBody.value.margin === true ? s2 : r2.scrollBody.value.margin }, c2) : c2 : { padding: 0, margin: 0 };
...
function Le(e2) {
  ...
  return S(() => {
    var _a;
    return (e2 == null ? void 0 : e2.value) || ((_a = t2.dir) == null ? void 0 : _a.value) || `ltr`;
  });
}
function Re(e2) {
...
function Ze(e2) {
  ...
  o(() => pe(e2), (e3) => {
    let n2 = false;
    try {
      n2 = !!(e3 == null ? void 0 : e3.closest(`[popover]:not(:popover-open)`));
    } catch {
    }
...
function $e(e2) {
  ...
  return { search: t2, handleTypeaheadSearch: (n2, r2) => {
    if (t2.value += n2, e2) e2(n2);
      ...
      let e3 = Q(), n3 = r2.map((e4) => {
        var _a, _b;
        return { ...e4, textValue: ((_a = e4.value) == null ? void 0 : _a.textValue) ?? ((_b = e4.ref.textContent) == null ? void 0 : _b.trim()) ?? `` };
      }), i2 = n3.find((t3) => t3.ref === e3), a2 = tt(n3.map((e4) => e4.textValue), t2.value, i2 == null ? void 0 : i2.textValue), o2 = n3.find((e4) => e4.textValue === a2);
      return o2 && o2.ref.focus(), o2 == null ? void 0 : o2.ref;
    }
  }, resetTypeahead: () => {
    t2.value = ``;
  } };
...
function rt() {
  ...
  return { add(t2) {
    let n2 = e2.value[0];
    t2 !== n2 && (n2 == null ? void 0 : n2.pause()), e2.value = it(e2.value, t2), e2.value.unshift(t2);
  }, remove(t2) {
    var _a;
    e2.value = it(e2.value, t2), (_a = e2.value[0]) == null ? void 0 : _a.resume();
  } };
}
function it(e2, t2) {
...
var ht = E({ __name: `FocusScope`, props: { loop: { type: Boolean, required: false, default: false }, trapped: { type: Boolean, required: false, default: false }, asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, emits: [`mountAutoFocus`, `unmountAutoFocus`], setup(e2, { emit: t2 }) {
  ...
  return (e3, t3) => (D(), F(u(K), { ref_key: `currentRef`, ref: i2, tabindex: `-1`, "as-child": e3.asChild, as: e3.as, onKeydown: l2 }, { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 8, [`as-child`, `as`]));
...
function Mt(e2) {
  return e2 == null ? void 0 : e2.querySelector(`[data-state=checked]`);
}
function Nt(e2, t2, n2) {
  return e2 === void 0 ? false : Array.isArray(e2) ? e2.some((e3) => Pt(e3, t2, n2)) : Pt(e2, t2, n2);
}
function Pt(e2, t2, n2) {
  return e2 === void 0 || t2 === void 0 ? false : typeof e2 == `string` ? e2 === t2 : typeof n2 == `function` ? n2(e2, t2) : typeof n2 == `string` ? (e2 == null ? void 0 : e2[n2]) === (t2 == null ? void 0 : t2[n2]) : ee(e2, t2);
}
...
var [Ht, Ut] = G(`ListboxRoot`), Wt = E({ __name: `ListboxRoot`, props: { modelValue: { type: null, required: false }, defaultValue: { type: null, required: false }, multiple: { type: Boolean, required: false }, orientation: { type: String, required: false, default: `vertical` }, dir: { type: String, required: false }, disabled: { type: Boolean, required: false }, selectionBehavior: { type: String, required: false, default: `toggle` }, highlightOnHover: { type: Boolean, required: false }, by: { type: [String, Function], required: false }, asChild: { type: Boolean, required: false }, as: { type: null, required: false }, name: { type: String, required: false }, required: { type: Boolean, required: false } }, emits: [`update:modelValue`, `highlight`, `entryFocus`, `leave`], setup(e2, { expose: t2, emit: n2 }) {
  ...
  function V2(e3, t3 = true) {
    e3 && (E2.value = e3, C2.value && E2.value.focus(), t3 && E2.value.scrollIntoView({ block: `nearest` }), i2(`highlight`, m2().find((t4) => t4.ref === e3)));
  }
  function H2(e3) {
    ...
    if (C2.value) {
      if (S2.value = true, k2.value) P2.trigger(e3);
        ...
        if (t3 && e3.key === `a` && a2.value) {
          let t4 = m2();
          w2.value = [...t4.map((e4) => e4.value)], e3.preventDefault(), V2(t4[t4.length - 1].ref);
        } else if (!t3) {
          let t4 = h2(e3.key, m2());
          t4 && V2(t4);
        }
  ...
  function ne2(e3) {
    let t3 = E2.value;
    (t3 == null ? void 0 : t3.isConnected) && (O2.value = t3), E2.value = null, i2(`leave`, e3);
  }
  function re2(e3) {
    var _a, _b;
    let t3 = new CustomEvent(`listbox.entryFocus`, { bubbles: false, cancelable: true });
    if ((_a = e3.currentTarget) == null ? void 0 : _a.dispatchEvent(t3), i2(`entryFocus`, t3), !t3.defaultPrevented) if (O2.value) V2(O2.value);
    else {
      let e4 = (_b = R2()) == null ? void 0 : _b[0];
      V2(e4);
    }
  }
  function ie2(e3) {
  ...
  function ae2(e3, t3) {
    ...
    if (!(k2.value || r2.selectionBehavior !== `replace` || !a2.value || !Array.isArray(w2.value)) && !((e3.altKey || e3.ctrlKey || e3.metaKey) && !e3.shiftKey) && e3.shiftKey) {
      let n3 = m2().filter((e4) => e4.ref.dataset.disabled !== ``), r3 = (_a = n3.find((e4) => e4.ref === t3)) == null ? void 0 : _a.value;
      if (e3.key === v2.END ? r3 = n3[n3.length - 1].value : e3.key === v2.HOME && (r3 = n3[0].value), !r3 || !x2.value) return;
  ...
  }, { immediate: true, deep: true }), t2({ highlightedElement: E2, highlightItem: H2, highlightFirstItem: G2, highlightSelected: oe2, getItems: m2 }), Ut({ modelValue: w2, onValueChange: T2, multiple: a2, orientation: c2, dir: y2, disabled: l2, highlightOnHover: s2, highlightedElement: E2, isVirtual: k2, virtualFocusHook: M2, virtualKeydownHook: P2, virtualHighlightHook: L2, by: r2.by, firstValue: x2, selectionBehavior: d2, focusable: C2, onLeave: ne2, onEnter: re2, changeHighlight: V2, onKeydownEnter: U2, onKeydownNavigation: ie2, onKeydownTypeAhead: W2, onCompositionStart: ee2, onCompositionEnd: te2, highlightFirstItem: G2 }), (e3, t3) => (D(), F(u(K), { ref_key: `primitiveElement`, ref: g2, as: e3.as, "as-child": e3.asChild, dir: u(y2), "data-disabled": u(l2) ? `` : void 0, onPointerleave: ne2, onFocusout: t3[0] || (t3[0] = async (e4) => {
    let t4 = e4.relatedTarget || e4.target;
    await N(), E2.value && u(_2) && !u(_2).contains(t4) && ne2(e4);
  ...
  return (e3, a2) => (D(), F(u(t2), null, { default: A(() => [n(u(K), { role: `listbox`, as: e3.as, "as-child": e3.asChild, tabindex: u(r2).focusable.value ? u(r2).highlightedElement.value ? `-1` : `0` : `-1`, "aria-orientation": u(r2).orientation.value, "aria-multiselectable": !!u(r2).multiple.value, "data-orientation": u(r2).orientation.value, onMousedown: a2[0] || (a2[0] = U((e4) => i2.value = true, [`left`])), onFocus: a2[1] || (a2[1] = (e4) => {
  ...
  return a(() => {
    var _a;
    return l2.value = (_a = i2.highlightedElement.value) == null ? void 0 : _a.id;
  }), _(() => {
    i2.focusable.value = false, setTimeout(() => {
      var _a;
      n2.autoFocus && ((_a = s2.value) == null ? void 0 : _a.focus());
    }, 1);
  }), x(() => {
    i2.focusable.value = true;
  }), (e3, t3) => (D(), F(u(K), { ref_key: `primitiveElement`, ref: o2, as: e3.as, "as-child": e3.asChild, value: u(r2), disabled: c2.value ? `` : void 0, "data-disabled": c2.value ? `` : void 0, "aria-disabled": c2.value ?? void 0, "aria-activedescendant": l2.value, type: `text`, onKeydown: [H(U(u(i2).onKeydownNavigation, [`prevent`]), [`down`, `up`, `home`, `end`]), H(u(i2).onKeydownEnter, [`enter`])], onInput: t3[0] || (t3[0] = (e4) => {
...
} }), [qt, Jt] = G(`ListboxGroup`), Yt = E({ __name: `ListboxGroup`, props: { asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, setup(e2) {
  let t2 = e2, n2 = J(void 0, `reka-listbox-group`);
  return Jt({ id: n2 }), (e3, r2) => (D(), F(u(K), y({ role: `group` }, t2, { "aria-labelledby": u(n2) }), { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 16, [`aria-labelledby`]));
} }), Xt = `listbox.select`, [Zt, Qt] = G(`ListboxItem`), $t = E({ __name: `ListboxItem`, props: { value: { type: null, required: true }, disabled: { type: Boolean, required: false }, asChild: { type: Boolean, required: false }, as: { type: null, required: false, default: `div` } }, emits: [`select`], setup(e2, { emit: t2 }) {
  ...
  async function h2(e3) {
    i2(`select`, e3), !(e3 == null ? void 0 : e3.defaultPrevented) && !p2.value && e3 && (l2.onValueChange(r2.value), l2.changeHighlight(c2.value));
  }
  function g2(e3) {
    Ee(Xt, h2, { originalEvent: e3, value: r2.value });
  }
  return Qt({ isSelected: f2 }), (e3, t3) => (D(), F(u(o2), { value: e3.value }, { default: A(() => [m([d2.value, f2.value], () => n(u(K), y({ id: u(a2) }, e3.$attrs, { ref: u(s2), role: `option`, tabindex: u(l2).focusable.value ? d2.value ? `0` : `-1` : -1, "aria-selected": f2.value, as: e3.as, "as-child": e3.asChild, disabled: p2.value ? `` : void 0, "data-disabled": p2.value ? `` : void 0, "data-highlighted": d2.value ? `` : void 0, "data-state": f2.value ? `checked` : `unchecked`, onClick: g2, onKeydown: H(U(g2, [`prevent`]), [`space`]), onPointermove: t3[0] || (t3[0] = () => {
    u(l2).highlightedElement.value !== u(c2) && u(l2).highlightOnHover.value && !u(l2).focusable.value && u(l2).changeHighlight(u(c2), false);
  ...
  X();
  let n2 = Zt();
  return (e3, r2) => u(n2).isSelected.value ? (D(), F(u(K), y({ key: 0, "aria-hidden": `true` }, t2), { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 16)) : B(`v-if`, true);
} });
function tn(e2, t2, n2) {
  ...
  function o2() {
    var _a, _b, _c;
    let o3;
    n2.key && ((_a = n2.debug) == null ? void 0 : _a.call(n2)) && (o3 = Date.now());
    let s2 = e2();
    if (!(s2.length !== r2.length || s2.some((e3, t3) => r2[t3] !== e3))) return i2;
    r2 = s2;
    let c2;
    if (n2.key && ((_b = n2.debug) == null ? void 0 : _b.call(n2)) && (c2 = Date.now()), i2 = t2(...s2), n2.key && ((_c = n2.debug) == null ? void 0 : _c.call(n2))) {
      ...
      console.info(`%c\u23F1 ${i3(t3, 5)} /${i3(e3, 5)} ms`, `
            font-size: .6rem;
            font-weight: bold;
            color: hsl(${Math.max(0, Math.min(120 - 120 * r3, 120))}deg 100% 31%);`, n2 == null ? void 0 : n2.key);
    }
    return (n2 == null ? void 0 : n2.onChange) && !(a2 && n2.skipInitialOnChange) && n2.onChange(i2), a2 = false, i2;
  }
...
var rn = (e2, t2) => Math.abs(e2 - t2) < 1.01, an = (e2, t2, n2) => {
  ...
  let a2 = new r2.ResizeObserver((t3) => {
    let r3 = () => {
      let e3 = t3[0];
      if (e3 == null ? void 0 : e3.borderBoxSize) {
  ...
  if (t2 == null ? void 0 : t2.borderBoxSize) {
  ...
  var i2, a2;
  let o2 = e2 + t2;
  (a2 = (_a = i2 = r2.scrollElement) == null ? void 0 : _a.scrollTo) == null || a2.call(i2, { [r2.options.horizontal ? `left` : `top`]: o2, behavior: n2 });
}, hn = class {
  constructor(e2) {
    this.unsubs = [], this.scrollElement = null, this.targetWindow = null, this.isScrolling = false, this.scrollState = null, this.measurementsCache = [], this.itemSizeCache = /* @__PURE__ */ new Map(), this.laneAssignments = /* @__PURE__ */ new Map(), this.pendingMeasuredCacheIndexes = [], this.prevLanes = void 0, this.lanesChangedFlag = false, this.lanesSettling = false, this.scrollRect = null, this.scrollOffset = null, this.scrollDirection = null, this.scrollAdjustments = 0, this.elementsCache = /* @__PURE__ */ new Map(), this.now = () => {
      var _a, _b, _c;
      var e3;
      return ((_c = (_b = e3 = (_a = this.targetWindow) == null ? void 0 : _a.performance) == null ? void 0 : _b.now) == null ? void 0 : _c.call(e3)) ?? Date.now();
      ...
      return { disconnect: () => {
        ...
        var _a;
        return (_a = t2()) == null ? void 0 : _a.observe(e4, { box: `border-box` });
      }, unobserve: (e4) => {
        var _a;
        return (_a = t2()) == null ? void 0 : _a.unobserve(e4);
      } };
      ...
      }, measureElement: pn, initialRect: { width: 0, height: 0 }, scrollMargin: 0, gap: 0, indexAttribute: `data-index`, initialMeasurementsCache: [], lanes: 1, isScrollingResetDelay: 150, enabled: true, isRtl: false, useScrollendEvent: false, useAnimationFrameWithResizeObserver: false, ...e3 };
    }, this.notify = (e3) => {
      var t2, n2;
      ...
      if (this.scrollElement !== e3) {
        ...
        this.scrollElement = e3, this.scrollElement && `ownerDocument` in this.scrollElement ? this.targetWindow = this.scrollElement.ownerDocument.defaultView : this.targetWindow = ((_a = this.scrollElement) == null ? void 0 : _a.window) ?? null, this.elementsCache.forEach((e4) => {
    ...
    }, this.getMeasurementOptions = tn(() => [this.options.count, this.options.paddingStart, this.options.scrollMargin, this.options.getItemKey, this.options.enabled, this.options.lanes], (e3, t2, n2, r2, i2, a2) => (this.prevLanes !== void 0 && this.prevLanes !== a2 && (this.lanesChangedFlag = true), this.prevLanes = a2, this.pendingMeasuredCacheIndexes = [], { count: e3, paddingStart: t2, scrollMargin: n2, getItemKey: r2, enabled: i2, lanes: a2 }), { key: false }), this.getMeasurements = tn(() => [this.getMeasurementOptions(), this.itemSizeCache], ({ count: e3, paddingStart: t2, scrollMargin: n2, getItemKey: r2, enabled: i2, lanes: a2 }, o2) => {
      ...
      let s2 = this.lanesSettling ? 0 : this.pendingMeasuredCacheIndexes.length > 0 ? Math.min(...this.pendingMeasuredCacheIndexes) : 0;
      this.pendingMeasuredCacheIndexes = [], this.lanesSettling && this.measurementsCache.length === e3 && (this.lanesSettling = false);
      let c2 = this.measurementsCache.slice(0, s2), l2 = Array(a2).fill(void 0);
      for (let e4 = 0; e4 < s2; e4++) {
        let t3 = c2[e4];
        t3 && (l2[t3.lane] = e4);
      }
      for (let i3 = s2; i3 < e3; i3++) {
        let e4 = r2(i3), a3 = this.laneAssignments.get(i3), s3, u2;
        if (a3 !== void 0 && this.options.lanes > 1) {
          s3 = a3;
          let e5 = l2[s3], r3 = e5 === void 0 ? void 0 : c2[e5];
          u2 = r3 ? r3.end + this.options.gap : t2 + n2;
        } else {
          let e5 = this.options.lanes === 1 ? c2[i3 - 1] : this.getFurthestMeasurement(c2, i3);
          u2 = e5 ? e5.end + this.options.gap : t2 + n2, s3 = e5 ? e5.lane : i3 % this.options.lanes, this.options.lanes > 1 && this.laneAssignments.set(i3, s3);
        }
        let d2 = o2.get(e4), f2 = typeof d2 == `number` ? d2 : this.options.estimateSize(i3), p2 = u2 + f2;
        c2[i3] = { index: i3, start: u2, size: f2, end: p2, key: e4, lane: s3 }, l2[s3] = i3;
      }
      return this.measurementsCache = c2, c2;
      ...
      let t2 = this.scrollState.index ?? ((_a = this.getVirtualItemForOffset(this.scrollState.lastTargetOffset)) == null ? void 0 : _a.index);
      ...
      let r2 = this.getOffsetForAlignment(e3, t2);
      this.scrollState = { index: null, align: t2, behavior: n2, startedAt: this.now(), lastTargetOffset: r2, stableFrames: 0 }, this._scrollToOffset(r2, { adjustments: void 0, behavior: n2 }), this.scheduleScrollReconcile();
      ...
      let n2 = this.getScrollOffset() + e3;
      this.scrollState = { index: null, align: `start`, behavior: t2, startedAt: this.now(), lastTargetOffset: n2, stableFrames: 0 }, this._scrollToOffset(n2, { adjustments: void 0, behavior: t2 }), this.scheduleScrollReconcile();
    }, this.getTotalSize = () => {
      var _a;
      let e3 = this.getMeasurements(), t2;
      if (e3.length === 0) t2 = this.options.paddingStart;
      else if (this.options.lanes === 1) t2 = ((_a = e3[e3.length - 1]) == null ? void 0 : _a.end) ?? 0;
      else {
...
var bn = E({ __name: `ListboxVirtualizer`, props: { options: { type: Array, required: true }, overscan: { type: Number, required: false }, estimateSize: { type: [Number, Function], required: false }, textContent: { type: Function, required: false } }, setup(e2) {
  ...
  let o2 = S(() => {
    ...
    return { item: e3, is: T(r3.type === O && Array.isArray(r3.children) ? r3.children[0] : r3, { key: `${e3.key}`, "data-index": e3.index, "aria-setsize": t2.options.length, "aria-posinset": e3.index + 1, style: { position: `absolute`, top: 0, left: 0, transform: `translateY(${e3.start}px)`, overflowAnchor: `none` } }) };
  }));
  r2.virtualFocusHook.on((e3) => {
    ...
    n3 === -1 ? r2.highlightFirstItem() : (e3 == null ? void 0 : e3.preventDefault(), s2.value.scrollToIndex(n3, { align: `start` }), requestAnimationFrame(() => {
      let t3 = Mt(i2.value);
      t3 && (r2.changeHighlight(t3), e3 && (t3 == null ? void 0 : t3.focus()));
    }));
  ...
  let d2 = de(``, 1e3), f2 = S(() => {
    let e3 = (e4) => t2.textContent ? t2.textContent(e4) : e4 == null ? void 0 : e4.toString().toLowerCase();
    return t2.options.map((t3, n3) => ({ index: n3, textContent: e3(t3) }));
  });
  function p2(e3, n3) {
    var _a, _b, _c, _d;
    if (!((_a = r2.firstValue) == null ? void 0 : _a.value) || !r2.multiple.value || !Array.isArray(r2.modelValue.value)) return;
    let i3 = (_b = a2().filter((e4) => e4.ref.dataset.disabled !== ``).find((e4) => e4.ref === r2.highlightedElement.value)) == null ? void 0 : _b.value;
    if (!i3) return;
    let o3 = null;
    switch (n3) {
      case `prev`:
      case `next`:
        ...
        break;
      case `first`:
        o3 = ke(t2.options, r2.firstValue.value, (_c = t2.options) == null ? void 0 : _c[0]);
        break;
      case `last`:
        o3 = ke(t2.options, r2.firstValue.value, (_d = t2.options) == null ? void 0 : _d[t2.options.length - 1]);
        break;
    }
  ...
  return r2.virtualKeydownHook.on((e3) => {
    ...
    if (n3 && e3.key === `a` && r2.multiple.value ? (e3.preventDefault(), r2.modelValue.value = [...t2.options], o3 = `last`) : e3.shiftKey && o3 && p2(e3, o3), [`first`, `last`].includes(o3)) {
      ...
      s2.value.scrollToIndex(n4), requestAnimationFrame(() => {
        let e4 = a2(), t3 = o3 === `first` ? e4[0] : e4[e4.length - 1];
        t3 && r2.changeHighlight(t3.ref);
      });
    } else if (!o3 && !n3) {
      d2.value += e3.key;
      let t3 = Number((_a = Q()) == null ? void 0 : _a.getAttribute(`data-index`)), n4 = f2.value[t3].textContent, a3 = tt(f2.value.map((e4) => e4.textContent ?? ``), d2.value, n4), o4 = f2.value.find((e4) => e4.textContent === a3);
  ...
  async function E2(e3) {
    var _a2, _b2;
    T2.value = e3, U2.value = ``, e3 ? (await N(), (_a2 = o2.value) == null ? void 0 : _a2.highlightSelected(), k2.value = true, (_b2 = M2.value) == null ? void 0 : _b2.focus()) : (k2.value = false, setTimeout(() => {
      !e3 && i2.resetSearchTermOnBlur && O2.trigger();
    }, 1));
  }
  let O2 = se(), k2 = I(false), j2 = I(false), M2 = I(), L2 = I(), R2 = S(() => {
    var _a2;
    return ((_a2 = o2.value) == null ? void 0 : _a2.highlightedElement) ?? void 0;
  }), B2 = I(/* @__PURE__ */ new Map()), V2 = I(/* @__PURE__ */ new Map()), { contains: H2 } = Re({ sensitivity: `base` }), U2 = I(``), W2 = S((e3) => {
    if (!U2.value || i2.ignoreFilter || j2.value) return { count: B2.value.size, items: (e3 == null ? void 0 : e3.items) ?? /* @__PURE__ */ new Map(), groups: (e3 == null ? void 0 : e3.groups) ?? new Set(V2.value.keys()) };
    let t3 = 0, n2 = /* @__PURE__ */ new Map(), r3 = /* @__PURE__ */ new Set();
    for (let [e4, r4] of B2.value) {
      let i3 = H2(r4, U2.value);
      n2.set(e4, i3 ? 1 : 0), i3 && t3++;
    }
  ...
  async function w2(e3) {
    var _a2, _b2;
    x2.value = e3, e3 ? (B2.value = b2.value || ``, await N(), (_a2 = o2.value) == null ? void 0 : _a2.highlightSelected(), E2.value = true, (_b2 = k2.value) == null ? void 0 : _b2.focus()) : (E2.value = false, B2.value = ``, setTimeout(() => {
      !e3 && i2.resetSearchTermOnBlur && T2.trigger();
    }, 1));
  }
  let T2 = se(), E2 = I(false), O2 = I(false), k2 = I(), j2 = I(), M2 = S(() => {
    var _a2;
    return ((_a2 = o2.value) == null ? void 0 : _a2.highlightedElement) ?? void 0;
  }), P2 = I(/* @__PURE__ */ new Map()), L2 = I(/* @__PURE__ */ new Map()), { contains: R2 } = Re({ sensitivity: `base` }), B2 = I(``), V2 = S((e3) => {
    if (!B2.value || i2.ignoreFilter || O2.value) return { count: P2.value.size, items: (e3 == null ? void 0 : e3.items) ?? /* @__PURE__ */ new Map(), groups: (e3 == null ? void 0 : e3.groups) ?? new Set(L2.value.keys()) };
    let t3 = 0, n2 = /* @__PURE__ */ new Map(), r3 = /* @__PURE__ */ new Set();
  ...
  function p2(e3) {
    ...
    i2.open.value ? i2.filterSearch.value = t3.value : (i2.onOpenChange(true), N(() => {
      t3.value && (i2.filterSearch.value = t3.value, s2.highlightFirstItem());
    })), a2.modelValue.value = t3.value;
  }
  function m2() {
  ...
  return _(() => {
    ...
    var _a;
    let e3 = Q();
    m2.value && (!e3 || e3 === document.body) && ((_a = o2.triggerElement.value) == null ? void 0 : _a.focus());
    ...
    var _a;
    ((_a = u(o2).parentElement.value) == null ? void 0 : _a.contains(e4.target)) && e4.preventDefault(), i2(`focusOutside`, e4);
    ...
    var _a;
    ((_a = u(o2).parentElement.value) == null ? void 0 : _a.contains(e4.target)) && e4.preventDefault(), i2(`pointerDownOutside`, e4);
  }) }, { default: A(() => [(D(), F(L(u(a2) === `popper` ? u(ve) : u(K)), y({ ...e3.$attrs, ...u(d2) }, { id: u(o2).contentId, ref: u(c2), "data-state": u(o2).open.value ? `open` : `closed`, "data-empty": s2.value ? `` : void 0, style: { display: r2.hideWhenEmpty && s2.value ? `none` : `flex`, flexDirection: `column`, outline: `none`, ...u(a2) === `popper` ? p2 : {} } }), { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 16, [`id`, `data-state`, `data-empty`, `style`]))]), _: 3 }, 8, [`disable-outside-pointer-events`])]), _: 3 })]), _: 3 }));
  ...
  function r2() {
    var _a;
    n2.filterSearch.value = ``, n2.inputElement.value && (n2.inputElement.value.value = ``, n2.inputElement.value.focus()), ((_a = n2.resetModelValueOnClear) == null ? void 0 : _a.value) && (n2.modelValue.value = n2.multiple.value ? [] : null);
  }
  return (e3, n3) => (D(), F(u(K), y({ type: e3.as === `button` ? `button` : void 0 }, t2, { tabindex: `-1`, onClick: r2 }), { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 16, [`type`]));
  ...
  return (t3, r3) => a2.value ? (D(), F(u(K), e(y({ key: 0 }, n2)), { default: A(() => [z(t3.$slots, `default`, {}, () => [r3[0] || (r3[0] = i(`No options`))])]), _: 3 }, 16)) : B(`v-if`, true);
} }), [Fn, In] = G(`ComboboxGroup`), Ln = E({ __name: `ComboboxGroup`, props: { asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, setup(e2) {
  ...
  function m2(e3) {
    ...
    if (!t3) return;
    let n3 = (_a = i2.parentElement.value) == null ? void 0 : _a.contains(t3), r3 = (_b = document.getElementById(i2.contentId)) == null ? void 0 : _b.contains(t3);
  ...
  return _(() => {
    ...
    let e3 = s2 == null ? void 0 : s2.id;
    e3 && (o2.allGroups.value.has(e3) ? (_a = o2.allGroups.value.get(e3)) == null ? void 0 : _a.add(a2) : o2.allGroups.value.set(e3, /* @__PURE__ */ new Set([a2])));
  }), x(() => {
    ...
    r2(`select`, t4), !t4.defaultPrevented && !u(o2).multiple.value && !e3.disabled && !u(o2).disabled.value && (t4.preventDefault(), u(o2).onOpenChange(false), u(o2).modelValue.value = n2.value);
  ...
  return n2.labelId || (n2.labelId = J(void 0, `reka-combobox-group-label`)), (e3, r2) => (D(), F(u(K), y(t2, { id: u(n2).labelId }), { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 16, [`id`]));
  ...
  let t2 = e2;
  return X(), (e3, n2) => (D(), F(u(K), y(t2, { "aria-hidden": `true` }), { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 16));
  ...
  }), (e3, r3) => (D(), F(u(K), y(t2, { ref: u(n2), type: e3.as === `button` ? `button` : void 0, tabindex: `-1`, "aria-label": `Show popup`, "aria-haspopup": `listbox`, "aria-expanded": u(i2).open.value, "aria-controls": u(i2).contentId, "data-state": u(i2).open.value ? `open` : `closed`, disabled: a2.value, "data-disabled": a2.value ? `` : void 0, "aria-disabled": a2.value ?? void 0, onClick: r3[0] || (r3[0] = (e4) => u(i2).onOpenChange(!u(i2).open.value)) }), { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 16, [`type`, `aria-expanded`, `aria-controls`, `data-state`, `disabled`, `data-disabled`, `aria-disabled`]));
} });
function Gn(e2) {
  let t2 = he({ nonce: I() });
  return S(() => {
    var _a;
    return (e2 == null ? void 0 : e2.value) || ((_a = t2.nonce) == null ? void 0 : _a.value);
  });
}
var Kn = E({ __name: `ComboboxViewport`, props: { nonce: { type: String, required: false }, asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, setup(e2) {
  ...
  return (e3, a3) => (D(), h(O, null, [n(u(K), y({ ...e3.$attrs, ...t2 }, { ref: u(r2), "data-reka-combobox-viewport": ``, role: `presentation`, style: { position: `relative`, flex: u(s2).isVirtual.value ? void 0 : 1, overflow: `auto` } }), { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 16, [`style`]), n(u(K), { as: `style`, nonce: u(o2) }, { default: A(() => a3[0] || (a3[0] = [i(` /* Hide scrollbars cross-browser and enable momentum scroll for touch devices */ [data-reka-combobox-viewport] { scrollbar-width:none; -ms-overflow-style: none; -webkit-overflow-scrolling: touch; } [data-reka-combobox-viewport]::-webkit-scrollbar { display: none; } `)])), _: 1, __: [0] }, 8, [`nonce`])], 64));
...
} }), [Jn, Yn] = G(`RovingFocusGroup`), Xn = E({ __name: `RovingFocusGroup`, props: { orientation: { type: String, required: false, default: void 0 }, dir: { type: String, required: false }, loop: { type: Boolean, required: false, default: false }, currentTabStopId: { type: [String, null], required: false }, defaultCurrentTabStopId: { type: String, required: false }, preventScrollOnEntryFocus: { type: Boolean, required: false, default: false }, asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, emits: [`entryFocus`, `update:currentTabStopId`], setup(e2, { expose: t2, emit: r2 }) {
...
var er = me($n), [tr, nr] = G([`MenuRoot`, `MenuSub`], `MenuContext`), [rr, ir] = G(`MenuRoot`), ar = E({ __name: `MenuRoot`, props: { open: { type: Boolean, required: false, default: false }, dir: { type: String, required: false }, modal: { type: Boolean, required: false, default: true } }, emits: [`update:open`], setup(e2, { emit: t2 }) {
  ...
  function E2(e3) {
    let t3 = je(e3, T2.value || Q(), C2.value, { loop: d2.value, arrowKeyOptions: `vertical`, dir: s2 == null ? void 0 : s2.dir.value, focus: false, attributeName: `[data-reka-collection-item]:not([data-disabled])` });
  ...
  function M2(e3) {
    var _a, _b;
    return _2.value === ((_a = g2.value) == null ? void 0 : _a.side) && Ot(e3, (_b = g2.value) == null ? void 0 : _b.area);
  }
  async function N2(e3) {
    var _a;
    i2(`openAutoFocus`, e3), !e3.defaultPrevented && (e3.preventDefault(), (_a = C2.value) == null ? void 0 : _a.focus({ preventScroll: true }));
  }
  function P2(e3) {
    var _a;
    if (e3.defaultPrevented) return;
    let t3 = e3.target, n2 = t3.closest(`[data-reka-menu-content]`) === e3.currentTarget, r3 = [`input`, `textarea`].includes(t3.tagName.toLowerCase()), i3 = e3.ctrlKey || e3.altKey || e3.metaKey, a3 = e3.key.length === 1, o2 = je(e3, Q(), C2.value, { loop: d2.value, arrowKeyOptions: `vertical`, dir: s2 == null ? void 0 : s2.dir.value, focus: true, attributeName: `[data-reka-collection-item]:not([data-disabled])` });
    if (o2) return o2 == null ? void 0 : o2.focus();
    if (e3.code === `Space`) return;
    let c3 = ((_a = b2.value) == null ? void 0 : _a.getItems()) ?? [];
  ...
  function L2(e3) {
    var _a, _b;
    ((_b = (_a = e3 == null ? void 0 : e3.currentTarget) == null ? void 0 : _a.contains) == null ? void 0 : _b.call(_a, e3.target)) || (window.clearTimeout(m2.value), p2.value = ``);
  }
  function R2(e3) {
    var _a;
    if (!kt(e3)) return;
    let t3 = e3.target, n2 = v2.value !== e3.clientX;
    ((_a = e3 == null ? void 0 : e3.currentTarget) == null ? void 0 : _a.contains(t3)) && n2 && (_2.value = e3.clientX > v2.value ? `right` : `left`, v2.value = e3.clientX);
  }
  function B2(e3) {
  ...
  return sr({ onItemEnter: (e3) => !!M2(e3), onItemLeave: (e3) => {
    var _a, _b;
    M2(e3) || ([`INPUT`, `TEXTAREA`].includes(((_a = Q()) == null ? void 0 : _a.tagName) || ``) || ((_b = C2.value) == null ? void 0 : _b.focus()), y2.value = null);
  ...
  async function l2(e3) {
    ...
    if (!(e3.defaultPrevented || !kt(e3))) {
      if (t2.disabled) r2.onItemLeave(e3);
        ...
        r2.highlightedElement.value = t3, [`INPUT`, `TEXTAREA`].includes(((_a = Q()) == null ? void 0 : _a.tagName) || ``) || t3.focus({ preventScroll: true });
      }
    }
  }
  ...
  return (e3, t3) => (D(), F(u(o2), { value: { textValue: e3.textValue } }, { default: A(() => [n(u(K), y({ ref: u(i2), role: `menuitem`, tabindex: `-1` }, e3.$attrs, { as: e3.as, "as-child": e3.asChild, "aria-disabled": e3.disabled || void 0, "data-disabled": e3.disabled ? `` : void 0, "data-highlighted": c2.value ? `` : void 0, onPointermove: l2, onPointerleave: d2, onFocus: t3[0] || (t3[0] = async (t4) => {
  ...
  return (e3, t3) => (D(), F(lr, y(n2, { ref: u(i2), onClick: l2, onPointerdown: t3[0] || (t3[0] = () => {
    ...
    var _a;
    await N(), !e4.defaultPrevented && (c2.value || ((_a = e4.currentTarget) == null ? void 0 : _a.click()));
...
} }), [dr, fr] = G([`MenuCheckboxItem`, `MenuRadioItem`], `MenuItemIndicatorContext`), pr = E({ __name: `MenuItemIndicator`, props: { forceMount: { type: Boolean, required: false }, asChild: { type: Boolean, required: false }, as: { type: null, required: false, default: `span` } }, setup(e2) {
  let t2 = dr({ modelValue: I(false) });
  return (e3, r2) => (D(), F(u(be), { present: e3.forceMount || u(wt)(u(t2).modelValue.value) || u(t2).modelValue.value === true }, { default: A(() => [n(u(K), { as: e3.as, "as-child": e3.asChild, "data-state": u(Tt)(u(t2).modelValue.value) }, { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 8, [`as`, `as-child`, `data-state`])]), _: 3 }, 8, [`present`]));
  ...
  let n2 = e2, r2 = t2, i2 = W(fe(n2, [`modelValue`])), a2 = q(n2, `modelValue`, r2);
...
} }), [vr, yr] = G(`MenuGroup`), br = E({ __name: `MenuGroup`, props: { asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, setup(e2) {
  let t2 = e2, n2 = J(void 0, `reka-menu-group`);
  return yr({ id: n2 }), (e3, r2) => (D(), F(u(K), y({ role: `group` }, t2, { "aria-labelledby": u(n2) }), { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 16, [`aria-labelledby`]));
} }), xr = E({ __name: `MenuLabel`, props: { asChild: { type: Boolean, required: false }, as: { type: null, required: false, default: `div` } }, setup(e2) {
  let t2 = e2, n2 = vr({ id: `` });
  return (e3, r2) => (D(), F(u(K), y(t2, { id: u(n2).id || void 0 }), { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 16, [`id`]));
  ...
  let n2 = t2;
  return (t3, r2) => (D(), F(u(ye), e(V(n2)), { default: A(() => [z(t3.$slots, `default`)]), _: 3 }, 16));
} }), [Cr, wr] = G(`MenuRadioGroup`), Tr = E({ __name: `MenuRadioGroup`, props: { modelValue: { type: null, required: false, default: `` }, asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, emits: [`update:modelValue`], setup(t2, { emit: n2 }) {
  let r2 = t2, i2 = n2, a2 = W(fe(r2, [`modelValue`])), o2 = q(r2, `modelValue`, i2);
  ...
  let n2 = e2, r2 = t2, i2 = W(fe(n2, [`value`])), { value: a2 } = f(n2), o2 = Cr(), s2 = S(() => o2.modelValue.value === (a2 == null ? void 0 : a2.value));
  ...
  let t2 = e2;
  return (e3, n2) => (D(), F(u(K), y(t2, { role: `separator`, "aria-orientation": `horizontal` }), { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 16));
} }), [Or, kr] = G(`MenuSub`), Ar = E({ __name: `MenuSub`, props: { open: { type: Boolean, required: false, default: void 0 } }, emits: [`update:open`], setup(e2, { emit: t2 }) {
  let n2 = e2, r2 = q(n2, `open`, t2, { defaultValue: false, passive: n2.open === void 0 }), i2 = tr(), a2 = I(), o2 = I();
  return p((e3) => {
    (i2 == null ? void 0 : i2.open.value) === false && (r2.value = false), e3(() => r2.value = false);
  ...
  return o2.contentId || (o2.contentId = J(void 0, `reka-menu-sub-content`)), (e3, t3) => (D(), F(u(be), { present: e3.forceMount || u(i2).open.value }, { default: A(() => [n(cr, y(u(r2), { id: u(o2).contentId, ref: u(c2), "aria-labelledby": u(o2).triggerId, align: `start`, side: u(a2).dir.value === `rtl` ? `left` : `right`, "disable-outside-pointer-events": false, "disable-outside-scroll": false, "trap-focus": false, onOpenAutoFocus: t3[0] || (t3[0] = U((e4) => {
    var _a;
    u(a2).isUsingKeyboardRef.value && ((_a = u(l2)) == null ? void 0 : _a.focus());
  }, [`prevent`])), onCloseAutoFocus: t3[1] || (t3[1] = U(() => {
  }, [`prevent`])), onFocusOutside: t3[2] || (t3[2] = (e4) => {
    var _a;
    if (e4.defaultPrevented) return;
    let t4 = (_a = u(s2).filterElement.value) == null ? void 0 : _a.contains(e4.target);
    ...
    var _a, _b, _c;
    let t4 = (_a = e4.currentTarget) == null ? void 0 : _a.contains(e4.target), n2 = u(St)[u(a2).dir.value].includes(e4.key);
    t4 && n2 && (u(i2).onOpenChange(false), u(s2).filterElement.value ? (u(s2).filterElement.value.focus(), u(s2).highlightedElement.value = u(o2).trigger.value, (_b = u(o2).trigger.value) == null ? void 0 : _b.scrollIntoView({ block: `nearest` })) : (_c = u(o2).trigger.value) == null ? void 0 : _c.focus(), e4.preventDefault());
  ...
  o(r2.open, (e3) => {
    var _a;
    e3 ? s2.activeSubmenuContext.value = { onOpenChange: r2.onOpenChange, trigger: a2.trigger } : ((_a = s2.activeSubmenuContext.value) == null ? void 0 : _a.trigger.value) === a2.trigger.value && (s2.activeSubmenuContext.value = void 0);
  });
  let c2 = I(null);
  ...
  async function f2(e3) {
    ...
    if (!kt(e3)) return;
    l2();
    let t3 = (_a = r2.content.value) == null ? void 0 : _a.getBoundingClientRect();
    if (t3 == null ? void 0 : t3.width) {
      let n2 = (_b = r2.content.value) == null ? void 0 : _b.dataset.side, i3 = n2 === `right`, a3 = i3 ? -5 : 5, o2 = t3[i3 ? `left` : `right`], c3 = t3[i3 ? `right` : `left`];
  ...
  async function p2(e3) {
    ...
    t2.disabled || n2 && e3.key === ` ` || xt[i2.dir.value].includes(e3.key) && (r2.onOpenChange(true), await N(), (_a = r2.content.value) == null ? void 0 : _a.focus(), e3.preventDefault());
  }
  return (e3, i3) => (D(), F(Zn, { "as-child": `` }, { default: A(() => [n(lr, y(t2, { id: u(a2).triggerId, ref: (e4) => {
    var _a;
    (_a = u(a2)) == null ? void 0 : _a.onTriggerChange(e4 == null ? void 0 : e4.$el);
...
} }), [Fr, Ir] = G(`ContextMenuRoot`), Lr = E({ inheritAttrs: false, __name: `ContextMenuRoot`, props: { pressOpenDelay: { type: Number, required: false, default: 700 }, dir: { type: String, required: false }, modal: { type: Boolean, required: false, default: true } }, emits: [`update:open`], setup(e2, { emit: t2 }) {
...
var Zr = E({ inheritAttrs: false, __name: `ContextMenuTrigger`, props: { disabled: { type: Boolean, required: false, default: false }, asChild: { type: Boolean, required: false }, as: { type: null, required: false, default: `span` } }, setup(e2) {
  ...
  async function m2(e3) {
    t2.value || (await N(), Xr(e3) && !e3.defaultPrevented && (l2(), c2.value = window.setTimeout(() => d2(e3), a2.pressOpenDelay.value)));
  }
  ...
  }), (e3, i3) => (D(), h(O, null, [n(u(Zn), { as: `template`, reference: s2.value }, null, 8, [`reference`]), n(u(K), y({ ref: u(r2), as: e3.as, "as-child": e3.asChild, "data-state": u(a2).open.value ? `open` : `closed`, "data-disabled": u(t2) ? `` : void 0, style: { WebkitTouchCallout: `none`, pointerEvents: `auto` } }, e3.$attrs, { onContextmenu: p2, onPointerdown: m2, onPointermove: g2, onPointercancel: g2, onPointerup: g2 }), { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 16, [`as`, `as-child`, `data-state`, `data-disabled`])], 64));
} }), [Qr, $r] = G(`PopoverRoot`), ei = E({ __name: `PopoverRoot`, props: { defaultOpen: { type: Boolean, required: false, default: false }, open: { type: Boolean, required: false, default: void 0 }, modal: { type: Boolean, required: false, default: false } }, emits: [`update:open`], setup(e2, { emit: t2 }) {
  ...
  X();
  let n2 = Qr();
  return (e3, r2) => (D(), F(u(K), { type: e3.as === `button` ? `button` : void 0, as: e3.as, "as-child": t2.asChild, onClick: r2[0] || (r2[0] = (e4) => u(n2).onOpenChange(false)) }, { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 8, [`type`, `as`, `as-child`]));
  ...
  let r2 = e2, i2 = t2, a2 = W(fe(r2, `trapFocus`, `disableOutsidePointerEvents`)), { forwardRef: o2 } = X(), s2 = Qr();
  ...
  return Ze(c2), (e3, t3) => (D(), F(ii, y(u(o2), { ref: u(s2), "trap-focus": u(i2).open.value, "disable-outside-pointer-events": ``, onCloseAutoFocus: t3[0] || (t3[0] = U((e4) => {
    var _a;
    r2(`closeAutoFocus`, e4), a2.value || ((_a = u(i2).triggerElement.value) == null ? void 0 : _a.focus());
  ...
  return (e3, t3) => (D(), F(ii, y(u(s2), { "trap-focus": false, "disable-outside-pointer-events": false, onCloseAutoFocus: t3[0] || (t3[0] = (e4) => {
    var _a;
    r2(`closeAutoFocus`, e4), e4.defaultPrevented || (a2.value || ((_a = u(i2).triggerElement.value) == null ? void 0 : _a.focus()), e4.preventDefault()), a2.value = false, o2.value = false;
    ...
    let t4 = e4.target;
    ((_a = u(i2).triggerElement.value) == null ? void 0 : _a.contains(t4)) && e4.preventDefault(), e4.detail.originalEvent.type === `focusin` && o2.value && e4.preventDefault();
  }) }), { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 16));
  ...
  }), (e3, a3) => (D(), F(L(u(r2).hasCustomAnchor.value ? u(K) : u(xe)), { "as-child": `` }, { default: A(() => [n(u(K), { id: u(r2).triggerId, ref: u(i2), type: e3.as === `button` ? `button` : void 0, "aria-haspopup": `dialog`, "aria-expanded": u(r2).open.value, "aria-controls": u(r2).contentId, "data-state": u(r2).open.value ? `open` : `closed`, as: e3.as, "as-child": t2.asChild, onClick: u(r2).onOpenToggle }, { default: A(() => [z(e3.$slots, `default`)]), _: 3 }, 8, [`id`, `type`, `aria-expanded`, `aria-controls`, `data-state`, `as`, `as-child`, `onClick`])]), _: 3 }));
  ...
  let r2 = t2, i2 = _e(n2);
  return X(), (t3, n3) => (D(), F(u(mr), e(V({ ...r2, ...u(i2) })), { default: A(() => [z(t3.$slots, `default`)]), _: 3 }, 16));
} }), [fi, pi] = G(`DropdownMenuRoot`), mi = E({ __name: `DropdownMenuRoot`, props: { defaultOpen: { type: Boolean, required: false }, open: { type: Boolean, required: false, default: void 0 }, dir: { type: String, required: false }, modal: { type: Boolean, required: false, default: true } }, emits: [`update:open`], setup(e2, { emit: t2 }) {
  let n2 = e2, r2 = t2;
  X();
  ...
  function a2(e3) {
    e3.defaultPrevented || (i2.value || setTimeout(() => {
      var _a;
      (_a = r2.triggerElement.value) == null ? void 0 : _a.focus();
    }, 0), i2.value = false, e3.preventDefault());
  }
  return r2.contentId || (r2.contentId = J(void 0, `reka-dropdown-menu-content`)), (e3, t3) => {
    var _a;
    return D(), F(u(_r), y(u(n2), { id: u(r2).contentId, "aria-labelledby": (_a = u(r2)) == null ? void 0 : _a.triggerId, style: { "--reka-dropdown-menu-content-transform-origin": `var(--reka-popper-transform-origin)`, "--reka-dropdown-menu-content-available-width": `var(--reka-popper-available-width)`, "--reka-dropdown-menu-content-available-height": `var(--reka-popper-available-height)`, "--reka-dropdown-menu-trigger-width": `var(--reka-popper-anchor-width)`, "--reka-dropdown-menu-trigger-height": `var(--reka-popper-anchor-height)` }, onCloseAutoFocus: a2, onInteractOutside: t3[0] || (t3[0] = (e4) => {
      var _a2;
      if (e4.defaultPrevented) return;
      let t4 = e4.detail.originalEvent, n3 = t4.button === 0 && t4.ctrlKey === true, a3 = t4.button === 2 || n3;
      (!u(r2).modal.value || a3) && (i2.value = true), ((_a2 = u(r2).triggerElement.value) == null ? void 0 : _a2.contains(e4.target)) && e4.preventDefault();
  ...
  a(() => {
    var _a;
    return p2.value = (_a = s2.highlightedElement.value) == null ? void 0 : _a.id;
  }), _(() => {
    s2.onFilterElementChange(d2.value), setTimeout(() => {
      var _a;
      n2.autoFocus && (!c2 || i2.isUsingKeyboardRef.value) && ((_a = d2.value) == null ? void 0 : _a.focus());
    }, 1);
  }), x(() => {
  ...
  return (e3, t3) => (D(), F(u(K), { ref_key: `primitiveElement`, ref: l2, as: e3.as, "as-child": e3.asChild, value: u(r2), disabled: f2.value ? `` : void 0, "data-disabled": f2.value ? `` : void 0, "aria-disabled": f2.value ? true : void 0, "aria-activedescendant": p2.value, type: `text`, role: `searchbox`, onInput: m2, onKeydown: h2 }, { default: A(() => [z(e3.$slots, `default`, { modelValue: u(r2) })]), _: 3 }, 8, [`as`, `as-child`, `value`, `disabled`, `data-disabled`, `aria-disabled`, `aria-activedescendant`]));
  ...
  }), r2.triggerId || (r2.triggerId = J(void 0, `reka-dropdown-menu-trigger`)), (e3, a3) => (D(), F(u(Zn), { "as-child": `` }, { default: A(() => [n(u(K), { id: u(r2).triggerId, ref: u(i2), type: e3.as === `button` ? `button` : void 0, "as-child": t2.asChild, as: e3.as, "aria-haspopup": `menu`, "aria-expanded": u(r2).open.value, "aria-controls": u(r2).open.value ? u(r2).contentId : void 0, "data-disabled": e3.disabled ? `` : void 0, disabled: e3.disabled, "data-state": u(r2).open.value ? `open` : `closed`, onClick: a3[0] || (a3[0] = async (t3) => {
    var _a;
    !e3.disabled && t3.button === 0 && t3.ctrlKey === false && ((_a = u(r2)) == null ? void 0 : _a.onOpenToggle(), await N(), u(r2).open.value && t3.preventDefault());
  ...
  let n2 = t2;
  return X(), (t3, r2) => (D(), F(u(Se), e(V(n2)), { default: A(() => [z(t3.$slots, `default`)]), _: 3 }, 16));
} }), [Ai, ji] = G(`HoverCardRoot`), Mi = E({ __name: `HoverCardRoot`, props: { defaultOpen: { type: Boolean, required: false, default: false }, open: { type: Boolean, required: false, default: void 0 }, openDelay: { type: Number, required: false, default: 700 }, closeDelay: { type: Number, required: false, default: 300 } }, emits: [`update:open`], setup(e2, { emit: t2 }) {
...
var Fi = E({ __name: `HoverCardContentImpl`, props: { side: { type: null, required: false }, sideOffset: { type: Number, required: false }, sideFlip: { type: Boolean, required: false }, align: { type: null, required: false }, alignOffset: { type: Number, required: false }, alignFlip: { type: Boolean, required: false }, avoidCollisions: { type: Boolean, required: false }, collisionBoundary: { type: null, required: false }, collisionPadding: { type: [Number, Object], required: false }, arrowPadding: { type: Number, required: false }, hideShiftedArrow: { type: Boolean, required: false }, sticky: { type: String, required: false }, hideWhenDetached: { type: Boolean, required: false }, positionStrategy: { type: String, required: false }, updatePositionStrategy: { type: String, required: false }, disableUpdateOnLayoutShift: { type: Boolean, required: false }, prioritizePosition: { type: Boolean, required: false }, reference: { type: null, required: false }, asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, emits: [`escapeKeyDown`, `pointerDownOutside`, `focusOutside`, `interactOutside`], setup(e2, { emit: t2 }) {
  let r2 = e2, i2 = t2, a2 = W(r2), { forwardRef: o2, currentElement: s2 } = X(), c2 = Ai(), { isPointerInTransit: l2, onPointerExit: d2 } = ge(c2.triggerElement, s2);
  ae(c2.isPointerInTransitRef, l2, { direction: `rtl` }), d2(() => {
    c2.onClose();
  });
  let f2 = I(false), m2;
  p((e3) => {
  ...
  function h2() {
    f2.value = false, c2.isPointerDownOnContentRef.value = false, N(() => {
      var _a;
      ((_a = document.getSelection()) == null ? void 0 : _a.toString()) !== `` && (c2.hasSelectionRef.value = true);
    });
  }
  return _(() => {
    s2.value && (document.addEventListener(`pointerup`, h2), Pi(s2.value).forEach((e3) => e3.setAttribute(`tabindex`, `-1`)));
  }), x(() => {

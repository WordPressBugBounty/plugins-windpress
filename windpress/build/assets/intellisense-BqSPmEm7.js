...
import { a as n, i as r, n as i, t as a } from "./default-map-Yw_evXzB.js";
import { a as o, i as s, l as c, n as l, o as u, r as d } from "./cssesc-BusMg9uA.js";
import { t as f } from "./adobe-css-tools-Buy25uqI.js";
import { n as p, t as m } from "./dlv.umd-BDMHJZds.js";
var ee = t(((e26, t2) => {
  var n2 = u(), r2 = s(), i2 = o();
...
async function g({ entrypoint: e26 = `/main.css`, volume: t2 = {}, ...a2 } = {}) {
  ...
  }), a2 = { entrypoint: e26, volume: o2, ...a2, parser: a2.strict ? h.default : null }, a2.volume[a2.entrypoint] = (await i(a2)).css, n(a2.volume[a2.entrypoint], { ...a2, loadModule: async (e27, t3, n2) => c(e27, t3, n2, a2.volume), loadStylesheet: async (e27, t3) => r(e27, t3, a2.volume) });
}
var ne = 48, _ = 57;
function re(e26, t2) {
...
at(`margin`), at(`padding`), at(`scroll-margin`), at(`scroll-padding`), at(`border`, `top-width`, `right-width`, `bottom-width`, `left-width`), at(`border`, `top-style`, `right-style`, `bottom-style`, `left-style`), at(`border`, `top-color`, `right-color`, `bottom-color`, `left-color`), new a((e26) => {
  let t2 = [];
  return ge(Ie(e26), (e27) => {
    if (!(e27.kind !== `function` || e27.value !== `var`)) return ge(e27.nodes, (e28) => {
      e28.kind !== `word` || e28.value[0] !== `-` || e28.value[1] !== `-` || t2.push(e28.value);
    }), he.Skip;
  }), t2;
});
var st = (function(e26) {
...
[...Object.keys(vl.default).map((e26) => e26.toLowerCase())];

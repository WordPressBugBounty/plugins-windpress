...
import { n as r, t as i } from "./lib-DaZz88T4.js";
import { n as a, t as o } from "./dist-CxnnVdIg.js";
import { t as s } from "./path-browserify-CRIrsyPl.js";
import { c, n as l, r as u, s as d, t as f } from "./cssesc-CBKzJz-F.js";
import { t as p } from "./dlv.umd-Dp2k9EC7.js";
var m = t(((e2) => {
...
var T = t(((e2, t2) => {
  ...
  e2.__esModule = true, e2.unesc = e2.stripComments = e2.resolveMaxNestingDepth = e2.getProp = e2.ensureObject = e2.MAX_NESTING_DEPTH = void 0, e2.unesc = r2(T()).default, e2.getProp = r2(ee()).default, e2.ensureObject = r2(E()).default, e2.stripComments = r2(D()).default;
  var t2 = n2(O());
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var S2 = e2.default = (function(e3) {
    ...
    return r2.getQuotedValue = function(e4) {
      ...
      t3 === void 0 && (t3 = e4), n4 === void 0 && (n4 = w2);
      ...
      return t3.push(this._stringFor(`qualifiedAttribute`, `attribute`)), this.operator && (this.value || this.value === ``) && (t3.push(this._stringFor(`operator`)), t3.push(this._stringFor(`value`)), t3.push(this._stringFor(`insensitiveFlag`, `insensitive`, function(t4, n4) {
        return t4.length > 0 && !e4.quoted && n4.before.length === 0 && !(e4.spaces.value && e4.spaces.value.after) && (n4.before = ` `), w2(t4, n4);
...
`), g2 = _2.length - 1, g2 > 0 ? (y2 = o3 + g2, b2 = v2 - _2[g2].length) : (y2 = o3, b2 = a3), S2 = t2.comment, o3 = y2, p2 = y2, f3 = v2 - b2) : l3 === t2.slash ? (v2 = s3, S2 = l3, p2 = o3, f3 = s3 - a3, c3 = v2 + 1) : (v2 = u2(r3, s3), S2 = t2.word, p2 = o3, f3 = v2 - a3), c3 = v2 + 1;
  ...
  e2.__esModule = true, e2.default = void 0;
  var n2 = S2(te()), r2 = S2(ne()), i2 = S2(re()), a2 = S2(ie()), o2 = S2(ae()), s2 = S2(oe()), c2 = S2(se()), l2 = S2(ce()), u2 = x2(le()), d2 = S2(ue()), f2 = S2(de()), p2 = S2(fe()), m2 = S2(pe()), h2 = x2(he()), g2 = x2(me()), _2 = x2(j()), v2 = k(), y2, b2;
  function x2(e3, t3) {
    if (typeof WeakMap == `function`) var n3 = /* @__PURE__ */ new WeakMap(), r3 = /* @__PURE__ */ new WeakMap();
  ...
  function C2(e3, t3) {
    for (var n3 = 0; n3 < t3.length; n3++) {
      var r3 = t3[n3];
      r3.enumerable = r3.enumerable || false, r3.configurable = true, `value` in r3 && (r3.writable = true), Object.defineProperty(e3, T2(r3.key), r3);
    }
  }
  ...
  e2.default = (function() {
    function e3(e4, t4) {
      ...
      var i3 = ge2(this.tokens[0], this.tokens[this.tokens.length - 1]);
    ...
    return t3._errorGenerator = function() {
        ...
        switch (l3[h2.FIELDS.TYPE]) {
          ...
          case g2.comment:
            if (s3) if (c3 || f3 && f3[h2.FIELDS.TYPE] === g2.space || s3 === `insensitive`) {
              var ee3 = (0, v2.getProp)(r3, `spaces`, s3, `after`) || ``, E3 = (0, v2.getProp)(r3, `raws`, `spaces`, s3, `after`) || ee3;
              (0, v2.ensureObject)(r3, `raws`, `spaces`, s3), r3.raws.spaces[s3].after = E3 + d3;
            } else {
              var D3 = r3[s3] || ``, O3 = (0, v2.getProp)(r3, `raws`, s3) || D3;
              (0, v2.ensureObject)(r3, `raws`), r3.raws[s3] = O3 + d3;
            }
            else o3 += d3;
            break;
          default:
      ...
      if (this.position++, e4 && e4.type === _2.PSEUDO) {
        ...
        try {
          for (this.nestingDepth > this.maxNestingDepth && this.error(`Cannot parse selector: nesting depth exceeds the maximum of ` + this.maxNestingDepth + `.`, { index: this.currToken[h2.FIELDS.START_POS] }); this.position < this.tokens.length && t4; ) this.currToken[h2.FIELDS.TYPE] === g2.openParenthesis && t4++, this.currToken[h2.FIELDS.TYPE] === g2.closeParenthesis && t4--, t4 ? this.parse() : (this.current.source.end = A2(this.currToken), this.current.parent.source.end = A2(this.currToken), this.position++);
        } finally {
          this.nestingDepth--;
        }
        this.current = i3;
      ...
      if (this.currToken[h2.FIELDS.TYPE] === g2.word) this.splitWord(false, function(r3, i3) {
        t4 += r3, e4.newNode(new l2.default({ value: t4, source: ge2(n3, e4.currToken), sourceIndex: n3[h2.FIELDS.START_POS] })), i3 > 1 && e4.nextToken && e4.nextToken[h2.FIELDS.TYPE] === g2.openParenthesis && e4.error(`Misplaced parenthesis.`, { index: e4.nextToken[h2.FIELDS.START_POS] });
      });
      ...
      var u3 = _e2(a3, `.`).filter(function(e5) {
        var t5 = a3[e5 - 1] === `\\`, n4 = /^\d+\.\d+%$/.test(a3);
        return !t5 && !n4;
      }), d3 = _e2(a3, `#`).filter(function(e5) {
        return a3[e5 - 1] !== `\\`;
      }), f3 = _e2(a3, `#{`);
      f3.length && (d3 = d3.filter(function(e5) {
        return !~f3.indexOf(e5);
      }));
      var p3 = (0, m2.default)(ve2([0].concat(u3, d3)));
      ...
      return -1;
    }, w2(e3, [{ key: `currToken`, get: function() {
  ...
  var t2 = p2(le()), n2 = p2(re()), r2 = p2(de()), i2 = p2(ie()), a2 = p2(ae()), o2 = p2(fe()), s2 = p2(ce()), c2 = p2(te()), l2 = p2(ne()), u2 = p2(se()), d2 = p2(oe()), f2 = p2(ue());
  function p2(e3) {
    return e3 && e3.__esModule ? e3 : { default: e3 };
  }
  ...
  var n2 = Ee();
  t2.exports = { objectify: we(), parse: Se(), async: n2, sync: De() };
})), F = e(be()), ke = e(xe()), Ae = e(Oe(), 1), je = Ae.default;
Ae.default.objectify, Ae.default.parse, Ae.default.async, Ae.default.sync;
function Me(e2) {
  return Array.isArray(e2) ? e2.flatMap((e3) => l([(0, ke.default)({ bubble: [`screen`] })]).process(e3, { parser: je }).root.nodes) : Me([e2]);
}
function I(e2) {
...
function He(e2, { loose: t2 = false } = {}) {
  ...
  let r2 = e2.match(Be) ?? e2.match(Ve);
...
function Ue({ mode: e2, color: t2, alpha: n2 }) {
  let r2 = n2 !== void 0;
...
function We(e2, t2, n2) {
  ...
  let r2 = He(e2, { loose: true });
  return r2 === null ? n2 : Ue({ ...r2, alpha: t2 });
}
function z({ color: e2, property: t2, variable: n2 }) {
  ...
  let i2 = He(e2);
  return i2 === null || i2.alpha !== void 0 ? Object.fromEntries(r2.map((t3) => [t3, e2])) : { [n2]: `1`, ...Object.fromEntries(r2.map((e3) => [e3, Ue({ ...i2, alpha: `var(${n2}, 1)` })])) };
}
var Ge = 97, Ke = 122, qe = 65, Je = 90, Ye = 101, Xe = 69, Ze = 48, Qe = 57, $e = 43, et = 45, tt = 42, nt = 47, rt = 40, it = 41, at = 44, ot = 32, st = 37, ct = [`calc`, `min`, `max`, `clamp`, `mod`, `rem`, `sin`, `cos`, `tan`, `asin`, `acos`, `atan`, `atan2`, `pow`, `sqrt`, `hypot`, `log`, `exp`, `round`];
function lt(e2) {
  if (!ct.some((t3) => e2.includes(t3))) return e2;
  let t2 = ``, n2 = [], r2 = null, i2 = null;
  for (let a2 = 0; a2 < e2.length; a2++) {
    let o2 = e2.charCodeAt(a2);
    if (o2 >= Ze && o2 <= Qe || r2 !== null && (o2 === st || o2 >= Ge && o2 <= Ke || o2 >= qe && o2 <= Je) ? r2 = a2 : (i2 = r2, r2 = null), o2 === rt) {
      t2 += e2[a2];
      let r3 = a2;
      for (let t3 = a2 - 1; t3 >= 0; t3--) {
        let n3 = e2.charCodeAt(t3);
        if (n3 >= Ze && n3 <= Qe) r3 = t3;
        else if (n3 >= Ge && n3 <= Ke) r3 = t3;
        else break;
      }
      ...
      n2.unshift(false);
      continue;
    } else if (o2 === it) t2 += e2[a2], n2.shift();
    else if (o2 === at && n2[0]) {
      t2 += `, `;
      continue;
    } else if (o2 === ot && n2[0] && t2.charCodeAt(t2.length - 1) === ot) continue;
    else if ((o2 === $e || o2 === tt || o2 === nt || o2 === et) && n2[0]) {
      let n3 = t2.trimEnd(), r3 = n3.charCodeAt(n3.length - 1), o3 = n3.charCodeAt(n3.length - 2), s2 = e2.charCodeAt(a2 + 1);
      if ((r3 === Ye || r3 === Xe) && o3 >= Ze && o3 <= Qe) {
        t2 += e2[a2];
        continue;
      } else if (r3 === $e || r3 === tt || r3 === nt || r3 === et) {
        t2 += e2[a2];
        continue;
      } else if (r3 === rt || r3 === at) {
        t2 += e2[a2];
        continue;
      } else e2.charCodeAt(a2 - 1) === ot ? t2 += `${e2[a2]} ` : r3 >= Ze && r3 <= Qe || s2 >= Ze && s2 <= Qe || r3 === it || s2 === rt || s2 === $e || s2 === tt || s2 === nt || s2 === et || i2 !== null && i2 === a2 - 1 ? t2 += ` ${e2[a2]} ` : t2 += e2[a2];
    } else t2 += e2[a2];
  }
  return t2;
}
...
var ut = /* @__PURE__ */ new Set([`inset`, `inherit`, `initial`, `revert`, `unset`]), dt = /\ +(?![^(]*\))/g, ft = /^-?(\d+|\.\d+)(.*?)$/g;
function pt(e2) {
  return B(e2, `,`).map((e3) => {
    let t2 = e3.trim(), n2 = { raw: t2 }, r2 = t2.split(dt), i2 = /* @__PURE__ */ new Set();
    for (let e4 of r2) ft.lastIndex = 0, !i2.has(`KEYWORD`) && ut.has(e4) ? (n2.keyword = e4, i2.add(`KEYWORD`)) : ft.test(e4) ? i2.has(`X`) ? i2.has(`Y`) ? i2.has(`BLUR`) ? i2.has(`SPREAD`) || (n2.spread = e4, i2.add(`SPREAD`)) : (n2.blur = e4, i2.add(`BLUR`)) : (n2.y = e4, i2.add(`Y`)) : (n2.x = e4, i2.add(`X`)) : n2.color ? (n2.unknown || (n2.unknown = []), n2.unknown.push(e4)) : n2.color = e4;
...
var ht = [`min`, `max`, `clamp`, `calc`];
function gt(e2) {
  return ht.some((t2) => RegExp(`^${t2}\\(.*\\)`).test(e2));
}
var _t = /* @__PURE__ */ new Set([`scroll-timeline-name`, `timeline-scope`, `view-timeline-name`, `font-palette`, `anchor-name`, `anchor-scope`, `position-anchor`, `position-try-options`, `scroll-timeline`, `animation-timeline`, `view-timeline`, `position-try`]);
function V(e2, t2 = null, n2 = true) {
  let r2 = t2 && _t.has(t2.property);
  return e2.startsWith(`--`) && !r2 ? `var(${e2})` : e2.includes(`url(`) ? e2.split(/(url\(.*?\))/g).filter(Boolean).map((e3) => /^url\(.*?\)$/.test(e3) ? e3 : V(e3, t2, false)).join(``) : (e2 = e2.replace(/([^\\])_+/g, (e3, t3) => t3 + ` `.repeat(e3.length - 1)).replace(/^_/g, ` `).replace(/\\_/g, `_`), n2 && (e2 = e2.trim()), e2 = lt(e2), e2);
}
function H(e2) {
...
function yt(e2) {
  return !isNaN(Number(e2)) || gt(e2);
}
function bt(e2) {
  return e2.endsWith(`%`) && yt(e2.slice(0, -1)) || gt(e2);
}
var xt = `(?:${`cm.mm.Q.in.pc.pt.px.em.ex.ch.rem.lh.rlh.vw.vh.vmin.vmax.vb.vi.svw.svh.lvw.lvh.dvw.dvh.cqw.cqh.cqi.cqb.cqmin.cqmax`.split(`.`).join(`|`)})`;
function St(e2) {
  return e2 === `0` || RegExp(`^[+-]?[0-9]*.?[0-9]+(?:[eE][+-]?[0-9]+)?${xt}$`).test(e2) || gt(e2);
}
var Ct = /* @__PURE__ */ new Set([`thin`, `medium`, `thick`]);
function wt(e2) {
  return Ct.has(e2);
}
function Tt(e2) {
...
function Et(e2) {
  let t2 = 0;
  return B(e2, `_`).every((e3) => (e3 = V(e3), e3.startsWith(`var(`) ? true : He(e3, { loose: true }) === null ? false : (t2++, true))) ? t2 > 0 : false;
}
function Dt(e2) {
  let t2 = 0;
  return B(e2, `,`).every((e3) => (e3 = V(e3), e3.startsWith(`var(`) ? true : vt(e3) || kt(e3) || [`element(`, `image(`, `cross-fade(`, `image-set(`].some((t3) => e3.startsWith(t3)) ? (t2++, true) : false)) ? t2 > 0 : false;
}
var Ot = /* @__PURE__ */ new Set([`conic-gradient`, `linear-gradient`, `radial-gradient`, `repeating-conic-gradient`, `repeating-linear-gradient`, `repeating-radial-gradient`]);
function kt(e2) {
  e2 = V(e2);
  for (let t2 of Ot) if (e2.startsWith(`${t2}(`)) return true;
  return false;
}
var At = /* @__PURE__ */ new Set([`center`, `top`, `right`, `bottom`, `left`]);
function jt(e2) {
  let t2 = 0;
  return B(e2, `_`).every((e3) => (e3 = V(e3), e3.startsWith(`var(`) ? true : At.has(e3) || St(e3) || bt(e3) ? (t2++, true) : false)) ? t2 > 0 : false;
}
function Mt(e2) {
  let t2 = 0;
  return B(e2, `,`).every((e3) => (e3 = V(e3), e3.startsWith(`var(`) ? true : e3.includes(` `) && !/(['"])([^"']+)\1/g.test(e3) || /^\d/g.test(e3) ? false : (t2++, true))) ? t2 > 0 : false;
}
var Nt = /* @__PURE__ */ new Set([`serif`, `sans-serif`, `monospace`, `cursive`, `fantasy`, `system-ui`, `ui-serif`, `ui-sans-serif`, `ui-monospace`, `ui-rounded`, `math`, `emoji`, `fangsong`]);
function Pt(e2) {
  return Nt.has(e2);
}
var Ft = /* @__PURE__ */ new Set([`xx-small`, `x-small`, `small`, `medium`, `large`, `x-large`, `xx-large`, `xxx-large`]);
function It(e2) {
  return Ft.has(e2);
}
var Lt = /* @__PURE__ */ new Set([`larger`, `smaller`]);
function Rt(e2) {
  return Lt.has(e2);
}
function zt(e2) {
...
function Bt(e2) {
  ...
  return B(e2, `,`).every((e3) => {
    ...
    return n2.length === 1 && t2.includes(n2[0]) ? true : n2.length !== 1 && n2.length !== 2 ? false : n2.every((e4) => St(e4) || bt(e4) || e4 === `auto`);
  });
}
var Vt = { optimizeUniversalDefaults: false, generalizedModifiers: true, disableColorOpacityUtilitiesByDefault: false, relativeContentPathsByDefault: false }, Ht = { future: [`hoverOnlyWhenSupported`, `respectDefaultRingColorOpacity`, `disableColorOpacityUtilitiesByDefault`, `relativeContentPathsByDefault`], experimental: [`optimizeUniversalDefaults`, `generalizedModifiers`] };
function U(e2, t2) {
  return Ht.future.includes(t2) ? e2.future === `all` || (e2?.future?.[t2] ?? Vt[t2] ?? false) : Ht.experimental.includes(t2) ? e2.experimental === `all` || (e2?.experimental?.[t2] ?? Vt[t2] ?? false) : false;
}
function Ut(e2) {
  return e2.experimental === `all` ? Ht.experimental : Object.keys(e2?.experimental ?? {}).filter((t2) => Ht.experimental.includes(t2) && e2.experimental[t2]);
}
function Wt(e2) {
  if ({}.JEST_WORKER_ID === void 0 && Ut(e2).length > 0) {
    let t2 = Ut(e2).map((e3) => h.default.yellow(e3)).join(`, `);
...
function Gt(e2, t2) {
  e2.walkClasses((e3) => {
    e3.value = t2(e3.value), e3.raws && e3.raws.value && (e3.raws.value = Pe(e3.raws.value));
  });
}
function Kt(e2, t2) {
  if (!W(e2)) return;
...
function qt(e2, t2 = {}, n2) {
  let r2 = t2[e2];
  if (r2 !== void 0) return zt(r2);
  if (W(e2)) {
    let t3 = Kt(e2, n2);
    return t3 === void 0 ? void 0 : zt(t3);
  }
}
function Jt(e2, t2 = {}, { validate: n2 = () => true } = {}) {
  let r2 = t2.values?.[e2];
  return r2 === void 0 ? t2.supportsNegativeValues && e2.startsWith(`-`) ? qt(e2.slice(1), t2.values, n2) : Kt(e2, n2) : r2;
}
function W(e2) {
...
function Qt(e2, t2 = {}, { tailwindConfig: n2 = {} } = {}) {
  if (t2.values?.[e2] !== void 0) return Xt(t2.values?.[e2]);
  let [r2, i2] = Yt(e2);
  if (i2 !== void 0) {
    let e3 = t2.values?.[r2] ?? (W(r2) ? r2.slice(1, -1) : void 0);
    return e3 === void 0 ? void 0 : (e3 = Xt(e3), W(i2) ? We(e3, Zt(i2)) : n2.theme?.opacity?.[i2] === void 0 ? void 0 : We(e3, n2.theme.opacity[i2]));
  }
  return Jt(e2, t2, { validate: Et });
}
function $t(e2, t2 = {}) {
  return t2.values?.[e2];
}
function G(e2) {
  return (t2, n2) => Jt(t2, n2, { validate: e2 });
}
var en = { any: Jt, color: Qt, url: G(vt), image: G(Dt), length: G(St), percentage: G(bt), position: G(jt), lookup: $t, "generic-name": G(Pt), "family-name": G(Mt), number: G(yt), "line-width": G(wt), "absolute-size": G(It), "relative-size": G(Rt), shadow: G(Tt), size: G(Bt) }, tn = Object.keys(en);
function nn(e2, t2) {
...
function rn(e2, t2, n2, r2) {
  if (n2.values && t2 in n2.values) for (let { type: i3 } of e2 ?? []) {
    let e3 = en[i3](t2, n2, { tailwindConfig: r2 });
    if (e3 !== void 0) return [e3, i3, null];
  }
  if (W(t2)) {
    let e3 = t2.slice(1, -1), [r3, i3] = nn(e3, `:`);
    if (!/^[\w-_]+$/g.test(r3)) i3 = e3;
    else if (r3 !== void 0 && !tn.includes(r3)) return [];
    if (i3.length > 0 && tn.includes(r3)) return [Jt(`[${i3}]`, n2), r3, null];
  }
  let i2 = an(e2, t2, n2, r2);
  for (let e3 of i2) return e3;
  return [];
}
function* an(e2, t2, n2, r2) {
  let i2 = U(r2, `generalizedModifiers`), [a2, o2] = Yt(t2);
  if (i2 && n2.modifiers != null && (n2.modifiers === `any` || typeof n2.modifiers == `object` && (o2 && W(o2) || o2 in n2.modifiers)) || (a2 = t2, o2 = void 0), o2 !== void 0 && a2 === `` && (a2 = `DEFAULT`), o2 !== void 0 && typeof n2.modifiers == `object`) {
    ...
    e3 === null ? W(o2) && (o2 = Zt(o2)) : o2 = e3;
  }
  for (let { type: t3 } of e2 ?? []) {
    let e3 = en[t3](a2, n2, { tailwindConfig: r2 });
...
function K(e2) {
  ...
  return t2.value = e2, Pe(t2?.raws?.value ?? t2.value);
}
var sn = { "::after": [`terminal`, `jumpable`], "::backdrop": [`terminal`, `jumpable`], "::before": [`terminal`, `jumpable`], "::cue": [`terminal`], "::cue-region": [`terminal`], "::first-letter": [`terminal`, `jumpable`], "::first-line": [`terminal`, `jumpable`], "::grammar-error": [`terminal`], "::marker": [`terminal`, `jumpable`], "::part": [`terminal`, `actionable`], "::placeholder": [`terminal`, `jumpable`], "::selection": [`terminal`, `jumpable`], "::slotted": [`terminal`], "::spelling-error": [`terminal`], "::target-text": [`terminal`], "::file-selector-button": [`terminal`, `actionable`], "::deep": [`actionable`], "::v-deep": [`actionable`], "::ng-deep": [`actionable`], ":after": [`terminal`, `jumpable`], ":before": [`terminal`, `jumpable`], ":first-letter": [`terminal`, `jumpable`], ":first-line": [`terminal`, `jumpable`], ":where": [], ":is": [], ":has": [], __default__: [`terminal`, `actionable`] };
function cn(e2) {
  let [t2] = ln(e2);
...
function ln(e2) {
  let t2 = [], n2 = null;
  for (let r2 of e2.nodes) if (r2.type === `combinator`) t2 = t2.filter(([, e3]) => pn(e3).includes(`jumpable`)), n2 = null;
  else if (r2.type === `pseudo`) {
    dn(r2) ? (n2 = r2, t2.push([e2, r2, null])) : n2 && fn(r2, n2) ? t2.push([e2, r2, n2]) : n2 = null;
...
function un(e2) {
  return e2.value.startsWith(`::`) || sn[e2.value] !== void 0;
}
function dn(e2) {
  return un(e2) && pn(e2).includes(`terminal`);
}
function fn(e2, t2) {
  return e2.type !== `pseudo` || un(e2) ? false : pn(t2).includes(`actionable`);
}
function pn(e2) {
  return sn[e2.value] ?? sn.__default__;
}
var mn = `:merge`;
function hn(e2, { context: t2, candidate: n2 }) {
  let r2 = t2?.tailwindConfig.prefix ?? ``, i2 = e2.map((e3) => {
    let t3 = (0, F.default)().astSync(e3.format);
    return { ...e3, ast: e3.respectPrefix ? Ne(r2, t3) : t3 };
  }), a2 = F.default.root({ nodes: [F.default.selector({ nodes: [F.default.className({ value: K(n2) })] })] });
  for (let { ast: e3 } of i2) [a2, e3] = bn(a2, e3), e3.walkNesting((e4) => e4.replaceWith(...a2.nodes[0].nodes)), a2 = e3;
  return a2;
}
function gn(e2) {
  let t2 = [];
...
function yn(e2, t2, { context: n2, candidate: r2, base: i2 }) {
  let a2 = n2?.tailwindConfig?.separator ?? `:`;
  i2 ?? (i2 = B(r2, a2).pop());
  let o2 = (0, F.default)().astSync(e2);
  if (o2.walkClasses((e3) => {
    e3.raws && e3.value.includes(i2) && (e3.raws.value = K((0, on.default)(e3.raws.value)));
  }), o2.each((e3) => vn(e3, i2)), o2.length === 0) return null;
  let s2 = Array.isArray(t2) ? hn(t2, { context: n2, candidate: r2 }) : t2;
  ...
  return o2.walkClasses((e3) => {
    ...
    e3.remove(), r3 = gn(c2);
    let a3 = t3.index(c2);
    t3.nodes.splice(a3, r3.length, ..._n(F.default.selector({ nodes: r3 })).nodes), c2.remove(), l2.remove();
  }), o2.walkPseudos((e3) => {
    e3.value === mn && e3.replaceWith(e3.nodes);
  }), o2.each((e3) => cn(e3)), o2.toString();
}
function bn(e2, t2) {
  let n2 = [];
  return e2.walkPseudos((e3) => {
    e3.value === mn && n2.push({ pseudo: e3, value: e3.nodes[0].toString() });
  }), t2.walkPseudos((e3) => {
    if (e3.value !== mn) return;
...
var kn = /* @__PURE__ */ new Set([`normal`, `reverse`, `alternate`, `alternate-reverse`]), An = /* @__PURE__ */ new Set([`running`, `paused`]), jn = /* @__PURE__ */ new Set([`none`, `forwards`, `backwards`, `both`]), Mn = /* @__PURE__ */ new Set([`infinite`]), Nn = /* @__PURE__ */ new Set([`linear`, `ease`, `ease-in`, `ease-out`, `ease-in-out`, `step-start`, `step-end`]), Pn = [`cubic-bezier`, `steps`], Fn = /\,(?![^(]*\))/g, In = /\ +(?![^(]*\))/g, Ln = /^(-?[\d.]+m?s)$/, Rn = /^(\d+)$/;
function zn(e2) {
  return e2.split(Fn).map((e3) => {
    let t2 = e3.trim(), n2 = { value: t2 }, r2 = t2.split(In), i2 = /* @__PURE__ */ new Set();
    for (let e4 of r2) !i2.has(`DIRECTIONS`) && kn.has(e4) ? (n2.direction = e4, i2.add(`DIRECTIONS`)) : !i2.has(`PLAY_STATES`) && An.has(e4) ? (n2.playState = e4, i2.add(`PLAY_STATES`)) : !i2.has(`FILL_MODES`) && jn.has(e4) ? (n2.fillMode = e4, i2.add(`FILL_MODES`)) : !i2.has(`ITERATION_COUNTS`) && (Mn.has(e4) || Rn.test(e4)) ? (n2.iterationCount = e4, i2.add(`ITERATION_COUNTS`)) : !i2.has(`TIMING_FUNCTION`) && Nn.has(e4) || !i2.has(`TIMING_FUNCTION`) && Pn.some((t3) => e4.startsWith(`${t3}(`)) ? (n2.timingFunction = e4, i2.add(`TIMING_FUNCTION`)) : !i2.has(`DURATION`) && Ln.test(e4) ? (n2.duration = e4, i2.add(`DURATION`)) : !i2.has(`DELAY`) && Ln.test(e4) ? (n2.delay = e4, i2.add(`DELAY`)) : i2.has(`NAME`) ? (n2.unknown || (n2.unknown = []), n2.unknown.push(e4)) : (n2.name = e4, i2.add(`NAME`));
    return n2;
  });
}
...
function Bn(e2, t2 = true) {
  return Array.isArray(e2) ? e2.map((e3) => {
    ...
    let [n2, r2] = e3;
    return n2 = n2.toString(), typeof r2 == `string` ? { name: n2, not: false, values: [{ min: r2, max: void 0 }] } : Array.isArray(r2) ? { name: n2, not: false, values: r2.map((e4) => Wn(e4)) } : { name: n2, not: false, values: [Wn(r2)] };
  }) : Bn(Object.entries(e2 ?? {}), false);
}
function Vn(e2) {
...
function Hn(e2, t2, n2) {
  let r2 = Un(t2, e2), i2 = Un(n2, e2), a2 = Vn(r2), o2 = Vn(i2);
...
function Wn({ "min-width": e2, min: t2 = e2, max: n2, raw: r2 } = {}) {
...
var X = { childVariant: ({ addVariant: e2 }) => {
  ...
  e2(`first-letter`, `&::first-letter`), e2(`first-line`, `&::first-line`), e2(`marker`, [({ container: e3 }) => (Gn(e3, [`--tw-text-opacity`]), `& *::marker`), ({ container: e3 }) => (Gn(e3, [`--tw-text-opacity`]), `&::marker`)]), e2(`selection`, [`& *::selection`, `&::selection`]), e2(`file`, `&::file-selector-button`), e2(`placeholder`, `&::placeholder`), e2(`backdrop`, `&::backdrop`), e2(`before`, ({ container: e3 }) => (e3.walkRules((e4) => {
    let t2 = false;
  ...
  }, { values: Object.fromEntries(i2), [rr]: { respectPrefix: false } });
  ...
  let r2 = e2(`screens`) ?? {}, i2 = Object.values(r2).every((e3) => typeof e3 == `string`), a2 = Bn(e2(`screens`)), o2 = /* @__PURE__ */ new Set([]);
  function s2(e3) {
  ...
  let u2 = o2.size <= 1;
  function d2(e3) {
    return Object.fromEntries(a2.filter((e4) => Vn(e4).result).map((t3) => {
  ...
  e2(`has`, (e3) => `&:has(${V(e3)})`, { values: {}, [rr]: { respectPrefix: false } }), e2(`group-has`, (e3, { modifier: n2 }) => n2 ? `:merge(${t2(`.group`)}\\/${n2}):has(${V(e3)}) &` : `:merge(${t2(`.group`)}):has(${V(e3)}) &`, { values: {}, [rr]: { respectPrefix: false } }), e2(`peer-has`, (e3, { modifier: n2 }) => n2 ? `:merge(${t2(`.peer`)}\\/${n2}):has(${V(e3)}) ~ &` : `:merge(${t2(`.peer`)}):has(${V(e3)}) ~ &`, { values: {}, [rr]: { respectPrefix: false } });
  ...
  return function({ addComponents: n2, theme: r2 }) {
    let i2 = Bn(r2(`container.screens`, r2(`screens`))), a2 = e2(i2), o2 = t2(a2, i2, r2(`container.padding`)), s2 = (e3) => {
  ...
  function e2(e3) {
    return We(e3, 0, `rgb(255 255 255 / 0)`);
  }
  ...
  let e2 = En(`boxShadow`), t2 = [`var(--tw-ring-offset-shadow, 0 0 #0000)`, `var(--tw-ring-shadow, 0 0 #0000)`, `var(--tw-shadow)`].join(`, `);
  return function({ matchUtilities: n2, addDefaults: r2, theme: i2 }) {
    r2(`box-shadow`, { "--tw-ring-offset-shadow": `0 0 #0000`, "--tw-ring-shadow": `0 0 #0000`, "--tw-shadow": `0 0 #0000`, "--tw-shadow-colored": `0 0 #0000` }), n2({ shadow: (n3) => {
      ...
      return { "@defaults box-shadow": {}, "--tw-shadow": n3 === `none` ? `0 0 #0000` : n3, "--tw-shadow-colored": n3 === `none` ? `0 0 #0000` : mt(r3), "box-shadow": t2 };
  ...
  let a2 = (() => {
    ...
    return r2(`ringColor`)?.DEFAULT ? We(r2(`ringColor`)?.DEFAULT, e3, `rgb(147 197 253 / ${e3})`) : `rgb(147 197 253 / ${e3})`;
  })();
...
var Jn = /* @__PURE__ */ new Map([[`{`, `}`], [`[`, `]`], [`(`, `)`]]), Yn = new Map(Array.from(Jn.entries()).map(([e2, t2]) => [t2, e2])), Xn = /* @__PURE__ */ new Set([`"`, `'`, "`"]);
function Zn(e2) {
  let t2 = [], n2 = false;
  for (let r2 = 0; r2 < e2.length; r2++) {
    let i2 = e2[r2];
    if (i2 === `:` && !n2 && t2.length === 0) return false;
    if (Xn.has(i2) && e2[r2 - 1] !== `\\` && (n2 = !n2), !n2 && e2[r2 - 1] !== `\\`) {
      if (Jn.has(i2)) t2.push(i2);
      else if (Yn.has(i2)) {
        let e3 = Yn.get(i2);
...
var er = class {
  ...
  applyVariantOffset(e2, t2, n2) {
    return n2.variant = t2.variants, { ...e2, layer: `variants`, parentLayer: e2.layer === `variants` ? e2.parentLayer : e2.layer, variants: e2.variants | t2.variants, options: n2.sort ? [].concat(n2, e2.options) : e2.options, parallelIndex: tr([e2.parallelIndex, t2.parallelIndex]) };
  }
  ...
  compare(e2, t2) {
    ...
    for (let n2 of e2.options) for (let r2 of t2.options) {
      ...
      let i2 = tr([n2.variant, r2.variant]) ?? 0n, a2 = ~(i2 | i2 - 1n);
  ...
  recalculateVariantOffsets() {
    let e2 = Array.from(this.variantOffsets.entries()).filter(([e3]) => e3.startsWith(`[`)).sort(([e3], [t3]) => nr(e3, t3)), t2 = e2.map(([, e3]) => e3).sort((e3, t3) => Qn(e3 - t3));
  ...
  remapArbitraryVariantOffsets(e2) {
    ...
    return t2.length === 0 ? e2 : e2.map((e3) => {
      let [n2, r2] = e3;
      return n2 = { ...n2, variants: $n(n2.variants, t2) }, [n2, r2];
    });
  }
  ...
  sort(e2) {
    return e2 = this.remapArbitraryVariantOffsets(e2), e2 = this.sortArbitraryProperties(e2), e2.sort(([e3], [t2]) => Qn(this.compare(e3, t2)));
  }
};
function tr(e2) {
  let t2 = null;
...
var rr = /* @__PURE__ */ Symbol(), ir = { AddVariant: /* @__PURE__ */ Symbol.for(`ADD_VARIANT`), MatchVariant: /* @__PURE__ */ Symbol.for(`MATCH_VARIANT`) }, ar = { Base: 1, Dynamic: 2 };
function or(e2, t2) {
  let n2 = e2.tailwindConfig.prefix;
  return typeof n2 == `function` ? n2(t2) : n2 + t2;
}
function sr({ type: e2 = `any`, ...t2 }) {
  let n2 = [].concat(e2);
...
function ur(e2) {
  return Array.isArray(e2) ? e2.flatMap((e3) => !Array.isArray(e3) && !I(e3) ? e3 : Me(e3)) : ur([e2]);
}
function dr(e2, t2) {
...
function pr(e2, t2 = { containsNonOnDemandable: false }, n2 = 0) {
  let r2 = [], i2 = [];
...
function mr(e2) {
  return ur(e2).flatMap((e3) => {
    let t2 = /* @__PURE__ */ new Map(), [n2, r2] = pr(e3);
...
function _r(e2, t2, { variantList: n2, variantMap: r2, offsets: i2, classList: a2 }) {
  function o2(t3, n3) {
    return t3 ? (0, Tn.default)(e2, t3, n3) : e2;
  }
  function s2(t3) {
    return Ne(e2.prefix, t3);
  }
  function c2(e3, n3) {
    return e3 === S ? S : n3.respectPrefix ? t2.tailwindConfig.prefix + e3 : e3;
  }
  function u2(e3, t3, n3 = {}) {
    let r3 = qn(e3), i3 = o2([`theme`, ...r3], t3);
    return En(r3[0])(i3, n3);
  }
  let d2 = 0, f2 = { postcss: l, prefix: s2, e: K, config: o2, theme: u2, corePlugins: (t3) => Array.isArray(e2.corePlugins) ? e2.corePlugins.includes(t3) : o2([`corePlugins`, t3], true), variants: () => [], addBase(e3) {
    ...
    r3 = sr({ respectPrefix: true, respectImportant: true, modifiers: false, ...r3 });
    let o3 = i2.create(`utilities`);
    for (let i3 in n3) {
      let u3 = function(t3, { isOnlyPlugin: n4 }) {
        let [a3, o4, s4] = rn(r3.types, t3, r3, e2);
        if (a3 === void 0) return [];
        ...
        return [].concat(u4 ? l2(a3, c3) : l2(a3)).filter(Boolean).map((e3) => ({ [Sn(i3, t3)]: e3 }));
      };
    ...
    r3 = sr({ respectPrefix: true, respectImportant: false, modifiers: false, ...r3 });
    ...
    i3 = [].concat(i3).map((t3) => {
      if (typeof t3 != `string`) return (n3 = {}) => {
        let { args: r3, modifySelectors: i4, container: o3, separator: s3, wrap: c3, format: l2 } = n3, u3 = t3(Object.assign({ modifySelectors: i4, container: o3, separator: s3 }, a3.type === ir.MatchVariant && { args: r3, wrap: c3, format: l2 }));
        if (typeof u3 == `string` && !hr(u3)) throw Error(`Your custom variant \`${e3}\` has an invalid format string. Make sure it's an at-rule or contains a \`&\` placeholder.`);
        return Array.isArray(u3) ? u3.filter((e4) => typeof e4 == `string`).map((e4) => gr(e4)) : u3 && typeof u3 == `string` && gr(u3)(n3);
      };
      if (!hr(t3)) throw Error(`Your custom variant \`${e3}\` has an invalid format string. Make sure it's an at-rule or contains a \`&\` placeholder.`);
      return gr(t3);
    }), lr(n2, e3, a3), r2.set(e3, i3), t2.variantOptions.set(e3, a3);
  }, matchVariant(t3, n3, r3) {
    let i3 = r3?.id ?? ++d2, a3 = t3 === `@`, o3 = U(e2, `generalizedModifiers`);
    for (let [e3, s4] of Object.entries(r3?.values ?? {})) e3 !== `DEFAULT` && f2.addVariant(a3 ? `${t3}${e3}` : `${t3}-${e3}`, ({ args: e4, container: t4 }) => n3(s4, o3 ? { modifier: e4?.modifier, container: t4 } : { container: t4 }), { ...r3, value: s4, id: i3, type: ir.MatchVariant, variantInfo: ar.Base });
    let s3 = `DEFAULT` in (r3?.values ?? {});
    f2.addVariant(t3, ({ args: e3, container: t4 }) => e3?.value === C && !s3 ? null : n3(e3?.value === C ? r3.values.DEFAULT : e3?.value ?? (typeof e3 == `string` ? e3 : ``), o3 ? { modifier: e3?.modifier, container: t4 } : { container: t4 }), { ...r3, id: i3, type: ir.MatchVariant, variantInfo: ar.Dynamic });
  } };
  return f2;
}
function vr(e2) {
  e2.walkAtRules((e3) => {
    [`responsive`, `variants`].includes(e3.name) && (vr(e3), e3.before(e3.nodes), e3.remove());
  });
}
function yr(e2) {
  let t2 = [];
...
function xr(e2, t2) {
  ...
  let i2 = new er();
  t2.offsets = i2;
  let a2 = /* @__PURE__ */ new Set(), o2 = _r(t2.tailwindConfig, t2, { variantList: n2, variantMap: r2, offsets: i2, classList: a2 });
    ...
    if (e3.length > 0) {
      ...
      for (let o3 of a2) {
        let a3 = Array.isArray(o3) ? (() => {
          let [e4, n4] = o3, a4 = Object.keys(n4?.values ?? {}).map((t3) => Cn(e4, t3));
  ...
  let c2 = [or(t2, [].concat(t2.tailwindConfig.darkMode ?? `media`)[1] ?? `dark`), or(t2, `group`), or(t2, `peer`)];
  t2.getClassOrder = function(e3) {
    let n3 = [...e3].sort((e4, t3) => e4 === t3 ? 0 : e4 < t3 ? -1 : 1), r3 = new Map(n3.map((e4) => [e4, null])), i3 = Kr(new Set(n3), t2, true);
    ...
    for (let r3 of a2) if (Array.isArray(r3)) {
      ...
      for (let [e4, t3] of Object.entries(a3?.values ?? {})) {
        if (t3 == null) continue;
        let r4 = Cn(i3, e4);
        if (n3.push(l2 ? [r4, c3] : r4), a3?.supportsNegativeValues && zt(t3)) {
          let t4 = Cn(i3, `-${e4}`);
          o3.push(l2 ? [t4, c3] : t4);
        }
      }
    ...
    for (let [r3, i3] of t2.variantOptions.entries()) i3.variantInfo !== ar.Base && n3.push({ name: r3, isArbitrary: i3.type === /* @__PURE__ */ Symbol.for(`MATCH_VARIANT`), values: Object.keys(i3.values ?? {}), hasDash: r3 !== `@`, selectors({ modifier: n4, value: a3 } = {}) {
      ...
      let m2 = !(a3 in (i3.values ?? {})), h2 = i3[rr] ?? {}, g2 = !(m2 || h2.respectPrefix === false);
      f2 = f2.map((e4) => e4.map((e5) => ({ format: e5, respectPrefix: g2 }))), p2 = p2.map((e4) => ({ format: e4, respectPrefix: g2 }));
      let _2 = { candidate: o3, context: t2 }, v2 = f2.map((e4) => yn(`.${o3}`, hn(e4, _2), _2).replace(`.${o3}`, `&`).replace(`{ & }`, ``).trim());
      return p2.length > 0 && v2.push(hn(p2, _2).toString().replace(`.${o3}`, `&`)), v2;
    } });
    return n3;
  };
}
  ...
  for (let n2 of e2) {
    ...
    if (e3.options.respectPrefix) {
      ...
      e4.walkRules((e5) => {
        ...
        e5.selector = Ne(t2.tailwindConfig.prefix, e5.selector, n3);
      }), n2[1] = e4.nodes[0];
    }
  }
  return e2;
...
function Ar(e2, t2) {
  ...
  for (let [i2, a2] of e2) {
    ...
    e3.walkRules((e4) => {
      ...
      n3.each((e5) => vn(e5, t2)), Gt(n3, (e5) => e5 === t2 ? `!${e5}` : e5);
      let i3 = n3.toString();
      if (i3.trim() === ``) {
        e4.remove();
        return;
...
function jr(e2, t2, n2) {
  ...
  if (qr(e2) && !n2.variantMap.has(e2)) {
    let t3 = n2.offsets.recordVariant(e2), r3 = B(V(e2.slice(1, -1)), `,`);
    if (r3.length > 1 || !r3.every(hr)) return [];
    let i2 = r3.map((e3, r4) => [n2.offsets.applyParallelOffset(t3, r4), gr(e3.trim())]);
    n2.variantMap.set(e2, i2);
  }
  if (n2.variantMap.has(e2)) {
    let i2 = qr(e2), a2 = n2.variantOptions.get(e2)?.[rr] ?? {}, o2 = n2.variantMap.get(e2).slice(), s2 = [], c2 = !(i2 || a2.respectPrefix === false);
    for (let [i3, a3] of t2) {
...
function Mr(e2, t2, n2 = {}) {
  return !I(e2) && !Array.isArray(e2) ? [[e2], n2] : Array.isArray(e2) ? Mr(e2[0], t2, e2[1]) : (t2.has(e2) || t2.set(e2, Me(e2)), [t2.get(e2), n2]);
}
var Nr = /^[a-z_-]/;
function Pr(e2) {
  return Nr.test(e2);
...
function Ir(e2) {
  ...
  return e2.walkDecls((e3) => {
    if (!Lr(e3.prop, e3.value)) return t2 = false, false;
  }), t2;
}
function Lr(e2, t2) {
  if (Fr(`${e2}:${t2}`)) return false;
  try {
...
function Rr(e2, t2) {
  ...
  if (r2 === void 0 || !Pr(n2) || !Zn(r2)) return null;
  let i2 = V(r2, { property: n2 });
  return Lr(n2, i2) ? [[{ sort: t2.offsets.arbitraryProperty(e2), layer: `utilities`, options: { respectImportant: true } }, () => ({ [xn(e2)]: { [n2]: i2 } })]] : null;
}
function* zr(e2, t2) {
  ...
  for (let [e3, i3] of Or(n2)) t2.candidateRuleMap.has(e3) && (yield [t2.candidateRuleMap.get(e3), r2 ? `-${i3}` : i3]);
}
function Br(e2, t2) {
      ...
      if (o2.length > 1) {
        let r3 = function(e3) {
          return e3.length === 1 ? e3[0] : e3.find((e4) => {
            let t4 = s2.get(e4);
            return e4.some(([{ options: e5 }, n5]) => Ir(n5) ? e5.types.some(({ type: e6, preferOnConflict: n6 }) => t4.includes(e6) && n6) : false);
          });
        };
...
`);
      ...
      o2 = o2.map((e3) => e3.filter((e4) => Ir(e4[1])));
    }
    o2 = o2.flat(), o2 = Array.from(Vr(o2, r2)), o2 = kr(o2, t2), a2 && (o2 = Ar(o2, r2));
    for (let e3 of i2) o2 = jr(e3, o2, t2);
    for (let n4 of o2) n4[1].raws.tailwind = { ...n4[1].raws.tailwind, candidate: e2 }, n4 = Ur(n4, { context: t2, candidate: e2 }), n4 !== null && (yield n4);
  }
}
function Ur(e2, { context: t2, candidate: n2 }) {
  if (!e2[0].collectedFormats) return e2;
  let r2 = true, i2;
  try {
    i2 = hn(e2[0].collectedFormats, { context: t2, candidate: n2 });
  } catch {
    return null;
  }
  ...
  return a2.walkRules((e3) => {
    if (!Wr(e3)) try {
      let r3 = yn(e3.selector, i2, { candidate: n2, context: t2 });
      if (r3 === null) {
        e3.remove();
        return;
      }
...
function Gr(e2) {
  if (e2 === true) return (e3) => {
    Wr(e3) || e3.walkDecls((e4) => {
      e4.parent.type === `rule` && !Wr(e4.parent) && (e4.important = true);
    });
  };
  if (typeof e2 == `string`) return (t2) => {
    Wr(t2) || (t2.selectors = t2.selectors.map((t3) => Tr(t3, e2)));
  };
}
function Kr(e2, t2, n2 = false) {
  let r2 = [], i2 = Gr(t2.tailwindConfig.important);
  for (let a2 of e2) {
...
function ni(e2, t2) {
  ...
  return e2.walkRules((e3) => {
    for (let t3 of $r(e3)) if (t3.raws.tailwind?.layer !== void 0) return;
    let r2 = ti(e3), i2 = t2.offsets.create(`user`);
    for (let t3 of Jr(e3)) {
      let e4 = n2.get(t3) || [];
...
function si(e2, t2, n2) {
  ...
  let a2 = ai([n2, ri(r2, t2)]);
  function o2(e3, t3, n3) {
    let r3 = Xr(e3), i3 = Xr(t3), a3 = Xr(`.${K(n3)}`).nodes[0].nodes[0];
    return r3.each((e4) => {
  ...
  for (let e3 of i2) {
    ...
    for (let o3 of r3) {
      if ([Qr(t2, `group`), Qr(t2, `peer`)].includes(o3)) throw e3.error(`@apply should not be used with the '${o3}' utility`);
...
`));
  ...
  for (let [e3, [n3, r3]] of s2) {
    ...
    for (let [a4, s3, c2] of n3) {
      let n4 = [a4, ...Zr([a4], t2.tailwindConfig.separator)];
      for (let [u2, d2] of c2) {
        let c3 = Jr(e3), f2 = Jr(d2);
        if (f2 = f2.groups.filter((e4) => e4.some((e5) => n4.includes(e5))).flat(), f2 = f2.concat(Zr(f2, t2.tailwindConfig.separator)), c3.some((e4) => f2.includes(e4))) throw d2.error(`You cannot \`@apply\` the \`${a4}\` utility here because it creates a circular dependency.`);
        let p2 = l.root({ nodes: [d2.clone()] });
        p2.walk((e4) => {
          e4.source = r3;
        }), (d2.type !== `atrule` || d2.type === `atrule` && d2.name !== `keyframes`) && p2.walkRules((n5) => {
          if (!Jr(n5).some((e4) => e4 === a4)) {
            n5.remove();
            return;
          }
          ...
          i4 === `` && (i4 = e3.selector), n5.selector = o2(i4, n5.selector, a4), r4 && i4 !== e3.selector && (n5.selector = Tr(n5.selector, r4)), n5.walkDecls((e4) => {
            e4.important = u2.important || s3;
          });
          let c4 = (0, F.default)().astSync(n5.selector);
          c4.each((e4) => cn(e4)), n5.selector = c4.toString();
...
var li = t(((e2, t2) => {
  ...
  t2.exports = function(e3) {
    for (var t3 = [], h2 = e3, g2, _2, v2, y2, b2, x2, S2, C2, w2 = 0, T2 = h2.charCodeAt(w2), ee2 = h2.length, E2 = [{ nodes: t3 }], D2 = 0, O2, k2 = ``, A2 = ``, j2 = ``; w2 < ee2; ) if (T2 <= 32) {
      g2 = w2;
      do
        g2 += 1, T2 = h2.charCodeAt(g2);
      while (T2 <= 32);
      y2 = h2.slice(w2, g2), v2 = t3[t3.length - 1], T2 === r2 && D2 ? j2 = y2 : v2 && v2.type === `div` ? (v2.after = y2, v2.sourceEndIndex += y2.length) : T2 === c2 || T2 === l2 || T2 === s2 && h2.charCodeAt(g2 + 1) !== u2 && (!O2 || O2 && O2.type === `function` && false) ? A2 = y2 : t3.push({ type: `space`, sourceIndex: w2, sourceEndIndex: g2, value: y2 }), w2 = g2;
    } else if (T2 === i2 || T2 === a2) {
    ...
    else if ((T2 === s2 || T2 === u2) && O2 && O2.type === `function`) y2 = h2[w2], t3.push({ type: `word`, sourceIndex: w2 - A2.length, sourceEndIndex: w2 + y2.length, value: y2 }), w2 += 1, T2 = h2.charCodeAt(w2);
    else if (T2 === s2 || T2 === c2 || T2 === l2) y2 = h2[w2], t3.push({ type: `div`, sourceIndex: w2 - A2.length, sourceEndIndex: w2 + y2.length, value: y2, before: A2, after: `` }), A2 = ``, w2 += 1, T2 = h2.charCodeAt(w2);
    else if (n2 === T2) {
      g2 = w2;
      do
        g2 += 1, T2 = h2.charCodeAt(g2);
      while (T2 <= 32);
      if (C2 = w2, y2 = { type: `function`, sourceIndex: w2 - k2.length, value: k2, before: h2.slice(C2 + 1, g2) }, w2 = g2, k2 === `url` && T2 !== i2 && T2 !== a2) {
        --g2;
        do
      ...
      } else D2 += 1, y2.after = ``, y2.sourceEndIndex = w2 + 1, t3.push(y2), E2.push(y2), t3 = y2.nodes = [], O2 = y2;
      k2 = ``;
    } else if (r2 === T2 && D2) w2 += 1, T2 = h2.charCodeAt(w2), O2.after = j2, O2.sourceEndIndex += j2.length, j2 = ``, --D2, E2[E2.length - 1].sourceEndIndex = w2, E2.pop(), O2 = E2[D2], t3 = O2.nodes;
    else {
      g2 = w2;
      do
        T2 === o2 && (g2 += 1), g2 += 1, T2 = h2.charCodeAt(g2);
      while (g2 < ee2 && !(T2 <= 32 || T2 === i2 || T2 === a2 || T2 === c2 || T2 === l2 || T2 === s2 || T2 === n2 || T2 === u2 && O2 && O2.type === `function` || T2 === s2 && O2.type === `function` || T2 === r2 && D2));
      y2 = h2.slice(w2, g2), n2 === T2 ? k2 = y2 : (d2 === y2.charCodeAt(0) || f2 === y2.charCodeAt(0)) && p2 === y2.charCodeAt(1) && m2.test(y2.slice(2)) ? t3.push({ type: `unicode-range`, sourceIndex: w2, sourceEndIndex: g2, value: y2 }) : t3.push({ type: `word`, sourceIndex: w2, sourceEndIndex: g2, value: y2 }), w2 = g2;
    }
    for (w2 = E2.length - 1; w2; --w2) E2[w2].unclosed = true, E2[w2].sourceEndIndex = h2.length;
    return E2[0].nodes;
  };
})), di = t(((e2, t2) => {
  ...
  }, a2.unit = pi(), a2.walk = r2, a2.stringify = i2, t2.exports = a2;
})), hi = e(li()), gi = e(mi());
function _i(e2) {
...
function vi(e2, t2) {
  let n2 = qn(t2);
  do
    if (n2.pop(), (0, Tn.default)(e2, n2) !== void 0) break;
  while (n2.length);
...
function xi(e2) {
  return bi(Object.keys(e2));
}
function Si(e2, t2, n2, r2 = {}) {
  let i2 = Array.isArray(t2) ? yi(t2) : t2.replace(/^['"]+|['"]+$/g, ``), a2 = Array.isArray(t2) ? t2 : qn(i2), o2 = (0, Tn.default)(e2.theme, a2, n2);
  if (o2 === void 0) {
    let t3 = `'${i2}' does not exist in your theme config.`, n3 = a2.slice(0, -1), r3 = (0, Tn.default)(e2.theme, n3);
    if (_i(r3)) {
      let i3 = Object.keys(r3).filter((t4) => Si(e2, [...n3, t4]).isValid), o3 = (0, hi.default)(a2[a2.length - 1], i3);
      o3 ? t3 += ` Did you mean '${yi([...n3, o3])}'?` : i3.length > 0 && (t3 += ` '${yi(n3)}' has the following valid keys: ${bi(i3)}`);
    } else {
      let n4 = vi(e2.theme, i2);
      if (n4) {
        let r4 = (0, Tn.default)(e2.theme, n4);
        _i(r4) ? t3 += ` '${yi(n4)}' has the following keys: ${xi(r4)}` : t3 += ` '${yi(n4)}' is not an object.`;
      } else t3 += ` Your theme has the following top-level keys: ${xi(e2.theme)}`;
    }
  ...
  if (!(typeof o2 == `string` || typeof o2 == `number` || typeof o2 == `function` || o2 instanceof String || o2 instanceof Number || Array.isArray(o2))) {
    ...
    if (_i(o2)) {
      let n3 = Object.keys(o2).filter((t4) => Si(e2, [...a2, t4]).isValid);
      n3.length && (t3 += ` Did you mean something like '${yi([...a2, n3[0]])}'?`);
    }
    return { isValid: false, error: t3 };
  }
  let [s2] = a2;
  return { isValid: true, value: En(s2)(o2, r2) };
}
function Ci(e2, t2, n2) {
  t2 = t2.map((t3) => wi(e2, t3, n2));
  let r2 = [``];
  for (let e3 of t2) e3.type === `div` && e3.value === `,` ? r2.push(``) : r2[r2.length - 1] += gi.default.stringify(e3);
  return r2;
}
function wi(e2, t2, n2) {
  if (t2.type === `function` && n2[t2.value] !== void 0) {
    let r2 = Ci(e2, t2.nodes, n2);
    t2.type = `word`, t2.value = n2[t2.value](e2, ...r2);
  }
  return t2;
}
function Ti(e2, t2, n2) {
  return Object.keys(n2).some((e3) => t2.includes(`${e3}(`)) ? (0, gi.default)(t2).walk((t3) => {
    wi(e2, t3, n2);
  }).toString() : t2;
}
var Ei = { atrule: `params`, decl: `value` };
function* Di(e2) {
  e2 = e2.replace(/^['"]+|['"]+$/g, ``);
...
function Oi(e2, t2, n2) {
  let r2 = Array.from(Di(t2)).map(([t3, r3]) => Object.assign(Si(e2, t3, n2, { opacityValue: r3 }), { resolvedPath: t3, alpha: r3 }));
  return r2.find((e3) => e3.isValid) ?? r2[0];
}
function ki(e2) {
  let t2 = e2.tailwindConfig, n2 = { theme: (n3, r2, ...i2) => {
    let { isValid: a2, value: o2, error: s2, alpha: c2 } = Oi(t2, r2, i2.length ? i2 : void 0);
    if (!a2) {
    ...
    let l2 = Xt(o2);
    return (c2 !== void 0 || l2 !== void 0 && typeof l2 == `function`) && (c2 === void 0 && (c2 = 1), o2 = We(l2, c2, l2)), o2;
  }, screen: (e3, n3) => {
    n3 = n3.replace(/^['"]+/g, ``).replace(/['"]+$/g, ``);
    let r2 = Bn(t2.theme.screens).find(({ name: e4 }) => e4 === n3);
...
function Mi({ version: e2, from: t2, to: n2 }) {
...
function Ii(e2) {
  return Array.isArray(e2) ? e2.map((e3) => Ii(e3)) : typeof e2 == `object` && e2 ? Object.fromEntries(Object.entries(e2).map(([e3, t2]) => [e3, Ii(t2)])) : e2;
}
function Li(e2) {
...
function Ri(e2, ...t2) {
  ...
  for (let r2 of t2) for (let t3 in r2) {
    ...
    i2 === void 0 ? I(e2[t3]) && I(r2[t3]) ? e2[t3] = Ri({}, e2[t3], r2[t3], n2) : e2[t3] = r2[t3] : e2[t3] = i2;
  }
  return e2;
}
var zi = { colors: Ni, negative(e2) {
...
function Bi(e2, ...t2) {
  return Li(e2) ? e2(...t2) : e2;
}
function Vi(e2) {
  return e2.reduce((e3, { extend: t2 }) => Ri(e3, t2, (e4, t3) => e4 === void 0 ? [t3] : Array.isArray(e4) ? [t3, ...e4] : [t3, e4]), {});
}
function Hi(e2) {
  return { ...e2.reduce((e3, t2) => Pi(e3, t2), {}), extend: Vi(e2) };
}
function Ui(e2, t2) {
...
function Wi({ extend: e2, ...t2 }) {
  return Ri(t2, e2, (e3, t3) => !Li(e3) && !t3.some(Li) ? Ri({}, e3, ...t3, Ui) : (n2, r2) => Ri({}, ...[e3, ...t3].map((e4) => Bi(e4, n2, r2)), Ui));
}
function* Gi(e2) {
  let t2 = qn(e2);
...
function Ki(e2) {
  let t2 = (n2, r2) => {
    for (let r3 of Gi(n2)) {
      let n3 = 0, i2 = e2;
      for (; i2 != null && n3 < r3.length; ) i2 = i2[r3[n3++]], i2 = Li(i2) && (r3.alpha === void 0 || n3 <= r3.length - 1) ? i2(t2, zi) : i2;
      if (i2 !== void 0) {
        if (r3.alpha !== void 0) {
          let e3 = Xt(i2);
          return We(e3, r3.alpha, Y(e3));
        }
        return I(i2) ? Ii(i2) : i2;
      }
    }
    return r2;
  };
  return Object.assign(t2, { theme: t2, ...zi }), Object.keys(e2).reduce((n2, r2) => (n2[r2] = Li(e2[r2]) ? e2[r2](t2, zi) : e2[r2], n2), {});
}
function qi(e2) {
  let t2 = [];
...
function Ji(e2) {
  return [...e2].reduceRight((e3, t2) => Li(t2) ? t2({ corePlugins: e3 }) : ji(t2, e3), Ai);
}
function Yi(e2) {
...
function Xi(e2) {
  ...
  return Fi(Pi({ theme: Ki(Wi(Hi(t2.map((e3) => e3?.theme ?? {})))), corePlugins: Ji(t2.map((e3) => e3.corePlugins)), plugins: Yi(e2.map((e3) => e3?.plugins ?? [])) }, ...t2));
}
var Zi = e(t(((e2, t2) => {
...
async function ta(e2 = {}, t2 = `/tailwind.config.js`) {
  ...
  return window.windpress && !window.windpress.__MEMFS_VOLUME__ && (window.windpress.__MEMFS_VOLUME__ = new wn.Volume(), window.windpress.__MEMFS_VOLUME__.mkdirSync(`/css`, { recursive: true }), window.windpress.__MEMFS_VOLUME__.writeFileSync(`/css/preflight.css`, ea, `utf8`)), $i(n2.module);
}
export {
  m as _,
  wr as a,

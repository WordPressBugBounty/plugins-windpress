import { D as e, E as t, Ht as n, J as r, Lt as i, On as a, Tn as o, Wt as s, Zn as c, _ as l, b as u, bt as d, ct as f, er as p, et as m, g as h, it as g, k as _, mt as v, o as y, qt as b, rt as x, tr as S, v as C, vn as w, xn as T, xt as E, y as D } from "./runtime-core.esm-bundler-CahM68iJ.js";
import { c as O, l as k } from "./vue.runtime.esm-bundler-B0iyRCM8.js";
import { F as A, T as j, b as M, g as N, q as P, t as ee, v as F, x as I, y as L } from "./Button-DpvhuBJO.js";
import { A as te, b as R, v as ne } from "./dist-BKF-Yqo1.js";
import { i as re } from "./vue-router-B3IuXUyS.js";
import { R as z, f as B } from "./namespaced-BdQ8WLes.js";
import { g as V, h as H, t as ie, v as U, y as W } from "./Tooltip-CZRNrufK.js";
import { n as G, t as ae } from "./FluidCalculatorSlideover-Cuyr3BQt.js";
import { n as K, t as oe } from "./Tree-DW_HwbbT.js";
import { t as se } from "./useOverlay-C3I9NwM7.js";
import { n as ce } from "./useToast-BSOztMWY.js";
import { t as q } from "./Badge-Df4B0ziO.js";
import { n as le } from "./index.browser-DL6dchOu.js";
import { n as ue, t as de } from "./DashboardNavbar-DDpWxmFn.js";
import { n as J, r as Y, t as X } from "./WizardTreeItem-CYoZ9dfA.js";
var [Z, fe] = j(`TabsRoot`), pe = _({ __name: `TabsRoot`, props: { defaultValue: { type: null, required: false }, orientation: { type: String, required: false, default: `horizontal` }, dir: { type: String, required: false }, activationMode: { type: String, required: false, default: `automatic` }, modelValue: { type: null, required: false }, unmountOnHide: { type: Boolean, required: false, default: true }, asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, emits: [`update:modelValue`], setup(e2, { emit: t2 }) {
  let n2 = e2, r2 = t2, { orientation: i2, unmountOnHide: s2, dir: c2 } = o(n2), l2 = z(c2);
  W();
  ...
  } }), (e3, t3) => (v(), C(a(I), { dir: a(l2), "data-orientation": a(i2), "as-child": e3.asChild, as: e3.as }, { default: b(() => [E(e3.$slots, `default`, { modelValue: a(u2) })]), _: 3 }, 8, [`dir`, `data-orientation`, `as-child`, `as`]));
} });
function Q(e2, t2) {
...
var me = _({ __name: `TabsContent`, props: { value: { type: [String, Number], required: true }, forceMount: { type: Boolean, required: false }, asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, setup(t2) {
  ...
  n(() => [i2.modelValue.value, i2 == null ? void 0 : i2.dir.value], () => {
    l2();
  }, { immediate: true, flush: `post` }), s(() => {
    var _a;
    c2.value = Array.from(((_a = i2.tabsList.value) == null ? void 0 : _a.querySelectorAll(`[role="tab"]`)) || []);
  }), ne(h(() => [i2.tabsList.value, ...c2.value]), l2);
  function l2() {
    var _a;
    let e3 = (_a = i2.tabsList.value) == null ? void 0 : _a.querySelector(`[role="tab"][data-state="active"]`);
  ...
  return (e3, t3) => typeof o2.value.size == `number` ? (v(), C(a(I), m({ key: 0 }, r2, { style: { "--reka-tabs-indicator-size": `${o2.value.size}px`, "--reka-tabs-indicator-position": `${o2.value.position}px` } }), { default: b(() => [E(e3.$slots, `default`)]), _: 3 }, 16, [`style`])) : D(`v-if`, true);
  ...
  return s2.tabsList = i2, (t3, i3) => (v(), C(a(B), { "as-child": ``, orientation: a(s2).orientation.value, dir: a(s2).dir.value, loop: a(n2) }, { default: b(() => [e(a(I), { ref: a(r2), role: `tablist`, "as-child": t3.asChild, as: t3.as, "aria-orientation": a(s2).orientation.value }, { default: b(() => [E(t3.$slots, `default`)]), _: 3 }, 8, [`as-child`, `as`, `aria-orientation`])]), _: 3 }, 8, [`orientation`, `dir`, `loop`]));
  ...
  return (t3, n3) => (v(), C(a(K), { "as-child": ``, focusable: !t3.disabled, active: c2.value }, { default: b(() => [e(a(I), { id: o2.value, ref: a(r2), role: `tab`, type: t3.as === `button` ? `button` : void 0, as: t3.as, "as-child": t3.asChild, "aria-selected": c2.value ? `true` : `false`, "aria-controls": s2.value, "data-state": c2.value ? `active` : `inactive`, disabled: t3.disabled, "data-disabled": t3.disabled ? `` : void 0, "data-orientation": a(i2).orientation.value, onMousedown: n3[0] || (n3[0] = k((e2) => {
  ...
  let s2 = n2, l2 = o2, f2 = i(), p2 = P(), g2 = M(`tabs`, s2), _2 = U(te(s2, `as`, `unmountOnHide`), l2), x2 = h(() => {
    var _a;
    return L({ extend: L(ve), ...((_a = p2.ui) == null ? void 0 : _a.tabs) || {} })({ color: s2.color, variant: s2.variant, size: s2.size, orientation: s2.orientation });
  }), T2 = w([]);
  function O2(e2, t2) {
    T2.value[e2] = t2;
  }
  return r2({ triggersRef: T2 }), (r3, i2) => {
    var _a;
    return v(), C(a(pe), m(a(_2), { "model-value": n2.modelValue, "default-value": n2.defaultValue, orientation: n2.orientation, "activation-mode": n2.activationMode, "data-slot": `root`, class: x2.value.root({ class: [(_a = a(g2)) == null ? void 0 : _a.root, s2.class] }) }), { default: b(() => {
      var _a2;
      return [e(a(ge), { "data-slot": `list`, class: c(x2.value.list({ class: (_a2 = a(g2)) == null ? void 0 : _a2.list })) }, { default: b(() => {
        var _a3;
        return [e(a(he), { "data-slot": `indicator`, class: c(x2.value.indicator({ class: (_a3 = a(g2)) == null ? void 0 : _a3.indicator })) }, null, 8, [`class`]), E(r3.$slots, `list-leading`), (v(true), u(y, null, d(n2.items, (e2, n3) => {
          var _a4, _b;
          return v(), C(a(_e), { key: n3, ref_for: true, ref: (e3) => O2(n3, e3), value: a(A)(e2, s2.valueKey) ?? String(n3), disabled: e2.disabled, "data-slot": `trigger`, class: c(x2.value.trigger({ class: [(_a4 = a(g2)) == null ? void 0 : _a4.trigger, (_b = e2.ui) == null ? void 0 : _b.trigger] })) }, { default: b(() => {
            var _a5, _b2;
            return [E(r3.$slots, `leading`, { item: e2, index: n3, ui: x2.value }, () => {
              var _a6, _b3, _c, _d, _e2, _f;
              return [e2.icon ? (v(), C(F, { key: 0, name: e2.icon, "data-slot": `leadingIcon`, class: c(x2.value.leadingIcon({ class: [(_a6 = a(g2)) == null ? void 0 : _a6.leadingIcon, (_b3 = e2.ui) == null ? void 0 : _b3.leadingIcon] })) }, null, 8, [`name`, `class`])) : e2.avatar ? (v(), C(N, m({ key: 1, size: ((_c = e2.ui) == null ? void 0 : _c.leadingAvatarSize) || ((_d = a(g2)) == null ? void 0 : _d.leadingAvatarSize) || x2.value.leadingAvatarSize() }, { ref_for: true }, e2.avatar, { "data-slot": `leadingAvatar`, class: x2.value.leadingAvatar({ class: [(_e2 = a(g2)) == null ? void 0 : _e2.leadingAvatar, (_f = e2.ui) == null ? void 0 : _f.leadingAvatar] }) }), null, 16, [`size`, `class`])) : D(``, true)];
            }), a(A)(e2, s2.labelKey) || f2.default ? (v(), u(`span`, { key: 0, "data-slot": `label`, class: c(x2.value.label({ class: [(_a5 = a(g2)) == null ? void 0 : _a5.label, (_b2 = e2.ui) == null ? void 0 : _b2.label] })) }, [E(r3.$slots, `default`, { item: e2, index: n3 }, () => [t(S(a(A)(e2, s2.labelKey)), 1)])], 2)) : D(``, true), E(r3.$slots, `trailing`, { item: e2, index: n3, ui: x2.value }, () => {
              var _a6, _b3, _c, _d;
              return [e2.badge || e2.badge === 0 ? (v(), C(q, m({ key: 0, color: `neutral`, variant: `outline`, size: ((_a6 = e2.ui) == null ? void 0 : _a6.trailingBadgeSize) || ((_b3 = a(g2)) == null ? void 0 : _b3.trailingBadgeSize) || x2.value.trailingBadgeSize() }, { ref_for: true }, typeof e2.badge == `string` || typeof e2.badge == `number` ? { label: e2.badge } : e2.badge, { "data-slot": `trailingBadge`, class: x2.value.trailingBadge({ class: [(_c = a(g2)) == null ? void 0 : _c.trailingBadge, (_d = e2.ui) == null ? void 0 : _d.trailingBadge] }) }), null, 16, [`size`, `class`])) : D(``, true)];
            })];
          }), _: 2 }, 1032, [`value`, `disabled`, `class`]);
        }), 128)), E(r3.$slots, `list-trailing`)];
      }), _: 3 }, 8, [`class`]), n2.content ? (v(true), u(y, { key: 0 }, d(n2.items, (e2, n3) => {
        var _a3, _b;
        return v(), C(a(me), { key: n3, value: a(A)(e2, s2.valueKey) ?? String(n3), "data-slot": `content`, class: c(x2.value.content({ class: [(_a3 = a(g2)) == null ? void 0 : _a3.content, (_b = e2.ui) == null ? void 0 : _b.content, e2.class] })) }, { default: b(() => [E(r3.$slots, e2.slot || `content`, { item: e2, index: n3, ui: x2.value }, () => [t(S(e2.content), 1)])]), _: 2 }, 1032, [`value`, `class`]);
      }), 128)) : D(``, true)];
  ...
  function pe2() {
    d2.value === `text` ? _2() : d2.value === `font` && L2();
  }
  function Q2(e2) {

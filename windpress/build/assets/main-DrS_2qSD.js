...
import { c as E, i as re } from "./intellisense-BqSPmEm7.js";
import "./tailwindcss-CdApilZd.js";
import { t as D } from "./logger-CvF98D4V.js";
import { t as O } from "./_plugin-vue_export-helper-BDNMzG2s.js";
import { n as ie, t as k } from "./constant-Bodr-Y8K.js";
import { a as ae, i as oe, n as se, r as ce, t as A } from "./chevron-right-BCavwTU8.js";
var j = { id: `windpressbreakdance-variable-app-header`, class: `header-container cursor:grab bb:1|solid|$(gray200)` }, M = { class: `header-content flex gap:10 align-items:center fg:var(dark)` }, N = { class: `header-logo flex align-items:center px:12 py:2` }, P = { class: `header-title text-transform:none font:medium text:center flex-grow:1 gap:10 align-items:center cursor:default px:12 py:2` }, F = O({ __name: `PanelHeader`, setup(c2) {
  ...
  return new MutationObserver((e3) => {
    ...
    o2();
  }), (e3, i2) => s((h(), u(`div`, { id: `windpressbreakdance-variable-app-container`, ref_key: `containerRef`, ref: r2, class: `v-application flex flex:column w:full h:full` }, [t(F), (h(), y(m, null, { default: _(() => [t(_e)]), _: 1 }))], 512)), [[ee, a(n2)]]);

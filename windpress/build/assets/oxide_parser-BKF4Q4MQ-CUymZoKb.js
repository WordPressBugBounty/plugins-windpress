...
function t() {
  return { __proto__: null, "./oxide_parser_bg.js": { __proto__: null, __wbg___wbindgen_string_get_d109740c0d18f4d7: function(e2, t2) {
  ...
  }, __wbg___wbindgen_throw_9c31b086c2b26051: function(e2, t2) {
    throw Error(o(e2, t2));
  }, __wbg_from_fa561fa561dc8031: function(e2) {
    return n(Array.from(l(e2)));
  }, __wbg_get_98fdf51d029a75eb: function(e2, t2) {
    let r2 = l(e2)[t2 >>> 0];
    return n(r2);
  }, __wbg_isArray_94898ed3aad6947b: function(e2) {
    return Array.isArray(l(e2));
  }, __wbg_length_2591a0f4f659a55c: function(e2) {
    return l(e2).length;
  }, __wbg_new_310879b66b6e95e1: function() {
    return n([]);
  }, __wbg_new_with_length_c2a8f9ac6aaaac03: function(e2) {
    return n(Array(e2 >>> 0));
  }, __wbg_set_78ea6a19f4818587: function(e2, t2, n2) {
    l(e2)[t2 >>> 0] = m(n2);
...
async function T(e2) {
  if (x !== void 0) return x;
  e2 !== void 0 && (Object.getPrototypeOf(e2) === Object.prototype ? { module_or_path: e2 } = e2 : console.warn(`using deprecated parameters for the initialization function; pass a single object instead`)), e2 === void 0 && (e2 = new URL(`` + new URL(`oxide_parser_bg-0VF7nXPX.wasm`, import.meta.url).href, `` + import.meta.url));
  let n2 = t();

...
import { n as t, t as n } from "./dist-DUC9kpkj.js";
import { n as r, t as i } from "./dist-u5p_KAIj.js";
...
var v = class {
  ...
  extends(e12) {
    return this === e12 || this.parent !== null && this.parent.extends(e12);
  }
...
function qe(e12, t2, n2, r2, i2, a2, o2, s2) {
  let c2 = t2.content.length, l2 = false, u2 = -1;
  if (o2) {
    let o3 = Je(e12, t2, n2, r2, i2, a2);
    i2 = o3.stack, r2 = o3.linePos, n2 = o3.isFirstLine, u2 = o3.anchorPosition;
  }
  let d2 = Date.now();
  for (; !l2; ) {
    if (s2 !== 0 && Date.now() - d2 > s2) return new Ke(i2, true);
    f2();
  }
  return new Ke(i2, false);
  function f2() {
    let o3 = Ye(e12, t2, n2, r2, i2, u2);
    if (!o3) {
...
function Je(e12, t2, n2, r2, i2, a2) {
  ...
  for (let c2 = s2.pop(); c2; c2 = s2.pop()) {
    let { ruleScanner: s3, findOptions: l2 } = $e(c2.rule, e12, c2.stack.endRule, n2, r2 === o2), u2 = s3.findNextMatchSync(t2, r2, l2);
    if (u2) {
      if (u2.ruleId !== Ne) {
        i2 = c2.stack.pop();
        break;
...
function Ye(e12, t2, n2, r2, i2, a2) {
  let o2 = Xe(e12, t2, n2, r2, i2, a2), s2 = e12.getInjections();
  if (s2.length === 0) return o2;
  let c2 = Ze(s2, e12, t2, n2, r2, i2, a2);
  if (!c2) return o2;
  if (!o2) return c2;
...
function Xe(e12, t2, n2, r2, i2, a2) {
  let { ruleScanner: o2, findOptions: s2 } = Qe(i2.getRule(e12), e12, i2.endRule, n2, r2 === a2), c2 = o2.findNextMatchSync(t2, r2, s2);
  return c2 ? { captureIndices: c2.captureIndices, matchedRuleId: c2.ruleId } : null;
}
function Ze(e12, t2, n2, r2, i2, a2, o2) {
  ...
  for (let a3 = 0, f2 = e12.length; a3 < f2; a3++) {
    ...
    let { ruleScanner: p2, findOptions: m2 } = Qe(t2.getRule(f3.ruleId), t2, null, r2, i2 === o2), h2 = p2.findNextMatchSync(n2, i2, m2);
    if (!h2) continue;
...
function Qe(e12, t2, n2, r2, i2) {
  return { ruleScanner: e12.compileAG(t2, n2, r2, i2), findOptions: 0 };
}
function $e(e12, t2, n2, r2, i2) {
  return { ruleScanner: e12.compileWhileAG(t2, n2, r2, i2), findOptions: 0 };
}
function E(e12, t2, n2, r2, i2, a2, o2) {
  ...
  for (let t3 = 0; t3 < c2; t3++) {
    ...
    if (l2.length > 0 ? i2.produceFromScopes(l2[l2.length - 1].scopes, d2.start) : i2.produce(r2, d2.start), c3.retokenizeCapturedWithRuleId) {
      ...
      qe(e12, p2, n2 && d2.start === 0, d2.start, f3, i2, false, 0), ge(p2);
      continue;
    }
...
function nt(e12, t2, n2, r2, i2) {
  let a2 = pe(t2, D), o2 = Ve.getCompiledRuleId(n2, r2, i2.repository);
...
var it = class {
  ...
  _tokenize(e12, t2, n2, r2) {
    ...
    if (!t2 || t2 === ot.NULL) {
      ...
      o3 = a3 ? O.createRootAndLookUpScopeName(a3, r3, this) : O.createRoot(`unknown`, r3), t2 = new ot(null, this._rootId, -1, -1, false, null, o3, o3);
    } else i2 = false, t2.reset();
    e12 += `
`;
    let a2 = this.createOnigString(e12), o2 = a2.content.length, s2 = new ct(n2, e12, this._tokenTypeMatchers, this.balancedBracketSelectors), c2 = qe(this, a2, i2, 0, t2, s2, true, r2);
...
var O = class e8 {
  ...
  static createRootAndLookUpScopeName(t2, n2, r2) {
    let i2 = r2.getMetadataForScope(t2), a2 = new ee(null, t2), o2 = r2.themeProvider.themeMatch(a2), s2 = e8.mergeAttributes(n2, i2, o2);
  ...
  equals(t2) {
    return t2 !== null && _b._equals(this, t2);
  }
  ...
  constructor(e12, t2) {
    ...
    this.balancedBracketScopes = e12.flatMap((e13) => e13 === `*` ? (this.allowAny = true, []) : pe(e13, D).map((e14) => e14.matcher)), this.unbalancedBracketScopes = t2.flatMap((e13) => pe(e13, D).map((e14) => e14.matcher));
  }
  get matchesAlways() {
...
var _t = { light: `#333333`, dark: `#bbbbbb` }, vt = { light: `#fffffe`, dark: `#1e1e1e` }, yt = `__shiki_resolved`;
function bt(e12) {
  if (e12?.[yt]) return e12;
  let t2 = { ...e12 };
  ...
  if (!n2 || !r2) {
    ...
    e13?.settings?.foreground && (r2 = e13.settings.foreground), e13?.settings?.background && (n2 = e13.settings.background), !r2 && t2?.colors?.[`editor.foreground`] && (r2 = t2.colors[`editor.foreground`]), !n2 && t2?.colors?.[`editor.background`] && (n2 = t2.colors[`editor.background`]), r2 || (r2 = t2.type === `light` ? _t.light : _t.dark), n2 || (n2 = t2.type === `light` ? vt.light : vt.dark), t2.fg = r2, t2.bg = n2;
  }
  ...
  return Object.defineProperty(t2, yt, { enumerable: false, writable: false, value: true }), t2;
}
async function xt(e12) {
  return [...new Set((await Promise.all(e12.filter((e13) => !mt(e13)).map(async (e13) => await pt(e13).then((e14) => Array.isArray(e14) ? e14 : [e14])))).flat())];
}
async function St(e12) {
  return (await Promise.all(e12.map(async (e13) => ht(e13) ? null : bt(await pt(e13))))).filter((e13) => !!e13);
}
function Ct(e12, t2) {
  if (!t2) return e12;
  if (t2[e12]) {
...
var wt = class extends ut {
  ...
  getGrammar(e12) {
    return e12 = Ct(e12, this._alias), this._resolvedGrammars.get(e12);
  }
  loadLanguage(e12) {
...
function Et(e12) {
  ...
  let n2 = (e12.langs || []).flat(1), r2 = (e12.themes || []).flat(1).map(bt), i2 = new wt(new Tt(e12.engine, n2), r2, n2, e12.langAlias), o2;
  function s2(t3) {
    return Ct(t3, e12.langAlias);
  }
  function c2(e13) {
    _2();
...
async function Dt(e12) {
  ...
  let [t2, n2, r2] = await Promise.all([St(e12.themes || []), xt(e12.langs || []), e12.engine]);
  return Et({ ...e12, themes: t2, langs: n2, engine: r2 });
}
...
function Pt(...e12) {
  ...
  return new L(It(n2, l2, s2, c2, r2).stateStack, l2.name, s2.name);
}
function Ft(e12, t2, n2, r2, i2) {
  let a2 = It(e12, t2, n2, r2, i2), o2 = new L(a2.stateStack, t2.name, n2.name);
  return F(a2.tokens, o2), a2.tokens;
}
function It(e12, t2, n2, r2, i2) {
  let a2 = k(n2, i2), { tokenizeMaxLineLength: o2 = 0, tokenizeTimeLimit: s2 = 500, includeExplanation: c2 = false } = i2, l2 = N(e12), u2 = i2.grammarState ? At(i2.grammarState, n2.name) ?? dt : i2.grammarContextCode == null ? dt : It(i2.grammarContextCode, t2, n2, r2, { ...i2, grammarState: void 0, grammarContextCode: void 0 }).stateStack, d2 = [], f2 = [];
  for (let e13 = 0, i3 = l2.length; e13 < i3; e13++) {
    let [i4, p2] = l2[e13];
    if (i4 === ``) {
      d2 = [], f2.push([]);
      continue;
    }
    if (o2 > 0 && i4.length >= o2) {
      d2 = [], f2.push([{ content: i4, offset: p2, color: ``, fontStyle: 0 }]);
      continue;
    }
    let m2, h2, g2;
    c2 && c2 !== `tokenType` && (m2 = t2.tokenizeLine(i4, u2, s2), h2 = m2.tokens, g2 = 0);
    let _2 = t2.tokenizeLine2(i4, u2, s2), v2 = _2.tokens.length / 2;
    for (let e14 = 0; e14 < v2; e14++) {
      let t3 = _2.tokens[2 * e14], o3 = e14 + 1 < v2 ? _2.tokens[2 * e14 + 2] : i4.length;
      if (t3 === o3) continue;
      let s3 = _2.tokens[2 * e14 + 1], l3 = A(r2[x.getForeground(s3)], a2), u3 = x.getFontStyle(s3), f3 = { content: i4.substring(t3, o3), offset: p2 + t3, color: l3, fontStyle: u3 };
      if (c2 === `tokenType`) f3.type = x.getTokenType(s3);
      else if (c2) {
        let e15 = [];
        if (c2 !== `scopeName`) for (let t4 of n2.settings) {
          let n3;
          switch (typeof t4.scope) {
            case `string`:
              n3 = t4.scope.split(jt).map((e16) => e16.trim());
              break;
            case `object`:
              n3 = t4.scope;
              break;
          ...
          e15.push({ settings: t4, selectors: n3.map((e16) => e16.split(Mt)) });
        }
        f3.explanation = [];
        let r3 = 0;
        for (; t3 + r3 < o3; ) {
          let t4 = h2[g2], n3 = i4.substring(t4.startIndex, t4.endIndex);
          r3 += n3.length, f3.explanation.push({ content: n3, scopes: c2 === `scopeName` ? Lt(t4.scopes) : Rt(e15, t4.scopes) }), g2 += 1;
        }
      }
      d2.push(f3);
    }
    f2.push(d2), d2 = [], u2 = _2.ruleStack;
  }
  return { tokens: f2, stateStack: u2 };
}
function Lt(e12) {
...
function Rt(e12, t2) {
  ...
  for (let r2 = 0, i2 = t2.length; r2 < i2; r2++) {
    let i3 = t2[r2];
    n2[r2] = { scopeName: i3, themeMatches: Vt(e12, i3, t2.slice(0, r2)) };
  }
  return n2;
}
function zt(e12, t2) {
...
function Bt(e12, t2, n2) {
  if (!zt(e12.at(-1), t2)) return false;
  let r2 = e12.length - 2, i2 = n2.length - 1;
  for (; r2 >= 0 && i2 >= 0; ) zt(e12[r2], n2[i2]) && --r2, --i2;
  return r2 === -1;
}
function Vt(e12, t2, n2) {
  let r2 = [];
  for (let { selectors: i2, settings: a2 } of e12) for (let e13 of i2) if (Bt(e13, t2, n2)) {
    r2.push(a2);
    break;
  }
  return r2;
}
function Ht(e12, t2, n2, r2 = Nt) {
  ...
  }), o2 = Ut(...a2.map((e13) => e13.tokens)), s2 = o2[0].map((e13, t3) => e13.map((e14, r3) => {
...
var Wt = [`area`, `base`, `basefont`, `bgsound`, `br`, `col`, `command`, `embed`, `frame`, `hr`, `image`, `img`, `input`, `keygen`, `link`, `meta`, `param`, `source`, `track`, `wbr`], R = class {
  constructor(e12, t2, n2) {
...
var mn = Gt([$t, nn, an, on, sn], `html`), hn = Gt([$t, rn, an, on, sn], `svg`), gn = {}.hasOwnProperty;
function _n(e12, t2) {
  let n2 = t2 || {};
  function r2(t3, ...n3) {
    let i2 = r2.invalid, a2 = r2.handlers;
    if (t3 && gn.call(t3, e12)) {
      let n4 = String(t3[e12]);
      i2 = gn.call(a2, n4) ? a2[n4] : r2.unknown;
    }
    if (i2) return i2.call(this, t3, ...n3);
  }
  return r2.handlers = n2.handlers || {}, r2.invalid = n2.invalid, r2.unknown = n2.unknown, r2;
}
var vn = /["&'<>`]/g, yn = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g, bn = /[\x01-\t\v\f\x0E-\x1F\x7F\x81\x8D\x8F\x90\x9D\xA0-\uFFFF]/g, xn = /[|\\{}()[\]^$+*?.]/g, Sn = /* @__PURE__ */ new WeakMap();
function Cn(e12, t2) {
  if (e12 = e12.replace(t2.subset ? wn(t2.subset) : vn, r2), t2.subset || t2.escapeOnly) return e12;
  return e12.replace(yn, n2).replace(bn, r2);
...
function wn(e12) {
  let t2 = Sn.get(e12);
  return t2 || (t2 = Tn(e12), Sn.set(e12, t2)), t2;
}
function Tn(e12) {
  let t2 = [], n2 = -1;
  for (; ++n2 < e12.length; ) t2.push(e12[n2].replace(xn, `\\$&`));
  return RegExp(`(?:` + t2.join(`|`) + `)`, `g`);
}
var En = /[\dA-Fa-f]/;
function Dn(e12, t2, n2) {
  let r2 = `&#x` + e12.toString(16).toUpperCase();
  return n2 && t2 && !En.test(String.fromCharCode(t2)) ? r2 : r2 + `;`;
}
var On = /\d/;
function kn(e12, t2, n2) {
  let r2 = `&#` + String(e12);
  return n2 && t2 && !On.test(String.fromCharCode(t2)) ? r2 : r2 + `;`;
}
var An = `AElig.AMP.Aacute.Acirc.Agrave.Aring.Atilde.Auml.COPY.Ccedil.ETH.Eacute.Ecirc.Egrave.Euml.GT.Iacute.Icirc.Igrave.Iuml.LT.Ntilde.Oacute.Ocirc.Ograve.Oslash.Otilde.Ouml.QUOT.REG.THORN.Uacute.Ucirc.Ugrave.Uuml.Yacute.aacute.acirc.acute.aelig.agrave.amp.aring.atilde.auml.brvbar.ccedil.cedil.cent.copy.curren.deg.divide.eacute.ecirc.egrave.eth.euml.frac12.frac14.frac34.gt.iacute.icirc.iexcl.igrave.iquest.iuml.laquo.lt.macr.micro.middot.nbsp.not.ntilde.oacute.ocirc.ograve.ordf.ordm.oslash.otilde.ouml.para.plusmn.pound.quot.raquo.reg.sect.shy.sup1.sup2.sup3.szlig.thorn.times.uacute.ucirc.ugrave.uml.uuml.yacute.yen.yuml`.split(`.`), jn = { nbsp: `\xA0`, iexcl: `\xA1`, cent: `\xA2`, pound: `\xA3`, curren: `\xA4`, yen: `\xA5`, brvbar: `\xA6`, sect: `\xA7`, uml: `\xA8`, copy: `\xA9`, ordf: `\xAA`, laquo: `\xAB`, not: `\xAC`, shy: `\xAD`, reg: `\xAE`, macr: `\xAF`, deg: `\xB0`, plusmn: `\xB1`, sup2: `\xB2`, sup3: `\xB3`, acute: `\xB4`, micro: `\xB5`, para: `\xB6`, middot: `\xB7`, cedil: `\xB8`, sup1: `\xB9`, ordm: `\xBA`, raquo: `\xBB`, frac14: `\xBC`, frac12: `\xBD`, frac34: `\xBE`, iquest: `\xBF`, Agrave: `\xC0`, Aacute: `\xC1`, Acirc: `\xC2`, Atilde: `\xC3`, Auml: `\xC4`, Aring: `\xC5`, AElig: `\xC6`, Ccedil: `\xC7`, Egrave: `\xC8`, Eacute: `\xC9`, Ecirc: `\xCA`, Euml: `\xCB`, Igrave: `\xCC`, Iacute: `\xCD`, Icirc: `\xCE`, Iuml: `\xCF`, ETH: `\xD0`, Ntilde: `\xD1`, Ograve: `\xD2`, Oacute: `\xD3`, Ocirc: `\xD4`, Otilde: `\xD5`, Ouml: `\xD6`, times: `\xD7`, Oslash: `\xD8`, Ugrave: `\xD9`, Uacute: `\xDA`, Ucirc: `\xDB`, Uuml: `\xDC`, Yacute: `\xDD`, THORN: `\xDE`, szlig: `\xDF`, agrave: `\xE0`, aacute: `\xE1`, acirc: `\xE2`, atilde: `\xE3`, auml: `\xE4`, aring: `\xE5`, aelig: `\xE6`, ccedil: `\xE7`, egrave: `\xE8`, eacute: `\xE9`, ecirc: `\xEA`, euml: `\xEB`, igrave: `\xEC`, iacute: `\xED`, icirc: `\xEE`, iuml: `\xEF`, eth: `\xF0`, ntilde: `\xF1`, ograve: `\xF2`, oacute: `\xF3`, ocirc: `\xF4`, otilde: `\xF5`, ouml: `\xF6`, divide: `\xF7`, oslash: `\xF8`, ugrave: `\xF9`, uacute: `\xFA`, ucirc: `\xFB`, uuml: `\xFC`, yacute: `\xFD`, thorn: `\xFE`, yuml: `\xFF`, fnof: `\u0192`, Alpha: `\u0391`, Beta: `\u0392`, Gamma: `\u0393`, Delta: `\u0394`, Epsilon: `\u0395`, Zeta: `\u0396`, Eta: `\u0397`, Theta: `\u0398`, Iota: `\u0399`, Kappa: `\u039A`, Lambda: `\u039B`, Mu: `\u039C`, Nu: `\u039D`, Xi: `\u039E`, Omicron: `\u039F`, Pi: `\u03A0`, Rho: `\u03A1`, Sigma: `\u03A3`, Tau: `\u03A4`, Upsilon: `\u03A5`, Phi: `\u03A6`, Chi: `\u03A7`, Psi: `\u03A8`, Omega: `\u03A9`, alpha: `\u03B1`, beta: `\u03B2`, gamma: `\u03B3`, delta: `\u03B4`, epsilon: `\u03B5`, zeta: `\u03B6`, eta: `\u03B7`, theta: `\u03B8`, iota: `\u03B9`, kappa: `\u03BA`, lambda: `\u03BB`, mu: `\u03BC`, nu: `\u03BD`, xi: `\u03BE`, omicron: `\u03BF`, pi: `\u03C0`, rho: `\u03C1`, sigmaf: `\u03C2`, sigma: `\u03C3`, tau: `\u03C4`, upsilon: `\u03C5`, phi: `\u03C6`, chi: `\u03C7`, psi: `\u03C8`, omega: `\u03C9`, thetasym: `\u03D1`, upsih: `\u03D2`, piv: `\u03D6`, bull: `\u2022`, hellip: `\u2026`, prime: `\u2032`, Prime: `\u2033`, oline: `\u203E`, frasl: `\u2044`, weierp: `\u2118`, image: `\u2111`, real: `\u211C`, trade: `\u2122`, alefsym: `\u2135`, larr: `\u2190`, uarr: `\u2191`, rarr: `\u2192`, darr: `\u2193`, harr: `\u2194`, crarr: `\u21B5`, lArr: `\u21D0`, uArr: `\u21D1`, rArr: `\u21D2`, dArr: `\u21D3`, hArr: `\u21D4`, forall: `\u2200`, part: `\u2202`, exist: `\u2203`, empty: `\u2205`, nabla: `\u2207`, isin: `\u2208`, notin: `\u2209`, ni: `\u220B`, prod: `\u220F`, sum: `\u2211`, minus: `\u2212`, lowast: `\u2217`, radic: `\u221A`, prop: `\u221D`, infin: `\u221E`, ang: `\u2220`, and: `\u2227`, or: `\u2228`, cap: `\u2229`, cup: `\u222A`, int: `\u222B`, there4: `\u2234`, sim: `\u223C`, cong: `\u2245`, asymp: `\u2248`, ne: `\u2260`, equiv: `\u2261`, le: `\u2264`, ge: `\u2265`, sub: `\u2282`, sup: `\u2283`, nsub: `\u2284`, sube: `\u2286`, supe: `\u2287`, oplus: `\u2295`, otimes: `\u2297`, perp: `\u22A5`, sdot: `\u22C5`, lceil: `\u2308`, rceil: `\u2309`, lfloor: `\u230A`, rfloor: `\u230B`, lang: `\u2329`, rang: `\u232A`, loz: `\u25CA`, spades: `\u2660`, clubs: `\u2663`, hearts: `\u2665`, diams: `\u2666`, quot: `"`, amp: `&`, lt: `<`, gt: `>`, OElig: `\u0152`, oelig: `\u0153`, Scaron: `\u0160`, scaron: `\u0161`, Yuml: `\u0178`, circ: `\u02C6`, tilde: `\u02DC`, ensp: `\u2002`, emsp: `\u2003`, thinsp: `\u2009`, zwnj: `\u200C`, zwj: `\u200D`, lrm: `\u200E`, rlm: `\u200F`, ndash: `\u2013`, mdash: `\u2014`, lsquo: `\u2018`, rsquo: `\u2019`, sbquo: `\u201A`, ldquo: `\u201C`, rdquo: `\u201D`, bdquo: `\u201E`, dagger: `\u2020`, Dagger: `\u2021`, permil: `\u2030`, lsaquo: `\u2039`, rsaquo: `\u203A`, euro: `\u20AC` }, Mn = [`cent`, `copy`, `divide`, `gt`, `lt`, `not`, `para`, `times`], Nn = {}.hasOwnProperty, Pn = {}, Fn;
for (Fn in jn) Nn.call(jn, Fn) && (Pn[jn[Fn]] = Fn);
var In = /[^\dA-Za-z]/;
function Ln(e12, t2, n2, r2) {
  let i2 = String.fromCharCode(e12);
  if (Nn.call(Pn, i2)) {
    let e13 = Pn[i2], a2 = `&` + e13;
    return n2 && An.includes(e13) && !Mn.includes(e13) && (!r2 || t2 && t2 !== 61 && In.test(String.fromCharCode(t2))) ? a2 : a2 + `;`;
  }
  return ``;
}
function Rn(e12, t2, n2) {
  let r2 = Dn(e12, t2, n2.omitOptionalSemicolons), i2;
  if ((n2.useNamedReferences || n2.useShortestReferences) && (i2 = Ln(e12, t2, n2.omitOptionalSemicolons, n2.attribute)), (n2.useShortestReferences || !i2) && n2.useShortestReferences) {
    let i3 = kn(e12, t2, n2.omitOptionalSemicolons);
    i3.length < r2.length && (r2 = i3);
  }
  return i2 && (!n2.useShortestReferences || i2.length < r2.length) ? i2 : r2;
}
function J(e12, t2) {
  return Cn(e12, Object.assign({ format: Rn }, t2));
}
var zn = /^>|^->|<!--|-->|--!>|<!-$/g, Bn = [`>`], Vn = [`<`, `>`];
function Hn(e12, t2, n2, r2) {
  return r2.settings.bogusComments ? `<?` + J(e12.value, Object.assign({}, r2.settings.characterReferences, { subset: Bn })) + `>` : `<!--` + e12.value.replace(zn, i2) + `-->`;
  function i2(e13) {
    return J(e13, Object.assign({}, r2.settings.characterReferences, { subset: Vn }));
  }
}
...
var qn = /[ \t\n\f\r]/g;
function Jn(e12) {
  return typeof e12 == `object` ? e12.type === `text` && Yn(e12.value) : Yn(e12);
}
function Yn(e12) {
  return e12.replace(qn, ``) === ``;
}
var Y = Qn(1), Xn = Qn(-1), Zn = [];
function Qn(e12) {
  return t2;
  function t2(t3, n2, r2) {
    let i2 = t3 ? t3.children : Zn, a2 = (n2 || 0) + e12, o2 = i2[a2];
    if (!r2) for (; o2 && Jn(o2); ) a2 += e12, o2 = i2[a2];
    return o2;
  }
}
...
function er(e12) {
  return t2;
  function t2(t3, n2, r2) {
    return $n.call(e12, t3.tagName) && e12[t3.tagName](t3, n2, r2);
  }
}
var tr = er({ body: ir, caption: nr, colgroup: nr, dd: cr, dt: sr, head: nr, html: rr, li: or, optgroup: ur, option: dr, p: ar, rp: lr, rt: lr, tbody: pr, td: gr, tfoot: mr, th: gr, thead: fr, tr: hr });
function nr(e12, t2, n2) {
  let r2 = Y(n2, t2, true);
  return !r2 || r2.type !== `comment` && !(r2.type === `text` && Jn(r2.value.charAt(0)));
}
...
var _r = er({ body: br, colgroup: xr, head: yr, html: vr, tbody: Sr });
function vr(e12) {
  let t2 = Y(e12, -1);
...
function br(e12) {
  let t2 = Y(e12, -1, true);
  return !t2 || t2.type !== `comment` && !(t2.type === `text` && Jn(t2.value.charAt(0))) && !(t2.type === `element` && (t2.tagName === `meta` || t2.tagName === `link` || t2.tagName === `script` || t2.tagName === `style` || t2.tagName === `template`));
}
function xr(e12, t2, n2) {
  let r2 = Xn(n2, t2), i2 = Y(e12, -1, true);
  return n2 && r2 && r2.type === `element` && r2.tagName === `colgroup` && tr(r2, n2.children.indexOf(r2), n2) ? false : !!(i2 && i2.type === `element` && i2.tagName === `col`);
}
function Sr(e12, t2, n2) {
  let r2 = Xn(n2, t2), i2 = Y(e12, -1);
  return n2 && r2 && r2.type === `element` && (r2.tagName === `thead` || r2.tagName === `tbody`) && tr(r2, n2.children.indexOf(r2), n2) ? false : !!(i2 && i2.type === `element` && i2.tagName === `tr`);
}
var Cr = { name: [[`	
\f\r &/=>`.split(``), `	
\f\r "&'/=>\``.split(``)], [`\0	
...
function wr(e12, t2, n2, r2) {
  let i2 = r2.schema, a2 = i2.space !== `svg` && r2.settings.omitOptionalTags, o2 = i2.space === `svg` ? r2.settings.closeEmptyElements : r2.settings.voids.includes(e12.tagName.toLowerCase()), s2 = [], c2;
  i2.space === `html` && e12.tagName === `svg` && (r2.schema = hn);
  let l2 = Tr(r2, e12.properties), u2 = r2.all(i2.space === `html` && e12.tagName === `template` ? e12.content : e12);
  return r2.schema = i2, u2 && (o2 = false), (l2 || !a2 || !_r(e12, t2, n2)) && (s2.push(`<`, e12.tagName, l2 ? ` ` + l2 : ``), o2 && (i2.space === `svg` || r2.settings.closeSelfClosing) && (c2 = l2.charAt(l2.length - 1), (!r2.settings.tightSelfClosing || c2 === `/` || c2 && c2 !== `"` && c2 !== `'`) && s2.push(` `), s2.push(`/`)), s2.push(`>`)), s2.push(u2), !o2 && (!a2 || !tr(e12, t2, n2)) && s2.push(`</` + e12.tagName + `>`), s2.join(``);
}
function Tr(e12, t2) {
  let n2 = [], r2 = -1, i2;
  if (t2) {
    for (i2 in t2) if (t2[i2] !== null && t2[i2] !== void 0) {
      let r3 = Er(e12, i2, t2[i2]);
      r3 && n2.push(r3);
    }
  }
  for (; ++r2 < n2.length; ) {
...
function Er(e12, t2, n2) {
  let r2 = dn(e12.schema, t2), i2 = e12.settings.allowParseErrors && e12.schema.space === `html` ? 0 : 1, a2 = +!e12.settings.allowDangerousCharacters, o2 = e12.quote, s2;
  ...
  let c2 = J(r2.attribute, Object.assign({}, e12.settings.characterReferences, { subset: Cr.name[i2][a2] }));
  return n2 === true || (n2 = Array.isArray(n2) ? (r2.commaSeparated ? Gn : Kn)(n2, { padLeft: !e12.settings.tightCommaSeparatedLists }) : String(n2), e12.settings.collapseEmptyAttributes && !n2) ? c2 : (e12.settings.preferUnquoted && (s2 = J(n2, Object.assign({}, e12.settings.characterReferences, { attribute: true, subset: Cr.unquoted[i2][a2] }))), s2 !== n2 && (e12.settings.quoteSmart && Wn(n2, o2) > Wn(n2, e12.alternative) && (o2 = e12.alternative), s2 = o2 + J(n2, Object.assign({}, e12.settings.characterReferences, { subset: (o2 === `'` ? Cr.single : Cr.double)[i2][a2], attribute: true })) + o2), c2 + (s2 && `=` + s2));
}
var Dr = [`<`, `&`];
function Or(e12, t2, n2, r2) {
  return n2 && n2.type === `element` && (n2.tagName === `script` || n2.tagName === `style`) ? e12.value : J(e12.value, Object.assign({}, r2.settings.characterReferences, { subset: Dr }));
}
function kr(e12, t2, n2, r2) {
  return r2.settings.allowDangerousHtml ? e12.value : Or(e12, t2, n2, r2);
}
function Ar(e12, t2, n2, r2) {
  return r2.all(e12);
}
var jr = _n(`type`, { invalid: Mr, unknown: Nr, handlers: { comment: Hn, doctype: Un, element: wr, raw: kr, root: Ar, text: Or } });
function Mr(e12) {
...
function Vr(e12, t2) {
  var _a2;
  if (!t2) return e12;
  e12.properties || (e12.properties = {}), (_a2 = e12.properties).class || (_a2.class = []), typeof e12.properties.class == `string` && (e12.properties.class = e12.properties.class.split(Br)), Array.isArray(e12.properties.class) || (e12.properties.class = []);
  let n2 = Array.isArray(t2) ? t2 : t2.split(Br);
...
function Gr(e12, t2) {
  ...
  return n2.length ? e12.map((e13) => e13.flatMap((e14) => {
    ...
    return t3.length ? Wr(e14, t3) : e14;
  })) : e12;
}
function Kr(e12, t2, n2, r2, i2 = `css-vars`) {
  let o2 = { content: e12.content, explanation: e12.explanation, offset: e12.offset }, s2 = t2.map((t3) => X(e12.variants[t3])), c2 = new Set(s2.flatMap((e13) => Object.keys(e13))), l2 = {}, u2 = (e13, r3) => {
  ...
  return s2.forEach((e13, n3) => {
    for (let o3 of c2) {
      ...
      if (n3 === 0 && r2 && Ur.includes(o3)) if (r2 === `light-dark()` && s2.length > 1) {
...
function Jr() {
  ...
  return { name: `shiki:decorations`, tokens(e13) {
    if (this.options.decorations?.length) return Gr(e13, t2(this).decorations.flatMap((e14) => [e14.start.offset, e14.end.offset]));
  }, code(e13) {
    ...
    function s2(e14, t3, n3) {
      ...
      return e14.tagName = t3.tagName || `span`, e14.properties = { ...e14.properties, ...r3, class: e14.properties.class }, t3.properties?.class && Vr(e14, t3.properties.class), e14 = i3(e14, n3) || e14, e14;
    }
...
var Z = [`black`, `red`, `green`, `yellow`, `blue`, `magenta`, `cyan`, `white`, `brightBlack`, `brightRed`, `brightGreen`, `brightYellow`, `brightBlue`, `brightMagenta`, `brightCyan`, `brightWhite`], ei = { 1: `bold`, 2: `dim`, 3: `italic`, 4: `underline`, 7: `reverse`, 8: `hidden`, 9: `strikethrough` };
function ti(e12, t2) {
...
function ri(e12) {
  ...
  for (; e12.length > 0; ) {
    ...
    } else if (r2 <= 37) t2.push({ type: `setForegroundColor`, value: { type: `named`, name: Z[r2 - 30] } });
    else if (r2 === 38) {
      let n3 = ni(e12);
      n3 && t2.push({ type: `setForegroundColor`, value: n3 });
    } else if (r2 === 39) t2.push({ type: `resetForegroundColor` });
    else if (r2 <= 47) t2.push({ type: `setBackgroundColor`, value: { type: `named`, name: Z[r2 - 40] } });
    else if (r2 === 48) {
      let n3 = ni(e12);
      n3 && t2.push({ type: `setBackgroundColor`, value: n3 });
    } else r2 === 49 ? t2.push({ type: `resetBackgroundColor` }) : r2 === 53 ? t2.push({ type: `setDecoration`, value: `overline` }) : r2 === 55 ? t2.push({ type: `resetDecoration`, value: `overline` }) : r2 >= 90 && r2 <= 97 ? t2.push({ type: `setForegroundColor`, value: { type: `named`, name: Z[r2 - 90 + 8] } }) : r2 >= 100 && r2 <= 107 && t2.push({ type: `setBackgroundColor`, value: { type: `named`, name: Z[r2 - 100 + 8] } });
  }
  return t2;
}
function ii() {
...
function oi(e12 = ai) {
  ...
  function i2() {
    if (r2) return r2;
    r2 = [];
    for (let e14 = 0; e14 < Z.length; e14++) r2.push(t2(Z[e14]));
...
var si = /#([0-9a-f]{3,8})/i, ci = /var\((--[\w-]+-ansi-[\w-]+)\)/, li = { black: `#000000`, red: `#cd3131`, green: `#0DBC79`, yellow: `#E5E510`, blue: `#2472C8`, magenta: `#BC3FBC`, cyan: `#11A8CD`, white: `#E5E5E5`, brightBlack: `#666666`, brightRed: `#F14C4C`, brightGreen: `#23D18B`, brightYellow: `#F5F543`, brightBlue: `#3B8EEA`, brightMagenta: `#D670D6`, brightCyan: `#29B8DB`, brightWhite: `#FFFFFF` };
function ui(e12, t2, n2) {
  let r2 = k(e12, n2), i2 = N(t2), a2 = oi(Object.fromEntries(Z.map((t3) => {
    let n3 = `terminal.ansi${t3[0].toUpperCase()}${t3.substring(1)}`;
    return [t3, e12.colors?.[n3] || li[t3]];
  }))), o2 = ii();
  return i2.map((t3) => o2.parse(t3[0]).map((n3) => {
    let i3, o3;
    n3.decorations.has(`reverse`) ? (i3 = n3.background ? a2.value(n3.background) : e12.bg, o3 = n3.foreground ? a2.value(n3.foreground) : e12.fg) : (i3 = n3.foreground ? a2.value(n3.foreground) : e12.fg, o3 = n3.background ? a2.value(n3.background) : void 0), i3 = A(i3, r2), o3 = A(o3, r2), n3.decorations.has(`dim`) && (i3 = di(i3));
    let s2 = b.None;
...
function pi(e12, t2, n2) {
  ...
  if (`themes` in n2) {
    ...
    let m2 = Ht(e12, t2, n2, fi);
    if (l2 = I(m2), u2 && u2 !== `light-dark()` && !p2.some((e13) => e13.color === u2)) throw new a(`\`themes\` option must contain the defaultColor key \`${u2}\``);
    let h2 = p2.map((t3) => e12.getTheme(t3.theme)), g2 = p2.map((e13) => e13.color);
    o2 = m2.map((e13) => e13.map((e14) => Kr(e14, g2, d2, u2, f2))), l2 && F(o2, l2);
    let _2 = p2.map((e13) => k(e13.theme, n2));
    i2 = mi(p2, h2, _2, d2, u2, `fg`, f2), r2 = mi(p2, h2, _2, d2, u2, `bg`, f2), s2 = `shiki-themes ${h2.map((e13) => e13.name).join(` `)}`, c2 = u2 ? void 0 : [i2, r2].join(`;`);
  } else if (`theme` in n2) {
...
function mi(e12, t2, n2, r2, i2, o2, s2) {
...
var hi = /^\s+$/, gi = /^(\s*)(.*?)(\s*)$/;
function _i(e12, t2, n2, r2 = { meta: {}, options: n2, codeToHast: (t3, n3) => _i(e12, t3, n3), codeToTokens: (t3, n3) => pi(e12, t3, n3) }) {
  let i2 = t2;
  for (let e13 of Qr(n2)) i2 = e13.preprocess?.call(r2, i2, n2) || i2;
  let { tokens: a2, fg: o2, bg: s2, themeName: c2, rootStyle: l2, grammarState: u2 } = pi(e12, i2, n2), { mergeWhitespaces: d2 = true, mergeSameStyleTokens: f2 = false } = n2;
  d2 === true ? a2 = yi(a2) : d2 === `never` && (a2 = bi(a2)), f2 && (a2 = xi(a2));
  let p2 = { ...r2, get source() {
    return i2;
  } };
  for (let e13 of Qr(n2)) a2 = e13.tokens?.call(p2, a2) || a2;
  return vi(a2, { ...n2, fg: o2, bg: s2, themeName: c2, rootStyle: n2.rootStyle === false ? false : n2.rootStyle ?? l2 }, p2, u2);
}
function vi(e12, t2, n2, r2 = I(e12)) {
  ...
  let u2 = { type: `element`, tagName: `pre`, properties: l2, children: [], data: t2.data }, d2 = { type: `element`, tagName: `code`, properties: {}, children: a2 }, f2 = [], p2 = { ...n2, structure: s2, addClassToHast: Vr, get source() {
    return n2.source;
  }, get tokens() {
    return e12;
  }, get options() {
...
` }));
    ...
    for (let a3 of e13) {
      let e14 = { type: `element`, tagName: `span`, properties: { ...a3.htmlAttrs }, children: [{ type: `text`, value: a3.content }] }, c3 = qr(a3.htmlStyle || X(a3));
...
function yi(e12) {
  return e12.map((e13) => {
    ...
    return e13.forEach((i2, a2) => {
      ...
      o2 && hi.test(i2.content) && e13[a2 + 1] ? (r2 === void 0 && (r2 = i2.offset), n2 += i2.content) : n2 ? (o2 ? t2.push({ ...i2, offset: r2, content: n2 + i2.content }) : t2.push({ content: n2, offset: r2 }, i2), r2 = void 0, n2 = ``) : t2.push(i2);
    }), t2;
  });
}
function bi(e12) {
  return e12.map((e13) => e13.flatMap((e14) => {
    if (hi.test(e14.content)) return e14;
    let t2 = e14.content.match(gi);
    if (!t2) return e14;
    let [, n2, r2, i2] = t2;
    if (!n2 && !i2) return e14;
...
function xi(e12) {
  return e12.map((e13) => {
    ...
    for (let n2 of e13) {
      ...
      let e14 = t2.at(-1), r2 = qr(e14.htmlStyle || X(e14)), i2 = qr(n2.htmlStyle || X(n2)), a2 = e14.fontStyle && (e14.fontStyle & b.Underline || e14.fontStyle & b.Strikethrough), o2 = n2.fontStyle && (n2.fontStyle & b.Underline || n2.fontStyle & b.Strikethrough);
...
function Ci(e12, t2, n2) {
  let r2 = { meta: {}, options: n2, codeToHast: (t3, n3) => _i(e12, t3, n3), codeToTokens: (t3, n3) => pi(e12, t3, n3) }, i2 = Si(_i(e12, t2, n2, r2));
  for (let e13 of Qr(n2)) i2 = e13.postprocess?.call(r2, i2, n2) || i2;
  return i2;
}
async function wi(e12) {
  let t2 = await Dt(e12);
  return { getLastGrammarState: (...e13) => Pt(t2, ...e13), codeToTokensBase: (e13, n2) => fi(t2, e13, n2), codeToTokensWithThemes: (e13, n2) => Ht(t2, e13, n2), codeToTokens: (e13, n2) => pi(t2, e13, n2), codeToHast: (e13, n2) => _i(t2, e13, n2), codeToHtml: (e13, n2) => Ci(t2, e13, n2), getBundledLanguages: () => ({}), getBundledThemes: () => ({}), ...t2, getInternalContext: () => t2 };
}
t();
...
var Oi = (e12, t2) => e12 + (t2 - e12 % t2) % t2;
async function ki(e12) {
  let t2, n2, r2 = {};
  function i2(e13) {
  ...
  function s2(e13) {
    ...
    for (let r3 = 1; r3 <= 4; r3 *= 2) {
      let i3 = t3 * (1 + 0.2 / r3);
      if (i3 = Math.min(i3, e13 + 100663296), o2(Math.min(n3, Oi(Math.max(e13, i3), 65536)))) return true;
    }
    return false;
  }
  ...
  let d2 = { emscripten_get_now: Di, emscripten_memcpy_big: a2, emscripten_resize_heap: s2, fd_write: () => 0 };
  async function f2() {
...
var Ai = Object.defineProperty, ji = (e12, t2, n2) => t2 in e12 ? Ai(e12, t2, { enumerable: true, configurable: true, writable: true, value: n2 }) : e12[t2] = n2, Q = (e12, t2, n2) => ji(e12, typeof t2 == `symbol` ? t2 : t2 + ``, n2), $ = null;
function Mi(e12) {
  throw new Ti(e12.UTF8ToString(e12.getLastOnigError()));
}
var Ni = class e10 {
  constructor(t2) {
  ...
  constructor(t2) {
    if (Q(this, `id`, ++e11.LAST_ID), Q(this, `_onigBinding`), Q(this, `content`), Q(this, `utf16Length`), Q(this, `utf8Length`), Q(this, `utf16OffsetToUtf8`), Q(this, `utf8OffsetToUtf16`), Q(this, `ptr`), !$) throw new Ti(`Must invoke loadWasm first.`);
...
Q(Pi, `LAST_ID`, 0), Q(Pi, `_sharedPtr`, 0), Q(Pi, `_sharedPtrInUse`, false);
var Fi = Pi, Ii = class {
  constructor(e12) {
    if (Q(this, `_onigBinding`), Q(this, `_ptr`), !$) throw new Ti(`Must invoke loadWasm first.`);
    let t2 = [], n2 = [];
    for (let r3 = 0, i3 = e12.length; r3 < i3; r3++) {
      let i4 = new Ni(e12[r3]);
    ...
    $.ofree(i2), $.ofree(r2), a2 === 0 && Mi($), this._onigBinding = $, this._ptr = a2;
  }
  dispose() {
...
function Ui(e12) {
  ...
  async function t2() {
    $ = await ki(async (t3) => {
      let n2 = e12;
      return n2 = await n2, typeof n2 == `function` && (n2 = await n2(t3)), typeof n2 == `function` && (n2 = await n2(t3)), Li(n2) ? n2 = await n2.instantiator(t3) : Ri(n2) ? n2 = await n2.default(t3) : (zi(n2) && (n2 = n2.data), Bi(n2) ? n2 = typeof WebAssembly.instantiateStreaming == `function` ? await Gi(n2)(t3) : await Ki(n2)(t3) : Vi(n2) || n2 instanceof WebAssembly.Module ? n2 = await Wi(n2)(t3) : `default` in n2 && n2.default instanceof WebAssembly.Module && (n2 = await Wi(n2.default)(t3))), `instance` in n2 && (n2 = n2.instance), `exports` in n2 && (n2 = n2.exports), n2;
    });
  }
  return Hi = t2(), Hi;
}
...
async function qi(e12) {
  return e12 && await Ui(e12), { createScanner(e13) {
    return new Ii(e13.map((e14) => typeof e14 == `string` ? e14 : e14.source));
  }, createString(e13) {
    return new Fi(e13);
  } };
}

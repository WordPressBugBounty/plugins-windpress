...
let __tla = (async () => {
  ...
  function ae(e2, t2, n2, r2) {
    ...
    if (E(t2)) return n2.Map?.(e2, t2, r2);
    if (ee(t2)) return n2.Seq?.(e2, t2, r2);
    if (D(t2)) return n2.Pair?.(e2, t2, r2);
    if (O(t2)) return n2.Scalar?.(e2, t2, r2);
...
`);
  ...
  var me = class {
    ...
    toJSON(e2, t2) {
      ...
      let o2 = n2.get(a2);
      if (o2 || (o2 = (L(a2, null, t2), n2.get(a2))), o2?.res === void 0) throw ReferenceError(`This should not happen: Alias anchor was not resolved?`);
  ...
  var _e = (e2) => !e2 || typeof e2 != `function` && typeof e2 != `object`, R = class extends me {
    ...
    toJSON(e2, t2) {
      return t2?.keep ? this.value : L(this.value, e2, t2);
    }
    toString() {
  ...
  function z(e2, t2, n2) {
    ...
    t2?.startsWith(`!!`) && (t2 = ve + t2.slice(2));
    ...
    let u2 = l2?.createNode ? l2.createNode(n2.schema, e2, n2) : typeof l2?.nodeClass?.from == `function` ? l2.nodeClass.from(n2.schema, e2, n2) : new R(e2);
...
`) && (S2 = ``);
  ...
  var He = `<<`, G = {
    ...
    stringify: () => He
  }, Ue = (e2, t2) => (G.identify(t2) || O(t2) && (!t2.type || t2.type === R.PLAIN) && G.identify(t2.value)) && e2?.doc.schema.tags.some((e3) => e3.tag === G.tag && e3.default);
  ...
  var K = class e2 {
    ...
    toJSON(e3, t2) {
      return Ke(t2, t2?.mapAsMap ? /* @__PURE__ */ new Map() : {}, this);
    }
    toString(e3, t2, n2) {
...
${i2}${p2}`;
  ...
  var J = class extends xe {
    ...
    add(e2, t2) {
      let n2;
      n2 = D(e2) ? e2 : !e2 || typeof e2 != `object` || !(`key` in e2) ? new K(e2, e2?.value) : new K(e2.key, e2.value);
...
${t3.comment}` : r2.comment;
  ...
  var Yt = (e2, t2) => e2.key < t2.key ? -1 : +(e2.key > t2.key), Xt = class e2 {
...
`;
  ...
  var Qt = class e2 {
    constructor(e3, t2, n2) {
      ...
      this.options = i2;
      let { version: a2 } = i2;
      n2?._directives ? (this.directives = n2._directives.atDocument(), this.directives.yaml.explicit && (a2 = this.directives.yaml.version)) : this.directives = new le({
        version: a2
  ...
  async function fn(s2 = {}) {
    ...
    if (u2.tailwindcss_version === 4) {
      let { compile: e2, getCandidates: t2, optimize: n2, loadSource: r2 } = await i(async () => {
        let { compile: e3, getCandidates: t3, optimize: n3, loadSource: r3 } = await import("./tailwindcss-nSBJD7BD.js").then(async (m3) => {
          await m3.__tla;
          return m3;
        });
        return {
      ...
      let { build: e2, optimize: t2 } = await i(async () => {
        let { build: e3, optimize: t3 } = await import("./tailwindcss-v3-DB0AMG3q.js").then(async (m3) => {
          await m3.__tla;
          return m3;
        });
        return {

...
import { t } from "./preload-helper-CtT0-S4g.js";
let H, n, V;
let __tla = (async () => {
  ...
  V = async function(e2) {
    ...
    e2 ?? (e2 = new URL(`` + new URL(`lightningcss_node-YoK8fJ2x.wasm`, import.meta.url).href, `` + import.meta.url)), (typeof e2 == `string` || typeof Request == `function` && e2 instanceof Request || typeof URL == `function` && e2 instanceof URL) && (e2 = G(e2));
    let t2;
    B = e2.then((e3) => W(e3, {
      env: {
        ...M,
      ...
      e3.exports.register_module(), t2 = new b(e3), R(t2), z = t2.exports;
    }), await B;
  };
  H = function(e2) {
    return U(z.transform, e2);
  };
  function U(e2, t2) {
  ...
  async function G(n2) {
    try {
      return (await t(() => import("./lib-CIa4rXJH.js").then(async (m2) => {
        await m2.__tla;
        return m2;

...
import { y as C } from "./dist-BKF-Yqo1.js";
import { t as w } from "./set-Re2vSVSO.js";
import { t as re } from "./vfs-DziqLF6T.js";
import { c as ie, i as ae } from "./intellisense-CtRsPNrz.js";
...
function X(e2) {
  var _a;
  !e2.shiftKey || !e2.target || ((_a = document == null ? void 0 : document.getSelection()) == null ? void 0 : _a.removeAllRanges(), e2.preventDefault(), e2.stopPropagation(), G.value = e2.target, K.value = e2.target.value, W.value = true);
}
function Z(e2) {
  G.value = e2.target;
}
  ...
  setTimeout(() => {
    ...
    Ce.forEach((t3) => {
      (typeof t3 == `string` ? [...document.querySelectorAll(t3)] : [...document.querySelectorAll(t3.selector)].filter((e3) => t3.hasChild.some((t4) => e3.querySelector(t4)))).forEach((t4) => {
        ...
        (n2 == null ? void 0 : n2.getAttribute(`windpressbuilderius-variable-app`)) !== `listened` && (n2 == null ? void 0 : n2.removeEventListener(`click`, X), n2 == null ? void 0 : n2.addEventListener(`click`, X), n2 == null ? void 0 : n2.removeEventListener(`focus`, Z), n2 == null ? void 0 : n2.addEventListener(`focus`, Z), n2 == null ? void 0 : n2.setAttribute(`windpressbuilderius-variable-app`, `listened`), e2 = true);
      });
    });

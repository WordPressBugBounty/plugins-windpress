...
function w(e2, t2) {
  for (var n2 in e2) n2 !== "default" && !Object.prototype.hasOwnProperty.call(t2, n2) && ee(t2, e2, n2);
}
function T(e2) {
...
function F(e2) {
  ...
  var t2 = {};
  if (e2 != null) for (var n2 = G(e2), r2 = 0; r2 < n2.length; r2++) n2[r2] !== "default" && ee(t2, e2, n2[r2]);
  return te(t2, e2), t2;
}
function I(e2) {
...
function V(e2) {
  function t2(t3) {
    e2.error = e2.hasError ? new ne(t3, e2.error, `An error was suppressed during disposal.`) : t3, e2.hasError = true;
  }
  var n2, r2 = 0;
  function i2() {
...
var U, W, ee, te, G, ne, K, q = t((() => {
  ...
  }, ee = Object.create ? (function(e2, t2, n2, r2) {
    r2 === void 0 && (r2 = n2);
  ...
  }), te = Object.create ? (function(e2, t2) {
    Object.defineProperty(e2, "default", { enumerable: true, value: t2 });
  }) : function(e2, t2) {
    e2.default = t2;
  }, G = function(e2) {
    return G = Object.getOwnPropertyNames || function(e3) {
      var t2 = [];
      for (var n2 in e3) Object.prototype.hasOwnProperty.call(e3, n2) && (t2[t2.length] = n2);
      return t2;
    }, G(e2);
  }, ne = typeof SuppressedError == `function` ? SuppressedError : function(e2, t2, n2) {
    var r2 = Error(n2);
    return r2.name = `SuppressedError`, r2.error = e2, r2.suppressed = t2, r2;
  }, K = { __extends: p, __assign: W, __rest: m, __decorate: h, __param: g, __esDecorate: _, __runInitializers: v, __propKey: y, __setFunctionName: b, __metadata: x, __awaiter: S, __generator: C, __createBinding: ee, __exportStar: w, __values: T, __read: E, __spread: D, __spreadArrays: O, __spreadArray: k, __await: A, __asyncGenerator: j, __asyncDelegator: M, __asyncValues: N, __makeTemplateObject: P, __importStar: F, __importDefault: I, __classPrivateFieldGet: L, __classPrivateFieldSet: R, __classPrivateFieldIn: z, __addDisposableResource: B, __disposeResources: V, __rewriteRelativeImportExtension: H };
})), re = i(((e2) => {
  ...
  g2.read = function(e3, t3, n3, r3, i3) {
    ...
    d3.prototype.swap16 = function() {
      ...
      return this === e4 || d3.compare(this, e4) === 0;
    ...
    d3.prototype.writeBigUInt64LE = Q2(function(e4, t4 = 0) {
      ...
      return ee2(this, e4, t4, BigInt(0), BigInt(`0xffffffffffffffff`));
      ...
      return ee2(this, e4, t4, -BigInt(`0x8000000000000000`), BigInt(`0x7fffffffffffffff`));
    });
    function te2(e4, t4, n3, r4, i4, a4) {
      if (n3 + r4 > e4.length || n3 < 0) throw RangeError(`Index out of range`);
    }
    function G2(e4, t4, n3, i4, a4) {
      return t4 = +t4, n3 >>>= 0, a4 || te2(e4, t4, n3, 4), r3.write(e4, t4, n3, i4, 23, 4), n3 + 4;
    }
    d3.prototype.writeFloatLE = function(e4, t4, n3) {
      return G2(this, e4, t4, true, n3);
    }, d3.prototype.writeFloatBE = function(e4, t4, n3) {
      return G2(this, e4, t4, false, n3);
    };
    function ne2(e4, t4, n3, i4, a4) {
      return t4 = +t4, n3 >>>= 0, a4 || te2(e4, t4, n3, 8), r3.write(e4, t4, n3, i4, 52, 8), n3 + 8;
    }
    d3.prototype.writeDoubleLE = function(e4, t4, n3) {
      return ne2(this, e4, t4, true, n3);
    }, d3.prototype.writeDoubleBE = function(e4, t4, n3) {
      return ne2(this, e4, t4, false, n3);
    ...
    let K2 = {};
    function q2(e4, t4, n3) {
      K2[e4] = class extends n3 {
        constructor() {
    ...
    q2(`ERR_BUFFER_OUT_OF_BOUNDS`, function(e4) {
      return e4 ? `${e4} is outside of buffer bounds` : `Attempt to access memory outside buffer bounds`;
    }, RangeError), q2(`ERR_INVALID_ARG_TYPE`, function(e4, t4) {
      return `The "${e4}" argument must be of type number. Received type ${typeof t4}`;
    }, TypeError), q2(`ERR_OUT_OF_RANGE`, function(e4, t4, n3) {
      let r4 = `The value of "${e4}" is out of range.`, i4 = n3;
      return Number.isInteger(n3) && Math.abs(n3) > 2 ** 32 ? i4 = re2(String(n3)) : typeof n3 == `bigint` && (i4 = String(n3), (n3 > BigInt(2) ** BigInt(32) || n3 < -(BigInt(2) ** BigInt(32))) && (i4 = re2(i4)), i4 += `n`), r4 += ` It must be ${t4}. Received ${i4}`, r4;
    }, RangeError);
    function re2(e4) {
    ...
    function Y2(e4, t4, n3, r4, i4, a4) {
      if (e4 > n3 || e4 < t4) {
        let r5 = typeof t4 == `bigint` ? `n` : ``, i5;
        throw i5 = a4 > 3 ? t4 === 0 || t4 === BigInt(0) ? `>= 0${r5} and < 2${r5} ** ${(a4 + 1) * 8}${r5}` : `>= -(2${r5} ** ${(a4 + 1) * 8 - 1}${r5}) and < 2 ** ${(a4 + 1) * 8 - 1}${r5}` : `>= ${t4}${r5} and <= ${n3}${r5}`, new K2.ERR_OUT_OF_RANGE(`value`, i5, e4);
      }
      J2(r4, i4, a4);
    }
    function X2(e4, t4) {
      if (typeof e4 != `number`) throw new K2.ERR_INVALID_ARG_TYPE(t4, `number`, e4);
    }
    function Z2(e4, t4, n3) {
      throw Math.floor(e4) === e4 ? t4 < 0 ? new K2.ERR_BUFFER_OUT_OF_BOUNDS() : new K2.ERR_OUT_OF_RANGE(n3 || `offset`, `>= ${+!!n3} and <= ${t4}`, e4) : (X2(e4, n3), new K2.ERR_OUT_OF_RANGE(n3 || `offset`, `an integer`, e4));
    }
  ...
  var t2 = Z(), n2 = re(), r2 = n2.posix ? n2.posix.join : n2.join;
  e2.flattenJSON = (e3) => {
    let n3 = {};
    function i2(e4, a2) {
      for (let o2 in a2) {
  ...
  Object.defineProperty(e2, "__esModule", { value: true }), e2.watchIgnoreToMatcher = e2.watchIgnorePatternToMatcher = void 0;
  var t2 = _e();
  e2.watchIgnorePatternToMatcher = (e3) => {
    if (typeof e3 == `function`) return e3;
    if (e3 instanceof RegExp) return (t3) => e3.test(t3);
    if (typeof e3 == `string`) {
      let n2 = (0, t2.toRegex)(e3);
      return (e4) => n2.test(e4);
    }
    throw TypeError(`The "options.ignore" property must be of type string, RegExp, function, or an array thereof. Received ${typeof e3}`);
  }, e2.watchIgnoreToMatcher = (t3) => {
    if (Array.isArray(t3)) {
      let n2 = t3.map(e2.watchIgnorePatternToMatcher);
      return (e3) => n2.some((t4) => t4(e3));
    }
    return (0, e2.watchIgnorePatternToMatcher)(t3);
  };
})), $ = i(((t2) => {
  Object.defineProperty(t2, "__esModule", { value: true });
  var n2 = (q(), e(f));
  n2.__exportStar(ue(), t2), n2.__exportStar(de(), t2), n2.__exportStar(fe(), t2), n2.__exportStar(pe(), t2), n2.__exportStar(Q(), t2), n2.__exportStar(ge(), t2), n2.__exportStar(ve(), t2);
})), ye = i(((e2) => {
  ...
  var I2 = Te(), L2 = I2.custom, R2 = re2(L2) ? L2 : null, z2 = { __proto__: null, double: `"`, single: `'` }, B2 = { __proto__: null, double: /(["\\])/g, single: /(['\\])/g };
  t2.exports = function e3(t3, n3, r3, a2) {
    ...
    var l3 = !X2(c3, `customInspect`) || c3.customInspect;
    ...
    if (typeof t3 == `function` && !te2(t3)) {
      var x3 = ie2(t3), C3 = $2(t3, v3);
    ...
    if (W2(t3)) {
      ...
      var U3 = $2(t3, v3);
      return _3 && !ge2(U3) ? `[` + ve2(U3, _3) + `]` : `[ ` + T2.call(U3, `, `) + ` ]`;
    }
    if (G2(t3)) {
      var Y3 = $2(t3, v3);
      return !(`cause` in Error.prototype) && `cause` in t3 && !N2.call(t3, `cause`) ? `{ [` + String(t3) + `] ` + T2.call(w2.call(`[cause]: ` + v3(t3.cause), Y3), `, `) + ` }` : Y3.length === 0 ? `[` + String(t3) + `]` : `{ [` + String(t3) + `] ` + T2.call(Y3, `, `) + ` }`;
    }
    ...
    if (K2(t3)) return Q2(v3(Number(t3)));
    if (J2(t3)) return Q2(v3(O2.call(t3)));
    if (q2(t3)) return Q2(h2.call(t3));
    if (ne2(t3)) return Q2(v3(String(t3)));
  ...
  var Y2 = Object.prototype.hasOwnProperty || function(e3) {
    return e3 in this;
  };
  function X2(e3, t3) {
    return Y2.call(e3, t3);
  }
  function Z2(e3) {
    return g2.call(e3);
  }
  ...
  function de2(e3) {
    return !e3 || typeof e3 != `object` ? false : typeof HTMLElement < `u` && e3 instanceof HTMLElement || typeof e3.nodeName == `string` && typeof e3.getAttribute == `function`;
  }
  function fe2(e3, t3) {
  ...
  function he2(e3, t3, n3, r3) {
    var i3 = r3 ? ve2(n3, r3) : T2.call(n3, `, `);
    return e3 + ` (` + t3 + `) {` + i3 + `}`;
  }
  function ge2(e3) {
...
` + t3.prev;
  ...
  var n2 = Ee(), r2 = we(), i2 = function(e3, t3, n3) {
  ...
  var n2 = typeof Symbol < `u` && Symbol, r2 = Ke();
  t2.exports = function() {
  ...
  t2.exports = Oe().getPrototypeOf || null;
})), Xe = i(((e2, t2) => {
  var n2 = Object.prototype.toString, r2 = Math.max, i2 = `[object Function]`, a2 = function(e3, t3) {
  ...
  t2.exports = function(e3) {
    var t3 = this;
    if (typeof t3 != `function` || n2.apply(t3) !== i2) throw TypeError(`Function.prototype.bind called on incompatible ` + t3);
    for (var c2 = o2(arguments, 1), l2, u2 = function() {
      if (this instanceof l2) {
        var n3 = t3.apply(this, a2(c2, arguments));
        return Object(n3) === n3 ? n3 : this;
      }
      return t3.apply(e3, a2(c2, arguments));
    }, d2 = r2(0, t3.length - c2.length), f2 = [], p2 = 0; p2 < d2; p2++) f2[p2] = `$` + p2;
    if (l2 = Function(`binder`, `return function (` + s2(f2, `,`) + `){ return binder.apply(this,arguments); }`)(u2), t3.prototype) {
      var m2 = function() {
      };
      m2.prototype = t3.prototype, l2.prototype = new m2(), m2.prototype = null;
    }
    return l2;
  };
})), Ze = i(((e2, t2) => {
  ...
  var n2 = Ze(), r2 = $e(), i2 = Qe();
  t2.exports = et() || n2.call(i2, r2);
})), nt = i(((e2, t2) => {
  var n2 = Ze(), r2 = we(), i2 = Qe(), a2 = tt();
  t2.exports = function(e3) {
  ...
  t2.exports = Ze().call(n2, r2);
})), ot = i(((e2, t2) => {
  var n2, r2 = Oe(), i2 = ke(), a2 = Ae(), o2 = je(), s2 = Me(), c2 = Ne(), l2 = we(), u2 = Pe(), d2 = Fe(), f2 = Ie(), p2 = Le(), m2 = Re(), h2 = ze(), g2 = Be(), _2 = He(), v2 = Function, y2 = function(e3) {
    try {
      return v2(`"use strict"; return (` + e3 + `).constructor;`)();
    } catch {
    }
  }, b2 = We(), x2 = Ge(), S2 = function() {
    throw new l2();
  }, C2 = b2 ? (function() {
    try {
  ...
  t2.exports = function(e3, t3) {
    ...
    var n3 = W2(e3), r3 = n3.length > 0 ? n3[0] : ``, i3 = ee2(`%` + r3 + `%`, t3), a3 = i3.name, o3 = i3.value, s3 = false, u3 = i3.alias;
  ...
  var n2 = ot(), r2 = nt(), i2 = r2([n2(`%String.prototype.indexOf%`)]);
  t2.exports = function(e3, t3) {
    var a2 = n2(e3, !!t3);
    return typeof a2 == `function` && i2(e3, `.prototype.`) > -1 ? r2([a2]) : a2;
  };
})), ct = i(((e2, t2) => {
  var n2 = ot(), r2 = st(), i2 = Ee(), a2 = we(), o2 = n2(`%Map%`, true), s2 = r2(`Map.prototype.get`, true), c2 = r2(`Map.prototype.set`, true), l2 = r2(`Map.prototype.has`, true), u2 = r2(`Map.prototype.delete`, true), d2 = r2(`Map.prototype.size`, true);
  ...
  var n2 = ot(), r2 = st(), i2 = Ee(), a2 = ct(), o2 = we(), s2 = n2(`%WeakMap%`, true), c2 = r2(`WeakMap.prototype.get`, true), l2 = r2(`WeakMap.prototype.set`, true), u2 = r2(`WeakMap.prototype.has`, true), d2 = r2(`WeakMap.prototype.delete`, true);
  ...
  var n2 = we(), r2 = Ee(), i2 = De(), a2 = ct(), o2 = lt() || a2 || i2;
  t2.exports = function() {
    var e3, t3 = { assert: function(e4) {
      if (!t3.has(e4)) throw new n2(`Side channel does not contain ` + (e4 && Object(e4) === e4 ? `the given object key` : r2(e4)));
    }, delete: function(t4) {
  ...
  var n2 = dt(), r2 = ut(), i2 = Ge(), a2 = Object.prototype.hasOwnProperty, o2 = Array.isArray, s2 = r2(), c2 = function(e3, t3) {
    return s2.set(e3, t3), e3;
  }, l2 = function(e3) {
    return s2.has(e3);
  }, u2 = function(e3) {
    return s2.get(e3);
    ...
    t3 === `__proto__` && i2 ? i2(e3, t3, { configurable: true, enumerable: true, value: n3, writable: true }) : e3[t3] = n3;
  }, g2 = function e3(t3, n3, r3) {
    if (!n3) return t3;
    if (typeof n3 != `object` && typeof n3 != `function`) {
      if (o2(t3)) {
        var i3 = t3.length;
        if (r3 && typeof r3.arrayLimit == `number` && i3 >= r3.arrayLimit) {
          if (r3.throwOnLimitExceeded) throw RangeError(`Array limit exceeded. Only ` + r3.arrayLimit + ` element` + (r3.arrayLimit === 1 ? `` : `s`) + ` allowed in an array.`);
          return c2(m2(t3.concat(n3), r3), i3);
        }
        t3[i3] = n3;
      } else if (t3 && typeof t3 == `object`) if (l2(t3)) {
        var s3 = u2(t3) + 1;
        t3[s3] = n3, d2(t3, s3);
      } else if (r3 && r3.strictMerge) return [t3, n3];
      else (r3 && (r3.plainObjects || r3.allowPrototypes) || !a2.call(Object.prototype, n3)) && (t3[n3] = true);
      else return [t3, n3];
      return t3;
    }
    if (!t3 || typeof t3 != `object`) {
      if (l2(n3)) {
        for (var f3 = Object.keys(n3), p3 = r3 && r3.plainObjects ? { __proto__: null, 0: t3 } : { 0: t3 }, g3 = 0; g3 < f3.length; g3++) {
          var _3 = parseInt(f3[g3], 10);
          p3[_3 + 1] = n3[f3[g3]];
        }
        return c2(p3, u2(n3) + 1);
      }
      var v3 = [t3].concat(n3);
      if (r3 && typeof r3.arrayLimit == `number` && v3.length > r3.arrayLimit) {
        if (r3.throwOnLimitExceeded) throw RangeError(`Array limit exceeded. Only ` + r3.arrayLimit + ` element` + (r3.arrayLimit === 1 ? `` : `s`) + ` allowed in an array.`);
        return c2(m2(v3, r3), v3.length - 1);
      }
      return v3;
    }
    var y3 = t3;
    if (o2(t3) && !o2(n3) && (y3 = m2(t3, r3)), o2(t3) && o2(n3)) {
      if (n3.forEach(function(n4, i4) {
        if (a2.call(t3, i4)) {
          var o3 = t3[i4];
          o3 && typeof o3 == `object` && n4 && typeof n4 == `object` ? t3[i4] = e3(o3, n4, r3) : t3[t3.length] = n4;
        } else t3[i4] = n4;
      }), r3 && typeof r3.arrayLimit == `number` && t3.length > r3.arrayLimit) {
        if (r3.throwOnLimitExceeded) throw RangeError(`Array limit exceeded. Only ` + r3.arrayLimit + ` element` + (r3.arrayLimit === 1 ? `` : `s`) + ` allowed in an array.`);
        return c2(m2(t3, r3), t3.length - 1);
      }
      return t3;
    }
    return Object.keys(n3).reduce(function(t4, i4) {
      var o3 = n3[i4];
      if (a2.call(t4, i4) ? h2(t4, i4, e3(t4[i4], o3, r3)) : h2(t4, i4, o3), l2(n3) && !l2(t4) && c2(t4, u2(n3)), l2(t4)) {
        var s4 = parseInt(i4, 10);
        String(s4) === i4 && s4 >= 0 && s4 > u2(t4) && d2(t4, s4);
      }
      return t4;
    }, y3);
  }, _2 = function(e3, t3) {
    return Object.keys(t3).reduce(function(e4, n3) {
      return h2(e4, n3, t3[n3]), e4;
    }, e3);
  ...
  t2.exports = { arrayToObject: m2, assign: _2, combine: function(e3, t3, n3, r3, i3) {
    if (l2(e3)) {
      if (i3) throw RangeError(`Array limit exceeded. Only ` + n3 + ` element` + (n3 === 1 ? `` : `s`) + ` allowed in an array.`);
      var a3 = u2(e3) + 1;
      return e3[a3] = t3, d2(e3, a3), e3;
    }
    var o3 = [].concat(e3, t3);
    if (o3.length > n3) {
      if (i3) throw RangeError(`Array limit exceeded. Only ` + n3 + ` element` + (n3 === 1 ? `` : `s`) + ` allowed in an array.`);
      return c2(m2(o3, { plainObjects: r3 }), o3.length - 1);
    }
    return o3;
  }, compact: function(e3) {
    for (var t3 = [{ obj: { o: e3 }, prop: `o` }], n3 = r2(), i3 = 0; i3 < t3.length; ++i3) for (var a3 = t3[i3], o3 = a3.obj[a3.prop], s3 = Object.keys(o3), c3 = 0; c3 < s3.length; ++c3) {
      var l3 = s3[c3], u3 = o3[l3];
      typeof u3 == `object` && u3 && !n3.has(u3) && (t3[t3.length] = { obj: o3, prop: l3 }, n3.set(u3, true));
    }
    return p2(t3), e3;
  }, decode: v2, encode: function(e3, t3, r3, i3, a3) {
    ...
    for (var s3 = ``, c3 = 0; c3 < o3.length; c3 += y2) {
      var l3 = o3.length >= y2 ? o3.slice(c3, c3 + y2) : o3;
      if (c3 + y2 < o3.length) {
        var u3 = l3.charCodeAt(l3.length - 1);
        u3 >= 55296 && u3 <= 56319 && (l3 = l3.slice(0, -1), --c3);
      }
      for (var d3 = [], p3 = 0; p3 < l3.length; ++p3) {
        var m3 = l3.charCodeAt(p3);
        if (m3 === 45 || m3 === 46 || m3 === 95 || m3 === 126 || m3 >= 48 && m3 <= 57 || m3 >= 65 && m3 <= 90 || m3 >= 97 && m3 <= 122 || a3 === n2.RFC1738 && (m3 === 40 || m3 === 41)) {
          d3[d3.length] = l3.charAt(p3);
          continue;
        }
        if (m3 < 128) {
          d3[d3.length] = f2[m3];
        ...
        if (m3 < 2048) {
          d3[d3.length] = f2[192 | m3 >> 6] + f2[128 | m3 & 63];
          continue;
        }
        if (m3 < 55296 || m3 >= 57344) {
          d3[d3.length] = f2[224 | m3 >> 12] + f2[128 | m3 >> 6 & 63] + f2[128 | m3 & 63];
          continue;
        }
        p3 += 1, m3 = 65536 + ((m3 & 1023) << 10 | l3.charCodeAt(p3) & 1023), d3[d3.length] = f2[240 | m3 >> 18] + f2[128 | m3 >> 12 & 63] + f2[128 | m3 >> 6 & 63] + f2[128 | m3 & 63];
      }
      s3 += d3.join(``);
    }
    return s3;
  ...
  }, isOverflow: l2, isRegExp: function(e3) {
    return Object.prototype.toString.call(e3) === `[object RegExp]`;
  }, markOverflow: c2, maybeMap: function(e3, t3) {
    if (o2(e3)) {
  ...
  var n2 = ut(), r2 = ft(), i2 = dt(), a2 = Object.prototype.hasOwnProperty, o2 = { brackets: function(e3) {
    return e3 + `[]`;
    ...
    if (typeof _2 == `function` ? E2 = _2(i3, E2) : E2 instanceof Date ? E2 = b2(E2) : a3 === `comma` && s2(E2) && (E2 = r2.maybeMap(E2, function(e4) {
      ...
      if (u3) return S2(g3 && !C2 ? g3(i3, f2.encoder, w2, `key`, x2) : i3);
      E2 = ``;
    }
    ...
    var M2;
    if (a3 === `comma` && s2(E2)) C2 && g3 && (E2 = r2.maybeMap(E2, function(e4) {
      return e4 == null ? e4 : g3(e4);
    })), M2 = [{ value: E2.length > 0 ? E2.join(`,`) || null : void 0 }];
    else if (s2(_2)) M2 = _2;
    else {
    ...
    var u3 = e3.allowDots === void 0 ? e3.encodeDotInKeys === true || f2.allowDots : !!e3.allowDots;
  ...
  var n2 = ft(), r2 = Object.prototype.hasOwnProperty, i2 = Array.isArray, a2 = { allowDots: false, allowEmptyArrays: false, allowPrototypes: false, allowSparse: false, arrayLimit: 20, charset: `utf-8`, charsetSentinel: false, comma: false, decodeDotInKeys: false, decoder: n2.decode, delimiter: `&`, depth: 5, duplicates: `combine`, ignoreQueryPrefix: false, interpretNumericEntities: false, parameterLimit: 1e3, parseArrays: true, plainObjects: false, strictDepth: false, strictMerge: true, strictNullHandling: false, throwOnLimitExceeded: false }, o2 = function(e3) {
    ...
    for (h2 = 0; h2 < p3.length; ++h2) if (h2 !== m3) {
      ...
      if (y2 === -1 ? (b2 = t3.decoder(_2, a2.decoder, g2, `key`), x2 = t3.strictNullHandling ? null : ``) : (b2 = t3.decoder(_2.slice(0, y2), a2.decoder, g2, `key`), b2 !== null && (x2 = n2.maybeMap(s2(_2.slice(y2 + 1), t3, i2(u3[b2]) ? u3[b2].length : 0, _2.indexOf(`[]=`) === -1), function(e4) {
        return t3.decoder(e4, a2.decoder, g2, `value`);
      }))), x2 && t3.interpretNumericEntities && g2 === `iso-8859-1` && (x2 = o2(String(x2))), _2.indexOf(`[]=`) > -1 && (x2 = i2(x2) ? [x2] : x2), t3.comma && i2(x2) && x2.length > t3.arrayLimit && (x2 = n2.combine([], x2, t3.arrayLimit, t3.plainObjects, t3.throwOnLimitExceeded)), b2 !== null) {
        var S2 = r2.call(u3, b2);
        S2 && (t3.duplicates === `combine` || _2.indexOf(`[]=`) > -1) ? u3[b2] = n2.combine(u3[b2], x2, t3.arrayLimit, t3.plainObjects, t3.throwOnLimitExceeded) : (!S2 || t3.duplicates === `last`) && (u3[b2] = x2);
      }
    }
    return u3;
    ...
    for (var c3 = i3 ? t3 : s2(t3, r3, a3), l3 = e3.length - 1; l3 >= 0; --l3) {
      var u3, d3 = e3[l3];
      if (d3 === `[]` && r3.parseArrays) u3 = n2.isOverflow(c3) ? c3 : r3.allowEmptyArrays && (c3 === `` || r3.strictNullHandling && c3 === null) ? [] : n2.combine([], c3, r3.arrayLimit, r3.plainObjects, r3.throwOnLimitExceeded);
      else {
    ...
    var i3 = [], a3 = n3.indexOf(`[`), o3 = a3 >= 0 ? n3.slice(0, a3) : n3;
    if (o3) {
      if (!t3.plainObjects && r2.call(Object.prototype, o3) && !t3.allowPrototypes) return;
      i3[i3.length] = o3;
    }
    for (var s3 = n3.length, c3 = a3, l3 = 0; c3 >= 0 && l3 < t3.depth; ) {
      for (var u3 = 1, d3 = c3 + 1, f3 = -1; d3 < s3 && f3 < 0; ) {
        var p3 = n3.charCodeAt(d3);
        p3 === 91 ? u3 += 1 : p3 === 93 && (--u3, u3 === 0 && (f3 = d3)), d3 += 1;
      }
      if (f3 < 0) return i3[i3.length] = `[` + n3.slice(c3) + `]`, i3;
      var m3 = n3.slice(c3, f3 + 1), h2 = m3.slice(1, -1);
      if (!t3.plainObjects && r2.call(Object.prototype, h2) && !t3.allowPrototypes) return;
      i3[i3.length] = m3, l3 += 1, c3 = n3.indexOf(`[`, f3 + 1);
    }
    if (c3 >= 0) {
      if (t3.strictDepth === true) throw RangeError(`Input depth exceeded depth option of ` + t3.depth + ` and strictDepth is true`);
      i3[i3.length] = `[` + n3.slice(c3) + `]`;
    }
    return i3;
  ...
  var n2 = pt(), r2 = mt();
  t2.exports = { formats: dt(), parse: r2, stringify: n2 };
})), gt = r({ URL: () => tn, URLSearchParams: () => nn, Url: () => en, default: () => hn, domainToASCII: () => un, domainToUnicode: () => dn, fileURLToPath: () => pn, format: () => mn, parse: () => Qt, pathToFileURL: () => fn, resolve: () => $t, resolveObject: () => qt });
function _t() {
  this.protocol = null, this.slashes = null, this.auth = null, this.host = null, this.port = null, this.hostname = null, this.hash = null, this.search = null, this.query = null, this.pathname = null, this.path = null, this.href = null;
}
function vt(e2, t2, n2) {
  if (e2 && typeof e2 == `object` && e2 instanceof _t) return e2;
  var r2 = new _t();
  return r2.parse(e2, t2, n2), r2;
}
function yt(e2) {
  return typeof e2 == `string` && (e2 = vt(e2)), e2 instanceof _t ? e2.format() : _t.prototype.format.call(e2);
}
function bt(e2, t2) {
  return vt(e2, false, true).resolve(t2);
}
function xt(e2, t2) {
  return e2 ? vt(e2, false, true).resolveObject(t2) : t2;
}
function St(e2, t2) {
...
function Ct() {
  ...
  return e2 = St(wt(e2.split(`/`), function(e3) {
    return !!e3;
  }), !t2).join(`/`), (t2 ? `/` : ``) + e2 || `.`;
}
function wt(e2, t2) {
...
function Dt(e2) {
  return e2.includes(`%`) && (e2 = e2.replace(rn, `%25`)), e2.includes(`\\`) && (e2 = e2.replace(an, `%5C`)), e2.includes(`
`) && (e2 = e2.replace(on, `%0A`)), e2.includes(`\r`) && (e2 = e2.replace(sn, `%0D`)), e2.includes(`	`) && (e2 = e2.replace(cn, `%09`)), e2;
}
var Ot, kt, At, jt, Mt, Nt, Pt, Ft, It, Lt, Rt, zt, Bt, Vt, Ht, Ut, Wt, Gt, Kt, qt, Jt, Yt, Xt, Zt, Qt, $t, en, tn, nn, rn, an, on, sn, cn, ln, un, dn, fn, pn, mn, hn, gn = t((() => {
  Ot = n(Ce()), kt = n(ht()), At = Ot.default, jt = /^([a-z0-9.+-]+:)/i, Mt = /:[0-9]*$/, Nt = /^(\/\/?(?!\/)[^?\s]*)(\?[^\s]*)?$/, Pt = [`{`, `}`, `|`, `\\`, `^`, "`", `<`, `>`, `"`, "`", ` `, `\r`, `
`, `	`], Ft = [`'`].concat(Pt), It = [`%`, `/`, `?`, `;`, `#`].concat(Ft), Lt = [`/`, `?`, `#`], Rt = 255, zt = /^[+a-z0-9A-Z_-]{0,63}$/, Bt = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, Vt = { javascript: true, "javascript:": true }, Ht = { javascript: true, "javascript:": true }, Ut = { http: true, https: true, ftp: true, gopher: true, file: true, "http:": true, "https:": true, "ftp:": true, "gopher:": true, "file:": true }, Wt = kt.default, _t.prototype.parse = function(e2, t2, n2) {
    ...
    if (o2 = o2.trim(), !n2 && e2.split(`#`).length === 1) {
      var s2 = Nt.exec(o2);
      if (s2) return this.path = o2, this.href = o2, this.pathname = s2[1], s2[2] ? (this.search = s2[2], t2 ? this.query = Wt.parse(this.search.substr(1)) : this.query = this.search.substr(1)) : t2 && (this.search = ``, this.query = {}), this;
    }
    var c2 = jt.exec(o2);
    if (c2) {
      c2 = c2[0];
    ...
    if (n2 || c2 || o2.match(/^\/\/[^@/]+@[^@/]+/)) {
      ...
      u2 && !(c2 && Ht[c2]) && (o2 = o2.substr(2), this.slashes = true);
    }
    if (!Ht[c2] && (u2 || c2 && !Ut[c2])) {
      for (var d2 = -1, f2 = 0; f2 < Lt.length; f2++) {
        var p2 = o2.indexOf(Lt[f2]);
      ...
      for (var f2 = 0; f2 < It.length; f2++) {
        var p2 = o2.indexOf(It[f2]);
        p2 !== -1 && (d2 === -1 || p2 < d2) && (d2 = p2);
      }
      ...
      if (!g2) for (var _2 = this.hostname.split(/\./), f2 = 0, v2 = _2.length; f2 < v2; f2++) {
        ...
        if (y2 && !y2.match(zt)) {
          ...
          if (!b2.match(zt)) {
            var C2 = _2.slice(0, f2), w2 = _2.slice(f2 + 1), T2 = y2.match(Bt);
            T2 && (C2.push(T2[1]), w2.unshift(T2[2])), w2.length && (o2 = `/` + w2.join(`.`) + o2), this.hostname = C2.join(`.`);
            break;
          }
        }
      }
      this.hostname.length > Rt ? this.hostname = `` : this.hostname = this.hostname.toLowerCase(), g2 || (this.hostname = At.toASCII(this.hostname));
    ...
    if (!Vt[l2]) for (var f2 = 0, v2 = Ft.length; f2 < v2; f2++) {
      var O2 = Ft[f2];
      if (o2.indexOf(O2) !== -1) {
    ...
    var j2 = o2.indexOf(`?`);
    if (j2 === -1 ? t2 && (this.search = ``, this.query = {}) : (this.search = o2.substr(j2), this.query = o2.substr(j2 + 1), t2 && (this.query = Wt.parse(this.query)), o2 = o2.slice(0, j2)), o2 && (this.pathname = o2), Ut[l2] && this.hostname && !this.pathname && (this.pathname = `/`), this.pathname || this.search) {
    ...
    this.host ? i2 = e2 + this.host : this.hostname && (i2 = e2 + (this.hostname.indexOf(`:`) === -1 ? this.hostname : `[` + this.hostname + `]`), this.port && (i2 += `:` + this.port)), this.query && typeof this.query == `object` && Object.keys(this.query).length && (a2 = Wt.stringify(this.query, { arrayFormat: `repeat`, addQueryPrefix: false }));
    var o2 = this.search || a2 && `?` + a2 || ``;
    return t2 && t2.substr(-1) !== `:` && (t2 += `:`), this.slashes || (!t2 || Ut[t2]) && i2 !== false ? (i2 = `//` + (i2 || ``), n2 && n2.charAt(0) !== `/` && (n2 = `/` + n2)) : i2 || (i2 = ``), r2 && r2.charAt(0) !== `#` && (r2 = `#` + r2), o2 && o2.charAt(0) !== `?` && (o2 = `?` + o2), n2 = n2.replace(/[?#]/g, function(e3) {
      return encodeURIComponent(e3);
    }), o2 = o2.replace(`#`, `%23`), t2 + i2 + n2 + o2 + r2;
  }, _t.prototype.resolve = function(e2) {
    return this.resolveObject(vt(e2, false, true)).format();
  }, _t.prototype.resolveObject = function(e2) {
    if (typeof e2 == `string`) {
      var t2 = new _t();
      t2.parse(e2, false, true), e2 = t2;
    }
    for (var n2 = new _t(), r2 = Object.keys(this), i2 = 0; i2 < r2.length; i2++) {
      var a2 = r2[i2];
      n2[a2] = this[a2];
    }
    ...
    if (e2.slashes && !e2.protocol) {
      ...
      return Ut[n2.protocol] && n2.hostname && !n2.pathname && (n2.pathname = `/`, n2.path = n2.pathname), n2.href = n2.format(), n2;
    }
    if (e2.protocol && e2.protocol !== n2.protocol) {
      ...
      if (n2.protocol = e2.protocol, !e2.host && !Ht[e2.protocol]) {
    ...
    var p2 = n2.pathname && n2.pathname.charAt(0) === `/`, m2 = e2.host || e2.pathname && e2.pathname.charAt(0) === `/`, h2 = m2 || p2 || n2.host && e2.pathname, g2 = h2, _2 = n2.pathname && n2.pathname.split(`/`) || [], f2 = e2.pathname && e2.pathname.split(`/`) || [], v2 = n2.protocol && !Ut[n2.protocol];
  ...
  })(Object), Zt = Jt, Qt = Gt, $t = Kt, en = Yt, tn = Xt.URL, nn = Xt.URLSearchParams, rn = /%/g, an = /\\/g, on = /\n/g, sn = /\r/g, cn = /\t/g, ln = 47, un = function(e2) {
    if (e2 === void 0) throw TypeError(`The "domain" argument must be specified`);
    return new tn(`http://` + e2).hostname;
  }, dn = function(e2) {
    if (e2 === void 0) throw TypeError(`The "domain" argument must be specified`);
    return new tn(`http://` + e2).hostname;
  }, fn = function(e2) {
    var t2 = new tn(`file://`), n2 = Ct(e2);
    return e2.charCodeAt(e2.length - 1) === ln && n2[n2.length - 1] !== `/` && (n2 += `/`), t2.pathname = Dt(n2), t2;
  }, pn = function(e2) {
    if (!Tt(e2) && typeof e2 != `string`) throw TypeError(`The "path" argument must be of type string or an instance of URL. Received type ` + typeof e2 + ` (` + e2 + `)`);
    var t2 = new tn(e2);
    if (t2.protocol !== `file:`) throw TypeError(`The URL must be of scheme file`);
    return Et(t2);
  }, mn = function(e2, t2) {
    if (t2 === void 0 && (t2 = {}), !(e2 instanceof tn)) return Zt(e2);
    ...
    t2.unicode;
    var a2 = new tn(e2.toString());
    return n2 || (a2.username = ``, a2.password = ``), r2 || (a2.hash = ``), i2 || (a2.search = ``), a2.toString();
  }, hn = { format: mn, parse: Qt, resolve: $t, resolveObject: qt, Url: en, URL: tn, URLSearchParams: nn, domainToASCII: un, domainToUnicode: dn, pathToFileURL: fn, fileURLToPath: pn };
})), _n = i(((t2) => {
  ...
  var n2 = re(), r2 = Z(), i2 = he(), a2 = le(), o2 = Se(), s2 = $();
  ...
  function y2(t3) {
    if (t3 instanceof Uint8Array && (t3 = (0, r2.bufferFrom)(t3)), typeof t3 != `string` && !r2.Buffer.isBuffer(t3)) {
      try {
        if (!(t3 instanceof (gn(), e(gt)).URL)) throw TypeError(s2.ERRSTR.PATH_STR);
      } catch {
  ...
  Object.defineProperty(e2, "__esModule", { value: true }), e2.FsEvent = void 0, e2.FsEvent = class {
    constructor(e3, t2, n2, r2, i2 = void 0) {
      this.type = e3, this.steps = t2, this.node = n2, this.link = r2, this.oldSteps = i2;
    }
  };
})), yn = i(((e2) => {
  Object.defineProperty(e2, "__esModule", { value: true }), e2.Superblock = void 0;
  var t2 = re(), n2 = ye(), r2 = be(), i2 = xe(), a2 = Z(), o2 = le(), s2 = $(), c2 = $(), l2 = _n(), u2 = ie(), d2 = oe(), f2 = se(), p2 = vn(), m2 = t2.posix ? t2.posix.sep : t2.sep, h2 = t2.posix ? t2.posix.relative : t2.relative, g2 = t2.posix ? t2.posix.join : t2.join, { O_RDONLY: _2, O_WRONLY: v2, O_RDWR: y2, O_CREAT: b2, O_EXCL: x2, O_TRUNC: S2, O_APPEND: C2, O_DIRECTORY: w2 } = s2.constants, T2 = class e3 {
    ...
    constructor(e4 = {}) {
      this.ino = 0, this.inodes = {}, this.releasedInos = [], this.fds = {}, this.releasedFds = [], this.maxFiles = 1e4, this.openFiles = 0, this.changes = new f2.FanOut(), this.open = (e5, t3, n4, r3 = true) => {
        ...
        let o3 = 0, s3 = t3.length, c3 = n4 & C2 ? void 0 : 0;
        try {
          for (; s3 > 0; ) {
        ...
        let s3 = r3.getNode();
        s3.nlink++;
        let c3 = a3.createChild(o3, s3);
        this.emit(new p2.FsEvent(0, c3.steps, s3, c3));
      }, this.unlink = (e5) => {
        let t3 = this.getLinkOrThrow(e5, `unlink`);
        if (t3.length) throw Error(`Dir not empty...`);
        this._emitDeleteRecursive(t3), this.deleteLink(t3);
        let n4 = t3.getNode();
        ...
        return o3.getNode().makeSymlink(e5), this.emit(new p2.FsEvent(0, o3.steps, o3.getNode(), o3)), o3;
      }, this.rename = (e5, n4) => {
        let r3;
        try {
        ...
        a3.deleteChild(r3);
        let c3 = (0, t2.basename)(n4), u3 = r3.steps;
        r3.name = c3, r3.steps = [...i3.steps, c3], i3.setChild(r3.getName(), r3), this.emit(new p2.FsEvent(4, r3.steps, r3.getNode(), r3, u3));
      }, this.mkdir = (e5, t3) => {
        ...
        let o3 = r3.createChild(i3, this.createNode(s2.constants.S_IFDIR | t3));
        this.emit(new p2.FsEvent(0, o3.steps, o3.getNode(), o3));
      }, this.mkdirp = (e5, n4) => {
        ...
        for (a3 || (a3 = this.root, o3 = 0), a3 = this.getResolvedLinkOrThrow(t2.sep + i3.slice(0, o3).join(t2.sep), `mkdir`); o3 < i3.length; o3++) {
          ...
          r3 = true, a3 = a3.createChild(i3[o3], this.createNode(s2.constants.S_IFDIR | n4)), this.emit(new p2.FsEvent(0, a3.steps, a3.getNode(), a3));
        }
        return r3 ? e5 : void 0;
      }, this.rmdir = (e5, t3 = false) => {
        let n4 = this.getLinkAsDirOrThrow(e5, `rmdir`);
        if (n4.length && !t3) throw (0, l2.createError)(`ENOTEMPTY`, `rmdir`, e5);
        this._emitDeleteRecursive(n4), this.deleteLink(n4);
        ...
        this._emitDeleteRecursive(r3), this.deleteLink(r3);
      }, this.close = (e5) => {
        (0, l2.validateFd)(e5);
        let t3 = this.getFileByFdOrThrow(e5, `close`);
        this.closeFile(t3);
      }, this.ftruncate = (e5, t3) => {
        let n4 = this.getFileByFdOrThrow(e5, `ftruncate`);
        n4.truncate(t3), this.emit(new p2.FsEvent(2, n4.link.steps, n4.node, n4.link));
      }, this.fchmod = (e5, t3) => {
        let n4 = this.getFileByFdOrThrow(e5, `fchmod`);
        n4.chmod(t3), this.emit(new p2.FsEvent(3, n4.link.steps, n4.node, n4.link));
      }, this.chmod = (e5, t3) => {
        let n4 = this.getResolvedLinkOrThrow(e5, `chmod`);
        n4.getNode().chmod(t3), this.emit(new p2.FsEvent(3, n4.steps, n4.getNode(), n4));
      }, this.lchmod = (e5, t3) => {
        let n4 = this.getLinkOrThrow(e5, `lchmod`);
        n4.getNode().chmod(t3), this.emit(new p2.FsEvent(3, n4.steps, n4.getNode(), n4));
      }, this.fchown = (e5, t3, n4) => {
        let r3 = this.getFileByFdOrThrow(e5, `fchown`);
        r3.chown(t3, n4), this.emit(new p2.FsEvent(3, r3.link.steps, r3.node, r3.link));
      }, this.chown = (e5, t3, n4) => {
        let r3 = this.getResolvedLinkOrThrow(e5, `chown`);
        r3.getNode().chown(t3, n4), this.emit(new p2.FsEvent(3, r3.steps, r3.getNode(), r3));
      }, this.lchown = (e5, t3, n4) => {
        let r3 = this.getLinkOrThrow(e5, `lchown`);
        r3.getNode().chown(t3, n4), this.emit(new p2.FsEvent(3, r3.steps, r3.getNode(), r3));
      }, this.futimes = (e5, t3, n4) => {
        let r3 = this.getFileByFdOrThrow(e5, `futimes`), i3 = r3.node;
        i3.atime = new Date(t3 * 1e3), i3.mtime = new Date(n4 * 1e3), this.emit(new p2.FsEvent(3, r3.link.steps, r3.node, r3.link));
      }, this.utimes = (e5, t3, n4, r3 = true) => {
        let i3 = r3 ? this.getResolvedLinkOrThrow(e5, `utimes`) : this.getLinkOrThrow(e5, `lutimes`), a3 = i3.getNode();
        a3.atime = new Date(t3 * 1e3), a3.mtime = new Date(n4 * 1e3), this.emit(new p2.FsEvent(3, i3.steps, a3, i3));
    ...
    _emitDeleteRecursive(e4) {
      if (e4.getNode().isDirectory()) for (let [t3, n3] of e4.children.entries()) n3 && t3 !== `.` && t3 !== `..` && this._emitDeleteRecursive(n3);
      this.emit(new p2.FsEvent(1, e4.steps, e4.getNode(), e4));
    }
    newInoNumber() {
    ...
    walk(e4, n3 = false, i3 = false, a3 = false, o3) {
      let s3, c3;
      e4 instanceof r2.Link ? (s3 = e4.steps, c3 = m2 + s3.join(m2)) : typeof e4 == `string` ? (s3 = (0, l2.filenameToSteps)(e4), c3 = e4) : (s3 = e4, c3 = m2 + s3.join(m2));
      let u3 = this.root, f3 = 0, p3 = this.process.getuid?.() ?? 0, h3 = this.process.getgid?.() ?? 0;
      for (; f3 < s3.length; ) {
        let e5 = u3.getNode();
        if (e5.isDirectory()) {
          if (a3 && !e5.canExecute(p3, h3)) return (0, d2.Err)((0, l2.createStatError)(`EACCES`, o3, c3));
        } else if (f3 < s3.length - 1) return (0, d2.Err)((0, l2.createStatError)(`ENOTDIR`, o3, c3));
        if (u3 = u3.getChild(s3[f3]) ?? null, !u3) return i3 ? (0, d2.Err)((0, l2.createStatError)(`ENOENT`, o3, c3)) : (0, d2.Ok)(null);
        if (e5 = u3?.getNode(), e5.isSymlink() && (n3 || f3 < s3.length - 1)) {
          let n4 = (0, t2.isAbsolute)(e5.symlink) ? e5.symlink : g2((0, t2.dirname)(u3.getPath()), e5.symlink);
          s3 = (0, l2.filenameToSteps)(n4).concat(s3.slice(f3 + 1)), u3 = this.root, f3 = 0;
          continue;
        }
        if (i3 && !e5.isDirectory() && f3 < s3.length - 1) {
    ...
    getLinkParentAsDirOrThrow(e4, t3) {
      let n3 = m2 + (e4 instanceof Array ? e4 : (0, l2.filenameToSteps)(e4)).slice(0, -1).join(m2), r3 = this.getLinkOrThrow(n3, t3);
    ...
    _toJSON(e4 = this.root, t3 = {}, n3, r3) {
      ...
      for (let o4 of a3.keys()) {
        ...
        if (s3.isFile()) {
          let e5 = a4.getPath();
          n3 && (e5 = h2(n3, e5)), t3[e5] = r3 ? s3.getBuffer() : s3.getString();
        } else s3.isDirectory() && this._toJSON(a4, t3, n3, r3);
      }
      let o3 = e4.getPath();
      return n3 && (o3 = h2(n3, o3)), o3 && i3 && (t3[o3] = null), t3;
    }
    ...
    openLink(e4, t3, n3 = true) {
      ...
      let a3 = r3.getNode();
      if (a3.isDirectory()) {
        if ((t3 & (_2 | y2 | v2)) !== _2) throw (0, l2.createError)(`EISDIR`, `open`, e4.getPath());
      } else if (t3 & w2) throw (0, l2.createError)(`ENOTDIR`, `open`, e4.getPath());
      if ((t3 & (_2 | y2 | v2)) !== v2 && !a3.canRead() || t3 & (v2 | y2) && !a3.canWrite()) throw (0, l2.createError)(`EACCES`, `open`, e4.getPath());
      let o3 = new i2.File(e4, a3, t3, this.newFdNumber());
      if (this.fds[o3.fd] = o3, this.openFiles++, t3 & S2) {
        let e5 = o3.node.getSize() > 0;
        o3.truncate(), e5 && this.emit(new p2.FsEvent(2, o3.link.steps, o3.node, o3.link));
      }
      return o3;
    }
    openFile(e4, n3, r3, i3 = true) {
      ...
      try {
        if (o3 = i3 ? this.getResolvedLinkOrThrow(e4, `open`) : this.getLinkOrThrow(e4, `open`), o3 && n3 & b2 && n3 & x2) throw (0, l2.createError)(`EEXIST`, `open`, e4);
      } catch (i4) {
        if (i4.code === `ENOENT` && n3 & b2) {
          ...
          r3 ?? (r3 = 438), o3 = this.createLink(i5, a3[a3.length - 1], false, r3), this.emit(new p2.FsEvent(0, o3.steps, o3.getNode(), o3));
        } else throw i4;
      }
    ...
    write(e4, t3, n3, r3, i3) {
      ...
      let o3 = a3.write(t3, n3, r3, i3 === -1 || typeof i3 != `number` ? void 0 : i3);
      return o3 > 0 && this.emit(new p2.FsEvent(2, a3.link.steps, a3.node, a3.link)), o3;
    }
  };
  e2.Superblock = T2, T2.fd = 2147483647;
})), bn = i(((e2) => {
  Object.defineProperty(e2, "__esModule", { value: true }), e2.CoreWatcher = e2.CoreWatchEvent = void 0;
  var t2 = se(), n2 = class {
    constructor(e3, t3, n3, r2, i2 = void 0) {
      this.type = e3, this.steps = t3, this.node = n3, this.link = r2, this.oldSteps = i2;
    }
  };
  e2.CoreWatchEvent = n2, e2.CoreWatcher = class {
    constructor(e3, n3, r2 = {}) {
      this.changes = new t2.FanOut(), this.link = r2.follow ?? true ? e3.getResolvedLinkOrThrow(n3, `watch`) : e3.getLinkOrThrow(n3, `watch`), this.node = this.link.getNode(), this.recursive = !!r2.recursive, this.unsub = e3.changes.listen((e4) => this.onEvent(e4));
    }
    get closed() {
      return !this.unsub;
    }
    onEvent(e3) {
      let t3 = this.link.steps.length;
      if (e3.link === this.link || e3.node === this.node && (e3.type === 2 || e3.type === 3)) {
        this.changes.emit(new n2(e3.type, [], e3.node, this.link)), e3.type === 1 && this.close();
        return;
      }
      if (e3.type === 4) {
        let r2 = e3.oldSteps && this.inScope(e3.oldSteps) ? e3.oldSteps.slice(t3) : void 0, i2 = this.inScope(e3.steps) ? e3.steps.slice(t3) : void 0;
        r2 && i2 ? this.changes.emit(new n2(4, i2, e3.node, e3.link, r2)) : r2 ? this.changes.emit(new n2(1, r2, e3.node, e3.link)) : i2 && this.changes.emit(new n2(0, i2, e3.node, e3.link));
        return;
      }
      this.inScope(e3.steps) && this.changes.emit(new n2(e3.type, e3.steps.slice(t3), e3.node, e3.link));
    }
    inScope(e3) {
      let t3 = this.link.steps;
      if (e3.length <= t3.length || !this.recursive && e3.length !== t3.length + 1) return false;
      for (let n3 = 0; n3 < t3.length; n3++) if (e3[n3] !== t3[n3]) return false;
      return true;
    }
    close() {
  ...
  var n2 = (q(), e(f));
  n2.__exportStar(J(), t2), n2.__exportStar(ie(), t2), n2.__exportStar(ae(), t2), n2.__exportStar(oe(), t2);
  var r2 = ye();
  ...
  } }), n2.__exportStar(vn(), t2), n2.__exportStar(bn(), t2);
  var s2 = _n();
  ...
  var n2 = kn()(), r2 = st()(`Object.prototype.toString`), i2 = function(e3) {
  ...
  var n2 = st(), r2 = kn()(), i2 = at(), a2 = We(), o2;
  if (r2) {
  ...
  var n2 = st(), r2 = jn(), i2 = n2(`RegExp.prototype.exec`), a2 = we();
  t2.exports = function(e3) {
  ...
  var n2 = st(), r2 = Mn()(/^\s*(?:function)?\*/), i2 = kn()(), a2 = it(), o2 = n2(`Object.prototype.toString`), s2 = n2(`Function.prototype.toString`), c2 = Nn();
  t2.exports = function(e3) {
  ...
  var n2 = Fn(), r2 = Object.prototype.toString, i2 = Object.prototype.hasOwnProperty, a2 = function(e3, t3, n3) {
  ...
  t2.exports = function(e3, t3, o2) {
    ...
    var s2 = arguments.length > 3 ? arguments[3] : null, c2 = arguments.length > 4 ? arguments[4] : null, l2 = arguments.length > 5 ? arguments[5] : null, u2 = arguments.length > 6 && arguments[6], d2 = !!a2 && a2(e3, t3);
  ...
  var n2 = ot(), r2 = zn(), i2 = Bn()(), a2 = We(), o2 = we(), s2 = n2(`%Math.floor%`);
  t2.exports = function(e3, t3) {
  ...
  var n2 = Ze(), r2 = $e(), i2 = tt();
  t2.exports = function() {
    return i2(n2, r2, arguments);
  };
})), Un = i(((e2, t2) => {
  var n2 = Vn(), r2 = Ge(), i2 = nt(), a2 = Hn();
  t2.exports = function(e3) {
  ...
  a();
  var n2 = In(), r2 = Rn(), i2 = Un(), s2 = st(), c2 = We(), l2 = it(), u2 = s2(`Object.prototype.toString`), d2 = kn()(), f2 = typeof globalThis > `u` ? o : globalThis, p2 = r2(), m2 = s2(`String.prototype.slice`), h2 = s2(`Array.prototype.indexOf`, true) || function(e3, t3) {
  ...
  t2.exports = function(e3) {
    ...
    if (!d2) {
      var t3 = m2(u2(e3), 8, -1);
      return y2(t3) ? t3 : t3 === `Object` && v2(e3);
    }
  ...
  e2.isSetIterator = ee2;
  function te2(e3) {
    return c2(e3) === `[object Generator]`;
  }
  e2.isGeneratorObject = te2;
  function G2(e3) {
    return c2(e3) === `[object WebAssembly.Module]`;
  }
  e2.isWebAssemblyCompiledModule = G2;
  function ne2(e3) {
    return m2(e3, l2);
  }
  e2.isNumberObject = ne2;
  function K2(e3) {
    return m2(e3, u2);
  }
  e2.isStringObject = K2;
  function q2(e3) {
    return m2(e3, d2);
  }
  e2.isBooleanObject = q2;
  function re2(e3) {
    return o2 && m2(e3, f2);
  }
  e2.isBigIntObject = re2;
  function J2(e3) {
    return s2 && m2(e3, p2);
  }
  e2.isSymbolObject = J2;
  function Y2(e3) {
    return ne2(e3) || K2(e3) || q2(e3) || re2(e3) || J2(e3);
  }
  e2.isBoxedPrimitive = Y2;
  function X2(e3) {
...
`) >= 0 && r3++, e4 + t4.replace(/\u001b\[\d\d?m/g, ``).length + 1;
 ...
 `) + ` ` + e3.join(`,
  ...
  e2.isPrimitive = j2, e2.isBuffer = qn();
  function M2(e3) {
  ...
  }, e2.inherits = Dn(), e2._extend = function(e3, t3) {
  ...
  var u2 = Y().Buffer, d2 = Jn().inspect, f2 = d2 && d2.custom || `inspect`;
  function p2(e3, t3, n3) {
  ...
  var n2 = Zn().codes.ERR_INVALID_OPT_VALUE;
  ...
  var r2;
  k2.WritableState = D2;
  var i2 = { deprecate: $n() }, s2 = On(), c2 = Y().Buffer, d2 = (o === void 0 ? typeof window < `u` ? window : typeof self < `u` ? self : {} : o).Uint8Array || function() {
  };
  function f2(e3) {
    return c2.from(e3);
  }
  ...
  var m2 = Xn(), h2 = Qn().getHighWaterMark, g2 = Zn().codes, _2 = g2.ERR_INVALID_ARG_TYPE, v2 = g2.ERR_METHOD_NOT_IMPLEMENTED, y2 = g2.ERR_MULTIPLE_CALLBACK, b2 = g2.ERR_STREAM_CANNOT_PIPE, x2 = g2.ERR_STREAM_DESTROYED, S2 = g2.ERR_STREAM_NULL_VALUES, C2 = g2.ERR_STREAM_WRITE_AFTER_END, w2 = g2.ERR_UNKNOWN_ENCODING, T2 = m2.errorOrDestroy;
  Dn()(k2, s2);
  function E2() {
  }
  function D2(e3, t3, i3) {
    r2 || (r2 = tr()), e3 || (e3 = {}), typeof i3 != `boolean` && (i3 = t3 instanceof r2), this.objectMode = !!e3.objectMode, i3 && (this.objectMode = this.objectMode || !!e3.writableObjectMode), this.highWaterMark = h2(this, e3, `writableHighWaterMark`, i3), this.finalCalled = false, this.needDrain = false, this.ending = false, this.ended = false, this.finished = false, this.destroyed = false;
  ...
  typeof Symbol == `function` && Symbol.hasInstance && typeof Function.prototype[Symbol.hasInstance] == `function` ? (O2 = Function.prototype[Symbol.hasInstance], Object.defineProperty(k2, Symbol.hasInstance, { value: function(e3) {
    return O2.call(this, e3) ? true : this === k2 && e3 && e3._writableState instanceof D2;
  } })) : O2 = function(e3) {
  ...
  k2.prototype._write = function(e3, t3, n3) {
    ...
    return typeof e3 == `function` ? (n3 = e3, e3 = null, t3 = null) : typeof t3 == `function` && (n3 = t3, t3 = null), e3 != null && this.write(e3, t3), r3.corked && (r3.corked = 1, this.uncork()), r3.ending || ee2(this, r3, n3), this;
  ...
  var t2 = nr().Buffer, n2 = t2.isEncoding || function(e3) {
  ...
  var n2 = Zn().codes.ERR_STREAM_PREMATURE_CLOSE;
  function r2(e3) {
    var t3 = false;
    return function() {
      if (!t3) {
  ...
  var o2 = ir(), s2 = /* @__PURE__ */ Symbol(`lastResolve`), c2 = /* @__PURE__ */ Symbol(`lastReject`), d2 = /* @__PURE__ */ Symbol(`error`), f2 = /* @__PURE__ */ Symbol(`ended`), p2 = /* @__PURE__ */ Symbol(`lastPromise`), m2 = /* @__PURE__ */ Symbol(`handlePromise`), h2 = /* @__PURE__ */ Symbol(`stream`);
  function g2(e3, t3) {
  ...
  a(), u(), t2.exports = A2;
  var n2;
  A2.ReadableState = k2, En().EventEmitter;
  var r2 = function(e3, t3) {
    return e3.listeners(t3).length;
  }, i2 = On(), s2 = Y().Buffer, c2 = (o === void 0 ? typeof window < `u` ? window : typeof self < `u` ? self : {} : o).Uint8Array || function() {
  };
  function d2(e3) {
    return s2.from(e3);
  }
  ...
  var p2 = Jn(), m2 = p2 && p2.debuglog ? p2.debuglog(`stream`) : function() {
  }, h2 = Yn(), g2 = Xn(), _2 = Qn().getHighWaterMark, v2 = Zn().codes, y2 = v2.ERR_INVALID_ARG_TYPE, b2 = v2.ERR_STREAM_PUSH_AFTER_EOF, x2 = v2.ERR_METHOD_NOT_IMPLEMENTED, S2 = v2.ERR_STREAM_UNSHIFT_AFTER_END_EVENT, C2, w2, T2;
  Dn()(A2, i2);
  ...
  A2.prototype.read = function(e3) {
    ...
    if (e3 !== 0 && (t3.emittedReadable = false), e3 === 0 && t3.needReadable && ((t3.highWaterMark === 0 ? t3.length > 0 : t3.length >= t3.highWaterMark) || t3.ended)) return m2(`read: emitReadable`, t3.length, t3.ended), t3.length === 0 && t3.ended ? K2(this) : R2(this), null;
    if (e3 = I2(e3, t3), e3 === 0 && t3.ended) return t3.length === 0 && K2(this), null;
    ...
    var i3 = e3 > 0 ? ne2(e3, t3) : null;
    return i3 === null ? (t3.needReadable = t3.length <= t3.highWaterMark, e3 = 0) : (t3.length -= e3, t3.awaitDrain = 0), t3.length === 0 && (t3.ended || (t3.needReadable = true), n3 !== e3 && t3.ended && K2(this)), i3 !== null && this.emit(`data`, i3), i3;
  };
  function L2(e3, t3) {
  ...
  function z2(e3) {
    var t3 = e3._readableState;
    m2(`emitReadable_`, t3.destroyed, t3.length, t3.ended), !t3.destroyed && (t3.length || t3.ended) && (e3.emit(`readable`), t3.emittedReadable = false), t3.needReadable = !t3.flowing && !t3.ended && t3.length <= t3.highWaterMark, G2(e3);
  }
  function B2(e3, t3) {
  ...
  A2.prototype._read = function(e3) {
    ...
    function f3(t4) {
      m2(`ondata`);
      var r3 = e3.write(t4);
      m2(`dest.write`, r3), r3 === false && ((i3.pipesCount === 1 && i3.pipes === e3 || i3.pipesCount > 1 && re2(i3.pipes, e3) !== -1) && !u2 && (m2(`false write response, pause`, i3.awaitDrain), i3.awaitDrain++), n3.pause());
    }
    function p3(t4) {
  ...
  function H2(e3) {
    return function() {
      var t3 = e3._readableState;
      m2(`pipeOnDrain`, t3.awaitDrain), t3.awaitDrain && t3.awaitDrain--, t3.awaitDrain === 0 && r2(e3, `data`) && (t3.flowing = true, G2(e3));
    };
  }
  ...
  A2.prototype.resume = function() {
    ...
    return e3.flowing || (m2(`resume`), e3.flowing = !e3.readableListening, ee2(this, e3)), e3.paused = false, this;
  };
  function ee2(e3, t3) {
    t3.resumeScheduled || (t3.resumeScheduled = true, l.nextTick(te2, e3, t3));
  }
  function te2(e3, t3) {
    m2(`resume`, t3.reading), t3.reading || e3.read(0), t3.resumeScheduled = false, e3.emit(`resume`), G2(e3), t3.flowing && !t3.reading && e3.read(0);
  }
  ...
  A2.prototype.wrap = function(e3) {
    ...
    return w2 === void 0 && (w2 = ar()), w2(this);
  ...
  } }), A2._fromList = ne2, Object.defineProperty(A2.prototype, "readableLength", { enumerable: false, get: function() {
  ...
  function K2(e3) {
    var t3 = e3._readableState;
    m2(`endReadable`, t3.endEmitted), t3.endEmitted || (t3.ended = true, l.nextTick(q2, t3, e3));
  }
  function q2(e3, t3) {
  ...
  typeof Symbol == `function` && (A2.from = function(e3, t3) {
    return T2 === void 0 && (T2 = or()), T2(A2, e3, t3);
  });
  function re2(e3, t3) {
    for (var n3 = 0, r3 = e3.length; n3 < r3; n3++) if (e3[n3] === t3) return n3;
    return -1;
  ...
  t2.exports = l2;
  var n2 = Zn().codes, r2 = n2.ERR_METHOD_NOT_IMPLEMENTED, i2 = n2.ERR_MULTIPLE_CALLBACK, a2 = n2.ERR_TRANSFORM_ALREADY_TRANSFORMING, o2 = n2.ERR_TRANSFORM_WITH_LENGTH_0, s2 = tr();
  Dn()(l2, s2);
  function c2(e3, t3) {
  ...
  var i2 = Zn().codes, a2 = i2.ERR_MISSING_ARGS, o2 = i2.ERR_STREAM_DESTROYED;
  function s2(e3) {
    if (e3) throw e3;
  }
  function c2(e3) {
  ...
  function l2(e3, t3, i3, a3) {
    ...
    e3.on(`close`, function() {
      s3 = true;
    }), n2 === void 0 && (n2 = ir()), n2(e3, { readable: t3, writable: i3 }, function(e4) {
      if (e4) return a3(e4);
      s3 = true, a3();
    });
    var l3 = false;
  ...
  t2.exports = r2;
  var n2 = En().EventEmitter;
  Dn()(r2, n2), r2.Readable = sr(), r2.Writable = er(), r2.Duplex = tr(), r2.Transform = cr(), r2.PassThrough = lr(), r2.finished = ir(), r2.pipeline = ur(), r2.Stream = r2;
  function r2() {
    n2.call(this);
  }
  ...
  function m2(t3) {
    if (t3 instanceof Uint8Array && (t3 = (0, i2.bufferFrom)(t3)), typeof t3 != `string` && !i2.Buffer.isBuffer(t3)) {
      try {
        if (!(t3 instanceof (gn(), e(gt)).URL)) throw TypeError(n2.ERRSTR.PATH_STR);
      } catch {
  ...
  u(), Object.defineProperty(e2, "__esModule", { value: true }), e2.FsPromises = void 0;
  var t2 = mr(), n2 = $(), r2 = (e3) => {
    let t3 = Error(`The operation was aborted`);
    return t3.name = `AbortError`, t3.code = `ABORT_ERR`, t3.cause = e3.reason, t3;
  }, i2 = class {
    constructor(e3, t3, n3 = {}) {
      this.fs = e3, this.path = t3, this.options = n3, this.eventQueue = [], this.resolveQueue = [], this.finished = false, this.maxQueue = n3.maxQueue || 2048;
      let i3 = n3.overflow || `ignore`;
      if (i3 !== `ignore` && i3 !== `error` && i3 !== `throw`) throw TypeError(`The argument 'options.overflow' must be one of: 'ignore', 'error'. Received '${i3}'`);
      this.overflow = i3 === `throw` ? `error` : i3;
      let a2 = n3.signal;
      if (a2) {
        if (a2.aborted) {
          this.finish(r2(a2));
        ...
        this.onAbort = () => this.finish(r2(a2)), a2.addEventListener(`abort`, this.onAbort);
      }
      this.startWatching();
    }
    startWatching() {
      let { signal: e3, ...t3 } = this.options;
      try {
        this.watcher = this.fs.watch(this.path, t3, (e4, t4) => {
          this.enqueueEvent({ eventType: e4, filename: t4 });
        });
      } catch (e4) {
        throw this.finish(), e4;
      }
    }
    enqueueEvent(e3) {
      if (!this.finished) {
        if (this.eventQueue.length >= this.maxQueue) {
          if (this.overflow === `error`) {
            ...
            e4.code = `ERR_FS_WATCH_QUEUE_OVERFLOW`, this.finish(e4);
          } else l !== void 0 && typeof l.emitWarning == `function` && l.emitWarning(`fs.watch maxQueue exceeded`);
          return;
        }
    ...
    finish(e3) {
      ...
      this.finished = true, this.error = e3, e3 && (this.eventQueue.length = 0), this.onAbort && (this.onAbort = (this.options.signal.removeEventListener(`abort`, this.onAbort), void 0)), this.watcher && (this.watcher = (this.watcher.close(), null));
      let t3 = e3 && this.resolveQueue.length > 0;
      for (; this.resolveQueue.length > 0; ) {
        let { resolve: t4, reject: n3 } = this.resolveQueue.shift();
        e3 ? n3(e3) : t4({ value: void 0, done: true });
      }
      t3 && (this.error = void 0);
    }
    async next() {
      if (this.error) {
        let e3 = this.error;
        throw this.error = void 0, e3;
      }
  ...
  e2.FsPromises = class {
    constructor(e3, r3) {
      this.fs = e3, this.FileHandle = r3, this.constants = n2.constants, this.cp = (0, t2.promisify)(this.fs, `cp`), this.opendir = (0, t2.promisify)(this.fs, `opendir`), this.statfs = (0, t2.promisify)(this.fs, `statfs`), this.lutimes = (0, t2.promisify)(this.fs, `lutimes`), this.glob = (0, t2.promisify)(this.fs, `glob`), this.access = (0, t2.promisify)(this.fs, `access`), this.chmod = (0, t2.promisify)(this.fs, `chmod`), this.chown = (0, t2.promisify)(this.fs, `chown`), this.copyFile = (0, t2.promisify)(this.fs, `copyFile`), this.lchmod = (0, t2.promisify)(this.fs, `lchmod`), this.lchown = (0, t2.promisify)(this.fs, `lchown`), this.link = (0, t2.promisify)(this.fs, `link`), this.lstat = (0, t2.promisify)(this.fs, `lstat`), this.mkdir = (0, t2.promisify)(this.fs, `mkdir`), this.mkdtemp = (0, t2.promisify)(this.fs, `mkdtemp`), this.readdir = (0, t2.promisify)(this.fs, `readdir`), this.readlink = (0, t2.promisify)(this.fs, `readlink`), this.realpath = (0, t2.promisify)(this.fs, `realpath`), this.rename = (0, t2.promisify)(this.fs, `rename`), this.rmdir = (0, t2.promisify)(this.fs, `rmdir`), this.rm = (0, t2.promisify)(this.fs, `rm`), this.stat = (0, t2.promisify)(this.fs, `stat`), this.symlink = (0, t2.promisify)(this.fs, `symlink`), this.truncate = (0, t2.promisify)(this.fs, `truncate`), this.unlink = (0, t2.promisify)(this.fs, `unlink`), this.utimes = (0, t2.promisify)(this.fs, `utimes`), this.readFile = (e4, n3) => (0, t2.promisify)(this.fs, `readFile`)(e4 instanceof this.FileHandle ? e4.fd : e4, n3), this.appendFile = (e4, n3, r4) => (0, t2.promisify)(this.fs, `appendFile`)(e4 instanceof this.FileHandle ? e4.fd : e4, n3, r4), this.open = (e4, n3 = `r`, r4) => (0, t2.promisify)(this.fs, `open`, (e5) => new this.FileHandle(this.fs, e5))(e4, n3, r4), this.writeFile = (e4, n3, r4) => ((0, t2.isReadableStream)(n3) ? (0, t2.streamToBuffer)(n3) : Promise.resolve(n3)).then((n4) => (0, t2.promisify)(this.fs, `writeFile`)(e4 instanceof this.FileHandle ? e4.fd : e4, n4, r4)), this.watch = (e4, t3) => {
        let n3 = typeof t3 == `string` ? { encoding: t3 } : t3 || {};
        return new i2(this.fs, e4, n3);
      };
    }
  };
})), _r = i(((e2) => {
...
` + e3);
  ...
  Object.defineProperty(t2, "__esModule", { value: true });
  var n2 = (q(), e(f));
  n2.__exportStar(_r(), t2), n2.__exportStar(vr(), t2), n2.__exportStar(yr(), t2);
})), xr = i(((e2) => {
  ...
  var t2 = Cr(), n2 = new Uint8Array([]), r2 = new DataView(n2.buffer), i2 = typeof c == `function`, a2 = i2 ? c.prototype.utf8Write : null, o2 = i2 ? c.from : null, l2 = typeof TextEncoder < `u` ? new TextEncoder() : null;
  e2.Writer = class {
  ...
  Object.defineProperty(e2, "__esModule", { value: true }), e2.validateEntryName = e2.writer = void 0, e2.writer = new (wr()).Writer(1024 * 32), e2.validateEntryName = (e3) => {
    if (!e3 || e3 === `.` || e3 === `..` || e3.indexOf(`/`) !== -1 || e3.indexOf(`\\`) !== -1) throw Error(`Invalid snapshot entry name: ${JSON.stringify(e3)}`);
  };
})), Er = i(((e2) => {
  Object.defineProperty(e2, "__esModule", { value: true }), e2.fromSnapshotSync = e2.toSnapshotSync = void 0;
  var t2 = Tr();
  e2.toSnapshotSync = ({ fs: t3, path: n2 = `/`, separator: r2 = `/` }) => {
    let i2 = t3.lstatSync(n2);
    if (i2.isDirectory()) {
      let i3 = t3.readdirSync(n2), a2 = {}, o2 = n2.endsWith(r2) ? n2 : n2 + r2;
      for (let n3 of i3) {
        let i4 = (0, e2.toSnapshotSync)({ fs: t3, path: `${o2}${n3}`, separator: r2 });
        i4 && (a2[`` + n3] = i4);
      }
      return [0, {}, a2];
    } else if (i2.isFile()) {
      let e3 = t3.readFileSync(n2);
      return [1, {}, new Uint8Array(e3.buffer, e3.byteOffset, e3.byteLength)];
    } else if (i2.isSymbolicLink()) return [2, { target: t3.readlinkSync(n2).toString() }];
    return null;
  }, e2.fromSnapshotSync = (n2, { fs: r2, path: i2 = `/`, separator: a2 = `/` }) => {
    if (n2) switch (n2[0]) {
      case 0: {
        i2.endsWith(a2) || (i2 += a2);
        let [, , o2] = n2;
        r2.mkdirSync(i2, { recursive: true });
        for (let [n3, s2] of Object.entries(o2)) (0, t2.validateEntryName)(n3), (0, e2.fromSnapshotSync)(s2, { fs: r2, path: `${i2}${n3}`, separator: a2 });
        break;
      }
      case 1: {
        let [, , e3] = n2;
        r2.writeFileSync(i2, e3);
        break;
      }
      case 2: {
        let [, { target: e3 }] = n2;
        r2.symlinkSync(e3, i2);
        break;
      }
    }
  };
  ...
  var t2 = wr(), n2 = Number.isSafeInteger;
  ...
  var n2 = (q(), e(f)).__importDefault(Rr()), r2 = 1 + Math.round(Math.random() * ((-1 >>> 0) - 1));
  function i2(e2, t3) {
  ...
  Object.defineProperty(e2, "__esModule", { value: true }), e2.default = new (zr()).CachedUtf8Decoder();
})), Vr = i(((t2) => {
  Object.defineProperty(t2, "__esModule", { value: true }), t2.CborDecoderBase = void 0;
  var n2 = (q(), e(f)), r2 = Mr(), i2 = Or(), a2 = Ar(), o2 = Lr(), s2 = n2.__importDefault(Br());
  ...
  Object.defineProperty(e2, "__esModule", { value: true }), e2.fromSnapshot = e2.toSnapshot = void 0;
  var t2 = Tr();
  e2.toSnapshot = async ({ fs: t3, path: n2 = `/`, separator: r2 = `/` }) => {
    let i2 = await t3.lstat(n2);
    if (i2.isDirectory()) {
      let i3 = await t3.readdir(n2), a2 = {}, o2 = n2.endsWith(r2) ? n2 : n2 + r2, s2 = await Promise.all(i3.map((n3) => (0, e2.toSnapshot)({ fs: t3, path: `${o2}${n3}`, separator: r2 })));
      for (let e3 = 0; e3 < i3.length; e3++) s2[e3] && (a2[`` + i3[e3]] = s2[e3]);
      return [0, {}, a2];
    } else if (i2.isFile()) {
      let e3 = await t3.readFile(n2);
      return [1, {}, new Uint8Array(e3.buffer, e3.byteOffset, e3.byteLength)];
    } else if (i2.isSymbolicLink()) return [2, { target: await t3.readlink(n2, { encoding: `utf8` }) }];
    return null;
  }, e2.fromSnapshot = async (n2, { fs: r2, path: i2 = `/`, separator: a2 = `/` }) => {
    if (n2) switch (n2[0]) {
      case 0: {
        i2.endsWith(a2) || (i2 += a2);
        let [, , o2] = n2;
        await r2.mkdir(i2, { recursive: true });
        for (let [n3, s2] of Object.entries(o2)) (0, t2.validateEntryName)(n3), await (0, e2.fromSnapshot)(s2, { fs: r2, path: `${i2}${n3}`, separator: a2 });
        break;
      }
      case 1: {
        let [, , e3] = n2;
        await r2.writeFile(i2, e3);
        break;
      }
      case 2: {
        let [, { target: e3 }] = n2;
        await r2.symlink(e3, i2);
        break;
      }
    }
  };
  ...
  var t2 = jr(), n2 = Hr(), r2 = Er(), i2 = Ur(), a2 = Tr(), o2 = new t2.CborEncoder(a2.writer), s2 = new n2.CborDecoder();
  ...
  Object.defineProperty(e2, "__esModule", { value: true }), e2.toBase64Bin = void 0, e2.toBase64Bin = (0, Kr().createToBase64Bin)();
})), Jr = i(((e2) => {
  ...
  Object.defineProperty(e2, "__esModule", { value: true }), e2.fromBase64Bin = void 0, e2.fromBase64Bin = (0, Yr().createFromBase64Bin)();
})), Zr = i(((e2) => {
  ...
  var t2 = Ir(), n2 = Lr(), r2 = Xr(), i2 = Zr(), a2 = /\\(b|f|n|r|t|"|\/|\\)/g, o2 = (e3) => {
    switch (e3) {
      case `\\b`:
        return `\b`;
      case `\\f`:
...
`;
  ...
  var t2 = Jr(), n2 = Qr(), r2 = Er(), i2 = Ur(), a2 = Tr(), o2 = new t2.JsonEncoder(a2.writer), s2 = new n2.JsonDecoder();
  ...
  Object.defineProperty(t2, "__esModule", { value: true });
  var n2 = (q(), e(f));
  n2.__exportStar(Sr(), t2), n2.__exportStar(Er(), t2), n2.__exportStar(Wr(), t2), n2.__exportStar($r(), t2);
})), ti = i(((e2) => {
  ...
  var t2 = $(), n2 = mr(), r2 = { mode: 511, recursive: false };
  ...
  var t2 = re(), n2 = _e(), r2 = mr(), i2 = t2.posix.join, a2 = t2.posix.relative, o2 = t2.posix.resolve;
  function s2(e3, t3) {
  ...
  a(), Object.defineProperty(e2, "__esModule", { value: true }), e2.FSWatcher = e2.StatWatcher = e2.Volume = void 0, e2.pathToSteps = R2, e2.dataToStr = z2, e2.toUnixTimestamp = B2;
  var t2 = re(), n2 = xn(), r2 = _n(), i2 = Sn(), s2 = Cn(), c2 = wn(), l2 = Z(), u2 = Tn(), d2 = fr(), f2 = $(), p2 = pr(), m2 = hr(), h2 = me(), g2 = gr(), _2 = xr(), v2 = ei(), y2 = $(), b2 = he(), x2 = ti(), S2 = mr(), C2 = ni(), w2 = t2.resolve, { O_SYMLINK: T2, F_OK: E2, R_OK: D2, W_OK: O2, X_OK: k2, COPYFILE_EXCL: A2, COPYFILE_FICLONE_FORCE: j2 } = f2.constants, M2 = t2.posix ? t2.posix.sep : t2.sep, N2 = t2.posix ? t2.posix.relative : t2.relative, P2 = t2.posix ? t2.posix.join : t2.join, F2 = t2.posix ? t2.posix.dirname : t2.dirname, I2 = t2.posix ? t2.posix.normalize : t2.normalize, L2 = 128;
  function R2(e3) {
    return (0, n2.filenameToSteps)((0, S2.pathToFilename)(e3));
  }
  function z2(e3, t3 = f2.ENCODING_UTF8) {
  ...
  var U2 = class {
    ...
    constructor(e3 = new n2.Superblock()) {
      this._core = e3, this.promisesApi = new g2.FsPromises(this, m2.FileHandle), this.openSync = (e4, t3, n3 = 438) => {
        ...
        return r2.isWin && (l4 = l4.replace(/\\/g, `/`)), c4.map((e5) => {
          if (i3.recursive) {
            let n3 = P2(e5.parentPath, e5.name.toString());
        ...
        this._core.futimes(e4, t3, n3);
      }, this.futimesSync = (e4, t3, n3) => {
        this._futimes(e4, B2(t3), B2(n3));
      }, this.futimes = (e4, t3, n3, r3) => {
        this.wrapAsync(this._futimes, [e4, B2(t3), B2(n3)], r3);
      }, this._utimes = (e4, t3, n3, r3 = true) => {
        this._core.utimes(e4, t3, n3, r3);
      }, this.utimesSync = (e4, t3, n3) => {
        this._utimes((0, S2.pathToFilename)(e4), B2(t3), B2(n3), true);
      }, this.utimes = (e4, t3, n3, r3) => {
        this.wrapAsync(this._utimes, [(0, S2.pathToFilename)(e4), B2(t3), B2(n3), true], r3);
      }, this.lutimesSync = (e4, t3, n3) => {
        this._utimes((0, S2.pathToFilename)(e4), B2(t3), B2(n3), false);
      }, this.lutimes = (e4, t3, n3, r3) => {
        this.wrapAsync(this._utimes, [(0, S2.pathToFilename)(e4), B2(t3), B2(n3), false], r3);
        ...
        n3 ? this._core.chmod(e4, t3) : this._core.lchmod(e4, t3);
        ...
        this._core.fchown(e4, t3, n3);
      }, this.fchownSync = (e4, t3, n3) => {
        V2(t3), H2(n3), this._fchown(e4, t3, n3);
      }, this.fchown = (e4, t3, n3, r3) => {
        V2(t3), H2(n3), this.wrapAsync(this._fchown, [e4, t3, n3], r3);
      }, this._chown = (e4, t3, n3) => {
        this._core.chown(e4, t3, n3);
      }, this.chownSync = (e4, t3, n3) => {
        V2(t3), H2(n3), this._chown((0, S2.pathToFilename)(e4), t3, n3);
      }, this.chown = (e4, t3, n3, r3) => {
        V2(t3), H2(n3), this.wrapAsync(this._chown, [(0, S2.pathToFilename)(e4), t3, n3], r3);
      }, this._lchown = (e4, t3, n3) => {
        this._core.lchown(e4, t3, n3);
      }, this.lchownSync = (e4, t3, n3) => {
        V2(t3), H2(n3), this._lchown((0, S2.pathToFilename)(e4), t3, n3);
      }, this.lchown = (e4, t3, n3, r3) => {
        V2(t3), H2(n3), this.wrapAsync(this._lchown, [(0, S2.pathToFilename)(e4), t3, n3], r3);
      ...
      let a2 = this;
      this.StatWatcher = class extends te2 {
        constructor() {
          super(a2);
        }
      };
      ...
      }, this.FSWatcher = class extends Y2 {
        constructor() {
          super(a2);
        }
      };
    ...
    _write(e3, t3, n3, r3, i3) {
      return this._core.write(e3, t3, n3, r3, i3);
    }
    writevBase(e3, t3, n3) {
      this._core.getFileByFdOrThrow(e3);
      let r3 = n3 ?? void 0;
      r3 === -1 && (r3 = void 0);
      let i3 = 0;
      for (let n4 of t3) {
        let t4 = l2.Buffer.from(n4.buffer, n4.byteOffset, n4.byteLength), a2 = this._core.write(e3, t4, 0, t4.byteLength, r3 ?? null);
        if (r3 = void 0, i3 += a2, a2 < t4.byteLength) break;
      }
      return i3;
    }
    _copyFile(e3, t3, n3) {
    ...
    isSrcSubdir(e3, n3) {
      try {
        let r3 = I2(e3.startsWith(`/`) ? e3 : `/` + e3), i3 = I2(n3.startsWith(`/`) ? n3 : `/` + n3);
    ...
    cpDirSync(e3, t3, n3, r3, i3) {
      ...
      for (let e4 of a2) {
        let t4 = P2(n3, String(e4)), a3 = P2(r3, String(e4));
    ...
    cpSymlinkSync(e3, n3, r3, i3) {
      ...
      !i3.verbatimSymlinks && !(0, t2.isAbsolute)(a2) && (a2 = w2(F2(n3), a2)), e3 && this.unlinkSync(r3), this.symlinkSync(a2, r3);
    }
    lstat(e3, t3, n3) {
    ...
    watchFile(e3, t3, n3) {
      ...
      if (typeof i3 == `function` && (a2 = t3, i3 = null), typeof a2 != `function`) throw TypeError(`The "listener" argument must be of type function. Received ` + typeof a2);
      let o2 = 5007, s3 = true, c3 = false;
      if (i3 && typeof i3 == `object`) {
        if (i3.interval !== void 0) {
          if (typeof i3.interval != `number`) throw TypeError(`The "options.interval" property must be of type number. Received ` + typeof i3.interval);
          if (!Number.isInteger(i3.interval) || i3.interval < 0 || i3.interval > 4294967295) throw RangeError(`The value of "options.interval" is out of range. It must be an integer >= 0 && <= 4294967295. Received ${i3.interval}`);
          o2 = i3.interval;
        }
        typeof i3.persistent == `boolean` && (s3 = i3.persistent), typeof i3.bigint == `boolean` && (c3 = i3.bigint);
      }
      let l3 = this.statWatchers[r3];
      return l3 || (l3 = new this.StatWatcher(), l3.start(r3, s3, o2, c3), this.statWatchers[r3] = l3), l3.addListener(`change`, a2), l3;
    }
    unwatchFile(e3, t3) {
    ...
    watch(e3, t3, n3) {
      ...
      let { persistent: a2, recursive: o2, encoding: s3, signal: c3, throwIfNoEntry: l3, ignore: u3 } = (0, x2.getDefaultOpts)(i3);
      a2 === void 0 && (a2 = true), o2 === void 0 && (o2 = false);
      let d3 = new this.FSWatcher();
      try {
        d3.start(r3, a2, o2, s3, u3);
      } catch (e4) {
        if (l3 === false && e4.code === `ENOENT`) return d3;
        throw e4;
      }
      if (n3 && d3.addListener(`change`, n3), c3) if (c3.aborted) d3.close();
      else {
        let e4 = () => d3.close();
        c3.addEventListener(`abort`, e4, { once: true }), d3.once(`close`, () => c3.removeEventListener(`abort`, e4));
      }
      return d3;
    }
    _statfs(e3, t3 = false) {
  ...
  e2.Volume = U2, U2.fromJSON = (e3, t3, r3) => new U2(n2.Superblock.fromJSON(e3, t3, r3)), U2.fromNestedJSON = (e3, t3, r3) => new U2(n2.Superblock.fromNestedJSON(e3, t3, r3));
  function W2(e3) {
    e3.emit(`stop`);
  }
  function ee2(e3) {
    let t3 = new i2.default(), n3 = e3 ? BigInt(0) : 0, r3 = /* @__PURE__ */ new Date(0);
    return t3.uid = n3, t3.gid = n3, t3.rdev = n3, t3.blksize = n3, t3.ino = n3, t3.size = n3, t3.blocks = n3, t3.atime = r3, t3.mtime = r3, t3.ctime = r3, t3.birthtime = r3, t3.atimeMs = n3, t3.mtimeMs = n3, t3.ctimeMs = n3, t3.birthtimeMs = n3, e3 && (t3.atimeNs = n3, t3.mtimeNs = n3, t3.ctimeNs = n3, t3.birthtimeNs = n3), t3.dev = n3, t3.mode = n3, t3.nlink = n3, t3;
  }
  var te2 = class extends p2.EventEmitter {
    constructor(e3) {
      super(), this.bigint = false, this.fileExists = false, this.stopped = false, this.onInterval = () => {
        if (this.stopped) return;
        let e4 = this.statSafe();
        if (e4) {
          if (!this.fileExists) {
            this.fileExists = true;
            let t3 = this.prev;
            this.prev = e4, this.emit(`change`, e4, t3);
          } else if (this.hasChanged(e4)) {
            let t3 = this.prev;
            this.prev = e4, this.emit(`change`, e4, t3);
          }
        } else this.fileExists && (this.fileExists = false, this.emit(`change`, ee2(this.bigint), this.prev));
        this.loop();
      }, this.vol = e3;
    }
    loop() {
    ...
    hasChanged(e3) {
      let t3 = this.prev;
      return e3.mtimeMs !== t3.mtimeMs || e3.ctimeMs !== t3.ctimeMs || e3.size !== t3.size || e3.ino !== t3.ino || e3.mode !== t3.mode || e3.uid !== t3.uid || e3.gid !== t3.gid || e3.nlink !== t3.nlink;
    }
    statSafe() {
      try {
    ...
    start(e3, t3 = true, n3 = 5007, r3 = false) {
      this.filename = (0, S2.pathToFilename)(e3), this.setTimeout = t3 ? setTimeout.bind(typeof globalThis < `u` ? globalThis : o) : u2.default, this.interval = n3, this.bigint = r3;
      let i3 = this.statSafe();
      i3 ? (this.prev = i3, this.fileExists = true) : (this.prev = ee2(r3), this.fileExists = false, queueMicrotask(() => {
        this.stopped || this.emit(`change`, this.prev, this.prev);
      })), this.loop();
    }
    stop() {
      this.stopped = true, clearTimeout(this.timeoutRef), queueMicrotask(() => {
        W2.call(this, this);
      });
    }
    ref() {
      this.setTimeout = setTimeout.bind(typeof globalThis < `u` ? globalThis : o);
      let e3 = this.timeoutRef;
      return e3 && typeof e3 == `object` && typeof e3.ref == `function` && e3.ref(), this;
    }
    unref() {
      this.setTimeout = u2.default;
      let e3 = this.timeoutRef;
      return e3 && typeof e3 == `object` && typeof e3.unref == `function` && e3.unref(), this;
    }
  };
  e2.StatWatcher = te2;
  var G2;
  ...
  K2.prototype.open = function() {
    ...
    (!G2 || G2.length - G2.used < L2) && ne2(this._readableState.highWaterMark);
  ...
  (0, h2.inherits)(J2, d2.Writable), e2.WriteStream = J2;
  function J2(e3, t3, n3) {
    if (!(this instanceof J2)) return new J2(e3, t3, n3);
    if (this._vol = e3, n3 = Object.assign({}, (0, x2.getOptions)(n3, {})), d2.Writable.call(this, n3), this.path = (0, S2.pathToFilename)(t3), this._fileHandle = n3.fd && typeof n3.fd != `number` ? n3.fd : null, this.fd = n3.fd === void 0 ? null : typeof n3.fd == `number` ? n3.fd : n3.fd.fd, this.flags = n3.flags === void 0 ? `w` : n3.flags, this.mode = n3.mode === void 0 ? 438 : n3.mode, this.start = n3.start, this.autoClose = n3.autoClose === void 0 || !!n3.autoClose, this.pos = void 0, this.bytesWritten = 0, this.pending = true, this.start !== void 0) {
      if (typeof this.start != `number`) throw TypeError(`"start" option must be a Number`);
  ...
  }, J2.prototype._write = function(e3, t3, n3) {
  ...
  }, J2.prototype._writev = function(e3, t3) {
    if (typeof this.fd != `number`) return this.once(`open`, function() {
      this._writev(e3, t3);
    });
  ...
  }, J2.prototype.close = function(e3) {
    if (e3 && this.once(`close`, e3), this.closed || typeof this.fd != `number`) {
      if (typeof this.fd != `number`) {
        this.once(`open`, q2);
        return;
  ...
  }, J2.prototype._destroy = K2.prototype._destroy, J2.prototype.destroySoon = J2.prototype.end;
  var Y2 = class extends p2.EventEmitter {
    constructor(e3) {
      super(), this._filename = ``, this._filenameEncoded = ``, this._recursive = false, this._encoding = f2.ENCODING_UTF8, this._closed = false, this._onEvent = (e4) => {
        switch (e4.type) {
          case 0:
          case 1:
            this._emit(`rename`, e4.steps);
            break;
          case 4:
            e4.oldSteps && this._emit(`rename`, e4.oldSteps), this._emit(`rename`, e4.steps);
            break;
          case 2:
          case 3:
            this._emit(`change`, e4.steps);
            break;
        }
      }, this._persist = () => {
    ...
    _emit(e3, t3) {
      let n3 = t3.length ? t3.join(M2) : this._watcher.link.getName();
      this._ignore && this._ignore(n3) || this.emit(`change`, e3, (0, f2.strToEncoding)(n3, this._encoding));
    }
    ref() {
    ...
    start(e3, t3 = true, r3 = false, i3 = f2.ENCODING_UTF8, a2) {
      this._filename = (0, S2.pathToFilename)(e3), this._steps = (0, n2.filenameToSteps)(this._filename), this._filenameEncoded = (0, f2.strToEncoding)(this._filename), this._recursive = r3, this._encoding = i3, this._ignore = a2 === void 0 ? void 0 : (0, f2.watchIgnoreToMatcher)(a2);
      try {
        this._watcher = new n2.CoreWatcher(this._vol._core, this._filename, { recursive: r3 });
      } catch (e4) {
        let t4 = Error(`watch ${this._filename} ${e4.code}`);
        throw t4.code = e4.code, t4.errno = e4.code, t4;
      }
      this._link = this._watcher.link, this._watcher.changes.listen(this._onEvent), t3 && this._persist();
    }
    close() {
      clearTimeout(this._timer), this._timer = void 0, !(!this._watcher || this._closed) && (this._closed = true, this._watcher.close(), queueMicrotask(() => this.emit(`close`)));
    }
  };
  e2.FSWatcher = Y2;
})), ai = i(((e2) => {
  ...
  } }), n2.__exportStar(ti(), t2), n2.__exportStar(mr(), t2), n2.__exportStar(ri(), t2);
  var u2 = ai();

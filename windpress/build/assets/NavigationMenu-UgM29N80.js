import { D as e, E as t, Ht as n, Lt as r, On as i, Tn as a, Ut as o, Zn as s, _ as c, b as l, bt as u, ct as d, et as f, g as p, k as m, mt as h, o as g, qt as _, tr as v, tt as y, u as b, v as x, vn as S, wn as C, wt as w, xt as T, y as E } from "./runtime-core.esm-bundler-C_RgxGrN.js";
import { c as D } from "./vue.runtime.esm-bundler-CFaGDlW9.js";
import { F as O, H as k, R as A, T as j, U as ee, _ as te, b as ne, g as re, i as ie, n as ae, q as oe, r as M, v as N, x as P, y as se } from "./Button-C1y42oVo.js";
import { A as ce, I as le, T as F, b as I, f as L, j as R, k as z, o as B, r as ue, v as V } from "./dist-BVQ2eZ4j.js";
import { B as H, D as U, R as de, V as W } from "./namespaced-DqTNyUG4.js";
import { C as fe, d as pe, g as G, h as K, p as me, t as he, v as q, y as J } from "./Tooltip-C9kG7ywk.js";
import { t as ge } from "./Badge-fqhIT_bK.js";
import { t as _e } from "./Popover-qFaQT83y.js";
function ve(e2, t2) {
...
var [ye, be] = j(`CollapsibleRoot`), xe = m({ __name: `CollapsibleRoot`, props: { defaultOpen: { type: Boolean, required: false, default: false }, open: { type: Boolean, required: false, default: void 0 }, disabled: { type: Boolean, required: false }, unmountOnHide: { type: Boolean, required: false, default: true }, asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, emits: [`update:open`], setup(e2, { expose: t2, emit: n2 }) {
  ...
  J();
  let n2 = ye();
  return (e3, r2) => (h(), x(i(P), { type: e3.as === `button` ? `button` : void 0, as: e3.as, "as-child": t2.asChild, "aria-controls": i(n2).contentId, "aria-expanded": i(n2).open.value, "data-state": i(n2).open.value ? `open` : `closed`, "data-disabled": i(n2).disabled?.value ? `` : void 0, disabled: i(n2).disabled?.value, onClick: i(n2).onOpenToggle }, { default: _(() => [T(e3.$slots, `default`)]), _: 3 }, 8, [`type`, `as`, `as-child`, `aria-controls`, `aria-expanded`, `data-state`, `data-disabled`, `disabled`, `onClick`]));
} });
...
var [$, He] = j([`NavigationMenuRoot`, `NavigationMenuSub`], `NavigationMenuContext`), Ue = m({ __name: `NavigationMenuRoot`, props: { modelValue: { type: String, required: false, default: void 0 }, defaultValue: { type: String, required: false }, dir: { type: String, required: false }, orientation: { type: String, required: false, default: `horizontal` }, delayDuration: { type: Number, required: false, default: 200 }, skipDelayDuration: { type: Number, required: false, default: 300 }, disableClickTrigger: { type: Boolean, required: false, default: false }, disableHoverTrigger: { type: Boolean, required: false, default: false }, disablePointerLeaveClose: { type: Boolean, required: false }, unmountOnHide: { type: Boolean, required: false, default: true }, asChild: { type: Boolean, required: false }, as: { type: null, required: false, default: `nav` } }, emits: [`update:modelValue`], setup(t2, { emit: n2 }) {
  ...
  function w2(e3) {
    ...
    H(e3, W(), void 0, { itemsArray: r3, loop: false, enableIgnoredElement: true })?.focus();
  }
  function E2() {
  ...
  return (r2, a3) => (h(), l(g, null, [e(i(le2), null, { default: _(({ item: a4, active: c2, index: u2 }) => [T(r2.$slots, a4.slot || `item`, { item: a4, index: u2, active: c2, ui: R2.value }, () => [T(r2.$slots, a4.slot ? `${a4.slot}-leading` : `item-leading`, { item: a4, active: c2, index: u2, ui: R2.value }, () => [a4.avatar ? (h(), x(re, f({ key: 0, size: a4.ui?.linkLeadingAvatarSize || i(b2)?.linkLeadingAvatarSize || R2.value.linkLeadingAvatarSize() }, a4.avatar, { "data-slot": `linkLeadingAvatar`, class: R2.value.linkLeadingAvatar({ class: [i(b2)?.linkLeadingAvatar, a4.ui?.linkLeadingAvatar], active: c2, disabled: !!a4.disabled }) }), null, 16, [`size`, `class`])) : a4.icon && a4.chip ? (h(), x(te, f({ key: 1, size: a4.ui?.linkLeadingChipSize || i(b2)?.linkLeadingChipSize || R2.value.linkLeadingChipSize(), inset: `` }, typeof a4.chip == `object` ? a4.chip : {}, { "data-slot": `linkLeadingChip` }), { default: _(() => [e(N, { name: a4.icon, "data-slot": `linkLeadingIcon`, class: s(R2.value.linkLeadingIcon({ class: [i(b2)?.linkLeadingIcon, a4.ui?.linkLeadingIcon], active: c2, disabled: !!a4.disabled })) }, null, 8, [`name`, `class`])]), _: 2 }, 1040, [`size`])) : a4.icon ? (h(), x(N, { key: 2, name: a4.icon, "data-slot": `linkLeadingIcon`, class: s(R2.value.linkLeadingIcon({ class: [i(b2)?.linkLeadingIcon, a4.ui?.linkLeadingIcon], active: c2, disabled: !!a4.disabled })) }, null, 8, [`name`, `class`])) : E(``, true)]), i(O)(a4, o2.labelKey) || m2[a4.slot ? `${a4.slot}-label` : `item-label`] ? (h(), l(`span`, { key: 0, "data-slot": `linkLabel`, class: s(R2.value.linkLabel({ class: [i(b2)?.linkLabel, a4.ui?.linkLabel] })) }, [T(r2.$slots, a4.slot ? `${a4.slot}-label` : `item-label`, { item: a4, active: c2, index: u2 }, () => [t(v(i(O)(a4, o2.labelKey)), 1)]), a4.target === `_blank` && n2.externalIcon !== false ? (h(), x(N, { key: 0, name: typeof n2.externalIcon == `string` ? n2.externalIcon : i(y2).ui.icons.external, "data-slot": `linkLabelExternalIcon`, class: s(R2.value.linkLabelExternalIcon({ class: [i(b2)?.linkLabelExternalIcon, a4.ui?.linkLabelExternalIcon], active: c2 })) }, null, 8, [`name`, `class`])) : E(``, true)], 2)) : E(``, true), a4.badge || a4.badge === 0 || n2.orientation === `horizontal` && (a4.children?.length || m2[a4.slot ? `${a4.slot}-content` : `item-content`]) || n2.orientation === `vertical` && a4.children?.length || a4.trailingIcon || m2[a4.slot ? `${a4.slot}-trailing` : `item-trailing`] ? (h(), x(w(n2.orientation === `vertical` && a4.children?.length && !n2.collapsed ? i(Fe) : `span`), { key: 1, as: n2.orientation === `vertical` && a4.children?.length && !n2.collapsed ? `span` : void 0, "data-slot": `linkTrailing`, class: s(R2.value.linkTrailing({ class: [i(b2)?.linkTrailing, a4.ui?.linkTrailing] })), onClick: (e2) => H2(e2, a4) }, { default: _(() => [T(r2.$slots, a4.slot ? `${a4.slot}-trailing` : `item-trailing`, { item: a4, active: c2, index: u2, ui: R2.value }, () => [a4.badge || a4.badge === 0 ? (h(), x(ge, f({ key: 0, color: `neutral`, variant: `outline`, size: a4.ui?.linkTrailingBadgeSize || i(b2)?.linkTrailingBadgeSize || R2.value.linkTrailingBadgeSize() }, typeof a4.badge == `string` || typeof a4.badge == `number` ? { label: a4.badge } : a4.badge, { "data-slot": `linkTrailingBadge`, class: R2.value.linkTrailingBadge({ class: [i(b2)?.linkTrailingBadge, a4.ui?.linkTrailingBadge] }) }), null, 16, [`size`, `class`])) : E(``, true), n2.orientation === `horizontal` && (a4.children?.length || m2[a4.slot ? `${a4.slot}-content` : `item-content`]) || n2.orientation === `vertical` && a4.children?.length ? (h(), x(N, { key: 1, name: a4.trailingIcon || n2.trailingIcon || i(y2).ui.icons.chevronDown, "data-slot": `linkTrailingIcon`, class: s(R2.value.linkTrailingIcon({ class: [i(b2)?.linkTrailingIcon, a4.ui?.linkTrailingIcon], active: c2 })) }, null, 8, [`name`, `class`])) : a4.trailingIcon ? (h(), x(N, { key: 2, name: a4.trailingIcon, "data-slot": `linkTrailingIcon`, class: s(R2.value.linkTrailingIcon({ class: [i(b2)?.linkTrailingIcon, a4.ui?.linkTrailingIcon], active: c2 })) }, null, 8, [`name`, `class`])) : E(``, true)])]), _: 2 }, 1032, [`as`, `class`, `onClick`])) : E(``, true)])]), _: 3 }), e(i(I2), null, { default: _(({ item: a4, index: d3, level: p2 = 0, listIndex: S3 = 0 }) => [(h(), x(w(n2.orientation === `vertical` && !n2.collapsed ? i(Ne) : i(Ke)), f({ as: `li` }, n2.orientation === `vertical` && !n2.collapsed ? { disabled: !!a4.disabled } : {}, { value: B2(a4, d3, p2, S3) }), { default: _(() => [n2.orientation === `vertical` && a4.type === `label` && !n2.collapsed ? (h(), l(`div`, { key: 0, "data-slot": `label`, class: s(R2.value.label({ class: [i(b2)?.label, a4.ui?.label, a4.class] })) }, [e(i(F2), { item: a4, index: d3 }, null, 8, [`item`, `index`])], 2)) : a4.type === `label` ? E(``, true) : (h(), x(ae, f({ key: 1 }, n2.orientation === `vertical` && a4.children?.length && !n2.collapsed && a4.type === `trigger` ? {} : i(ie)(a4), { custom: `` }), { default: _(({ active: S4, ...C2 }) => [(h(), x(w(n2.orientation === `horizontal` && (a4.children?.length || m2[a4.slot ? `${a4.slot}-content` : `item-content`]) ? i($e) : n2.orientation === `vertical` && a4.children?.length && !n2.collapsed && !C2.href ? i(Fe) : i(Xe)), { "as-child": ``, active: S4 || a4.active, disabled: a4.disabled, onSelect: a4.onSelect }, { default: _(() => [n2.orientation === `vertical` && n2.collapsed && a4.children?.length && (o2.popover || a4.popover) ? (h(), x(_e, f({ key: 0 }, { ...P2.value, ...typeof a4.popover == `boolean` ? {} : a4.popover || {} }, { ui: { content: R2.value.content({ class: [i(b2)?.content, a4.ui?.content] }) } }), { content: _(({ close: p3 }) => [T(r2.$slots, a4.slot ? `${a4.slot}-content` : `item-content`, { item: a4, active: S4 || a4.active, index: d3, ui: R2.value, close: p3 }, () => [c(`ul`, { "data-slot": `childList`, class: s(R2.value.childList({ class: [i(b2)?.childList, a4.ui?.childList] })) }, [c(`li`, { "data-slot": `childLabel`, class: s(R2.value.childLabel({ class: [i(b2)?.childLabel, a4.ui?.childLabel] })) }, v(i(O)(a4, o2.labelKey)), 3), (h(true), l(g, null, u(a4.children, (r3, u2) => (h(), l(`li`, { key: u2, "data-slot": `childItem`, class: s(R2.value.childItem({ class: [i(b2)?.childItem, a4.ui?.childItem] })) }, [e(ae, f({ ref_for: true }, i(ie)(r3), { custom: `` }), { default: _(({ active: l2, ...u3 }) => [e(i(Xe), { "as-child": ``, active: l2, onSelect: r3.onSelect }, { default: _(() => [e(M, f({ ref_for: true }, u3, { "data-slot": `childLink`, class: R2.value.childLink({ class: [i(b2)?.childLink, a4.ui?.childLink, r3.class], active: l2 }) }), { default: _(() => [r3.icon ? (h(), x(N, { key: 0, name: r3.icon, "data-slot": `childLinkIcon`, class: s(R2.value.childLinkIcon({ class: [i(b2)?.childLinkIcon, a4.ui?.childLinkIcon], active: l2 })) }, null, 8, [`name`, `class`])) : E(``, true), c(`span`, { "data-slot": `childLinkLabel`, class: s(R2.value.childLinkLabel({ class: [i(b2)?.childLinkLabel, a4.ui?.childLinkLabel], active: l2 })) }, [t(v(i(O)(r3, o2.labelKey)) + ` `, 1), r3.target === `_blank` && n2.externalIcon !== false ? (h(), x(N, { key: 0, name: typeof n2.externalIcon == `string` ? n2.externalIcon : i(y2).ui.icons.external, "data-slot": `childLinkLabelExternalIcon`, class: s(R2.value.childLinkLabelExternalIcon({ class: [i(b2)?.childLinkLabelExternalIcon, a4.ui?.childLinkLabelExternalIcon], active: l2 })) }, null, 8, [`name`, `class`])) : E(``, true)], 2)]), _: 2 }, 1040, [`class`])]), _: 2 }, 1032, [`active`, `onSelect`])]), _: 2 }, 1040)], 2))), 128))], 2)])]), default: _(() => [e(M, f(C2, { "data-slot": `link`, class: R2.value.link({ class: [i(b2)?.link, a4.ui?.link, a4.class], active: S4 || a4.active, disabled: !!a4.disabled, level: p2 > 0 }) }), { default: _(() => [e(i(F2), { item: a4, active: S4 || a4.active, index: d3 }, null, 8, [`item`, `active`, `index`])]), _: 2 }, 1040, [`class`])]), _: 2 }, 1040, [`ui`])) : n2.orientation === `vertical` && n2.collapsed && (o2.tooltip || a4.tooltip) || n2.orientation === `horizontal` && a4.tooltip ? (h(), x(he, f({ key: 1, text: i(O)(a4, o2.labelKey) }, { ...j2.value, ...typeof a4.tooltip == `boolean` ? {} : a4.tooltip || {} }), { default: _(() => [e(M, f(C2, { "data-slot": `link`, class: R2.value.link({ class: [i(b2)?.link, a4.ui?.link, a4.class], active: S4 || a4.active, disabled: !!a4.disabled, level: p2 > 0 }) }), { default: _(() => [e(i(F2), { item: a4, active: S4 || a4.active, index: d3 }, null, 8, [`item`, `active`, `index`])]), _: 2 }, 1040, [`class`])]), _: 2 }, 1040, [`text`])) : (h(), x(M, f({ key: 2 }, C2, { "data-slot": `link`, class: R2.value.link({ class: [i(b2)?.link, a4.ui?.link, a4.class], active: S4 || a4.active, disabled: !!a4.disabled, level: n2.orientation === `horizontal` || p2 > 0 }) }), { default: _(() => [e(i(F2), { item: a4, active: S4 || a4.active, index: d3 }, null, 8, [`item`, `active`, `index`])]), _: 2 }, 1040, [`class`]))]), _: 2 }, 1064, [`active`, `disabled`, `onSelect`])), n2.orientation === `horizontal` && (a4.children?.length || m2[a4.slot ? `${a4.slot}-content` : `item-content`]) ? (h(), x(i(Je), f({ key: 0 }, k2.value, { "data-slot": `content`, class: R2.value.content({ class: [i(b2)?.content, a4.ui?.content] }) }), { default: _(() => [T(r2.$slots, a4.slot ? `${a4.slot}-content` : `item-content`, { item: a4, active: S4 || a4.active, index: d3, ui: R2.value }, () => [c(`ul`, { "data-slot": `childList`, class: s(R2.value.childList({ class: [i(b2)?.childList, a4.ui?.childList] })) }, [(h(true), l(g, null, u(a4.children, (r3, u2) => (h(), l(`li`, { key: u2, "data-slot": `childItem`, class: s(R2.value.childItem({ class: [i(b2)?.childItem, a4.ui?.childItem] })) }, [e(ae, f({ ref_for: true }, i(ie)(r3), { custom: `` }), { default: _(({ active: u3, ...d4 }) => [e(i(Xe), { "as-child": ``, active: u3, onSelect: r3.onSelect }, { default: _(() => [e(M, f({ ref_for: true }, d4, { "data-slot": `childLink`, class: R2.value.childLink({ class: [i(b2)?.childLink, a4.ui?.childLink, r3.class], active: u3 }) }), { default: _(() => [r3.icon ? (h(), x(N, { key: 0, name: r3.icon, "data-slot": `childLinkIcon`, class: s(R2.value.childLinkIcon({ class: [i(b2)?.childLinkIcon, a4.ui?.childLinkIcon], active: u3 })) }, null, 8, [`name`, `class`])) : E(``, true), c(`div`, { "data-slot": `childLinkWrapper`, class: s(R2.value.childLinkWrapper({ class: [i(b2)?.childLinkWrapper, a4.ui?.childLinkWrapper] })) }, [c(`p`, { "data-slot": `childLinkLabel`, class: s(R2.value.childLinkLabel({ class: [i(b2)?.childLinkLabel, a4.ui?.childLinkLabel], active: u3 })) }, [t(v(i(O)(r3, o2.labelKey)) + ` `, 1), r3.target === `_blank` && n2.externalIcon !== false ? (h(), x(N, { key: 0, name: typeof n2.externalIcon == `string` ? n2.externalIcon : i(y2).ui.icons.external, "data-slot": `childLinkLabelExternalIcon`, class: s(R2.value.childLinkLabelExternalIcon({ class: [i(b2)?.childLinkLabelExternalIcon, a4.ui?.childLinkLabelExternalIcon], active: u3 })) }, null, 8, [`name`, `class`])) : E(``, true)], 2), r3.description ? (h(), l(`p`, { key: 0, "data-slot": `childLinkDescription`, class: s(R2.value.childLinkDescription({ class: [i(b2)?.childLinkDescription, a4.ui?.childLinkDescription], active: u3 })) }, v(r3.description), 3)) : E(``, true)], 2)]), _: 2 }, 1040, [`class`])]), _: 2 }, 1032, [`active`, `onSelect`])]), _: 2 }, 1040)], 2))), 128))], 2)])]), _: 2 }, 1040, [`class`])) : E(``, true)]), _: 2 }, 1040)), n2.orientation === `vertical` && a4.children?.length && !n2.collapsed ? (h(), x(i(Pe), { key: 2, "data-slot": `content`, class: s(R2.value.content({ class: [i(b2)?.content, a4.ui?.content] })) }, { default: _(() => [e(i(ke), f({ ...i(D2), defaultValue: V2(a4.children, p2 + 1, S3) }, { as: `ul`, "data-slot": `childList`, class: R2.value.childList({ class: [i(b2)?.childList, a4.ui?.childList] }) }), { default: _(() => [(h(true), l(g, null, u(a4.children, (e2, t2) => (h(), x(i(L2), { key: t2, item: e2, index: t2, level: p2 + 1, "list-index": S3, "data-slot": `childItem`, class: s(R2.value.childItem({ class: [i(b2)?.childItem, e2.ui?.childItem] })) }, null, 8, [`item`, `index`, `level`, `list-index`, `class`]))), 128))]), _: 2 }, 1040, [`class`])]), _: 2 }, 1032, [`class`])) : E(``, true)]), _: 2 }, 1040, [`value`]))]), _: 3 }), e(i(Ue), f({ ...i(S2), ...n2.orientation === `horizontal` ? { modelValue: n2.modelValue, defaultValue: n2.defaultValue } : {}, ...r2.$attrs }, { "data-collapsed": n2.collapsed, "data-slot": `root`, class: R2.value.root({ class: [i(b2)?.root, o2.class] }) }), { default: _(() => [T(r2.$slots, `list-leading`), (h(true), l(g, null, u(z2.value, (e2, t2) => (h(), l(g, { key: `list-${t2}` }, [(h(), x(w(n2.orientation === `vertical` ? i(ke) : i(Ze)), f({ ref_for: true }, n2.orientation === `vertical` && !n2.collapsed ? { ...i(D2), modelValue: n2.modelValue, defaultValue: n2.defaultValue ?? V2(e2, 0, t2) } : {}, { as: `ul`, "data-slot": `list`, class: R2.value.list({ class: i(b2)?.list }) }), { default: _(() => [(h(true), l(g, null, u(e2, (e3, n3) => (h(), x(i(L2), { key: `list-${t2}-${n3}`, item: e3, index: n3, "list-index": t2, "data-slot": `item`, class: s(R2.value.item({ class: [i(b2)?.item, e3.ui?.item] })) }, null, 8, [`item`, `index`, `list-index`, `class`]))), 128))]), _: 2 }, 1040, [`class`])), n2.orientation === `vertical` && t2 < z2.value.length - 1 ? (h(), l(`div`, { key: 0, "data-slot": `separator`, class: s(R2.value.separator({ class: i(b2)?.separator })) }, null, 2)) : E(``, true)], 64))), 128)), T(r2.$slots, `list-trailing`), n2.orientation === `horizontal` ? (h(), l(`div`, { key: 0, "data-slot": `viewportWrapper`, class: s(R2.value.viewportWrapper({ class: i(b2)?.viewportWrapper })) }, [n2.arrow ? (h(), x(i(Ye), { key: 0, "data-slot": `indicator`, class: s(R2.value.indicator({ class: i(b2)?.indicator })) }, { default: _(() => [c(`div`, { "data-slot": `arrow`, class: s(R2.value.arrow({ class: i(b2)?.arrow })) }, null, 2)]), _: 1 }, 8, [`class`])) : E(``, true), e(i(et), { "data-slot": `viewport`, class: s(R2.value.viewport({ class: i(b2)?.viewport })) }, null, 8, [`class`])], 2)) : E(``, true)]), _: 3 }, 16, [`data-collapsed`, `class`])], 64));
} });
export {
  nt as t
};

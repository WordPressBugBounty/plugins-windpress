import { J as e, tt as t, vn as n } from "./runtime-core.esm-bundler-CahM68iJ.js";
import { j as r } from "./Button-DpvhuBJO.js";
  ...
  async function u() {
    if (!(s.value || c.length === 0)) {
      for (s.value = true; c.length > 0; ) {
        let e2 = c.shift();
        await t(), a2.value = [...a2.value, e2].slice(-((o == null ? void 0 : o.value) ?? 5));
      }
      s.value = false;
    }
  }

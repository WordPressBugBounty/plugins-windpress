import { Ct as e, D as t, E as n, Ht as r, J as i, On as a, St as o, Yt as s, Zn as c, _ as l, b as u, bt as d, ct as f, er as p, l as m, mt as h, o as g, qt as _, tr as v, tt as y, v as b, vn as x, xt as S, y as C } from "./runtime-core.esm-bundler-Twwq1XF8.js";
import { S as w, i as ee, t as te } from "./runtime-dom.esm-bundler-Owfape5M.js";
import { y as ne } from "./dist-ChpmCc7n.js";
import { t as re } from "./set-4UwbVlC4.js";
import { t as ie } from "./vfs-DGZNrgMJ.js";
import { c as ae, i as oe } from "./intellisense-BqSPmEm7.js";
...
import { a as se, i as ce, n as le, r as ue, t as de } from "./chevron-right-BCavwTU8.js";
import { n as D, r as fe, t as O } from "./constant-BgOp3xbn.js";
...
var ye = { class: `{m:10;pb:15}>div` }, be = { class: `variable-section-title` }, xe = { key: 0, class: `variable-section-items default-color` }, Se = [`onClick`, `onMouseenter`], Ce = [`onClick`, `onMouseenter`], we = 1e3, Te = E({ __name: `ColorVariableItems`, props: { variableItems: { type: Object, required: true } }, setup(t2) {
  ...
  let n2 = i(`isOpen`);
  return (e3, r2) => s((h(), u(`div`, Oe, [t(_e), (h(), b(m, null, { default: _(() => [t(De)]), _: 1 }))], 512)), [[w, a(n2)]]);
...
function Me(e2) {
  ...
  return n2 === `number` || n2 === `text` && Y.find((e3) => typeof e3 != `string`).hasChild.some((n3) => t2.querySelector(n3) === e2);
}
function Z(e2) {
  if (!X(e2)) return null;

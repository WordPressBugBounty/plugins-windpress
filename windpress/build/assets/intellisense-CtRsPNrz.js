...
import { a as n, i as r, n as i, t as a } from "./default-map-CP1tOC8X.js";
import { a as o, i as s, l as c, n as l, o as u, r as d } from "./cssesc-BlGGmlzH.js";
import { n as f } from "./adobe-css-tools-DPH8i0dL.js";
import { n as p, t as m } from "./dlv.umd-DTG8-zoP.js";
var h = t(((e26, t2) => {
  var n2 = u(), r2 = s(), i2 = o();
...
async function _({ entrypoint: e26 = `/main.css`, volume: t2 = {}, ...a2 } = {}) {
  let o2 = { ...t2 }, s2 = false;
  return (a2 == null ? void 0 : a2.strict) === true && (s2 = true, delete a2.strict), s2 || Object.keys(o2).forEach((e27) => {
  ...
  for (let o2 = 0; o2 < e26.length; o2++) {
    ...
    switch (s2) {
      ...
      case Se: {
        ...
        if (i2.length > 0) {
          let t3 = _e(i2);
          e27 == null ? void 0 : e27.nodes.push(t3), i2 = ``;
        }
...
({ ...Ze }, { ...Je }), { ...qe }, { ...b }, { ...qe }, { ...b }, { ...b }, { ...qe }, { ...qe }, { ...b }, { ...b }, { ...b }, { ...b }, { ...Qe }, { ...Qe }, { ...Xe }, { ...qe }, { ...b }, { ...qe }, { ...b }, { ...Je }, { ...Je }, { ...Je }, { ...Je }, { ...Xe }, { ...qe }, { ...qe }, { ...qe }, { ...Xe }, { ...b }, { ...Je }, { ...Je }, { ...Ye }, { ...Ye }, { ...b }, new a((e26) => {
  let t2 = Fe(e26), n2 = /* @__PURE__ */ new Set();
  return he(t2, (e27, r2) => {
    let i2 = r2.parent === null ? t2 : r2.parent.nodes ?? [];
    if (e27.kind === `word` && (e27.value === `+` || e27.value === `-` || e27.value === `*` || e27.value === `/`)) {
      let t3 = i2.indexOf(e27) ?? -1;
      if (t3 === -1) return;
      let r3 = i2[t3 - 1];
      ...
      n2.add(r3), n2.add(a2);
    } else e27.kind === `separator` && e27.value.length > 0 && e27.value.trim() === `` ? (i2[0] === e27 || i2[i2.length - 1] === e27) && n2.add(e27) : e27.kind === `separator` && e27.value.trim() === `,` && (e27.value = `,`);
  }), n2.size > 0 && he(t2, (e27) => {
...
new a((e26) => {
  ...
  let t2 = nt.exec(e26);
  if (!t2) return null;
  let n2 = (_a2 = t2.groups) == null ? void 0 : _a2.value;
  if (n2 === void 0) return null;
  let r2 = Number(n2);
  if (Number.isNaN(r2)) return null;
  let i2 = (_b = t2.groups) == null ? void 0 : _b.unit;
...
function lt(e26, t2) {
  ...
  return n2 && t2.startsWith(`--${n2}`) && (t2 = `--${t2.slice(n2.length + 3)}`), t2 = t2.replaceAll(`\\.`, `.`), ((_a2 = e26.resolveThemeValue) == null ? void 0 : _a2.call(e26, t2, true)) ?? null;
}
...
function Qt(e26, t2) {
  let n2 = e26.css.valueOf(), r2 = e26.unicodeRangesAllowed ?? false, i2 = new Ut(n2), a2 = { onParseError: (t2 == null ? void 0 : t2.onParseError) ?? $t };
...
function wn(e26, t2) {
  ...
  for (; ; ) {
    let e27 = t2[n2];
    if (!fn(e27)) return { advance: n2, node: new Cn(t2.slice(0, n2)) };
    n2++;
  }
}
var Tn = class e5 {
...
function En(e26, t2) {
  return { advance: 1, node: new Tn(t2[0]) };
}
function Dn(e26, t2) {
  let n2 = [], r2 = 0;
  for (; ; ) if (fn(t2[r2])) {
    let e27 = wn(0, t2.slice(r2));
    r2 += e27.advance, n2.push(e27.node);
  } else {
    if (!cn(t2[r2])) return { advance: r2, nodes: n2 };
    n2.push(new Tn(t2[r2])), r2++;
  }
}
var N = class e6 {
  constructor(e26) {
...
function On(e26, t2) {
  let n2 = { onParseError: (t2 == null ? void 0 : t2.onParseError) ?? (() => {
  }) }, r2 = [...e26];
...
function jn(e26, t2, n2) {
  e26.length !== 0 && An(e26, ((n3, r2) => false !== t2(n3, r2) && (!(`walk` in n3.node) || !e26.includes(n3.node) || false !== n3.node.walk(t2, n3.state)) && void 0), n2);
}
function Mn(e26, t2) {
  for (let n2 = 0; n2 < e26.length; n2++) jn(e26[n2], ((e27, n3) => {
...
function Fn(e26) {
  return Cn.isWhitespaceNode(e26);
}
function In(e26) {
  return Tn.isCommentNode(e26);
}
function Ln(e26) {
  return Fn(e26) || In(e26);
}
function P(e26) {
...
var Rn = /[A-Z]/g;
function F(e26) {
  return e26.replace(Rn, ((e27) => String.fromCharCode(e27.charCodeAt(0) + 32)));
}
var zn = { cm: `px`, in: `px`, mm: `px`, pc: `px`, pt: `px`, px: `px`, q: `px`, deg: `deg`, grad: `deg`, rad: `deg`, turn: `deg`, ms: `s`, s: `s`, hz: `hz`, khz: `hz` }, Bn = /* @__PURE__ */ new Map([[`cm`, (e26) => e26], [`mm`, (e26) => 10 * e26], [`q`, (e26) => 40 * e26], [`in`, (e26) => e26 / 2.54], [`pc`, (e26) => e26 / 2.54 * 6], [`pt`, (e26) => e26 / 2.54 * 72], [`px`, (e26) => e26 / 2.54 * 96]]), Vn = /* @__PURE__ */ new Map([[`deg`, (e26) => e26], [`grad`, (e26) => e26 / 0.9], [`rad`, (e26) => e26 / 180 * Math.PI], [`turn`, (e26) => e26 / 360]]), Hn = /* @__PURE__ */ new Map([[`deg`, (e26) => 0.9 * e26], [`grad`, (e26) => e26], [`rad`, (e26) => 0.9 * e26 / 180 * Math.PI], [`turn`, (e26) => 0.9 * e26 / 360]]), Un = /* @__PURE__ */ new Map([[`hz`, (e26) => e26], [`khz`, (e26) => e26 / 1e3]]), Wn = /* @__PURE__ */ new Map([[`cm`, (e26) => 2.54 * e26], [`mm`, (e26) => 25.4 * e26], [`q`, (e26) => 25.4 * e26 * 4], [`in`, (e26) => e26], [`pc`, (e26) => 6 * e26], [`pt`, (e26) => 72 * e26], [`px`, (e26) => 96 * e26]]), Gn = /* @__PURE__ */ new Map([[`hz`, (e26) => 1e3 * e26], [`khz`, (e26) => e26]]), Kn = /* @__PURE__ */ new Map([[`cm`, (e26) => e26 / 10], [`mm`, (e26) => e26], [`q`, (e26) => 4 * e26], [`in`, (e26) => e26 / 25.4], [`pc`, (e26) => e26 / 25.4 * 6], [`pt`, (e26) => e26 / 25.4 * 72], [`px`, (e26) => e26 / 25.4 * 96]]), qn = /* @__PURE__ */ new Map([[`ms`, (e26) => e26], [`s`, (e26) => e26 / 1e3]]), Jn = /* @__PURE__ */ new Map([[`cm`, (e26) => e26 / 6 * 2.54], [`mm`, (e26) => e26 / 6 * 25.4], [`q`, (e26) => e26 / 6 * 25.4 * 4], [`in`, (e26) => e26 / 6], [`pc`, (e26) => e26], [`pt`, (e26) => e26 / 6 * 72], [`px`, (e26) => e26 / 6 * 96]]), Yn = /* @__PURE__ */ new Map([[`cm`, (e26) => e26 / 72 * 2.54], [`mm`, (e26) => e26 / 72 * 25.4], [`q`, (e26) => e26 / 72 * 25.4 * 4], [`in`, (e26) => e26 / 72], [`pc`, (e26) => e26 / 72 * 6], [`pt`, (e26) => e26], [`px`, (e26) => e26 / 72 * 96]]), Xn = /* @__PURE__ */ new Map([[`cm`, (e26) => e26 / 96 * 2.54], [`mm`, (e26) => e26 / 96 * 25.4], [`q`, (e26) => e26 / 96 * 25.4 * 4], [`in`, (e26) => e26 / 96], [`pc`, (e26) => e26 / 96 * 6], [`pt`, (e26) => e26 / 96 * 72], [`px`, (e26) => e26]]), Zn = /* @__PURE__ */ new Map([[`cm`, (e26) => e26 / 4 / 10], [`mm`, (e26) => e26 / 4], [`q`, (e26) => e26], [`in`, (e26) => e26 / 4 / 25.4], [`pc`, (e26) => e26 / 4 / 25.4 * 6], [`pt`, (e26) => e26 / 4 / 25.4 * 72], [`px`, (e26) => e26 / 4 / 25.4 * 96]]), Qn = /* @__PURE__ */ new Map([[`deg`, (e26) => 180 * e26 / Math.PI], [`grad`, (e26) => 180 * e26 / Math.PI / 0.9], [`rad`, (e26) => e26], [`turn`, (e26) => 180 * e26 / Math.PI / 360]]), $n = /* @__PURE__ */ new Map([[`ms`, (e26) => 1e3 * e26], [`s`, (e26) => e26]]), er = /* @__PURE__ */ new Map([[`deg`, (e26) => 360 * e26], [`grad`, (e26) => 360 * e26 / 0.9], [`rad`, (e26) => 360 * e26 / 180 * Math.PI], [`turn`, (e26) => e26]]), tr = /* @__PURE__ */ new Map([[`cm`, Bn], [`mm`, Kn], [`q`, Zn], [`in`, Wn], [`pc`, Jn], [`pt`, Yn], [`px`, Xn], [`ms`, qn], [`s`, $n], [`deg`, Vn], [`grad`, Hn], [`rad`, Qn], [`turn`, er], [`hz`, Un], [`khz`, Gn]]);
function I(e26, t2) {
...
function rr(e26) {
  ...
  if (k(t2) && k(n2)) {
    ...
    return new N([w.Number, e27.toString(), t2[2], n2[3], { value: e27, type: t2[4].type === T.Integer && n2[4].type === T.Integer ? T.Integer : T.Number }]);
  }
  if (A(t2) && A(n2)) {
    let e27 = t2[4].value + n2[4].value;
    return new N([w.Percentage, e27.toString() + `%`, t2[2], n2[3], { value: e27 }]);
  }
  if (D(t2) && D(n2) && (n2 = I(t2, n2), F(t2[4].unit) === F(n2[4].unit))) {
    let e27 = t2[4].value + n2[4].value;
    return new N([w.Dimension, e27.toString() + t2[4].unit, t2[2], n2[3], { value: e27, type: t2[4].type === T.Integer && n2[4].type === T.Integer ? T.Integer : T.Number, unit: t2[4].unit }]);
  }
  return -1;
}
function ir(e26) {
  ...
  if (k(t2) && k(n2)) {
    let e27 = t2[4].value / n2[4].value;
    return new N([w.Number, e27.toString(), t2[2], n2[3], { value: e27, type: Number.isInteger(e27) ? T.Integer : T.Number }]);
  }
  if (A(t2) && k(n2)) {
    let e27 = t2[4].value / n2[4].value;
    return new N([w.Percentage, e27.toString() + `%`, t2[2], n2[3], { value: e27 }]);
  ...
  if (D(t2) && k(n2)) {
    let e27 = t2[4].value / n2[4].value;
    return new N([w.Dimension, e27.toString() + t2[4].unit, t2[2], n2[3], { value: e27, type: Number.isInteger(e27) ? T.Integer : T.Number, unit: t2[4].unit }]);
  }
  return -1;
}
function ar(e26) {
...
function or(e26) {
  ...
  if (k(t2) && D(n2)) {
    let e27 = t2[4].value * n2[4].value;
    return new N([w.Dimension, e27.toString() + n2[4].unit, t2[2], n2[3], { value: e27, type: t2[4].type === T.Integer && n2[4].type === T.Integer ? T.Integer : T.Number, unit: n2[4].unit }]);
  }
  return -1;
}
function sr(e26, t2) {
  for (let n2 = 0; n2 < e26.length; n2++) {
    ...
    switch (a2) {
      case `e`:
        e26.splice(n2, 1, new N([w.Number, Math.E.toString(), i2[2], i2[3], { value: Math.E, type: T.Number }]));
        break;
      case `pi`:
        e26.splice(n2, 1, new N([w.Number, Math.PI.toString(), i2[2], i2[3], { value: Math.PI, type: T.Number }]));
        break;
      case `infinity`:
        e26.splice(n2, 1, new N([w.Number, `infinity`, i2[2], i2[3], { value: 1 / 0, type: T.Number }]));
        break;
      case `-infinity`:
        e26.splice(n2, 1, new N([w.Number, `-infinity`, i2[2], i2[3], { value: -1 / 0, type: T.Number }]));
        break;
      case `nan`:
        e26.splice(n2, 1, new N([w.Number, `NaN`, i2[2], i2[3], { value: NaN, type: T.Number }]));
        break;
      default:
        if (t2.has(a2)) {
          let r3 = t2.get(a2);
...
function lr(e26, t2, n2) {
  return D(t2) ? ur(e26, t2[4].unit, n2) : A(t2) ? dr(e26, n2) : k(t2) ? R(e26, n2) : -1;
}
function ur(e26, t2, n2) {
  let r2 = e26.tokens();
  return { inputs: [new N([w.Dimension, n2.toString() + t2, r2[0][2], r2[r2.length - 1][3], { value: n2, type: Number.isInteger(n2) ? T.Integer : T.Number, unit: t2 }])], operation: cr };
}
function dr(e26, t2) {
  let n2 = e26.tokens();
  return { inputs: [new N([w.Percentage, t2.toString() + `%`, n2[0][2], n2[n2.length - 1][3], { value: t2 }])], operation: cr };
}
function R(e26, t2) {
  let n2 = e26.tokens();
  return { inputs: [new N([w.Number, t2.toString(), n2[0][2], n2[n2.length - 1][3], { value: t2, type: Number.isInteger(t2) ? T.Integer : T.Number }])], operation: cr };
}
function fr(e26, t2) {
  let n2 = t2.value;
  return k(n2) ? ur(e26, `rad`, Math.acos(n2[4].value)) : -1;
}
function pr(e26, t2) {
  let n2 = t2.value;
  return k(n2) ? ur(e26, `rad`, Math.asin(n2[4].value)) : -1;
}
function mr(e26, t2) {
  let n2 = t2.value;
  return k(n2) ? ur(e26, `rad`, Math.atan(n2[4].value)) : -1;
}
function hr(e26) {
  return D(e26) || k(e26);
}
...
function _r(e26, t2) {
  return !!E(e26) && (D(e26) ? e26[0] === t2[0] && F(e26[4].unit) === F(t2[4].unit) : e26[0] === t2[0]);
}
function vr(e26, t2, n2) {
  let r2 = t2.value;
  if (!hr(r2)) return -1;
  let i2 = I(r2, n2.value);
  return _r(r2, i2) ? ur(e26, `rad`, Math.atan2(r2[4].value, i2[4].value)) : -1;
}
function yr(e26, t2, n2) {
  let r2 = t2.value;
  return !E(r2) || !n2.rawPercentages && A(r2) ? -1 : lr(e26, r2, Math.abs(r2[4].value));
}
function br(e26, t2, n2, r2, i2) {
  if (!P(t2) || !P(n2) || !P(r2)) return -1;
  let a2 = t2.value;
  if (!E(a2) || !i2.rawPercentages && A(a2)) return -1;
  let o2 = I(a2, n2.value);
  if (!_r(a2, o2)) return -1;
  let s2 = I(a2, r2.value);
  return _r(a2, s2) ? lr(e26, a2, Math.max(a2[4].value, Math.min(o2[4].value, s2[4].value))) : -1;
}
function xr(e26, t2) {
  let n2 = t2.value;
  if (!hr(n2)) return -1;
...
function Sr(e26, t2) {
  let n2 = t2.value;
  return k(n2) ? R(e26, Math.exp(n2[4].value)) : -1;
}
function Cr(e26, t2, n2) {
  ...
  return lr(e26, r2, Math.hypot(...a2));
}
...
function Tr(e26, t2, n2) {
  ...
  if (!gr(i2)) return -1;
  let a2 = i2.map(((e27) => e27[4].value));
  return lr(e26, r2, Math.min(...a2));
}
function Er(e26, t2, n2) {
  let r2 = t2.value;
  if (!E(r2)) return -1;
  let i2 = I(r2, n2.value);
  if (!_r(r2, i2)) return -1;
  let a2;
  return a2 = i2[4].value === 0 ? NaN : Number.isFinite(r2[4].value) && (Number.isFinite(i2[4].value) || (i2[4].value !== 1 / 0 || r2[4].value !== -1 / 0 && !Object.is(0 * r2[4].value, -0)) && (i2[4].value !== -1 / 0 || r2[4].value !== 1 / 0 && !Object.is(0 * r2[4].value, 0))) ? Number.isFinite(i2[4].value) ? (r2[4].value % i2[4].value + i2[4].value) % i2[4].value : r2[4].value : NaN, lr(e26, r2, a2);
}
function Dr(e26, t2, n2) {
  let r2 = t2.value, i2 = n2.value;
  return !k(r2) || !_r(r2, i2) ? -1 : R(e26, r2[4].value ** +i2[4].value);
}
function Or(e26, t2, n2) {
  ...
  if (!_r(r2, i2)) return -1;
  let a2;
  return a2 = i2[4].value === 0 ? NaN : Number.isFinite(r2[4].value) ? Number.isFinite(i2[4].value) ? r2[4].value % i2[4].value : r2[4].value : NaN, lr(e26, r2, a2);
}
...
function Ar(e26, t2, n2) {
  let r2 = t2.value;
  return !E(r2) || !n2.rawPercentages && A(r2) ? -1 : R(e26, Math.sign(r2[4].value));
}
function jr(e26, t2) {
  let n2 = t2.value;
  if (!hr(n2)) return -1;
  let r2 = n2[4].value;
  if (D(n2)) switch (F(n2[4].unit)) {
    case `rad`:
      break;
    case `deg`:
      r2 = Vn.get(`rad`)(n2[4].value);
...
function Mr(e26, t2) {
  let n2 = t2.value;
  return k(n2) ? R(e26, Math.sqrt(n2[4].value)) : -1;
}
function Nr(e26, t2) {
  let n2 = t2.value;
  if (!hr(n2)) return -1;
  ...
  if (D(n2)) switch (F(n2[4].unit)) {
    case `rad`:
      ...
      break;
    case `deg`:
      i2 = r2, a2 = Vn.get(`rad`)(r2);
      break;
    case `grad`:
      i2 = Hn.get(`deg`)(r2), a2 = Hn.get(`rad`)(r2);
      break;
    case `turn`:
      i2 = er.get(`deg`)(r2), a2 = er.get(`rad`)(r2);
      break;
    default:
      return -1;
  }
...
function Fr(e26, t2) {
  if (t2.length === 1) {
    ...
    if (!n2 || !P(n2)) return -1;
    let r2 = n2.value;
    return k(r2) ? R(e26, Math.log(r2[4].value)) : -1;
  }
  if (t2.length === 2) {
    let n2 = t2[0];
    if (!n2 || !P(n2)) return -1;
    ...
    if (!i2 || !P(i2)) return -1;
    let a2 = i2.value;
    return k(a2) ? R(e26, Math.log(r2[4].value) / Math.log(a2[4].value)) : -1;
  }
  return -1;
}
var Ir = /^none$/i;
function Lr(e26) {
  if (Array.isArray(e26)) {
    let t3 = e26.filter(((e27) => !(Fn(e27) && In(e27))));
    return t3.length === 1 && Lr(t3[0]);
  }
  if (!P(e26)) return false;
  let t2 = e26.value;
  return !!dn(t2) && Ir.test(t2[4].value);
}
function Rr(e26, t2, n2, r2, i2, a2) {
  let o2 = n2.value;
  if (!E(o2)) return -1;
  let s2 = I(o2, r2.value);
  if (!_r(o2, s2)) return -1;
  let c2, l2 = null;
  if (i2 && (l2 = I(o2, i2.value), !_r(o2, l2))) return -1;
  if (Number.isFinite(o2[4].value)) if (Number.isFinite(s2[4].value)) if (Number.isFinite(s2[4].value - o2[4].value)) if (l2 && !Number.isFinite(l2[4].value)) c2 = o2[4].value;
    ...
    let e27 = zr(Br([t2, x(o2), x(s2), i2 ? `by ${i2.toString()}` : ``].join(`,`)), a2.randomSeed), n3 = o2[4].value, r3 = s2[4].value;
...
function zr(e26 = 0.34944106645296036, t2 = 0.19228640875738723, n2 = 0.8784393832007205, r2 = 0.04850964319275053) {
  return () => {
...
var Vr = /* @__PURE__ */ new Map([[`abs`, function(e26, t2, n2) {
  ...
  let s2 = Lr(i2), c2 = Lr(o2);
  if (s2 && c2) return z(V(a2), t2, n2);
  let l2 = L(z(V(a2), t2, n2));
  if (l2 === -1) return -1;
  if (s2) {
    let e27 = L(z(V(o2), t2, n2));
    return e27 === -1 ? -1 : Tr((u2 = l2, d2 = e27, new M([w.Function, `min(`, -1, -1, { value: `min` }], [w.CloseParen, `)`, -1, -1, void 0], [u2, new N([w.Comma, `,`, -1, -1, void 0]), d2])), [l2, e27], n2);
  }
  if (c2) {
    let e27 = L(z(V(i2), t2, n2));
    return e27 === -1 ? -1 : wr(Jr(e27, l2), [e27, l2], n2);
  }
  var u2, d2;
  let f2 = L(z(V(i2), t2, n2));
  if (f2 === -1) return -1;
  let p2 = L(z(V(o2), t2, n2));
  return p2 === -1 ? -1 : br(e26, f2, l2, p2, n2);
}], [`cos`, function(e26, t2, n2) {
  return B(e26, t2, n2, xr);
}], [`exp`, function(e26, t2, n2) {
  return B(e26, t2, n2, Sr);
}], [`hypot`, function(e26, t2, n2) {
  return Gr(e26, e26.value, t2, n2, Cr);
}], [`log`, function(e26, t2, n2) {
  return Gr(e26, e26.value, t2, n2, Fr);
}], [`max`, function(e26, t2, n2) {
  return Gr(e26, e26.value, t2, n2, wr);
}], [`min`, function(e26, t2, n2) {
  return Gr(e26, e26.value, t2, n2, Tr);
}], [`mod`, function(e26, t2, n2) {
  return Ur(e26, t2, n2, Er);
}], [`pow`, function(e26, t2, n2) {
  return Ur(e26, t2, n2, Dr);
}], [`random`, function(e26, t2, n2) {
  let r2 = e26.value.filter(((e27) => !Ln(e27))), i2 = ``, a2 = [], o2 = [];
  for (let e27 = 0; e27 < r2.length; e27++) {
    let t3 = r2[e27];
    if (!i2 && o2.length === 0 && P(t3) && dn(t3.value)) {
      let n3 = t3.value[4].value.toLowerCase();
      if (n3 === `per-element` || n3.startsWith(`--`)) {
        i2 = n3;
        let t4 = r2[e27 + 1];
        if (!P(t4) || !sn(t4.value)) return -1;
        e27++;
        continue;
      }
    }
    if (P(t3) && sn(t3.value)) {
      let t4 = r2[e27 + 1];
      if (o2.length > 0 && P(t4) && dn(t4.value)) {
  ...
  return a2.length && (u2 = Hr(a2, t2, n2), u2 === -1) ? -1 : Rr(e26, i2, c2, l2, u2, n2);
}], [`rem`, function(e26, t2, n2) {
  return Ur(e26, t2, n2, Or);
}], [`round`, function(e26, t2, n2) {
  let r2 = sr([...e26.value.filter(((e27) => !Ln(e27)))], t2), i2 = ``, a2 = false, o2 = [], s2 = [];
  {
    let e27 = o2;
    for (let t3 = 0; t3 < r2.length; t3++) {
      let n3 = r2[t3];
      if (!i2 && o2.length === 0 && s2.length === 0 && P(n3) && dn(n3.value)) {
  ...
  if (c2 === -1) return -1;
  a2 || s2.length !== 0 || s2.push(new N([w.Number, `1`, -1, -1, { value: 1, type: T.Integer }]));
  let l2 = L(z(V(s2), t2, n2));
  return l2 === -1 ? -1 : (i2 || (i2 = `nearest`), kr(e26, i2, c2, l2, n2));
}], [`sign`, function(e26, t2, n2) {
  return B(e26, t2, n2, Ar);
...
function z(e26, t2, n2) {
  let r2 = sr([...e26.value.filter(((e27) => !Ln(e27)))], t2);
  if (r2.length === 1 && P(r2[0])) return { inputs: [r2[0]], operation: cr };
  let i2 = 0;
  for (; i2 < r2.length; ) {
    let e27 = r2[i2];
    if (Nn(e27) && pn(e27.startToken)) {
      let a2 = z(e27, t2, n2);
      if (a2 === -1) return -1;
      r2.splice(i2, 1, a2);
    } else if (Pn(e27)) {
      let a2 = Vr.get(e27.getName().toLowerCase());
      if (!a2) return -1;
      let o2 = a2(e27, t2, n2);
      if (o2 === -1) return -1;
      r2.splice(i2, 1, o2);
  ...
  if (i2 = 0, r2.length === 1 && ar(r2[0])) return r2[0];
  for (; i2 < r2.length; ) {
    let e27 = r2[i2];
    if (!e27 || !P(e27) && !ar(e27)) {
      i2++;
    ...
    let a2 = r2[i2 + 2];
    if (!a2 || !P(a2) && !ar(a2)) return -1;
    n3[4].value === `*` ? r2.splice(i2, 3, { inputs: [e27, a2], operation: or }) : n3[4].value === `/` ? r2.splice(i2, 3, { inputs: [e27, a2], operation: ir }) : i2++;
  }
  if (i2 = 0, r2.length === 1 && ar(r2[0])) return r2[0];
  for (; i2 < r2.length; ) {
    let e27 = r2[i2];
    ...
    let a2 = r2[i2 + 2];
    if (!a2 || !P(a2) && !ar(a2)) return -1;
    n3[4].value === `+` ? r2.splice(i2, 3, { inputs: [e27, a2], operation: rr }) : n3[4].value === `-` ? r2.splice(i2, 3, { inputs: [e27, a2], operation: Pr }) : i2++;
  }
  return r2.length === 1 && ar(r2[0]) ? r2[0] : -1;
}
function B(e26, t2, n2, r2) {
  let i2 = Hr(e26.value, t2, n2);
  return i2 === -1 ? -1 : r2(e26, i2, n2);
}
function Hr(e26, t2, n2) {
  let r2 = L(z(V(sr([...e26.filter(((e27) => !Ln(e27)))], t2)), t2, n2));
  return r2 === -1 ? -1 : r2;
}
function Ur(e26, t2, n2, r2) {
  let i2 = Wr(e26.value, t2, n2);
  if (i2 === -1) return -1;
  let [a2, o2] = i2;
  return r2(e26, a2, o2, n2);
}
function Wr(e26, t2, n2) {
  let r2 = sr([...e26.filter(((e27) => !Ln(e27)))], t2), i2 = [], a2 = [];
  {
    let e27 = i2;
    for (let t3 = 0; t3 < r2.length; t3++) {
      let n3 = r2[t3];
...
function Gr(e26, t2, n2, r2, i2) {
  let a2 = Kr(e26.value, n2, r2);
  return a2 === -1 ? -1 : i2(e26, a2, r2);
}
function Kr(e26, t2, n2) {
  let r2 = sr([...e26.filter(((e27) => !Ln(e27)))], t2), i2 = [];
  {
    let e27 = [], a2 = [];
    for (let t3 = 0; t3 < r2.length; t3++) {
      let n3 = r2[t3];
      P(n3) && sn(n3.value) ? (e27.push(a2), a2 = []) : a2.push(n3);
    }
    e27.push(a2);
...
var qr = /* @__PURE__ */ new Set([`nearest`, `up`, `down`, `to-zero`]);
function V(e26) {
  return new M([w.Function, `calc(`, -1, -1, { value: `calc` }], [w.CloseParen, `)`, -1, -1, void 0], e26);
}
function Jr(e26, t2) {
  return new M([w.Function, `max(`, -1, -1, { value: `max` }], [w.CloseParen, `)`, -1, -1, void 0], [e26, new N([w.Comma, `,`, -1, -1, void 0]), t2]);
}
function Yr(e26) {
  if (e26 === -1) return -1;
  if (Pn(e26)) return e26;
  let t2 = e26.value;
  return E(t2) && Number.isNaN(t2[4].value) ? k(t2) ? new M([w.Function, `calc(`, t2[2], t2[3], { value: `calc` }], [w.CloseParen, `)`, t2[2], t2[3], void 0], [new N([w.Ident, `NaN`, t2[2], t2[3], { value: `NaN` }])]) : D(t2) ? new M([w.Function, `calc(`, t2[2], t2[3], { value: `calc` }], [w.CloseParen, `)`, t2[2], t2[3], void 0], [new N([w.Ident, `NaN`, t2[2], t2[3], { value: `NaN` }]), new Cn([[w.Whitespace, ` `, t2[2], t2[3], void 0]]), new N([w.Delim, `*`, t2[2], t2[3], { value: `*` }]), new Cn([[w.Whitespace, ` `, t2[2], t2[3], void 0]]), new N([w.Dimension, `1` + t2[4].unit, t2[2], t2[3], { value: 1, type: T.Integer, unit: t2[4].unit }])]) : A(t2) ? new M([w.Function, `calc(`, t2[2], t2[3], { value: `calc` }], [w.CloseParen, `)`, t2[2], t2[3], void 0], [new N([w.Ident, `NaN`, t2[2], t2[3], { value: `NaN` }]), new Cn([[w.Whitespace, ` `, t2[2], t2[3], void 0]]), new N([w.Delim, `*`, t2[2], t2[3], { value: `*` }]), new Cn([[w.Whitespace, ` `, t2[2], t2[3], void 0]]), new N([w.Percentage, `1%`, t2[2], t2[3], { value: 1 }])]) : -1 : e26;
}
function Xr(e26) {
  if (e26 === -1) return -1;
  if (Pn(e26)) return e26;
  ...
  let n2 = ``;
  return t2[4].value === -1 / 0 && (n2 = `-`), k(t2) ? new M([w.Function, `calc(`, t2[2], t2[3], { value: `calc` }], [w.CloseParen, `)`, t2[2], t2[3], void 0], [new N([w.Ident, n2 + `infinity`, t2[2], t2[3], { value: n2 + `infinity` }])]) : D(t2) ? new M([w.Function, `calc(`, t2[2], t2[3], { value: `calc` }], [w.CloseParen, `)`, t2[2], t2[3], void 0], [new N([w.Ident, n2 + `infinity`, t2[2], t2[3], { value: n2 + `infinity` }]), new Cn([[w.Whitespace, ` `, t2[2], t2[3], void 0]]), new N([w.Delim, `*`, t2[2], t2[3], { value: `*` }]), new Cn([[w.Whitespace, ` `, t2[2], t2[3], void 0]]), new N([w.Dimension, `1` + t2[4].unit, t2[2], t2[3], { value: 1, type: T.Integer, unit: t2[4].unit }])]) : new M([w.Function, `calc(`, t2[2], t2[3], { value: `calc` }], [w.CloseParen, `)`, t2[2], t2[3], void 0], [new N([w.Ident, n2 + `infinity`, t2[2], t2[3], { value: n2 + `infinity` }]), new Cn([[w.Whitespace, ` `, t2[2], t2[3], void 0]]), new N([w.Delim, `*`, t2[2], t2[3], { value: `*` }]), new Cn([[w.Whitespace, ` `, t2[2], t2[3], void 0]]), new N([w.Percentage, `1%`, t2[2], t2[3], { value: 1 }])]);
}
function Zr(e26) {
  if (e26 === -1) return -1;
  if (Pn(e26)) return e26;
...
function Qr(e26, t2 = 13) {
  if (e26 === -1) return -1;
  if (t2 <= 0 || Pn(e26)) return e26;
  let n2 = e26.value;
...
function $r(e26) {
  return e26 === -1 ? -1 : (Pn(e26) || D(e26.value) && (e26.value = nr(e26.value)), e26);
}
function ei(e26, t2) {
  let n2 = e26;
  return (t2 == null ? void 0 : t2.toCanonicalUnits) && (n2 = $r(n2)), n2 = Qr(n2, t2 == null ? void 0 : t2.precision), n2 = Zr(n2), (t2 == null ? void 0 : t2.censorIntoStandardRepresentableValues) || (n2 = Yr(n2), n2 = Xr(n2)), n2;
}
function ti(e26) {
...
function ni(e26, t2) {
  let n2 = ti(t2 == null ? void 0 : t2.globals);
  return Mn(e26, ((e27) => {
    if (!Pn(e27)) return;
    let r2 = Vr.get(e27.getName().toLowerCase());
    if (!r2) return;
    let i2 = ei(L(r2(e27, n2, t2 ?? {})), t2);
    return i2 === -1 ? void 0 : i2;
  }));
}
new Set(Vr.keys());
function ri(e26) {
  let t2 = On(Zt({ css: `calc(${e26})` }), {});
  if (!t2) return null;
  let n2 = ni([[t2]], { randomSeed: 1, precision: 6 })[0][0];
  return Pn(n2) && n2.name[1] === `calc(` ? null : x(...n2.tokens());
}
var H;
(function(e26) {
...
var ai = class e7 {
  ...
  negateQuery() {
    ...
    for (let e26 = 0; e26 < t2.modifier.length; e26++) {
      ...
      if (n2[0] === w.Ident && U(n2[4].value) === `not`) {
        t2.modifier.splice(e26, 1);
        break;
      }
      if (n2[0] === w.Ident && U(n2[4].value) === `only`) {
...
function mi(e26) {
  return !!(e26.type === j.Token && e26.value[0] === w.Number || e26.type === j.Function && hi.has(U(e26.name[4].value)));
}
...
function vi(e26) {
  return e26.type === j.Function && U(e26.name[4].value) === `env`;
}
var yi = class e16 {
  constructor(e26, t2 = [], n2 = []) {
...
function Mi(e26) {
  ...
  if (e26[1][0] !== w.Delim || e26[1][4].value !== Ai.EQ) return false;
...
var Ni = class e20 {
  ...
  valueOneOperatorKind() {
    return Mi(this.valueOneOperator);
  }
  valueTwoOperatorKind() {
    return Mi(this.valueTwoOperator);
  }
  getName() {
    return this.name.getName();
  }
...
function Ii(e26) {
  ...
  if (t2[0] !== t2[1] && r2.push(e26[t2[1]].value), false === n2) {
    ...
    if (a3 && !o3 || a3 && Li.has(U(a3.getName()))) {
      let e27 = wi(i3);
      return !!e27 && new Ni(a3, r2, e27);
    }
    if (!a3 && o3 || o3 && Li.has(U(o3.getName()))) {
      let e27 = wi(n3);
      return !!e27 && new Pi(o3, r2, e27);
    }
    return false;
  }
  ...
  {
    let e27 = Mi(r2);
    if (false === e27 || e27 === Ai.EQ) return false;
    let t3 = Mi(i2);
    if (false === t3 || t3 === Ai.EQ || !(e27 !== W.LT && e27 !== W.LT_OR_EQ || t3 !== ki.GT && t3 !== ki.GT_OR_EQ) || !(e27 !== ki.GT && e27 !== ki.GT_OR_EQ || t3 !== W.LT && t3 !== W.LT_OR_EQ)) return false;
  }
  return new Fi(l2, c2, r2, u2, i2);
}
var Li = new Set(`any-hover.any-pointer.aspect-ratio.color.color-gamut.color-index.device-aspect-ratio.device-height.device-width.display-mode.dynamic-range.environment-blending.forced-colors.grid.height.horizontal-viewport-segments.hover.inverted-colors.monochrome.nav-controls.orientation.overflow-block.overflow-inline.pointer.prefers-color-scheme.prefers-contrast.prefers-reduced-data.prefers-reduced-motion.prefers-reduced-transparency.resolution.scan.scripting.update.vertical-viewport-segments.video-color-gamut.video-dynamic-range.width`.split(`.`)), Ri = class e23 {
  constructor(e26, t2 = [], n2 = []) {
...
function zi(e26, t2 = [], n2 = []) {
  if (e26.startToken[0] !== w.OpenParen) return false;
  let r2 = Si(e26.value);
  if (false !== r2) return new Ri(r2, t2, n2);
  let i2 = Oi(e26.value);
  if (false !== i2) return new Ri(i2, t2, n2);
  let a2 = Ii(e26.value);
  return false !== a2 && new Ri(a2, t2, n2);
}
var Bi = class e24 {
  constructor(e26, t2) {
  ...
  }
  {
    ...
    for (let i3 = 0; i3 < e26.length; i3++) {
      ...
      if (!Fn(a3) && !In(a3)) {
        if (P(a3)) {
          let o3 = a3.value;
          if (t2 === -1 && o3[0] === w.Ident && Wi(o3)) {
            t2 = i3;
            continue;
          }
          if (n2 === -1 && o3[0] === w.Ident && !Wi(o3)) {
            n2 = i3;
            continue;
          }
          if (r2 === -1 && o3[0] === w.Ident && U(o3[4].value) === `and`) {
            if (r2 = i3, false === Yi(e26.slice(i3 + 1))) return false;
            break;
          }
          return false;
        }
    ...
    let o2 = Yi(e26.slice(Math.max(t2, n2, r2) + 1));
...
function Ki(e26) {
  ...
  for (let a2 = 0; a2 < e26.length; a2++) {
    ...
    if (o2.type !== j.Whitespace && o2.type !== j.Comment) {
      if (t2 || false !== t2 || !Nn(o2) || (o2.normalize(), t2 = Zi(o2), false === t2)) return false;
      r2 = a2;
    }
  }
...
function Xi(e26) {
  ...
  n2.normalize();
  let r2 = [...e26.slice(0, t2).flatMap(((e27) => e27.tokens())), n2.startToken], i2 = [n2.endToken, ...e26.slice(t2 + 1).flatMap(((e27) => e27.tokens()))], a2 = zi(n2, r2, i2);
...
function Zi(e26) {
  if (e26.startToken[0] !== w.OpenParen) return false;
  let t2 = zi(e26, [e26.startToken], [e26.endToken]);
...
function Qi(e26) {
  ...
  for (let r2 = 0; r2 < e26.length; r2++) {
    ...
    if (i2.type !== j.Whitespace && i2.type !== j.Comment) {
      ...
      if (!t2 || !Nn(i2)) return false;
      {
        i2.normalize();
        let t3 = Zi(i2);
        if (false === t3) return false;
        n2 = new Bi(e26.slice(0, r2).flatMap(((e27) => e27.tokens())), t3);
      }
    }
  }
  return n2 || false;
  ...
  for (let n2 = 0; n2 < e26.length; n2++) {
    ...
    if (r2.type !== j.Whitespace && r2.type !== j.Comment) {
      ...
      if (t2 && Nn(r2)) {
        r2.normalize();
        let t3 = Zi(r2);
        return false !== t3 && { advance: n2, node: new Vi(e26.slice(0, n2).flatMap(((e27) => e27.tokens())), t3) };
      }
      return false;
    }
  }
...
function ta(e26, t2) {
  let n2 = kn(e26, { onParseError: t2 == null ? void 0 : t2.onParseError });
  return n2.map(((e27, r2) => {
    let i2 = Gi(e27);
    return i2 == 0 && true === (t2 == null ? void 0 : t2.preserveInvalidMediaQueries) ? new li(n2[r2]) : i2;
  })).filter(((e27) => !!e27));
}
function na(e26, t2) {
  let n2 = Qt({ css: e26 }, { onParseError: t2 == null ? void 0 : t2.onParseError }), r2 = [];
  for (; !n2.endOfFile(); ) r2.push(n2.nextToken());
  return r2.push(n2.nextToken()), ta(r2, t2);
}
(function(e26) {
...
function ia(e26, t2) {
  return ra(e26, t2.map((e27) => ({ start: e27.index, end: e27.index, replacement: ` /* ${e27.value} */` })));
}
var aa = e(p());
function oa(e26, t2, n2 = true) {
  return e26.includes(`rem`) && (0, aa.default)(e26).walk((r2) => {
    if (r2.type !== `word`) return true;
    let i2 = aa.default.unit(r2.value);
...
var ca = Object.assign(({ comments: e26, rootFontSize: t2 }) => ({ postcssPlugin: `plugin`, AtRule: { media(t3) {
  ...
  n2.value.includes(`rem`) && (0, aa.default)(n2.value).walk((r2) => {
    if (r2.type !== `word`) return true;
    let i2 = aa.default.unit(r2.value);
...
function bl(e26) {
  ...
  let t2 = e26.trim();
  return yl(t2) || (!/^\s*(?:rgba?|hsla?|(?:ok)?(?:lab|lch))\s*\([^)]+\)\s*$/.test(t2) && !/^\s*#[0-9a-f]+\s*$/i.test(t2) && !Object.keys(vl.default).includes(t2) ? null : Sl(t2));
}
function xl(e26) {
...
var Tl = Object.assign(({ comments: e26 }) => ({ postcssPlugin: `plugin`, Declaration(t2) {
  Cl.some((e27) => t2.value.includes(e27)) && (0, aa.default)(t2.value).walk((n2) => {
...
function El(e26, t2, n2) {
  ...
  return e26 = ct(e26, (e27) => {
    let a2 = ri(st(e27.value, { replace({ name: e28 }) {
      if (!e28.startsWith(`--`)) return null;
      let n3 = lt(t2.designSystem, e28);
      return n3 === null ? null : (n3 = ct(n3, (e29) => ri(e29.value)), n3);
    } }));
...
function Ll(e26) {
  return Dl(e26).concat(Ol(e26).concat(kl())).filter((e27) => e27.selector !== `*`).map((t2) => {
    ...
    return r2 && (r2 = r2.replaceAll(/([0-9.]+)rem/g, (e27, t3) => `${parseFloat(t3) * 16}px`)), r2 = r2 == null ? void 0 : r2.replaceAll(/\\/g, ``), { ...t2, declarations: n2 == null ? void 0 : n2.filter((e27) => e27.kind === `declaration`), css: r2 };

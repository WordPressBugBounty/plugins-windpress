import { t as e } from "./index.browser-DL6dchOu.js";
import { t } from "./vfs-DziqLF6T.js";
import { c as n, i as r } from "./intellisense-CtRsPNrz.js";
import "./tailwindcss-DNCLGH_x.js";
import { t as i } from "./logger-BvowV9fY.js";
import { n as a, r as o } from "./constant-B8yb_wxs.js";
...
async function l() {
  a.$_state.globalVariables = a.$_state.globalVariables.filter((e2) => e2.category !== `windpress`), a.$_state.globalVariablesCategories.find((e2) => e2.id === `windpress`) || a.$_state.globalVariablesCategories.push({ id: `windpress`, name: `WindPress` }), (await r(await n({ volume: t(o.contentWindow.document.querySelector(`script#windpress\\:vfs[type="text/plain"]`).textContent) }))).forEach((e2) => {
    var _a;
    ((_a = e2.value) == null ? void 0 : _a.includes(`--`)) || a.$_state.globalVariables.push({ id: c(), name: e2.key.substring(2), value: e2.value, category: `windpress` });
  });
}
...
function u() {
  var _a, _b, _c, _d;
  if (a.$_state.activePanel !== `element` || !((_b = (_a = a.$_state) == null ? void 0 : _a.activeElement) == null ? void 0 : _b.id) || !((_c = o) == null ? void 0 : _c.contentWindow)) return;
  let e2 = document.querySelector(`.expand .options-wrapper`), t2 = e2 == null ? void 0 : e2.querySelector(`.searchable`), n2 = e2 == null ? void 0 : e2.querySelector(`.dropdown`), r2 = n2 == null ? void 0 : n2.querySelectorAll(`.variable-picker-item:not(.title)`), i2 = (_d = document.querySelector(`.variable-picker-button.open`)) == null ? void 0 : _d.previousElementSibling;
  if (!i2 || !(r2 == null ? void 0 : r2.length) || !e2 || !n2 || !t2) return;
  let s2 = (e3) => {
    var _a2;
  ...
  h.classList.add(`custom-dropdown`), h.setAttribute(`style`, `
    ...
    let n3 = m.filter((e4) => {
      var _a2;
      return (((_a2 = Object.keys(e4)[0]) == null ? void 0 : _a2.toLowerCase()) ?? ``).includes(t2.value.toLowerCase());
    });
    h.innerHTML = ``, d2(n3, h);
  });
  let g = (i2 == null ? void 0 : i2.value) ?? ` `, _ = new IntersectionObserver(l2, { root: i2.parentElement });

import { B as e, Ht as t, ct as n, ft as r, g as i, k as a, tt as o, vn as s, xn as c } from "./runtime-core.esm-bundler-CahM68iJ.js";
function l(e2, t2) {
...
function _e(e2, t2, n2) {
  return x(t2) ? t2(e2.current) : Object.keys(n2).forEach(function(n3) {
    var _a;
    return (_a = t2[n3]) == null ? void 0 : _a.call(t2, e2.current[n3]);
  }), n2;
}
...
function H() {
  ...
  return n(() => {
    e2.value || (r2 = I.init(), r2.then((t3) => e2.value = t3).catch((e3) => {
      (e3 == null ? void 0 : e3.type) !== `cancelation` && (t2.value = true, console.error(`Monaco initialization error:`, e3));
    }));
  }), { monacoRef: e2, unload: () => r2 == null ? void 0 : r2.cancel(), isLoadFailed: t2 };
}
function U(e2) {
  ...
  let a2 = s(null), c2 = t([r2, i2], () => {
    if (r2.value && i2.value) {
      ...
      let t2 = r2.value.editor.onDidChangeMarkers((t3) => {
        var _a, _b;
        let n3 = (_b = (_a = i2.value) == null ? void 0 : _a.getModel()) == null ? void 0 : _b.uri;
        n3 && t3.find((e3) => e3.path === n3.path) && e2(`validate`, r2.value.editor.getModelMarkers({ resource: n3 }));
      });
      a2.value = () => t2 == null ? void 0 : t2.dispose();
    }
  });
...
var X = Object.defineProperty, Z = Object.getOwnPropertySymbols, Je = Object.prototype.hasOwnProperty, Ye = Object.prototype.propertyIsEnumerable, Q = (e2, t2, n2) => t2 in e2 ? X(e2, t2, { enumerable: true, configurable: true, writable: true, value: n2 }) : e2[t2] = n2, Xe = (e2, t2) => {
  ...
  return r(() => {
    ...
    !o2.value && s2();
    let l3 = (_b = (_a = e3 = u2.value) == null ? void 0 : _a.getModel) == null ? void 0 : _b.call(e3);
    (n3 = (_c = t2 = l3 == null ? void 0 : l3.original) == null ? void 0 : _c.dispose) == null || n3.call(t2), (i2 = (_d = r2 = l3 == null ? void 0 : l3.modified) == null ? void 0 : _d.dispose) == null || i2.call(r2), (c2 = (_e2 = a3 = u2.value) == null ? void 0 : _e2.dispose) == null || c2.call(a3);
    ...
    var _a;
    return (_a = o2.value) == null ? void 0 : _a.editor.setTheme(e2.theme);
  }), t(() => e2.options, () => {
    var _a;
    return (_a = u2.value) == null ? void 0 : _a.updateOptions(e2.options);
  }, { deep: true }), { containerRef: a2, isDiffEditorReady: d2, isLoadFailed: l2, wrapperStyle: f2, containerStyle: p2 };
}, render() {

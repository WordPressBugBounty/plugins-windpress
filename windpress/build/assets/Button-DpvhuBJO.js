...
var _a2;
import { $ as e, $n as t, B as n, D as r, E as i, En as a, Ft as o, Ht as s, J as c, L as l, Lt as u, On as d, Zn as f, b as p, ct as m, et as h, ft as g, g as _, gn as v, gt as y, h as b, jn as x, k as S, mt as C, o as w, pn as T, qt as E, r as ee, tr as D, tt as te, un as ne, v as O, vn as k, wn as A, wt as j, xn as re, xt as M, y as ie, z as ae } from "./runtime-core.esm-bundler-CahM68iJ.js";
import { A as oe, I as se, f as N, k as P, l as ce, s as le, w as F } from "./dist-BKF-Yqo1.js";
import { a as ue, t as de } from "./vue-router-B3IuXUyS.js";
function I(e2, t2 = {}, n2) {
  for (let r2 in e2) {
...
function L(e2, t2, n2, r2) {
  for (let i2 = n2; i2 < e2.length; i2 += 1) try {
    ...
    if (n3 instanceof Promise) return n3.then(() => L(e2, t2, i2 + 1, r2));
  } catch (e3) {
...
function Ee(e2, t2 = `_`) {
  ...
  function r2(e3) {
    e3.forEach((e4) => {
      var _a3;
      if (((_a3 = e4.kbds) == null ? void 0 : _a3.length) && (e4.onSelect || e4.onClick)) {
...
function De(e2, t2 = {}) {
  let n2 = k([]), r2 = () => {
    ...
    var _a3, _b, _c;
    let e3 = (_a3 = s2.value) == null ? void 0 : _a3.tagName, t3 = (_b = s2.value) == null ? void 0 : _b.contentEditable;
    return e3 === `INPUT` || e3 === `TEXTAREA` || t3 === `true` || t3 === `plaintext-only` ? ((_c = s2.value) == null ? void 0 : _c.name) || true : false;
  }), f2 = _(() => Object.entries(a(e2)).map(([e3, t3]) => {
    var _a3, _b;
    if (!t3) return null;
    let n3;
    e3.includes(`-`) && e3 !== `-` && !e3.includes(`_`) && !((_a3 = e3.match(Se)) == null ? void 0 : _a3.length) && console.trace(`[Shortcut] Invalid key: "${e3}"`), e3.includes(`_`) && e3 !== `_` && !((_b = e3.match(Ce)) == null ? void 0 : _b.length) && console.trace(`[Shortcut] Invalid key: "${e3}"`);
...
var Ne = (function() {
  ...
  class e2 {
    ...
    serializeBuiltInType(e3, t2) {
      ...
      if (typeof (t2 == null ? void 0 : t2.entries) == `function`) return this.serializeObjectEntries(e3, t2.entries());
...
function Ie(e2, t2) {
  ...
  if (e2.props && t2.props) for (let i2 of r2) {
    ...
    r3 && a2 ? n2.push(...Ie((_a3 = e2.props) == null ? void 0 : _a3[i2], (_b = t2.props) == null ? void 0 : _b[i2])) : (r3 || a2) && n2.push(new Re((a2 || r3).key, r3 ? `removed` : `added`, a2, r3));
  }
...
var Re = class {
  ...
  toJSON() {
    ...
    switch (this.type) {
      ...
      case `changed`:
        return `Changed \`${this.key}\` from \`${((_a3 = this.oldValue) == null ? void 0 : _a3.toString()) || `-`}\` to \`${this.newValue.toString()}\``;
    }
  }
}, ze = class {
  constructor(e2, t2, n2, r2) {
...
function Qe(e2, t2) {
  return Object.entries(e2).reduce((e3, [n2, r2]) => (e3[n2] = typeof r2 == `function` ? r2({ class: t2 == null ? void 0 : t2[n2] }) : r2, e3), { ...t2 || {} });
}
function $e(e2) {
  return (t2, n2) => et(t2, n2, d(e2));
}
function et(e2, t2, n2) {
  return B(n2, `messages.${e2}`, e2).replace(/\{(\w+)\}/g, (e3, n3) => `${(t2 == null ? void 0 : t2[n3]) ?? `{${n3}}`}`);
}
function tt(e2) {
...
var nt = je({ name: `English`, code: `en`, messages: { alert: { close: `Close` }, authForm: { hidePassword: `Hide password`, showPassword: `Show password`, submit: `Continue` }, banner: { close: `Close` }, calendar: { nextMonth: `Next month`, nextYear: `Next year`, prevMonth: `Previous month`, prevYear: `Previous year` }, carousel: { dots: `Choose slide to display`, goto: `Go to slide {slide}`, next: `Next`, prev: `Prev` }, chatPrompt: { placeholder: `Type your message here\u2026` }, chatPromptSubmit: { label: `Send prompt` }, colorMode: { dark: `Dark`, light: `Light`, switchToDark: `Switch to dark mode`, switchToLight: `Switch to light mode`, system: `System` }, commandPalette: { back: `Back`, close: `Close`, noData: `No data`, noMatch: `No matching data`, placeholder: `Type a command or search\u2026` }, contentSearch: { links: `Links`, theme: `Theme` }, contentSearchButton: { label: `Search\u2026` }, contentToc: { title: `On this page` }, dropdownMenu: { noMatch: `No matching data`, search: `Search\u2026` }, dashboardSearch: { theme: `Theme` }, dashboardSearchButton: { label: `Search\u2026` }, dashboardSidebarCollapse: { collapse: `Collapse sidebar`, expand: `Expand sidebar` }, dashboardSidebarToggle: { close: `Close sidebar`, open: `Open sidebar` }, error: { clear: `Back to home` }, fileUpload: { removeFile: `Remove {filename}` }, header: { close: `Close menu`, open: `Open menu` }, inputMenu: { create: `Create "{label}"`, noData: `No data`, noMatch: `No matching data` }, inputNumber: { decrement: `Decrement`, increment: `Increment` }, modal: { close: `Close` }, pricingTable: { caption: `Pricing plan comparison` }, prose: { codeCollapse: { closeText: `Collapse`, name: `code`, openText: `Expand` }, collapsible: { closeText: `Hide`, name: `properties`, openText: `Show` }, pre: { copy: `Copy code to clipboard` } }, chatReasoning: { thinking: `Thinking...`, thought: `Thought`, thoughtFor: `Thought for {duration}` }, sidebar: { close: `Close`, toggle: `Toggle` }, selectMenu: { create: `Create "{label}"`, noData: `No data`, noMatch: `No matching data`, search: `Search\u2026` }, slideover: { close: `Close` }, table: { noData: `No data` }, toast: { close: `Close` } } }), rt = /* @__PURE__ */ Symbol.for(`nuxt-ui.locale-context`), it = F((e2) => {
  ...
  var _a3;
  let n2 = k(((_a3 = t2 == null ? void 0 : t2.default) == null ? void 0 : _a3.call(t2)) ?? null);
...
function ht(e2) {
  let t2 = l(), n2 = Object.keys((t2 == null ? void 0 : t2.type.props) ?? {}).reduce((e3, n3) => {
    let r3 = (t2 == null ? void 0 : t2.type.props[n3]).default;
    return r3 !== void 0 && (e3[n3] = r3), e3;
  }, {}), r2 = A(e2);
  return _(() => {
    let e3 = {}, i2 = (t2 == null ? void 0 : t2.vnode.props) ?? {};
...
var gt = S({ name: `PrimitiveSlot`, inheritAttrs: false, setup(e2, { attrs: t2, slots: n2 }) {
  return () => {
    ...
    if (r2 === -1) return e3;
    let i2 = e3[r2];
    (_a3 = i2.props) == null ? true : delete _a3.ref;
...
var H = Mt(), Nt = (e2) => {
  let t2 = (t3, n2) => {
    let { extend: r2 = null, slots: i2 = {}, variants: a2 = {}, compoundVariants: o2 = [], compoundSlots: s2 = [], defaultVariants: c2 = {} } = t3, l2 = { ...jt, ...n2 }, u2 = (r2 == null ? void 0 : r2.base) ? wt(r2.base, t3 == null ? void 0 : t3.base) : t3 == null ? void 0 : t3.base, d2 = (r2 == null ? void 0 : r2.variants) && !V(r2.variants) ? At(a2, r2.variants) : a2, f2 = (r2 == null ? void 0 : r2.defaultVariants) && !V(r2.defaultVariants) ? { ...r2.defaultVariants, ...c2 } : c2;
    ...
    let p2 = V(r2 == null ? void 0 : r2.slots), m2 = V(i2) ? {} : { base: wt(t3 == null ? void 0 : t3.base, p2 && (r2 == null ? void 0 : r2.base)), ...i2 }, h2 = p2 ? m2 : Dt({ ...r2 == null ? void 0 : r2.slots }, V(m2) ? { base: t3 == null ? void 0 : t3.base } : m2), g2 = V(r2 == null ? void 0 : r2.compoundVariants) ? o2 : kt(r2 == null ? void 0 : r2.compoundVariants, o2), _2 = (t4) => {
      if (V(d2) && V(i2) && p2) return e2(u2, t4 == null ? void 0 : t4.class, t4 == null ? void 0 : t4.className)(l2);
      ...
      let n3 = (e3, n4 = d2, r4 = null, i3 = null) => {
        ...
        let o4 = (i3 == null ? void 0 : i3[e3]) ?? (t4 == null ? void 0 : t4[e3]);
        if (o4 === null) return null;
        let s3 = Tt(o4);
        if (typeof s3 == `object`) return null;
        let c4 = f2 == null ? void 0 : f2[e3];
      ...
      let c3 = (e3, n4) => {
        var _a3;
        let r4 = typeof (t4 == null ? void 0 : t4[e3]) == `object` ? { [e3]: (_a3 = t4[e3]) == null ? void 0 : _a3.initial } : {};
        return { ...f2, ...o3, ...r4, ...n4 };
      }, m3 = (e3 = [], t5) => {
        let n4 = [], r4 = e3.length;
      ...
      if (!V(i2) || !p2) {
        ...
        if (typeof h2 == `object` && !V(h2)) {
          ...
          for (let e3 in h2) t5[e3] = (t6) => {
            ...
            return n4(h2[e3], a3(e3, t6), r4 ? r4[e3] : void 0, i3 ? i3[e3] : void 0, t6 == null ? void 0 : t6.class, t6 == null ? void 0 : t6.className)(l2);
          };
        }
        return t5;
      }
      return e2(u2, r3(), m3(g2), t4 == null ? void 0 : t4.class, t4 == null ? void 0 : t4.className)(l2);
    };
  ...
  return { getClassGroupId: (e3) => {
    ...
    let n3 = e3.split(Lt);
    return Vt(n3, n3[0] === `` && n3.length > 1 ? 1 : 0, t2);
  ...
  let n2 = wt(e2);
  return !n2 || !((t2 == null ? void 0 : t2.twMerge) ?? true) ? n2 : ((!H.cachedTwMerge || H.didTwMergeConfigChange) && (H.didTwMergeConfigChange = false, H.cachedTwMerge = ir(H.cachedTwMergeConfig)), H.cachedTwMerge(n2) || void 0);
}, { createTV: or, tv: sr } = Nt((...e2) => (t2) => ar(e2, t2)), $ = or((_a2 = ve.ui) == null ? void 0 : _a2.tv), cr = /^[a-z0-9]+(-[a-z0-9]+)*$/, lr = (e2, t2, n2, r2 = ``) => {
  let i2 = e2.split(`:`);
  if (e2.slice(0, 1) === `@`) {
...
var Ki = { ...pr, body: `` }, qi = S((e2, { emit: t2 }) => {
  ...
  function r2() {
    var _a3, _b;
    n2.value && (n2.value = ((_b = (_a3 = n2.value).abort) == null ? void 0 : _b.call(_a3), null));
  }
  ...
  function l2() {
    var _a3;
    let e3 = c2();
    e3 ? e3.data !== ((_a3 = o2.value) == null ? void 0 : _a3.data) && (o2.value = e3) : o2.value = null;
  }
  ...
  let i2 = _(() => {
    var _a3;
    let e3 = t2.mode || ((_a3 = n2.icon) == null ? void 0 : _a3.mode);
    return e3 === `css` ? `style` : e3;
  }), a2 = _(() => {
    var _a3;
    return t2.size || ((_a3 = n2.icon) == null ? void 0 : _a3.size);
  }), o2 = _(() => {
    var _a3;
    return r2(t2.customize, (_a3 = n2.icon) == null ? void 0 : _a3.customize);
  });
...
function Xi(e2) {
  let t2 = c(Yi, void 0), n2 = _(() => e2.size ?? (t2 == null ? void 0 : t2.value.size));
...
var Zi = { slots: { root: `relative inline-flex items-center justify-center shrink-0`, base: `rounded-full ring ring-bg flex items-center justify-center text-inverted font-medium whitespace-nowrap` }, variants: { color: { primary: `bg-primary`, secondary: `bg-secondary`, success: `bg-success`, info: `bg-info`, warning: `bg-warning`, error: `bg-error`, neutral: `bg-inverted` }, size: { "3xs": `h-[4px] min-w-[4px] text-[4px]`, "2xs": `h-[5px] min-w-[5px] text-[5px]`, xs: `h-[6px] min-w-[6px] text-[6px]`, sm: `h-[7px] min-w-[7px] text-[7px]`, md: `h-[8px] min-w-[8px] text-[8px]`, lg: `h-[9px] min-w-[9px] text-[9px]`, xl: `h-[10px] min-w-[10px] text-[10px]`, "2xl": `h-[11px] min-w-[11px] text-[11px]`, "3xl": `h-[12px] min-w-[12px] text-[12px]` }, position: { "top-right": `top-0 right-0`, "bottom-right": `bottom-0 right-0`, "top-left": `top-0 left-0`, "bottom-left": `bottom-0 left-0` }, inset: { false: `` }, standalone: { false: `absolute` } }, compoundVariants: [{ position: `top-right`, inset: false, class: `-translate-y-1/2 translate-x-1/2 transform` }, { position: `bottom-right`, inset: false, class: `translate-y-1/2 translate-x-1/2 transform` }, { position: `top-left`, inset: false, class: `-translate-y-1/2 -translate-x-1/2 transform` }, { position: `bottom-left`, inset: false, class: `translate-y-1/2 -translate-x-1/2 transform` }], defaultVariants: { size: `md`, color: `primary`, position: `top-right` } }, Qi = Object.assign({ inheritAttrs: false }, { __name: `Chip`, props: e({ as: { type: null, required: false }, text: { type: [String, Number], required: false }, color: { type: null, required: false }, size: { type: null, required: false }, position: { type: null, required: false }, inset: { type: Boolean, required: false, default: false }, standalone: { type: Boolean, required: false, default: false }, class: { type: null, required: false }, ui: { type: Object, required: false } }, { show: { type: Boolean, default: true }, showModifiers: {} }), emits: [`update:show`], setup(e2) {
  let n2 = e2, a2 = o(e2, `show`, { type: Boolean, default: true }), { size: s2 } = Xi(n2), c2 = R(), l2 = xt(`chip`, n2), u2 = _(() => {
    var _a3;
    return $({ extend: $(Zi), ...((_a3 = c2.ui) == null ? void 0 : _a3.chip) || {} })({ color: n2.color, size: s2.value, position: n2.position, inset: n2.inset, standalone: n2.standalone });
  });
  return (o2, s3) => {
    var _a3;
    return C(), O(d(vt), { as: e2.as, "data-slot": `root`, class: f(u2.value.root({ class: [(_a3 = d(l2)) == null ? void 0 : _a3.root, n2.class] })) }, { default: E(() => {
      var _a4;
      return [r(d(gt), t(ae(o2.$attrs)), { default: E(() => [M(o2.$slots, `default`)]), _: 3 }, 16), a2.value ? (C(), p(`span`, { key: 0, "data-slot": `base`, class: f(u2.value.base({ class: (_a4 = d(l2)) == null ? void 0 : _a4.base })) }, [M(o2.$slots, `content`, {}, () => [i(D(e2.text), 1)])], 2)) : ie(``, true)];
    }), _: 3 }, 8, [`as`, `class`]);
  };
  ...
  let n2 = e2, r2 = _(() => {
    var _a3;
    return typeof n2.as == `string` || typeof ((_a3 = n2.as) == null ? void 0 : _a3.render) == `function` ? { root: n2.as } : z(n2.as, { root: `span` });
  }), i2 = _(() => n2.text || (n2.alt || ``).split(` `).map((e3) => e3.charAt(0)).join(``).substring(0, 2)), a2 = R(), o2 = xt(`avatar`, n2), { size: c2 } = Xi(n2), l2 = _(() => {
    var _a3;
    return $({ extend: $($i), ...((_a3 = a2.ui) == null ? void 0 : _a3.avatar) || {} })({ size: c2.value });
  }), u2 = _(() => {
    var _a3;
    return l2.value.root({ class: [(_a3 = o2.value) == null ? void 0 : _a3.root, n2.class] });
  }), m2 = _(() => {
  ...
  return (a3, s2) => (C(), O(j(n2.chip ? Qi : d(vt)), h({ as: r2.value.root }, n2.chip ? typeof n2.chip == `object` ? { inset: true, ...n2.chip } : { inset: true } : {}, { "data-slot": `root`, class: u2.value, style: n2.style }), { default: E(() => {
    var _a3;
    return [e2.src && !g2.value ? (C(), O(j(r2.value.img || d(`img`)), h({ key: 0, src: e2.src, alt: e2.alt, width: m2.value, height: m2.value }, a3.$attrs, { "data-slot": `image`, class: l2.value.image({ class: (_a3 = d(o2)) == null ? void 0 : _a3.image }), onError: v2 }), null, 16, [`src`, `alt`, `width`, `height`, `class`])) : (C(), O(d(gt), t(h({ key: 1 }, a3.$attrs)), { default: E(() => [M(a3.$slots, `default`, {}, () => {
      var _a4, _b;
      return [e2.icon ? (C(), O(Ji, { key: 0, name: e2.icon, "data-slot": `icon`, class: f(l2.value.icon({ class: (_a4 = d(o2)) == null ? void 0 : _a4.icon })) }, null, 8, [`name`, `class`])) : (C(), p(`span`, { key: 1, "data-slot": `fallback`, class: f(l2.value.fallback({ class: (_b = d(o2)) == null ? void 0 : _b.fallback })) }, D(i2.value || `\xA0`), 3))];
    })]), _: 3 }, 16))];
  }), _: 3 }, 16, [`as`, `class`, `style`]));
} });
function ta(e2) {
...
function ra(e2) {
  let t2 = c(na, void 0);
  return { orientation: _(() => t2 == null ? void 0 : t2.value.orientation), size: _(() => (e2 == null ? void 0 : e2.size) ?? (t2 == null ? void 0 : t2.value.size)) };
}
var ia = /* @__PURE__ */ Symbol(`nuxt-ui.form-options`), aa = /* @__PURE__ */ Symbol(`nuxt-ui.form-events`), oa = /* @__PURE__ */ Symbol(`nuxt-ui.form-state`), sa = /* @__PURE__ */ Symbol(`nuxt-ui.form-field`), ca = /* @__PURE__ */ Symbol(`nuxt-ui.input-id`), la = /* @__PURE__ */ Symbol(`nuxt-ui.form-inputs`), ua = /* @__PURE__ */ Symbol(`nuxt-ui.form-loading`), da = /* @__PURE__ */ Symbol(`nuxt-ui.form-errors`);
function fa(e2, t2) {
  let n2 = c(ia, void 0), r2 = c(aa, void 0), i2 = c(sa, void 0), a2 = c(ca, void 0);
  y(sa, void 0), i2 && a2 && ((t2 == null ? void 0 : t2.bind) === false ? a2.value = void 0 : (e2 == null ? void 0 : e2.id) && (a2.value = e2 == null ? void 0 : e2.id));
  function o2(e3, t3, n3) {
    r2 && i2 && t3 && r2.emit({ type: e3, name: t3, eager: n3 });
  }
  function s2() {
    o2(`blur`, i2 == null ? void 0 : i2.value.name);
  }
  function l2() {
    o2(`focus`, i2 == null ? void 0 : i2.value.name);
  }
  function u2() {
    o2(`change`, i2 == null ? void 0 : i2.value.name);
  }
  let d2 = se(() => {
    o2(`input`, i2 == null ? void 0 : i2.value.name, !(t2 == null ? void 0 : t2.deferInputValidation) || (i2 == null ? void 0 : i2.value.eagerValidation));
  }, (i2 == null ? void 0 : i2.value.validateOnInputDelay) ?? (n2 == null ? void 0 : n2.value.validateOnInputDelay) ?? 0);
  return { id: _(() => (e2 == null ? void 0 : e2.id) ?? (a2 == null ? void 0 : a2.value)), name: _(() => (e2 == null ? void 0 : e2.name) ?? (i2 == null ? void 0 : i2.value.name)), size: _(() => (e2 == null ? void 0 : e2.size) ?? (i2 == null ? void 0 : i2.value.size)), color: _(() => (i2 == null ? void 0 : i2.value.error) ? `error` : e2 == null ? void 0 : e2.color), highlight: _(() => (i2 == null ? void 0 : i2.value.error) ? true : e2 == null ? void 0 : e2.highlight), disabled: _(() => (n2 == null ? void 0 : n2.value.disabled) || (e2 == null ? void 0 : e2.disabled)), emitFormBlur: s2, emitFormInput: d2, emitFormChange: u2, emitFormFocus: l2, ariaAttrs: _(() => {
    if (!(i2 == null ? void 0 : i2.value)) return;
    let e3 = [`error`, `hint`, `description`, `help`].filter((e4) => {
      var _a3;
      return (_a3 = i2 == null ? void 0 : i2.value) == null ? void 0 : _a3[e4];
    }).map((e4) => `${i2 == null ? void 0 : i2.value.ariaId}-${e4}`) || [], t3 = { "aria-invalid": !!(i2 == null ? void 0 : i2.value.error) };
    return e3.length > 0 && (t3[`aria-describedby`] = e3.join(` `)), t3;
  }) };
}
var pa = `active.activeClass.ariaCurrentValue.as.disabled.download.exact.exactActiveClass.exactHash.exactQuery.external.form.formaction.formenctype.formmethod.formnovalidate.formtarget.href.hreflang.inactiveClass.media.noPrefetch.noRel.onClick.ping.prefetch.prefetchOn.prefetchedClass.referrerpolicy.rel.replace.target.title.to.trailingSlash.type.viewTransition`.split(`.`);
function ma(e2) {
  let t2 = Object.keys(e2), n2 = t2.filter((e3) => e3.startsWith(`aria-`)), r2 = t2.filter((e3) => e3.startsWith(`data-`));
  return oe(e2, ...pa, ...n2, ...r2);
}
function ha(e2, t2) {
...
var ga = { __name: `LinkBase`, props: { as: { type: String, required: false, default: `button` }, type: { type: String, required: false, default: `button` }, disabled: { type: Boolean, required: false }, onClick: { type: [Function, Array], required: false }, href: { type: String, required: false }, navigate: { type: Function, required: false }, target: { type: [String, Object, null], required: false }, rel: { type: [String, Object, null], required: false }, active: { type: Boolean, required: false }, isExternal: { type: Boolean, required: false } }, setup(e2) {
  ...
  function f2({ route: e3, isActive: t2, isExactActive: i3 }) {
    ...
    if (n2.exactQuery === `partial`) {
      if (!ha(e3.query, r2.query)) return false;
  ...
  function m2({ route: e3, isActive: t2, isExactActive: r3 } = {}) {

import { D as e, E as t, On as n, St as r, _ as i, b as a, g as o, gt as s, k as c, mt as l, o as u, qt as d, rt as f, tr as p, v as m, vn as h } from "./runtime-core.esm-bundler-Twwq1XF8.js";
import { t as g } from "./Tooltip-CPUUajce.js";
import { j as _, n as v, t as y, y as b } from "./Button-DbU2pTtV.js";
import { h as x } from "./useApi-CROJJdhE-DpbaUaur.js";
import { t as S } from "./NavigationMenu-BjdTXMUa.js";
import { r as C, t as w } from "./useFileAction-D-vgsRpM.js";
import { t as T } from "./settings-DsLgXECG.js";
import { n as E, t as D } from "./adobe-css-tools-Buy25uqI.js";
import { n as O, t as k } from "./DashboardNavbar-BmMVUB2G.js";
import { t as A } from "./DashboardSidebarCollapse-_wrNpC08.js";
...
function U(e2) {
  ...
  return E({ type: `stylesheet`, stylesheet: { rules: [{ type: `rule`, selectors: [e2.isStatic ? `@theme static` : `@theme`], declarations: n2 }] } });
}
function W() {
...
var G = { class: `flex flex-col items-center justify-center h-full p-8 text-center` }, K = { class: `max-w-md mx-auto` }, q = { class: `text-2xl font-bold text-highlighted mb-4` }, J = { class: `text-dimmed mb-6 leading-relaxed` }, Y = { class: `space-y-4` }, X = { class: `text-sm text-dimmed` }, Z = c({ __name: `VersionRequirement`, setup(r2) {
  ...
  let n2 = C(), i2 = w(), c2 = W(), p2 = x(), v2 = T(), b2 = h(c2.getDefaultTheme());
  s(`theme`, b2);
  let E2 = o(() => v2.virtualOptions(`general.tailwindcss.version`, 4).value === 4);
  f(async () => {
    if (await Promise.all([n2.initPull(), v2.initPull()]), E2.value) {
      let e2 = n2.data.entries.find((e3) => e3.relative_path === `wizard.css`)?.content || ``;
      e2.includes(`@theme`) || (e2 += `
@theme {

}`), b2.value = c2.parseWizardFile(e2);
    }
  });
  function D2() {
    let e2 = c2.stringifyTheme(b2.value), t3 = n2.data.entries.find((e3) => e3.relative_path === `wizard.css`);
  ...
  return _((e2, t3, n3) => {
    ...
    let i3 = A, o2 = y, s2 = g, c3 = k, f2 = S, p3 = O, h2 = r(`RouterView`);

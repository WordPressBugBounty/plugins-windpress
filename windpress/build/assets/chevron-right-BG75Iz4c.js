import { $n as e, B as t, D as n, Ht as r, Nt as i, St as a, Zn as o, Zt as s, _ as c, _t as l, b as u, er as d, et as f, fn as p, ht as m, k as h, mt as g, o as ee, qt as _, tr as te, tt as ne, v, vn as y, xt as b, y as re, z as ie } from "./runtime-core.esm-bundler-CahM68iJ.js";
import { c as ae, r as oe } from "./vue.runtime.esm-bundler-B0iyRCM8.js";
...
function S(e2) {
  var _a;
  return ((_a = e2.ownerDocument) == null ? void 0 : _a.defaultView) || window;
}
function C(e2) {
...
function M(e2, t2, n2, r2) {
  ...
  let s2 = a2 ? S(a2) : window, c2 = !Oe() && n2, l2 = (i2.left + (c2 && ((_a = s2.visualViewport) == null ? void 0 : _a.offsetLeft) || 0)) / o2.x, u2 = (i2.top + (c2 && ((_b = s2.visualViewport) == null ? void 0 : _b.offsetTop) || 0)) / o2.y, d2 = i2.width / o2.x, f2 = i2.height / o2.y;
  if (a2) {
...
function I(e2, t2) {
  var _a;
  t2 === void 0 && (t2 = []);
  let n2 = Ne(e2), r2 = n2 === ((_a = e2.ownerDocument) == null ? void 0 : _a.body), i2 = S(n2);
...
var Ze = `__floating-vue__popper`, Qe = () => h({ name: `VPopper`, provide() {
  ...
  var _a;
  return (_a = this[Ze]) == null ? void 0 : _a.parentPopper;
  ...
  var _a;
  var r2;
  (r2 = this.parentPopper) != null && r2.lockedChild && this.parentPopper.lockedChild !== this || (this.pendingHide = false, (n2 || !this.disabled) && (((_a = this.parentPopper) == null ? void 0 : _a.lockedChild) === this && (this.parentPopper.lockedChild = null), this.$_scheduleShow(e2, t2), this.$emit(`show`), this.$_showFrameLocked = true, requestAnimationFrame(() => {

...
function me(e2) {
  var _a;
  var t2 = M(e2), n2 = de(e2), r2 = (_a = e2.ownerDocument) == null ? void 0 : _a.body, i2 = S(t2.scrollWidth, t2.clientWidth, r2 ? r2.scrollWidth : 0, r2 ? r2.clientWidth : 0), a2 = S(t2.scrollHeight, t2.clientHeight, r2 ? r2.scrollHeight : 0, r2 ? r2.clientHeight : 0), o2 = -n2.scrollLeft + fe(e2), s2 = -n2.scrollTop;
...
function Y(e2, t2) {
  var _a;
  t2 === void 0 && (t2 = []);
  var n2 = ge(e2), r2 = n2 === ((_a = e2.ownerDocument) == null ? void 0 : _a.body), i2 = m(n2), a2 = r2 ? [i2].concat(i2.visualViewport || [], he(n2) ? n2 : []) : n2, o2 = t2.concat(a2);
...
function Tt(e2, t2) {
  ...
  for (var n2 = t2; n2; ) {
    ...
    n2 = n2.getRootNode == null ? void 0 : (_a = n2.getRootNode()) == null ? void 0 : _a.host;
  }
  return false;
}
...
function Kt(e2, t2) {
  ...
  function j2(e3) {
    return y2.state.isMounted && !y2.state.isVisible || Q.isTouch || u2 && u2.type === `focus` ? 0 : rt(y2.props.delay, e3 ? 0 : 1, $.delay);
  }
  function M2(e3) {
  ...
  function ne2(e3) {
    ...
    if (!(!y2.state.isEnabled || oe2(e3) || s2)) {
      var n3 = (u2 == null ? void 0 : u2.type) === `focus`;
  ...
  function re2(e3) {
    ...
    e3.type === `mousemove` && r3 || Ct(q2().concat(x2).map(function(e4) {
      var _a;
      var t4 = (_a = e4._tippy.popperInstance) == null ? void 0 : _a.state;
  ...
  function K2() {
    ...
    D2() && s3 && l3.push({ name: `arrow`, options: { element: s3, padding: 3 } }), l3.push.apply(l3, (n3 == null ? void 0 : n3.modifiers) || []), y2.popperInstance = Xe(c3, x2, Object.assign({}, n3, { placement: r3, onFirstUpdate: f2, modifiers: l3 }));
  }
  function se2() {

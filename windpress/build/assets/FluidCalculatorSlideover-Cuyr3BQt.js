import { $ as e, $n as t, Cn as n, D as r, E as i, Ft as a, Ht as o, Lt as s, On as c, Rt as l, Tn as u, Zn as d, _ as f, b as p, bt as m, ct as h, et as g, g as _, k as v, mt as y, o as b, qt as x, tr as S, tt as C, v as w, vn as T, wn as E, xt as D, y as O, z as k } from "./runtime-core.esm-bundler-CahM68iJ.js";
import { c as A, l as j } from "./vue.runtime.esm-bundler-B0iyRCM8.js";
import { F as M, H as N, I as ee, N as te, P as ne, R as re, T as P, U as F, _ as ie, b as I, g as ae, h as L, m as R, p as oe, q as se, t as ce, v as z, x as B, y as le, z as ue } from "./Button-DpvhuBJO.js";
import { A as de, O as fe, S as V, T as H, b as pe, f as me, k as he, o as ge, p as U, r as _e, y as ve } from "./dist-BKF-Yqo1.js";
import { B as ye, D as be, R as xe, V as Se, n as Ce, t as we } from "./namespaced-BdQ8WLes.js";
import { n as Te, t as Ee } from "./clamp-DWsB7m9b.js";
import { C as De, S as Oe, g as ke, i as Ae, v as je, y as W } from "./Tooltip-CZRNrufK.js";
import { n as G, r as Me, t as Ne } from "./VisuallyHiddenInput-D4UqkOgw.js";
import { t as Pe } from "./Separator-DX0bLfZm.js";
import { t as Fe } from "./Slideover-SxW0jiNx.js";
import { n as Ie } from "./DropdownMenu-BEraqKHF.js";
import { t as Le } from "./Input-CpPafee7.js";
import { t as Re } from "./virtualizer-Dm0ZM8dK.js";
import { t as ze } from "./_plugin-vue_export-helper-4qEyeFbT.js";
function Be(e2) {
  let t2 = Oe({ locale: T(`en`) });
  return _(() => {
    var _a;
    return (e2 == null ? void 0 : e2.value) || ((_a = t2.locale) == null ? void 0 : _a.value) || `en`;
  });
}
...
var Ue = { degree: { narrow: { default: `\xB0`, "ja-JP": ` \u5EA6`, "zh-TW": `\u5EA6`, "sl-SI": ` \xB0` } } }, We = class {
  format(e2) {
    ...
    if (t2 = !He && this.options.signDisplay != null ? Ge(this.numberFormatter, this.options.signDisplay, e2) : this.numberFormatter.format(e2), this.options.style === `unit` && !K) {
      ...
      if (!e3) return t2;
      let i2 = (_a = Ue[e3]) == null ? void 0 : _a[n2];
      t2 += i2[r2] || i2.default;
    }
    return t2;
  }
...
function q(e2, t2 = {}) {
  ...
  if (n2 && e2.includes(`-nu-`) && (e2.includes(`-u-`) || (e2 += `-u-`), e2 += `-nu-${n2}`), t2.style === `unit` && !K) {
    ...
    if (!((_a = Ue[e3]) == null ? void 0 : _a[n3])) throw Error(`Unsupported unit ${e3} with unitDisplay = ${n3}`);
    t2 = { ...t2, style: `decimal` };
  }
...
function Qe(e2, t2, n2, r2) {
  var _a, _b, _c, _d;
  let i2 = new Intl.NumberFormat(e2, { ...n2, minimumSignificantDigits: 1, maximumSignificantDigits: 21, roundingIncrement: 1, roundingPriority: `auto`, roundingMode: `halfExpand` }), a2 = i2.formatToParts(-10000.111), o2 = i2.formatToParts(10000.111), s2 = Ze.map((e3) => i2.formatToParts(e3)), c2 = ((_a = a2.find((e3) => e3.type === `minusSign`)) == null ? void 0 : _a.value) ?? `-`, l2 = (_b = o2.find((e3) => e3.type === `plusSign`)) == null ? void 0 : _b.value;
  !l2 && ((r2 == null ? void 0 : r2.signDisplay) === `exceptZero` || (r2 == null ? void 0 : r2.signDisplay) === `always`) && (l2 = `+`);
  let u2 = (_c = new Intl.NumberFormat(e2, { ...n2, minimumFractionDigits: 2, maximumFractionDigits: 2 }).formatToParts(1e-3).find((e3) => e3.type === `decimal`)) == null ? void 0 : _c.value, d2 = (_d = a2.find((e3) => e3.type === `group`)) == null ? void 0 : _d.value, f2 = a2.filter((e3) => !X.has(e3.type)).map((e3) => $e(e3.value)), p2 = s2.flatMap((e3) => e3.filter((e4) => !X.has(e4.type)).map((e4) => $e(e4.value))), m2 = [.../* @__PURE__ */ new Set([...f2, ...p2])].sort((e3, t3) => t3.length - e3.length), h2 = m2.length === 0 ? RegExp(`[\\p{White_Space}]`, `gu`) : RegExp(`${m2.join(`|`)}|[\\p{White_Space}]`, `gu`), g2 = [...new Intl.NumberFormat(n2.locale, { useGrouping: false }).format(9876543210)].reverse(), _2 = new Map(g2.map((e3, t3) => [e3, t3])), v2 = RegExp(`[${g2.join(``)}]`, `g`);
...
var [it, at] = P(`NumberFieldRoot`), ot = v({ inheritAttrs: false, __name: `NumberFieldRoot`, props: { defaultValue: { type: Number, required: false, default: void 0 }, modelValue: { type: [Number, null], required: false }, min: { type: Number, required: false }, max: { type: Number, required: false }, step: { type: Number, required: false, default: 1 }, stepSnapping: { type: Boolean, required: false, default: true }, focusOnChange: { type: Boolean, required: false, default: true }, formatOptions: { type: null, required: false }, locale: { type: String, required: false }, disabled: { type: Boolean, required: false }, readonly: { type: Boolean, required: false }, disableWheelChange: { type: Boolean, required: false }, invertWheelChange: { type: Boolean, required: false }, id: { type: String, required: false }, asChild: { type: Boolean, required: false }, as: { type: null, required: false, default: `div` }, name: { type: String, required: false }, required: { type: Boolean, required: false } }, emits: [`update:modelValue`], setup(e2, { emit: t2 }) {
  ...
  function N2(e3, t3 = 1) {
    var _a, _b;
    if (n2.focusOnChange && ((_a = A2.value) == null ? void 0 : _a.focus()), n2.disabled || n2.readonly) return;
    let r3 = P2.parse(((_b = A2.value) == null ? void 0 : _b.value) ?? ``);
  ...
  let t2 = e2, n2 = it(), r2 = _(() => {
    var _a;
    return ((_a = n2.disabled) == null ? void 0 : _a.value) || n2.readonly.value || t2.disabled || n2.isDecreaseDisabled.value;
  }), { primitiveElement: i2, currentElement: a2 } = G(), { isPressed: o2, onTrigger: s2 } = et({ target: a2, disabled: r2 });
  return s2(() => {
    n2.handleDecrease();
  ...
  let t2 = e2, n2 = it(), r2 = _(() => {
    var _a;
    return ((_a = n2.disabled) == null ? void 0 : _a.value) || n2.readonly.value || t2.disabled || n2.isIncreaseDisabled.value;
  }), { primitiveElement: i2, currentElement: a2 } = G(), { isPressed: o2, onTrigger: s2 } = et({ target: a2, disabled: r2 });
  return s2(() => {
    n2.handleIncrease();
  ...
  }), onChange: l2, onBlur: r3[9] || (r3[9] = (e4) => {
    var _a;
    return c(i2).applyInputValue((_a = e4.target) == null ? void 0 : _a.value);
  }) }), { default: x(() => [D(e3.$slots, `default`)]), _: 3 }, 16, [`id`, `value`, `inputmode`, `disabled`, `data-disabled`, `readonly`, `data-readonly`, `aria-valuenow`, `aria-valuemin`, `aria-valuemax`]));
  ...
  function a2(e3) {
    ...
    let t3 = e3.target;
    t3.value && n2.onAddValue(t3.value) && (t3.value = ``);
  }
  function o2(e3) {
  ...
  return h(() => {
    ...
    e3 && setTimeout(() => {
      t2.autoFocus && (e3 == null ? void 0 : e3.focus());
    }, 1);
  }), (e3, t3) => {
    var _a;
    return y(), w(c(B), { id: (_a = c(n2).id) == null ? void 0 : _a.value, ref: c(r2), type: `text`, autocomplete: `off`, autocorrect: `off`, autocapitalize: `off`, as: e3.as, "as-child": e3.asChild, maxlength: e3.maxLength, placeholder: e3.placeholder, disabled: c(n2).disabled.value, "data-invalid": c(n2).isInvalidInput.value ? `` : void 0, onInput: f2, onKeydown: [A(d2, [`enter`]), A(o2, [`tab`]), c(n2).onInputKeydown], onBlur: a2, onCompositionstart: l2, onCompositionend: u2, onPaste: p2 }, { default: x(() => [D(e3.$slots, `default`)]), _: 3 }, 8, [`id`, `as`, `as-child`, `maxlength`, `placeholder`, `disabled`, `data-invalid`, `onKeydown`]);
  };
  ...
  let n2 = $(), r2 = ft(), i2 = _(() => {
    var _a;
    return ((_a = r2.disabled) == null ? void 0 : _a.value) || n2.disabled.value;
  });
  function a2() {
    if (i2.value) return;
  ...
  let i2 = e2, a2 = n2, o2 = pe(i2, `modelValue`, a2, { defaultValue: i2.defaultValue }), { t: s2 } = te(), u2 = se(), f2 = I(`inputNumber`, i2), m2 = je(de(i2, `as`, `stepSnapping`, `formatOptions`, `disableWheelChange`, `invertWheelChange`, `required`, `readonly`, `focusOnChange`), a2), { emitFormBlur: v2, emitFormFocus: b2, emitFormChange: S2, emitFormInput: C2, id: T2, color: k2, size: A2, name: j2, highlight: M2, disabled: N2, ariaAttrs: ee2 } = oe(i2), { orientation: ne2, size: re2 } = R(i2), P2 = _(() => re2.value || A2.value), F2 = _(() => {
    var _a;
    return le({ extend: le(_t), ...((_a = u2.ui) == null ? void 0 : _a.inputNumber) || {} })({ color: k2.value, variant: i2.variant, size: P2.value, highlight: M2.value, fixed: i2.fixed, orientation: i2.orientation, fieldGroup: ne2.value, increment: i2.orientation === `vertical` ? !!i2.increment || !!i2.decrement : !!i2.increment, decrement: i2.orientation === `vertical` ? false : !!i2.decrement });
  }), ie2 = _(() => i2.incrementIcon || (i2.orientation === `horizontal` ? u2.ui.icons.plus : u2.ui.icons.chevronUp)), ae2 = _(() => i2.decrementIcon || (i2.orientation === `horizontal` ? u2.ui.icons.minus : u2.ui.icons.chevronDown)), L2 = l(`inputRef`);
  function z2(e3) {
    var _a;
    ((_a = i2.modelModifiers) == null ? void 0 : _a.optional) && (o2.value = e3 ?? (e3 = void 0)), a2(`change`, new Event(`change`, { target: { value: e3 } })), S2(), C2();
  }
  function B2(e3) {
    v2(), a2(`blur`, e3);
  }
  function ue2() {
    var _a, _b;
    i2.autofocus && ((_b = (_a = L2.value) == null ? void 0 : _a.$el) == null ? void 0 : _b.focus());
  }
  return h(() => {
    setTimeout(() => {
      ue2();
    ...
    var _a;
    return (_a = L2.value) == null ? void 0 : _a.$el;
  }) }), (t3, n3) => {
    var _a;
    return y(), w(c(ot), g(c(m2), { id: c(T2), "default-value": e2.defaultValue, "model-value": c(o2), min: e2.min, max: e2.max, step: e2.step, "data-slot": `root`, class: F2.value.root({ class: [(_a = c(f2)) == null ? void 0 : _a.root, i2.class] }), name: c(j2), disabled: c(N2), "onUpdate:modelValue": n3[0] || (n3[0] = (e3) => z2(e3)) }), { default: x(() => {
      var _a2, _b, _c;
      return [r(c(ct), g({ ...t3.$attrs, ...c(ee2) }, { ref_key: `inputRef`, ref: L2, placeholder: e2.placeholder, required: e2.required, "data-slot": `base`, class: F2.value.base({ class: (_a2 = c(f2)) == null ? void 0 : _a2.base }), onBlur: B2, onFocus: c(b2) }), null, 16, [`placeholder`, `required`, `class`, `onFocus`]), e2.increment ? (y(), p(`div`, { key: 0, "data-slot": `increment`, class: d(F2.value.increment({ class: (_b = c(f2)) == null ? void 0 : _b.increment })) }, [r(c(st), { "as-child": ``, disabled: c(N2) || e2.incrementDisabled }, { default: x(() => [D(t3.$slots, `increment`, {}, () => [r(ce, g({ icon: ie2.value, color: c(k2), size: P2.value, variant: `link`, "aria-label": c(s2)(`inputNumber.increment`) }, typeof e2.increment == `object` ? e2.increment : void 0), null, 16, [`icon`, `color`, `size`, `aria-label`])])]), _: 3 }, 8, [`disabled`])], 2)) : O(``, true), e2.decrement ? (y(), p(`div`, { key: 1, "data-slot": `decrement`, class: d(F2.value.decrement({ class: (_c = c(f2)) == null ? void 0 : _c.decrement })) }, [r(c(Q), { "as-child": ``, disabled: c(N2) || e2.decrementDisabled }, { default: x(() => [D(t3.$slots, `decrement`, {}, () => [r(ce, g({ icon: ae2.value, color: c(k2), size: P2.value, variant: `link`, "aria-label": c(s2)(`inputNumber.decrement`) }, typeof e2.decrement == `object` ? e2.decrement : void 0), null, 16, [`icon`, `color`, `size`, `aria-label`])])]), _: 3 }, 8, [`disabled`])], 2)) : O(``, true)];
    }), _: 3 }, 16, [`id`, `default-value`, `model-value`, `min`, `max`, `step`, `class`, `name`, `disabled`]);
  };
  ...
  function Z2() {
    var _a, _b;
    T2.autofocus && ((_b = (_a = Qe2.value) == null ? void 0 : _a.$el) == null ? void 0 : _b.focus());
  }
  h(() => {
    C(() => {
  ...
  function $e2(e3) {
    var _a, _b, _c, _d, _e2;
    n(T2.modelValue) !== e3 && (((_a = T2.modelModifiers) == null ? void 0 : _a.trim) && (typeof e3 == `string` || e3 == null) && (e3 = (e3 == null ? void 0 : e3.trim()) ?? null), ((_b = T2.modelModifiers) == null ? void 0 : _b.number) && (e3 = ue(e3)), ((_c = T2.modelModifiers) == null ? void 0 : _c.nullable) && (e3 ?? (e3 = null)), ((_d = T2.modelModifiers) == null ? void 0 : _d.optional) && !((_e2 = T2.modelModifiers) == null ? void 0 : _e2.nullable) && e3 !== null && (e3 ?? (e3 = void 0)), A2(`change`, new Event(`change`, { target: { value: e3 } })), De2(), Oe2(), T2.autocomplete ? B2.value = String(e3 ?? ``) : T2.resetSearchTermOnSelect && (B2.value = ``));
  }
  function et2(e3) {
  ...
  function ot2(e3, t2) {
    ...
    if (Q2(t2)) {
      ...
      (_a = t2.onSelect) == null ? void 0 : _a.call(t2, e3);
    }
  }
  function Q2(e3) {
  ...
  let $2 = l(`viewportRef`);
  return u2({ inputRef: E(() => {
    var _a;
    return (_a = Qe2.value) == null ? void 0 : _a.$el;
  }), viewportRef: E(() => $2.value) }), (n2, a2) => {
    var _a;
    return y(), p(b, null, [r(c(We2), null, { default: x(() => {
      var _a2;
      return [r(c(U2).Item, { "data-slot": `item`, class: d(J2.value.item({ class: (_a2 = c(H2)) == null ? void 0 : _a2.item })), value: B2.value, onSelect: at2 }, { default: x(() => {
        var _a3;
        return [f(`span`, { "data-slot": `itemLabel`, class: d(J2.value.itemLabel({ class: (_a3 = c(H2)) == null ? void 0 : _a3.itemLabel })) }, [D(n2.$slots, `create-item-label`, { item: B2.value }, () => [i(S(c(fe2)(`inputMenu.create`, { label: B2.value })), 1)])], 2)];
      }), _: 3 }, 8, [`class`, `value`])];
    }), _: 3 }), r(c(Ge2), null, { default: x(({ item: t2, index: a3 }) => {
      var _a2, _b, _c, _d, _e2, _f;
      return [Q2(t2) && t2.type === `label` ? (y(), w(c(U2).Label, { key: 0, "data-slot": `label`, class: d(J2.value.label({ class: [(_a2 = c(H2)) == null ? void 0 : _a2.label, (_b = t2.ui) == null ? void 0 : _b.label, t2.class] })) }, { default: x(() => [i(S(c(M)(t2, T2.labelKey)), 1)]), _: 2 }, 1032, [`class`])) : Q2(t2) && t2.type === `separator` ? (y(), w(c(U2).Separator, { key: 1, "data-slot": `separator`, class: d(J2.value.separator({ class: [(_c = c(H2)) == null ? void 0 : _c.separator, (_d = t2.ui) == null ? void 0 : _d.separator, t2.class] })) }, null, 8, [`class`])) : (y(), w(c(U2).Item, { key: 2, "data-slot": `item`, class: d(J2.value.item({ class: [(_e2 = c(H2)) == null ? void 0 : _e2.item, Q2(t2) && ((_f = t2.ui) == null ? void 0 : _f.item), Q2(t2) && t2.class] })), disabled: Q2(t2) && t2.disabled, value: T2.valueKey && Q2(t2) ? c(M)(t2, T2.valueKey) : t2, onSelect: (e3) => ot2(e3, t2) }, { default: x(() => [D(n2.$slots, `item`, { item: t2, index: a3, ui: J2.value }, () => {
        var _a3, _b2, _c2, _d2, _e3, _f2, _g, _h;
        return [D(n2.$slots, `item-leading`, { item: t2, index: a3, ui: J2.value }, () => {
          var _a4, _b3, _c3, _d3, _e4, _f3, _g2, _h2, _i, _j;
          return [Q2(t2) && t2.icon ? (y(), w(z, { key: 0, name: t2.icon, "data-slot": `itemLeadingIcon`, class: d(J2.value.itemLeadingIcon({ class: [(_a4 = c(H2)) == null ? void 0 : _a4.itemLeadingIcon, (_b3 = t2.ui) == null ? void 0 : _b3.itemLeadingIcon] })) }, null, 8, [`name`, `class`])) : Q2(t2) && t2.avatar ? (y(), w(ae, g({ key: 1, size: ((_c3 = t2.ui) == null ? void 0 : _c3.itemLeadingAvatarSize) || ((_d3 = c(H2)) == null ? void 0 : _d3.itemLeadingAvatarSize) || J2.value.itemLeadingAvatarSize() }, t2.avatar, { "data-slot": `itemLeadingAvatar`, class: J2.value.itemLeadingAvatar({ class: [(_e4 = c(H2)) == null ? void 0 : _e4.itemLeadingAvatar, (_f3 = t2.ui) == null ? void 0 : _f3.itemLeadingAvatar] }) }), null, 16, [`size`, `class`])) : Q2(t2) && t2.chip ? (y(), w(ie, g({ key: 2, size: ((_g2 = t2.ui) == null ? void 0 : _g2.itemLeadingChipSize) || ((_h2 = c(H2)) == null ? void 0 : _h2.itemLeadingChipSize) || J2.value.itemLeadingChipSize(), inset: ``, standalone: `` }, t2.chip, { "data-slot": `itemLeadingChip`, class: J2.value.itemLeadingChip({ class: [(_i = c(H2)) == null ? void 0 : _i.itemLeadingChip, (_j = t2.ui) == null ? void 0 : _j.itemLeadingChip] }) }), null, 16, [`size`, `class`])) : O(``, true)];
        }), f(`span`, { "data-slot": `itemWrapper`, class: d(J2.value.itemWrapper({ class: [(_a3 = c(H2)) == null ? void 0 : _a3.itemWrapper, Q2(t2) && ((_b2 = t2.ui) == null ? void 0 : _b2.itemWrapper)] })) }, [f(`span`, { "data-slot": `itemLabel`, class: d(J2.value.itemLabel({ class: [(_c2 = c(H2)) == null ? void 0 : _c2.itemLabel, Q2(t2) && ((_d2 = t2.ui) == null ? void 0 : _d2.itemLabel)] })) }, [D(n2.$slots, `item-label`, { item: t2, index: a3 }, () => [i(S(Q2(t2) ? c(M)(t2, T2.labelKey) : t2), 1)])], 2), Q2(t2) && (c(M)(t2, T2.descriptionKey) || P2[`item-description`]) ? (y(), p(`span`, { key: 0, "data-slot": `itemDescription`, class: d(J2.value.itemDescription({ class: [(_e3 = c(H2)) == null ? void 0 : _e3.itemDescription, Q2(t2) && ((_f2 = t2.ui) == null ? void 0 : _f2.itemDescription)] })) }, [D(n2.$slots, `item-description`, { item: t2, index: a3 }, () => [i(S(c(M)(t2, T2.descriptionKey)), 1)])], 2)) : O(``, true)], 2), f(`span`, { "data-slot": `itemTrailing`, class: d(J2.value.itemTrailing({ class: [(_g = c(H2)) == null ? void 0 : _g.itemTrailing, Q2(t2) && ((_h = t2.ui) == null ? void 0 : _h.itemTrailing)] })) }, [D(n2.$slots, `item-trailing`, { item: t2, index: a3, ui: J2.value }), e2.autocomplete ? O(``, true) : (y(), w(c(U2).ItemIndicator, { key: 0, "as-child": `` }, { default: x(() => {
          var _a4, _b3;
          return [r(z, { name: e2.selectedIcon || c(V2).ui.icons.check, "data-slot": `itemTrailingIcon`, class: d(J2.value.itemTrailingIcon({ class: [(_a4 = c(H2)) == null ? void 0 : _a4.itemTrailingIcon, Q2(t2) && ((_b3 = t2.ui) == null ? void 0 : _b3.itemTrailingIcon)] })) }, null, 8, [`name`, `class`])];
        }), _: 2 }, 1024))], 2)];
      })]), _: 2 }, 1032, [`class`, `disabled`, `value`, `onSelect`]))];
    }), _: 3 }), r(c(U2).Root, g(c(ge2), { name: c(Me2), disabled: c(Pe2), "data-slot": `root`, class: J2.value.root({ class: [(_a = c(H2)) == null ? void 0 : _a.root, T2.class] }), "as-child": !!e2.multiple && !e2.autocomplete, "ignore-filter": ``, "onUpdate:modelValue": $e2, "onUpdate:open": rt2 }), { default: x(({ modelValue: o2, open: s2 }) => {
      var _a2;
      return [r(c(U2).Anchor, { "as-child": !e2.multiple, "data-slot": `base`, class: d(J2.value.base({ class: (_a2 = c(H2)) == null ? void 0 : _a2.base })) }, { default: x(() => {
        var _a3, _b;
        return [e2.multiple && !e2.autocomplete ? (y(), w(c(ut), { key: 0, "model-value": o2, disabled: c(Pe2), required: e2.required, delimiter: ``, "as-child": ``, onBlur: tt2, onFocus: nt2, onRemoveTag: (e3) => it2(e3, o2) }, { default: x(({ modelValue: t2 }) => [(y(true), p(b, null, m(t2, (t3, a3) => {
          var _a4, _b2;
          return y(), w(c(mt), { key: a3, value: t3, "data-slot": `tagsItem`, class: d(J2.value.tagsItem({ class: [(_a4 = c(H2)) == null ? void 0 : _a4.tagsItem, Q2(t3) && ((_b2 = t3.ui) == null ? void 0 : _b2.tagsItem)] })) }, { default: x(() => {
            var _a5, _b3, _c, _d;
            return [r(c(gt), { "data-slot": `tagsItemText`, class: d(J2.value.tagsItemText({ class: [(_a5 = c(H2)) == null ? void 0 : _a5.tagsItemText, Q2(t3) && ((_b3 = t3.ui) == null ? void 0 : _b3.tagsItemText)] })) }, { default: x(() => [D(n2.$slots, `tags-item-text`, { item: t3, index: a3 }, () => [i(S(Je2(t3)), 1)])]), _: 2 }, 1032, [`class`]), r(c(ht), { "data-slot": `tagsItemDelete`, class: d(J2.value.tagsItemDelete({ class: [(_c = c(H2)) == null ? void 0 : _c.tagsItemDelete, Q2(t3) && ((_d = t3.ui) == null ? void 0 : _d.tagsItemDelete)] })), disabled: c(Pe2) }, { default: x(() => [D(n2.$slots, `tags-item-delete`, { item: t3, index: a3, ui: J2.value }, () => {
              var _a6, _b4;
              return [r(z, { name: e2.deleteIcon || c(V2).ui.icons.close, "data-slot": `tagsItemDeleteIcon`, class: d(J2.value.tagsItemDeleteIcon({ class: [(_a6 = c(H2)) == null ? void 0 : _a6.tagsItemDeleteIcon, Q2(t3) && ((_b4 = t3.ui) == null ? void 0 : _b4.tagsItemDeleteIcon)] })) }, null, 8, [`name`, `class`])];
            })]), _: 2 }, 1032, [`class`, `disabled`])];
          }), _: 2 }, 1032, [`value`, `class`]);
        }), 128)), r(c(U2).Input, { modelValue: B2.value, "onUpdate:modelValue": a2[1] || (a2[1] = (e3) => B2.value = e3), "as-child": `` }, { default: x(() => {
          var _a4;
          return [r(c(dt), g({ id: c(G2), ref_key: `inputRef`, ref: Qe2 }, { ...n2.$attrs, ...c(Fe2) }, { placeholder: e2.placeholder, "data-slot": `tagsInput`, class: J2.value.tagsInput({ class: (_a4 = c(H2)) == null ? void 0 : _a4.tagsInput }), onChange: a2[0] || (a2[0] = j(() => {
          }, [`stop`])) }), null, 16, [`id`, `placeholder`, `class`])];
        }), _: 1 }, 8, [`modelValue`])]), _: 3 }, 8, [`model-value`, `disabled`, `required`, `onRemoveTag`])) : (y(), w(c(U2).Input, g({ key: 1, id: c(G2), ref_key: `inputRef`, ref: Qe2 }, { ...e2.autocomplete ? {} : { displayValue: Je2 }, ...n2.$attrs, ...c(Fe2) }, { type: e2.type, placeholder: e2.placeholder, required: e2.required, onBlur: tt2, onFocus: nt2, onChange: a2[2] || (a2[2] = j(() => {
        }, [`stop`])), "onUpdate:modelValue": et2 }), null, 16, [`id`, `type`, `placeholder`, `required`])), c(Be2) || e2.avatar || P2.leading ? (y(), p(`span`, { key: 2, "data-slot": `leading`, class: d(J2.value.leading({ class: (_a3 = c(H2)) == null ? void 0 : _a3.leading })) }, [D(n2.$slots, `leading`, { modelValue: o2, open: s2, ui: J2.value }, () => {
          var _a4, _b2, _c;
          return [c(Be2) && c(He2) ? (y(), w(z, { key: 0, name: c(He2), "data-slot": `leadingIcon`, class: d(J2.value.leadingIcon({ class: (_a4 = c(H2)) == null ? void 0 : _a4.leadingIcon })) }, null, 8, [`name`, `class`])) : e2.avatar ? (y(), w(ae, g({ key: 1, size: ((_b2 = c(H2)) == null ? void 0 : _b2.itemLeadingAvatarSize) || J2.value.itemLeadingAvatarSize() }, e2.avatar, { "data-slot": `itemLeadingAvatar`, class: J2.value.itemLeadingAvatar({ class: (_c = c(H2)) == null ? void 0 : _c.itemLeadingAvatar }) }), null, 16, [`size`, `class`])) : O(``, true)];
        })], 2)) : O(``, true), c(Ve2) || P2.trailing || e2.clear ? (y(), w(c(U2).Trigger, { key: 3, "data-slot": `trailing`, class: d(J2.value.trailing({ class: (_b = c(H2)) == null ? void 0 : _b.trailing })) }, { default: x(() => [D(n2.$slots, `trailing`, { modelValue: o2, open: s2, ui: J2.value }, () => {
          var _a4;
          return [e2.clear && !st2(o2) ? (y(), w(c(U2).Cancel, { key: 0, "as-child": `` }, { default: x(() => {
            var _a5;
            return [r(ce, g({ as: `span`, icon: e2.clearIcon || c(V2).ui.icons.close, size: Ue2.value, variant: `link`, color: `neutral`, tabindex: `-1` }, xe2.value, { "data-slot": `trailingClear`, class: J2.value.trailingClear({ class: (_a5 = c(H2)) == null ? void 0 : _a5.trailingClear }), onClick: j(ct2, [`stop`]) }), null, 16, [`icon`, `size`, `class`])];
          }), _: 1 })) : c(K2) ? (y(), w(z, { key: 1, name: c(K2), "data-slot": `trailingIcon`, class: d(J2.value.trailingIcon({ class: (_a4 = c(H2)) == null ? void 0 : _a4.trailingIcon })) }, null, 8, [`name`, `class`])) : O(``, true)];
        })]), _: 2 }, 1032, [`class`])) : O(``, true)];
      }), _: 2 }, 1032, [`as-child`, `class`]), r(c(U2).Portal, t(k(c(ve2))), { default: x(() => {
        var _a3;
        return [r(c(U2).Content, g({ "data-slot": `content`, class: J2.value.content({ class: (_a3 = c(H2)) == null ? void 0 : _a3.content }) }, ye2.value, { onFocusOutside: a2[3] || (a2[3] = j(() => {
        }, [`prevent`])) }), { default: x(() => {
          var _a4, _b, _c, _d, _e2;
          return [D(n2.$slots, `content-top`), r(c(U2).Empty, { "data-slot": `empty`, class: d(J2.value.empty({ class: (_a4 = c(H2)) == null ? void 0 : _a4.empty })) }, { default: x(() => [D(n2.$slots, `empty`, { searchTerm: B2.value }, () => [i(S(B2.value ? c(fe2)(`inputMenu.noMatch`, { searchTerm: B2.value }) : c(fe2)(`inputMenu.noData`)), 1)])]), _: 3 }, 8, [`class`]), f(`div`, { ref_key: `viewportRef`, ref: $2, role: `presentation`, "data-slot": `viewport`, class: d(J2.value.viewport({ class: (_b = c(H2)) == null ? void 0 : _b.viewport })) }, [e2.virtualize ? (y(), p(b, { key: 0 }, [X2.value && Ze2.value === `top` ? (y(), w(c(q2), { key: 0 })) : O(``, true), r(c(U2).Virtualizer, g({ options: Xe2.value, "text-content": (e3) => Q2(e3) ? c(M)(e3, T2.labelKey) : String(e3) }, Se2.value), { default: x(({ option: e3, virtualItem: t2 }) => [r(c(Ke2), { item: e3, index: t2.index }, null, 8, [`item`, `index`])]), _: 1 }, 16, [`options`, `text-content`]), X2.value && Ze2.value === `bottom` ? (y(), w(c(q2), { key: 1 })) : O(``, true)], 64)) : (y(), p(b, { key: 1 }, [X2.value && Ze2.value === `top` ? (y(), w(c(U2).Group, { key: 0, "data-slot": `group`, class: d(J2.value.group({ class: (_c = c(H2)) == null ? void 0 : _c.group })) }, { default: x(() => [r(c(q2))]), _: 1 }, 8, [`class`])) : O(``, true), (y(true), p(b, null, m(Ye2.value, (e3, t2) => {
            var _a5;
            return y(), w(c(U2).Group, { key: `group-${t2}`, "data-slot": `group`, class: d(J2.value.group({ class: (_a5 = c(H2)) == null ? void 0 : _a5.group })) }, { default: x(() => [(y(true), p(b, null, m(e3, (e4, n3) => (y(), w(c(Ke2), { key: `group-${t2}-${n3}`, item: e4, index: n3 }, null, 8, [`item`, `index`]))), 128))]), _: 2 }, 1032, [`class`]);
          }), 128)), X2.value && Ze2.value === `bottom` ? (y(), w(c(U2).Group, { key: 1, "data-slot": `group`, class: d(J2.value.group({ class: (_d = c(H2)) == null ? void 0 : _d.group })) }, { default: x(() => [r(c(q2))]), _: 1 }, 8, [`class`])) : O(``, true)], 64))], 2), D(n2.$slots, `content-bottom`), e2.arrow ? (y(), w(c(U2).Arrow, g({ key: 0 }, be2.value, { "data-slot": `arrow`, class: J2.value.arrow({ class: (_e2 = c(H2)) == null ? void 0 : _e2.arrow }) }), null, 16, [`class`])) : O(``, true)];
        }), _: 3 }, 16, [`class`])];
      }), _: 3 }, 16)];
    }), _: 3 }, 16, [`name`, `disabled`, `class`, `as-child`])], 64);
  };

...
import { $n as t, D as n, E as r, Ht as i, Lt as a, On as o, St as s, Zn as c, _ as l, b as u, bt as d, ct as f, et as p, g as m, it as h, k as g, mt as _, o as v, qt as y, tr as b, v as x, vn as S, w as C, wn as w, wt as T, xn as E, xt as D, y as O, z as k } from "./runtime-core.esm-bundler-Twwq1XF8.js";
import { t as A } from "./runtime-dom.esm-bundler-Owfape5M.js";
import { i as ee, n as te, t as j, v as ne } from "./Tooltip-CPUUajce.js";
import { H as M, I as re, N, R as P, S as F, _ as ie, b as I, i as ae, m as oe, n as se, r as ce, t as L, v as R, x as le, y as z } from "./Button-DbU2pTtV.js";
import { v as ue, y as de } from "./dist-Bw8ba7To.js";
import { c as fe, l as pe, r as me, t as he } from "./dist-ChpmCc7n.js";
import { s as ge } from "./DashboardSidebarToggle-DwmriNl0.js";
import { d as _e, r as B, u as ve } from "./namespaced-CFCft_Em.js";
import { t as ye } from "./Tree-BzGN7kkJ.js";
import { n as be, r as V, t as xe } from "./useFileAction-D-vgsRpM.js";
import { t as Se } from "./Slideover-BcwYUYf1.js";
import { t as Ce } from "./Badge-amSaWZqG.js";
import { t as H } from "./settings-DsLgXECG.js";
import { t as we } from "./isObject-D2o2XD3m.js";
import { t as U } from "./debounce-yqYF8y1Y.js";
import { t as Te } from "./path-browserify-BXFVjck0.js";
import { a as W, c as G, i as Ee, n as K, r as De } from "./intellisense-BqSPmEm7.js";
import "./tailwindcss-CdApilZd.js";
import { t as q } from "./monaco.contribution-BFIRcy1x.js";
import { n as J, t as Oe } from "./DashboardNavbar-BmMVUB2G.js";
import { t as ke } from "./DashboardSidebarCollapse-_wrNpC08.js";
import { t as Y } from "./src-BpxGpK6s.js";
var Ae = `Expected a function`;
function je(e2, t2, n2) {
  var r2 = true, i2 = true;
  if (typeof e2 != `function`) throw TypeError(Ae);
  return we(n2) && (r2 = `leading` in n2 ? !!n2.leading : r2, i2 = `trailing` in n2 ? !!n2.trailing : i2), U(e2, t2, { leading: r2, maxWait: t2, trailing: i2 });
}
var Me = { __name: `ContextMenuContent`, props: { items: { type: null, required: false }, portal: { type: [Boolean, String], required: false, skipCheck: true }, sub: { type: Boolean, required: false }, labelKey: { type: null, required: true }, descriptionKey: { type: null, required: true }, checkedIcon: { type: null, required: false }, loadingIcon: { type: null, required: false }, externalIcon: { type: [Boolean, String], required: false, skipCheck: true }, class: { type: null, required: false }, ui: { type: null, required: true }, uiOverride: { type: null, required: false }, loop: { type: Boolean, required: false }, memoDependencies: { type: Array, required: false }, sideFlip: { type: Boolean, required: false }, alignOffset: { type: Number, required: false }, alignFlip: { type: Boolean, required: false }, avoidCollisions: { type: Boolean, required: false }, collisionBoundary: { type: null, required: false }, collisionPadding: { type: [Number, Object], required: false }, hideShiftedArrow: { type: Boolean, required: false }, sticky: { type: String, required: false }, hideWhenDetached: { type: Boolean, required: false }, positionStrategy: { type: String, required: false }, disableUpdateOnLayoutShift: { type: Boolean, required: false }, prioritizePosition: { type: Boolean, required: false }, reference: { type: null, required: false } }, emits: [`escapeKeyDown`, `pointerDownOutside`, `focusOutside`, `interactOutside`, `closeAutoFocus`], setup(e2, { emit: i2 }) {
  let s2 = e2, f2 = i2, h2 = a(), { dir: g2 } = ge(), S2 = M(), E2 = ee(w(() => s2.portal)), A2 = ne(ue(s2, `sub`, `items`, `portal`, `labelKey`, `descriptionKey`, `checkedIcon`, `loadingIcon`, `externalIcon`, `class`, `ui`, `uiOverride`), f2), j2 = () => P(h2, [`default`]), [F2, I2] = me(), L2 = m(() => g2.value === `rtl` ? S2.ui.icons.chevronLeft : S2.ui.icons.chevronRight), R2 = m(() => s2.items?.length ? re(s2.items) ? s2.items : [s2.items] : []);
  return (i3, a2) => (_(), u(v, null, [n(o(F2), null, { default: y(({ item: t2, active: a3, index: f3 }) => [D(i3.$slots, t2.slot || `item`, { item: t2, index: f3, ui: e2.ui }, () => [D(i3.$slots, t2.slot ? `${t2.slot}-leading` : `item-leading`, { item: t2, active: a3, index: f3, ui: e2.ui }, () => [t2.loading ? (_(), x(z, { key: 0, name: e2.loadingIcon || o(S2).ui.icons.loading, "data-slot": `itemLeadingIcon`, class: c(e2.ui.itemLeadingIcon({ class: [e2.uiOverride?.itemLeadingIcon, t2.ui?.itemLeadingIcon], color: t2?.color, loading: true })) }, null, 8, [`name`, `class`])) : t2.icon ? (_(), x(z, { key: 1, name: t2.icon, "data-slot": `itemLeadingIcon`, class: c(e2.ui.itemLeadingIcon({ class: [e2.uiOverride?.itemLeadingIcon, t2.ui?.itemLeadingIcon], color: t2?.color, active: a3 })) }, null, 8, [`name`, `class`])) : t2.avatar ? (_(), x(ie, p({ key: 2, size: t2.ui?.itemLeadingAvatarSize || e2.uiOverride?.itemLeadingAvatarSize || e2.ui.itemLeadingAvatarSize() }, t2.avatar, { "data-slot": `itemLeadingAvatar`, class: e2.ui.itemLeadingAvatar({ class: [e2.uiOverride?.itemLeadingAvatar, t2.ui?.itemLeadingAvatar], active: a3 }) }), null, 16, [`size`, `class`])) : O(``, true)]), o(N)(t2, s2.labelKey) || h2[t2.slot ? `${t2.slot}-label` : `item-label`] || o(N)(t2, s2.descriptionKey) || h2[t2.slot ? `${t2.slot}-description` : `item-description`] ? (_(), u(`span`, { key: 0, "data-slot": `itemWrapper`, class: c(e2.ui.itemWrapper({ class: [e2.uiOverride?.itemWrapper, t2.ui?.itemWrapper] })) }, [l(`span`, { "data-slot": `itemLabel`, class: c(e2.ui.itemLabel({ class: [e2.uiOverride?.itemLabel, t2.ui?.itemLabel], active: a3 })) }, [D(i3.$slots, t2.slot ? `${t2.slot}-label` : `item-label`, { item: t2, active: a3, index: f3 }, () => [r(b(o(N)(t2, s2.labelKey)), 1)]), t2.target === `_blank` && e2.externalIcon !== false ? (_(), x(z, { key: 0, name: typeof e2.externalIcon == `string` ? e2.externalIcon : o(S2).ui.icons.external, "data-slot": `itemLabelExternalIcon`, class: c(e2.ui.itemLabelExternalIcon({ class: [e2.uiOverride?.itemLabelExternalIcon, t2.ui?.itemLabelExternalIcon], color: t2?.color, active: a3 })) }, null, 8, [`name`, `class`])) : O(``, true)], 2), o(N)(t2, s2.descriptionKey) || h2[t2.slot ? `${t2.slot}-description` : `item-description`] ? (_(), u(`span`, { key: 0, "data-slot": `itemDescription`, class: c(e2.ui.itemDescription({ class: [e2.uiOverride?.itemDescription, t2.ui?.itemDescription] })) }, [D(i3.$slots, t2.slot ? `${t2.slot}-description` : `item-description`, { item: t2, active: a3, index: f3 }, () => [r(b(o(N)(t2, s2.descriptionKey)), 1)])], 2)) : O(``, true)], 2)) : O(``, true), l(`span`, { "data-slot": `itemTrailing`, class: c(e2.ui.itemTrailing({ class: [e2.uiOverride?.itemTrailing, t2.ui?.itemTrailing] })) }, [D(i3.$slots, t2.slot ? `${t2.slot}-trailing` : `item-trailing`, { item: t2, active: a3, index: f3, ui: e2.ui }, () => [t2.children?.length ? (_(), x(z, { key: 0, name: L2.value, "data-slot": `itemTrailingIcon`, class: c(e2.ui.itemTrailingIcon({ class: [e2.uiOverride?.itemTrailingIcon, t2.ui?.itemTrailingIcon], color: t2?.color, active: a3 })) }, null, 8, [`name`, `class`])) : t2.kbds?.length ? (_(), u(`span`, { key: 1, "data-slot": `itemTrailingKbds`, class: c(e2.ui.itemTrailingKbds({ class: [e2.uiOverride?.itemTrailingKbds, t2.ui?.itemTrailingKbds] })) }, [(_(true), u(v, null, d(t2.kbds, (n2, r2) => (_(), x(te, p({ key: r2, size: t2.ui?.itemTrailingKbdsSize || e2.uiOverride?.itemTrailingKbdsSize || e2.ui.itemTrailingKbdsSize() }, { ref_for: true }, typeof n2 == `string` ? { value: n2 } : n2), null, 16, [`size`]))), 128))], 2)) : O(``, true)]), n(o(B).ItemIndicator, { "as-child": `` }, { default: y(() => [n(z, { name: e2.checkedIcon || o(S2).ui.icons.check, "data-slot": `itemTrailingIcon`, class: c(e2.ui.itemTrailingIcon({ class: [e2.uiOverride?.itemTrailingIcon, t2.ui?.itemTrailingIcon], color: t2?.color })) }, null, 8, [`name`, `class`])]), _: 2 }, 1024)], 2)])]), _: 3 }), n(o(B).Portal, t(k(o(E2))), { default: y(() => [n(o(oe), null, { default: y(() => [(_(), x(T(e2.sub ? o(B).SubContent : o(B).Content), p({ "data-slot": `content`, class: e2.ui.content({ class: [e2.uiOverride?.content, s2.class] }) }, o(A2)), { default: y(() => [D(i3.$slots, `content-top`, { sub: e2.sub ?? false }), l(`div`, { role: `presentation`, "data-slot": `viewport`, class: c(e2.ui.viewport({ class: e2.uiOverride?.viewport })) }, [(_(true), u(v, null, d(R2.value, (t2, r2) => (_(), x(o(B).Group, { key: `group-${r2}`, "data-slot": `group`, class: c(e2.ui.group({ class: e2.uiOverride?.group })) }, { default: y(() => [(_(true), u(v, null, d(t2, (t3, a3) => (_(), u(v, { key: `group-${r2}-${a3}` }, [t3.type === `label` ? (_(), x(o(B).Label, { key: 0, "data-slot": `label`, class: c(e2.ui.label({ class: [e2.uiOverride?.label, t3.ui?.label, t3.class] })) }, { default: y(() => [n(o(I2), { item: t3, index: a3 }, null, 8, [`item`, `index`])]), _: 2 }, 1032, [`class`])) : t3.type === `separator` ? (_(), x(o(B).Separator, { key: 1, "data-slot": `separator`, class: c(e2.ui.separator({ class: [e2.uiOverride?.separator, t3.ui?.separator, t3.class] })) }, null, 8, [`class`])) : t3?.children?.length ? (_(), x(o(B).Sub, { key: 2, open: t3.open, "default-open": t3.defaultOpen }, { default: y(() => [n(o(B).SubTrigger, { as: `button`, type: `button`, disabled: t3.disabled, "text-value": o(N)(t3, s2.labelKey), "data-slot": `item`, class: c(e2.ui.item({ class: [e2.uiOverride?.item, t3.ui?.item, t3.class], color: t3?.color })) }, { default: y(() => [n(o(I2), { item: t3, index: a3 }, null, 8, [`item`, `index`])]), _: 2 }, 1032, [`disabled`, `text-value`, `class`]), n(Me, p({ sub: ``, class: t3.ui?.content, ui: e2.ui, "ui-override": e2.uiOverride, portal: e2.portal, items: t3.children, "align-offset": -4, "label-key": e2.labelKey, "description-key": e2.descriptionKey, "checked-icon": e2.checkedIcon, "loading-icon": e2.loadingIcon, "external-icon": e2.externalIcon }, { ref_for: true }, t3.content), C({ _: 2 }, [d(j2(), (e3, t4) => ({ name: t4, fn: y((e4) => [D(i3.$slots, t4, p({ ref_for: true }, e4))]) }))]), 1040, [`class`, `ui`, `ui-override`, `portal`, `items`, `label-key`, `description-key`, `checked-icon`, `loading-icon`, `external-icon`])]), _: 2 }, 1032, [`open`, `default-open`])) : t3.type === `checkbox` ? (_(), x(o(B).CheckboxItem, { key: 3, "model-value": t3.checked, disabled: t3.disabled, "text-value": o(N)(t3, s2.labelKey), "data-slot": `item`, class: c(e2.ui.item({ class: [e2.uiOverride?.item, t3.ui?.item, t3.class], color: t3?.color })), "onUpdate:modelValue": t3.onUpdateChecked, onSelect: t3.onSelect }, { default: y(() => [n(o(I2), { item: t3, index: a3 }, null, 8, [`item`, `index`])]), _: 2 }, 1032, [`model-value`, `disabled`, `text-value`, `class`, `onUpdate:modelValue`, `onSelect`])) : (_(), x(se, p({ key: 4, ref_for: true }, o(ae)(t3), { custom: `` }), { default: y(({ active: r3, ...i4 }) => [n(o(B).Item, { "as-child": ``, disabled: t3.disabled, "text-value": o(N)(t3, s2.labelKey), onSelect: t3.onSelect }, { default: y(() => [n(ce, p({ ref_for: true }, i4, { "data-slot": `item`, class: e2.ui.item({ class: [e2.uiOverride?.item, t3.ui?.item, t3.class], active: r3, color: t3?.color }) }), { default: y(() => [n(o(I2), { item: t3, active: r3, index: a3 }, null, 8, [`item`, `active`, `index`])]), _: 2 }, 1040, [`class`])]), _: 2 }, 1032, [`disabled`, `text-value`, `onSelect`])]), _: 2 }, 1040))], 64))), 128))]), _: 2 }, 1032, [`class`]))), 128))], 2), D(i3.$slots, `default`), D(i3.$slots, `content-bottom`, { sub: e2.sub ?? false })]), _: 3 }, 16, [`class`]))]), _: 3 })]), _: 3 }, 16)], 64));
} }, Ne = { slots: { content: `min-w-32 max-h-(--reka-context-menu-content-available-height) bg-default shadow-lg rounded-md ring ring-default overflow-hidden data-[state=open]:animate-[scale-in_100ms_ease-out] data-[state=closed]:animate-[scale-out_100ms_ease-in] origin-(--reka-context-menu-content-transform-origin) flex flex-col`, viewport: `relative divide-y divide-default scroll-py-1 overflow-y-auto flex-1`, group: `p-1 isolate`, label: `w-full flex items-center font-semibold text-highlighted`, separator: `-mx-1 my-1 h-px bg-border`, item: `group relative w-full flex items-start select-none outline-none before:absolute before:z-[-1] before:inset-px before:rounded-md data-disabled:cursor-not-allowed data-disabled:opacity-75`, itemLeadingIcon: `shrink-0`, itemLeadingAvatar: `shrink-0`, itemLeadingAvatarSize: ``, itemTrailing: `ms-auto inline-flex gap-1.5 items-center`, itemTrailingIcon: `shrink-0`, itemTrailingKbds: `hidden lg:inline-flex items-center shrink-0`, itemTrailingKbdsSize: ``, itemWrapper: `flex-1 flex flex-col text-start min-w-0`, itemLabel: `truncate`, itemDescription: `truncate text-muted`, itemLabelExternalIcon: `inline-block size-3 align-top text-dimmed` }, variants: { color: { primary: ``, secondary: ``, success: ``, info: ``, warning: ``, error: ``, neutral: `` }, active: { true: { item: `text-highlighted before:bg-elevated`, itemLeadingIcon: `text-default` }, false: { item: [`text-default data-highlighted:text-highlighted data-[state=open]:text-highlighted data-highlighted:before:bg-elevated/50 data-[state=open]:before:bg-elevated/50`, `transition-colors before:transition-colors`], itemLeadingIcon: [`text-dimmed group-data-highlighted:text-default group-data-[state=open]:text-default`, `transition-colors`] } }, loading: { true: { itemLeadingIcon: `animate-spin` } }, size: { xs: { label: `p-1 text-xs gap-1`, item: `p-1 text-xs gap-1`, itemLeadingIcon: `size-4`, itemLeadingAvatarSize: `3xs`, itemTrailingIcon: `size-4`, itemTrailingKbds: `gap-0.5`, itemTrailingKbdsSize: `sm` }, sm: { label: `p-1.5 text-xs gap-1.5`, item: `p-1.5 text-xs gap-1.5`, itemLeadingIcon: `size-4`, itemLeadingAvatarSize: `3xs`, itemTrailingIcon: `size-4`, itemTrailingKbds: `gap-0.5`, itemTrailingKbdsSize: `sm` }, md: { label: `p-1.5 text-sm gap-1.5`, item: `p-1.5 text-sm gap-1.5`, itemLeadingIcon: `size-5`, itemLeadingAvatarSize: `2xs`, itemTrailingIcon: `size-5`, itemTrailingKbds: `gap-0.5`, itemTrailingKbdsSize: `md` }, lg: { label: `p-2 text-sm gap-2`, item: `p-2 text-sm gap-2`, itemLeadingIcon: `size-5`, itemLeadingAvatarSize: `2xs`, itemTrailingIcon: `size-5`, itemTrailingKbds: `gap-1`, itemTrailingKbdsSize: `md` }, xl: { label: `p-2 text-base gap-2`, item: `p-2 text-base gap-2`, itemLeadingIcon: `size-6`, itemLeadingAvatarSize: `xs`, itemTrailingIcon: `size-6`, itemTrailingKbds: `gap-1`, itemTrailingKbdsSize: `lg` } } }, compoundVariants: [{ color: `primary`, active: false, class: { item: `text-primary data-highlighted:text-primary data-highlighted:before:bg-primary/10 data-[state=open]:before:bg-primary/10`, itemLeadingIcon: `text-primary/75 group-data-highlighted:text-primary group-data-[state=open]:text-primary` } }, { color: `secondary`, active: false, class: { item: `text-secondary data-highlighted:text-secondary data-highlighted:before:bg-secondary/10 data-[state=open]:before:bg-secondary/10`, itemLeadingIcon: `text-secondary/75 group-data-highlighted:text-secondary group-data-[state=open]:text-secondary` } }, { color: `success`, active: false, class: { item: `text-success data-highlighted:text-success data-highlighted:before:bg-success/10 data-[state=open]:before:bg-success/10`, itemLeadingIcon: `text-success/75 group-data-highlighted:text-success group-data-[state=open]:text-success` } }, { color: `info`, active: false, class: { item: `text-info data-highlighted:text-info data-highlighted:before:bg-info/10 data-[state=open]:before:bg-info/10`, itemLeadingIcon: `text-info/75 group-data-highlighted:text-info group-data-[state=open]:text-info` } }, { color: `warning`, active: false, class: { item: `text-warning data-highlighted:text-warning data-highlighted:before:bg-warning/10 data-[state=open]:before:bg-warning/10`, itemLeadingIcon: `text-warning/75 group-data-highlighted:text-warning group-data-[state=open]:text-warning` } }, { color: `error`, active: false, class: { item: `text-error data-highlighted:text-error data-highlighted:before:bg-error/10 data-[state=open]:before:bg-error/10`, itemLeadingIcon: `text-error/75 group-data-highlighted:text-error group-data-[state=open]:text-error` } }, { color: `primary`, active: true, class: { item: `text-primary before:bg-primary/10`, itemLeadingIcon: `text-primary` } }, { color: `secondary`, active: true, class: { item: `text-secondary before:bg-secondary/10`, itemLeadingIcon: `text-secondary` } }, { color: `success`, active: true, class: { item: `text-success before:bg-success/10`, itemLeadingIcon: `text-success` } }, { color: `info`, active: true, class: { item: `text-info before:bg-info/10`, itemLeadingIcon: `text-info` } }, { color: `warning`, active: true, class: { item: `text-warning before:bg-warning/10`, itemLeadingIcon: `text-warning` } }, { color: `error`, active: true, class: { item: `text-error before:bg-error/10`, itemLeadingIcon: `text-error` } }], defaultVariants: { size: `md` } }, Pe = { __name: `ContextMenu`, props: { size: { type: null, required: false }, items: { type: null, required: false }, checkedIcon: { type: null, required: false }, loadingIcon: { type: null, required: false }, externalIcon: { type: [Boolean, String], required: false, skipCheck: true, default: true }, content: { type: Object, required: false }, portal: { type: [Boolean, String], required: false, skipCheck: true, default: true }, labelKey: { type: null, required: false, default: `label` }, descriptionKey: { type: null, required: false, default: `description` }, disabled: { type: Boolean, required: false }, class: { type: null, required: false }, ui: { type: Object, required: false }, pressOpenDelay: { type: Number, required: false }, modal: { type: Boolean, required: false, default: true } }, emits: [`update:open`], setup(e2, { emit: r2 }) {
  let i2 = e2, s2 = r2, l2 = a(), u2 = F(`contextMenu`, i2), f2 = M(), h2 = le(de(u2, `modal`), s2), g2 = w(() => u2.content), v2 = () => P(l2, [`default`]), b2 = m(() => I({ extend: Ne, ...f2.ui?.contextMenu || {} })({ size: u2.size }));
  return (e3, r3) => (_(), x(o(_e), t(k(o(h2))), { default: y(() => [l2.default ? (_(), x(o(ve), { key: 0, "as-child": ``, disabled: o(u2).disabled, class: c(o(u2).class) }, { default: y(() => [D(e3.$slots, `default`)]), _: 3 }, 8, [`disabled`, `class`])) : O(``, true), n(Me, p({ class: b2.value.content({ class: [!l2.default && o(u2).class, o(u2).ui?.content] }), ui: b2.value, "ui-override": o(u2).ui }, g2.value, { items: o(u2).items, portal: o(u2).portal, "label-key": o(u2).labelKey, "description-key": o(u2).descriptionKey, "checked-icon": o(u2).checkedIcon, "loading-icon": o(u2).loadingIcon, "external-icon": o(u2).externalIcon }), C({ _: 2 }, [d(v2(), (n2, r4) => ({ name: r4, fn: y((n3) => [D(e3.$slots, r4, t(k(n3)))]) }))]), 1040, [`class`, `ui`, `ui-override`, `items`, `portal`, `label-key`, `description-key`, `checked-icon`, `loading-icon`, `external-icon`])]), _: 3 }, 16));
} }, X = e(Te(), 1), Fe = { class: `overflow-y-auto divide-y divide-(--ui-border)` }, Ie = { class: `flex items-center gap-1.5 w-full` }, Le = g({ __name: `FileExplorer`, emits: [`delete`, `rename`, `reset`], setup(e2, { emit: t2 }) {
  ...
  return f(() => {
    ...
    return _(), u(`div`, Fe, [n(f2, { items: h2.value, modelValue: d2.value, "onUpdate:modelValue": t3[0] || (t3[0] = (e4) => d2.value = e4), "get-key": (e4) => e4.value ?? e4.label }, { "tree-file": y(({ item: e4 }) => [n(a3, { items: [{ label: `Reset`, icon: `lucide:file-minus-2`, disabled: e4.entry.relative_path !== `main.css` && !(Number(o(s2).virtualOptions(`general.tailwindcss.version`, 4).value) === 4 && e4.entry.relative_path === `wizard.css`), onSelect: () => {
      ...
      c2(`delete`, e4.entry);
    } }] }, { default: y(() => [l(`div`, Ie, [e4.icon ? (_(), x(i2, { key: 0, name: e4.icon, class: `shrink-0 size-5` }, null, 8, [`name`])) : O(``, true), r(` ` + b(e4.label), 1)])]), _: 2 }, 1032, [`items`])]), _: 1 }, 8, [`items`, `modelValue`, `get-key`])]);
  };
} }), Re = { $schema: `https://schemas.wp.org/trunk/theme.json`, version: 3, settings: { color: {}, typography: {}, border: {}, shadow: {}, spacing: {} } }, Z = { COLOR: `--color-`, FONT_FAMILY: `--font-`, FONT_SIZE: `--text-`, BORDER_RADIUS: `--radius-`, SHADOW: `--shadow-`, INSET_SHADOW: `--inset-shadow-`, DROP_SHADOW: `--drop-shadow-`, SPACING: `--spacing-` }, ze = [`feature-settings`, `variation-settings`, `family`, `size`, `smoothing`, `style`, `weight`, `stretch`], Be = [`line-height`, `letter-spacing`, `font-weight`, `shadow`];
function Q(e2) {
...
function We(e2, t2) {
  ...
  return Ve(n2, ze) ? { name: Q(n2), slug: $(n2), fontFamily: t2.trim().replace(/['"]/g, ``) } : null;
}
function Ge(e2, t2) {
  let n2 = e2.replace(Z.FONT_SIZE, ``);
  return Ve(n2, Be) ? { name: Q(n2), slug: $(n2), size: t2.trim() } : null;
}
function Ke(e2, t2) {
...
function Ye(e2) {
  let t2 = { ...Re, settings: { color: { palette: [] }, typography: { fontSizes: [], fontFamilies: [] }, border: { radiusSizes: [] }, shadow: { presets: [] }, spacing: { spacingSizes: [] } } };
  ...
  }), t2.settings.typography.fontSizes = He(t2.settings.typography.fontSizes), t2;
}
var Xe = { class: `text-xs opacity-60 font-normal` }, Ze = { class: `flex-1 overflow-y-auto relative` }, Qe = { key: 0, class: `absolute bottom-5 left-5 z-50` }, $e = { key: `panel`, class: `bg-(--ui-bg)/30 backdrop-blur-md border border-error/20 rounded-lg p-4 shadow-xl min-w-80 max-w-96 origin-bottom-left` }, et = { class: `flex items-start gap-3` }, tt = { class: `flex-1` }, nt = { class: `flex items-center justify-between mb-2` }, rt = { class: `font-medium text-error text-sm` }, it = { class: `text-sm mb-2` }, at = { key: 0, class: `text-xs text-muted` }, ot = g({ __name: `FileEditor`, props: { entry: {} }, emits: [`close`, `save`, `delete`, `reset`], setup(e2, { emit: t2 }) {
  let i2 = V(), a2 = H(), c2 = pe(), d2 = be(), f2 = e2, p2 = t2, m2 = { automaticLayout: true, formatOnType: false, formatOnPaste: false, fontSize: 14 }, g2 = E(), v2 = S(false), C2 = S([]), w2 = null, T2 = /* @__PURE__ */ new Set(), D2 = S({ hasErrors: false, errors: [] }), k2 = S(false);
  async function ee2(e3, t3) {
    if (g2.value = e3, v2.value = true, Number(a2.virtualOptions(`general.tailwindcss.version`, 4).value) === 4) {
      let n2 = null, r2 = null, a3 = 0, o2 = 3e4, s2 = async () => {
        ...
        try {
          let e4 = await G({ volume: i2.getKVEntries() }), t4 = await Ee(e4);
          n2 = { designSystem: e4, variablesList: t4, classList: De(e4) };
          let r3 = Ye(t4);
          d2.themeJson = r3, a3 = Date.now();
        } catch (e4) {
        ...
        try {
          ...
          let t4 = { message: e4.message || `Unknown CSS error`, line: e4.line, column: e4.column, file: e4.input?.from || `main.css` };
          D2.value = { hasErrors: true, errors: [t4] };
        }
...
`), o4 = null;
  ...
  return h(() => {
    ...
    let h2 = L, g3 = j, v3 = z, S2 = Ce, C3 = R, w3 = Oe, T3 = s(`vue-monaco-editor`), E2 = J;
    return _(), x(E2, { id: `explorer-2`, class: `min-h-[calc(100svh-var(--wp-admin--admin-bar--height))]` }, { default: y(() => [n(w3, { title: e2.entry?.relative_path, toggle: false, ui: { title: `text-sm` } }, { leading: y(() => [n(g3, { text: t3.i18n.__(`Close`, `windpress`) }, { default: y(() => [n(h2, { icon: `i-lucide-x`, color: `neutral`, variant: `ghost`, class: `-ms-1.5`, onClick: d3[0] || (d3[0] = (e3) => p2(`close`)) })]), _: 1 }, 8, [`text`])]), title: y(() => [n(v3, { name: `vscode-icons:file-type-${e2.entry?.relative_path === `main.css` ? `tailwind` : o(X.default).extname(e2.entry?.relative_path ?? ``).replace(`.`, ``)}`, class: `size-5` }, null, 8, [`name`]), r(` ` + b(e2.entry?.relative_path) + ` `, 1), f2.entry.readonly ? (_(), x(S2, { key: 0, label: t3.i18n.__(`read-only`, `windpress`), color: `warning`, variant: `outline` }, null, 8, [`label`])) : O(``, true), e2.entry?.path_on_disk ? (_(), x(g3, { key: 1, text: `${t3.i18n.__(`Path on disk`, `windpress`)}: ${e2.entry?.path_on_disk}` }, { default: y(() => [l(`span`, Xe, [d3[8] || (d3[8] = r(` [ `, -1)), n(v3, { name: `i-lucide-hard-drive`, class: `inline-block align-middle me-1` }), r(` ` + b(e2.entry?.path_on_disk) + ` ] `, 1)])]), _: 1 }, 8, [`text`])) : O(``, true)]), right: y(() => [e2.entry?.relative_path !== `main.css` && !(Number(o(a2).virtualOptions(`general.tailwindcss.version`, 4).value) === 3 && (e2.entry?.relative_path === `tailwind.config.js` || e2.entry?.relative_path === `wizard.js`)) ? (_(), x(g3, { key: 0, text: t3.i18n.__(`Delete`, `windpress`) }, { default: y(() => [n(h2, { icon: `i-lucide-trash`, color: `neutral`, variant: `ghost`, onClick: d3[1] || (d3[1] = (t4) => p2(`delete`, e2.entry)) })]), _: 1 }, 8, [`text`])) : O(``, true), e2.entry?.relative_path === `main.css` || e2.entry?.relative_path === `wizard.css` || Number(o(a2).virtualOptions(`general.tailwindcss.version`, 4).value) === 3 && (e2.entry?.relative_path === `tailwind.config.js` || e2.entry?.relative_path === `wizard.js`) ? (_(), x(g3, { key: 1, text: t3.i18n.__(`Reset to default`, `windpress`) }, { default: y(() => [n(h2, { icon: `lucide:file-minus-2`, color: `neutral`, variant: `ghost`, onClick: d3[2] || (d3[2] = (t4) => p2(`reset`, e2.entry)) })]), _: 1 }, 8, [`text`])) : O(``, true), n(g3, { text: t3.i18n.__(`Save`, `windpress`) }, { default: y(() => [o(i2).entryHasChanged(e2.entry?.relative_path) ? (_(), x(C3, { key: 0, color: `warning`, size: `md` }, { default: y(() => [n(h2, { icon: `i-lucide-save`, color: `primary`, variant: `subtle`, onClick: d3[3] || (d3[3] = (e3) => p2(`save`)) })]), _: 1 })) : (_(), x(h2, { key: 1, icon: `i-lucide-save`, color: `primary`, variant: `subtle`, onClick: d3[4] || (d3[4] = (e3) => p2(`save`)) }))]), _: 1 }, 8, [`text`])]), _: 1 }, 8, [`title`]), l(`div`, Ze, [n(A, { "enter-active-class": `transition-all duration-500 ease-out`, "leave-active-class": `transition-all duration-300 ease-in`, "enter-from-class": `scale-50 opacity-0 translate-y-4`, "enter-to-class": `scale-100 opacity-100 translate-y-0`, "leave-from-class": `scale-100 opacity-100 translate-y-0`, "leave-to-class": `scale-50 opacity-0 translate-y-4` }, { default: y(() => [D2.value.hasErrors ? (_(), u(`div`, Qe, [n(A, { "enter-active-class": `transition-all duration-300 ease-out`, "leave-active-class": `transition-all duration-200 ease-in`, "enter-from-class": `scale-75 opacity-0`, "enter-to-class": `scale-100 opacity-100`, "leave-from-class": `scale-100 opacity-100`, "leave-to-class": `scale-75 opacity-0`, mode: `out-in` }, { default: y(() => [k2.value ? (_(), u(`div`, $e, [l(`div`, et, [n(v3, { name: `lucide:alert-triangle`, class: `size-4 text-error mt-0.5 flex-shrink-0` }), l(`div`, tt, [l(`div`, nt, [l(`p`, rt, b(t3.i18n.__(`CSS Validation Error`, `windpress`)), 1), n(h2, { variant: `ghost`, size: `xs`, icon: `i-lucide-x`, color: `neutral`, onClick: d3[6] || (d3[6] = (e3) => k2.value = false) })]), l(`p`, it, b(D2.value.errors[0]?.message), 1), D2.value.errors[0]?.line ? (_(), u(`div`, at, b(t3.i18n.__(`Line`, `windpress`)) + ` ` + b(D2.value.errors[0].line) + b(D2.value.errors[0]?.column ? `, ${t3.i18n.__(`Column`, `windpress`)} ${D2.value.errors[0].column}` : ``), 1)) : O(``, true)])])])) : (_(), u(`div`, { key: `icon`, class: `bg-(--ui-bg)/30 backdrop-blur-md border border-error/20 rounded-lg p-3 shadow-xl hover:scale-110 transition-transform origin-bottom-left cursor-pointer`, onClick: d3[5] || (d3[5] = (e3) => k2.value = true) }, [n(v3, { name: `lucide:alert-triangle`, class: `size-4 text-error flex-shrink-0` })]))]), _: 1 })])) : O(``, true)]), _: 1 }), n(T3, { value: f2.entry.content, "onUpdate:value": d3[7] || (d3[7] = (e3) => f2.entry.content = e3), language: f2.entry.relative_path.endsWith(`.css`) ? `css` : `javascript`, saveViewState: false, options: { ...m2, readOnly: f2.entry.readonly }, onMount: ee2, theme: o(c2) === `dark` ? `vs-dark` : `vs` }, null, 8, [`value`, `language`, `options`, `theme`])])]), _: 1 });
  };
} }), st = { key: 1, class: `hidden lg:flex flex-1 items-center justify-center` }, ct = g({ __name: `File`, setup(e2) {
  let t2 = V(), r2 = xe(), i2 = S(null), a2 = m({ get() {
    return !!t2.activeViewEntryRelativePath;
  }, set(e3) {
    e3 || (t2.activeViewEntryRelativePath = null);
  } }), s2 = m(() => t2.data.entries.find((e3) => e3.relative_path === t2.activeViewEntryRelativePath) || (console.error(wp.i18n.__(`Entry not found: `, `windpress`), t2.activeViewEntryRelativePath), t2.activeViewEntryRelativePath = `main.css`, t2.data.entries.find((e3) => e3.relative_path === t2.activeViewEntryRelativePath))), c2 = fe(he).smaller(`lg`);
  return (e3, d2) => {
    let f2 = ke, p2 = L, m2 = j, h2 = Oe, g2 = J, b2 = z, S2 = Se;
    return _(), u(v, null, [n(g2, { id: `explorer-1`, "default-size": 25, "min-size": 20, "max-size": 30, resizable: ``, class: `min-h-[calc(100svh-var(--wp-admin--admin-bar--height))]` }, { default: y(() => [n(h2, { title: e3.i18n.__(`Explorer`, `windpress`), class: `text-sm` }, { leading: y(() => [n(f2)]), right: y(() => [n(m2, { "delay-duration": 0, text: e3.i18n.__(`Add new file`, `windpress`) }, { default: y(() => [n(p2, { color: `primary`, variant: `subtle`, icon: `i-lucide-plus`, onClick: d2[0] || (d2[0] = (e4) => o(r2).addNewFile()) })]), _: 1 }, 8, [`text`]), n(m2, { "delay-duration": 0, text: e3.i18n.__(`Export SFS volume`, `windpress`) }, { default: y(() => [n(p2, { color: `neutral`, variant: `outline`, icon: `i-lucide-download`, onClick: d2[1] || (d2[1] = (e4) => o(r2).exportVolume()) })]), _: 1 }, 8, [`text`]), n(m2, { "delay-duration": 0, text: e3.i18n.__(`Import SFS volume`, `windpress`) }, { default: y(() => [n(p2, { color: `neutral`, variant: `outline`, icon: `i-lucide-upload`, onClick: d2[2] || (d2[2] = (e4) => i2.value?.click()) }), l(`input`, { ref_key: `importFileField`, ref: i2, type: `file`, onChange: d2[3] || (d2[3] = (...e4) => o(r2).importVolume && o(r2).importVolume(...e4)), style: { display: `none` }, accept: `.windpress` }, null, 544)]), _: 1 }, 8, [`text`])]), _: 1 }, 8, [`title`]), n(Le, { onRename: d2[4] || (d2[4] = (e4) => o(r2).renameFile(e4)), onDelete: d2[5] || (d2[5] = (e4) => o(r2).deleteFile(e4)), onReset: d2[6] || (d2[6] = (e4) => o(r2).resetFile(e4)) })]), _: 1 }), o(t2).activeViewEntryRelativePath ? (_(), x(ot, { key: 0, onClose: d2[7] || (d2[7] = (e4) => o(t2).activeViewEntryRelativePath = null), entry: s2.value, onDelete: d2[8] || (d2[8] = (e4) => o(r2).deleteFile(e4)), onSave: d2[9] || (d2[9] = (e4) => o(r2).save()), onReset: d2[10] || (d2[10] = (e4) => o(r2).resetFile(e4)) }, null, 8, [`entry`])) : (_(), u(`div`, st, [n(b2, { name: `lucide:file-pen`, class: `size-32 text-(--ui-text-dimmed)` })])), o(c2) ? (_(), x(S2, { key: 2, open: a2.value, "onUpdate:open": d2[11] || (d2[11] = (e4) => a2.value = e4) }, { content: y(() => [n(Le)]), _: 1 }, 8, [`open`])) : O(``, true)], 64);
  };
} });
export {
  ct as default

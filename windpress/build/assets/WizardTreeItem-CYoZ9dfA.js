...
import { D as t, Ut as n, Zn as r, _ as i, b as a, g as o, k as s, mt as c, qt as l, tr as u, v as d, vn as f, w as p, xt as m, y as h } from "./runtime-core.esm-bundler-CahM68iJ.js";
import { c as g } from "./vue.runtime.esm-bundler-B0iyRCM8.js";
import { t as _, v } from "./Button-DpvhuBJO.js";
import { o as y } from "./dist-BKF-Yqo1.js";
import { t as ee } from "./DropdownMenu-BEraqKHF.js";
import { t as te } from "./Input-CpPafee7.js";
...
function ne(e2, t2) {
  ...
  function a2() {
    try {
      let r3 = (e3) => {
        var _a;
        if (!((_a = e3.var) == null ? void 0 : _a.key)) return null;
  ...
  function d2(e3, t3, r3) {
    ...
    if (o2 && o2.children) {
      let e4 = (_a = o2.children) == null ? void 0 : _a.indexOf(a3);
...
function le(e2) {
  ...
  return n2 ? T(n2) ? r2 ?? null : n2 : null;
}
function E(e2) {
...
function ye(e2) {
  ...
  n2.setAttribute(ce, `true`);
  var r2 = M({ client: t2 });
  Object.assign(n2.style, pe(pe({ backgroundColor: `transparent`, position: `fixed`, padding: 0, margin: 0, boxSizing: `border-box` }, N({ clientRect: r2 })), {}, { pointerEvents: `auto`, zIndex: fe })), document.body.appendChild(n2);
  var i2 = (0, O.bind)(window, { type: `pointermove`, listener: function(e3) {
  ...
  return function(e3) {
    ...
    var o2 = (0, O.bindAll)(window, [{ type: `pointerdown`, listener: a2 }, { type: `pointermove`, listener: a2 }, { type: `focusin`, listener: a2 }, { type: `focusout`, listener: a2 }, { type: `dragstart`, listener: a2 }, { type: `dragenter`, listener: a2 }, { type: `dragover`, listener: a2 }], { capture: true });
  };
}
function be() {
  var e2 = null;
  function t2() {
    return e2 = null, (0, O.bind)(window, { type: `pointermove`, listener: function(t3) {
...
(function() {
  ...
  (0, O.bindAll)(window, [{ type: `dragstart`, listener: function() {
...
function Oe(e2) {
  ...
  return n2 === `dragleave` ? I() ? Te({ dragLeave: t2 }) : r2 == null ? true : we() ? De(r2) : r2 instanceof HTMLIFrameElement : false;
}
function ke(e2) {
  var t2 = e2.onDragEnd;
...
function Ne(e2) {
  ...
  function l2(e3) {
    var t3 = R(e3), i3 = r2({ target: T(e3.target) ? le({ x: t3.clientX, y: t3.clientY }) : e3.target, input: t3, source: n2.payload, current: o2.current.dropTargets });
  ...
  var f2 = (0, O.bindAll)(window, [{ type: `dragover`, listener: function(e3) {
  ...
  } }].concat(P(ke({ onDragEnd: u2 }))), { capture: true });
...
var W = { canStart: H, start: Ne }, G = /* @__PURE__ */ new Map();
function Fe(e2) {
...
function ze(e2) {
  ...
  function c2(e3) {
    ...
    var p2 = ((_a = d3.getData) == null ? void 0 : _a.call(d3, f3)) ?? {}, m2 = ((_b = d3.getDropEffect) == null ? void 0 : _b.call(d3, f3)) ?? n2, h2 = { data: p2, element: d3.element, dropEffect: m2, isActiveDueToStickiness: false };
  ...
  function f2(e3) {
    ...
    for (var s3 = Z(a3), l3 = Z(o3), u3 = [], d3 = 0; d3 < s3.length; d3++) {
      ...
      if ((h2 == null ? void 0 : h2.element) !== (g2 == null ? void 0 : g2.element)) break;
...
}), Je = `pdnd:android-fallback`, Ye = `text/plain`, Xe = `application/vnd.pdnd`, Q = /* @__PURE__ */ new WeakMap();
function Ze(e2) {
  return Q.set(e2.element, e2), function() {
    Q.delete(e2.element);
  };
}
var Qe = be(), $ = Ke({ typeKey: `element`, defaultDropEffect: `move`, mount: function(e2) {
  return K(Qe.bindEvents(), (0, O.bind)(document, { type: `dragstart`, listener: function(t2) {
    var _a, _b;
    if (e2.canStart(t2) && !t2.defaultPrevented && t2.dataTransfer) {
      ...
      if (n2 instanceof HTMLElement) {
        ...
        if (r2) {
          ...
          if (r2.dragHandle) {
            var o2 = le({ x: i2.clientX, y: i2.clientY });
          ...
          if (s2) for (var c2 = 0, l2 = Object.entries(s2); c2 < l2.length; c2++) {
            var u2 = C(l2[c2], 2), d2 = u2[0], f2 = u2[1];
          ...
          var p2 = { type: `element`, payload: { element: r2.element, dragHandle: r2.dragHandle ?? null, data: ((_b = r2.getInitialData) == null ? void 0 : _b.call(r2, a2)) ?? {} }, startedFrom: `internal` };
...
}, onPostDispatch: Qe.getOnPostDispatch() }), $e = $.dropTarget, et = $.monitor;
function tt(e2) {
  return F(K($.registerUsage(), Ze(e2), q(e2.element, { attribute: `draggable`, value: `true` })));
}
function nt(e2, t2, r2) {
  ...
  return n((e3) => {
    ...
    let t3 = K(et({ onDragStart({ source: e4 }) {
      i2.value = e4.data.id;
    }, onDrop(e4) {
      let { location: t4, source: n2 } = e4;
...
var rt = { key: 2, class: `absolute text-primary bg-primary/30 backdrop-blur-md px-4 py-2 rounded-lg pointer-events-none top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 font-medium whitespace-nowrap z-10 transition-all duration-150 ease-out` }, it = s({ __name: `DraggableTreeItem`, props: { item: {}, level: {}, hasChildren: { type: Boolean }, isLast: { type: Boolean }, isDescendantOf: { type: Function }, onDelete: { type: Function } }, setup(e2) {
  function t2(e3, t3) {
  ...
  return n((e3) => {
    ...
    let f2 = K(tt({ element: c2, getInitialData: () => a2, onGenerateDragPreview: ({ nativeSetDragImage: e4 }) => {
      var _a;
      if (e4) {
        ...
        if (n3.className = `m-0 py-2 px-0 [&_*]:!bg-default [&_*]:!text-highlighted`, t3.appendChild(n3), s2.hasChildren && ((_a = s2.item.children) == null ? void 0 : _a.length)) {
    ...
    e3(() => f2());
  }), (e3, t3) => (c(), a(`div`, { ref_key: `outerDropZoneRef`, ref: l2, class: r([`relative w-full px-2.5 py-1.5 transition-all duration-200 ease-out`, { "bg-elevated": g2.value }]), onKeydown: v2, tabindex: `0` }, [_2.value ? (c(), a(`div`, { key: 0, class: r([`absolute pointer-events-none border-primary transition-all duration-150 ease-out`, { "!border-b-2 -bottom-px left-1 right-0": _2.value.type === `reorder-below`, "!border-t-2 -top-px left-1 right-0": _2.value.type === `reorder-above`, "!border-2 rounded top-0 bottom-0 bg-primary/10 w-full -left-px": _2.value.type === `make-child` }]) }, null, 2)) : h(``, true), _2.value && (_2.value.type === `reorder-below` || _2.value.type === `reorder-above`) ? (c(), a(`div`, { key: 1, class: r([`absolute pointer-events-none w-2 h-2 border-2 border-primary bg-transparent rounded-full -left-1 z-10 transition-all duration-150 ease-out`, { "-bottom-1": _2.value.type === `reorder-below`, "-top-1": _2.value.type === `reorder-above` }]) }, null, 2)) : h(``, true), _2.value && _2.value.type === `make-child` ? (c(), a(`div`, rt, ` Drop to nest inside `)) : h(``, true), i(`div`, { ref_key: `dropZoneRef`, ref: u2, class: `relative w-full transition-all duration-200 ease-out` }, [i(`div`, { ref_key: `draggableRef`, ref: d2, class: r([`relative w-full py-4 transition-all duration-200 ease-out`, { "is-being-dragged": p2.value }]) }, [m(e3.$slots, `default`)], 2)], 512)], 34));
} }), at = { class: `flex items-center gap-2 w-full` }, ot = { class: `drag-and-drop-handler bg-elevated rounded p-1 hover:bg-accented cursor-grab` }, st = { class: `pointer-events-none absolute left-0 -top-2.5 text-highlighted text-xs font-medium px-1.5 transition-all peer-focus:-top-2.5 peer-focus:text-highlighted peer-focus:text-xs peer-focus:font-medium peer-placeholder-shown:text-sm peer-placeholder-shown:text-dimmed peer-placeholder-shown:top-1.5 peer-placeholder-shown:font-normal` }, ct = { class: `inline-flex bg-default px-1` }, lt = { class: `w-full` }, ut = { class: `inline-flex bg-default px-1` }, dt = s({ __name: `WizardTreeItem`, props: { item: {}, level: {}, shouldBeDimmed: { type: Function }, wasRecentlyMoved: { type: Function }, isDescendantOf: { type: Function }, onAddNext: { type: Function }, onAddChild: { type: Function }, onDelete: { type: Function } }, setup(e2) {
  function n2(e3) {
    e3.stopPropagation(), e3.stopImmediatePropagation();
  }
  return (a2, o2) => {
    let s2 = v, f2 = te, h2 = _, y2 = ee;
    return c(), d(it, { item: e2.item, level: e2.level, "has-children": !!(e2.item.children && e2.item.children.length > 0), "is-last": false, "is-descendant-of": e2.isDescendantOf, "on-delete": e2.onDelete, class: r([{ "opacity-30": e2.shouldBeDimmed(e2.item.value || ``), "ring-2 ring-primary ring-offset-2 bg-primary/5": e2.wasRecentlyMoved(e2.item.value || ``) }, `transition-all duration-300 ease-out rounded-lg`]) }, { default: l(() => [i(`div`, at, [i(`div`, ot, [t(s2, { name: `lucide:grip-vertical`, class: `size-4 text-dimmed` })]), m(a2.$slots, `leading`, { item: e2.item }), i(`div`, null, [t(f2, { modelValue: e2.item.var.key, "onUpdate:modelValue": [o2[0] || (o2[0] = (t2) => e2.item.var.key = t2), o2[1] || (o2[1] = (t2) => {
      let n3 = t2.replace(/[^a-zA-Z0-9\\-_]/g, ``);
      e2.item.var.key = n3;
    })], onKeydown: [g(n2, [`left`]), g(n2, [`right`])], placeholder: ``, ui: { base: `peer` } }, { default: l(() => [i(`label`, st, [i(`span`, ct, u(a2.i18n.__(`Name`)), 1)])]), _: 1 }, 8, [`modelValue`])]), m(a2.$slots, `before-value`, { item: e2.item }), i(`div`, lt, [t(f2, { modelValue: e2.item.var.value, "onUpdate:modelValue": [o2[2] || (o2[2] = (t2) => e2.item.var.value = t2), o2[3] || (o2[3] = (t2) => {
      e2.item.var.value = t2;
    })], onKeydown: [g(n2, [`left`]), g(n2, [`right`])], placeholder: ``, ui: { base: `peer`, root: `block` } }, p({ default: l(() => [i(`label`, { class: r([`pointer-events-none absolute left-0 -top-2.5 text-highlighted text-xs font-medium px-1.5 transition-all peer-focus:-top-2.5 peer-focus:text-highlighted peer-focus:text-xs peer-focus:font-medium peer-placeholder-shown:text-sm peer-placeholder-shown:text-dimmed peer-placeholder-shown:top-1.5 peer-placeholder-shown:font-normal`, { "peer-placeholder-shown:ps-9 peer-focus:ps-1.5": a2.$slots[`value-leading`] }]) }, [i(`span`, ut, u(a2.i18n.__(`Value`)), 1)], 2)]), _: 2 }, [a2.$slots[`value-leading`] ? { name: `leading`, fn: l(() => [m(a2.$slots, `value-leading`, { item: e2.item })]), key: `0` } : void 0]), 1032, [`modelValue`])]), i(`div`, null, [t(y2, { items: [{ label: a2.i18n.__(`Add (next)`, `windpress`), icon: `i-lucide-plus`, onSelect() {

...
import { __tla as __tla_0 } from "./cssesc-D57kXlof.js";
import "./build-BOfldFz1.js";
import "./vfs-DziqLF6T.js";
import "./intellisense-B03cqEsw.js";
let l, c, Je;
let __tla = Promise.all([
  ...
  c = async function(e2) {
    if (!o) return s || (s = (async () => {
      try {
        let t2 = await n(() => import("./oxide_parser-BOBx97C4-DHRjwz66.js").then(async (m2) => {
          await m2.__tla;
          return m2;
        }), [], import.meta.url);

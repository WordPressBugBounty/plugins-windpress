import { En as e, Ht as t, b as n, bt as r, et as i, g as a, k as o, mt as s, o as c, v as l, vn as u, y as d } from "./runtime-core.esm-bundler-CahM68iJ.js";
import { o as f } from "./dist-BKF-Yqo1.js";
import { d as p } from "./Tooltip-CZRNrufK.js";
function m(t2) {
  return a(() => {
    var _a;
    return e(t2) ? !!((_a = f(t2)) == null ? void 0 : _a.closest(`form`)) : true;
  });
}
function h() {
  let e2 = u();
  return { primitiveElement: e2, currentElement: a(() => {
    var _a, _b;
    return [`#text`, `#comment`].includes((_a = e2.value) == null ? void 0 : _a.$el.nodeName) ? (_b = e2.value) == null ? void 0 : _b.$el.nextElementSibling : f(e2);
  }) };
}

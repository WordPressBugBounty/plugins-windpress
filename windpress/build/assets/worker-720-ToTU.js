  ...
  async function pn(s2 = {}) {
    ...
    if (u2.tailwindcss_version === 4) {
      let { compile: e2, getCandidates: t2, optimize: n2, loadSource: r2 } = await i(async () => {
        let { compile: e3, getCandidates: t3, optimize: n3, loadSource: r3 } = await import("./tailwindcss-D5PR858z.js").then(async (m3) => {
          await m3.__tla;
          return m3;
        });
        return {
      ...
      let { build: e2, optimize: t2 } = await i(async () => {
        let { build: e3, optimize: t3 } = await import("./tailwindcss-v3-CqFyqBkz.js").then(async (m3) => {
          await m3.__tla;
          return m3;
        });
        return {

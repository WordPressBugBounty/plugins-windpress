...
import { Ht as t, tt as n, vn as r } from "./runtime-core.esm-bundler-CahM68iJ.js";
import { t as i } from "./debounce-2SSeCGpK.js";
import { t as a } from "./preload-helper-Cb81DA_d.js";
import { t as o } from "./logger-BvowV9fY.js";
import { n as s, t as c } from "./tippy.esm-C6S0S-or.js";
import { n as l, t as u } from "./dist-CPjYssU5.js";
import { n as d, t as f } from "./highlight-in-textarea-DSKu_7Fz.js";
import { t as p } from "./tribute.min-BObELRP9.js";
import { a as m, i as h, n as g, r as _ } from "./constant-B8yb_wxs.js";
(async () => {
  var v = e(p(), 1), y = null;
  (async () => {
    y = await l({
...
`).querySelector(`#windpressbricks-plc-class-down`);
  ...
  k.events.callbacks = function() {
    ...
    (e2[0] !== t2[0] || e2[2] !== t2[2]) && n(() => {
      if (e2[0].length > 0) {
        let t3 = e2[0].map((e3) => {
          var _a, _b, _c, _d, _e;
          return g.$_state.activeComponent ? ((_c = (_b = (_a = g.$_state.components.find((e4) => e4.id === g.$_state.activeComponent.id)) == null ? void 0 : _a.elements.find((t4) => t4.id === e3)) == null ? void 0 : _b.settings) == null ? void 0 : _c._cssClasses) || `` : ((_e = (_d = g.$_state[z()].find((t4) => t4.id === e3)) == null ? void 0 : _d.settings) == null ? void 0 : _e._cssClasses) || ``;
        });
  ...
  b.addEventListener(`tribute-active-true`, function(e2) {
    ...
    (((_a = t2.settings) == null ? void 0 : _a._cssGlobalClasses) ? [

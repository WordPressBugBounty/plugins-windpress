...
import { $ as e, $n as t, B as n, D as r, E as i, En as a, Ft as o, Ht as s, J as c, L as l, Lt as u, On as d, Zn as f, b as p, ct as m, et as h, ft as g, g as _, gn as v, gt as y, h as b, jn as x, k as S, mt as C, o as w, pn as T, qt as E, r as ee, tr as D, tt as te, un as ne, v as O, vn as k, wn as A, wt as j, xn as re, xt as M, y as ie, z as ae } from "./runtime-core.esm-bundler-C_RgxGrN.js";
import { A as oe, I as se, f as N, k as P, l as ce, s as le, w as F } from "./dist-BVQ2eZ4j.js";
import { a as ue, t as de } from "./vue-router-duOdSZkK.js";
function I(e2, t2 = {}, n2) {
  for (let r2 in e2) {
...
function fa(e2, t2) {
  ...
  y(sa, void 0), i2 && a2 && (t2?.bind === false ? a2.value = void 0 : e2?.id && (a2.value = e2?.id));
...
var ga = { __name: `LinkBase`, props: { as: { type: String, required: false, default: `button` }, type: { type: String, required: false, default: `button` }, disabled: { type: Boolean, required: false }, onClick: { type: [Function, Array], required: false }, href: { type: String, required: false }, navigate: { type: Function, required: false }, target: { type: [String, Object, null], required: false }, rel: { type: [String, Object, null], required: false }, active: { type: Boolean, required: false }, isExternal: { type: Boolean, required: false } }, setup(e2) {
  ...
  let n2 = e2, r2 = ue(), i2 = R(), a2 = ht(P(n2, `as`, `type`, `disabled`, `active`, `exact`, `exactQuery`, `exactHash`, `activeClass`, `inactiveClass`, `to`, `href`, `raw`, `custom`, `class`, `noRel`)), o2 = _(() => $({ extend: $(_a), ...z({ variants: { active: { true: Xe(i2.ui?.link?.variants?.active?.true, n2.activeClass), false: Xe(i2.ui?.link?.variants?.active?.false, n2.inactiveClass) } } }, i2.ui?.link || {}) })), s2 = _(() => n2.to ?? n2.href), c2 = _(() => n2.external ? true : s2.value ? typeof s2.value == `string` && Ue(s2.value, { acceptRelative: true }) : false), l2 = _(() => !!n2.target && n2.target !== `_self`), u2 = _(() => n2.noRel ? null : n2.rel === void 0 ? c2.value || l2.value ? `noopener noreferrer` : null : n2.rel || null);

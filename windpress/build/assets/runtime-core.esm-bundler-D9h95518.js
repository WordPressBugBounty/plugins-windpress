import { n as e, t } from "./dist-csr2igEd.js";
e();
function n(e2) {
...
function Vo(e2, t2, n2, r2, i2, a2, o2, s2, c2, l2, u2 = false) {
  ...
  let y2 = e2.props ? ue(e2.props.timeout) : void 0, b2 = a2, x2 = { vnode: e2, parent: t2, parentComponent: n2, namespace: o2, container: r2, hiddenContainer: i2, deps: 0, pendingId: Io++, timeout: typeof y2 == `number` ? y2 : -1, activeBranch: null, isFallbackMountPending: false, pendingBranch: null, isInFallback: !u2, isHydrating: u2, isUnmounted: false, effects: [], resolve(e3 = false, n3 = false) {
    ...
    x2.isFallbackMountPending = false, Ko(x2, o3), x2.pendingBranch = null, x2.isInFallback = false;
...
var Gs = `3.5.34`, Ks = a, qs = In, Js = tr, Ys = rr, Xs = { createComponentInstance: bs, setupComponent: Ds, renderComponentRoot: Za, setCurrentRenderingInstance: ar, isVNode: is, normalizeVNode: X, getComponentPublicInstance: Ls, ensureValidVNode: aa, pushWarningContext: Mn, popWarningContext: Nn };
export {
  wa as $,
  ye as $n,
  Ie as $t,

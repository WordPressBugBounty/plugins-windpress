...
var d = `Invalid doc index: must be a non-negative integer within the bounds of the docs array`, f = (e2) => `Invalid value for key ${e2}`, p = (e2) => `Pattern length exceeds max of ${e2}.`, m = (e2) => `Missing ${e2} property in key`, h = (e2) => `Property 'weight' in key '${e2}' must be a positive integer`, g = `Fuse.match does not support useTokenSearch: token search requires corpus-level statistics (df, fieldCount) that a one-off string comparison does not have. Use new Fuse(...).search(...) instead.`, _ = Object.prototype.hasOwnProperty, v = class {
  constructor(e2) {
...
function y(t2) {
  ...
  if (r(t2) || e(t2)) a2 = t2, n2 = b(t2), i2 = x(t2);
  else {
    if (!_.call(t2, `name`)) throw Error(m(`name`));
    let e2 = t2.name;
    if (a2 = e2, _.call(t2, `weight`) && t2.weight !== void 0 && (o2 = t2.weight, o2 <= 0)) throw Error(h(x(e2)));
    n2 = b(e2), i2 = x(e2), s2 = t2.getFn ?? null;
  }
...
var C = { includeMatches: false, findAllMatches: false, minMatchCharLength: 1 }, w = { isCaseSensitive: false, ignoreDiacritics: false, includeScore: false, keys: [], shouldSort: true, sortFn: (e2, t2) => e2.score === t2.score ? e2.idx < t2.idx ? -1 : 1 : e2.score < t2.score ? -1 : 1 }, T = { location: 0, threshold: 0.6, distance: 100 }, E = { useExtendedSearch: false, useTokenSearch: false, tokenize: void 0, tokenMatch: `any`, getFn: S, ignoreLocation: false, ignoreFieldNorm: false, fieldNormWeight: 1 }, D = Object.freeze({ ...w, ...C, ...T, ...E });
function ee(e2) {
...
function te(e2 = 1, t2 = 3) {
  ...
  return { get(t3) {
    let i2 = 0, a2 = false;
    for (let e3 = 0; e3 < t3.length; e3++) ee(t3.charCodeAt(e3)) ? a2 = false : a2 || (a2 = (i2++, true));
...
function re(e2, t2, n2, { location: r2 = D.location, distance: i2 = D.distance, threshold: a2 = D.threshold, findAllMatches: o2 = D.findAllMatches, minMatchCharLength: s2 = D.minMatchCharLength, includeMatches: c2 = D.includeMatches, ignoreLocation: l2 = D.ignoreLocation } = {}) {
  if (t2.length > 32) throw Error(p(32));
  ...
  for (let t3 = 0; t3 < u2; t3 += 1) {
    let r3 = 0, i3 = C2;
    for (; r3 < i3; ) g2(t3, f2 + i3) <= m2 ? r3 = i3 : C2 = i3, i3 = Math.floor((C2 - r3) / 2 + r3);
    C2 = i3;
    ...
    for (let r4 = s3; r4 >= a3; --r4) {
      ...
      if (c3[r4] = (c3[r4 + 1] << 1 | 1) & o3, t3 && (c3[r4] |= (b2[r4 + 1] | b2[r4]) << 1 | 1 | b2[r4 + 1]), c3[r4] & w2 && (x2 = g2(t3, i4), x2 <= m2)) {
        if (m2 = x2, h2 = i4, S2 = t3, h2 <= f2) break;
...
var $ = class {
  constructor(e2, t2, n2) {
    this.options = { ...D, ...t2 }, this.options.useExtendedSearch, this.options.useTokenSearch, this._keyStore = new v(this.options.keys), this._docs = e2, this._myIndex = null, this._invertedIndex = null, this.setCollection(e2, n2), this._lastQuery = null, this._lastSearcher = null;
  }
  _getSearcher(e2) {
  ...
  search(e2, t2) {
    ...
    } else p2 = r(e2) ? r(this._docs[0]) ? this._searchStringList(e2) : this._searchObjectList(e2) : this._searchLogical(e2), me(p2, { ignoreFieldNorm: l2 }), s2 && p2.sort(r(e2) ? f2 : d2), i(n2) && n2 > -1 && (p2 = p2.slice(0, n2));
    return _e(p2, this._docs, { includeMatches: a2, includeScore: o2 });
  }
    ...
    return a2.forEach(({ v: e3, i: a3, n: s2 }) => {
      ...
      if (l2.isMatch) {
        ...
        if (!i2 || this._coversAllTokens(c2)) {
          ...
          t2 ? (r4.score = q(r4.matches, { ignoreFieldNorm: n2 }), t2.insert(r4)) : o2.push(r4);
        }
      }
    }), o2;
  }
  _searchLogical(e2) {
    let t2 = K(e2, this.options), n2 = this._normalizedKeys(), r2 = (e3, t3, i3) => {
      if (!(`children` in e3)) {
        let { keyId: r3, searcher: a4 } = e3, o4;
        return r3 === null ? (o4 = [], n2.forEach((e4, n3) => {
          o4.push(...this._findMatches({ key: e4, value: t3[n3], searcher: a4 }));
        })) : o4 = this._findMatches({ key: this._keyStore.get(r3), value: this._myIndex.getValueForItemAtKeyId(t3, r3), searcher: a4 }), o4 && o4.length ? [{ idx: i3, item: t3, matches: o4 }] : [];
      }
      let { children: a3, operator: o3 } = e3, s2 = [];
      for (let e4 = 0, n3 = a3.length; e4 < n3; e4 += 1) {
        let n4 = a3[e4], c2 = r2(n4, t3, i3);
        if (c2.length) s2.push(...c2);
        else if (o3 === V.AND) return [];
      }
      return s2;
    }, i2 = this._myIndex.records, a2 = /* @__PURE__ */ new Map(), o2 = [];
    return i2.forEach(({ $: e3, i: n3 }) => {
      if (c(e3)) {
        let i3 = r2(t2, e3, n3);
        i3.length && (a2.has(n3) || (a2.set(n3, { idx: n3, item: e3, matches: [] }), o2.push(a2.get(n3))), i3.forEach(({ matches: e4 }) => {
          a2.get(n3).matches.push(...e4);
        }));
      }
    }), o2;
  }
  _searchObjectList(e2, { heap: t2, ignoreFieldNorm: n2 } = {}) {
    ...
    return a2.forEach(({ $: e3, i: a3 }) => {
      ...
      if (o2.forEach((t3, n3) => {
        ...
        t2 ? (r3.score = q(r3.matches, { ignoreFieldNorm: n2 }), t2.insert(r3)) : s2.push(r3);
      }
    }), s2;
  }
...
$.version = `7.5.0`, $.createIndex = k, $.parseIndex = ne, $.config = D, $.match = function(e2, t2, n2) {
  if (n2 && n2.useTokenSearch) throw Error(g);

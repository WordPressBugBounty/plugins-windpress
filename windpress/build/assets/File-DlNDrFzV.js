...
import { $n as t, D as n, E as r, Ht as i, Lt as a, On as o, St as s, Zn as c, _ as l, b as u, bt as d, ct as f, et as p, g as m, it as h, k as g, mt as _, o as v, qt as y, tr as b, v as x, vn as S, w as C, wn as w, wt as T, xn as E, xt as D, y as O, z as k } from "./runtime-core.esm-bundler-Ci9kEgM7.js";
import { n as A } from "./vue.runtime.esm-bundler-CWCE91rd.js";
import { I as ee, R as j, S as M, U as N, V as te, X as P, _ as ne, b as F, i as re, m as ie, n as ae, r as oe, t as I, v as L, x as R, y as z } from "./Button-CzGEASGR.js";
import { A as se, c as ce, k as le, l as ue, r as de, t as fe } from "./dist-D5YmEqpM.js";
import { i as pe, n as me, t as B, x as he } from "./Tooltip-CmrGYuQV.js";
import { d as ge, r as V, u as _e } from "./namespaced-DmrIZId-.js";
import { t as ve } from "./Tree-B0rB3fqE.js";
import { n as ye, r as H, t as be } from "./useFileAction-Dk-x46Ea.js";
import { t as xe } from "./Slideover-CjoUKxIP.js";
import { t as Se } from "./Badge-Dw196kvM.js";
import { t as U } from "./settings-BxZvj8OA.js";
import { r as Ce } from "./isSymbol-B9ImcFp_.js";
import { t as W } from "./debounce-BMzMU_Rn.js";
import { t as we } from "./path-browserify-CRIrsyPl.js";
import { a as G, c as K, i as Te, n as q, r as Ee } from "./intellisense-Cuajj_d-.js";
import "./tailwindcss-me5qj0Ys.js";
import { t as J } from "./monaco.contribution-CdwEtGTx.js";
import { n as De, t as Oe } from "./DashboardNavbar-BjpmTDcR.js";
import { t as ke } from "./DashboardSidebarCollapse-Co1bZzEP.js";
import { t as Y } from "./color-CzKk6fKW.js";
var Ae = `Expected a function`;
function je(e2, t2, n2) {
  var r2 = true, i2 = true;
  if (typeof e2 != `function`) throw TypeError(Ae);
  return Ce(n2) && (r2 = `leading` in n2 ? !!n2.leading : r2, i2 = `trailing` in n2 ? !!n2.trailing : i2), W(e2, t2, { leading: r2, maxWait: t2, trailing: i2 });
}
...
var Xe = { class: `text-xs opacity-60 font-normal` }, Ze = { class: `flex-1 overflow-y-auto relative` }, Qe = { key: 0, class: `absolute bottom-5 left-5 z-50` }, $e = { key: `panel`, class: `bg-(--ui-bg)/30 backdrop-blur-md border border-error/20 rounded-lg p-4 shadow-xl min-w-80 max-w-96 origin-bottom-left` }, et = { class: `flex items-start gap-3` }, tt = { class: `flex-1` }, nt = { class: `flex items-center justify-between mb-2` }, rt = { class: `font-medium text-error text-sm` }, it = { class: `text-sm mb-2` }, at = { key: 0, class: `text-xs text-muted` }, ot = g({ __name: `FileEditor`, props: { entry: {} }, emits: [`close`, `save`, `delete`, `reset`], setup(e2, { emit: t2 }) {
  let i2 = H(), a2 = U(), c2 = ue(), d2 = ye(), f2 = e2, p2 = t2, m2 = { automaticLayout: true, formatOnType: false, formatOnPaste: false, fontSize: 14 }, g2 = E(), v2 = S(false), C2 = S([]), w2 = null, T2 = /* @__PURE__ */ new Set(), D2 = S({ hasErrors: false, errors: [] }), k2 = S(false);
  async function ee2(e3, t3) {
    if (g2.value = e3, v2.value = true, Number(a2.virtualOptions(`general.tailwindcss.version`, 4).value) === 4) {
      let n2 = null, r2 = null, a3 = 0, o2 = 3e4, s2 = async () => {
        ...
        try {
          let e4 = await K({ volume: i2.getKVEntries() }), t4 = await Te(e4);
          n2 = { designSystem: e4, variablesList: t4, classList: Ee(e4) }, d2.themeJson = Ye(t4), a3 = Date.now();
        } catch (e4) {
...
`), o4 = null;
  ...
  return h(() => {
    ...
    let h2 = I, g3 = B, v3 = z, S2 = Se, C3 = L, w3 = Oe, T3 = s(`vue-monaco-editor`), E2 = De;
  ...
  let t2 = H(), r2 = be(), i2 = S(null), a2 = m({ get() {
  ...
  return (e3, d2) => {
    let f2 = ke, p2 = I, m2 = B, h2 = Oe, g2 = De, b2 = z, S2 = xe;

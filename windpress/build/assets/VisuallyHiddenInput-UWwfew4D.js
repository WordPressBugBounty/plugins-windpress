import { En as e, Ht as t, b as n, bt as r, et as i, g as a, k as o, mt as s, o as c, v as l, vn as u, y as d } from "./runtime-core.esm-bundler-Twwq1XF8.js";
import { d as f } from "./Tooltip-CPUUajce.js";
import { o as p } from "./dist-ChpmCc7n.js";
function m(t2) {
  return a(() => !e(t2) || !!p(t2)?.closest(`form`));
}
function h() {
  let e2 = u();
  return { primitiveElement: e2, currentElement: a(() => [`#text`, `#comment`].includes(e2.value?.$el.nodeName) ? e2.value?.$el.nextElementSibling : p(e2)) };
}
var g = o({ inheritAttrs: false, __name: `VisuallyHiddenInputBubble`, props: { name: { type: String, required: true }, value: { type: null, required: true }, checked: { type: Boolean, required: false, default: void 0 }, required: { type: Boolean, required: false }, disabled: { type: Boolean, required: false }, feature: { type: String, required: false, default: `fully-hidden` } }, setup(e2) {
  ...
  }), (e3, t2) => (s(), l(f, i({ ref_key: `primitiveElement`, ref: r2 }, { ...n2, ...e3.$attrs }, { as: `input` }), null, 16));

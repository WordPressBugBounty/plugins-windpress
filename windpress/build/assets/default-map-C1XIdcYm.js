...
var _Ne_instances, e_fn, t_fn, n_fn, _a2;
import { o as e, t } from "./rolldown-runtime-CMxvf4Kt.js";
import { t as n } from "./chunk-X4GG3EDV-DHGklrDp.js";
import { n as r } from "./lib-DaZz88T4.js";
import { t as i } from "./path-browserify-CRIrsyPl.js";
import { n as a, r as o, t as s, u as c } from "./cssesc-CBKzJz-F.js";
...
var v = { color: d, length: fe, percentage: ce, ratio: ue, number: oe, integer: E, url: ee, position: pe, "bg-size": me, "line-width": x, image: te, "family-name": ne, "generic-name": w, "absolute-size": re, "relative-size": ie, angle: ge, vector: ve };
function y(e3, t2) {
...
function x(e3) {
  return _(e3, ` `).every((e4) => fe(e4) || oe(e4) || e4 === `thin` || e4 === `medium` || e4 === `thick`);
}
...
var de = RegExp(`^${T.source}(${`cm.mm.Q.in.pc.pt.px.em.ex.ch.rem.lh.rlh.vw.vh.vmin.vmax.vb.vi.svw.svh.lvw.lvh.dvw.dvh.cqw.cqh.cqi.cqb.cqmin.cqmax`.split(`.`).join(`|`)})$`);
function fe(e3) {
  return de.test(e3) || m(e3);
}
function pe(e3) {
  let t2 = 0;
  for (let n2 of _(e3, ` `)) {
...
function me(e3) {
  ...
  for (let n2 of _(e3, `,`)) {
    ...
    if (e4.every((e5) => e5 === `auto` || fe(e5) || ce(e5))) {
      t2 += 1;
      continue;
    }
  }
...
var he = RegExp(`^${T.source}(${[`deg`, `rad`, `grad`, `turn`].join(`|`)})$`);
function ge(e3) {
  return he.test(e3);
}
var _e = RegExp(`^${T.source} +${T.source} +${T.source}$`);
function ve(e3) {
  return _e.test(e3);
}
function E(e3) {
...
var je = /* @__PURE__ */ new Map([[`--font`, [`--font-weight`, `--font-size`]], [`--inset`, [`--inset-shadow`, `--inset-ring`]], [`--text`, [`--text-color`, `--text-decoration-color`, `--text-decoration-thickness`, `--text-indent`, `--text-shadow`, `--text-underline-offset`]], [`--grid-column`, [`--grid-column-start`, `--grid-column-end`]], [`--grid-row`, [`--grid-row-start`, `--grid-row-end`]]]);
function Me(e3, t2) {
  return (je.get(t2) ?? []).some((t3) => e3 === t3 || e3.startsWith(`${t3}-`));
}
var Ne = (_a2 = class {
  ...
  keysInNamespaces(e3) {
    ...
    for (let n2 of e3) {
      let e4 = `${n2}-`;
      for (let r2 of this.values.keys()) r2.startsWith(e4) && r2.indexOf(`--`, 2) === -1 && (Me(r2, n2) || t2.push(r2.slice(e4.length)));
    }
    return t2;
  }
  get(e3) {
  ...
  getOptions(e3) {
    return e3 = Ae(__privateMethod(this, _Ne_instances, e_fn).call(this, e3)), this.values.get(e3)?.options ?? 0;
  }
  entries() {
  ...
  markUsedVariable(e3) {
    let t2 = Ae(__privateMethod(this, _Ne_instances, e_fn).call(this, e3)), n2 = this.values.get(t2);
    if (!n2) return false;
    let r2 = n2.options & 16;
    return n2.options |= 16, !r2;
  }
  resolve(e3, t2, n2 = 0) {
    let r2 = __privateMethod(this, _Ne_instances, t_fn).call(this, e3, t2);
    if (!r2) return null;
    let i2 = this.values.get(r2);
    return (n2 | i2.options) & 1 ? i2.value : __privateMethod(this, _Ne_instances, n_fn).call(this, r2);
  }
  resolveValue(e3, t2) {
    let n2 = __privateMethod(this, _Ne_instances, t_fn).call(this, e3, t2);
  ...
  resolveWith(e3, t2, n2 = []) {
    ...
    for (let e4 of n2) {
      ...
      n3 && (n3.options & 1 ? i2[e4] = n3.value : i2[e4] = __privateMethod(this, _Ne_instances, n_fn).call(this, t3));
    }
    let a2 = this.values.get(r2);
    return a2.options & 1 ? [a2.value, i2] : [__privateMethod(this, _Ne_instances, n_fn).call(this, r2), i2];
  }
  namespace(e3) {
...
}, _Ne_instances = new WeakSet(), e_fn = function(e3) {
  ...
  if (!t2) return null;
  let n2 = null;
  return t2.options & 2 && (n2 = t2.value), `var(${ke(this.prefixKey(e3))}${n2 ? `, ${n2}` : ``})`;
}, _a2), Pe = `4.3.1`;
function Fe(e3) {
  let t2 = [0];
...
var Ie = 92, Le = 47, Re = 42, ze = 34, Be = 39, Ve = 58, He = 59, A = 10, Ue = 13, We = 32, Ge = 9, Ke = 123, qe = 125, Je = 40, Ye = 41, Xe = 91, Ze = 93, Qe = 45, $e = 64, et = 33, tt = class e2 extends Error {
  constructor(t2, n2) {
    if (n2) {
      let e3 = n2[0], r2 = Fe(e3.code).find(n2[1]);
...
function nt(e3, t2) {
  ...
  for (let t3 = 0; t3 < e3.length; t3++) {
    ...
    if (!(f2 === Ue && (d2 = e3.charCodeAt(t3 + 1), d2 === A))) if (f2 === Ie) c2 === `` && (u2 = t3), c2 += e3.slice(t3, t3 + 2), t3 += 1;
    else if (f2 === Le && e3.charCodeAt(t3 + 1) === Re) {
      let r3 = t3;
      for (let n3 = t3 + 2; n3 < e3.length; n3++) if (d2 = e3.charCodeAt(n3), d2 === Ie) n3 += 1;
      else if (d2 === Re && e3.charCodeAt(n3 + 1) === Le) {
        t3 = n3 + 1;
        break;
      }
      let a3 = e3.slice(r3, t3 + 1);
      if (a3.charCodeAt(2) === et) {
        let e4 = Et(a3.slice(2, -2));
        i2.push(e4), n2 && (e4.src = [n2, r3, t3 + 1], e4.dst = [n2, r3, t3 + 1]);
      }
    } else if (f2 === Be || f2 === ze) {
      let r3 = at(e3, t3, f2, n2);
      c2 += e3.slice(t3, r3 + 1), t3 = r3;
    } else {
      if ((f2 === We || f2 === A || f2 === Ge) && (d2 = e3.charCodeAt(t3 + 1)) && (d2 === We || d2 === A || d2 === Ge || d2 === Ue && (d2 = e3.charCodeAt(t3 + 2)) && d2 == A)) continue;
      if (f2 === A) {
        if (c2.length === 0) continue;
        d2 = c2.charCodeAt(c2.length - 1), d2 !== We && d2 !== A && d2 !== Ge && (c2 += ` `);
      } else if (f2 === Qe && e3.charCodeAt(t3 + 1) === Qe && c2.length === 0) {
        let i3 = ``, a3 = t3, s3 = -1;
        for (let r3 = t3 + 2; r3 < e3.length; r3++) if (d2 = e3.charCodeAt(r3), d2 === Ie) r3 += 1;
        else if (d2 === Be || d2 === ze) r3 = at(e3, r3, d2, n2);
        else if (d2 === Le && e3.charCodeAt(r3 + 1) === Re) {
          for (let t4 = r3 + 2; t4 < e3.length; t4++) if (d2 = e3.charCodeAt(t4), d2 === Ie) t4 += 1;
          else if (d2 === Re && e3.charCodeAt(t4 + 1) === Le) {
            r3 = t4 + 1;
            break;
          }
        } else if (s3 === -1 && d2 === Ve) s3 = c2.length + r3 - a3;
        else if (d2 === He && i3.length === 0) {
          c2 += e3.slice(a3, r3), t3 = r3;
          break;
        } else if (d2 === Je) i3 += `)`;
        else if (d2 === Xe) i3 += `]`;
        else if (d2 === Ke) i3 += `}`;
        else if ((d2 === qe || e3.length - 1 === r3) && i3.length === 0) {
          t3 = r3 - 1, c2 += e3.slice(a3, r3);
          break;
        } else (d2 === Ye || d2 === Ze || d2 === qe) && i3.length > 0 && e3[r3] === i3[i3.length - 1] && (i3 = i3.slice(0, -1));
        let l3 = it(c2, s3);
        if (!l3) throw new tt(`Invalid custom property, expected a value`, n2 ? [n2, a3, t3] : null);
        n2 && (l3.src = [n2, a3, t3], l3.dst = [n2, a3, t3]), o2 ? o2.nodes.push(l3) : r2.push(l3), c2 = ``;
      } else if (f2 === He && c2.charCodeAt(0) === $e) s2 = rt(c2), n2 && (s2.src = [n2, u2, t3], s2.dst = [n2, u2, t3]), o2 ? o2.nodes.push(s2) : r2.push(s2), c2 = ``, s2 = null;
      else if (f2 === He && l2[l2.length - 1] !== `)`) {
        let e4 = it(c2);
        if (!e4) {
          if (c2.length === 0) continue;
          throw new tt(`Invalid declaration: \`${c2.trim()}\``, n2 ? [n2, u2, t3] : null);
        }
        n2 && (e4.src = [n2, u2, t3], e4.dst = [n2, u2, t3]), o2 ? o2.nodes.push(e4) : r2.push(e4), c2 = ``;
      } else if (f2 === Ke && l2[l2.length - 1] !== `)`) l2 += `}`, s2 = z(c2.trim()), n2 && (s2.src = [n2, u2, t3], s2.dst = [n2, u2, t3]), o2 && o2.nodes.push(s2), a2.push(o2), o2 = s2, c2 = ``, s2 = null;
      else if (f2 === qe && l2[l2.length - 1] !== `)`) {
        if (l2 === ``) throw new tt(`Missing opening {`, n2 ? [n2, t3, t3] : null);
        if (l2 = l2.slice(0, -1), c2.length > 0) if (c2.charCodeAt(0) === $e) s2 = rt(c2), n2 && (s2.src = [n2, u2, t3], s2.dst = [n2, u2, t3]), o2 ? o2.nodes.push(s2) : r2.push(s2), c2 = ``, s2 = null;
        else {
          let e5 = c2.indexOf(`:`);
          if (o2) {
            let r3 = it(c2, e5);
            if (!r3) throw new tt(`Invalid declaration: \`${c2.trim()}\``, n2 ? [n2, u2, t3] : null);
        ...
        if (l2[l2.length - 1] !== `)`) throw new tt(`Missing opening (`, n2 ? [n2, t3, t3] : null);
        l2 = l2.slice(0, -1), c2 += `)`;
      } else {
        if (c2.length === 0 && (f2 === We || f2 === A || f2 === Ge)) continue;
        c2 === `` && (u2 = t3), c2 += String.fromCharCode(f2);
      }
    }
  }
  if (c2.charCodeAt(0) === $e) {
    let t3 = rt(c2);
    n2 && (t3.src = [n2, u2, e3.length], t3.dst = [n2, u2, e3.length]), r2.push(t3);
  }
  if (l2.length > 0 && o2) {
    if (o2.kind === `rule`) throw new tt(`Missing closing } at ${o2.selector}`, o2.src ? [o2.src[0], o2.src[1], o2.src[1]] : null);
    if (o2.kind === `at-rule`) throw new tt(`Missing closing } at ${o2.name} ${o2.params}`, o2.src ? [o2.src[0], o2.src[1], o2.src[1]] : null);
  }
...
function it(e3, t2 = e3.indexOf(`:`)) {
  if (t2 === -1) return null;
  let n2 = e3.indexOf(`!important`, t2 + 1);
  return B(e3.slice(0, t2).trim(), e3.slice(t2 + 1, n2 === -1 ? e3.length : n2).trim(), n2 !== -1);
}
function at(e3, t2, n2, r2 = null) {
  let i2;
  for (let a2 = t2 + 1; a2 < e3.length; a2++) if (i2 = e3.charCodeAt(a2), i2 === Ie) a2 += 1;
  else {
    if (i2 === n2) return a2;
    if (i2 === He && (e3.charCodeAt(a2 + 1) === A || e3.charCodeAt(a2 + 1) === Ue && e3.charCodeAt(a2 + 2) === A)) throw new tt(`Unterminated string: ${e3.slice(t2, a2 + 1) + String.fromCharCode(n2)}`, r2 ? [r2, t2, a2 + 1] : null);
    if (i2 === A || i2 === Ue && e3.charCodeAt(a2 + 1) === A) throw new tt(`Unterminated string: ${e3.slice(t2, a2) + String.fromCharCode(n2)}`, r2 ? [r2, t2, a2 + 1] : null);
  }
  return t2;
}
...
var ct = 92, lt = 41, ut = 58, dt = 44, ft = 34, pt = 61, mt = 62, ht = 60, gt = 10, _t = 40, vt = 39, yt = 47, bt = 32, xt = 9;
function P(e3) {
  e3 = e3.replaceAll(`\r
`, `
`);
  ...
  for (let o2 = 0; o2 < e3.length; o2++) {
    ...
    switch (s2) {
      ...
      case xt: {
        ...
        let n3 = o2, s3 = o2 + 1;
        for (; s3 < e3.length && (a2 = e3.charCodeAt(s3), !(a2 !== ut && a2 !== dt && a2 !== pt && a2 !== mt && a2 !== ht && a2 !== gt && a2 !== bt && a2 !== xt)); s3++) ;
        o2 = s3 - 1;
        let c2 = st(e3.slice(n3, s3));
      ...
      case ft: {
        let t3 = o2;
        for (let t4 = o2 + 1; t4 < e3.length; t4++) if (a2 = e3.charCodeAt(t4), a2 === ct) t4 += 1;
        else if (a2 === s2) {
          o2 = t4;
          break;
        }
...
var St = ((e3) => (e3[e3.Continue = 0] = `Continue`, e3[e3.Skip = 1] = `Skip`, e3[e3.Stop = 2] = `Stop`, e3[e3.Replace = 3] = `Replace`, e3[e3.ReplaceSkip = 4] = `ReplaceSkip`, e3[e3.ReplaceStop = 5] = `ReplaceStop`, e3))(St || {}), F = { Continue: { kind: 0 }, Skip: { kind: 1 }, Stop: { kind: 2 }, Replace: (e3) => ({ kind: 3, nodes: Array.isArray(e3) ? e3 : [e3] }), ReplaceSkip: (e3) => ({ kind: 4, nodes: Array.isArray(e3) ? e3 : [e3] }), ReplaceStop: (e3) => ({ kind: 5, nodes: Array.isArray(e3) ? e3 : [e3] }) };
function I(e3, t2) {
  typeof t2 == `function` ? Ct(e3, t2) : Ct(e3, t2.enter, t2.exit);
}
function Ct(e3, t2 = () => F.Continue, n2 = () => F.Continue) {
    ...
    if (i2.parent = s2, i2.siblings = a2, o2 >= 0) {
      ...
      switch (s3.kind) {
        ...
        case 4:
          ...
          continue;
        default:
          throw Error(`Invalid \`WalkAction.${St[s3.kind] ?? `Unknown(${s3.kind})`}\` in enter.`);
      }
    }
    let c2 = ~o2;
    i2.index = c2;
    let l2 = a2[c2], u2 = n2(l2, i2) ?? F.Continue;
    switch (u2.kind) {
      case 0:
        e4[1] = c2 + 1;
        continue;
      ...
      case 4:
        ...
        continue;
      default:
        throw Error(`Invalid \`WalkAction.${St[u2.kind] ?? `Unknown(${u2.kind})`}\` in exit.`);
    }
  }
}
function wt(e3) {
...
function z(e3, t2 = []) {
  return e3.charCodeAt(0) === Tt ? rt(e3, t2) : L(e3, t2);
}
...
function kt(e3, t2, n2 = 3) {
  ...
  function f2(e4, p3, m2 = {}, h2 = 0) {
    if (e4.kind === `declaration`) {
      ...
      if (e4.value.includes(`var(`)) if (m2.theme && e4.property[0] === `-` && e4.property[1] === `-`) for (let t3 of wt(e4.value)) d2.get(t3).add(e4.property);
      else t2.trackUsedVariables(e4.value);
      if (e4.property === `animation`) for (let t3 of Nt(e4.value)) c2.add(t3);
  ...
  e: for (let [e4, n3] of a2) for (let r3 of n3) {
    if (Mt(r3.property, t2.theme, d2)) {
      if (r3.property.startsWith(t2.theme.prefixKey(`--animate-`))) for (let e5 of Nt(r3.value)) c2.add(e5);
      continue;
    }
    let n4 = e4.indexOf(r3);
    if (e4.splice(n4, 1), e4.length === 0) {
      let t3 = jt(p2, (t4) => t4.kind === `rule` && t4.nodes === e4);
...
function Mt(e3, t2, n2, r2 = /* @__PURE__ */ new Set()) {
  if (r2.has(e3) || (r2.add(e3), t2.getOptions(e3) & 24)) return true;
  {
    let i2 = n2.get(e3) ?? [];
    for (let e4 of i2) if (Mt(e4, t2, n2, r2)) return true;
  }
  return false;
}
function Nt(e3) {
...
function Pt(e3) {
  if (e3.indexOf(`(`) === -1) return Ft(e3);
  let t2 = P(e3);
  return It(t2), e3 = N(t2), e3 = h(e3), e3;
}
function Ft(e3, t2 = false) {
  let n2 = ``;
...
function It(e3) {
  for (let t2 of e3) switch (t2.kind) {
    case `function`:
      ...
      if (t2.value === `var` || t2.value.endsWith(`_var`) || t2.value === `theme` || t2.value.endsWith(`_theme`)) {
        ...
        for (let e4 = 0; e4 < t2.nodes.length; e4++) {
          if (e4 == 0 && t2.nodes[e4].kind === `word`) {
            t2.nodes[e4].value = Ft(t2.nodes[e4].value, true);
            continue;
          }
          It([t2.nodes[e4]]);
        }
      ...
      t2.value = Ft(t2.value), It(t2.nodes);
      break;
    case `separator`:
    case `word`:
      t2.value = Ft(t2.value);
...
var Bt = 58, Vt = 45, Ht = 97, Ut = 122, Wt = /^[a-zA-Z0-9_.%-]+$/;
function Gt(e3) {
  switch (e3.kind) {
    case `arbitrary`:
      return { kind: e3.kind, property: e3.property, value: e3.value, modifier: e3.modifier ? { kind: e3.modifier.kind, value: e3.modifier.value } : null, variants: e3.variants.map(Kt), important: e3.important, raw: e3.raw };
    case `static`:
      return { kind: e3.kind, root: e3.root, variants: e3.variants.map(Kt), important: e3.important, raw: e3.raw };
    case `functional`:
      return { kind: e3.kind, root: e3.root, value: e3.value ? e3.value.kind === `arbitrary` ? { kind: e3.value.kind, dataType: e3.value.dataType, value: e3.value.value } : { kind: e3.value.kind, value: e3.value.value, fraction: e3.value.fraction } : null, modifier: e3.modifier ? { kind: e3.modifier.kind, value: e3.modifier.value } : null, variants: e3.variants.map(Kt), important: e3.important, raw: e3.raw };
    default:
...
function Kt(e3) {
  switch (e3.kind) {
    ...
    case `compound`:
      return { kind: e3.kind, root: e3.root, variant: Kt(e3.variant), modifier: e3.modifier ? { kind: e3.modifier.kind, value: e3.modifier.value } : null };
    default:
...
function* qt(e3, t2) {
  ...
  if (o2[o2.length - 1] === `]`) {
    ...
    if (i3.length === 2 && (a3 = i3[0], r3 = i3[1]), r3[0] !== `-` || r3[1] !== `-` || !zt(r3)) return;
    u2 = [[n3, a3 === null ? `[var(${r3})]` : `[${a3}:var(${r3})]`]];
  } else u2 = Xt(o2, (e4) => t2.utilities.has(e4, `functional`));
  for (let [t3, n3] of u2) {
...
function Jt(e3) {
  if (e3[0] === `[` && e3[e3.length - 1] === `]`) {
    let t2 = Pt(e3.slice(1, -1));
    return !zt(t2) || t2.length === 0 || t2.trim().length === 0 ? null : { kind: `arbitrary`, value: t2 };
  }
  return e3[0] === `(` && e3[e3.length - 1] === `)` ? (e3 = e3.slice(1, -1), e3[0] !== `-` || e3[1] !== `-` || !zt(e3) ? null : (e3 = `var(${e3})`, { kind: `arbitrary`, value: Pt(e3) })) : Wt.test(e3) ? { kind: `named`, value: e3 } : null;
}
function Yt(e3, t2) {
  if (e3[0] === `[` && e3[e3.length - 1] === `]`) {
    if (e3[1] === `@` && e3.includes(`&`)) return null;
    let t3 = Pt(e3.slice(1, -1));
    if (!zt(t3) || t3.length === 0 || t3.trim().length === 0) return null;
  ...
  }
  {
    ...
    if (i2) return null;
    let a2 = Xt(n2, (e4) => t2.variants.has(e4));
    for (let [e4, n3] of a2) switch (t2.variants.kind(e4)) {
      case `static`:
        return n3 !== null || r2 !== null ? null : { kind: `static`, root: e4 };
      case `functional`: {
        let t3 = r2 === null ? null : Jt(r2);
        if (r2 !== null && t3 === null) return null;
        if (n3 === null) return { kind: `functional`, root: e4, modifier: t3, value: null };
        if (n3[n3.length - 1] === `]`) {
          if (n3[0] !== `[`) continue;
          let r3 = Pt(n3.slice(1, -1));
          return !zt(r3) || r3.length === 0 || r3.trim().length === 0 ? null : { kind: `functional`, root: e4, modifier: t3, value: { kind: `arbitrary`, value: r3 } };
        }
        if (n3[n3.length - 1] === `)`) {
          if (n3[0] !== `(`) continue;
          let r3 = Pt(n3.slice(1, -1));
          return !zt(r3) || r3.length === 0 || r3.trim().length === 0 || r3[0] !== `-` || r3[1] !== `-` ? null : { kind: `functional`, root: e4, modifier: t3, value: { kind: `arbitrary`, value: `var(${r3})` } };
        }
        if (!Wt.test(n3)) continue;
...
function Zt(e3, t2) {
  let n2 = [];
  for (let e4 of t2.variants) n2.unshift($t(e4));
  ...
  if (t2.kind === `static` && (r2 += t2.root), t2.kind === `functional` && (r2 += t2.root, t2.value)) if (t2.value.kind === `arbitrary`) {
    if (t2.value !== null) {
      let e4 = sn(t2.value.value), n3 = e4 ? t2.value.value.slice(4, -1) : t2.value.value, [i2, a2] = e4 ? [`(`, `)`] : [`[`, `]`];
      t2.value.dataType ? r2 += `-${i2}${t2.value.dataType}:${tn(n3)}${a2}` : r2 += `-${i2}${tn(n3)}${a2}`;
    }
  } else t2.value.kind === `named` && (r2 += `-${t2.value.value}`);
  return t2.kind === `arbitrary` && (r2 += `[${t2.property}:${tn(t2.value)}]`), (t2.kind === `arbitrary` || t2.kind === `functional`) && (r2 += Qt(t2.modifier)), t2.important && (r2 += `!`), n2.push(r2), n2.join(`:`);
}
function Qt(e3) {
  if (e3 === null) return ``;
  let t2 = sn(e3.value), n2 = t2 ? e3.value.slice(4, -1) : e3.value, [r2, i2] = t2 ? [`(`, `)`] : [`[`, `]`];
  return e3.kind === `arbitrary` ? `/${r2}${tn(n2)}${i2}` : e3.kind === `named` ? `/${e3.value}` : ``;
}
function $t(e3) {
  if (e3.kind === `static`) return e3.root;
  if (e3.kind === `arbitrary`) return `[${tn(rn(e3.selector))}]`;
  let t2 = ``;
  if (e3.kind === `functional`) {
    t2 += e3.root;
    let n2 = e3.root !== `@`;
    if (e3.value) if (e3.value.kind === `arbitrary`) {
      let r2 = sn(e3.value.value), i2 = r2 ? e3.value.value.slice(4, -1) : e3.value.value, [a2, o2] = r2 ? [`(`, `)`] : [`[`, `]`];
      t2 += `${n2 ? `-` : ``}${a2}${tn(i2)}${o2}`;
    } else e3.value.kind === `named` && (t2 += `${n2 ? `-` : ``}${e3.value.value}`);
  }
  return e3.kind === `compound` && (t2 += e3.root, t2 += `-`, t2 += $t(e3.variant)), (e3.kind === `functional` || e3.kind === `compound`) && (t2 += Qt(e3.modifier)), t2;
}
var en = new j((e3) => {
  let t2 = P(e3), n2 = /* @__PURE__ */ new Set(), r2 = /* @__PURE__ */ new Set([`~`, `>`, `+`, `-`, `*`, `/`]);
  return I(t2, (e4, t3) => {
    if (e4.kind === `word` && r2.has(e4.value)) {
      ...
      return a2 && !r2.has(a2.value) ? void 0 : F.ReplaceSkip({ kind: `function`, value: ``, nodes: [e4] });
    }
  }), n2.size > 0 && I(t2, (e4) => {
...
function an(e3) {
  for (let t2 of e3) switch (t2.kind) {
    case `function`:
      if (t2.value === `url` || t2.value.endsWith(`_url`)) {
        t2.value = ln(t2.value);
        break;
      }
      if (t2.value === `var` || t2.value.endsWith(`_var`) || t2.value === `theme` || t2.value.endsWith(`_theme`)) {
        t2.value = ln(t2.value);
        for (let e4 = 0; e4 < t2.nodes.length; e4++) an([t2.nodes[e4]]);
        break;
      }
      t2.value = ln(t2.value), an(t2.nodes);
      break;
    case `separator`:
      t2.value = ln(t2.value);
      break;
    case `word`:
      (t2.value[0] !== `-` || t2.value[1] !== `-`) && (t2.value = ln(t2.value));
      break;
    default:
      cn(t2);
  }
...
var dn = /^(?<value>[-+]?(?:\d*\.)?\d+)(?<unit>[a-z]+|%)?$/i, U = new j((e3) => {
  let t2 = dn.exec(e3);
  if (!t2) return null;
...
}), fn = /* @__PURE__ */ new Set([`inset`, `inherit`, `initial`, `revert`, `unset`]), pn = /* @__PURE__ */ new Set([`calc`, `clamp`, `max`, `min`, `--spacing`]), mn = /* @__PURE__ */ new Set([`color`, `color-mix`, `contrast-color`, `device-cmyk`, `hsl`, `hsla`, `hwb`, `lab`, `lch`, `light-dark`, `oklab`, `oklch`, `rgb`, `rgba`, `--alpha`]), hn = /^-?(\d+|\.\d+)(.*?)$/;
function gn(e3, t2) {
  function n2(e4) {
    return P(t2(N([e4])));
  }
  return _(e3, `,`).map((e4) => {
    e4 = e4.trim();
    let r2 = P(e4), i2 = null, a2 = 0, o2 = 0, s2 = false;
    return I(r2, (e5) => {
      switch (e5.kind) {
        case `word`:
          if (fn.has(e5.value.toLowerCase())) return F.Continue;
          if (hn.test(e5.value.toLowerCase())) return o2++, F.Continue;
          if (e5.value[0] === `#` || f(e5.value)) return s2 = true, F.ReplaceStop(n2(e5));
          i2 = e5, a2++;
          break;
        case `function`:
          return mn.has(e5.value.toLowerCase()) ? (s2 = true, F.ReplaceStop(n2(e5))) : pn.has(e5.value.toLowerCase()) ? (o2++, F.Skip) : (i2 = e5, a2++, F.Skip);
        case `separator`:
          return F.Continue;
        default:
      }
    }), s2 ? N(r2) : o2 < 2 ? e4 : a2 === 0 ? `${e4} ${t2(`currentcolor`)}` : (a2 === 1 && I(r2, (e5) => e5 === i2 ? (s2 = true, F.ReplaceStop(n2(e5))) : F.Skip), s2 ? N(r2) : e4);
  }).join(`, `);
}
var _n = `0,0.5,1,1.5,2,2.5,3,3.5,4,5,6,7,8,9,10,11,12,14,16,20,24,28,32,36,40,44,48,52,56,60,64,72,80,96`.split(`,`), vn = class {
  constructor() {
...
function K(e3, t2, n2) {
  ...
  return r2 ? G(e3, r2) : be(t2.value) ? G(e3, `${t2.value}%`) : null;
}
function q(e3, t2, n2) {
  let r2 = null;
...
function xn(e3) {
  ...
  function n2(n3, r3) {
    function* i3(t3) {
      for (let n4 of e3.keysInNamespaces(t3)) yield n4.replace(bn, (e4, t4, n5) => `${t4}.${n5}`);
    }
  ...
  function o2(r3, a3, o3, { supportsNegative: s3 = false, supportsFractions: c3 = false, staticValues: l3 } = {}) {
    s3 && t2.static(`-${r3}-px`, () => o3(`-1px`)), t2.static(`${r3}-px`, () => o3(`1px`)), i2(r3, { themeKeys: a3, supportsFractions: c3, supportsNegative: s3, defaultValue: null, handleBareValue: ({ value: t3 }) => !e3.resolve(null, [`--spacing`]) || !D(t3) ? null : `--spacing(${t3})`, handleNegativeBareValue: ({ value: t3 }) => !e3.resolve(null, [`--spacing`]) || !D(t3) ? null : `--spacing(-${t3})`, handle: o3, staticValues: l3 }), n2(r3, () => [{ values: e3.get([`--spacing`]) ? _n : [], supportsNegative: s3, supportsFractions: c3, valueThemeKeys: a3 }]);
  }
    ...
    let e4 = function(e5) {
      ...
      return (n3) => {
        ...
        if (n3.value.kind === `arbitrary`) {
          ...
          return (n3.value.dataType ?? y(e5, [`angle`])) === `angle` ? (e5 = t3 ? `calc(${e5} * -1)` : `${e5}`, [B(`--tw-gradient-position`, e5), B(`background-image`, `linear-gradient(var(--tw-gradient-stops,${e5}))`)]) : t3 ? void 0 : [B(`--tw-gradient-position`, e5), B(`background-image`, `linear-gradient(var(--tw-gradient-stops,${e5}))`)];
        }
  ...
  g2(`from`, { color: (e4) => [m2(), B(`--tw-sort`, `--tw-gradient-from`), B(`--tw-gradient-from`, e4), B(`--tw-gradient-stops`, `var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))`)], position: (e4) => [m2(), B(`--tw-gradient-from-position`, e4)] }), r2(`via-none`, [[`--tw-gradient-via-stops`, `initial`]]), g2(`via`, { color: (e4) => [m2(), B(`--tw-sort`, `--tw-gradient-via`), B(`--tw-gradient-via`, e4), B(`--tw-gradient-via-stops`, `var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-via) var(--tw-gradient-via-position), var(--tw-gradient-to) var(--tw-gradient-to-position)`), B(`--tw-gradient-stops`, `var(--tw-gradient-via-stops)`)], position: (e4) => [m2(), B(`--tw-gradient-via-position`, e4)] }), g2(`to`, { color: (e4) => [m2(), B(`--tw-sort`, `--tw-gradient-to`), B(`--tw-gradient-to`, e4), B(`--tw-gradient-stops`, `var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))`)], position: (e4) => [m2(), B(`--tw-gradient-to-position`, e4)] }), r2(`mask-none`, [[`mask-image`, `none`]]), t2.functional(`mask`, (e4) => {
  ...
  let v2 = () => V([W(`--tw-mask-linear`, `linear-gradient(#fff, #fff)`), W(`--tw-mask-radial`, `linear-gradient(#fff, #fff)`), W(`--tw-mask-conic`, `linear-gradient(#fff, #fff)`)]);
  function b2(r3, i3) {
    t2.functional(r3, (t3) => {
      if (t3.value) {
        if (t3.value.kind === `arbitrary`) {
    ...
    }), n2(r3, () => [{ values: [`current`, `inherit`, `transparent`], valueThemeKeys: [`--background-color`, `--color`], modifiers: Array.from({ length: 21 }, (e4, t3) => `${t3 * 5}`) }, { values: Array.from({ length: 21 }, (e4, t3) => `${t3 * 5}%`), valueThemeKeys: [`--gradient-color-stop-positions`] }]), n2(r3, () => [{ values: Array.from({ length: 21 }, (e4, t3) => `${t3 * 5}%`) }, { values: e3.get([`--spacing`]) ? _n : [] }, { values: [`current`, `inherit`, `transparent`], valueThemeKeys: [`--background-color`, `--color`], modifiers: Array.from({ length: 21 }, (e4, t3) => `${t3 * 5}`) }]);
  }
  let ee2 = () => V([W(`--tw-mask-left`, `linear-gradient(#fff, #fff)`), W(`--tw-mask-right`, `linear-gradient(#fff, #fff)`), W(`--tw-mask-bottom`, `linear-gradient(#fff, #fff)`), W(`--tw-mask-top`, `linear-gradient(#fff, #fff)`)]);
  function x2(e4, t3, n3) {
    b2(e4, { color(e5) {
      let r3 = [v2(), ee2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-linear`, `var(--tw-mask-left), var(--tw-mask-right), var(--tw-mask-bottom), var(--tw-mask-top)`)];
  ...
  i2(`mask-linear`, { defaultValue: null, supportsNegative: true, supportsFractions: false, handleBareValue({ value: e4 }) {
    ...
    let t3 = Number(e4);
    return t3 === 0 ? `0deg` : t3 === 1 ? `-1deg` : `calc(1deg * -${e4})`;
  }, handle: (e4) => [v2(), S2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-linear`, `linear-gradient(var(--tw-mask-linear-stops, var(--tw-mask-linear-position)))`), B(`--tw-mask-linear-position`, e4)] }), n2(`mask-linear`, () => [{ supportsNegative: true, values: [`0`, `1`, `2`, `3`, `6`, `12`, `45`, `90`, `180`] }]), b2(`mask-linear-from`, { color: (e4) => [v2(), S2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-linear-stops`, `var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)`), B(`--tw-mask-linear`, `linear-gradient(var(--tw-mask-linear-stops))`), B(`--tw-mask-linear-from-color`, e4)], position: (e4) => [v2(), S2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-linear-stops`, `var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)`), B(`--tw-mask-linear`, `linear-gradient(var(--tw-mask-linear-stops))`), B(`--tw-mask-linear-from-position`, e4)] }), b2(`mask-linear-to`, { color: (e4) => [v2(), S2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-linear-stops`, `var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)`), B(`--tw-mask-linear`, `linear-gradient(var(--tw-mask-linear-stops))`), B(`--tw-mask-linear-to-color`, e4)], position: (e4) => [v2(), S2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-linear-stops`, `var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)`), B(`--tw-mask-linear`, `linear-gradient(var(--tw-mask-linear-stops))`), B(`--tw-mask-linear-to-position`, e4)] });
  ...
  }), n2(`decoration`, () => [{ values: [`current`, `inherit`, `transparent`], valueThemeKeys: [`--text-decoration-color`, `--color`], modifiers: Array.from({ length: 21 }, (e4, t3) => `${t3 * 5}`) }, { values: [`0`, `1`, `2`], valueThemeKeys: [`--text-decoration-thickness`] }]), i2(`animate`, { themeKeys: [`--animate`], handle: (e4) => [B(`animation`, e4)], staticValues: { none: [B(`animation`, `none`)] } });
  {
    ...
    t2.functional(`filter`, (e4) => {
      if (!e4.modifier) {
        ...
        if (e4.value.value === `none`) return [B(`filter`, `none`)];
      }
      ...
      if (!e4.modifier) {
        ...
        if (e4.value.value === `none`) return [B(`-webkit-backdrop-filter`, `none`), B(`backdrop-filter`, `none`)];
      }
      ...
      if (t3.modifier && (t3.modifier.kind === `arbitrary` ? n3 = t3.modifier.value : E(t3.modifier.value) && (n3 = `${t3.modifier.value}%`)), !t3.value) {
        ...
        return t4 === null || r3 === null ? void 0 : [s3(), B(`--tw-drop-shadow-alpha`, n3), ...En(`--tw-drop-shadow-size`, t4, n3, (e4) => `var(--tw-drop-shadow-color, ${e4})`), B(`--tw-drop-shadow`, _(r3, `,`).map((e4) => `drop-shadow(${e4})`).join(` `)), B(`filter`, a3)];
      }
      if (t3.value.kind === `arbitrary`) {
        let r3 = t3.value.value;
        return (t3.value.dataType ?? y(r3, [`color`])) === `color` ? (r3 = K(r3, t3.modifier, e3), r3 === null ? void 0 : [s3(), B(`--tw-drop-shadow-color`, G(r3, `var(--tw-drop-shadow-alpha)`)), B(`--tw-drop-shadow`, `var(--tw-drop-shadow-size)`)]) : t3.modifier && !n3 ? void 0 : [s3(), B(`--tw-drop-shadow-alpha`, n3), ...En(`--tw-drop-shadow-size`, r3, n3, (e4) => `var(--tw-drop-shadow-color, ${e4})`), B(`--tw-drop-shadow`, `var(--tw-drop-shadow-size)`), B(`filter`, a3)];
      }
      {
        let r3 = e3.get([`--drop-shadow-${t3.value.value}`]), i3 = e3.resolve(t3.value.value, [`--drop-shadow`]);
        if (r3 && i3) return t3.modifier && !n3 ? void 0 : n3 ? [s3(), B(`--tw-drop-shadow-alpha`, n3), ...En(`--tw-drop-shadow-size`, r3, n3, (e4) => `var(--tw-drop-shadow-color, ${e4})`), B(`--tw-drop-shadow`, `var(--tw-drop-shadow-size)`), B(`filter`, a3)] : [s3(), B(`--tw-drop-shadow-alpha`, n3), ...En(`--tw-drop-shadow-size`, r3, n3, (e4) => `var(--tw-drop-shadow-color, ${e4})`), B(`--tw-drop-shadow`, _(i3, `,`).map((e4) => `drop-shadow(${e4})`).join(` `)), B(`filter`, a3)];
      }
      {
    ...
    }), n2(`drop-shadow`, () => [{ values: [`current`, `inherit`, `transparent`], valueThemeKeys: [`--drop-shadow-color`, `--color`], modifiers: Array.from({ length: 21 }, (e4, t3) => `${t3 * 5}`) }, { valueThemeKeys: [`--drop-shadow`] }]), i2(`backdrop-opacity`, { themeKeys: [`--backdrop-opacity`, `--opacity`], handleBareValue: ({ value: e4 }) => be(e4) ? `${e4}%` : null, handle: (e4) => [c3(), B(`--tw-backdrop-opacity`, `opacity(${e4})`), B(`-webkit-backdrop-filter`, o3), B(`backdrop-filter`, o3)] }), n2(`backdrop-opacity`, () => [{ values: Array.from({ length: 21 }, (e4, t3) => `${t3 * 5}`), valueThemeKeys: [`--backdrop-opacity`, `--opacity`] }]);
  }
  {
  ...
  r2(`text-shadow-initial`, [w2, [`--tw-text-shadow-color`, `initial`]]), t2.functional(`text-shadow`, (t3) => {
    ...
    if (t3.modifier && (t3.modifier.kind === `arbitrary` ? n3 = t3.modifier.value : E(t3.modifier.value) && (n3 = `${t3.modifier.value}%`)), !t3.value) {
      ...
      return t4 === null ? void 0 : [w2(), B(`--tw-text-shadow-alpha`, n3), ...Tn(`text-shadow`, t4, n3, (e4) => `var(--tw-text-shadow-color, ${e4})`)];
    }
    if (t3.value.kind === `arbitrary`) {
      let r3 = t3.value.value;
      return (t3.value.dataType ?? y(r3, [`color`])) === `color` ? (r3 = K(r3, t3.modifier, e3), r3 === null ? void 0 : [w2(), B(`--tw-text-shadow-color`, G(r3, `var(--tw-text-shadow-alpha)`))]) : [w2(), B(`--tw-text-shadow-alpha`, n3), ...Tn(`text-shadow`, r3, n3, (e4) => `var(--tw-text-shadow-color, ${e4})`)];
    }
    ...
    }
    {
      ...
      if (r3) return [w2(), B(`--tw-text-shadow-alpha`, n3), ...Tn(`text-shadow`, r3, n3, (e4) => `var(--tw-text-shadow-color, ${e4})`)];
    }
    {
  ...
  }), n2(`text-shadow`, () => [{ values: [`current`, `inherit`, `transparent`], valueThemeKeys: [`--text-shadow-color`, `--color`], modifiers: Array.from({ length: 21 }, (e4, t3) => `${t3 * 5}`) }, { values: [`none`] }, { valueThemeKeys: [`--text-shadow`], modifiers: Array.from({ length: 21 }, (e4, t3) => `${t3 * 5}`), hasDefaultValue: e3.get([`--text-shadow`]) !== null }]);
  {
    ...
    r2(`shadow-initial`, [c3, [`--tw-shadow-color`, `initial`]]), t2.functional(`shadow`, (t3) => {
      ...
      if (t3.modifier && (t3.modifier.kind === `arbitrary` ? n3 = t3.modifier.value : E(t3.modifier.value) && (n3 = `${t3.modifier.value}%`)), !t3.value) {
        ...
        return t4 === null ? void 0 : [c3(), B(`--tw-shadow-alpha`, n3), ...Tn(`--tw-shadow`, t4, n3, (e4) => `var(--tw-shadow-color, ${e4})`), B(`box-shadow`, o3)];
      }
      if (t3.value.kind === `arbitrary`) {
        let r3 = t3.value.value;
        return (t3.value.dataType ?? y(r3, [`color`])) === `color` ? (r3 = K(r3, t3.modifier, e3), r3 === null ? void 0 : [c3(), B(`--tw-shadow-color`, G(r3, `var(--tw-shadow-alpha)`))]) : [c3(), B(`--tw-shadow-alpha`, n3), ...Tn(`--tw-shadow`, r3, n3, (e4) => `var(--tw-shadow-color, ${e4})`), B(`box-shadow`, o3)];
      }
      switch (t3.value.value) {
        case `none`:
      ...
      }
      {
        ...
        if (r3) return [c3(), B(`--tw-shadow-alpha`, n3), ...Tn(`--tw-shadow`, r3, n3, (e4) => `var(--tw-shadow-color, ${e4})`), B(`box-shadow`, o3)];
      }
      {
      ...
      if (t3.modifier && (t3.modifier.kind === `arbitrary` ? n3 = t3.modifier.value : E(t3.modifier.value) && (n3 = `${t3.modifier.value}%`)), !t3.value) {
        ...
        return t4 === null ? void 0 : [c3(), B(`--tw-inset-shadow-alpha`, n3), ...Tn(`--tw-inset-shadow`, t4, n3, (e4) => `var(--tw-inset-shadow-color, ${e4})`), B(`box-shadow`, o3)];
      }
      if (t3.value.kind === `arbitrary`) {
        let r3 = t3.value.value;
        return (t3.value.dataType ?? y(r3, [`color`])) === `color` ? (r3 = K(r3, t3.modifier, e3), r3 === null ? void 0 : [c3(), B(`--tw-inset-shadow-color`, G(r3, `var(--tw-inset-shadow-alpha)`))]) : [c3(), B(`--tw-inset-shadow-alpha`, n3), ...Tn(`--tw-inset-shadow`, r3, n3, (e4) => `var(--tw-inset-shadow-color, ${e4})`, `inset`), B(`box-shadow`, o3)];
      }
      switch (t3.value.value) {
        case `none`:
          return t3.modifier ? void 0 : [c3(), B(`--tw-inset-shadow`, `inset ${s3}`), B(`box-shadow`, o3)];
        case `inherit`:
          return t3.modifier ? void 0 : [c3(), B(`--tw-inset-shadow-color`, `inherit`)];
      }
      {
        let r3 = e3.get([`--inset-shadow-${t3.value.value}`]);
        if (r3) return [c3(), B(`--tw-inset-shadow-alpha`, n3), ...Tn(`--tw-inset-shadow`, r3, n3, (e4) => `var(--tw-inset-shadow-color, ${e4})`), B(`box-shadow`, o3)];
      }
      {
        let n4 = q(t3, e3, [`--box-shadow-color`, `--color`]);
    ...
    t2.functional(`ring`, (t3) => {
      ...
      if (t3.value.kind === `arbitrary`) {
        let n3 = t3.value.value;
        return (t3.value.dataType ?? y(n3, [`color`, `length`])) === `length` ? t3.modifier ? void 0 : [c3(), B(`--tw-ring-shadow`, i3(n3)), B(`box-shadow`, o3)] : (n3 = K(n3, t3.modifier, e3), n3 === null ? void 0 : [B(`--tw-ring-color`, n3)]);
      }
      {
      ...
      if (t3.value.kind === `arbitrary`) {
        let n3 = t3.value.value;
        return (t3.value.dataType ?? y(n3, [`color`, `length`])) === `length` ? t3.modifier ? void 0 : [c3(), B(`--tw-inset-ring-shadow`, a3(n3)), B(`box-shadow`, o3)] : (n3 = K(n3, t3.modifier, e3), n3 === null ? void 0 : [B(`--tw-inset-ring-color`, n3)]);
      }
      {
        let n3 = q(t3, e3, [`--ring-color`, `--color`]);
    ...
    t2.functional(`ring-offset`, (t3) => {
      if (t3.value) {
        if (t3.value.kind === `arbitrary`) {
          let n3 = t3.value.value;
          return (t3.value.dataType ?? y(n3, [`color`, `length`])) === `length` ? t3.modifier ? void 0 : [B(`--tw-ring-offset-width`, n3), B(`--tw-ring-offset-shadow`, u3)] : (n3 = K(n3, t3.modifier, e3), n3 === null ? void 0 : [B(`--tw-ring-offset-color`, n3)]);
        }
        {
  ...
  return n2(`ring-offset`, () => [{ values: [`current`, `inherit`, `transparent`], valueThemeKeys: [`--ring-offset-color`, `--color`], modifiers: Array.from({ length: 21 }, (e4, t3) => `${t3 * 5}`) }, { values: [`0`, `1`, `2`, `4`, `8`], valueThemeKeys: [`--ring-offset-width`] }]), t2.functional(`@container`, (e4) => {
    let t3 = null;
    if (e4.value === null ? t3 = `inline-size` : e4.value.kind === `arbitrary` ? t3 = e4.value.value : e4.value.kind === `named` && e4.value.value === `normal` ? t3 = `normal` : e4.value.kind === `named` && e4.value.value === `size` && (t3 = `size`), t3 !== null) return e4.modifier ? [B(`container-type`, t3), B(`container-name`, e4.modifier.value)] : [B(`container-type`, t3)];
  }), n2(`@container`, () => [{ values: [`normal`], valueThemeKeys: [], hasDefaultValue: true }]), t2;
}
var Sn = [`number`, `integer`, `ratio`, `percentage`];
function Cn(e3) {
  let t2 = Ae(e3.params);
  return Bn(t2) ? (n2) => {
    ...
    I(e3.nodes, (e4) => {
      ...
      I(t3, (e5) => {
        ...
        } else if (t5.kind === `word` && !(t5.value[0] === `[` && t5.value[t5.value.length - 1] === `]`) && !Sn.includes(t5.value)) {
          console.warn(`Unsupported bare value data type: "${t5.value}".
Only valid data types are: ${Sn.map((e6) => `"${e6}"`).join(`, `)}.
`);
...
`);
      ...
      let r3 = H(e3), i2 = t3.value, a2 = t3.modifier, o2 = false, s2 = false, c2 = false, l2 = false, u2 = /* @__PURE__ */ new Map(), d2 = false;
      if (I([r3], (e4, t4) => {
        let r4 = t4.parent;
        ...
        if (I(p2, (t5) => {
          if (t5.kind === `function`) {
            if (t5.value === `--value`) {
              o2 = true;
              let a3 = wn(i2, t5, n2);
              return a3 ? (s2 = true, a3.ratio ? d2 = true : u2.set(e4, r4), F.ReplaceSkip(a3.nodes)) : (f2 = true, F.Stop);
            } else if (t5.value === `--modifier`) {
              c2 = true;
              let e5 = wn(a2, t5, n2);
              return e5 ? (l2 = true, F.ReplaceSkip(e5.nodes)) : (f2 = true, F.Stop);
            }
          }
      ...
      for (let [i2, { literals: a2, usedSpacingNumber: o2, usedSpacingInteger: s2, themeKeys: c2 }] of [[e4, r2[`--value`]], [t3, r2[`--modifier`]]]) {
        ...
        if (o2) i2.push(..._n);
        else if (s2) for (let e5 of _n) E(e5) && i2.push(e5);
        for (let e5 of n2.theme.keysInNamespaces(c2)) i2.push(e5.replace(bn, (e6, t4, n3) => `${t4}.${n3}`));
      }
...
function wn(e3, t2, n2) {
  ...
  for (let r2 of t2.nodes) {
    ...
    if (e3.kind === `named` && r2.kind === `word` && r2.value[0] === `-` && r2.value[1] === `-`) {
      ...
      if (!Sn.includes(r2.value)) continue;
      ...
      if (`dataType` in e3 && e3.dataType || y(e3.value, [t3]) !== null) return { nodes: P(e3.value) };
    }
  }
}
function Tn(e3, t2, n2, r2, i2 = ``) {
  let a2 = false, o2 = gn(t2, (e4) => n2 == null ? r2(e4) : e4.startsWith(`current`) ? r2(G(e4, n2)) : ((e4.startsWith(`var(`) || n2.startsWith(`var(`)) && (a2 = true), r2(yn(e4, n2))));
  function s2(e4) {
    return i2 ? _(e4, `,`).map((e5) => i2.trim() + ` ` + e5.trim()).join(`, `) : e4;
  }
  return a2 ? [B(e3, s2(gn(t2, r2))), z(`@supports (color: lab(from red l a b))`, [B(e3, s2(o2))])] : [B(e3, s2(o2))];
}
function En(e3, t2, n2, r2, i2 = ``) {
  let a2 = false, o2 = _(t2, `,`).map((e4) => gn(e4, (e5) => n2 == null ? r2(e5) : e5.startsWith(`current`) ? r2(G(e5, n2)) : ((e5.startsWith(`var(`) || n2.startsWith(`var(`)) && (a2 = true), r2(yn(e5, n2))))).map((e4) => `drop-shadow(${e4})`).join(` `);
  return a2 ? [B(e3, i2 + _(t2, `,`).map((e4) => `drop-shadow(${gn(e4, r2)})`).join(` `)), z(`@supports (color: lab(from red l a b))`, [B(e3, i2 + o2)])] : [B(e3, i2 + o2)];
}
var Dn = /^-?[a-z][a-zA-Z0-9_-]*/, On = 37, kn = 47, An = 46, jn = 97, Mn = 122, Nn = 65, Pn = 90, Fn = 48, In = 57, Ln = 95, Rn = 45;
function zn(e3) {
  let t2 = Dn.exec(e3);
  ...
  for (let e4 = 0; e4 < r2.length; e4++) {
    ...
    switch (t3) {
      ...
      case Rn:
        continue;
      default:
        if (t3 >= jn && t3 <= Mn || t3 >= Nn && t3 <= Pn || t3 >= Fn && t3 <= In) continue;
        return false;
    }
  }
  return true;
...
var Vn = { "--alpha": Hn, "--spacing": Un, "--theme": Wn, theme: Gn };
...
function Wn(e3, t2, n2, ...r2) {
  ...
  if (a2.startsWith(`var(`) || a2.startsWith(`theme(`) || a2.startsWith(`--theme(`)) {
    let e4 = P(a2);
    return Xn(e4, o2), N(e4);
  }
  return a2;
}
function Gn(e3, t2, n2, ...r2) {
  n2 = Yn(n2);
...
var Kn = new RegExp(Object.keys(Vn).map((e3) => `${e3}\\(`).join(`|`));
function qn(e3, t2) {
  let n2 = 0;
  return I(e3, (e4) => {
    if (e4.kind === `declaration` && e4.value && Kn.test(e4.value)) {
      n2 |= 8, e4.value = Jn(e4.value, e4, t2);
      return;
    }
    e4.kind === `at-rule` && (e4.name === `@media` || e4.name === `@custom-media` || e4.name === `@container` || e4.name === `@supports`) && Kn.test(e4.params) && (n2 |= 8, e4.params = Jn(e4.params, e4, t2));
  }), n2;
}
function Jn(e3, t2, n2) {
  let r2 = P(e3);
  return I(r2, (e4) => {
    if (e4.kind === `function` && e4.value in Vn) {
      let r3 = _(N(e4.nodes).trim(), `,`).map((e5) => e5.trim()), i2 = Vn[e4.value](n2, t2, ...r3);
...
function Qn(e3) {
  ...
  if (o2 = e3.charCodeAt(t2), o2 === 39 || o2 === 34) {
    ...
    for (n2 = t2; t2 < r2 && !$n(e3.charCodeAt(t2)); ) t2++;
    s2 = e3.slice(n2, t2);
  }
  for (; $n(e3.charCodeAt(t2)); ) t2++;
...
function tr(e3, t2) {
  let n2 = e3.kind === `word` ? U.get(e3.value) : null, r2 = t2.kind === `word` ? U.get(t2.value) : null;
...
function rr(e3, { theme: t2 }, n2) {
  ...
  if (Object.hasOwn(t2, `fontFamily`)) {
    {
      let n3 = nr(t2.fontFamily.sans);
      n3 && e3.theme.hasDefault(`--font-sans`) && (e3.theme.add(`--default-font-family`, n3, 5), e3.theme.add(`--default-font-feature-settings`, nr(t2.fontFamily.sans, `fontFeatureSettings`) ?? `normal`, 5), e3.theme.add(`--default-font-variation-settings`, nr(t2.fontFamily.sans, `fontVariationSettings`) ?? `normal`, 5));
    }
    {
      let n3 = nr(t2.fontFamily.mono);
      n3 && e3.theme.hasDefault(`--font-mono`) && (e3.theme.add(`--default-mono-font-family`, n3, 5), e3.theme.add(`--default-mono-font-feature-settings`, nr(t2.fontFamily.mono, `fontFeatureSettings`) ?? `normal`, 5), e3.theme.add(`--default-mono-font-variation-settings`, nr(t2.fontFamily.mono, `fontVariationSettings`) ?? `normal`, 5));
    }
  }
  return t2;
}
function ir(e3) {
  let t2 = [];
  return dr(e3, [], (e4, n2) => {
    if (lr(e4)) return t2.push([n2, e4]), 1;
    if (ur(e4)) {
      t2.push([n2, e4[0]]);
...
var ar = { borderWidth: `border-width`, outlineWidth: `outline-width`, ringColor: `ring-color`, ringWidth: `ring-width`, transitionDuration: `transition-duration`, transitionTimingFunction: `transition-timing-function` }, or = { animation: `animate`, aspectRatio: `aspect`, borderRadius: `radius`, boxShadow: `shadow`, colors: `color`, containers: `container`, fontFamily: `font`, fontSize: `text`, letterSpacing: `tracking`, lineHeight: `leading`, maxWidth: `container`, screens: `breakpoint`, transitionTimingFunction: `ease` }, sr = /^[a-zA-Z0-9-_%/.]+$/;
function cr(e3) {
  let t2 = ar[e3[0]];
  if (t2 && e3[1] === `DEFAULT`) return `default-${t2}`;
  if (e3[0] === `container`) return null;
  for (let t3 of e3) if (!sr.test(t3)) return null;
  let n2 = or[e3[0]];
...
function dr(e3, t2 = [], n2) {
  for (let r2 of Reflect.ownKeys(e3)) {
    ...
    if (o2 !== 1 && (o2 === 2 || !(!Array.isArray(i2) && typeof i2 != `object`) && dr(i2, a2, n2) === 2)) return 2;
  }
}
function fr(e3, t2 = null, n2 = true) {
  let [r2, i2] = pr(P(e3), t2, n2);
  return r2 ? N(i2) : e3;
}
function pr(e3, t2 = null, n2 = true) {
  let r2 = false;
  return I(e3, { exit(e4, i2) {
    if (e4.kind === `word` && e4.value !== `0`) {
      let a2 = mr(e4.value, t2, n2);
      if (a2 === null || a2 === e4.value) return;
      if (a2 === `0` && i2.parent?.kind === `function`) {
        let n3 = mr(e4.value, t2, false);
        return n3 === null ? void 0 : (r2 = true, F.ReplaceSkip(M(n3)));
      }
      return r2 = true, F.ReplaceSkip(M(a2));
    } else if (e4.kind === `function` && (e4.value === `calc` || e4.value === ``)) {
      if (e4.nodes.length !== 5 || e4.nodes[2].kind !== `word`) return;
      let t3 = e4.nodes[0], n3 = e4.nodes[2].value, a2 = e4.nodes[4], o2 = t3.kind === `word` ? U.get(t3.value) : null, s2 = a2.kind === `word` ? U.get(a2.value) : null;
      if (n3 === `*` && (o2?.[0] === 0 && o2?.[1] === null || s2?.[0] === 0 && s2?.[1] === null)) return r2 = true, F.ReplaceSkip(M(`0`));
      if (n3 === `*` && o2?.[0] === 0 && o2?.[1] !== null && s2?.[1] === null) return r2 = true, i2.parent?.kind === `function` ? F.ReplaceSkip(M(`0${o2[1]}`)) : F.ReplaceSkip(M(`0`));
      if (n3 === `*` && s2?.[0] === 0 && s2?.[1] !== null && o2?.[1] === null) return r2 = true, i2.parent?.kind === `function` ? F.ReplaceSkip(M(`0${s2[1]}`)) : F.ReplaceSkip(M(`0`));
      if (n3 === `*`) {
        if (o2?.[0] === 1 && o2?.[1] === null) return r2 = true, F.ReplaceSkip(a2);
        if (s2?.[0] === 1 && s2?.[1] === null) return r2 = true, F.ReplaceSkip(t3);
      }
      if (n3 === `*` || n3 === `+`) {
        ...
        if (i3 !== null && c2 !== null && c2.kind === `function` && (c2.value === `calc` || c2.value === ``) && c2.nodes.length === 5 && c2.nodes[2].kind === `word` && c2.nodes[2].value === n3) {
          let t4 = c2.nodes[0], a3 = c2.nodes[4], o3 = t4.kind === `word` ? U.get(t4.value) : null, s3 = a3.kind === `word` ? U.get(a3.value) : null, l2 = o3 ?? s3, u2 = o3 === null ? t4 : s3 === null ? a3 : null;
          if (l2 !== null && u2 !== null) {
            ...
            if (r2 = true, n3 === `*` && t5 === `1`) return F.ReplaceSkip(u2);
            let a4 = { kind: `function`, value: e4.value, nodes: [M(t5), e4.nodes[1], e4.nodes[2], e4.nodes[3], u2] };
            return F.ReplaceSkip(a4);
          }
        }
      }
      ...
      switch (n3) {
        case `*`:
          if (o2[1] === s2[1] || o2[1] === null && s2[1] !== null || o2[1] !== null && s2[1] === null) return r2 = true, F.ReplaceSkip(M(`${o2[0] * s2[0]}${o2[1] ?? s2[1] ?? ``}`));
          break;
        case `+`:
          if (o2[1] === s2[1]) return r2 = true, F.ReplaceSkip(M(`${o2[0] + s2[0]}${o2[1] ?? ``}`));
          break;
        case `-`:
          if (o2[1] === s2[1]) return r2 = true, F.ReplaceSkip(M(`${o2[0] - s2[0]}${o2[1] ?? ``}`));
          break;
        case `/`:
          if (s2[0] !== 0 && (o2[1] === null && s2[1] === null || o2[1] !== null && s2[1] === null)) {
            ...
            return r2 = true, F.ReplaceSkip(M(`${e5}${o2[1] ?? ``}`));
          }
          break;
      }
    }
...
function mr(e3, t2 = null, n2 = true) {
  let r2 = U.get(e3);
  if (r2 === null) return null;
  let [i2, a2] = r2;
  if (a2 === null) return `${i2}`;
  if (i2 === 0 && fe(e3)) return n2 ? `0` : `0${a2}`;
  if (!n2) return `${e3}`;
...
function hr(e3, t2 = `top`, n2 = `right`, r2 = `bottom`, i2 = `left`) {
  return gr(`${e3}-${t2}`, `${e3}-${n2}`, `${e3}-${r2}`, `${e3}-${i2}`);
}
function gr(e3 = `top`, t2 = `right`, n2 = `bottom`, r2 = `left`) {
...
var _r = { inset: gr(), margin: hr(`margin`), padding: hr(`padding`), "scroll-margin": hr(`scroll-margin`), "scroll-padding": hr(`scroll-padding`), "border-width": hr(`border`, `top-width`, `right-width`, `bottom-width`, `left-width`), "border-style": hr(`border`, `top-style`, `right-style`, `bottom-style`, `left-style`), "border-color": hr(`border`, `top-color`, `right-color`, `bottom-color`, `left-color`), gap: J(`row-gap`, `column-gap`), overflow: J(`overflow-x`, `overflow-y`), "overscroll-behavior": J(`overscroll-behavior-x`, `overscroll-behavior-y`) }, vr = { "inset-block": J(`top`, `bottom`), "inset-inline": J(`left`, `right`), "margin-block": J(`margin-top`, `margin-bottom`), "margin-inline": J(`margin-left`, `margin-right`), "padding-block": J(`padding-top`, `padding-bottom`), "padding-inline": J(`padding-left`, `padding-right`), "scroll-margin-block": J(`scroll-margin-top`, `scroll-margin-bottom`), "scroll-margin-inline": J(`scroll-margin-left`, `scroll-margin-right`), "scroll-padding-block": J(`scroll-padding-top`, `scroll-padding-bottom`), "scroll-padding-inline": J(`scroll-padding-left`, `scroll-padding-right`) }, yr = { "border-block": [`border-bottom`, `border-top`], "border-block-color": [`border-bottom-color`, `border-top-color`], "border-block-style": [`border-bottom-style`, `border-top-style`], "border-block-width": [`border-bottom-width`, `border-top-width`], "border-inline": [`border-left`, `border-right`], "border-inline-color": [`border-left-color`, `border-right-color`], "border-inline-style": [`border-left-style`, `border-right-style`], "border-inline-width": [`border-left-width`, `border-right-width`] };
function br(e3, t2) {
  if (t2 & 2) {
    if (e3.property in vr) {
      let t3 = _(e3.value, ` `);
      return vr[e3.property][t3.length]?.map(([n2, r2]) => B(n2, t3[r2], e3.important));
    }
    if (e3.property in yr) return yr[e3.property]?.map((t3) => B(t3, e3.value, e3.important));
  }
  if (e3.property in _r) {
    let t3 = _(e3.value, ` `);
    return _r[e3.property][t3.length]?.map(([n2, r2]) => B(n2, t3[r2], e3.important));
  }
  return null;
}
function xr(e3) {
...
function Y(e3, t2 = false) {
  ...
  for (let r2 of e3) switch (r2.kind) {
    ...
    case `compound`:
      ...
      break;
    case `list`:
      n2 += r2.nodes.map((e4) => Y([e4], t2)).join(t2 ? `,` : `, `);
      break;
  }
  return n2;
}
var Or = 92, kr = 93, Ar = 41, jr = 58, Mr = 44, Nr = 34, Pr = 46, Fr = 62, Ir = 10, Lr = 35, Rr = 91, zr = 40, Br = 43, Vr = 39, Hr = 32, Ur = 9, Wr = 126, Gr = 38, Kr = 42;
function qr(e3) {
  e3 = e3.replaceAll(`\r
`, `
`);
  ...
  function c2(e4 = n2) {
    return e4.length === 1 ? e4[0] : r2 ? Sr(e4) : Cr(e4);
  }
  function l2(e4) {
    let t3 = n2[n2.length - 1];
    t3?.kind === `compound` ? t3.nodes.push(e4) : t3 && t3.kind !== `list` && t3.kind !== `combinator` ? n2[n2.length - 1] = Cr([t3, e4]) : n2.push(e4);
  }
  for (let u2 = 0; u2 < e3.length; u2++) {
    let d2 = e3.charCodeAt(u2);
    switch (d2) {
      case Mr:
        for (o2.length > 0 && (l2(Er(o2)), o2 = ``); u2 + 1 < e3.length && (s2 = e3.charCodeAt(u2 + 1), !(s2 !== Ir && s2 !== Hr && s2 !== Ur)); u2++) ;
        if (a2) a2.nodes.push(c2()), n2 = [], r2 = false;
        else {
          let e4 = Tr([c2(n2.splice(0))]);
      ...
      case Ur:
      case Wr: {
        o2.length > 0 && (l2(Er(o2)), o2 = ``);
        let t3 = u2, i3 = u2 + 1;
        for (; i3 < e3.length && (s2 = e3.charCodeAt(i3), !(s2 !== Fr && s2 !== Ir && s2 !== Hr && s2 !== Br && s2 !== Ur && s2 !== Wr)); i3++) ;
        u2 = i3 - 1;
        let a3 = e3.slice(t3, i3).trim();
        if (a3 === `` && (n2.length === 0 || i3 >= e3.length || e3.charCodeAt(i3) === Mr)) break;
        n2.push(xr(a3 === `` ? ` ` : a3)), r2 = true;
        break;
      }
      case zr: {
        let t3 = wr(o2, []);
        if (o2 = ``, t3.value !== `:not` && t3.value !== `:where` && t3.value !== `:has` && t3.value !== `:is`) {
          ...
          let i3 = u2;
          t3.nodes.push(Dr(e3.slice(n3, i3))), o2 = ``, u2 = i3, l2(t3);
          break;
        }
      ...
      case Ar: {
        o2.length > 0 && (l2(Er(o2)), o2 = ``), a2 ? a2.nodes.push(c2()) : r2 && n2.splice(0, n2.length, Sr(n2.splice(0)));
        let e4 = i2.pop();
      ...
      case Lr:
        ...
        o2.length > 0 && l2(Er(o2)), o2 = e3[u2];
        break;
      case Rr: {
        o2.length > 0 && l2(Er(o2)), o2 = ``;
        let t3 = u2, n3 = 0;
        for (let t4 = u2 + 1; t4 < e3.length; t4++) {
          if (s2 = e3.charCodeAt(t4), s2 === Rr) {
            n3++;
            continue;
          }
          if (s2 === kr) {
      ...
      case Nr: {
        let t3 = u2;
        for (let t4 = u2 + 1; t4 < e3.length; t4++) if (s2 = e3.charCodeAt(t4), s2 === Or) t4 += 1;
        else if (s2 === d2) {
          u2 = t4;
          break;
        }
      ...
      case Gr:
      case Kr:
        o2.length > 0 && (l2(Er(o2)), o2 = ``), l2(Er(e3[u2]));
        break;
      case Or:
  ...
  return o2.length > 0 && l2(Er(o2)), a2 ? a2.nodes.push(c2()) : r2 && n2.splice(0, n2.length, Sr(n2.splice(0))), t2;
}
function X(e3, t2) {
...
function Yr(e3, t2) {
  ...
  let n2 = e3;
  return (_a3 = n2.storage)[Xr] ?? (_a3[Xr] = Zr()), (_b = n2.storage)[ti] ?? (_b[ti] = ni(n2)), (_c = n2.storage)[oi] ?? (_c[oi] = si()), (_d = n2.storage)[li] ?? (_d[li] = ui()), (_e2 = n2.storage)[fi] ?? (_e2[fi] = pi()), (_f = n2.storage)[bi] ?? (_f[bi] = xi(n2)), (_g = n2.storage)[Ei] ?? (_g[Ei] = Ai(n2, t2)), (_h = n2.storage)[Ji] ?? (_h[Ji] = Yi(n2)), (_i2 = n2.storage)[Qi] ?? (_i2[Qi] = $i()), (_j = n2.storage)[ea] ?? (_j[ea] = ta(n2)), (_k = n2.storage)[na] ?? (_k[na] = ra(n2)), (_l = n2.storage)[ia] ?? (_l[ia] = aa(n2)), (_m = n2.storage)[oa] ?? (_m[oa] = sa(n2)), (_n2 = n2.storage)[Qr] ?? (_n2[Qr] = $r(n2)), n2;
}
var Xr = /* @__PURE__ */ Symbol();
function Zr() {
  return new j((e3) => new j((t2) => ({ rem: e3, features: t2 })));
}
var Qr = /* @__PURE__ */ Symbol();
function $r(e3) {
  return new j((t2) => {
    let n2 = e3.storage[Ji].get(t2);
...
function ei(e3, t2) {
  let n2 = 0;
  return t2?.collapse && (n2 |= 1), t2?.logicalToPhysical && (n2 |= 2), Yr(e3, t2).storage[Xr].get(t2?.rem ?? null).get(n2);
}
...
function ri(e3, t2, n2) {
  let r2 = 0;
  return n2?.collapse && (r2 |= 1), Yr(e3).storage[ti].get(t2).get(r2);
}
function ii(e3, t2, n2) {
  let r2 = ri(e3, ei(e3, n2), n2), i2 = Yr(e3), a2 = /* @__PURE__ */ new Set(), o2 = i2.storage[oi].get(r2);
  for (let e4 of t2) a2.add(o2.get(e4));
  return a2.size <= 1 || !(r2.features & 1) ? Array.from(a2) : ai(r2, Array.from(a2));
}
function ai(e3, t2) {
  ...
  function o2(t3) {
    let r3 = e3.signatureOptions, i3 = n2.storage[ea].get(r3), a3 = n2.storage[Qi].get(r3), o3 = t3.map((e4) => i3.get(e4));
    if (o3.some((e4) => e4.has(`line-height`))) {
      ...
      if (e4.length > 0) {
        ...
        for (let a5 of o3) if (a5.has(`line-height`)) for (let o4 of a5.get(`line-height`)) {
          ...
          r4.add(o4);
          let a6 = n2.storage[Ei]?.get(o4) ?? null;
          if (a6 !== null) if (D(a6)) {
            t4.add(a6);
    ...
    let s2 = new j((e4) => {
      ...
      for (let a4 of Z(n2, e4)) if (!(a4.kind !== `functional` || a4.value === null)) {
        for (let e5 of n2.utilities.keys(`functional`)) {
          ...
          let o4 = Ti(n2, { ...Gt(a4), root: e5 }), s3 = i3.get(o4);
      ...
      for (let i4 of e4.keys()) {
        ...
        if (r4 = r4 === null ? o4 : ua(r4, o4), r4.size === 0) return r4;
      }
    ...
    for (let e4 of u2.values()) for (let i4 of la(e4)) {
      if (i4.some((e6) => f2.has(t3[e6]))) continue;
      let e5 = i4.flatMap((e6) => c2[e6]).reduce(ua), a4 = n2.storage[Ji].get(r3).get(i4.map((e6) => t3[e6]).sort((e6, t4) => e6.localeCompare(t4)).join(` `));
      for (let o4 of e5) if (n2.storage[Ji].get(r3).get(o4) === a4) {
        d2.add(o4);
...
function si() {
  return new j((e3) => {
    let t2 = e3.designSystem, n2 = t2.theme.prefix ? `${t2.theme.prefix}:` : ``, r2 = t2.storage[li].get(e3), i2 = t2.storage[fi].get(e3);
    return new j((e4, a2) => {
...
var ci = [_i, Vi, Gi, Ri], li = /* @__PURE__ */ Symbol();
function ui() {
  return new j((e3) => new j((t2) => {
    let n2 = [t2];
    for (let t3 of ci) for (let r2 of n2.splice(0)) {
      let i2 = t3(Kt(r2), e3);
      if (Array.isArray(i2)) {
        n2.push(...i2);
        continue;
...
var di = [hi, gi, vi, Ki, ji, Ni, Li, zi, Bi, qi], fi = /* @__PURE__ */ Symbol();
function pi() {
  return new j((e3) => {
...
var mi = [`t`, `tr`, `r`, `br`, `b`, `bl`, `l`, `tl`];
function hi(e3) {
  if (e3.kind === `static` && e3.root.startsWith(`bg-gradient-to-`)) {
    let t2 = e3.root.slice(15);
    return mi.includes(t2) && (e3.root = `bg-linear-to-${t2}`), e3;
  }
  return e3;
}
function gi(e3, t2) {
  let n2 = t2.designSystem.storage[bi];
...
function _i(e3, t2) {
  let n2 = t2.designSystem.storage[bi], r2 = wi(e3);
...
function vi(e3, t2) {
  return e3.kind === `arbitrary` ? e3.value = yi(e3.value, t2.designSystem) : e3.kind === `functional` && e3.value?.kind === `arbitrary` && (e3.value.value = yi(e3.value.value, t2.designSystem)), e3;
}
function yi(e3, t2) {
...
function xi(e3) {
  ...
  function t2(e4) {
    function t3(e5, t4 = 0) {
      ...
      if (o2 === 0) return [Si(n3, r2), null];
      if (o2 > 1) return [Si(n3, i2), null];
      let s2 = null;
      return [Si(n3, (e6, a3) => {
...
var Ei = /* @__PURE__ */ Symbol(), Di = 1536, Oi = Di / 16;
function ki(e3, t2, n2) {
  let r2 = t2.resolveThemeValue(`--spacing`);
  if (r2 === void 0) return false;
  let i2 = U.get(fr(r2, n2));
  if (i2 === null) return false;
  let [a2, o2] = i2, s2 = e3 * a2;
  return o2 === `px` ? s2 <= Di : o2 === `rem` ? s2 <= Oi : false;
}
function Ai(e3, t2) {
  let n2 = e3.resolveThemeValue(`--spacing`);
  if (n2 === void 0) return null;
  n2 = fr(n2, t2?.rem ?? null);
  let r2 = U.get(n2);
  if (!r2) return null;
  let [i2, a2] = r2;
  return new j((e4) => {
    if (i2 === 0) return null;
    let n3 = U.get(fr(e4, t2?.rem ?? null));
    if (!n3) return null;
    let [r3, o2] = n3;
...
function ji(e3, t2) {
  ...
  let n2 = t2.designSystem, r2 = n2.storage[na].get(t2.signatureOptions), i2 = n2.storage[Ji].get(t2.signatureOptions), a2 = n2.storage[Qr].get(t2.signatureOptions), o2 = n2.printCandidate(e3), s2 = i2.get(o2);
  if (typeof s2 != `string`) return e3;
  for (let t3 of c2(s2, e3)) if (a2(e3, t3) && Mi(n2, e3, t3)) return t3;
  return e3;
  function* c2(e4, a3) {
    let o3 = r2.get(e4);
    if (o3.length > 1) {
    ...
    if (o3.length === 1) for (let e5 of Z(n2, o3[0])) yield e5;
      ...
      if (t2.signatureOptions.rem !== null && a3.kind === `functional` && a3.value?.kind === `arbitrary`) {
        let r4 = n2.storage[Ei]?.get(e5) ?? null;
        r4 !== null && D(r4) && ki(r4, n2, t2.signatureOptions.rem) && (yield Object.assign({}, a3, { value: { kind: `named`, value: r4, fraction: null } }));
      }
      let r3 = n2.storage[Ei]?.get(e5) ?? null, i3 = ``;
      ...
      for (let o4 of Array.from(n2.utilities.keys(`functional`)).sort((e6, t3) => (e6[0] === `-`) - +(t3[0] === `-`))) {
        ...
        if (r3 !== null && D(r3) && ki(r3, n2, t2.signatureOptions.rem)) {
          for (let e6 of Z(n2, `${o4}-${r3}`)) yield e6;
          if (a3.modifier) for (let e6 of Z(n2, `${o4}-${r3}${Qt(a3.modifier)}`)) yield e6;
        }
        for (let t3 of Z(n2, `${o4}-[${e5}]`)) yield t3;
        if (a3.modifier) for (let t3 of Z(n2, `${o4}-[${e5}]${Qt(a3.modifier)}`)) yield t3;
      }
    }
  }
}
...
var Pi = /* @__PURE__ */ new Map([[`order-none`, `order-0`], [`break-words`, `wrap-break-word`], [`overflow-ellipsis`, `text-ellipsis`]]), Fi = /* @__PURE__ */ new Map([[/^(-)?start-(.*?)$/, `$1inset-s-$2`], [/^(-)?end-(.*?)$/, `$1inset-e-$2`]]);
function* Ii(e3) {
  let t2 = Pi.get(e3);
  t2 && (yield t2);
  for (let [t3, n2] of Fi) {
...
function Li(e3, t2) {
  let n2 = t2.designSystem, r2 = n2.storage[Qr].get(t2.signatureOptions), i2 = Ti(n2, e3);
  for (let t3 of Ii(i2)) {
...
function Ri(e3, t2) {
  let n2 = t2.designSystem, r2 = n2.storage[ia], i2 = n2.storage[oa], a2 = wi(e3);
  for (let [e4] of a2) {
...
function zi(e3, t2) {
  let n2 = t2.designSystem, r2 = n2.storage[Ji].get(t2.signatureOptions);
...
function Bi(e3, t2) {
  ...
  let n2 = t2.designSystem, r2 = n2.storage[Ji].get(t2.signatureOptions), i2 = r2.get(n2.printCandidate(e3));
  if (i2 === null) return e3;
  for (let t3 of Hi(e3)) if (r2.get(n2.printCandidate({ ...e3, value: t3 })) === i2) return e3.value = t3, e3;
  return e3;
}
function Vi(e3) {
  let t2 = wi(e3);
...
function* Hi(e3, t2 = e3.value?.value ?? ``, n2 = /* @__PURE__ */ new Set()) {
  if (n2.has(t2)) return;
  ...
  for (let t3 of i2) yield* Hi(e3, t3, n2);
}
function Ui(e3) {
...
function Gi(e3, t2) {
  let n2 = [e3], r2 = t2.designSystem, i2 = r2.storage[ia], a2 = wi(e3);
  for (let [e4, t3] of a2) if (e4.kind === `compound` && (e4.root === `has` || e4.root === `not` || e4.root === `in`) && e4.modifier !== null && `modifier` in e4.variant && (e4.variant.modifier = e4.modifier, e4.modifier = null), e4.kind === `arbitrary`) {
    ...
    let a3 = null;
    t3 === null && n3.length === 3 && n3[0].kind === `selector` && n3[0].value === `&` && n3[1].kind === `combinator` && n3[1].value === `>` && n3[2].kind === `selector` && (n3[2].value[0] === `:` || Wi(n3[2])) && (n3 = [n3[2]], a3 = r2.parseVariant(`*`)), t3 === null && n3.length === 3 && n3[0].kind === `selector` && n3[0].value === `&` && n3[1].kind === `combinator` && n3[1].value === ` ` && n3[2].kind === `selector` && (n3[2].value[0] === `:` || Wi(n3[2])) && (n3 = [n3[2]], a3 = r2.parseVariant(`**`));
    let o2 = n3;
    if (I(o2, { enter(e5) {
      if (e5.kind === `selector` && e5.value === `&`) return F.Replace([]);
      if (e5.kind === `function`) return F.Skip;
    }, exit(e5) {
      if (e5.kind === `compound` && e5.nodes.length === 1) return F.ReplaceSkip(e5.nodes);
    } }), o2.length !== 1) continue;
    let s2 = o2[0];
    if (s2.kind === `function` && s2.value === `:is`) {
      if (!Ui(s2.nodes) || s2.nodes.length !== 1 || s2.nodes[0].kind === `selector` && !Wi(s2.nodes[0])) continue;
      s2 = s2.nodes[0];
    }
    if (s2.kind === `function` && s2.value[0] === `:` || s2.kind === `selector` && s2.value[0] === `:`) {
      ...
      let o3 = ((a4) => {
        ...
        for (let [e5, n5] of [[`:nth-child`, `nth`], [`:nth-last-child`, `nth-last`], [`:nth-of-type`, `nth-of-type`], [`:nth-last-of-type`, `nth-of-last-type`]]) if (a4 === e5 && t4.kind === `function` && t4.nodes.length === 1) return t4.nodes.length === 1 && t4.nodes[0].kind === `value` && E(t4.nodes[0].value) ? `${n5}-${t4.nodes[0].value}` : `${n5}-[${Y(t4.nodes, true)}]`;
      ...
      if (c2 === null) continue;
      X(e4, c2);
    } else if (s2.kind === `selector` && Wi(s2)) {
      let t4 = Qn(s2.value);
      if (t4 === null) continue;
...
function Ki(e3, t2) {
  if (e3.kind !== `functional` || e3.value?.kind !== `arbitrary`) return e3;
  let n2 = t2.designSystem.storage[Qr].get(t2.signatureOptions), r2 = P(e3.value.value);
  if (r2.length === 1 && r2[0].kind === `function` && r2[0].value === `calc`) {
    let [t3, i2] = pr(r2, null, false);
    if (t3) {
      let t4 = Gt(e3);
  ...
  if (e3.root[0] === `-`) {
    ...
    let [t3, i2] = pr(P(`calc(${e3.value.value} * -1)`), null, false);
    if (t3) {
      let t4 = Gt(e3);
...
function qi(e3, t2) {
  ...
  let n2 = t2.designSystem, r2 = n2.storage[Ji].get(t2.signatureOptions), i2 = r2.get(n2.printCandidate(e3)), a2 = e3.modifier;
...
function Xi(e3, t2, n2) {
  ...
  return I(t2, { enter(t3, i2) {
    if (t3.kind === `declaration`) {
      if (t3.value === void 0 || t3.property === `--tw-sort` || t3.property.startsWith(`--tw-`) && i2.siblings.some((e4) => e4.kind === `declaration` && t3.value === e4.value && t3.important === e4.important && !e4.property.startsWith(`--tw-`))) return F.Replace([]);
      if (n2.features & 1) {
        let e4 = br(t3, n2.features);
        if (e4) return F.Replace(e4);
      }
      t3.value.includes(`var(`) && (t3.value = Zi(t3.value, e3));
      let [a2, o2] = pr(P(t3.value), r2), [s2, c2] = er(o2);
      (a2 || s2) && (t3.value = N(c2)), t3.value = tn(t3.value);
    } else {
...
function ta(e3) {
  return new j((t2) => new j((n2) => {
    ...
    try {
      I(Xi(e3, e3.compileAstNodes(i2[0]).map((e4) => H(e4.node)), t2), (i3) => {
        i3.kind === `declaration` && (r2.get(i3.property).add(i3.value), e3.storage[Qi].get(t2).get(i3.property).get(i3.value).add(n2));
      });
    } catch {
    }
    return r2;
...
function ra(e3) {
  return new j((t2) => {
    let n2 = e3.storage[Ji].get(t2), r2 = new j(() => []);
    for (let [i2, a2] of e3.getClassList()) {
      ...
      if (typeof o2 == `string`) {
        ...
        r2.get(o2).push(i2), e3.storage[ea].get(t2).get(i2);
        for (let o3 of a2.modifiers) {
          if (D(o3)) continue;
          let a3 = `${i2}/${o3}`, s2 = n2.get(a3);
          typeof s2 == `string` && (r2.get(s2).push(a3), e3.storage[ea].get(t2).get(a3));
        }
      }
    }
    return r2;
...
var oa = /* @__PURE__ */ Symbol();
function sa(e3) {
  let t2 = e3.storage[ia], n2 = new j(() => []);
...
function fa(e3) {
  ...
  for (let n3 of e3.utilities.keys(`functional`)) {
    ...
    for (let e4 of r2) for (let r3 of e4.values) {
      let i2 = r3 !== null && da.test(r3), a2 = r3 === null ? n3 : `${n3}-${r3}`, o2 = t2.get(a2);
  ...
  return n2.sort((e4, t3) => Zn(e4.name, t3.name)), pa(n2);
}
function pa(e3) {
...
function ha(e3, t2) {
  let { astNodes: n2, nodeSorting: r2 } = Ta(Array.from(t2), e3), i2 = new Map(t2.map((e4) => [e4, null])), a2 = 0n;
  for (let e4 of n2) {
...
var ga = /^@?[a-z0-9][a-zA-Z0-9_-]*(?<![_-])$/, _a = class {
  constructor() {
  ...
  fromAst(e3, t2, n2) {
    ...
    I(t2, (e4) => {
      ...
      let r3 = t2.map(H);
      i2 && Sa(r3, n2), xa(r3, e4.nodes), e4.nodes = r3;
    }, { compounds: va(r2) });
  }
  ...
  compoundsWith(e3, t2) {
    let n2 = this.variants.get(e3), r2 = typeof t2 == `string` ? this.variants.get(t2) : t2.kind === `arbitrary` ? { compounds: va([t2.selector]) } : this.variants.get(t2.root);
...
function ya(e3) {
  ...
  function r2(e4, t3) {
    return t3.map((t4) => {
      if (e4 === `@container`) {
        let e5 = P(t4.trim());
        return e5.length >= 1 && e5[0].kind === `function` ? `not ${t4}` : e5.length >= 3 && e5[0].kind === `word` && e5[0].value === `not` && e5[2].kind === `function` ? (e5.splice(0, 2), N(e5)) : e5.length >= 5 && e5[0].kind === `word` && e5[2].kind === `word` && e5[2].value === `not` && e5[4].kind === `function` ? (e5.splice(2, 2), N(e5)) : e5.length >= 3 && e5[0].kind === `word` && e5[0].value !== `not` && e5[2].kind === `function` ? (e5.splice(1, 0, { kind: `separator`, value: ` ` }, { kind: `word`, value: `not` }), N(e5)) : `not ${t4}`;
      } else {
        t4 = t4.trim();
        let e5 = _(t4, ` `);
  ...
  n2(`first`, [`&:first-child`]), n2(`last`, [`&:last-child`]), n2(`only`, [`&:only-child`]), n2(`odd`, [`&:nth-child(odd)`]), n2(`even`, [`&:nth-child(even)`]), n2(`first-of-type`, [`&:first-of-type`]), n2(`last-of-type`, [`&:last-of-type`]), n2(`only-of-type`, [`&:only-of-type`]), n2(`visited`, [`&:visited`]), n2(`target`, [`&:target`]), n2(`open`, [`&:is([open], :popover-open, :open)`]), n2(`default`, [`&:default`]), n2(`checked`, [`&:checked`]), n2(`indeterminate`, [`&:indeterminate`]), n2(`placeholder-shown`, [`&:placeholder-shown`]), n2(`autofill`, [`&:autofill`]), n2(`optional`, [`&:optional`]), n2(`required`, [`&:required`]), n2(`valid`, [`&:valid`]), n2(`invalid`, [`&:invalid`]), n2(`user-valid`, [`&:user-valid`]), n2(`user-invalid`, [`&:user-invalid`]), n2(`in-range`, [`&:in-range`]), n2(`out-of-range`, [`&:out-of-range`]), n2(`read-only`, [`&:read-only`]), n2(`empty`, [`&:empty`]), n2(`focus-within`, [`&:focus-within`]), t2.static(`hover`, (e4) => {
    ...
    t3.value.kind === `arbitrary` ? e4.nodes = [L(`&[aria-${ba(t3.value.value)}]`, e4.nodes)] : e4.nodes = [L(`&[aria-${t3.value.value}="true"]`, e4.nodes)];
  }), t2.suggest(`aria`, () => [`busy`, `checked`, `disabled`, `expanded`, `hidden`, `pressed`, `readonly`, `required`, `selected`]), t2.functional(`data`, (e4, t3) => {
    if (!t3.value || t3.modifier) return null;
    e4.nodes = [L(`&[data-${ba(t3.value.value)}]`, e4.nodes)];
  ...
  }, { compounds: 1 }), n2(`motion-safe`, [`@media (prefers-reduced-motion: no-preference)`]), n2(`motion-reduce`, [`@media (prefers-reduced-motion: reduce)`]), n2(`contrast-more`, [`@media (prefers-contrast: more)`]), n2(`contrast-less`, [`@media (prefers-contrast: less)`]);
  {
    let n3 = function(e4, t3, n4, r3) {
      ...
      let a3 = r3.get(t3);
      return a3 === null ? n4 === `asc` ? 1 : -1 : un(i3, a3, n4);
    };
    {
...
function Sa(e3, t2) {
  ...
  return I(e3, (e4) => {
    ...
    for (let [n3, a2] of i2.entries()) {
      let o2 = L(`&`, n3 === i2.length - 1 ? e4.nodes : e4.nodes.map(H)), s2 = _(a2, `:`);
      for (let e5 = s2.length - 1; e5 >= 0; --e5) {
        ...
        if (Da(o2, r3, t2.variants) === null) throw Error(`Cannot use \`@variant\` with variant: ${n4}`);
      }
      r2.push(o2);
    }
...
function Ca(e3, t2) {
  let n2 = xn(e3), r2 = ya(e3), i2 = new j((e4) => Yt(e4, u2)), a2 = new j((e4) => Array.from(qt(e4, u2))), o2 = new j((e4) => new j((t3) => {
    let n3 = Ea(t3, u2, e4);
    try {
      qn(n3.map(({ node: e5 }) => e5), u2), Sa(n3.map(({ node: e5 }) => e5), u2);
    } catch {
      return [];
    }
    return n3;
  })), s2 = new j((t3) => {
    for (let n3 of wt(t3)) e3.markUsedVariable(n3);
  });
  function c2(e4) {
    let n3 = [];
    for (let r3 of e4) {
      let e5 = true, { astNodes: i3 } = Ta([r3], u2, { onInvalidCandidate() {
        e5 = false;
      } });
      t2 && I(i3, (e6) => (e6.src ?? (e6.src = t2), F.Continue)), i3 = kt(i3, u2, 0), n3.push(e5 ? i3 : []);
    }
    return n3;
  }
  function l2(e4) {
    return c2(e4).map((e5) => e5.length > 0 ? At(e5) : null);
  }
...
function Ta(e3, t2, { onInvalidCandidate: n2, respectImportant: r2 } = {}) {
  ...
  return a2.sort((e4, t3) => {
    ...
    return (n3.properties.order[a3] ?? 1 / 0) - (r3.properties.order[a3] ?? 1 / 0) || r3.properties.count - n3.properties.count || Zn(n3.candidate, r3.candidate);
  }), { astNodes: a2, nodeSorting: i2 };
}
function Ea(e3, t2, n2) {
  let r2 = ka(e3, t2);
  if (r2.length === 0) return [];
  let i2 = t2.important && !!(n2 & 1), a2 = [], o2 = `.${ke(e3.raw)}`;
  for (let n3 of r2) {
    let r3 = ja(n3);
    (e3.important || i2) && Aa(n3);
...
function ka(e3, t2) {
  ...
  let n2 = t2.utilities.get(e3.root) ?? [], r2 = [], i2 = n2.filter((e4) => !Oa(e4));
  for (let t3 of i2) {
...
function Aa(e3) {
  for (let t2 of e3) t2.kind !== `at-root` && (t2.kind === `declaration` ? t2.important = true : (t2.kind === `rule` || t2.kind === `at-rule`) && Aa(t2.nodes));
}
function ja(e3) {
  ...
  for (; r2.length > 0; ) {
    ...
    if (e4.kind === `declaration`) {
      ...
      if (e4.property === `--tw-sort`) {
        let n3 = wa.indexOf(e4.value ?? ``);
        if (n3 !== -1) {
          t2.add(n3), i2 = true;
          continue;
        }
      }
      let r3 = wa.indexOf(e4.property);
      r3 !== -1 && t2.add(r3);
  ...
  I([r2], (e4, r3) => {
    if (e4.kind === `at-rule`) {
      ...
      if (e4.name === `@utility`) {
        ...
        o2.get(n3).add(e4), I(e4.nodes, (n4) => {
          if (!(n4.kind !== `at-rule` || n4.name !== `@apply`)) {
            i2.add(e4);
            for (let r4 of Na(n4, t2)) a2.get(e4).add(r4);
          }
        });
        return;
      }
      if (e4.name === `@apply`) {
        ...
        for (let n3 of Na(e4, t2)) for (let e5 of r3.path()) i2.has(e5) && a2.get(e5).add(n3);
      }
    }
  });
...
${At([r3])}`);
  ...
  for (let e4 of c2) `nodes` in e4 && I(e4.nodes, (e5) => {
    ...
    {
      let n4 = Ta(Object.keys(r3), t2, { respectImportant: false, onInvalidCandidate: (e6) => {
        ...
        if (e6 = H(e6), !i4 || !t3 || a5 === void 0) return I([e6], (e7) => {
          e7.src = i4;
        }), e6;
        let o5 = [i4[0], i4[1], i4[2]];
        return o5[1] += 7 + a5, o5[2] = o5[1] + t3.length, I([e6], (e7) => {
          e7.src = o5;
        }), e6;
      }), o4 = [];
...
async function Pa(e3, t2, n2, r2 = 0, i2 = false) {
  let a2 = 0, o2 = [];
  return I(e3, (e4) => {
    if (e4.kind === `at-rule` && (e4.name === `@import` || e4.name === `@reference`)) {
      let s2 = Fa(P(e4.params));
      if (s2 === null) return;
      ...
      return o2.push((async () => {
        ...
        let a3 = await n2(c2, t2), o3 = nt(a3.content, { from: i2 ? a3.path : void 0 });
        await Pa(o3, a3.base, n2, r2 + 1, i2), f2.nodes = Ia(e4, [Dt({ base: a3.base }, o3)], l2, u2, d2);
      })()), F.ReplaceSkip(f2);
    }
...
function Ra(e3, t2, n2, r2 = []) {
  for (let i2 of t2) if (i2 != null) for (let t3 of Reflect.ownKeys(i2)) {
    ...
    a2 === void 0 ? !La(e3[t3]) || !La(i2[t3]) ? e3[t3] = i2[t3] : e3[t3] = Ra({}, [e3[t3], i2[t3]], n2, r2) : e3[t3] = a2, r2.pop();
  }
  return e3;
}
function za(e3, t2, n2) {
  return function(r2, i2) {
    ...
    let s2 = (() => {
      let i3 = Jr(r2), [a3, o3] = Ba(e3.theme, i3), s3 = n2(Va(t2() ?? {}, i3) ?? null);
      ...
      if (typeof s3 == `object` && s3 && !Array.isArray(s3)) {
        let e4 = Ra({}, [s3], (e5, t3) => t3);
        if (a3 === null && Object.hasOwn(s3, `__CSS_VALUES__`)) {
          let t3 = {};
          for (let n3 in s3.__CSS_VALUES__) t3[n3] = s3[n3], delete e4[n3];
          a3 = t3;
        }
        for (let t3 in a3) t3 !== `__CSS_VALUES__` && (s3?.__CSS_VALUES__?.[t3] & 4 && Va(e4, t3.split(`-`)) !== void 0 || (e4[Ae(t3)] = a3[t3]));
        return e4;
      }
...
function Ba(e3, t2) {
  ...
  let n2 = cr(t2), r2 = /* @__PURE__ */ new Map(), i2 = new j(() => /* @__PURE__ */ new Map()), a2 = e3.namespace(`--${n2}`);
  ...
  let c2 = {}, l2 = {};
  for (let [e4, t3] of r2) Ha(c2, [e4 ?? `DEFAULT`], t3);
  for (let [e4, t3] of o2) Ha(l2, [e4 ?? `DEFAULT`], t3);
...
function Ha(e3, t2, n2) {
  for (let n3 of t2.slice(0, -1)) e3[n3] === void 0 && (e3[n3] = {}), e3 = e3[n3];
  e3[t2[t2.length - 1]] = n2;
}
var Ua = /^[a-z@][a-zA-Z0-9/%._-]*$/;
function Wa({ designSystem: e3, ast: t2, resolvedConfig: n2, featuresRef: r2, referenceMode: i2, src: a2 }) {
  let o2 = { addBase(n3) {
    if (i2) return;
    let o3 = Ga(n3);
    r2.current |= qn(o3, e3), r2.current |= Sa(o3, e3);
    let s2 = R(`@layer`, `base`, o3);
    I([s2], (e4) => {
      e4.src = a2;
    }), t2.push(s2);
  }, addVariant(t3, n3) {
    if (!ga.test(t3)) throw Error(`\`addVariant('${t3}')\` defines an invalid variant name. Variants should only contain alphanumeric, dashes, or underscore characters and start with a lowercase letter or number.`);
    if (typeof n3 == `string`) {
    ...
    typeof n3 == `string` || Array.isArray(n3) ? e3.variants.static(t3, (e4) => {
      e4.nodes = Ka(n3, e4.nodes);
    }, { compounds: va(typeof n3 == `string` ? [n3] : n3) }) : typeof n3 == `object` && e3.variants.fromAst(t3, Ga(n3), e3);
  }, matchVariant(t3, n3, r3) {
    function i3(e4, t4, r4) {
      return Ka(n3(e4, { modifier: t4?.value ?? null }), r4);
    }
    try {
    ...
    for (let [e4, n4] of o3) {
      ...
      let r3 = qr(e4), o4 = false;
      if (I(r3, (e5) => {
        if (e5.kind === `selector` && e5.value[0] === `.` && Ua.test(e5.value.slice(1))) {
          let t3 = e5.value;
          e5.value = `&`;
          let i3 = Y(r3), a3 = t3.slice(1), c2 = i3 === `&` ? Ga(n4) : [z(i3, Ga(n4))];
    ...
    for (let [t3, n4] of s2) e3.theme.prefix && I(n4, (t4) => {
      ...
      let a3 = n4.map(H);
      return qa(a3, t3, i3.raw), r2.current |= Ma(a3, e3), a3;
    });
    ...
    for (let [a3, o3] of Object.entries(t3)) {
      let t4 = function({ negative: t5 }) {
        return (s2) => {
          ...
          let f2 = Ga(o3(l2, { modifier: d2 }));
          return qa(f2, a3, s2.raw), r2.current |= Ma(f2, e3), f2;
        };
      };
      if (!Ua.test(a3)) throw Error(`\`matchUtilities({ '${a3}' : \u2026 })\` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter, eg. \`scrollbar\`.`);
  ...
  }, theme: za(e3, () => n2.theme ?? {}, (e4) => e4), prefix(e4) {
    return e4;
  }, config(e4, t3) {
    let r3 = n2;
    if (!e4) return r3;
...
function Ga(e3) {
  ...
  } else if (Array.isArray(r2)) for (let n3 of r2) typeof n3 == `string` ? t2.push(B(e4, n3)) : t2.push(z(e4, Ga(n3)));
  else t2.push(z(e4, Ga(r2)));
  return t2;
}
function Ka(e3, t2) {
  return (typeof e3 == `string` ? [e3] : e3).flatMap((e4) => {
    if (e4.trim().endsWith(`}`)) {
      let n2 = nt(e4.replace(`}`, `{@slot}}`));
      return xa(n2, t2), n2;
    } else return z(e4, t2);
  });
}
function qa(e3, t2, n2) {
  I(e3, (e4) => {
    if (e4.kind === `rule`) {
      let r2 = qr(e4.selector);
      I(r2, (e5) => {
        e5.kind === `selector` && e5.value === `.${t2}` && (e5.value = `.${ke(n2)}`);
      }), e4.selector = Y(r2);
    }
  });
}
function Ja(e3, t2) {
  for (let n2 of Ya(t2)) e3.theme.addKeyframes(n2);
}
function Ya(e3) {
  let t2 = [];
  if (`keyframes` in e3.theme) for (let [n2, r2] of Object.entries(e3.theme.keyframes)) t2.push(R(`@keyframes`, n2, Ga(r2)));
  return t2;
}
function Xa(e3) {
  return { theme: { ...Oe, colors: ({ theme: e4 }) => e4(`color`, {}), extend: { fontSize: ({ theme: e4 }) => ({ ...e4(`text`, {}) }), boxShadow: ({ theme: e4 }) => ({ ...e4(`shadow`, {}) }), animation: ({ theme: e4 }) => ({ ...e4(`animate`, {}) }), aspectRatio: ({ theme: e4 }) => ({ ...e4(`aspect`, {}) }), borderRadius: ({ theme: e4 }) => ({ ...e4(`radius`, {}) }), screens: ({ theme: e4 }) => ({ ...e4(`breakpoint`, {}) }), letterSpacing: ({ theme: e4 }) => ({ ...e4(`tracking`, {}) }), lineHeight: ({ theme: e4 }) => ({ ...e4(`leading`, {}) }), transitionDuration: { DEFAULT: e3.get([`--default-transition-duration`]) ?? null }, transitionTimingFunction: { DEFAULT: e3.get([`--default-transition-timing-function`]) ?? null }, maxWidth: ({ theme: e4 }) => ({ ...e4(`container`, {}) }) } } };
}
var Za = { blocklist: [], future: {}, experimental: {}, prefix: ``, important: false, darkMode: null, theme: {}, plugins: [], content: { files: [] } };
function Qa(e3, t2) {
  let n2 = { design: e3, configs: [], plugins: [], content: { files: [] }, theme: {}, extend: {}, result: structuredClone(Za) };
  for (let e4 of t2) eo(n2, e4);
...
function $a(e3, t2) {
  if (Array.isArray(e3) && La(e3[0])) return e3.concat(t2);
  if (Array.isArray(t2) && La(t2[0]) && La(e3)) return [e3, ...t2];
  if (Array.isArray(t2)) return t2;
}
function eo(e3, { config: t2, base: n2, path: r2, reference: i2, src: a2 }) {
  let o2 = [];
  ...
  for (let o3 of t2.presets ?? []) eo(e3, { path: r2, base: n2, config: o3, reference: i2, src: a2 });
  for (let t3 of o2) e3.plugins.push(t3), t3.config && eo(e3, { path: r2, base: n2, config: t3.config, reference: !!t3.reference, src: t3.src ?? a2 });
...
function to(e3) {
  var _a3;
  let t2 = /* @__PURE__ */ new Set(), r2 = za(e3.design, () => e3.theme, a2), i2 = Object.assign(r2, { theme: r2, colors: n });
  function a2(e4) {
...
function ro({ center: e3, padding: t2, screens: n2 }, r2) {
  let i2 = [], a2 = null;
  if (e3 && i2.push(B(`margin-inline`, `auto`)), (typeof t2 == `string` || typeof t2 == `object` && t2 && `DEFAULT` in t2) && i2.push(B(`padding-inline`, typeof t2 == `string` ? t2 : t2.DEFAULT)), typeof n2 == `object` && n2) {
    ...
    if (e4.sort((e5, t3) => un(e5[1], t3[1], `asc`)), e4.length > 0) {
      let [t3] = e4[0];
  ...
  if (typeof t2 == `object` && t2) {
    ...
    e4.sort((e5, t3) => un(e5[1], t3[1], `asc`));
...
function io({ addVariant: e3, config: t2 }) {
...
var lo = /^[a-z]+$/;
async function uo({ designSystem: e3, base: t2, ast: n2, loadModule: r2, sources: i2 }) {
  let a2 = 0, o2 = [], s2 = [];
  I(n2, (e4, t3) => {
...
\`@plugin\` options must be a flat list of declarations.`);
        ...
        let e5 = t5.value, n4 = _(e5, `,`).map((e6) => {
          ...
          if (Number.isNaN(Number(e6))) {
            ...
            if (e6[0] === `{` && e6[e6.length - 1] === `}`) throw Error(`Unexpected \`@plugin\` option: Value of declaration \`${At([t5]).trim()}\` is not supported.
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`);
  ...
  if (e3.resolveThemeValue = function(r3, o3) {
    return r3.startsWith(`--`) ? c2(r3, o3) : (a2 |= fo({ designSystem: e3, base: t2, ast: n2, sources: i2, configs: [], pluginDetails: [] }), e3.resolveThemeValue(r3, o3));
  ...
  return a2 |= fo({ designSystem: e3, base: t2, ast: n2, sources: i2, configs: l2, pluginDetails: u2 }), a2;
}
function fo({ designSystem: e3, base: t2, ast: n2, sources: r2, configs: i2, pluginDetails: a2 }) {
  ...
  }), ...i2], { resolvedConfig: c2 } = Qa(e3, [{ config: Xa(e3.theme), base: t2, reference: true, src: void 0 }, ...s2, { config: { plugins: [io] }, base: t2, reference: true, src: void 0 }]), { resolvedConfig: l2, replacedThemeKeys: u2 } = Qa(e3, s2), d2 = { designSystem: e3, ast: n2, resolvedConfig: c2, featuresRef: { set current(e4) {
    o2 |= e4;
  } } }, f2 = Wa({ ...d2, referenceMode: false, src: void 0 }), p2 = e3.resolveThemeValue;
  ...
  for (let { handler: e4, reference: t3, src: n3 } of c2.plugins) e4(Wa({ ...d2, referenceMode: t3 ?? false, src: n3 }));
  if (rr(e3, l2, u2), Ja(e3, l2), co(l2, e3), oo(l2, e3), no(l2, e3), !e3.theme.prefix && c2.prefix) {
    if (c2.prefix.endsWith(`-`) && (c2.prefix = c2.prefix.slice(0, -1), console.warn(`The prefix "${c2.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only and is written as a variant before all utilities. We have fixed up the prefix for you. Remove the trailing \`-\` to silence this warning.`)), !lo.test(c2.prefix)) throw Error(`The prefix "${c2.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
...
function po({ ast: e3 }) {
  let t2 = new j((e4) => Fe(e4.code)), n2 = new j((e4) => ({ url: e4.file, content: e4.code, ignore: false })), r2 = { file: null, sources: [], mappings: [] };
  I(e3, (e4) => {
...
function ho(e3) {
  ...
  l2 = go(s2) ? _o(s2) : _(s2, `,`), l2 = l2.flatMap((e4) => ho(e4));
  let u2 = ho(c2);
...
var yo = /^[a-z]+$/, bo = ((e3) => (e3[e3.None = 0] = `None`, e3[e3.AtProperty = 1] = `AtProperty`, e3[e3.ColorMix = 2] = `ColorMix`, e3[e3.All = 3] = `All`, e3))(bo || {});
function xo() {
...
var wo = ((e3) => (e3[e3.None = 0] = `None`, e3[e3.AtApply = 1] = `AtApply`, e3[e3.AtImport = 2] = `AtImport`, e3[e3.JsPluginCompat = 4] = `JsPluginCompat`, e3[e3.ThemeFunction = 8] = `ThemeFunction`, e3[e3.Utilities = 16] = `Utilities`, e3[e3.Variants = 32] = `Variants`, e3[e3.AtTheme = 64] = `AtTheme`, e3))(wo || {});
async function To(e3, { base: t2 = ``, from: n2, loadModule: r2 = xo, loadStylesheet: i2 = So } = {}) {
  let a2 = 0;
  e3 = [Dt({ base: t2 }, e3)], a2 |= await Pa(e3, t2, i2, 0, n2 !== void 0);
  let o2 = null, s2 = new Ne(), c2 = /* @__PURE__ */ new Map(), l2 = /* @__PURE__ */ new Map(), u2 = [], d2 = null, f2 = null, p2 = [], m2 = [], h2 = [], g2 = [], v2 = null;
  I(e3, (e4, t3) => {
    if (e4.kind !== `at-rule`) return;
    let n3 = Ot(t3);
    ...
    if (e4.name === `@source`) {
      ...
      if (r3) {
        ...
        for (let t5 of n4) for (let n5 of ho(t5)) e5.push(n5);
    ...
    if (e4.name === `@variant` && (n3.parent === null ? e4.nodes.length === 0 ? e4.name = `@custom-variant` : (I(e4.nodes, (t4) => {
      ...
      if (!ga.test(t4)) throw Error(`\`@custom-variant ${t4}\` defines an invalid variant name. Variants should only contain alphanumeric, dashes, or underscore characters and start with a lowercase letter or number.`);
    ...
    if (e4.name === `@media`) {
      ...
      for (let i3 of t4) if (i3.startsWith(`source(`)) {
        let t5 = i3.slice(7, -1);
        I(e4.nodes, (e5) => {
          if (e5.kind === `at-rule` && e5.name === `@tailwind` && e5.params === `utilities`) return e5.params += ` source(${t5})`, F.ReplaceStop([Dt({ sourceBase: n3.context.base }, [e5])]);
        });
      ...
      } else i3 === `important` ? o2 = true : i3 === `reference` ? e4.nodes = [Dt({ reference: true }, e4.nodes)] : r3.push(i3);
      if (r3.length > 0) e4.params = r3.join(` `);
      else if (t4.length > 0) return F.Replace(e4.nodes);
      return F.Continue;
    }
    if (e4.name === `@theme`) {
      let [t4, r3] = Co(e4.params);
      if (a2 |= 64, n3.context.reference && (t4 |= 2), r3) {
        if (!yo.test(r3)) throw Error(`The prefix "${r3}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
        s2.prefix = r3;
      }
      return I(e4.nodes, (n4) => {
        ...
        if (n4.kind === `declaration` && n4.property.startsWith(`--`)) {
          s2.add(Ae(n4.property), n4.value ?? ``, t4, n4.src);
          return;
        }
        let r4 = At([R(e4.name, e4.params, [n4])]).split(`
...
${r4}`);
  ...
  a2 |= await uo({ designSystem: y2, base: t2, ast: e3, loadModule: r2, sources: m2 });
  for (let e4 of c2.keys()) y2.variants.static(e4, () => {
  });
  for (let e4 of vo(l2, { onCircularDependency(e5, t3) {
    let n3 = At(e5.map((n4, r3) => R(`@custom-variant`, n4, [R(`@variant`, e5[r3 + 1] ?? t3, [])]))).replaceAll(`;`, ` { \u2026 }`).replace(`@custom-variant ${t3} {`, `@custom-variant ${t3} { /* \u2190 */`);
...
${n3}`);
  ...
  if (d2) {
    ...
    for (let [e4, n4] of y2.theme.entries()) {
      ...
      let r3 = B(ke(e4), n4.value);
      r3.src = n4.src, t3.push(r3);
    }
    let n3 = y2.theme.getKeyframes();
    for (let t4 of n3) e3.push(Dt({ theme: true }, [V([t4])]));
    d2.nodes = [Dt({ theme: true }, t3)];
  }
  if (a2 |= Sa(e3, y2), a2 |= qn(e3, y2), a2 |= Ma(e3, y2), f2) {
    let e4 = f2;
...
async function Eo(e3, t2 = {}) {
  let { designSystem: n2, ast: r2, sources: i2, root: a2, utilitiesNode: o2, features: s2, inlineCandidates: c2 } = await To(e3, t2);
  r2.unshift(Et(`! tailwindcss v${Pe} | MIT License | https://tailwindcss.com `));
  function l2(e4) {
  ...
  return { sources: i2, root: a2, features: s2, build(i3) {
    if (s2 === 0) return e3;
    if (!o2) return d2 ?? (d2 = kt(r2, n2, t2.polyfills)), d2;
    let a3 = p2, c3 = false;
    p2 = false;
    let m2 = u2.size;
    ...
    if (!a3) return d2 ?? (d2 = kt(r2, n2, t2.polyfills)), d2;
    let h2 = Ta(u2, n2, { onInvalidCandidate: l2 }).astNodes;
    return t2.from && I(h2, (e4) => {
      e4.src ?? (e4.src = o2.src);
    }), !c3 && f2 === h2.length ? (d2 ?? (d2 = kt(r2, n2, t2.polyfills)), d2) : (f2 = h2.length, o2.nodes = h2, d2 = kt(r2, n2, t2.polyfills), d2);
  } };
}
async function Do(e3, t2 = {}) {
  let n2 = nt(e3, { from: t2.from }), r2 = await Eo(n2, t2), i2 = n2, a2 = e3;
  return { ...r2, build(e4) {
    let n3 = r2.build(e4);
    return n3 === i2 || (a2 = At(n3, !!t2.from), i2 = n3), a2;
  }, buildSourceMap() {
    return po({ ast: i2 });
  } };
}
async function Oo(e3, t2 = {}) {
  return (await To(nt(e3, { from: t2.from }), t2)).designSystem;
}
var Q = e(i(), 1), ko = { "/tailwindcss": `@import './tailwindcss/index.css';`, "/tailwindcss/index.css": `@layer theme, base, components, utilities;
...
async function jo(e3, t2 = `/`, n2 = {}) {
  t2 || (t2 = `/`);
  let r2 = e3;
  if (e3.startsWith(`fetch:`) && c(e3.substring(6))) return { base: Q.default.dirname(e3), content: await Ao(new URL(e3.substring(6)).toString()), path: e3 };
  {
    for (let [e4, t3] of Object.entries(ko)) Object.keys(n2).includes(e4) || (n2[e4] = t3);
    !e3.startsWith(`/`) && (Object.keys(ko).includes(Q.default.resolve(e3)) || Object.keys(ko).includes(Q.default.resolve(e3).concat(`.css`))) && (t2 = `/`, e3 = Q.default.resolve(e3)), e3.startsWith(`.`) && (e3 = Q.default.resolve(t2, e3)), e3.startsWith(`/`) && (e3.endsWith(`.css`) || (Object.keys(n2).some((t3) => t3.includes(e3.concat(`.css`))) ? e3 = e3.concat(`.css`) : Object.keys(n2).some((t3) => t3.includes(e3.concat(`/index.css`))) && (e3 = e3.concat(`/index.css`))));
...
var Mo = t(((e3) => {
  ...
  var t2 = Lo(), n2 = function(e4, r2, i2) {
  ...
  Object.defineProperty(e3, "__esModule", { value: true });
  var r2 = n2(Ro()), i2 = $(), a2 = (function(e4) {
    t2(n3, e4);
    function n3(t3) {
      var n4 = e4.call(this, t3) || this;
  ...
  var a2 = n2(s()), o2 = n2(Mo()), c2 = n2(Go()), l2 = $(), u2 = r(), d2 = /^('|")([^]*)\1$/, f2 = u2(function() {
...
`), g2 = _2.length - 1, g2 > 0 ? (y2 = a3 + g2, b2 = v2 - _2[g2].length) : (y2 = a3, b2 = i3), x2 = o2.comment, a3 = y2, p3 = y2, d3 = v2 - b2) : l3 === o2.slash ? (v2 = s3, x2 = l3, p3 = a3, d3 = s3 - i3, c3 = v2 + 1) : (v2 = f2(n3, s3), x2 = o2.word, p3 = a3, d3 = v2 - i3), c3 = v2 + 1;
  ...
  Object.defineProperty(e3, "__esModule", { value: true });
  var u2 = s2(Bo()), d2 = s2(Vo()), f2 = s2(Ho()), p2 = s2(Uo()), m2 = s2(Wo()), h2 = s2(Ko()), g2 = s2(qo()), _2 = s2(Jo()), v2 = i2(Yo()), y2 = s2(Xo()), b2 = s2(Zo()), ee2 = s2(Qo()), x2 = s2($o()), S2 = i2(ts()), C2 = i2(es()), te2 = i2($()), w2 = Lo(), ne2 = (c2 = {}, c2[C2.space] = true, c2[C2.cr] = true, c2[C2.feed] = true, c2[C2.newline] = true, c2[C2.tab] = true, c2), re2 = t2(t2({}, ne2), (l2 = {}, l2[C2.comment] = true, l2));
  function ie2(e4) {
  ...
  e3.default = (function() {
    ...
    return e4.prototype._shouldUpdateSelector = function(e5, t3) {
      return t3 === void 0 && (t3 = {}), Object.assign({}, this.options, t3).updateSelector === false ? false : typeof e5 != `string`;
  ...
  var n2 = t2(Yo()), r2 = t2(Ho()), i2 = t2(Zo()), a2 = t2(Uo()), o2 = t2(Wo()), s2 = t2(Qo()), c2 = t2(Jo()), l2 = t2(Bo()), u2 = t2(Vo()), d2 = t2(qo()), f2 = t2(Ko()), p2 = t2(Xo());
  ...
  Object.defineProperty(e3, "__esModule", { value: true }), n2($(), e3), n2(is(), e3), n2(as(), e3);
})), ss = t(((e3, t2) => {
  var n2 = e3 && e3.__createBinding || (Object.create ? (function(e4, t3, n3, r3) {
    ...
    return e4 && e4.__esModule ? e4 : { default: e4 };
  })(rs()), o2 = i2(os()), s2 = function(e4) {
    return new a2.default(e4);
  };
  Object.assign(s2, o2), delete s2.__esModule, t2.exports = s2;
})), cs = e(t(((e3, t2) => {
  var { AtRule: n2, Rule: r2 } = o(), i2 = ss();
  function a2(e4, t3) {
    let n3;
    try {
      i2((e5) => {
...
async function ls({ entrypoint: e3 = `/main.css`, volume: t2 = {}, ...n2 } = {}) {
  return n2 = { entrypoint: e3, volume: t2, ...n2 }, { css: (await a().use((0, cs.default)()).process(n2.volume[n2.entrypoint], { from: n2.entrypoint, parser: n2.parser || null })).css };
}

...
import { t } from "./source-map-generator-DnTvOCwo.js";
...
function g(e3, t2, n2) {
  return e3 === 45 ? u(t2) || t2 === 45 || h(t2, n2) : u(e3) ? true : e3 === 92 && h(e3, t2);
}
function _(e3, t2, n2) {
...
var xe = class {
  ...
  lookupValue(e3, t2) {
    return e3 += this.tokenIndex, e3 < this.tokenCount && ne(this.source, this.offsetAndType[e3 - 1] & C, this.offsetAndType[e3] & C, t2);
  }
  getTokenStart(e3) {
...
function Be(e3) {
  ...
  return Object.assign(function(e4, l2) {
    ...
    Object.assign(s2, d2 ? Ie : Fe), Array.isArray(p2) ? s2.forEachToken((e5, t3, n3) => {
      ...
      if (e5 === 25) {
        let e6 = s2.getLocation(n3, r3), i3 = ne(t2, r3 - 2, r3, `*/`) ? t2.slice(n3 + 2, r3 - 2) : t2.slice(n3 + 2, r3);
        f2(i3, e6);
      }
    });
...
function dt(e3) {
  ...
  let o2 = ut(n2), s2 = ut(r2), c2 = function(e4, c3) {
    function l2(e5, t3, n3) {
      ...
      return r3 === i2 || r3 !== a2 && !!(f2.hasOwnProperty(e5.type) && f2[e5.type](e5, m2, l2, p2) || d2.call(m2, e5, t3, n3) === i2);
    }
...
function un(e3, t2) {
  return t2 === e3.length - 2 && F(e3, t2) === 92 && i(F(e3, t2 + 1));
}
...
function ii(e3) {
  return e3.type === 9 && e3.value !== `?`;
}
function ai(e3) {
  return e3 === null || e3.type === 18 || e3.type === 2 || e3.type === 21 || e3.type === 19 || e3.type === 23 || ii(e3);
}
function oi(e3) {
  return e3 === null || e3.type === 22 || e3.type === 20 || e3.type === 24 || e3.type === 9 && e3.value === `/`;
}
function si(e3, t2, n2) {
  ...
  switch (ti += h2, g2) {
    case null:
      console.warn(`[csstree-match] BREAK after 15000 iterations`), g2 = $r, b2 = null;
      break;
    case Zr:
      for (; d2 !== null; ) u2();
      break;

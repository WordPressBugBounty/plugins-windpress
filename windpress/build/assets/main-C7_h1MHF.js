...
import { n as c, t as l } from "./tippy.esm-C6S0S-or.js";
import { n as u, t as d } from "./dist-CPjYssU5.js";
import { n as f, t as p } from "./highlight-in-textarea-DSKu_7Fz.js";
import { t as m } from "./tribute.min-BObELRP9.js";
...
`).querySelector(`#windpressbreakdance-plc-class-sort`);
  ...
  async function j() {
    var _a, _b, _c, _d, _e;
    x.value = ((_e = (_d = (_c = (_b = (_a = h.$store.getters[`ui/activeElement`].data) == null ? void 0 : _a.properties) == null ? void 0 : _b.settings) == null ? void 0 : _c.advanced) == null ? void 0 : _d.classes) == null ? void 0 : _e.join(` `)) || ``;
  }
  async function M() {
    var _a, _b, _c, _d;
    if ((_d = (_c = (_b = (_a = h.$store.getters[`ui/activeElement`].data) == null ? void 0 : _a.properties) == null ? void 0 : _b.settings) == null ? void 0 : _c.advanced) == null ? void 0 : _d.classes) return true;

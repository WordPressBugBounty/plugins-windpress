import { a as e, c as t, f as n, h as r, o as i, p as a } from "./toggleHighContrast-CKTWexjN.js";
import { t as o } from "./monaco.contribution-ZvOQcqJJ.js";
import { t as s } from "./workers-C9WvSAft.js";
var c = class {
  constructor(e4, t2) {
...
` + c2 : ``) }] };
  ...
  async provideDocumentSymbols(e4, t2) {
    ...
    let o2 = (t3, n3) => {
      var _a;
      return { name: t3.text, detail: ``, kind: w[t3.kind] || r.SymbolKind.Variable, range: this._textSpanToRange(e4, t3.spans[0]), selectionRange: this._textSpanToRange(e4, t3.spans[0]), tags: [], children: (_a = t3.childItems) == null ? void 0 : _a.map((e5) => o2(e5, t3.text)), containerName: n3 };
    };

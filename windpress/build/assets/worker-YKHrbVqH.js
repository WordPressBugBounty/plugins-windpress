import { t as e } from "./log-P-z-QaYz.js";
import { t } from "./api-nCMUpdHx.js";
import { n } from "./index.browser-Dk_QLjUQ.js";
import { t as r } from "./get-EDJoEFUP.js";
import { t as i } from "./preload-helper-DYZqtPCf.js";
import { n as a } from "./base64-DuuBzeXX.js";
import { t as o } from "./dist-r8HZe431.js";
let hn;
let __tla = (async () => {
  var s = [
    [
  ...
  async function pn(s2 = {}) {
    ...
    if (u2.tailwindcss_version === 4) {
      let { compile: e2, getCandidates: t2, optimize: n2, loadSource: r2 } = await i(async () => {
        let { compile: e3, getCandidates: t3, optimize: n3, loadSource: r3 } = await import("./tailwindcss-C364ThPL.js").then(async (m3) => {
          await m3.__tla;
          return m3;
        });
        return {
      ...
      let { build: e2, optimize: t2 } = await i(async () => {
        let { build: e3, optimize: t3 } = await import("./tailwindcss-v3-Bs6gD6LR.js").then(async (m3) => {
          await m3.__tla;
          return m3;
        });
        return {

...
import { t as n } from "./package-DyXNJo-C.js";
import { n as r, t as i } from "./lib-BfAoLx_4.js";
import { n as a, t as o } from "./dist-u5p_KAIj.js";
import { t as s } from "./path-browserify-BXFVjck0.js";
import { c, n as l, r as u, s as d, t as f } from "./cssesc-BusMg9uA.js";
import { t as p } from "./dlv.umd-BDMHJZds.js";
var m = t(((e2) => {
...
o();
var b = a === void 0 ? { NODE_ENV: `production`, DEBUG: false } : { NODE_ENV: `production`, DEBUG: ee({}.DEBUG) }, x = /* @__PURE__ */ new Map(), S = new String(`*`), C = /* @__PURE__ */ Symbol(`__NONE__`);
function ee(e2) {
  ...
  return !t2.includes(`-tailwindcss`) && !!t2.includes(`tailwindcss`);
}
var te = t(((e2, t2) => {
  ...
  e2.__esModule = true, e2.MAX_NESTING_DEPTH = void 0, e2.default = n2;
  var t2 = e2.MAX_NESTING_DEPTH = 256;
  function n2(e3) {
    return Number.isSafeInteger(e3) && e3 >= 0 ? e3 : t2;
  }
})), oe = t(((e2) => {
  e2.__esModule = true, e2.unesc = e2.stripComments = e2.resolveMaxNestingDepth = e2.getProp = e2.ensureObject = e2.MAX_NESTING_DEPTH = void 0, e2.unesc = r2(te()).default, e2.getProp = r2(ne()).default, e2.ensureObject = r2(re()).default, e2.stripComments = r2(ie()).default;
  var t2 = n2(ae());
  e2.resolveMaxNestingDepth = t2.default, e2.MAX_NESTING_DEPTH = t2.MAX_NESTING_DEPTH;
  function n2(e3, t3) {
    if (typeof WeakMap == `function`) var r3 = /* @__PURE__ */ new WeakMap(), i2 = /* @__PURE__ */ new WeakMap();
    return (n2 = function(e4, t4) {
      if (!t4 && e4 && e4.__esModule) return e4;
      var n3, a2, o2 = { __proto__: null, default: e4 };
      if (e4 === null || typeof e4 != `object` && typeof e4 != `function`) return o2;
      if (n3 = t4 ? i2 : r3) {
        if (n3.has(e4)) return n3.get(e4);
        n3.set(e4, o2);
      }
      for (var s2 in e4) s2 !== "default" && {}.hasOwnProperty.call(e4, s2) && ((a2 = (n3 = Object.defineProperty) && Object.getOwnPropertyDescriptor(e4, s2)) && (a2.get || a2.set) ? n3(o2, s2, a2) : o2[s2] = e4[s2]);
      return o2;
    })(e3, t3);
  }
  function r2(e3) {
  ...
  function r2(e3, t3) {
    for (var n3 = 0; n3 < t3.length; n3++) {
      var r3 = t3[n3];
      r3.enumerable = r3.enumerable || false, r3.configurable = true, `value` in r3 && (r3.writable = true), Object.defineProperty(e3, a2(r3.key), r3);
    }
  }
  ...
  var s2 = function e3(t3, r3, i3) {
    if (i3 === void 0 && (i3 = 0), i3 > n2.MAX_NESTING_DEPTH) throw Error(`Cannot clone selector: nesting depth exceeds the maximum of ` + n2.MAX_NESTING_DEPTH + `.`);
    if (typeof t3 != `object` || !t3) return t3;
    var a3 = new t3.constructor();
    for (var o3 in t3) if (t3.hasOwnProperty(o3)) {
      var s3 = t3[o3];
      o3 === `parent` && typeof s3 == `object` ? r3 && (a3[o3] = r3) : s3 instanceof Array ? a3[o3] = s3.map(function(t4) {
        return e3(t4, a3, i3 + 1);
      }) : a3[o3] = e3(s3, a3, i3 + 1);
    }
    return a3;
  };
  ...
  e2.__esModule = true, e2.default = void 0;
  var n2 = oe(), r2 = o2(w()), i2 = a2(T());
  function a2(e3, t3) {
    if (typeof WeakMap == `function`) var n3 = /* @__PURE__ */ new WeakMap(), r3 = /* @__PURE__ */ new WeakMap();
    return (a2 = function(e4, t4) {
      if (!t4 && e4 && e4.__esModule) return e4;
      var i3, a3, o3 = { __proto__: null, default: e4 };
      if (e4 === null || typeof e4 != `object` && typeof e4 != `function`) return o3;
      if (i3 = t4 ? r3 : n3) {
        if (i3.has(e4)) return i3.get(e4);
        i3.set(e4, o3);
      }
      for (var s3 in e4) s3 !== "default" && {}.hasOwnProperty.call(e4, s3) && ((a3 = (i3 = Object.defineProperty) && Object.getOwnPropertyDescriptor(e4, s3)) && (a3.get || a3.set) ? i3(o3, s3, a3) : o3[s3] = e4[s3]);
      return o3;
    })(e3, t3);
  }
  function o2(e3) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  function c2(e3, t3) {
    if (e3) {
      ...
      return n3 === `Object` && e3.constructor && (n3 = e3.constructor.name), n3 === `Map` || n3 === `Set` ? Array.from(e3) : n3 === `Arguments` || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3) ? l2(e3, t3) : void 0;
    }
  }
  function l2(e3, t3) {
  ...
  function u2(e3, t3) {
    for (var n3 = 0; n3 < t3.length; n3++) {
      var r3 = t3[n3];
      r3.enumerable = r3.enumerable || false, r3.configurable = true, `value` in r3 && (r3.writable = true), Object.defineProperty(e3, f2(r3.key), r3);
    }
  }
  ...
  function m2(e3, t3) {
    e3.prototype = Object.create(t3.prototype), e3.prototype.constructor = e3, h2(e3, t3);
  }
  function h2(e3, t3) {
    return h2 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e4, t4) {
  ...
  e2.default = (function(e3) {
    ...
    }, r3.insertAfter = function(e4, t4) {
      t4.parent = this;
      var n3 = this.index(e4);
      this.nodes.splice(n3 + 1, 0, t4), t4.parent = this;
      var r4;
      for (var i3 in this.indexes) r4 = this.indexes[i3], n3 <= r4 && (this.indexes[i3] = r4 + 1);
      return this;
    }, r3.insertBefore = function(e4, t4) {
      t4.parent = this;
      var n3 = this.index(e4);
      this.nodes.splice(n3, 0, t4), t4.parent = this;
      var r4;
      for (var i3 in this.indexes) r4 = this.indexes[i3], r4 <= n3 && (this.indexes[i3] = r4 + 1);
      return this;
    }, r3._findChildAtPosition = function(e4, t4) {
      var n3 = void 0;
      return this.each(function(r4) {
        if (r4.atPosition) {
          var i3 = r4.atPosition(e4, t4);
          if (i3) return n3 = i3, false;
        } else if (r4.isAtPosition(e4, t4)) return n3 = r4, false;
      }), n3;
    }, r3.atPosition = function(e4, t4) {
      if (this.isAtPosition(e4, t4)) return this._findChildAtPosition(e4, t4) || this;
    }, r3._inferEndPosition = function() {
      this.last && this.last.source && this.last.source.end && (this.source = this.source || {}, this.source.end = this.source.end || {}, Object.assign(this.source.end, this.last.source.end));
    }, r3.each = function(e4) {
      this.lastEach || (this.lastEach = 0), this.indexes || (this.indexes = {}), this.lastEach++;
      var t4 = this.lastEach;
      if (this.indexes[t4] = 0, this.length) {
        for (var n3, r4; this.indexes[t4] < this.length && (n3 = this.indexes[t4], r4 = e4(this.at(n3), n3), r4 !== false); ) this.indexes[t4] += 1;
        if (delete this.indexes[t4], r4 === false) return false;
      }
    }, r3.walk = function(e4, t4) {
      if (t4 === void 0 && (t4 = 0), t4 > n2.MAX_NESTING_DEPTH) throw Error(`Cannot walk selector: nesting depth exceeds the maximum of ` + n2.MAX_NESTING_DEPTH + `.`);
      return this.each(function(n3, r4) {
        var i3 = e4(n3, r4);
        if (i3 !== false && n3.length && (i3 = n3.walk(e4, t4 + 1)), i3 === false) return false;
      });
    }, r3.walkAttributes = function(e4) {
      var t4 = this;
      return this.walk(function(n3) {
        if (n3.type === i2.ATTRIBUTE) return e4.call(t4, n3);
      });
    }, r3.walkClasses = function(e4) {
      var t4 = this;
      return this.walk(function(n3) {
        if (n3.type === i2.CLASS) return e4.call(t4, n3);
      });
    }, r3.walkCombinators = function(e4) {
      var t4 = this;
      return this.walk(function(n3) {
        if (n3.type === i2.COMBINATOR) return e4.call(t4, n3);
      });
    }, r3.walkComments = function(e4) {
      var t4 = this;
      return this.walk(function(n3) {
        if (n3.type === i2.COMMENT) return e4.call(t4, n3);
      });
    }, r3.walkIds = function(e4) {
      var t4 = this;
      return this.walk(function(n3) {
        if (n3.type === i2.ID) return e4.call(t4, n3);
      });
    }, r3.walkNesting = function(e4) {
      var t4 = this;
      return this.walk(function(n3) {
        if (n3.type === i2.NESTING) return e4.call(t4, n3);
      });
    }, r3.walkPseudos = function(e4) {
      var t4 = this;
      return this.walk(function(n3) {
        if (n3.type === i2.PSEUDO) return e4.call(t4, n3);
      });
    }, r3.walkTags = function(e4) {
      var t4 = this;
      return this.walk(function(n3) {
        if (n3.type === i2.TAG) return e4.call(t4, n3);
      });
    }, r3.walkUniversals = function(e4) {
      var t4 = this;
      return this.walk(function(n3) {
        if (n3.type === i2.UNIVERSAL) return e4.call(t4, n3);
      });
    }, r3.split = function(e4) {
      var t4 = this, n3 = [];
      return this.reduce(function(r4, i3, a3) {
        var o3 = e4.call(t4, i3);
        return n3.push(i3), o3 ? (r4.push(n3), n3 = []) : a3 === t4.length - 1 && r4.push(n3), r4;
      }, []);
    }, r3.map = function(e4) {
      return this.nodes.map(e4);
    }, r3.reduce = function(e4, t4) {
      return this.nodes.reduce(e4, t4);
    }, r3.every = function(e4) {
    ...
    }, r3.toString = function(e4) {
      return e4 === void 0 && (e4 = {}), this._stringify(e4, 0, (0, n2.resolveMaxNestingDepth)(e4.maxNestingDepth));
    }, r3._stringify = function(e4, t4, n3) {
      var r4 = this;
      return this.map(function(i3) {
        return r4._stringifyChild(i3, e4, t4, n3);
      }).join(``);
    }, r3._stringifyChild = function(e4, t4, n3, r4) {
      return typeof e4._stringify == `function` ? e4._stringify(t4, n3, r4) : String(e4);
  ...
  })(r2.default), t2.exports = e2.default;
})), se = t(((e2, t2) => {
  e2.__esModule = true, e2.default = void 0;
  var n2 = i2(E()), r2 = T();
  function i2(e3) {
  ...
  e2.default = (function(e3) {
    ...
    var n3 = t3.prototype;
    return n3._stringify = function(e4, t4, n4) {
      var r3 = this, i3 = this.reduce(function(i4, a3) {
        return i4.push(r3._stringifyChild(a3, e4, t4, n4)), i4;
      }, []).join(`,`);
  ...
  e2.__esModule = true, e2.default = void 0;
  var n2 = o2(f()), r2 = oe(), i2 = o2(w()), a2 = T();
  function o2(e3) {
    return e3 && e3.__esModule ? e3 : { default: e3 };
  }
  function s2(e3, t3) {
  ...
  e2.default = (function(e3) {
    ...
    return n3._stringify = function(e4, t4, n4) {
      var r3 = this;
      if (t4 >= n4) throw Error(`Cannot serialize selector: nesting depth exceeds the maximum of ` + n4 + `.`);
      var i3 = this.length ? `(` + this.map(function(i4) {
        return r3._stringifyChild(i4, e4, t4 + 1, n4);
      }).join(`,`) + `)` : ``;
      return [this.rawSpaceBefore, this.stringifyProperty(`value`), i3, this.rawSpaceAfter].join(``);
    }, t3;
  })(n2.default), t2.exports = e2.default;
})), he = t(((e2) => {
  e2.__esModule = true, e2.default = void 0, e2.unescapeValue = b2;
  var t2 = s2(f()), n2 = s2(te()), i2 = s2(D()), a2 = T(), o2;
  function s2(e3) {
    return e3 && e3.__esModule ? e3 : { default: e3 };
  }
  function c2(e3, t3) {
    for (var n3 = 0; n3 < t3.length; n3++) {
      var r2 = t3[n3];
      r2.enumerable = r2.enumerable || false, r2.configurable = true, `value` in r2 && (r2.writable = true), Object.defineProperty(e3, u2(r2.key), r2);
    }
  }
  ...
  function p2(e3, t3) {
    e3.prototype = Object.create(t3.prototype), e3.prototype.constructor = e3, m2(e3, t3);
  }
  function m2(e3, t3) {
  ...
  var h2 = r(), g2 = /^('|")([^]*)\1$/, _2 = h2(function() {
  }, `Assigning an attribute a value containing characters that might need to be escaped is deprecated. Call attribute.setValue() instead.`), v2 = h2(function() {
  }, `Assigning attr.quoted is deprecated and has no effect. Assign to attr.quoteMark instead.`), y2 = h2(function() {
  }, `Constructing an Attribute selector with a value without specifying quoteMark is deprecated. Note: The value should be unescaped now.`);
  function b2(e3) {
    var t3 = false, r2 = null, i3 = e3, a3 = i3.match(g2);
  ...
  function x2(e3) {
    ...
    y2();
    var t3 = b2(e3.value), n3 = t3.quoteMark, r2 = t3.unescaped;
    return e3.raws || (e3.raws = {}), e3.raws.value === void 0 && (e3.raws.value = e3.value), e3.value = r2, e3.quoteMark = n3, e3;
  }
  var S2 = e2.default = (function(e3) {
    p2(n3, e3);
    function n3(t3) {
      var n4;
      return t3 === void 0 && (t3 = {}), n4 = e3.call(this, x2(t3)) || this, n4.type = a2.ATTRIBUTE, n4.raws = n4.raws || {}, Object.defineProperty(n4.raws, "unquoted", { get: h2(function() {
        return n4.value;
      }, `attr.raws.unquoted is deprecated. Call attr.value instead.`), set: h2(function() {
        return n4.value;
    ...
    return r2.getQuotedValue = function(e4) {
      e4 === void 0 && (e4 = {});
      var n4 = C2[this._determineQuoteMark(e4)];
      ...
      if (i3 + a3 === 0) {
        ...
        if (s3 === n3.NO_QUOTE) {
          var c3 = this.quoteMark || e4.quoteMark || n3.DOUBLE_QUOTE, l3 = C2[c3];
      ...
      var e4 = (0, t2.default)(this._value, C2[this.quoteMark]);
      ...
      t3 === void 0 && (t3 = e4), n4 === void 0 && (n4 = ee2);
      ...
      return t3.push(this._stringFor(`qualifiedAttribute`, `attribute`)), this.operator && (this.value || this.value === ``) && (t3.push(this._stringFor(`operator`)), t3.push(this._stringFor(`value`)), t3.push(this._stringFor(`insensitiveFlag`, `insensitive`, function(t4, n4) {
        return t4.length > 0 && !e4.quoted && n4.before.length === 0 && !(e4.spaces.value && e4.spaces.value.after) && (n4.before = ` `), ee2(t4, n4);
      ...
      if (this._constructed) {
        var t3 = b2(e4), n4 = t3.deprecatedUsage, r3 = t3.unescaped, i3 = t3.quoteMark;
        if (n4 && _2(), r3 === this._value && i3 === this._quoteMark) return;
  ...
  S2.NO_QUOTE = null, S2.SINGLE_QUOTE = `'`, S2.DOUBLE_QUOTE = `"`;
  var C2 = (o2 = { "'": { quotes: `single`, wrap: true }, '"': { quotes: `double`, wrap: true } }, o2[null] = { isIdentifier: true }, o2);
  function ee2(e3, t3) {
  ...
  var t2 = e2.singleQuote = 39;
  e2.doubleQuote = 34, e2.slash = 47, e2.bang = 33, e2.backslash = 92, e2.cr = 13, e2.feed = 12, e2.newline = 10, e2.tab = 9, e2.str = t2, e2.comment = -1, e2.word = -2, e2.combinator = -3;
})), xe = t(((e2) => {
  e2.__esModule = true, e2.FIELDS = void 0, e2.default = f2;
  var t2 = i2(be()), n2, r2;
  function i2(e3, t3) {
    if (typeof WeakMap == `function`) var n3 = /* @__PURE__ */ new WeakMap(), r3 = /* @__PURE__ */ new WeakMap();
...
`), g2 = _2.length - 1, g2 > 0 ? (y2 = o3 + g2, b2 = v2 - _2[g2].length) : (y2 = o3, b2 = a3), S2 = t2.comment, o3 = y2, p2 = y2, f3 = v2 - b2) : l3 === t2.slash ? (v2 = s3, S2 = l3, p2 = o3, f3 = s3 - a3, c3 = v2 + 1) : (v2 = u2(r3, s3), S2 = t2.word, p2 = o3, f3 = v2 - a3), c3 = v2 + 1;
      ...
      n3.push([S2, o3, s3 - a3, p2, f3, s3, c3]), b2 && (b2 = (a3 = b2, null)), s3 = c3;
    }
    return n3;
  }
})), Se = t(((e2, t2) => {
  e2.__esModule = true, e2.default = void 0;
  var n2 = S2(se()), r2 = S2(ce()), i2 = S2(le()), a2 = S2(ue()), o2 = S2(de()), s2 = S2(fe()), c2 = S2(pe()), l2 = S2(me()), u2 = x2(he()), d2 = S2(ge()), f2 = S2(_e()), p2 = S2(ve()), m2 = S2(ye()), h2 = x2(xe()), g2 = x2(be()), _2 = x2(T()), v2 = oe(), y2, b2;
  function x2(e3, t3) {
    if (typeof WeakMap == `function`) var n3 = /* @__PURE__ */ new WeakMap(), r3 = /* @__PURE__ */ new WeakMap();
    return (x2 = function(e4, t4) {
      if (!t4 && e4 && e4.__esModule) return e4;
      var i3, a3, o3 = { __proto__: null, default: e4 };
      if (e4 === null || typeof e4 != `object` && typeof e4 != `function`) return o3;
      if (i3 = t4 ? r3 : n3) {
  ...
  function C2(e3, t3) {
    for (var n3 = 0; n3 < t3.length; n3++) {
      var r3 = t3[n3];
      r3.enumerable = r3.enumerable || false, r3.configurable = true, `value` in r3 && (r3.writable = true), Object.defineProperty(e3, te2(r3.key), r3);
    }
  }
  ...
  var re2 = (y2 = {}, y2[g2.space] = true, y2[g2.cr] = true, y2[g2.feed] = true, y2[g2.newline] = true, y2[g2.tab] = true, y2), ie2 = Object.assign({}, re2, (b2 = {}, b2[g2.comment] = true, b2));
  function ae2(e3) {
  ...
  function D2(e3) {
    return E2(e3[h2.FIELDS.START_LINE], e3[h2.FIELDS.START_COL], e3[h2.FIELDS.END_LINE], e3[h2.FIELDS.END_COL]);
  }
  function Se2(e3, t3) {
    if (e3) return E2(e3[h2.FIELDS.START_LINE], e3[h2.FIELDS.START_COL], t3[h2.FIELDS.END_LINE], t3[h2.FIELDS.END_COL]);
  }
  function O2(e3, t3) {
    var n3 = e3[t3];
  ...
  e2.default = (function() {
    function e3(e4, t4) {
      t4 === void 0 && (t4 = {}), this.rule = e4, this.options = Object.assign({ lossy: false, safe: false }, t4), this.position = 0, this.nestingDepth = 0, this.maxNestingDepth = (0, v2.resolveMaxNestingDepth)(this.options.maxNestingDepth), this.css = typeof this.rule == `string` ? this.rule : this.rule.selector, this.tokens = (0, h2.default)({ css: this.css, error: this._errorGenerator(), safe: this.options.safe });
      var i3 = Se2(this.tokens[0], this.tokens[this.tokens.length - 1]);
    ...
    return t3._errorGenerator = function() {
      ...
      var n3 = e4.length, r3 = { source: E2(t4[1], t4[2], this.currToken[3], this.currToken[4]), sourceIndex: t4[h2.FIELDS.START_POS] };
      ...
      for (var i3 = 0, a3 = ``, o3 = ``, s3 = null, c3 = false; i3 < n3; ) {
        ...
        switch (l3[h2.FIELDS.TYPE]) {
          ...
          case g2.str:
            ...
            var C3 = (0, u2.unescapeValue)(d3), ee3 = C3.unescaped, te3 = C3.quoteMark;
            r3.value = ee3, r3.quoteMark = te3, s3 = `value`, (0, v2.ensureObject)(r3, `raws`), r3.raws.value = d3, c3 = false;
            break;
          case g2.equals:
          ...
          case g2.comment:
            if (s3) if (c3 || f3 && f3[h2.FIELDS.TYPE] === g2.space || s3 === `insensitive`) {
              var ne3 = (0, v2.getProp)(r3, `spaces`, s3, `after`) || ``, re3 = (0, v2.getProp)(r3, `raws`, `spaces`, s3, `after`) || ne3;
              (0, v2.ensureObject)(r3, `raws`, `spaces`, s3), r3.raws.spaces[s3].after = re3 + d3;
            } else {
              var ie3 = r3[s3] || ``, ae3 = (0, v2.getProp)(r3, `raws`, s3) || ie3;
              (0, v2.ensureObject)(r3, `raws`), r3.raws[s3] = ae3 + d3;
            }
            else o3 += d3;
            break;
          default:
      ...
      O2(r3, `attribute`), O2(r3, `namespace`), this.newNode(new u2.default(r3)), this.position++;
    }, t3.parseWhitespaceEquivalentTokens = function(e4) {
      e4 < 0 && (e4 = this.tokens.length);
      var t4 = this.position, n3 = [], r3 = ``, i3 = void 0;
      do
        if (re2[this.currToken[h2.FIELDS.TYPE]]) this.options.lossy || (r3 += this.content());
        else if (this.currToken[h2.FIELDS.TYPE] === g2.comment) {
          var o3 = {};
          r3 && (r3 = (o3.before = r3, ``)), i3 = new a2.default({ value: this.content(), source: D2(this.currToken), sourceIndex: this.currToken[h2.FIELDS.START_POS], spaces: o3 }), n3.push(i3);
        }
      ...
      if (r3) {
        if (i3) i3.spaces.after = r3;
          ...
          n3.push(new c2.default({ value: ``, source: E2(s3[h2.FIELDS.START_LINE], s3[h2.FIELDS.START_COL], l3[h2.FIELDS.END_LINE], l3[h2.FIELDS.END_COL]), sourceIndex: s3[h2.FIELDS.START_POS], spaces: { before: r3, after: `` } }));
        }
      }
      return n3;
      ...
      if (this.isNamedCombinator()) {
        ...
        t4 !== e4 && (n3.value = `/` + e4 + `/`);
        var r3 = new f2.default({ value: `/` + t4 + `/`, source: E2(this.currToken[h2.FIELDS.START_LINE], this.currToken[h2.FIELDS.START_COL], this.tokens[this.position + 2][h2.FIELDS.END_LINE], this.tokens[this.position + 2][h2.FIELDS.END_COL]), sourceIndex: this.currToken[h2.FIELDS.START_POS], raws: n3 });
      ...
      var l3;
      if (this.isNamedCombinator() ? l3 = this.namedCombinator() : this.currToken[h2.FIELDS.TYPE] === g2.combinator ? (l3 = new f2.default({ value: this.content(), source: D2(this.currToken), sourceIndex: this.currToken[h2.FIELDS.START_POS] }), this.position++) : re2[this.currToken[h2.FIELDS.TYPE]] || c3 || this.unexpected(), l3) {
        if (c3) {
      ...
      var e4 = new r2.default({ source: { start: ae2(this.tokens[this.position + 1]) }, sourceIndex: this.tokens[this.position + 1][h2.FIELDS.START_POS] });
      this.current.parent.append(e4), this.current = e4, this.position++;
    }, t3.comment = function() {
      var e4 = this.currToken;
      this.newNode(new a2.default({ value: this.content(), source: D2(e4), sourceIndex: e4[h2.FIELDS.START_POS] })), this.position++;
      ...
      var e4 = this.currToken;
      this.newNode(new p2.default({ value: this.content(), source: D2(e4), sourceIndex: e4[h2.FIELDS.START_POS] })), this.position++;
    }, t3.parentheses = function() {
      var e4 = this.current.last, t4 = 1;
      if (this.position++, e4 && e4.type === _2.PSEUDO) {
        var n3 = new r2.default({ source: { start: ae2(this.tokens[this.position]) }, sourceIndex: this.tokens[this.position][h2.FIELDS.START_POS] }), i3 = this.current;
        e4.append(n3), this.current = n3, this.nestingDepth++;
        try {
          for (this.nestingDepth > this.maxNestingDepth && this.error(`Cannot parse selector: nesting depth exceeds the maximum of ` + this.maxNestingDepth + `.`, { index: this.currToken[h2.FIELDS.START_POS] }); this.position < this.tokens.length && t4; ) this.currToken[h2.FIELDS.TYPE] === g2.openParenthesis && t4++, this.currToken[h2.FIELDS.TYPE] === g2.closeParenthesis && t4--, t4 ? this.parse() : (this.current.source.end = w2(this.currToken), this.current.parent.source.end = w2(this.currToken), this.position++);
        } finally {
          this.nestingDepth--;
        }
        this.current = i3;
        ...
        e4 ? e4.appendToPropertyAndEscape(`value`, o3, o3) : this.newNode(new c2.default({ value: o3, source: E2(a3[h2.FIELDS.START_LINE], a3[h2.FIELDS.START_COL], s3[h2.FIELDS.END_LINE], s3[h2.FIELDS.END_COL]), sourceIndex: a3[h2.FIELDS.START_POS] }));
      }
      ...
      if (this.currToken[h2.FIELDS.TYPE] === g2.word) this.splitWord(false, function(r3, i3) {
        t4 += r3, e4.newNode(new l2.default({ value: t4, source: Se2(n3, e4.currToken), sourceIndex: n3[h2.FIELDS.START_POS] })), i3 > 1 && e4.nextToken && e4.nextToken[h2.FIELDS.TYPE] === g2.openParenthesis && e4.error(`Misplaced parenthesis.`, { index: e4.nextToken[h2.FIELDS.START_POS] });
      });
      ...
      var e4 = this.currToken;
      this.newNode(new c2.default({ value: this.content(), source: D2(e4), sourceIndex: e4[h2.FIELDS.START_POS] })), this.position++;
      ...
      this.newNode(new d2.default({ value: this.content(), source: D2(n3), sourceIndex: n3[h2.FIELDS.START_POS] }), e4), this.position++;
      ...
      return t4 && (/^ +$/.test(t4) && (this.options.lossy || (this.spaces = (this.spaces || ``) + t4), t4 = true), e4.namespace = t4, O2(e4, `namespace`)), this.spaces && (this.spaces = (e4.spaces.before = this.spaces, ``)), this.current.append(e4);
      ...
      for (var t4 = e4; t4 < this.tokens.length; ) if (ie2[this.tokens[t4][h2.FIELDS.TYPE]]) {
        t4++;
        continue;
      } else return t4;
      return -1;
    }, ee2(e3, [{ key: `currToken`, get: function() {
  ...
  e2.default = (function() {
    ...
    return t3._shouldUpdateSelector = function(e4, t4) {
      ...
      return { lossy: this._isLossy(t4), maxNestingDepth: t4.maxNestingDepth };
    }, t3._stringifyOptions = function(e4) {
      return { maxNestingDepth: Object.assign({}, this.options, e4).maxNestingDepth };
      ...
      return t4 === void 0 && (t4 = {}), new Promise(function(r3, i2) {
        try {
          ...
          Promise.resolve(n3.func(a2)).then(function(r4) {
            var i3 = void 0;
            return n3._shouldUpdateSelector(e4, t4) && (i3 = a2.toString(n3._stringifyOptions(t4)), e4.selector = i3), { transform: r4, root: a2, string: i3 };
          }).then(r3, i2);
        } catch (e5) {
          i2(e5);
          return;
      ...
      var i2 = void 0;
      return t4.updateSelector && typeof e4 != `string` && (i2 = n3.toString(this._stringifyOptions(t4)), e4.selector = i2), { transform: r3, root: n3, string: i2 };
      ...
      var n3 = this;
      return this._run(e4, t4).then(function(e5) {
        return e5.string || e5.root.toString(n3._stringifyOptions(t4));
      });
    }, t3.processSync = function(e4, t4) {
      var n3 = this._runSync(e4, t4);
      return n3.string || n3.root.toString(this._stringifyOptions(t4));
    }, e3;
  })(), t2.exports = e2.default;
})), Ce = t(((e2) => {
  ...
  var t2 = p2(he()), n2 = p2(le()), r2 = p2(_e()), i2 = p2(ue()), a2 = p2(de()), o2 = p2(ve()), s2 = p2(me()), c2 = p2(se()), l2 = p2(ce()), u2 = p2(pe()), d2 = p2(fe()), f2 = p2(ge());
  function p2(e3) {
    return e3 && e3.__esModule ? e3 : { default: e3 };
  }
  ...
  var t2 = T(), n2, r2 = (n2 = {}, n2[t2.ATTRIBUTE] = true, n2[t2.CLASS] = true, n2[t2.COMBINATOR] = true, n2[t2.COMMENT] = true, n2[t2.ID] = true, n2[t2.NESTING] = true, n2[t2.PSEUDO] = true, n2[t2.ROOT] = true, n2[t2.SELECTOR] = true, n2[t2.STRING] = true, n2[t2.TAG] = true, n2[t2.UNIVERSAL] = true, n2);
  function i2(e3) {
  ...
  var o2 = e2.isAttribute = a2.bind(null, t2.ATTRIBUTE);
  e2.isClassName = a2.bind(null, t2.CLASS), e2.isCombinator = a2.bind(null, t2.COMBINATOR), e2.isComment = a2.bind(null, t2.COMMENT), e2.isIdentifier = a2.bind(null, t2.ID), e2.isNesting = a2.bind(null, t2.NESTING);
  var s2 = e2.isPseudo = a2.bind(null, t2.PSEUDO);
  e2.isRoot = a2.bind(null, t2.ROOT), e2.isSelector = a2.bind(null, t2.SELECTOR), e2.isString = a2.bind(null, t2.STRING);
  var c2 = e2.isTag = a2.bind(null, t2.TAG);
  e2.isUniversal = a2.bind(null, t2.UNIVERSAL);
  function l2(e3) {
  ...
  function i2(e3, t3) {
    ...
    return (i2 = function(e4, t4) {
      ...
      for (var s2 in e4) s2 !== "default" && {}.hasOwnProperty.call(e4, s2) && ((a3 = (i3 = Object.defineProperty) && Object.getOwnPropertyDescriptor(e4, s2)) && (a3.get || a3.set) ? i3(o3, s2, a3) : o3[s2] = e4[s2]);
      return o3;
    })(e3, t3);
  }
  function a2(e3) {
  ...
  function p2(e3) {
    ...
    if (n3) {
      ...
      let r3 = (e5) => !!t4[e5];
      return t4.all ? r3 = () => true : e4 && (r3 = (e5) => e5 !== `all` && !t4[e5]), { escapes: r3, type: `withrules` };
    }
    return { type: `unknown` };
  }
  function m2(e3) {
  ...
  var n2 = Me();
  t2.exports = { objectify: Ae(), parse: Oe(), async: n2, sync: Ne() };
})), k = e(Ee()), Fe = e(De()), A = e(Pe(), 1), Ie = A.default;
A.default.objectify, A.default.parse, A.default.async, A.default.sync;
function Le(e2) {
  return Array.isArray(e2) ? e2.flatMap((e3) => l([(0, Fe.default)({ bubble: [`screen`] })]).process(e3, { parser: Ie }).root.nodes) : Le([e2]);
}
function j(e2) {
...
function Re(e2, t2, n2 = false) {
  if (e2 === ``) return t2;
  let r2 = typeof t2 == `string` ? (0, k.default)().astSync(t2) : t2;
...
var Be = { aliceblue: [240, 248, 255], antiquewhite: [250, 235, 215], aqua: [0, 255, 255], aquamarine: [127, 255, 212], azure: [240, 255, 255], beige: [245, 245, 220], bisque: [255, 228, 196], black: [0, 0, 0], blanchedalmond: [255, 235, 205], blue: [0, 0, 255], blueviolet: [138, 43, 226], brown: [165, 42, 42], burlywood: [222, 184, 135], cadetblue: [95, 158, 160], chartreuse: [127, 255, 0], chocolate: [210, 105, 30], coral: [255, 127, 80], cornflowerblue: [100, 149, 237], cornsilk: [255, 248, 220], crimson: [220, 20, 60], cyan: [0, 255, 255], darkblue: [0, 0, 139], darkcyan: [0, 139, 139], darkgoldenrod: [184, 134, 11], darkgray: [169, 169, 169], darkgreen: [0, 100, 0], darkgrey: [169, 169, 169], darkkhaki: [189, 183, 107], darkmagenta: [139, 0, 139], darkolivegreen: [85, 107, 47], darkorange: [255, 140, 0], darkorchid: [153, 50, 204], darkred: [139, 0, 0], darksalmon: [233, 150, 122], darkseagreen: [143, 188, 143], darkslateblue: [72, 61, 139], darkslategray: [47, 79, 79], darkslategrey: [47, 79, 79], darkturquoise: [0, 206, 209], darkviolet: [148, 0, 211], deeppink: [255, 20, 147], deepskyblue: [0, 191, 255], dimgray: [105, 105, 105], dimgrey: [105, 105, 105], dodgerblue: [30, 144, 255], firebrick: [178, 34, 34], floralwhite: [255, 250, 240], forestgreen: [34, 139, 34], fuchsia: [255, 0, 255], gainsboro: [220, 220, 220], ghostwhite: [248, 248, 255], gold: [255, 215, 0], goldenrod: [218, 165, 32], gray: [128, 128, 128], green: [0, 128, 0], greenyellow: [173, 255, 47], grey: [128, 128, 128], honeydew: [240, 255, 240], hotpink: [255, 105, 180], indianred: [205, 92, 92], indigo: [75, 0, 130], ivory: [255, 255, 240], khaki: [240, 230, 140], lavender: [230, 230, 250], lavenderblush: [255, 240, 245], lawngreen: [124, 252, 0], lemonchiffon: [255, 250, 205], lightblue: [173, 216, 230], lightcoral: [240, 128, 128], lightcyan: [224, 255, 255], lightgoldenrodyellow: [250, 250, 210], lightgray: [211, 211, 211], lightgreen: [144, 238, 144], lightgrey: [211, 211, 211], lightpink: [255, 182, 193], lightsalmon: [255, 160, 122], lightseagreen: [32, 178, 170], lightskyblue: [135, 206, 250], lightslategray: [119, 136, 153], lightslategrey: [119, 136, 153], lightsteelblue: [176, 196, 222], lightyellow: [255, 255, 224], lime: [0, 255, 0], limegreen: [50, 205, 50], linen: [250, 240, 230], magenta: [255, 0, 255], maroon: [128, 0, 0], mediumaquamarine: [102, 205, 170], mediumblue: [0, 0, 205], mediumorchid: [186, 85, 211], mediumpurple: [147, 112, 219], mediumseagreen: [60, 179, 113], mediumslateblue: [123, 104, 238], mediumspringgreen: [0, 250, 154], mediumturquoise: [72, 209, 204], mediumvioletred: [199, 21, 133], midnightblue: [25, 25, 112], mintcream: [245, 255, 250], mistyrose: [255, 228, 225], moccasin: [255, 228, 181], navajowhite: [255, 222, 173], navy: [0, 0, 128], oldlace: [253, 245, 230], olive: [128, 128, 0], olivedrab: [107, 142, 35], orange: [255, 165, 0], orangered: [255, 69, 0], orchid: [218, 112, 214], palegoldenrod: [238, 232, 170], palegreen: [152, 251, 152], paleturquoise: [175, 238, 238], palevioletred: [219, 112, 147], papayawhip: [255, 239, 213], peachpuff: [255, 218, 185], peru: [205, 133, 63], pink: [255, 192, 203], plum: [221, 160, 221], powderblue: [176, 224, 230], purple: [128, 0, 128], rebeccapurple: [102, 51, 153], red: [255, 0, 0], rosybrown: [188, 143, 143], royalblue: [65, 105, 225], saddlebrown: [139, 69, 19], salmon: [250, 128, 114], sandybrown: [244, 164, 96], seagreen: [46, 139, 87], seashell: [255, 245, 238], sienna: [160, 82, 45], silver: [192, 192, 192], skyblue: [135, 206, 235], slateblue: [106, 90, 205], slategray: [112, 128, 144], slategrey: [112, 128, 144], snow: [255, 250, 250], springgreen: [0, 255, 127], steelblue: [70, 130, 180], tan: [210, 180, 140], teal: [0, 128, 128], thistle: [216, 191, 216], tomato: [255, 99, 71], turquoise: [64, 224, 208], violet: [238, 130, 238], wheat: [245, 222, 179], white: [255, 255, 255], whitesmoke: [245, 245, 245], yellow: [255, 255, 0], yellowgreen: [154, 205, 50] }, Ve = /^#([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})?$/i, He = /^#([a-f\d])([a-f\d])([a-f\d])([a-f\d])?$/i, M = /(?:\d+|\d*\.\d+)%?/, Ue = /(?:\s*,\s*|\s+)/, We = /\s*[,/]\s*/, N = /var\(--(?:[^ )]*?)(?:,(?:[^ )]*?|var\(--[^ )]*?\)))?\)/, Ge = RegExp(`^(rgba?)\\(\\s*(${M.source}|${N.source})(?:${Ue.source}(${M.source}|${N.source}))?(?:${Ue.source}(${M.source}|${N.source}))?(?:${We.source}(${M.source}|${N.source}))?\\s*\\)$`), Ke = RegExp(`^(hsla?)\\(\\s*((?:${M.source})(?:deg|rad|grad|turn)?|${N.source})(?:${Ue.source}(${M.source}|${N.source}))?(?:${Ue.source}(${M.source}|${N.source}))?(?:${We.source}(${M.source}|${N.source}))?\\s*\\)$`);
function qe(e2, { loose: t2 = false } = {}) {
  if (typeof e2 != `string`) return null;
  if (e2 = e2.trim(), e2 === `transparent`) return { mode: `rgb`, color: [`0`, `0`, `0`], alpha: `0` };
  if (e2 in Be) return { mode: `rgb`, color: Be[e2].map((e3) => e3.toString()) };
  let n2 = e2.replace(He, (e3, t3, n3, r3, i3) => [`#`, t3, t3, n3, n3, r3, r3, i3 ? i3 + i3 : ``].join(``)).match(Ve);
  ...
  let r2 = e2.match(Ge) ?? e2.match(Ke);
...
function Je({ mode: e2, color: t2, alpha: n2 }) {
  let r2 = n2 !== void 0;
  return e2 === `rgba` || e2 === `hsla` ? `${e2}(${t2.join(`, `)}${r2 ? `, ${n2}` : ``})` : `${e2}(${t2.join(` `)}${r2 ? ` / ${n2}` : ``})`;
}
function P(e2, t2, n2) {
  if (typeof e2 == `function`) return e2({ opacityValue: t2 });
  let r2 = qe(e2, { loose: true });
  return r2 === null ? n2 : Je({ ...r2, alpha: t2 });
}
function F({ color: e2, property: t2, variable: n2 }) {
  let r2 = [].concat(t2);
  if (typeof e2 == `function`) return { [n2]: `1`, ...Object.fromEntries(r2.map((t3) => [t3, e2({ opacityVariable: n2, opacityValue: `var(${n2}, 1)` })])) };
  let i2 = qe(e2);
  return i2 === null || i2.alpha !== void 0 ? Object.fromEntries(r2.map((t3) => [t3, e2])) : { [n2]: `1`, ...Object.fromEntries(r2.map((e3) => [e3, Je({ ...i2, alpha: `var(${n2}, 1)` })])) };
}
var Ye = 97, Xe = 122, Ze = 65, Qe = 90, $e = 101, et = 69, tt = 48, nt = 57, rt = 43, it = 45, at = 42, ot = 47, st = 40, ct = 41, lt = 44, ut = 32, dt = 37, ft = [`calc`, `min`, `max`, `clamp`, `mod`, `rem`, `sin`, `cos`, `tan`, `asin`, `acos`, `atan`, `atan2`, `pow`, `sqrt`, `hypot`, `log`, `exp`, `round`];
function pt(e2) {
  if (!ft.some((t3) => e2.includes(t3))) return e2;
  let t2 = ``, n2 = [], r2 = null, i2 = null;
  for (let a2 = 0; a2 < e2.length; a2++) {
    let o2 = e2.charCodeAt(a2);
    if (o2 >= tt && o2 <= nt || r2 !== null && (o2 === dt || o2 >= Ye && o2 <= Xe || o2 >= Ze && o2 <= Qe) ? r2 = a2 : (i2 = r2, r2 = null), o2 === st) {
      t2 += e2[a2];
      let r3 = a2;
      for (let t3 = a2 - 1; t3 >= 0; t3--) {
        let n3 = e2.charCodeAt(t3);
        if (n3 >= tt && n3 <= nt) r3 = t3;
        else if (n3 >= Ye && n3 <= Xe) r3 = t3;
        else break;
      }
      ...
      n2.unshift(false);
      continue;
    } else if (o2 === ct) t2 += e2[a2], n2.shift();
    else if (o2 === lt && n2[0]) {
      t2 += `, `;
      continue;
    } else if (o2 === ut && n2[0] && t2.charCodeAt(t2.length - 1) === ut) continue;
    else if ((o2 === rt || o2 === at || o2 === ot || o2 === it) && n2[0]) {
      let n3 = t2.trimEnd(), r3 = n3.charCodeAt(n3.length - 1), o3 = n3.charCodeAt(n3.length - 2), s2 = e2.charCodeAt(a2 + 1);
      if ((r3 === $e || r3 === et) && o3 >= tt && o3 <= nt) {
        t2 += e2[a2];
        continue;
      } else if (r3 === rt || r3 === at || r3 === ot || r3 === it) {
        t2 += e2[a2];
        continue;
      } else if (r3 === st || r3 === lt) {
        t2 += e2[a2];
        continue;
      } else e2.charCodeAt(a2 - 1) === ut ? t2 += `${e2[a2]} ` : r3 >= tt && r3 <= nt || s2 >= tt && s2 <= nt || r3 === ct || s2 === st || s2 === rt || s2 === at || s2 === ot || s2 === it || i2 !== null && i2 === a2 - 1 ? t2 += ` ${e2[a2]} ` : t2 += e2[a2];
    } else t2 += e2[a2];
  }
  return t2;
}
function I(e2, t2) {
  ...
  for (let o2 = 0; o2 < e2.length; o2++) {
    let s2 = e2[o2];
    n2.length === 0 && s2 === t2[0] && !a2 && (t2.length === 1 || e2.slice(o2, o2 + t2.length) === t2) && (r2.push(e2.slice(i2, o2)), i2 = o2 + t2.length), a2 = !a2 && s2 === `\\`, s2 === `(` || s2 === `[` || s2 === `{` ? n2.push(s2) : (s2 === `)` && n2[n2.length - 1] === `(` || s2 === `]` && n2[n2.length - 1] === `[` || s2 === `}` && n2[n2.length - 1] === `{`) && n2.pop();
  }
  return r2.push(e2.slice(i2)), r2;
}
var mt = /* @__PURE__ */ new Set([`inset`, `inherit`, `initial`, `revert`, `unset`]), ht = /\ +(?![^(]*\))/g, gt = /^-?(\d+|\.\d+)(.*?)$/g;
function _t(e2) {
  return I(e2, `,`).map((e3) => {
    let t2 = e3.trim(), n2 = { raw: t2 }, r2 = t2.split(ht), i2 = /* @__PURE__ */ new Set();
    for (let e4 of r2) gt.lastIndex = 0, !i2.has(`KEYWORD`) && mt.has(e4) ? (n2.keyword = e4, i2.add(`KEYWORD`)) : gt.test(e4) ? i2.has(`X`) ? i2.has(`Y`) ? i2.has(`BLUR`) ? i2.has(`SPREAD`) || (n2.spread = e4, i2.add(`SPREAD`)) : (n2.blur = e4, i2.add(`BLUR`)) : (n2.y = e4, i2.add(`Y`)) : (n2.x = e4, i2.add(`X`)) : n2.color ? (n2.unknown || (n2.unknown = []), n2.unknown.push(e4)) : n2.color = e4;
...
var yt = [`min`, `max`, `clamp`, `calc`];
function bt(e2) {
  return yt.some((t2) => RegExp(`^${t2}\\(.*\\)`).test(e2));
}
var xt = /* @__PURE__ */ new Set([`scroll-timeline-name`, `timeline-scope`, `view-timeline-name`, `font-palette`, `anchor-name`, `anchor-scope`, `position-anchor`, `position-try-options`, `scroll-timeline`, `animation-timeline`, `view-timeline`, `position-try`]);
function L(e2, t2 = null, n2 = true) {
  let r2 = t2 && xt.has(t2.property);
  return e2.startsWith(`--`) && !r2 ? `var(${e2})` : e2.includes(`url(`) ? e2.split(/(url\(.*?\))/g).filter(Boolean).map((e3) => /^url\(.*?\)$/.test(e3) ? e3 : L(e3, t2, false)).join(``) : (e2 = e2.replace(/([^\\])_+/g, (e3, t3) => t3 + ` `.repeat(e3.length - 1)).replace(/^_/g, ` `).replace(/\\_/g, `_`), n2 && (e2 = e2.trim()), e2 = pt(e2), e2);
}
function R(e2) {
...
function Ct(e2) {
  return !isNaN(Number(e2)) || bt(e2);
}
function wt(e2) {
  return e2.endsWith(`%`) && Ct(e2.slice(0, -1)) || bt(e2);
}
var Tt = `(?:${`cm.mm.Q.in.pc.pt.px.em.ex.ch.rem.lh.rlh.vw.vh.vmin.vmax.vb.vi.svw.svh.lvw.lvh.dvw.dvh.cqw.cqh.cqi.cqb.cqmin.cqmax`.split(`.`).join(`|`)})`;
function Et(e2) {
  return e2 === `0` || RegExp(`^[+-]?[0-9]*.?[0-9]+(?:[eE][+-]?[0-9]+)?${Tt}$`).test(e2) || bt(e2);
}
var Dt = /* @__PURE__ */ new Set([`thin`, `medium`, `thick`]);
function Ot(e2) {
  return Dt.has(e2);
}
function kt(e2) {
...
function At(e2) {
  let t2 = 0;
  return I(e2, `_`).every((e3) => (e3 = L(e3), e3.startsWith(`var(`) ? true : qe(e3, { loose: true }) === null ? false : (t2++, true))) ? t2 > 0 : false;
}
function jt(e2) {
  let t2 = 0;
  return I(e2, `,`).every((e3) => (e3 = L(e3), e3.startsWith(`var(`) ? true : St(e3) || Nt(e3) || [`element(`, `image(`, `cross-fade(`, `image-set(`].some((t3) => e3.startsWith(t3)) ? (t2++, true) : false)) ? t2 > 0 : false;
}
var Mt = /* @__PURE__ */ new Set([`conic-gradient`, `linear-gradient`, `radial-gradient`, `repeating-conic-gradient`, `repeating-linear-gradient`, `repeating-radial-gradient`]);
function Nt(e2) {
  e2 = L(e2);
  for (let t2 of Mt) if (e2.startsWith(`${t2}(`)) return true;
  return false;
}
var Pt = /* @__PURE__ */ new Set([`center`, `top`, `right`, `bottom`, `left`]);
function Ft(e2) {
  let t2 = 0;
  return I(e2, `_`).every((e3) => (e3 = L(e3), e3.startsWith(`var(`) ? true : Pt.has(e3) || Et(e3) || wt(e3) ? (t2++, true) : false)) ? t2 > 0 : false;
}
function It(e2) {
  let t2 = 0;
  return I(e2, `,`).every((e3) => (e3 = L(e3), e3.startsWith(`var(`) ? true : e3.includes(` `) && !/(['"])([^"']+)\1/g.test(e3) || /^\d/g.test(e3) ? false : (t2++, true))) ? t2 > 0 : false;
}
var Lt = /* @__PURE__ */ new Set([`serif`, `sans-serif`, `monospace`, `cursive`, `fantasy`, `system-ui`, `ui-serif`, `ui-sans-serif`, `ui-monospace`, `ui-rounded`, `math`, `emoji`, `fangsong`]);
function Rt(e2) {
  return Lt.has(e2);
}
var zt = /* @__PURE__ */ new Set([`xx-small`, `x-small`, `small`, `medium`, `large`, `x-large`, `xx-large`, `xxx-large`]);
function Bt(e2) {
  return zt.has(e2);
}
var Vt = /* @__PURE__ */ new Set([`larger`, `smaller`]);
function Ht(e2) {
  return Vt.has(e2);
}
function Ut(e2) {
...
function Wt(e2) {
  ...
  return I(e2, `,`).every((e3) => {
    let n2 = I(e3, `_`).filter(Boolean);
    return n2.length === 1 && t2.includes(n2[0]) ? true : n2.length !== 1 && n2.length !== 2 ? false : n2.every((e4) => Et(e4) || wt(e4) || e4 === `auto`);
  });
}
var Gt = { optimizeUniversalDefaults: false, generalizedModifiers: true, disableColorOpacityUtilitiesByDefault: false, relativeContentPathsByDefault: false }, Kt = { future: [`hoverOnlyWhenSupported`, `respectDefaultRingColorOpacity`, `disableColorOpacityUtilitiesByDefault`, `relativeContentPathsByDefault`], experimental: [`optimizeUniversalDefaults`, `generalizedModifiers`] };
function z(e2, t2) {
  return Kt.future.includes(t2) ? e2.future === `all` || (e2?.future?.[t2] ?? Gt[t2] ?? false) : Kt.experimental.includes(t2) ? e2.experimental === `all` || (e2?.experimental?.[t2] ?? Gt[t2] ?? false) : false;
}
function qt(e2) {
  return e2.experimental === `all` ? Kt.experimental : Object.keys(e2?.experimental ?? {}).filter((t2) => Kt.experimental.includes(t2) && e2.experimental[t2]);
}
function Jt(e2) {
  if ({}.JEST_WORKER_ID === void 0 && qt(e2).length > 0) {
    let t2 = qt(e2).map((e3) => h.default.yellow(e3)).join(`, `);
...
function Yt(e2, t2) {
  e2.walkClasses((e3) => {
    e3.value = t2(e3.value), e3.raws && e3.raws.value && (e3.raws.value = ze(e3.raws.value));
  });
}
function Xt(e2, t2) {
  if (!B(e2)) return;
  let n2 = e2.slice(1, -1);
  if (t2(n2)) return L(n2);
}
function Zt(e2, t2 = {}, n2) {
  let r2 = t2[e2];
  if (r2 !== void 0) return Ut(r2);
  if (B(e2)) {
    let t3 = Xt(e2, n2);
    return t3 === void 0 ? void 0 : Ut(t3);
  }
}
function Qt(e2, t2 = {}, { validate: n2 = () => true } = {}) {
  let r2 = t2.values?.[e2];
  return r2 === void 0 ? t2.supportsNegativeValues && e2.startsWith(`-`) ? Zt(e2.slice(1), t2.values, n2) : Xt(e2, n2) : r2;
}
function B(e2) {
...
function $t(e2) {
  ...
  return e2[t2 - 1] === `]` || e2[t2 + 1] === `[` || n2 !== -1 && r2 !== -1 && n2 < t2 && t2 < r2 && (t2 = e2.lastIndexOf(`/`, n2)), t2 === -1 || t2 === e2.length - 1 || B(e2) && !e2.includes(`]/[`) ? [e2, void 0] : [e2.slice(0, t2), e2.slice(t2 + 1)];
}
function en(e2) {
...
function tn(e2) {
  return L(e2.slice(1, -1));
}
function nn(e2, t2 = {}, { tailwindConfig: n2 = {} } = {}) {
  if (t2.values?.[e2] !== void 0) return en(t2.values?.[e2]);
  let [r2, i2] = $t(e2);
  if (i2 !== void 0) {
    let e3 = t2.values?.[r2] ?? (B(r2) ? r2.slice(1, -1) : void 0);
    return e3 === void 0 ? void 0 : (e3 = en(e3), B(i2) ? P(e3, tn(i2)) : n2.theme?.opacity?.[i2] === void 0 ? void 0 : P(e3, n2.theme.opacity[i2]));
  }
  return Qt(e2, t2, { validate: At });
}
function rn(e2, t2 = {}) {
  return t2.values?.[e2];
}
...
var an = { any: Qt, color: nn, url: V(St), image: V(jt), length: V(Et), percentage: V(wt), position: V(Ft), lookup: rn, "generic-name": V(Rt), "family-name": V(It), number: V(Ct), "line-width": V(Ot), "absolute-size": V(Bt), "relative-size": V(Ht), shadow: V(kt), size: V(Wt) }, on = Object.keys(an);
function sn(e2, t2) {
...
function cn(e2, t2, n2, r2) {
  if (n2.values && t2 in n2.values) for (let { type: i3 } of e2 ?? []) {
    let e3 = an[i3](t2, n2, { tailwindConfig: r2 });
    if (e3 !== void 0) return [e3, i3, null];
  }
  if (B(t2)) {
    let e3 = t2.slice(1, -1), [r3, i3] = sn(e3, `:`);
    if (!/^[\w-_]+$/g.test(r3)) i3 = e3;
    else if (r3 !== void 0 && !on.includes(r3)) return [];
    if (i3.length > 0 && on.includes(r3)) return [Qt(`[${i3}]`, n2), r3, null];
  }
...
function* ln(e2, t2, n2, r2) {
  let i2 = z(r2, `generalizedModifiers`), [a2, o2] = $t(t2);
  if (i2 && n2.modifiers != null && (n2.modifiers === `any` || typeof n2.modifiers == `object` && (o2 && B(o2) || o2 in n2.modifiers)) || (a2 = t2, o2 = void 0), o2 !== void 0 && a2 === `` && (a2 = `DEFAULT`), o2 !== void 0 && typeof n2.modifiers == `object`) {
    let e3 = n2.modifiers?.[o2] ?? null;
    e3 === null ? B(o2) && (o2 = tn(o2)) : o2 = e3;
  }
  for (let { type: t3 } of e2 ?? []) {
    let e3 = an[t3](a2, n2, { tailwindConfig: r2 });
    e3 !== void 0 && (yield [e3, t3, o2 ?? null]);
  }
}
var un = e(te());
function H(e2) {
  let t2 = k.default.className();
  return t2.value = e2, ze(t2?.raws?.value ?? t2.value);
}
var dn = { "::after": [`terminal`, `jumpable`], "::backdrop": [`terminal`, `jumpable`], "::before": [`terminal`, `jumpable`], "::cue": [`terminal`], "::cue-region": [`terminal`], "::first-letter": [`terminal`, `jumpable`], "::first-line": [`terminal`, `jumpable`], "::grammar-error": [`terminal`], "::marker": [`terminal`, `jumpable`], "::part": [`terminal`, `actionable`], "::placeholder": [`terminal`, `jumpable`], "::selection": [`terminal`, `jumpable`], "::slotted": [`terminal`], "::spelling-error": [`terminal`], "::target-text": [`terminal`], "::file-selector-button": [`terminal`, `actionable`], "::deep": [`actionable`], "::v-deep": [`actionable`], "::ng-deep": [`actionable`], ":after": [`terminal`, `jumpable`], ":before": [`terminal`, `jumpable`], ":first-letter": [`terminal`, `jumpable`], ":first-line": [`terminal`, `jumpable`], ":where": [], ":is": [], ":has": [], __default__: [`terminal`, `actionable`] };
function fn(e2) {
  let [t2] = pn(e2);
...
function pn(e2) {
  let t2 = [], n2 = null;
  for (let r2 of e2.nodes) if (r2.type === `combinator`) t2 = t2.filter(([, e3]) => _n(e3).includes(`jumpable`)), n2 = null;
  else if (r2.type === `pseudo`) {
    hn(r2) ? (n2 = r2, t2.push([e2, r2, null])) : n2 && gn(r2, n2) ? t2.push([e2, r2, n2]) : n2 = null;
...
function mn(e2) {
  return e2.value.startsWith(`::`) || dn[e2.value] !== void 0;
}
function hn(e2) {
  return mn(e2) && _n(e2).includes(`terminal`);
}
function gn(e2, t2) {
  return e2.type !== `pseudo` || mn(e2) ? false : _n(t2).includes(`actionable`);
}
function _n(e2) {
  return dn[e2.value] ?? dn.__default__;
}
var vn = `:merge`;
function yn(e2, { context: t2, candidate: n2 }) {
  let r2 = t2?.tailwindConfig.prefix ?? ``, i2 = e2.map((e3) => {
    let t3 = (0, k.default)().astSync(e3.format);
    return { ...e3, ast: e3.respectPrefix ? Re(r2, t3) : t3 };
  }), a2 = k.default.root({ nodes: [k.default.selector({ nodes: [k.default.className({ value: H(n2) })] })] });
  for (let { ast: e3 } of i2) [a2, e3] = wn(a2, e3), e3.walkNesting((e4) => e4.replaceWith(...a2.nodes[0].nodes)), a2 = e3;
  return a2;
}
function bn(e2) {
  let t2 = [];
...
function Cn(e2, t2, { context: n2, candidate: r2, base: i2 }) {
  let a2 = n2?.tailwindConfig?.separator ?? `:`;
  i2 ?? (i2 = I(r2, a2).pop());
  let o2 = (0, k.default)().astSync(e2);
  if (o2.walkClasses((e3) => {
    e3.raws && e3.value.includes(i2) && (e3.raws.value = H((0, un.default)(e3.raws.value)));
  }), o2.each((e3) => Sn(e3, i2)), o2.length === 0) return null;
  let s2 = Array.isArray(t2) ? yn(t2, { context: n2, candidate: r2 }) : t2;
  if (s2 === null) return o2.toString();
  let c2 = k.default.comment({ value: `/*__simple__*/` }), l2 = k.default.comment({ value: `/*__simple__*/` });
  return o2.walkClasses((e3) => {
    ...
    e3.remove(), r3 = bn(c2);
    let a3 = t3.index(c2);
    t3.nodes.splice(a3, r3.length, ...xn(k.default.selector({ nodes: r3 })).nodes), c2.remove(), l2.remove();
  }), o2.walkPseudos((e3) => {
    e3.value === vn && e3.replaceWith(e3.nodes);
  }), o2.each((e3) => fn(e3)), o2.toString();
}
function wn(e2, t2) {
  let n2 = [];
  return e2.walkPseudos((e3) => {
    e3.value === vn && n2.push({ pseudo: e3, value: e3.nodes[0].toString() });
  }), t2.walkPseudos((e3) => {
    if (e3.value !== vn) return;
    let t3 = e3.nodes[0].toString(), r2 = n2.find((e4) => e4.value === t3);
    if (!r2) return;
    let i2 = [], a2 = e3.next();
    for (; a2 && a2.type !== `combinator`; ) i2.push(a2), a2 = a2.next();
    let o2 = a2;
    r2.pseudo.parent.insertAfter(r2.pseudo, k.default.selector({ nodes: i2.map((e4) => e4.clone()) })), e3.remove(), i2.forEach((e4) => e4.remove()), o2 && o2.type === `combinator` && o2.remove();
  }), [e2, t2];
}
function Tn(e2) {
  return ze(`.${H(e2)}`);
...
function An(e2) {
  return [`fontSize`, `outline`].includes(e2) ? (e3) => (typeof e3 == `function` && (e3 = e3({})), Array.isArray(e3) && (e3 = e3[0]), e3) : e2 === `fontFamily` ? (e3) => {
    ...
    let t2 = Array.isArray(e3) && j(e3[1]) ? e3[0] : e3;
...
var jn = e(s());
function U(e2, t2 = [[e2, [e2]]], { filterDefault: n2 = false, ...r2 } = {}) {
  let i2 = An(e2);
...
var Nn = /* @__PURE__ */ new Set([`normal`, `reverse`, `alternate`, `alternate-reverse`]), Pn = /* @__PURE__ */ new Set([`running`, `paused`]), Fn = /* @__PURE__ */ new Set([`none`, `forwards`, `backwards`, `both`]), In = /* @__PURE__ */ new Set([`infinite`]), Ln = /* @__PURE__ */ new Set([`linear`, `ease`, `ease-in`, `ease-out`, `ease-in-out`, `step-start`, `step-end`]), Rn = [`cubic-bezier`, `steps`], zn = /\,(?![^(]*\))/g, Bn = /\ +(?![^(]*\))/g, Vn = /^(-?[\d.]+m?s)$/, Hn = /^(\d+)$/;
function Un(e2) {
  return e2.split(zn).map((e3) => {
    let t2 = e3.trim(), n2 = { value: t2 }, r2 = t2.split(Bn), i2 = /* @__PURE__ */ new Set();
    for (let e4 of r2) !i2.has(`DIRECTIONS`) && Nn.has(e4) ? (n2.direction = e4, i2.add(`DIRECTIONS`)) : !i2.has(`PLAY_STATES`) && Pn.has(e4) ? (n2.playState = e4, i2.add(`PLAY_STATES`)) : !i2.has(`FILL_MODES`) && Fn.has(e4) ? (n2.fillMode = e4, i2.add(`FILL_MODES`)) : !i2.has(`ITERATION_COUNTS`) && (In.has(e4) || Hn.test(e4)) ? (n2.iterationCount = e4, i2.add(`ITERATION_COUNTS`)) : !i2.has(`TIMING_FUNCTION`) && Ln.has(e4) || !i2.has(`TIMING_FUNCTION`) && Rn.some((t3) => e4.startsWith(`${t3}(`)) ? (n2.timingFunction = e4, i2.add(`TIMING_FUNCTION`)) : !i2.has(`DURATION`) && Vn.test(e4) ? (n2.duration = e4, i2.add(`DURATION`)) : !i2.has(`DELAY`) && Vn.test(e4) ? (n2.delay = e4, i2.add(`DELAY`)) : i2.has(`NAME`) ? (n2.unknown || (n2.unknown = []), n2.unknown.push(e4)) : (n2.name = e4, i2.add(`NAME`));
    return n2;
  });
}
var W = (e2) => Object.assign({}, ...Object.entries(e2 ?? {}).flatMap(([e3, t2]) => typeof t2 == `object` ? Object.entries(W(t2)).map(([t3, n2]) => ({ [e3 + (t3 === `DEFAULT` ? `` : `-${t3}`)]: n2 })) : [{ [`${e3}`]: t2 }]));
function G(e2) {
  return typeof e2 == `function` ? e2({}) : e2;
}
function Wn(e2, t2 = true) {
  return Array.isArray(e2) ? e2.map((e3) => {
    ...
    let [n2, r2] = e3;
    return n2 = n2.toString(), typeof r2 == `string` ? { name: n2, not: false, values: [{ min: r2, max: void 0 }] } : Array.isArray(r2) ? { name: n2, not: false, values: r2.map((e4) => Jn(e4)) } : { name: n2, not: false, values: [Jn(r2)] };
  }) : Wn(Object.entries(e2 ?? {}), false);
}
function Gn(e2) {
...
function Kn(e2, t2, n2) {
  let r2 = qn(t2, e2), i2 = qn(n2, e2), a2 = Gn(r2), o2 = Gn(i2);
...
function Jn({ "min-width": e2, min: t2 = e2, max: n2, raw: r2 } = {}) {
...
var K = { childVariant: ({ addVariant: e2 }) => {
  e2(`*`, `& > *`);
}, pseudoElementVariants: ({ addVariant: e2 }) => {
  e2(`first-letter`, `&::first-letter`), e2(`first-line`, `&::first-line`), e2(`marker`, [({ container: e3 }) => (Yn(e3, [`--tw-text-opacity`]), `& *::marker`), ({ container: e3 }) => (Yn(e3, [`--tw-text-opacity`]), `&::marker`)]), e2(`selection`, [`& *::selection`, `&::selection`]), e2(`file`, `&::file-selector-button`), e2(`placeholder`, `&::placeholder`), e2(`backdrop`, `&::backdrop`), e2(`before`, ({ container: e3 }) => (e3.walkRules((e4) => {
    let t2 = false;
  ...
  let i2 = [[`first`, `&:first-child`], [`last`, `&:last-child`], [`only`, `&:only-child`], [`odd`, `&:nth-child(odd)`], [`even`, `&:nth-child(even)`], `first-of-type`, `last-of-type`, `only-of-type`, [`visited`, ({ container: e3 }) => (Yn(e3, [`--tw-text-opacity`, `--tw-border-opacity`, `--tw-bg-opacity`]), `&:visited`)], `target`, [`open`, `&[open]`], `default`, `checked`, `indeterminate`, `placeholder-shown`, `autofill`, `optional`, `required`, `valid`, `invalid`, `in-range`, `out-of-range`, `read-only`, `empty`, `focus-within`, [`hover`, z(n2(), `hoverOnlyWhenSupported`) ? `@media (hover: hover) and (pointer: fine) { &:hover }` : `&:hover`], `focus`, `focus-visible`, `active`, `enabled`, `disabled`].map((e3) => Array.isArray(e3) ? e3 : [e3, `&:${e3}`]);
  for (let [t3, n3] of i2) e2(t3, (e3) => typeof n3 == `function` ? n3(e3) : n3);
  let a2 = { group: (e3, { modifier: t3 }) => t3 ? [`:merge(${r2(`.group`)}\\/${H(t3)})`, ` &`] : [`:merge(${r2(`.group`)})`, ` &`], peer: (e3, { modifier: t3 }) => t3 ? [`:merge(${r2(`.peer`)}\\/${H(t3)})`, ` ~ &`] : [`:merge(${r2(`.peer`)})`, ` ~ &`] };
  for (let [e3, n3] of Object.entries(a2)) t2(e3, (e4 = ``, t3) => {
    let r3 = L(typeof e4 == `function` ? e4(t3) : e4);
    r3.includes(`&`) || (r3 = `&` + r3);
  ...
  }, { values: Object.fromEntries(i2), [X]: { respectPrefix: false } });
  ...
  let r2 = e2(`screens`) ?? {}, i2 = Object.values(r2).every((e3) => typeof e3 == `string`), a2 = Wn(e2(`screens`)), o2 = /* @__PURE__ */ new Set([]);
  function s2(e3) {
  ...
  let u2 = o2.size <= 1;
  function d2(e3) {
    return Object.fromEntries(a2.filter((e4) => Gn(e4).result).map((t3) => {
  ...
  e2(`has`, (e3) => `&:has(${L(e3)})`, { values: {}, [X]: { respectPrefix: false } }), e2(`group-has`, (e3, { modifier: n2 }) => n2 ? `:merge(${t2(`.group`)}\\/${n2}):has(${L(e3)}) &` : `:merge(${t2(`.group`)}):has(${L(e3)}) &`, { values: {}, [X]: { respectPrefix: false } }), e2(`peer-has`, (e3, { modifier: n2 }) => n2 ? `:merge(${t2(`.peer`)}\\/${n2}):has(${L(e3)}) ~ &` : `:merge(${t2(`.peer`)}):has(${L(e3)}) ~ &`, { values: {}, [X]: { respectPrefix: false } });
}, ariaVariants: ({ matchVariant: e2, theme: t2 }) => {
  e2(`aria`, (e3) => `&[aria-${R(L(e3))}]`, { values: t2(`aria`) ?? {} }), e2(`group-aria`, (e3, { modifier: t3 }) => t3 ? `:merge(.group\\/${t3})[aria-${R(L(e3))}] &` : `:merge(.group)[aria-${R(L(e3))}] &`, { values: t2(`aria`) ?? {} }), e2(`peer-aria`, (e3, { modifier: t3 }) => t3 ? `:merge(.peer\\/${t3})[aria-${R(L(e3))}] ~ &` : `:merge(.peer)[aria-${R(L(e3))}] ~ &`, { values: t2(`aria`) ?? {} });
}, dataVariants: ({ matchVariant: e2, theme: t2 }) => {
  e2(`data`, (e3) => `&[data-${R(L(e3))}]`, { values: t2(`data`) ?? {} }), e2(`group-data`, (e3, { modifier: t3 }) => t3 ? `:merge(.group\\/${t3})[data-${R(L(e3))}] &` : `:merge(.group)[data-${R(L(e3))}] &`, { values: t2(`data`) ?? {} }), e2(`peer-data`, (e3, { modifier: t3 }) => t3 ? `:merge(.peer\\/${t3})[data-${R(L(e3))}] ~ &` : `:merge(.peer)[data-${R(L(e3))}] ~ &`, { values: t2(`data`) ?? {} });
...
} }, q = [`translate(var(--tw-translate-x), var(--tw-translate-y))`, `rotate(var(--tw-rotate))`, `skewX(var(--tw-skew-x))`, `skewY(var(--tw-skew-y))`, `scaleX(var(--tw-scale-x))`, `scaleY(var(--tw-scale-y))`].join(` `), J = [`var(--tw-blur)`, `var(--tw-brightness)`, `var(--tw-contrast)`, `var(--tw-grayscale)`, `var(--tw-hue-rotate)`, `var(--tw-invert)`, `var(--tw-saturate)`, `var(--tw-sepia)`, `var(--tw-drop-shadow)`].join(` `), Y = [`var(--tw-backdrop-blur)`, `var(--tw-backdrop-brightness)`, `var(--tw-backdrop-contrast)`, `var(--tw-backdrop-grayscale)`, `var(--tw-backdrop-hue-rotate)`, `var(--tw-backdrop-invert)`, `var(--tw-backdrop-opacity)`, `var(--tw-backdrop-saturate)`, `var(--tw-backdrop-sepia)`].join(` `), Xn = { preflight: ({ addBase: e2 }) => {
  let t2 = (0, On.createFsFromVolume)(window.windpress.__MEMFS_VOLUME__ || new On.Volume()), r2 = l.parse(t2.readFileSync(jn.join(`/`, `./css/preflight.css`), `utf8`));
  e2([l.comment({ text: `! tailwindcss v${n} | MIT License | https://tailwindcss.com` }), ...r2.nodes]);
}, container: /* @__PURE__ */ (() => {
  function e2(e3 = []) {
  ...
  return function({ addComponents: n2, theme: r2 }) {
    let i2 = Wn(r2(`container.screens`, r2(`screens`))), a2 = e2(i2), o2 = t2(a2, i2, r2(`container.padding`)), s2 = (e3) => {
...
}, inset: U(`inset`, [[`inset`, [`inset`]], [[`inset-x`, [`left`, `right`]], [`inset-y`, [`top`, `bottom`]]], [[`start`, [`inset-inline-start`]], [`end`, [`inset-inline-end`]], [`top`, [`top`]], [`right`, [`right`]], [`bottom`, [`bottom`]], [`left`, [`left`]]]], { supportsNegativeValues: true }), isolation: ({ addUtilities: e2 }) => {
  e2({ ".isolate": { isolation: `isolate` }, ".isolation-auto": { isolation: `auto` } });
}, zIndex: U(`zIndex`, [[`z`, [`zIndex`]]], { supportsNegativeValues: true }), order: U(`order`, void 0, { supportsNegativeValues: true }), gridColumn: U(`gridColumn`, [[`col`, [`gridColumn`]]]), gridColumnStart: U(`gridColumnStart`, [[`col-start`, [`gridColumnStart`]]], { supportsNegativeValues: true }), gridColumnEnd: U(`gridColumnEnd`, [[`col-end`, [`gridColumnEnd`]]], { supportsNegativeValues: true }), gridRow: U(`gridRow`, [[`row`, [`gridRow`]]]), gridRowStart: U(`gridRowStart`, [[`row-start`, [`gridRowStart`]]], { supportsNegativeValues: true }), gridRowEnd: U(`gridRowEnd`, [[`row-end`, [`gridRowEnd`]]], { supportsNegativeValues: true }), float: ({ addUtilities: e2 }) => {
...
}, margin: U(`margin`, [[`m`, [`margin`]], [[`mx`, [`margin-left`, `margin-right`]], [`my`, [`margin-top`, `margin-bottom`]]], [[`ms`, [`margin-inline-start`]], [`me`, [`margin-inline-end`]], [`mt`, [`margin-top`]], [`mr`, [`margin-right`]], [`mb`, [`margin-bottom`]], [`ml`, [`margin-left`]]]], { supportsNegativeValues: true }), boxSizing: ({ addUtilities: e2 }) => {
...
}, transformOrigin: U(`transformOrigin`, [[`origin`, [`transformOrigin`]]]), translate: U(`translate`, [[[`translate-x`, [[`@defaults transform`, {}], `--tw-translate-x`, [`transform`, q]]], [`translate-y`, [[`@defaults transform`, {}], `--tw-translate-y`, [`transform`, q]]]]], { supportsNegativeValues: true }), rotate: U(`rotate`, [[`rotate`, [[`@defaults transform`, {}], `--tw-rotate`, [`transform`, q]]]], { supportsNegativeValues: true }), skew: U(`skew`, [[[`skew-x`, [[`@defaults transform`, {}], `--tw-skew-x`, [`transform`, q]]], [`skew-y`, [[`@defaults transform`, {}], `--tw-skew-y`, [`transform`, q]]]]], { supportsNegativeValues: true }), scale: U(`scale`, [[`scale`, [[`@defaults transform`, {}], `--tw-scale-x`, `--tw-scale-y`, [`transform`, q]]], [[`scale-x`, [[`@defaults transform`, {}], `--tw-scale-x`, [`transform`, q]]], [`scale-y`, [[`@defaults transform`, {}], `--tw-scale-y`, [`transform`, q]]]]], { supportsNegativeValues: true }), transform: ({ addDefaults: e2, addUtilities: t2 }) => {
  e2(`transform`, { "--tw-translate-x": `0`, "--tw-translate-y": `0`, "--tw-rotate": `0`, "--tw-skew-x": `0`, "--tw-skew-y": `0`, "--tw-scale-x": `1`, "--tw-scale-y": `1` }), t2({ ".transform": { "@defaults transform": {}, transform: q }, ".transform-cpu": { transform: q }, ".transform-gpu": { transform: q.replace(`translate(var(--tw-translate-x), var(--tw-translate-y))`, `translate3d(var(--tw-translate-x), var(--tw-translate-y), 0)`) }, ".transform-none": { transform: `none` } });
}, animation: ({ matchUtilities: e2, theme: t2, config: n2 }) => {
  let r2 = (e3) => H(n2(`prefix`) + e3), i2 = Object.fromEntries(Object.entries(t2(`keyframes`) ?? {}).map(([e3, t3]) => [e3, { [`@keyframes ${r2(e3)}`]: t3 }]));
  e2({ animate: (e3) => {
    let t3 = Un(e3);
    return [...t3.flatMap((e4) => i2[e4.name]), { animation: t3.map(({ name: e4, value: t4 }) => e4 === void 0 || i2[e4] === void 0 ? t4 : t4.replace(e4, r2(e4))).join(`, `) }];
  } }, { values: t2(`animation`) });
}, cursor: U(`cursor`), touchAction: ({ addDefaults: e2, addUtilities: t2 }) => {
...
}, scrollMargin: U(`scrollMargin`, [[`scroll-m`, [`scroll-margin`]], [[`scroll-mx`, [`scroll-margin-left`, `scroll-margin-right`]], [`scroll-my`, [`scroll-margin-top`, `scroll-margin-bottom`]]], [[`scroll-ms`, [`scroll-margin-inline-start`]], [`scroll-me`, [`scroll-margin-inline-end`]], [`scroll-mt`, [`scroll-margin-top`]], [`scroll-mr`, [`scroll-margin-right`]], [`scroll-mb`, [`scroll-margin-bottom`]], [`scroll-ml`, [`scroll-margin-left`]]]], { supportsNegativeValues: true }), scrollPadding: U(`scrollPadding`, [[`scroll-p`, [`scroll-padding`]], [[`scroll-px`, [`scroll-padding-left`, `scroll-padding-right`]], [`scroll-py`, [`scroll-padding-top`, `scroll-padding-bottom`]]], [[`scroll-ps`, [`scroll-padding-inline-start`]], [`scroll-pe`, [`scroll-padding-inline-end`]], [`scroll-pt`, [`scroll-padding-top`]], [`scroll-pr`, [`scroll-padding-right`]], [`scroll-pb`, [`scroll-padding-bottom`]], [`scroll-pl`, [`scroll-padding-left`]]]]), listStylePosition: ({ addUtilities: e2 }) => {
  e2({ ".list-inside": { "list-style-position": `inside` }, ".list-outside": { "list-style-position": `outside` } });
}, listStyleType: U(`listStyleType`, [[`list`, [`listStyleType`]]]), listStyleImage: U(`listStyleImage`, [[`list-image`, [`listStyleImage`]]]), appearance: ({ addUtilities: e2 }) => {
  e2({ ".appearance-none": { appearance: `none` }, ".appearance-auto": { appearance: `auto` } });
}, columns: U(`columns`, [[`columns`, [`columns`]]]), breakBefore: ({ addUtilities: e2 }) => {
...
}, gridAutoColumns: U(`gridAutoColumns`, [[`auto-cols`, [`gridAutoColumns`]]]), gridAutoFlow: ({ addUtilities: e2 }) => {
...
}, gridAutoRows: U(`gridAutoRows`, [[`auto-rows`, [`gridAutoRows`]]]), gridTemplateColumns: U(`gridTemplateColumns`, [[`grid-cols`, [`gridTemplateColumns`]]]), gridTemplateRows: U(`gridTemplateRows`, [[`grid-rows`, [`gridTemplateRows`]]]), flexDirection: ({ addUtilities: e2 }) => {
...
}, gap: U(`gap`, [[`gap`, [`gap`]], [[`gap-x`, [`columnGap`]], [`gap-y`, [`rowGap`]]]]), space: ({ matchUtilities: e2, addUtilities: t2, theme: n2 }) => {
  ...
  e2({ divide: (e3) => n2(`divideOpacity`) ? { "& > :not([hidden]) ~ :not([hidden])": F({ color: e3, property: `border-color`, variable: `--tw-divide-opacity` }) } : { "& > :not([hidden]) ~ :not([hidden])": { "border-color": G(e3) } } }, { values: (({ DEFAULT: e3, ...t3 }) => t3)(W(t2(`divideColor`))), type: [`color`, `any`] });
  ...
  e2({ border: (e3) => n2(`borderOpacity`) ? F({ color: e3, property: `border-color`, variable: `--tw-border-opacity` }) : { "border-color": G(e3) } }, { values: (({ DEFAULT: e3, ...t3 }) => t3)(W(t2(`borderColor`))), type: [`color`, `any`] }), e2({ "border-x": (e3) => n2(`borderOpacity`) ? F({ color: e3, property: [`border-left-color`, `border-right-color`], variable: `--tw-border-opacity` }) : { "border-left-color": G(e3), "border-right-color": G(e3) }, "border-y": (e3) => n2(`borderOpacity`) ? F({ color: e3, property: [`border-top-color`, `border-bottom-color`], variable: `--tw-border-opacity` }) : { "border-top-color": G(e3), "border-bottom-color": G(e3) } }, { values: (({ DEFAULT: e3, ...t3 }) => t3)(W(t2(`borderColor`))), type: [`color`, `any`] }), e2({ "border-s": (e3) => n2(`borderOpacity`) ? F({ color: e3, property: `border-inline-start-color`, variable: `--tw-border-opacity` }) : { "border-inline-start-color": G(e3) }, "border-e": (e3) => n2(`borderOpacity`) ? F({ color: e3, property: `border-inline-end-color`, variable: `--tw-border-opacity` }) : { "border-inline-end-color": G(e3) }, "border-t": (e3) => n2(`borderOpacity`) ? F({ color: e3, property: `border-top-color`, variable: `--tw-border-opacity` }) : { "border-top-color": G(e3) }, "border-r": (e3) => n2(`borderOpacity`) ? F({ color: e3, property: `border-right-color`, variable: `--tw-border-opacity` }) : { "border-right-color": G(e3) }, "border-b": (e3) => n2(`borderOpacity`) ? F({ color: e3, property: `border-bottom-color`, variable: `--tw-border-opacity` }) : { "border-bottom-color": G(e3) }, "border-l": (e3) => n2(`borderOpacity`) ? F({ color: e3, property: `border-left-color`, variable: `--tw-border-opacity` }) : { "border-left-color": G(e3) } }, { values: (({ DEFAULT: e3, ...t3 }) => t3)(W(t2(`borderColor`))), type: [`color`, `any`] });
}, borderOpacity: U(`borderOpacity`, [[`border-opacity`, [`--tw-border-opacity`]]]), backgroundColor: ({ matchUtilities: e2, theme: t2, corePlugins: n2 }) => {
  e2({ bg: (e3) => n2(`backgroundOpacity`) ? F({ color: e3, property: `background-color`, variable: `--tw-bg-opacity` }) : { "background-color": G(e3) } }, { values: W(t2(`backgroundColor`)), type: [`color`, `any`] });
}, backgroundOpacity: U(`backgroundOpacity`, [[`bg-opacity`, [`--tw-bg-opacity`]]]), backgroundImage: U(`backgroundImage`, [[`bg`, [`background-image`]]], { type: [`lookup`, `image`, `url`] }), gradientColorStops: /* @__PURE__ */ (() => {
  function e2(e3) {
    return P(e3, 0, `rgb(255 255 255 / 0)`);
  }
  return function({ matchUtilities: t2, theme: n2, addDefaults: r2 }) {
    ...
    let i2 = { values: W(n2(`gradientColorStops`)), type: [`color`, `any`] }, a2 = { values: n2(`gradientColorStopPositions`), type: [`length`, `percentage`] };
    t2({ from: (t3) => {
      let n3 = e2(t3);
      return { "@defaults gradient-color-stops": {}, "--tw-gradient-from": `${G(t3)} var(--tw-gradient-from-position)`, "--tw-gradient-to": `${n3} var(--tw-gradient-to-position)`, "--tw-gradient-stops": `var(--tw-gradient-from), var(--tw-gradient-to)` };
    } }, i2), t2({ from: (e3) => ({ "--tw-gradient-from-position": e3 }) }, a2), t2({ via: (t3) => ({ "@defaults gradient-color-stops": {}, "--tw-gradient-to": `${e2(t3)}  var(--tw-gradient-to-position)`, "--tw-gradient-stops": `var(--tw-gradient-from), ${G(t3)} var(--tw-gradient-via-position), var(--tw-gradient-to)` }) }, i2), t2({ via: (e3) => ({ "--tw-gradient-via-position": e3 }) }, a2), t2({ to: (e3) => ({ "@defaults gradient-color-stops": {}, "--tw-gradient-to": `${G(e3)} var(--tw-gradient-to-position)` }) }, i2), t2({ to: (e3) => ({ "--tw-gradient-to-position": e3 }) }, a2);
  };
...
}, backgroundSize: U(`backgroundSize`, [[`bg`, [`background-size`]]], { type: [`lookup`, `length`, `percentage`, `size`] }), backgroundAttachment: ({ addUtilities: e2 }) => {
...
}, backgroundPosition: U(`backgroundPosition`, [[`bg`, [`background-position`]]], { type: [`lookup`, [`position`, { preferOnConflict: true }]] }), backgroundRepeat: ({ addUtilities: e2 }) => {
  ...
  e2({ fill: (e3) => ({ fill: G(e3) }) }, { values: W(t2(`fill`)), type: [`color`, `any`] });
}, stroke: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ stroke: (e3) => ({ stroke: G(e3) }) }, { values: W(t2(`stroke`)), type: [`color`, `url`, `any`] });
}, strokeWidth: U(`strokeWidth`, [[`stroke`, [`stroke-width`]]], { type: [`length`, `number`, `percentage`] }), objectFit: ({ addUtilities: e2 }) => {
...
}, objectPosition: U(`objectPosition`, [[`object`, [`object-position`]]]), padding: U(`padding`, [[`p`, [`padding`]], [[`px`, [`padding-left`, `padding-right`]], [`py`, [`padding-top`, `padding-bottom`]]], [[`ps`, [`padding-inline-start`]], [`pe`, [`padding-inline-end`]], [`pt`, [`padding-top`]], [`pr`, [`padding-right`]], [`pb`, [`padding-bottom`]], [`pl`, [`padding-left`]]]]), textAlign: ({ addUtilities: e2 }) => {
...
}, textIndent: U(`textIndent`, [[`indent`, [`text-indent`]]], { supportsNegativeValues: true }), verticalAlign: ({ addUtilities: e2, matchUtilities: t2 }) => {
  ...
  e2({ font: (e3) => {
    let [t3, n2 = {}] = Array.isArray(e3) && j(e3[1]) ? e3 : [e3], { fontFeatureSettings: r2, fontVariationSettings: i2 } = n2;
  ...
  e2({ text: (e3, { modifier: t3 }) => {
    ...
    let { lineHeight: i2, letterSpacing: a2, fontWeight: o2 } = j(r2) ? r2 : { lineHeight: r2 };
...
}, fontWeight: U(`fontWeight`, [[`font`, [`fontWeight`]]], { type: [`lookup`, `number`, `any`] }), textTransform: ({ addUtilities: e2 }) => {
...
}, lineHeight: U(`lineHeight`, [[`leading`, [`lineHeight`]]]), letterSpacing: U(`letterSpacing`, [[`tracking`, [`letterSpacing`]]], { supportsNegativeValues: true }), textColor: ({ matchUtilities: e2, theme: t2, corePlugins: n2 }) => {
  e2({ text: (e3) => n2(`textOpacity`) ? F({ color: e3, property: `color`, variable: `--tw-text-opacity` }) : { color: G(e3) } }, { values: W(t2(`textColor`)), type: [`color`, `any`] });
}, textOpacity: U(`textOpacity`, [[`text-opacity`, [`--tw-text-opacity`]]]), textDecoration: ({ addUtilities: e2 }) => {
  ...
  e2({ decoration: (e3) => ({ "text-decoration-color": G(e3) }) }, { values: W(t2(`textDecorationColor`)), type: [`color`, `any`] });
...
}, textDecorationThickness: U(`textDecorationThickness`, [[`decoration`, [`text-decoration-thickness`]]], { type: [`length`, `percentage`] }), textUnderlineOffset: U(`textUnderlineOffset`, [[`underline-offset`, [`text-underline-offset`]]], { type: [`length`, `percentage`, `any`] }), fontSmoothing: ({ addUtilities: e2 }) => {
  ...
  e2({ placeholder: (e3) => n2(`placeholderOpacity`) ? { "&::placeholder": F({ color: e3, property: `color`, variable: `--tw-placeholder-opacity` }) } : { "&::placeholder": { color: G(e3) } } }, { values: W(t2(`placeholderColor`)), type: [`color`, `any`] });
  ...
  e2({ caret: (e3) => ({ "caret-color": G(e3) }) }, { values: W(t2(`caretColor`)), type: [`color`, `any`] });
}, accentColor: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ accent: (e3) => ({ "accent-color": G(e3) }) }, { values: W(t2(`accentColor`)), type: [`color`, `any`] });
}, opacity: U(`opacity`, [[`opacity`, [`opacity`]]]), backgroundBlendMode: ({ addUtilities: e2 }) => {
  ...
  let e2 = An(`boxShadow`), t2 = [`var(--tw-ring-offset-shadow, 0 0 #0000)`, `var(--tw-ring-shadow, 0 0 #0000)`, `var(--tw-shadow)`].join(`, `);
  return function({ matchUtilities: n2, addDefaults: r2, theme: i2 }) {
    r2(`box-shadow`, { "--tw-ring-offset-shadow": `0 0 #0000`, "--tw-ring-shadow": `0 0 #0000`, "--tw-shadow": `0 0 #0000`, "--tw-shadow-colored": `0 0 #0000` }), n2({ shadow: (n3) => {
      ...
      return { "@defaults box-shadow": {}, "--tw-shadow": n3 === `none` ? `0 0 #0000` : n3, "--tw-shadow-colored": n3 === `none` ? `0 0 #0000` : vt(r3), "box-shadow": t2 };
    } }, { values: i2(`boxShadow`), type: [`shadow`] });
  };
})(), boxShadowColor: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ shadow: (e3) => ({ "--tw-shadow-color": G(e3), "--tw-shadow": `var(--tw-shadow-colored)` }) }, { values: W(t2(`boxShadowColor`)), type: [`color`, `any`] });
...
}, outlineWidth: U(`outlineWidth`, [[`outline`, [`outline-width`]]], { type: [`length`, `number`, `percentage`] }), outlineOffset: U(`outlineOffset`, [[`outline-offset`, [`outline-offset`]]], { type: [`length`, `number`, `percentage`, `any`], supportsNegativeValues: true }), outlineColor: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ outline: (e3) => ({ "outline-color": G(e3) }) }, { values: W(t2(`outlineColor`)), type: [`color`, `any`] });
}, ringWidth: ({ matchUtilities: e2, addDefaults: t2, addUtilities: n2, theme: r2, config: i2 }) => {
  let a2 = (() => {
    if (z(i2(), `respectDefaultRingColorOpacity`)) return r2(`ringColor.DEFAULT`);
    let e3 = r2(`ringOpacity.DEFAULT`, `0.5`);
    return r2(`ringColor`)?.DEFAULT ? P(r2(`ringColor`)?.DEFAULT, e3, `rgb(147 197 253 / ${e3})`) : `rgb(147 197 253 / ${e3})`;
  })();
  ...
  e2({ ring: (e3) => n2(`ringOpacity`) ? F({ color: e3, property: `--tw-ring-color`, variable: `--tw-ring-opacity` }) : { "--tw-ring-color": G(e3) } }, { values: Object.fromEntries(Object.entries(W(t2(`ringColor`))).filter(([e3]) => e3 !== `DEFAULT`)), type: [`color`, `any`] });
}, ringOpacity: (e2) => {
  let { config: t2 } = e2;
  return U(`ringOpacity`, [[`ring-opacity`, [`--tw-ring-opacity`]]], { filterDefault: !z(t2(), `respectDefaultRingColorOpacity`) })(e2);
}, ringOffsetWidth: U(`ringOffsetWidth`, [[`ring-offset`, [`--tw-ring-offset-width`]]], { type: `length` }), ringOffsetColor: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ "ring-offset": (e3) => ({ "--tw-ring-offset-color": G(e3) }) }, { values: W(t2(`ringOffsetColor`)), type: [`color`, `any`] });
}, blur: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ blur: (e3) => ({ "--tw-blur": e3.trim() === `` ? ` ` : `blur(${e3})`, "@defaults filter": {}, filter: J }) }, { values: t2(`blur`) });
}, brightness: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ brightness: (e3) => ({ "--tw-brightness": `brightness(${e3})`, "@defaults filter": {}, filter: J }) }, { values: t2(`brightness`) });
}, contrast: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ contrast: (e3) => ({ "--tw-contrast": `contrast(${e3})`, "@defaults filter": {}, filter: J }) }, { values: t2(`contrast`) });
}, dropShadow: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ "drop-shadow": (e3) => ({ "--tw-drop-shadow": Array.isArray(e3) ? e3.map((e4) => `drop-shadow(${e4})`).join(` `) : `drop-shadow(${e3})`, "@defaults filter": {}, filter: J }) }, { values: t2(`dropShadow`) });
}, grayscale: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ grayscale: (e3) => ({ "--tw-grayscale": `grayscale(${e3})`, "@defaults filter": {}, filter: J }) }, { values: t2(`grayscale`) });
}, hueRotate: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ "hue-rotate": (e3) => ({ "--tw-hue-rotate": `hue-rotate(${e3})`, "@defaults filter": {}, filter: J }) }, { values: t2(`hueRotate`), supportsNegativeValues: true });
}, invert: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ invert: (e3) => ({ "--tw-invert": `invert(${e3})`, "@defaults filter": {}, filter: J }) }, { values: t2(`invert`) });
}, saturate: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ saturate: (e3) => ({ "--tw-saturate": `saturate(${e3})`, "@defaults filter": {}, filter: J }) }, { values: t2(`saturate`) });
}, sepia: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ sepia: (e3) => ({ "--tw-sepia": `sepia(${e3})`, "@defaults filter": {}, filter: J }) }, { values: t2(`sepia`) });
}, filter: ({ addDefaults: e2, addUtilities: t2 }) => {
  e2(`filter`, { "--tw-blur": ` `, "--tw-brightness": ` `, "--tw-contrast": ` `, "--tw-grayscale": ` `, "--tw-hue-rotate": ` `, "--tw-invert": ` `, "--tw-saturate": ` `, "--tw-sepia": ` `, "--tw-drop-shadow": ` ` }), t2({ ".filter": { "@defaults filter": {}, filter: J }, ".filter-none": { filter: `none` } });
}, backdropBlur: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ "backdrop-blur": (e3) => ({ "--tw-backdrop-blur": e3.trim() === `` ? ` ` : `blur(${e3})`, "@defaults backdrop-filter": {}, "-webkit-backdrop-filter": Y, "backdrop-filter": Y }) }, { values: t2(`backdropBlur`) });
}, backdropBrightness: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ "backdrop-brightness": (e3) => ({ "--tw-backdrop-brightness": `brightness(${e3})`, "@defaults backdrop-filter": {}, "-webkit-backdrop-filter": Y, "backdrop-filter": Y }) }, { values: t2(`backdropBrightness`) });
}, backdropContrast: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ "backdrop-contrast": (e3) => ({ "--tw-backdrop-contrast": `contrast(${e3})`, "@defaults backdrop-filter": {}, "-webkit-backdrop-filter": Y, "backdrop-filter": Y }) }, { values: t2(`backdropContrast`) });
}, backdropGrayscale: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ "backdrop-grayscale": (e3) => ({ "--tw-backdrop-grayscale": `grayscale(${e3})`, "@defaults backdrop-filter": {}, "-webkit-backdrop-filter": Y, "backdrop-filter": Y }) }, { values: t2(`backdropGrayscale`) });
}, backdropHueRotate: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ "backdrop-hue-rotate": (e3) => ({ "--tw-backdrop-hue-rotate": `hue-rotate(${e3})`, "@defaults backdrop-filter": {}, "-webkit-backdrop-filter": Y, "backdrop-filter": Y }) }, { values: t2(`backdropHueRotate`), supportsNegativeValues: true });
}, backdropInvert: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ "backdrop-invert": (e3) => ({ "--tw-backdrop-invert": `invert(${e3})`, "@defaults backdrop-filter": {}, "-webkit-backdrop-filter": Y, "backdrop-filter": Y }) }, { values: t2(`backdropInvert`) });
}, backdropOpacity: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ "backdrop-opacity": (e3) => ({ "--tw-backdrop-opacity": `opacity(${e3})`, "@defaults backdrop-filter": {}, "-webkit-backdrop-filter": Y, "backdrop-filter": Y }) }, { values: t2(`backdropOpacity`) });
}, backdropSaturate: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ "backdrop-saturate": (e3) => ({ "--tw-backdrop-saturate": `saturate(${e3})`, "@defaults backdrop-filter": {}, "-webkit-backdrop-filter": Y, "backdrop-filter": Y }) }, { values: t2(`backdropSaturate`) });
}, backdropSepia: ({ matchUtilities: e2, theme: t2 }) => {
  e2({ "backdrop-sepia": (e3) => ({ "--tw-backdrop-sepia": `sepia(${e3})`, "@defaults backdrop-filter": {}, "-webkit-backdrop-filter": Y, "backdrop-filter": Y }) }, { values: t2(`backdropSepia`) });
}, backdropFilter: ({ addDefaults: e2, addUtilities: t2 }) => {
  e2(`backdrop-filter`, { "--tw-backdrop-blur": ` `, "--tw-backdrop-brightness": ` `, "--tw-backdrop-contrast": ` `, "--tw-backdrop-grayscale": ` `, "--tw-backdrop-hue-rotate": ` `, "--tw-backdrop-invert": ` `, "--tw-backdrop-opacity": ` `, "--tw-backdrop-saturate": ` `, "--tw-backdrop-sepia": ` ` }), t2({ ".backdrop-filter": { "@defaults backdrop-filter": {}, "-webkit-backdrop-filter": Y, "backdrop-filter": Y }, ".backdrop-filter-none": { "-webkit-backdrop-filter": `none`, "backdrop-filter": `none` } });
...
}, content: U(`content`, [[`content`, [`--tw-content`, [`content`, `var(--tw-content)`]]]]), forcedColorAdjust: ({ addUtilities: e2 }) => {
...
var Qn = /* @__PURE__ */ new Map([[`{`, `}`], [`[`, `]`], [`(`, `)`]]), $n = new Map(Array.from(Qn.entries()).map(([e2, t2]) => [t2, e2])), er = /* @__PURE__ */ new Set([`"`, `'`, "`"]);
function tr(e2) {
  let t2 = [], n2 = false;
  for (let r2 = 0; r2 < e2.length; r2++) {
    let i2 = e2[r2];
    if (i2 === `:` && !n2 && t2.length === 0) return false;
    if (er.has(i2) && e2[r2 - 1] !== `\\` && (n2 = !n2), !n2 && e2[r2 - 1] !== `\\`) {
...
var ir = class {
  ...
  applyVariantOffset(e2, t2, n2) {
    return n2.variant = t2.variants, { ...e2, layer: `variants`, parentLayer: e2.layer === `variants` ? e2.parentLayer : e2.layer, variants: e2.variants | t2.variants, options: n2.sort ? [].concat(n2, e2.options) : e2.options, parallelIndex: ar([e2.parallelIndex, t2.parallelIndex]) };
  }
  ...
  compare(e2, t2) {
    ...
    for (let n2 of e2.options) for (let r2 of t2.options) {
      ...
      let i2 = ar([n2.variant, r2.variant]) ?? 0n, a2 = ~(i2 | i2 - 1n);
  ...
  recalculateVariantOffsets() {
    let e2 = Array.from(this.variantOffsets.entries()).filter(([e3]) => e3.startsWith(`[`)).sort(([e3], [t3]) => or(e3, t3)), t2 = e2.map(([, e3]) => e3).sort((e3, t3) => nr(e3 - t3));
  ...
  remapArbitraryVariantOffsets(e2) {
    ...
    return t2.length === 0 ? e2 : e2.map((e3) => {
      let [n2, r2] = e3;
      return n2 = { ...n2, variants: rr(n2.variants, t2) }, [n2, r2];
    });
  }
  ...
  sort(e2) {
    return e2 = this.remapArbitraryVariantOffsets(e2), e2 = this.sortArbitraryProperties(e2), e2.sort(([e3], [t2]) => nr(this.compare(e3, t2)));
  }
};
function ar(e2) {
  let t2 = null;
...
var X = /* @__PURE__ */ Symbol(), sr = { AddVariant: /* @__PURE__ */ Symbol.for(`ADD_VARIANT`), MatchVariant: /* @__PURE__ */ Symbol.for(`MATCH_VARIANT`) }, cr = { Base: 1, Dynamic: 2 };
function lr(e2, t2) {
  let n2 = e2.tailwindConfig.prefix;
  return typeof n2 == `function` ? n2(t2) : n2 + t2;
}
function ur({ type: e2 = `any`, ...t2 }) {
  let n2 = [].concat(e2);
...
function pr(e2) {
  return Array.isArray(e2) ? e2.flatMap((e3) => !Array.isArray(e3) && !j(e3) ? e3 : Le(e3)) : pr([e2]);
}
function mr(e2, t2) {
  return (0, k.default)((e3) => {
    let n2 = [];
...
function gr(e2, t2 = { containsNonOnDemandable: false }, n2 = 0) {
  let r2 = [], i2 = [];
...
function _r(e2) {
  return pr(e2).flatMap((e3) => {
    let t2 = /* @__PURE__ */ new Map(), [n2, r2] = gr(e3);
...
function br(e2, t2, { variantList: n2, variantMap: r2, offsets: i2, classList: a2 }) {
  function o2(t3, n3) {
    return t3 ? (0, kn.default)(e2, t3, n3) : e2;
  }
  function s2(t3) {
    return Re(e2.prefix, t3);
  }
  function c2(e3, n3) {
    return e3 === S ? S : n3.respectPrefix ? t2.tailwindConfig.prefix + e3 : e3;
  }
  function u2(e3, t3, n3 = {}) {
    let r3 = Zn(e3), i3 = o2([`theme`, ...r3], t3);
    return An(r3[0])(i3, n3);
  }
  let d2 = 0, f2 = { postcss: l, prefix: s2, e: H, config: o2, theme: u2, corePlugins: (t3) => Array.isArray(e2.corePlugins) ? e2.corePlugins.includes(t3) : o2([`corePlugins`, t3], true), variants: () => [], addBase(e3) {
    for (let [n3, r3] of _r(e3)) {
    ...
    r3 = ur({ respectPrefix: true, respectImportant: true, modifiers: false, ...r3 });
    let o3 = i2.create(`utilities`);
    for (let i3 in n3) {
      let u3 = function(t3, { isOnlyPlugin: n4 }) {
        let [a3, o4, s4] = cn(r3.types, t3, r3, e2);
        if (a3 === void 0) return [];
        ...
        } }, u4 = z(e2, `generalizedModifiers`);
        return [].concat(u4 ? l2(a3, c3) : l2(a3)).filter(Boolean).map((e3) => ({ [En(i3, t3)]: e3 }));
      };
    ...
    r3 = ur({ respectPrefix: true, respectImportant: false, modifiers: false, ...r3 });
    ...
    i3 = [].concat(i3).map((t3) => {
      if (typeof t3 != `string`) return (n3 = {}) => {
        let { args: r3, modifySelectors: i4, container: o3, separator: s3, wrap: c3, format: l2 } = n3, u3 = t3(Object.assign({ modifySelectors: i4, container: o3, separator: s3 }, a3.type === sr.MatchVariant && { args: r3, wrap: c3, format: l2 }));
        if (typeof u3 == `string` && !vr(u3)) throw Error(`Your custom variant \`${e3}\` has an invalid format string. Make sure it's an at-rule or contains a \`&\` placeholder.`);
        return Array.isArray(u3) ? u3.filter((e4) => typeof e4 == `string`).map((e4) => yr(e4)) : u3 && typeof u3 == `string` && yr(u3)(n3);
      };
      if (!vr(t3)) throw Error(`Your custom variant \`${e3}\` has an invalid format string. Make sure it's an at-rule or contains a \`&\` placeholder.`);
      return yr(t3);
    }), fr(n2, e3, a3), r2.set(e3, i3), t2.variantOptions.set(e3, a3);
  }, matchVariant(t3, n3, r3) {
    let i3 = r3?.id ?? ++d2, a3 = t3 === `@`, o3 = z(e2, `generalizedModifiers`);
    for (let [e3, s4] of Object.entries(r3?.values ?? {})) e3 !== `DEFAULT` && f2.addVariant(a3 ? `${t3}${e3}` : `${t3}-${e3}`, ({ args: e4, container: t4 }) => n3(s4, o3 ? { modifier: e4?.modifier, container: t4 } : { container: t4 }), { ...r3, value: s4, id: i3, type: sr.MatchVariant, variantInfo: cr.Base });
    let s3 = `DEFAULT` in (r3?.values ?? {});
    f2.addVariant(t3, ({ args: e3, container: t4 }) => e3?.value === C && !s3 ? null : n3(e3?.value === C ? r3.values.DEFAULT : e3?.value ?? (typeof e3 == `string` ? e3 : ``), o3 ? { modifier: e3?.modifier, container: t4 } : { container: t4 }), { ...r3, id: i3, type: sr.MatchVariant, variantInfo: cr.Dynamic });
  } };
  return f2;
}
function xr(e2) {
  e2.walkAtRules((e3) => {
    [`responsive`, `variants`].includes(e3.name) && (xr(e3), e3.before(e3.nodes), e3.remove());
  });
}
function Sr(e2) {
  let t2 = [];
...
function Cr(e2, t2) {
  let n2 = Object.entries({ ...K, ...Xn }).map(([t3, n3]) => e2.tailwindConfig.corePlugins.includes(t3) ? n3 : null).filter(Boolean), r2 = e2.tailwindConfig.plugins.map((e3) => (e3.__isOptionsFunction && (e3 = e3()), typeof e3 == `function` ? e3 : e3.handler)), i2 = Sr(t2), a2 = [K.childVariant, K.pseudoElementVariants, K.pseudoClassVariants, K.hasVariants, K.ariaVariants, K.dataVariants], o2 = [K.supportsVariants, K.reducedMotionVariants, K.prefersContrastVariants, K.screenVariants, K.orientationVariants, K.directionVariants, K.darkVariants, K.forcedColorsVariants, K.printVariant];
  return (e2.tailwindConfig.darkMode === `class` || Array.isArray(e2.tailwindConfig.darkMode) && e2.tailwindConfig.darkMode[0] === `class`) && (o2 = [K.supportsVariants, K.reducedMotionVariants, K.prefersContrastVariants, K.darkVariants, K.screenVariants, K.orientationVariants, K.directionVariants, K.forcedColorsVariants, K.printVariant]), [...n2, ...a2, ...r2, ...o2, ...i2];
}
function wr(e2, t2) {
  ...
  let i2 = new ir();
  t2.offsets = i2;
  let a2 = /* @__PURE__ */ new Set(), o2 = br(t2.tailwindConfig, t2, { variantList: n2, variantMap: r2, offsets: i2, classList: a2 });
    ...
    if (e3.length > 0) {
      ...
      for (let o3 of a2) {
        let a3 = Array.isArray(o3) ? (() => {
          let [e4, n4] = o3, a4 = Object.keys(n4?.values ?? {}).map((t3) => Dn(e4, t3));
  ...
  let c2 = [lr(t2, [].concat(t2.tailwindConfig.darkMode ?? `media`)[1] ?? `dark`), lr(t2, `group`), lr(t2, `peer`)];
  t2.getClassOrder = function(e3) {
    let n3 = [...e3].sort((e4, t3) => e4 === t3 ? 0 : e4 < t3 ? -1 : 1), r3 = new Map(n3.map((e4) => [e4, null])), i3 = Yr(new Set(n3), t2, true);
    ...
    for (let r3 of a2) if (Array.isArray(r3)) {
      ...
      for (let [e4, t3] of Object.entries(a3?.values ?? {})) {
        if (t3 == null) continue;
        let r4 = Dn(i3, e4);
        if (n3.push(l2 ? [r4, c3] : r4), a3?.supportsNegativeValues && Ut(t3)) {
          let t4 = Dn(i3, `-${e4}`);
          o3.push(l2 ? [t4, c3] : t4);
        }
      }
    ...
    for (let [r3, i3] of t2.variantOptions.entries()) i3.variantInfo !== cr.Base && n3.push({ name: r3, isArbitrary: i3.type === /* @__PURE__ */ Symbol.for(`MATCH_VARIANT`), values: Object.keys(i3.values ?? {}), hasDash: r3 !== `@`, selectors({ modifier: n4, value: a3 } = {}) {
      ...
      u2 !== c3.toString() && (c3.walkRules((e4) => {
        let n5 = e4.selector, i4 = (0, k.default)((e5) => {
          e5.walkClasses((e6) => {
      ...
      let m2 = !(a3 in (i3.values ?? {})), h2 = i3[X] ?? {}, g2 = !(m2 || h2.respectPrefix === false);
      f2 = f2.map((e4) => e4.map((e5) => ({ format: e5, respectPrefix: g2 }))), p2 = p2.map((e4) => ({ format: e4, respectPrefix: g2 }));
      let _2 = { candidate: o3, context: t2 }, v2 = f2.map((e4) => Cn(`.${o3}`, yn(e4, _2), _2).replace(`.${o3}`, `&`).replace(`{ & }`, ``).trim());
      return p2.length > 0 && v2.push(yn(p2, _2).toString().replace(`.${o3}`, `&`)), v2;
    } });
    return n3;
  };
}
  ...
  for (let n2 of e2) {
    ...
    if (e3.options.respectPrefix) {
      ...
      e4.walkRules((e5) => {
        ...
        e5.selector = Re(t2.tailwindConfig.prefix, e5.selector, n3);
      }), n2[1] = e4.nodes[0];
    }
  }
  return e2;
...
function Nr(e2, t2) {
  ...
  for (let [i2, a2] of e2) {
    ...
    e3.walkRules((e4) => {
      if (r2(e4)) return;
      let n3 = (0, k.default)().astSync(e4.selector);
      n3.each((e5) => Sn(e5, t2)), Yt(n3, (e5) => e5 === t2 ? `!${e5}` : e5);
      let i3 = n3.toString();
      if (i3.trim() === ``) {
        e4.remove();
        return;
...
function Pr(e2, t2, n2) {
  ...
  {
    let [t3, ...i2] = I(e2, `/`);
    if (i2.length > 1 && (t3 = t3 + `/` + i2.slice(0, -1).join(`/`), i2 = i2.slice(-1)), i2.length && !n2.variantMap.has(e2) && (e2 = t3, r2.modifier = i2[0], !z(n2.tailwindConfig, `generalizedModifiers`))) return [];
  }
  ...
  if (Xr(e2) && !n2.variantMap.has(e2)) {
    let t3 = n2.offsets.recordVariant(e2), r3 = I(L(e2.slice(1, -1)), `,`);
    if (r3.length > 1 || !r3.every(vr)) return [];
    let i2 = r3.map((e3, r4) => [n2.offsets.applyParallelOffset(t3, r4), yr(e3.trim())]);
    n2.variantMap.set(e2, i2);
  }
  if (n2.variantMap.has(e2)) {
    let i2 = Xr(e2), a2 = n2.variantOptions.get(e2)?.[X] ?? {}, o2 = n2.variantMap.get(e2).slice(), s2 = [], c2 = !(i2 || a2.respectPrefix === false);
    for (let [i3, a3] of t2) {
      ...
      for (let [a4, l2, u2] of o2) {
        ...
        d2.raws.neededBackup && (delete d2.raws.neededBackup, d2.walkRules((t4) => {
          ...
          let i4 = t4.selector, a5 = (0, k.default)((t5) => {
            t5.walkClasses((t6) => {
...
function Fr(e2, t2, n2 = {}) {
  return !j(e2) && !Array.isArray(e2) ? [[e2], n2] : Array.isArray(e2) ? Fr(e2[0], t2, e2[1]) : (t2.has(e2) || t2.set(e2, Le(e2)), [t2.get(e2), n2]);
}
var Ir = /^[a-z_-]/;
function Lr(e2) {
  return Ir.test(e2);
...
function zr(e2) {
  ...
  return e2.walkDecls((e3) => {
    if (!Br(e3.prop, e3.value)) return t2 = false, false;
  }), t2;
}
function Br(e2, t2) {
  if (Rr(`${e2}:${t2}`)) return false;
  try {
...
function Vr(e2, t2) {
  ...
  if (r2 === void 0 || !Lr(n2) || !tr(r2)) return null;
  let i2 = L(r2, { property: n2 });
  return Br(n2, i2) ? [[{ sort: t2.offsets.arbitraryProperty(e2), layer: `utilities`, options: { respectImportant: true } }, () => ({ [Tn(e2)]: { [n2]: i2 } })]] : null;
}
function* Hr(e2, t2) {
  ...
  for (let [e3, i3] of jr(n2)) t2.candidateRuleMap.has(e3) && (yield [t2.candidateRuleMap.get(e3), r2 ? `-${i3}` : i3]);
}
function Ur(e2, t2) {
  return e2 === S ? [S] : I(e2, t2);
}
function* Wr(e2, t2) {
      ...
      if (o2.length > 1) {
        let r3 = function(e3) {
          return e3.length === 1 ? e3[0] : e3.find((e4) => {
            let t4 = s2.get(e4);
            return e4.some(([{ options: e5 }, n5]) => zr(n5) ? e5.types.some(({ type: e6, preferOnConflict: n6 }) => t4.includes(e6) && n6) : false);
          });
        };
...
`);
      ...
      o2 = o2.map((e3) => e3.filter((e4) => zr(e4[1])));
    }
    o2 = o2.flat(), o2 = Array.from(Wr(o2, r2)), o2 = Mr(o2, t2), a2 && (o2 = Nr(o2, r2));
    for (let e3 of i2) o2 = Pr(e3, o2, t2);
    for (let n4 of o2) n4[1].raws.tailwind = { ...n4[1].raws.tailwind, candidate: e2 }, n4 = Kr(n4, { context: t2, candidate: e2 }), n4 !== null && (yield n4);
  }
}
function Kr(e2, { context: t2, candidate: n2 }) {
  if (!e2[0].collectedFormats) return e2;
  let r2 = true, i2;
  try {
    i2 = yn(e2[0].collectedFormats, { context: t2, candidate: n2 });
  } catch {
    return null;
  }
  ...
  return a2.walkRules((e3) => {
    if (!qr(e3)) try {
      let r3 = Cn(e3.selector, i2, { candidate: n2, context: t2 });
      if (r3 === null) {
        e3.remove();
        return;
      }
...
function Jr(e2) {
  if (e2 === true) return (e3) => {
    qr(e3) || e3.walkDecls((e4) => {
      e4.parent.type === `rule` && !qr(e4.parent) && (e4.important = true);
    });
  };
  if (typeof e2 == `string`) return (t2) => {
    qr(t2) || (t2.selectors = t2.selectors.map((t3) => Or(t3, e2)));
  };
}
function Yr(e2, t2, n2 = false) {
  let r2 = [], i2 = Jr(t2.tailwindConfig.important);
  for (let a2 of e2) {
...
function ai(e2, t2) {
  ...
  return e2.walkRules((e3) => {
    for (let t3 of ni(e3)) if (t3.raws.tailwind?.layer !== void 0) return;
    let r2 = ii(e3), i2 = t2.offsets.create(`user`);
    for (let t3 of Zr(e3)) {
      let e4 = n2.get(t3) || [];
...
function ui(e2, t2, n2) {
  ...
  let a2 = ci([n2, oi(r2, t2)]);
  function o2(e3, t3, n3) {
    let r3 = $r(e3), i3 = $r(t3), a3 = $r(`.${H(n3)}`).nodes[0].nodes[0];
    return r3.each((e4) => {
  ...
  for (let e3 of i2) {
    ...
    for (let o3 of r3) {
      if ([ti(t2, `group`), ti(t2, `peer`)].includes(o3)) throw e3.error(`@apply should not be used with the '${o3}' utility`);
...
`));
  ...
  for (let [e3, [n3, r3]] of s2) {
    ...
    for (let [a4, s3, c2] of n3) {
      let n4 = [a4, ...ei([a4], t2.tailwindConfig.separator)];
      for (let [u2, d2] of c2) {
        let c3 = Zr(e3), f2 = Zr(d2);
        if (f2 = f2.groups.filter((e4) => e4.some((e5) => n4.includes(e5))).flat(), f2 = f2.concat(ei(f2, t2.tailwindConfig.separator)), c3.some((e4) => f2.includes(e4))) throw d2.error(`You cannot \`@apply\` the \`${a4}\` utility here because it creates a circular dependency.`);
        let p2 = l.root({ nodes: [d2.clone()] });
        p2.walk((e4) => {
          e4.source = r3;
        }), (d2.type !== `atrule` || d2.type === `atrule` && d2.name !== `keyframes`) && p2.walkRules((n5) => {
          if (!Zr(n5).some((e4) => e4 === a4)) {
            n5.remove();
            return;
          }
          ...
          i4 === `` && (i4 = e3.selector), n5.selector = o2(i4, n5.selector, a4), r4 && i4 !== e3.selector && (n5.selector = Or(n5.selector, r4)), n5.walkDecls((e4) => {
            e4.important = u2.important || s3;
          });
          let c4 = (0, k.default)().astSync(n5.selector);
          c4.each((e4) => fn(e4)), n5.selector = c4.toString();
...
var fi = t(((e2, t2) => {
  ...
  var n2 = /^[a-f0-9?-]+$/i;
  t2.exports = function(e3) {
    for (var t3 = [], r2 = e3, i2, a2, o2, s2, c2, l2, u2, d2, f2 = 0, p2 = r2.charCodeAt(f2), m2 = r2.length, h2 = [{ nodes: t3 }], g2 = 0, _2, v2 = ``, y2 = ``, b2 = ``; f2 < m2; ) if (p2 <= 32) {
      i2 = f2;
      do
        i2 += 1, p2 = r2.charCodeAt(i2);
      while (p2 <= 32);
      s2 = r2.slice(f2, i2), o2 = t3[t3.length - 1], p2 === 41 && g2 ? b2 = s2 : o2 && o2.type === `div` ? (o2.after = s2, o2.sourceEndIndex += s2.length) : p2 === 44 || p2 === 58 || p2 === 47 && r2.charCodeAt(i2 + 1) !== 42 && (!_2 || _2 && _2.type === `function` && false) ? y2 = s2 : t3.push({ type: `space`, sourceIndex: f2, sourceEndIndex: i2, value: s2 }), f2 = i2;
    } else if (p2 === 39 || p2 === 34) {
      i2 = f2, a2 = p2 === 39 ? `'` : `"`, s2 = { type: `string`, sourceIndex: f2, quote: a2 };
      do
        if (c2 = false, i2 = r2.indexOf(a2, i2 + 1), ~i2) for (l2 = i2; r2.charCodeAt(l2 - 1) === 92; ) --l2, c2 = !c2;
        else r2 += a2, i2 = r2.length - 1, s2.unclosed = true;
      while (c2);
      s2.value = r2.slice(f2 + 1, i2), s2.sourceEndIndex = s2.unclosed ? i2 : i2 + 1, t3.push(s2), f2 = i2 + 1, p2 = r2.charCodeAt(f2);
    } else if (p2 === 47 && r2.charCodeAt(f2 + 1) === 42) i2 = r2.indexOf(`*/`, f2), s2 = { type: `comment`, sourceIndex: f2, sourceEndIndex: i2 + 2 }, i2 === -1 && (s2.unclosed = true, i2 = r2.length, s2.sourceEndIndex = i2), s2.value = r2.slice(f2 + 2, i2), t3.push(s2), f2 = i2 + 2, p2 = r2.charCodeAt(f2);
    else if ((p2 === 47 || p2 === 42) && _2 && _2.type === `function`) s2 = r2[f2], t3.push({ type: `word`, sourceIndex: f2 - y2.length, sourceEndIndex: f2 + s2.length, value: s2 }), f2 += 1, p2 = r2.charCodeAt(f2);
    else if (p2 === 47 || p2 === 44 || p2 === 58) s2 = r2[f2], t3.push({ type: `div`, sourceIndex: f2 - y2.length, sourceEndIndex: f2 + s2.length, value: s2, before: y2, after: `` }), y2 = ``, f2 += 1, p2 = r2.charCodeAt(f2);
    else if (p2 === 40) {
      i2 = f2;
      do
        i2 += 1, p2 = r2.charCodeAt(i2);
      while (p2 <= 32);
      if (d2 = f2, s2 = { type: `function`, sourceIndex: f2 - v2.length, value: v2, before: r2.slice(d2 + 1, i2) }, f2 = i2, v2 === `url` && p2 !== 39 && p2 !== 34) {
        --i2;
        do
          if (c2 = false, i2 = r2.indexOf(`)`, i2 + 1), ~i2) for (l2 = i2; r2.charCodeAt(l2 - 1) === 92; ) --l2, c2 = !c2;
          else r2 += `)`, i2 = r2.length - 1, s2.unclosed = true;
        while (c2);
        u2 = i2;
        do
          --u2, p2 = r2.charCodeAt(u2);
        while (p2 <= 32);
        d2 < u2 ? (f2 === u2 + 1 ? s2.nodes = [] : s2.nodes = [{ type: `word`, sourceIndex: f2, sourceEndIndex: u2 + 1, value: r2.slice(f2, u2 + 1) }], s2.unclosed && u2 + 1 !== i2 ? (s2.after = ``, s2.nodes.push({ type: `space`, sourceIndex: u2 + 1, sourceEndIndex: i2, value: r2.slice(u2 + 1, i2) })) : (s2.after = r2.slice(u2 + 1, i2), s2.sourceEndIndex = i2)) : (s2.after = ``, s2.nodes = []), f2 = i2 + 1, s2.sourceEndIndex = s2.unclosed ? i2 : f2, p2 = r2.charCodeAt(f2), t3.push(s2);
      } else g2 += 1, s2.after = ``, s2.sourceEndIndex = f2 + 1, t3.push(s2), h2.push(s2), t3 = s2.nodes = [], _2 = s2;
      v2 = ``;
    } else if (p2 === 41 && g2) f2 += 1, p2 = r2.charCodeAt(f2), _2.after = b2, _2.sourceEndIndex += b2.length, b2 = ``, --g2, h2[h2.length - 1].sourceEndIndex = f2, h2.pop(), _2 = h2[g2], t3 = _2.nodes;
    else {
      i2 = f2;
      do
        p2 === 92 && (i2 += 1), i2 += 1, p2 = r2.charCodeAt(i2);
      while (i2 < m2 && !(p2 <= 32 || p2 === 39 || p2 === 34 || p2 === 44 || p2 === 58 || p2 === 47 || p2 === 40 || p2 === 42 && _2 && _2.type === `function` || p2 === 47 && _2.type === `function` || p2 === 41 && g2));
      s2 = r2.slice(f2, i2), p2 === 40 ? v2 = s2 : (s2.charCodeAt(0) === 117 || s2.charCodeAt(0) === 85) && s2.charCodeAt(1) === 43 && n2.test(s2.slice(2)) ? t3.push({ type: `unicode-range`, sourceIndex: f2, sourceEndIndex: i2, value: s2 }) : t3.push({ type: `word`, sourceIndex: f2, sourceEndIndex: i2, value: s2 }), f2 = i2;
    }
    for (f2 = h2.length - 1; f2; --f2) h2[f2].unclosed = true, h2[f2].sourceEndIndex = r2.length;
    return h2[0].nodes;
  };
})), mi = t(((e2, t2) => {
  ...
  }, a2.unit = gi(), a2.walk = r2, a2.stringify = i2, t2.exports = a2;
})), vi = e(fi()), yi = e(_i());
function bi(e2) {
...
function xi(e2, t2) {
  let n2 = Zn(t2);
  do
    if (n2.pop(), (0, kn.default)(e2, n2) !== void 0) break;
  while (n2.length);
...
function wi(e2, t2, n2, r2 = {}) {
  let i2 = Array.isArray(t2) ? Z(t2) : t2.replace(/^['"]+|['"]+$/g, ``), a2 = Array.isArray(t2) ? t2 : Zn(i2), o2 = (0, kn.default)(e2.theme, a2, n2);
  if (o2 === void 0) {
    let t3 = `'${i2}' does not exist in your theme config.`, n3 = a2.slice(0, -1), r3 = (0, kn.default)(e2.theme, n3);
    if (bi(r3)) {
      let i3 = Object.keys(r3).filter((t4) => wi(e2, [...n3, t4]).isValid), o3 = (0, vi.default)(a2[a2.length - 1], i3);
      o3 ? t3 += ` Did you mean '${Z([...n3, o3])}'?` : i3.length > 0 && (t3 += ` '${Z(n3)}' has the following valid keys: ${Si(i3)}`);
    } else {
      let n4 = xi(e2.theme, i2);
      if (n4) {
        let r4 = (0, kn.default)(e2.theme, n4);
        bi(r4) ? t3 += ` '${Z(n4)}' has the following keys: ${Ci(r4)}` : t3 += ` '${Z(n4)}' is not an object.`;
      } else t3 += ` Your theme has the following top-level keys: ${Ci(e2.theme)}`;
    }
  ...
  if (!(typeof o2 == `string` || typeof o2 == `number` || typeof o2 == `function` || o2 instanceof String || o2 instanceof Number || Array.isArray(o2))) {
    ...
    if (bi(o2)) {
      let n3 = Object.keys(o2).filter((t4) => wi(e2, [...a2, t4]).isValid);
      n3.length && (t3 += ` Did you mean something like '${Z([...a2, n3[0]])}'?`);
    }
    return { isValid: false, error: t3 };
  }
  let [s2] = a2;
  return { isValid: true, value: An(s2)(o2, r2) };
}
function Ti(e2, t2, n2) {
  t2 = t2.map((t3) => Ei(e2, t3, n2));
  let r2 = [``];
  for (let e3 of t2) e3.type === `div` && e3.value === `,` ? r2.push(``) : r2[r2.length - 1] += yi.default.stringify(e3);
  return r2;
}
function Ei(e2, t2, n2) {
  if (t2.type === `function` && n2[t2.value] !== void 0) {
    let r2 = Ti(e2, t2.nodes, n2);
    t2.type = `word`, t2.value = n2[t2.value](e2, ...r2);
  }
  return t2;
}
function Di(e2, t2, n2) {
  return Object.keys(n2).some((e3) => t2.includes(`${e3}(`)) ? (0, yi.default)(t2).walk((t3) => {
    Ei(e2, t3, n2);
  }).toString() : t2;
}
var Oi = { atrule: `params`, decl: `value` };
function* ki(e2) {
  e2 = e2.replace(/^['"]+|['"]+$/g, ``);
...
function Ai(e2, t2, n2) {
  let r2 = Array.from(ki(t2)).map(([t3, r3]) => Object.assign(wi(e2, t3, n2, { opacityValue: r3 }), { resolvedPath: t3, alpha: r3 }));
  return r2.find((e3) => e3.isValid) ?? r2[0];
}
function ji(e2) {
  let t2 = e2.tailwindConfig, n2 = { theme: (n3, r2, ...i2) => {
    let { isValid: a2, value: o2, error: s2, alpha: c2 } = Ai(t2, r2, i2.length ? i2 : void 0);
    if (!a2) {
    ...
    let l2 = en(o2);
    return (c2 !== void 0 || l2 !== void 0 && typeof l2 == `function`) && (c2 === void 0 && (c2 = 1), o2 = P(l2, c2, l2)), o2;
  }, screen: (e3, n3) => {
    n3 = n3.replace(/^['"]+/g, ``).replace(/['"]+$/g, ``);
    let r2 = Wn(t2.theme.screens).find(({ name: e4 }) => e4 === n3);
...
function Pi({ version: e2, from: t2, to: n2 }) {
...
function Li(e2) {
  (() => {
    ...
    if (Array.isArray(e2.content)) return e2.content.every((e3) => typeof e3 == `string` || !(typeof e3?.raw != `string` || e3?.extension && typeof e3?.extension != `string`));
    if (typeof e2.content == `object` && e2.content !== null) {
      ...
      if (Array.isArray(e2.content.files)) {
        if (!e2.content.files.every((e3) => typeof e3 == `string` || !(typeof e3?.raw != `string` || e3?.extension && typeof e3?.extension != `string`))) return false;
    ...
    let { content: t2 } = e2;
    return t2?.relative ? t2.relative : z(e2, `relativeContentPathsByDefault`);
  })(), files: (() => {
...
function Ri(e2) {
  return Array.isArray(e2) ? e2.map((e3) => Ri(e3)) : typeof e2 == `object` && e2 ? Object.fromEntries(Object.entries(e2).map(([e3, t2]) => [e3, Ri(t2)])) : e2;
}
function Q(e2) {
...
function $(e2, ...t2) {
  ...
  for (let r2 of t2) for (let t3 in r2) {
    ...
    i2 === void 0 ? j(e2[t3]) && j(r2[t3]) ? e2[t3] = $({}, e2[t3], r2[t3], n2) : e2[t3] = r2[t3] : e2[t3] = i2;
  }
  return e2;
}
var zi = { colors: Fi, negative(e2) {
...
function Bi(e2, ...t2) {
  return Q(e2) ? e2(...t2) : e2;
}
function Vi(e2) {
  return e2.reduce((e3, { extend: t2 }) => $(e3, t2, (e4, t3) => e4 === void 0 ? [t3] : Array.isArray(e4) ? [t3, ...e4] : [t3, e4]), {});
}
function Hi(e2) {
  return { ...e2.reduce((e3, t2) => Ii(e3, t2), {}), extend: Vi(e2) };
}
function Ui(e2, t2) {
  if (Array.isArray(e2) && j(e2[0])) return e2.concat(t2);
  if (Array.isArray(t2) && j(t2[0]) && j(e2)) return [e2, ...t2];
  if (Array.isArray(t2)) return t2;
}
function Wi({ extend: e2, ...t2 }) {
  return $(t2, e2, (e3, t3) => !Q(e3) && !t3.some(Q) ? $({}, e3, ...t3, Ui) : (n2, r2) => $({}, ...[e3, ...t3].map((e4) => Bi(e4, n2, r2)), Ui));
}
function* Gi(e2) {
  let t2 = Zn(e2);
...
function Ki(e2) {
  let t2 = (n2, r2) => {
    for (let r3 of Gi(n2)) {
      let n3 = 0, i2 = e2;
      for (; i2 != null && n3 < r3.length; ) i2 = i2[r3[n3++]], i2 = Q(i2) && (r3.alpha === void 0 || n3 <= r3.length - 1) ? i2(t2, zi) : i2;
      if (i2 !== void 0) {
        if (r3.alpha !== void 0) {
          let e3 = en(i2);
          return P(e3, r3.alpha, G(e3));
        }
        return j(i2) ? Ri(i2) : i2;
      }
    }
    return r2;
  };
  return Object.assign(t2, { theme: t2, ...zi }), Object.keys(e2).reduce((n2, r2) => (n2[r2] = Q(e2[r2]) ? e2[r2](t2, zi) : e2[r2], n2), {});
}
function qi(e2) {
  let t2 = [];
  return e2.forEach((e3) => {
    ...
    n2.length !== 0 && n2.forEach((e4) => {
      e4.__isOptionsFunction && (e4 = e4()), t2 = [...t2, ...qi([e4?.config ?? {}])];
    });
  }), t2;
}
function Ji(e2) {
  return [...e2].reduceRight((e3, t2) => Q(t2) ? t2({ corePlugins: e3 }) : Ni(t2, e3), Mi);
}
function Yi(e2) {
  return [...e2].reduceRight((e3, t2) => [...e3, ...t2], []);
}
function Xi(e2) {
  let t2 = [...qi(e2), { prefix: ``, important: false, separator: `:` }];
  return Li(Ii({ theme: Ki(Wi(Hi(t2.map((e3) => e3?.theme ?? {})))), corePlugins: Ji(t2.map((e3) => e3.corePlugins)), plugins: Yi(e2.map((e3) => e3?.plugins ?? [])) }, ...t2));
}
var Zi = e(t(((e2, t2) => {
...
function Qi(e2) {
  let t2 = (e2?.presets ?? [Zi.default]).slice().reverse().flatMap((e3) => Qi(e3 instanceof Function ? e3() : e3)), n2 = { respectDefaultRingColorOpacity: { theme: { ringColor: ({ theme: e3 }) => ({ DEFAULT: `#3b82f67f`, ...e3(`colors`) }) } }, disableColorOpacityUtilitiesByDefault: { corePlugins: { backgroundOpacity: false, borderOpacity: false, divideOpacity: false, placeholderOpacity: false, ringOpacity: false, textOpacity: false } } };
  return [e2, ...Object.keys(n2).filter((t3) => z(e2, t3)).map((e3) => n2[e3]), ...t2];
}
function $i(...e2) {
  let [, ...t2] = Qi(e2[0]);
  return Xi([...e2, ...t2]);
...
`;
async function ta(e2 = {}, t2 = `/tailwind.config.js`) {
  let n2 = await c(t2, void 0, `config`, e2);
  return window.windpress && !window.windpress.__MEMFS_VOLUME__ && (window.windpress.__MEMFS_VOLUME__ = new On.Volume(), window.windpress.__MEMFS_VOLUME__.mkdirSync(`/css`, { recursive: true }), window.windpress.__MEMFS_VOLUME__.writeFileSync(`/css/preflight.css`, ea, `utf8`)), $i(n2.module);
}
export {
  m as _,
  Dr as a,

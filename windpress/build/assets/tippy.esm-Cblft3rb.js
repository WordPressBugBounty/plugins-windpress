...
function ae(e2) {
  var t2 = e2.state, n2 = e2.options, r2 = n2.gpuAcceleration, i2 = r2 === void 0 || r2, a2 = n2.adaptive, o2 = a2 === void 0 || a2, s2 = n2.roundOffsets, c2 = s2 === void 0 || s2, l2 = { placement: x(t2.placement), variation: G(t2.placement), popper: t2.elements.popper, popperRect: t2.rects.popper, gpuAcceleration: i2, isFixed: t2.options.strategy === `fixed` };
...
function se(e2) {
  var t2 = e2.state, n2 = e2.instance, r2 = e2.options, i2 = r2.scroll, a2 = i2 === void 0 || i2, o2 = r2.resize, s2 = o2 === void 0 || o2, c2 = m(t2.elements.popper), l2 = [].concat(t2.scrollParents.reference, t2.scrollParents.popper);
...
function Se(e2, t2) {
  t2 === void 0 && (t2 = {});
  var n2 = t2, r2 = n2.placement, a2 = r2 === void 0 ? e2.placement : r2, u2 = n2.strategy, d2 = u2 === void 0 ? e2.strategy : u2, f2 = n2.boundary, p2 = f2 === void 0 ? o : f2, m2 = n2.rootBoundary, g2 = m2 === void 0 ? s : m2, _2 = n2.elementContext, v2 = _2 === void 0 ? c : _2, y2 = n2.altBoundary, b2 = y2 !== void 0 && y2, x2 = n2.padding, S2 = x2 === void 0 ? 0 : x2, C2 = B(typeof S2 == `number` ? V(S2, i) : S2), w2 = v2 === `popper` ? l : c, T2 = e2.rects.popper, E2 = e2.elements[b2 ? w2 : v2], O2 = be(h(E2) ? E2 : E2.contextElement || M(e2.elements.popper), p2, g2, d2), k2 = D(e2.elements.reference), A2 = xe({ reference: k2, element: T2, strategy: `absolute`, placement: a2 }), j2 = X(Object.assign({}, T2, A2)), N2 = v2 === `popper` ? j2 : k2, P2 = { top: O2.top - N2.top + C2.top, bottom: N2.bottom - O2.bottom + C2.bottom, left: O2.left - N2.left + C2.left, right: N2.right - O2.right + C2.right }, F2 = e2.modifiersData.offset;
  if (v2 === `popper` && F2) {
    var I2 = F2[a2];
...
function Te(r2) {
  ...
  if (!i2.modifiersData[s2]._skip) {
    for (var c2 = o2.mainAxis, l2 = c2 === void 0 || c2, u2 = o2.altAxis, d2 = u2 === void 0 || u2, f2 = o2.fallbackPlacements, p2 = o2.padding, m2 = o2.boundary, h2 = o2.rootBoundary, g2 = o2.altBoundary, _2 = o2.flipVariations, v2 = _2 === void 0 || _2, y2 = o2.allowedAutoPlacements, b2 = i2.options.placement, S2 = x(b2) === b2, C2 = f2 || (S2 || !v2 ? [J(b2)] : we(b2)), w2 = [b2].concat(C2).reduce(function(e2, t2) {
...
function Le(r2) {
  var i2 = r2.state, a2 = r2.options, o2 = r2.name, s2 = a2.mainAxis, c2 = s2 === void 0 || s2, l2 = a2.altAxis, u2 = l2 !== void 0 && l2, d2 = a2.boundary, f2 = a2.rootBoundary, p2 = a2.altBoundary, m2 = a2.padding, h2 = a2.tether, g2 = h2 === void 0 || h2, _2 = a2.tetherOffset, v2 = _2 === void 0 ? 0 : _2, y2 = Se(i2, { boundary: d2, rootBoundary: f2, padding: m2, altBoundary: p2 }), b2 = x(i2.placement), w2 = G(i2.placement), T2 = !w2, E2 = L(b2), D2 = Ie(E2), k2 = i2.modifiersData.popperOffsets, A2 = i2.rects.reference, j2 = i2.rects.popper, M2 = typeof v2 == `function` ? v2(Object.assign({}, i2.rects, { placement: i2.placement })) : v2, N2 = typeof M2 == `number` ? { mainAxis: M2, altAxis: M2 } : Object.assign({ mainAxis: 0, altAxis: 0 }, M2), P2 = i2.modifiersData.offset ? i2.modifiersData.offset[i2.placement] : null, F2 = { x: 0, y: 0 };
  if (k2) {
    if (c2) {
...
var jt = typeof window < `u` && typeof document < `u` && !!window.msCrypto, $ = Object.assign({ appendTo: nt, aria: { content: `auto`, expanded: `auto` }, delay: 0, duration: [300, 250], getReferenceClientRect: null, hideOnClick: true, ignoreAttributes: false, interactive: false, interactiveBorder: 2, interactiveDebounce: 0, moveTransition: ``, offset: [0, 10], onAfterUpdate: function() {
...
var $t = { name: `followCursor`, defaultValue: false, fn: function(e2) {
  ...
  function d2(n3) {
    var r3 = !n3.target || t2.contains(n3.target), i3 = e2.props.followCursor, a3 = n3.clientX, o3 = n3.clientY, s3 = t2.getBoundingClientRect(), c3 = a3 - s3.left, l3 = o3 - s3.top;

...
import { e as encodeBase64 } from "../chunks/index-BmWe5YW7.min.js";
import { a5 as effectScope, V as ref, az as markRaw, ae as reactive, ad as isRef, aF as isReactive, Q as toRaw, a8 as getCurrentScope, a9 as onScopeDispose, w as watch, n as nextTick, af as toRefs, ac as computed, ab as inject, aa as hasInjectionContext } from "../chunks/runtime-core.esm-bundler-hRyeZ98I.min.js";
import { n as nanoid } from "../chunks/index.browser-BBNxE1As.min.js";
import { u as useStorage } from "../chunks/index-SE8wVPz0.min.js";
import { a as axios } from "../chunks/redaxios.module-Dyf46lvQ.min.js";
import { l as libExports } from "../chunks/index-EVinwGpQ.min.js";
import { g as get$1 } from "../chunks/get-DXxw6yUY.min.js";
let useApi, createPinia, createLogComposable, defineStore, setupWorker, useLogStore, w;
let __tla = (async () => {
  let activePinia;
...
${cn.comment}` : item.comment;
  ...
  async function buildCache(opts = {}) {
    ...
    if (options.tailwindcss_version === 4) {
      const { compile: buildV4, find_tw_candidates, optimize: optimizeV4, loadSource } = await __vitePreload(async () => {
        const { compile: buildV42, find_tw_candidates: find_tw_candidates2, optimize: optimizeV42, loadSource: loadSource2 } = await import("./index-BGScpU9k.js").then(async (m2) => {
          await m2.__tla;
          return m2;
        });
        return {
          compile: buildV42,
          find_tw_candidates: find_tw_candidates2,
          optimize: optimizeV42,
          loadSource: loadSource2
        };
      ...
      normal = (await optimizeV4({
        css: result
      })).css;
      minified = (await optimizeV4({
        css: result,
        minify: true
      })).css;
    } else if (options.tailwindcss_version === 3) {
      const { build: buildV3, optimize: optimizeV3 } = await __vitePreload(async () => {
        const { build: buildV32, optimize: optimizeV32 } = await import("./index-Dc-BpCSB.js").then(async (m2) => {
          await m2.__tla;
          return m2;
        });
        return {
          build: buildV32,
          optimize: optimizeV32
        };
      }, true ? [] : void 0, import.meta.url);
      log.add({
        message: "Scanning complete",

import { a as e, n as t, o as n, r, t as i } from "./chunk-DlkHe4MQ.js";
import { n as a, t as o } from "./dist-BdGzUZX_.js";
import { n as s, t as c } from "./dist-DkW5GlYv.js";
...
var U, W, G, ee, K, te, q, J = t((() => {
  ...
  g2.read = function(e3, t3, n3, r3, i3) {
    ...
    var o3, s3, c3, l3 = a3 * 8 - i3 - 1, u3 = (1 << l3) - 1, d3 = u3 >> 1, f3 = i3 === 23 ? 2 ** -24 - 2 ** -77 : 0, p3 = r3 ? 0 : a3 - 1, m3 = r3 ? 1 : -1, h3 = t3 < 0 || t3 === 0 && 1 / t3 < 0 ? 1 : 0;
    for (t3 = Math.abs(t3), isNaN(t3) || t3 === 1 / 0 ? (s3 = isNaN(t3) ? 1 : 0, o3 = u3) : (o3 = Math.floor(Math.log(t3) / Math.LN2), t3 * (c3 = 2 ** -o3) < 1 && (o3--, c3 *= 2), o3 + d3 >= 1 ? t3 += f3 / c3 : t3 += f3 * 2 ** (1 - d3), t3 * c3 >= 2 && (o3++, c3 /= 2), o3 + d3 >= u3 ? (s3 = 0, o3 = u3) : o3 + d3 >= 1 ? (s3 = (t3 * c3 - 1) * 2 ** i3, o3 += d3) : (s3 = t3 * 2 ** (d3 - 1) * 2 ** i3, o3 = 0)); i3 >= 8; e3[n3 + p3] = s3 & 255, p3 += m3, s3 /= 256, i3 -= 8) ;
    ...
    function Y2(e4) {
      let t4 = ``, n3 = e4.length, r4 = e4[0] === `-` ? 1 : 0;
    ...
    function Z2(e4, t4, n3) {
      throw Math.floor(e4) === e4 ? t4 < 0 ? new q2.ERR_BUFFER_OUT_OF_BOUNDS() : new q2.ERR_OUT_OF_RANGE(n3 || `offset`, `>= ${n3 ? 1 : 0} and <= ${t4}`, e4) : (X2(e4, n3), new q2.ERR_OUT_OF_RANGE(n3 || `offset`, `an integer`, e4));
    }
  ...
  var t2 = se(), n2 = le(), r2 = Z(), { S_IFMT: i2, S_IFDIR: a2, S_IFREG: o2, S_IFLNK: s2, S_IFCHR: c2 } = $().constants, l2 = () => {
    var _a, _b;
    return ((_b = (_a = n2.default).getuid) == null ? void 0 : _b.call(_a)) ?? 0;
  }, u2 = () => {
    var _a, _b;
    return ((_b = (_a = n2.default).getgid) == null ? void 0 : _b.call(_a)) ?? 0;
  }, d2 = (0, r2.bufferAllocUnsafe)(0);
  e2.Node = class {
  ...
  e2.Link = class e3 {
    ...
    set steps(e4) {
      this._steps = e4;
      for (let [e5, t3] of this.children.entries()) e5 === `.` || e5 === `..` || (t3 == null ? void 0 : t3.syncSteps());
    }
...
` + t3.prev;
  ...
  t2.exports = function() {
    var e3, t3 = { assert: function(e4) {
      ...
      var n3 = e3 && e3.next, r3 = c2(e3, t4);
      return r3 && n3 && n3 === r3 && (e3 = void 0), !!r3;
    }, get: function(t4) {
      return a2(e3, t4);
    }, has: function(t4) {
      return s2(e3, t4);
  ...
  var n2 = ut(), r2 = Object.prototype.hasOwnProperty, i2 = Array.isArray, a2 = { allowDots: false, allowEmptyArrays: false, allowPrototypes: false, allowSparse: false, arrayLimit: 20, charset: `utf-8`, charsetSentinel: false, comma: false, decodeDotInKeys: false, decoder: n2.decode, delimiter: `&`, depth: 5, duplicates: `combine`, ignoreQueryPrefix: false, interpretNumericEntities: false, parameterLimit: 1e3, parseArrays: true, plainObjects: false, strictDepth: false, strictMerge: true, strictNullHandling: false, throwOnLimitExceeded: false }, o2 = function(e3) {
    ...
    var f3 = t3.parameterLimit === 1 / 0 ? void 0 : t3.parameterLimit, p3 = d3.split(t3.delimiter, t3.throwOnLimitExceeded ? f3 + 1 : f3);
    if (t3.throwOnLimitExceeded && p3.length > f3) throw RangeError(`Parameter limit exceeded. Only ` + f3 + ` parameter` + (f3 === 1 ? `` : `s`) + ` allowed.`);
...
function Ct(e2) {
  var t2 = e2 ?? null;
  return !!(t2 !== null && (t2 == null ? void 0 : t2.href) && (t2 == null ? void 0 : t2.origin));
}
function wt(e2) {
...
`, `	`], Nt = [`'`].concat(Mt), Pt = [`%`, `/`, `?`, `;`, `#`].concat(Nt), Ft = [`/`, `?`, `#`], It = 255, Lt = /^[+a-z0-9A-Z_-]{0,63}$/, Rt = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, zt = { javascript: true, "javascript:": true }, Bt = { javascript: true, "javascript:": true }, Vt = { http: true, https: true, ftp: true, gopher: true, file: true, "http:": true, "https:": true, "ftp:": true, "gopher:": true, "file:": true }, Ht = Dt.default, ht.prototype.parse = function(e2, t2, n2) {
    ...
    if (!Bt[c2] && (u2 || c2 && !Vt[c2])) {
      ...
      var E2 = this.port ? `:` + this.port : ``;
      this.host = (this.hostname || ``) + E2, this.href += this.host, g2 && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), o2[0] !== `/` && (o2 = `/` + o2));
    }
    if (!zt[l2]) for (var f2 = 0, v2 = Nt.length; f2 < v2; f2++) {
      var D2 = Nt[f2];
      if (o2.indexOf(D2) !== -1) {
        var O2 = encodeURIComponent(D2);
        O2 === D2 && (O2 = escape(D2)), o2 = o2.split(D2).join(O2);
      }
    }
    var k2 = o2.indexOf(`#`);
    k2 !== -1 && (this.hash = o2.substr(k2), o2 = o2.slice(0, k2));
    var A2 = o2.indexOf(`?`);
    if (A2 === -1 ? t2 && (this.search = ``, this.query = {}) : (this.search = o2.substr(A2), this.query = o2.substr(A2 + 1), t2 && (this.query = Ht.parse(this.query)), o2 = o2.slice(0, A2)), o2 && (this.pathname = o2), Vt[l2] && this.hostname && !this.pathname && (this.pathname = `/`), this.pathname || this.search) {
      var E2 = this.pathname || ``;
      this.path = E2 + (this.search || ``);
    }
  ...
  var t2 = Y(), n2 = _e(), r2 = ve(), i2 = ye(), a2 = Z(), o2 = le(), s2 = $(), c2 = $(), l2 = hn(), u2 = ie(), d2 = oe(), f2 = t2.posix ? t2.posix.sep : t2.sep, p2 = t2.posix ? t2.posix.relative : t2.relative, m2 = t2.posix ? t2.posix.join : t2.join, { O_RDONLY: h2, O_WRONLY: g2, O_RDWR: _2, O_CREAT: v2, O_EXCL: y2, O_TRUNC: b2, O_APPEND: x2, O_DIRECTORY: S2 } = s2.constants, C2 = class e3 {
    ...
    constructor(e4 = {}) {
      this.ino = 0, this.inodes = {}, this.releasedInos = [], this.fds = {}, this.releasedFds = [], this.maxFiles = 1e4, this.openFiles = 0, this.open = (e5, t3, n4, r3 = true) => {
        ...
        if (!((_a = r3.parent) == null ? void 0 : _a.getNode().canWrite())) throw (0, l2.createError)(`EACCES`, `rm`, e5);
        this.deleteLink(r3);
      }, this.close = (e5) => {
        (0, l2.validateFd)(e5);
    ...
    createNode(e4) {
      var _a, _b, _c, _d;
      let t3 = ((_b = (_a = this.process).getuid) == null ? void 0 : _b.call(_a)) ?? 0, r3 = ((_d = (_c = this.process).getgid) == null ? void 0 : _d.call(_c)) ?? 0, i3 = new n2.Node(this.newInoNumber(), e4, t3, r3);
    ...
    walk(e4, n3 = false, i3 = false, a3 = false, o3) {
      ...
      let u3 = this.root, p3 = 0, h3 = ((_b = (_a = this.process).getuid) == null ? void 0 : _b.call(_a)) ?? 0, g3 = ((_d = (_c = this.process).getgid) == null ? void 0 : _d.call(_c)) ?? 0;
      for (; p3 < s3.length; ) {
        let e5 = u3.getNode();
        if (e5.isDirectory()) {
        ...
        if (e5 = u3 == null ? void 0 : u3.getNode(), e5.isSymlink() && (n3 || p3 < s3.length - 1)) {
  ...
  t2.exports = function(e3) {
    var t3 = i2(arguments), r3 = e3.length - (arguments.length - 1);
    return n2(t3, 1 + (r3 > 0 ? r3 : 0), true);
...
`) >= 0 && r3++, e4 + t4.replace(/\u001b\[\d\d?m/g, ``).length + 1;
 ...
 `) + ` ` + e3.join(`,
  ...
  function D2(e3, t3, i3) {
    r2 || (r2 = Zn()), e3 || (e3 = {}), typeof i3 != `boolean` && (i3 = t3 instanceof r2), this.objectMode = !!e3.objectMode, i3 && (this.objectMode = this.objectMode || !!e3.writableObjectMode), this.highWaterMark = h2(this, e3, `writableHighWaterMark`, i3), this.finalCalled = false, this.needDrain = false, this.ending = false, this.ended = false, this.finished = false, this.destroyed = false, this.decodeStrings = e3.decodeStrings !== false, this.defaultEncoding = e3.defaultEncoding || `utf8`, this.length = 0, this.writing = false, this.corked = 0, this.sync = true, this.bufferProcessing = false, this.onwrite = function(e4) {
      L2(t3, e4);
  ...
  e2.FileHandle = class extends n2.EventEmitter {
    ...
    readableWebStream(e3 = {}) {
      ...
      return new ReadableStream({ type: t3 === `bytes` ? `bytes` : void 0, autoAllocateChunkSize: 16384, pull: async (e4) => {
        var _a;
        try {
          let t4 = (_a = e4.byobRequest) == null ? void 0 : _a.view;
          if (!t4) {
...
`;
  ...
  e2.toRegex = (r3, i2) => {
    ...
    let l2 = (i2 == null ? void 0 : i2.nocase) ? `i` : ``;
    return RegExp(`^` + a2 + `$`, l2);
  };
  ...
  var H2 = class {
    ...
    constructor(e3 = new n2.Superblock()) {
      this._core = e3, this.promisesApi = new g2.FsPromises(this, m2.FileHandle), this.openSync = (e4, t3, n3 = 438) => {
        ...
        if (!r2.isWin && i3.encoding !== `buffer` && c4.sort((e5, t3) => e5.name < t3.name ? -1 : e5.name > t3.name ? 1 : 0), i3.withFileTypes) return c4;
        let l4 = e4;
        ...
        this._core.rm((0, S2.pathToFilename)(e4), t3 == null ? void 0 : t3.force, t3 == null ? void 0 : t3.recursive);
      }, this.rm = (e4, t3, n3) => {
        let [r3, i3] = (0, x2.getRmOptsAndCb)(t3, n3);
        this.wrapAsync(this._core.rm, [(0, S2.pathToFilename)(e4), r3 == null ? void 0 : r3.force, r3 == null ? void 0 : r3.recursive], i3);
      }, this._fchmod = (e4, t3) => {
        ...
        let r3 = (0, S2.pathToFilename)(e4), i3 = (0, S2.pathToFilename)(t3), a3 = { dereference: (n3 == null ? void 0 : n3.dereference) ?? false, errorOnExist: (n3 == null ? void 0 : n3.errorOnExist) ?? false, filter: n3 == null ? void 0 : n3.filter, force: (n3 == null ? void 0 : n3.force) ?? true, mode: (n3 == null ? void 0 : n3.mode) ?? 0, preserveTimestamps: (n3 == null ? void 0 : n3.preserveTimestamps) ?? false, recursive: (n3 == null ? void 0 : n3.recursive) ?? false, verbatimSymlinks: (n3 == null ? void 0 : n3.verbatimSymlinks) ?? false };
        return this._cp(r3, i3, a3);
      }, this.cp = (e4, t3, n3, r3) => {
        let i3 = (0, S2.pathToFilename)(e4), a3 = (0, S2.pathToFilename)(t3), o3, s3;
        typeof n3 == `function` ? [o3, s3] = [{}, n3] : [o3, s3] = [n3 || {}, r3], (0, S2.validateCallback)(s3);
        let c4 = { dereference: (o3 == null ? void 0 : o3.dereference) ?? false, errorOnExist: (o3 == null ? void 0 : o3.errorOnExist) ?? false, filter: o3 == null ? void 0 : o3.filter, force: (o3 == null ? void 0 : o3.force) ?? true, mode: (o3 == null ? void 0 : o3.mode) ?? 0, preserveTimestamps: (o3 == null ? void 0 : o3.preserveTimestamps) ?? false, recursive: (o3 == null ? void 0 : o3.recursive) ?? false, verbatimSymlinks: (o3 == null ? void 0 : o3.verbatimSymlinks) ?? false };
        ...
        let i3 = r3.getNode().getBuffer(), a3 = (t3 == null ? void 0 : t3.type) || ``;
    ...
    _access(e3, t3) {
      let n3 = this._core.getLinkOrThrow(e3, `access`).getNode();
  ...
  K2.prototype.open = function() {
    ...
    typeof ((_a = this._readableState) == null ? void 0 : _a.closed) == `boolean` ? this._readableState.closed = true : this.closed = true, this._fileHandle ? this._fileHandle.close().then(() => this.emit(`close`), (e4) => this.emit(`error`, e4)) : this._vol.close(this.fd, (e4) => {
  ...
  q2.prototype.open = function() {
    ...
    typeof ((_a = this._writableState) == null ? void 0 : _a.closed) == `boolean` ? this._writableState.closed = true : this.closed = true, this._fileHandle ? this._fileHandle.close().then(() => this.emit(`close`), (e4) => this.emit(`error`, e4)) : this._vol.close(this.fd, (e4) => {
      e4 ? this.emit(`error`, e4) : this.emit(`close`);
    }), this.fd = null;
  ...
  var J2 = class extends p2.EventEmitter {
    ...
    close() {
      ...
      clearTimeout(this._timer), this._listenerRemovers.forEach((e3) => {
        e3.forEach((e4) => e4());
      }), this._listenerRemovers.clear(), (_a = this._parentChangesUnsub) == null ? void 0 : _a.call(this);
    }
  };
  e2.FSWatcher = J2;
})), ni = i(((e2) => {

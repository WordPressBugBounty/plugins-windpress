...
import { $n as t, D as n, E as r, Ht as i, Lt as a, On as o, St as s, Zn as c, _ as l, b as u, bt as d, ct as f, et as p, g as m, it as h, k as g, mt as _, o as v, qt as y, tr as b, v as x, vn as S, w as C, wn as w, wt as T, xn as E, xt as D, y as O, z as k } from "./runtime-core.esm-bundler-CahM68iJ.js";
import { n as A } from "./vue.runtime.esm-bundler-B0iyRCM8.js";
import { B as j, F as M, N as ee, R as te, _ as ne, b as N, g as re, i as ie, n as ae, q as P, r as oe, t as F, v as I, y as L } from "./Button-DpvhuBJO.js";
import { A as se, c as ce, k as le, l as ue, r as de, t as fe } from "./dist-BKF-Yqo1.js";
import { d as pe, r as R, u as me } from "./namespaced-BdQ8WLes.js";
import { i as he, n as ge, t as z, v as B } from "./Tooltip-CZRNrufK.js";
import { t as _e } from "./Tree-DW_HwbbT.js";
import { n as ve, r as V, t as ye } from "./useFileAction-BM3bbZfF.js";
import { t as be } from "./Slideover-SxW0jiNx.js";
import { t as xe } from "./Badge-Df4B0ziO.js";
import { t as H } from "./settings-B68hC1Sq.js";
import { t as Se } from "./isObject-Da6SbqXi.js";
import { t as U } from "./debounce-2SSeCGpK.js";
import { t as Ce } from "./path-browserify-CWnXpqR1.js";
import { a as W, c as G, i as we, n as K, r as Te } from "./intellisense-CtRsPNrz.js";
import "./tailwindcss-DNCLGH_x.js";
import { t as q } from "./monaco.contribution-g3sH6BoO.js";
import { n as Ee, t as De } from "./DashboardNavbar-DDpWxmFn.js";
import { t as Oe } from "./DashboardSidebarCollapse-1SyUPjQc.js";
import { t as J } from "./color-BTusM6yG.js";
var ke = `Expected a function`;
function Ae(e2, t2, n2) {
  var r2 = true, i2 = true;
  if (typeof e2 != `function`) throw TypeError(ke);
  return Se(n2) && (r2 = `leading` in n2 ? !!n2.leading : r2, i2 = `trailing` in n2 ? !!n2.trailing : i2), U(e2, t2, { leading: r2, maxWait: t2, trailing: i2 });
}
var je = { __name: `ContextMenuContent`, props: { items: { type: null, required: false }, portal: { type: [Boolean, String], required: false, skipCheck: true }, sub: { type: Boolean, required: false }, labelKey: { type: null, required: true }, descriptionKey: { type: null, required: true }, checkedIcon: { type: null, required: false }, loadingIcon: { type: null, required: false }, externalIcon: { type: [Boolean, String], required: false, skipCheck: true }, class: { type: null, required: false }, ui: { type: null, required: true }, uiOverride: { type: null, required: false }, loop: { type: Boolean, required: false }, sideFlip: { type: Boolean, required: false }, alignOffset: { type: Number, required: false }, alignFlip: { type: Boolean, required: false }, avoidCollisions: { type: Boolean, required: false }, collisionBoundary: { type: null, required: false }, collisionPadding: { type: [Number, Object], required: false }, hideShiftedArrow: { type: Boolean, required: false }, sticky: { type: String, required: false }, hideWhenDetached: { type: Boolean, required: false }, positionStrategy: { type: String, required: false }, disableUpdateOnLayoutShift: { type: Boolean, required: false }, prioritizePosition: { type: Boolean, required: false }, reference: { type: null, required: false } }, emits: [`escapeKeyDown`, `pointerDownOutside`, `focusOutside`, `interactOutside`, `closeAutoFocus`], setup(e2, { emit: i2 }) {
  let s2 = e2, f2 = i2, h2 = a(), { dir: g2 } = ee(), S2 = P(), E2 = he(w(() => s2.portal)), A2 = B(le(s2, `sub`, `items`, `portal`, `labelKey`, `descriptionKey`, `checkedIcon`, `loadingIcon`, `externalIcon`, `class`, `ui`, `uiOverride`), f2), ne2 = () => j(h2, [`default`]), [N2, F2] = de(), L2 = m(() => g2.value === `rtl` ? S2.ui.icons.chevronLeft : S2.ui.icons.chevronRight), se2 = m(() => {
    var _a;
    return ((_a = s2.items) == null ? void 0 : _a.length) ? te(s2.items) ? s2.items : [s2.items] : [];
  });
  return (i3, a2) => (_(), u(v, null, [n(o(N2), null, { default: y(({ item: t2, active: a3, index: f3 }) => [D(i3.$slots, t2.slot || `item`, { item: t2, index: f3, ui: e2.ui }, () => {
    var _a, _b, _c, _d, _e2, _f, _g, _h, _i, _j;
    return [D(i3.$slots, t2.slot ? `${t2.slot}-leading` : `item-leading`, { item: t2, active: a3, index: f3, ui: e2.ui }, () => {
      var _a2, _b2, _c2, _d2, _e3, _f2, _g2, _h2;
      return [t2.loading ? (_(), x(I, { key: 0, name: e2.loadingIcon || o(S2).ui.icons.loading, "data-slot": `itemLeadingIcon`, class: c(e2.ui.itemLeadingIcon({ class: [(_a2 = e2.uiOverride) == null ? void 0 : _a2.itemLeadingIcon, (_b2 = t2.ui) == null ? void 0 : _b2.itemLeadingIcon], color: t2 == null ? void 0 : t2.color, loading: true })) }, null, 8, [`name`, `class`])) : t2.icon ? (_(), x(I, { key: 1, name: t2.icon, "data-slot": `itemLeadingIcon`, class: c(e2.ui.itemLeadingIcon({ class: [(_c2 = e2.uiOverride) == null ? void 0 : _c2.itemLeadingIcon, (_d2 = t2.ui) == null ? void 0 : _d2.itemLeadingIcon], color: t2 == null ? void 0 : t2.color, active: a3 })) }, null, 8, [`name`, `class`])) : t2.avatar ? (_(), x(re, p({ key: 2, size: ((_e3 = t2.ui) == null ? void 0 : _e3.itemLeadingAvatarSize) || ((_f2 = e2.uiOverride) == null ? void 0 : _f2.itemLeadingAvatarSize) || e2.ui.itemLeadingAvatarSize() }, t2.avatar, { "data-slot": `itemLeadingAvatar`, class: e2.ui.itemLeadingAvatar({ class: [(_g2 = e2.uiOverride) == null ? void 0 : _g2.itemLeadingAvatar, (_h2 = t2.ui) == null ? void 0 : _h2.itemLeadingAvatar], active: a3 }) }), null, 16, [`size`, `class`])) : O(``, true)];
    }), o(M)(t2, s2.labelKey) || h2[t2.slot ? `${t2.slot}-label` : `item-label`] || o(M)(t2, s2.descriptionKey) || h2[t2.slot ? `${t2.slot}-description` : `item-description`] ? (_(), u(`span`, { key: 0, "data-slot": `itemWrapper`, class: c(e2.ui.itemWrapper({ class: [(_a = e2.uiOverride) == null ? void 0 : _a.itemWrapper, (_b = t2.ui) == null ? void 0 : _b.itemWrapper] })) }, [l(`span`, { "data-slot": `itemLabel`, class: c(e2.ui.itemLabel({ class: [(_c = e2.uiOverride) == null ? void 0 : _c.itemLabel, (_d = t2.ui) == null ? void 0 : _d.itemLabel], active: a3 })) }, [D(i3.$slots, t2.slot ? `${t2.slot}-label` : `item-label`, { item: t2, active: a3, index: f3 }, () => [r(b(o(M)(t2, s2.labelKey)), 1)]), t2.target === `_blank` && e2.externalIcon !== false ? (_(), x(I, { key: 0, name: typeof e2.externalIcon == `string` ? e2.externalIcon : o(S2).ui.icons.external, "data-slot": `itemLabelExternalIcon`, class: c(e2.ui.itemLabelExternalIcon({ class: [(_e2 = e2.uiOverride) == null ? void 0 : _e2.itemLabelExternalIcon, (_f = t2.ui) == null ? void 0 : _f.itemLabelExternalIcon], color: t2 == null ? void 0 : t2.color, active: a3 })) }, null, 8, [`name`, `class`])) : O(``, true)], 2), o(M)(t2, s2.descriptionKey) || h2[t2.slot ? `${t2.slot}-description` : `item-description`] ? (_(), u(`span`, { key: 0, "data-slot": `itemDescription`, class: c(e2.ui.itemDescription({ class: [(_g = e2.uiOverride) == null ? void 0 : _g.itemDescription, (_h = t2.ui) == null ? void 0 : _h.itemDescription] })) }, [D(i3.$slots, t2.slot ? `${t2.slot}-description` : `item-description`, { item: t2, active: a3, index: f3 }, () => [r(b(o(M)(t2, s2.descriptionKey)), 1)])], 2)) : O(``, true)], 2)) : O(``, true), l(`span`, { "data-slot": `itemTrailing`, class: c(e2.ui.itemTrailing({ class: [(_i = e2.uiOverride) == null ? void 0 : _i.itemTrailing, (_j = t2.ui) == null ? void 0 : _j.itemTrailing] })) }, [D(i3.$slots, t2.slot ? `${t2.slot}-trailing` : `item-trailing`, { item: t2, active: a3, index: f3, ui: e2.ui }, () => {
      var _a2, _b2, _c2, _d2, _e3, _f2;
      return [((_a2 = t2.children) == null ? void 0 : _a2.length) ? (_(), x(I, { key: 0, name: L2.value, "data-slot": `itemTrailingIcon`, class: c(e2.ui.itemTrailingIcon({ class: [(_b2 = e2.uiOverride) == null ? void 0 : _b2.itemTrailingIcon, (_c2 = t2.ui) == null ? void 0 : _c2.itemTrailingIcon], color: t2 == null ? void 0 : t2.color, active: a3 })) }, null, 8, [`name`, `class`])) : ((_d2 = t2.kbds) == null ? void 0 : _d2.length) ? (_(), u(`span`, { key: 1, "data-slot": `itemTrailingKbds`, class: c(e2.ui.itemTrailingKbds({ class: [(_e3 = e2.uiOverride) == null ? void 0 : _e3.itemTrailingKbds, (_f2 = t2.ui) == null ? void 0 : _f2.itemTrailingKbds] })) }, [(_(true), u(v, null, d(t2.kbds, (n2, r2) => {
        var _a3, _b3;
        return _(), x(ge, p({ key: r2, size: ((_a3 = t2.ui) == null ? void 0 : _a3.itemTrailingKbdsSize) || ((_b3 = e2.uiOverride) == null ? void 0 : _b3.itemTrailingKbdsSize) || e2.ui.itemTrailingKbdsSize() }, { ref_for: true }, typeof n2 == `string` ? { value: n2 } : n2), null, 16, [`size`]);
      }), 128))], 2)) : O(``, true)];
    }), n(o(R).ItemIndicator, { "as-child": `` }, { default: y(() => {
      var _a2, _b2;
      return [n(I, { name: e2.checkedIcon || o(S2).ui.icons.check, "data-slot": `itemTrailingIcon`, class: c(e2.ui.itemTrailingIcon({ class: [(_a2 = e2.uiOverride) == null ? void 0 : _a2.itemTrailingIcon, (_b2 = t2.ui) == null ? void 0 : _b2.itemTrailingIcon], color: t2 == null ? void 0 : t2.color })) }, null, 8, [`name`, `class`])];
    }), _: 2 }, 1024)], 2)];
  })]), _: 3 }), n(o(R).Portal, t(k(o(E2))), { default: y(() => {
    var _a;
    return [(_(), x(T(e2.sub ? o(R).SubContent : o(R).Content), p({ "data-slot": `content`, class: e2.ui.content({ class: [(_a = e2.uiOverride) == null ? void 0 : _a.content, s2.class] }) }, o(A2)), { default: y(() => {
      var _a2;
      return [D(i3.$slots, `content-top`, { sub: e2.sub ?? false }), l(`div`, { role: `presentation`, "data-slot": `viewport`, class: c(e2.ui.viewport({ class: (_a2 = e2.uiOverride) == null ? void 0 : _a2.viewport })) }, [(_(true), u(v, null, d(se2.value, (t2, r2) => {
        var _a3;
        return _(), x(o(R).Group, { key: `group-${r2}`, "data-slot": `group`, class: c(e2.ui.group({ class: (_a3 = e2.uiOverride) == null ? void 0 : _a3.group })) }, { default: y(() => [(_(true), u(v, null, d(t2, (t3, a3) => {
          var _a4, _b, _c, _d, _e2, _f, _g;
          return _(), u(v, { key: `group-${r2}-${a3}` }, [t3.type === `label` ? (_(), x(o(R).Label, { key: 0, "data-slot": `label`, class: c(e2.ui.label({ class: [(_a4 = e2.uiOverride) == null ? void 0 : _a4.label, (_b = t3.ui) == null ? void 0 : _b.label, t3.class] })) }, { default: y(() => [n(o(F2), { item: t3, index: a3 }, null, 8, [`item`, `index`])]), _: 2 }, 1032, [`class`])) : t3.type === `separator` ? (_(), x(o(R).Separator, { key: 1, "data-slot": `separator`, class: c(e2.ui.separator({ class: [(_c = e2.uiOverride) == null ? void 0 : _c.separator, (_d = t3.ui) == null ? void 0 : _d.separator, t3.class] })) }, null, 8, [`class`])) : ((_e2 = t3 == null ? void 0 : t3.children) == null ? void 0 : _e2.length) ? (_(), x(o(R).Sub, { key: 2, open: t3.open, "default-open": t3.defaultOpen }, { default: y(() => {
            var _a5, _b2, _c2;
            return [n(o(R).SubTrigger, { as: `button`, type: `button`, disabled: t3.disabled, "text-value": o(M)(t3, s2.labelKey), "data-slot": `item`, class: c(e2.ui.item({ class: [(_a5 = e2.uiOverride) == null ? void 0 : _a5.item, (_b2 = t3.ui) == null ? void 0 : _b2.item, t3.class], color: t3 == null ? void 0 : t3.color })) }, { default: y(() => [n(o(F2), { item: t3, index: a3 }, null, 8, [`item`, `index`])]), _: 2 }, 1032, [`disabled`, `text-value`, `class`]), n(je, p({ sub: ``, class: (_c2 = t3.ui) == null ? void 0 : _c2.content, ui: e2.ui, "ui-override": e2.uiOverride, portal: e2.portal, items: t3.children, "align-offset": -4, "label-key": e2.labelKey, "description-key": e2.descriptionKey, "checked-icon": e2.checkedIcon, "loading-icon": e2.loadingIcon, "external-icon": e2.externalIcon }, { ref_for: true }, t3.content), C({ _: 2 }, [d(ne2(), (e3, t4) => ({ name: t4, fn: y((e4) => [D(i3.$slots, t4, p({ ref_for: true }, e4))]) }))]), 1040, [`class`, `ui`, `ui-override`, `portal`, `items`, `label-key`, `description-key`, `checked-icon`, `loading-icon`, `external-icon`])];
          }), _: 2 }, 1032, [`open`, `default-open`])) : t3.type === `checkbox` ? (_(), x(o(R).CheckboxItem, { key: 3, "model-value": t3.checked, disabled: t3.disabled, "text-value": o(M)(t3, s2.labelKey), "data-slot": `item`, class: c(e2.ui.item({ class: [(_f = e2.uiOverride) == null ? void 0 : _f.item, (_g = t3.ui) == null ? void 0 : _g.item, t3.class], color: t3 == null ? void 0 : t3.color })), "onUpdate:modelValue": t3.onUpdateChecked, onSelect: t3.onSelect }, { default: y(() => [n(o(F2), { item: t3, index: a3 }, null, 8, [`item`, `index`])]), _: 2 }, 1032, [`model-value`, `disabled`, `text-value`, `class`, `onUpdate:modelValue`, `onSelect`])) : (_(), x(ae, p({ key: 4, ref_for: true }, o(ie)(t3), { custom: `` }), { default: y(({ active: r3, ...i4 }) => [n(o(R).Item, { "as-child": ``, disabled: t3.disabled, "text-value": o(M)(t3, s2.labelKey), onSelect: t3.onSelect }, { default: y(() => {
            var _a5, _b2;
            return [n(oe, p({ ref_for: true }, i4, { "data-slot": `item`, class: e2.ui.item({ class: [(_a5 = e2.uiOverride) == null ? void 0 : _a5.item, (_b2 = t3.ui) == null ? void 0 : _b2.item, t3.class], active: r3, color: t3 == null ? void 0 : t3.color }) }), { default: y(() => [n(o(F2), { item: t3, active: r3, index: a3 }, null, 8, [`item`, `active`, `index`])]), _: 2 }, 1040, [`class`])];
          }), _: 2 }, 1032, [`disabled`, `text-value`, `onSelect`])]), _: 2 }, 1040))], 64);
        }), 128))]), _: 2 }, 1032, [`class`]);
      }), 128))], 2), D(i3.$slots, `default`), D(i3.$slots, `content-bottom`, { sub: e2.sub ?? false })];
    }), _: 3 }, 16, [`class`]))];
  }), _: 3 }, 16)], 64));
  ...
  let i2 = e2, s2 = r2, l2 = a(), u2 = P(), f2 = N(`contextMenu`, i2), h2 = B(se(i2, `modal`), s2), g2 = w(() => i2.content), v2 = () => j(l2, [`default`]), b2 = m(() => {
    var _a;
    return L({ extend: L(Me), ...((_a = u2.ui) == null ? void 0 : _a.contextMenu) || {} })({ size: i2.size });
  });
  return (r3, a2) => (_(), x(o(pe), t(k(o(h2))), { default: y(() => {
    var _a;
    return [l2.default ? (_(), x(o(me), { key: 0, "as-child": ``, disabled: e2.disabled, class: c(i2.class) }, { default: y(() => [D(r3.$slots, `default`)]), _: 3 }, 8, [`disabled`, `class`])) : O(``, true), n(je, p({ class: b2.value.content({ class: [!l2.default && i2.class, (_a = o(f2)) == null ? void 0 : _a.content] }), ui: b2.value, "ui-override": o(f2) }, g2.value, { items: e2.items, portal: e2.portal, "label-key": e2.labelKey, "description-key": e2.descriptionKey, "checked-icon": e2.checkedIcon, "loading-icon": e2.loadingIcon, "external-icon": e2.externalIcon }), C({ _: 2 }, [d(v2(), (e3, n2) => ({ name: n2, fn: y((e4) => [D(r3.$slots, n2, t(k(e4)))]) }))]), 1040, [`class`, `ui`, `ui-override`, `items`, `portal`, `label-key`, `description-key`, `checked-icon`, `loading-icon`, `external-icon`])];
  }), _: 3 }, 16));
} }, Y = e(Ce(), 1), Pe = { class: `overflow-y-auto divide-y divide-(--ui-border)` }, Fe = { class: `flex items-center gap-1.5 w-full` }, Ie = g({ __name: `FileExplorer`, emits: [`delete`, `rename`, `reset`], setup(e2, { emit: t2 }) {
  let a2 = V(), s2 = H(), c2 = t2, d2 = S(void 0);
  i(d2, (e3) => {
    a2.activeViewEntryRelativePath = (e3 == null ? void 0 : e3.value) ?? null;
  });
  function p2(e3, t3, n2) {
    let r2 = (n2 ? Y.default.relative(n2, t3.relative_path) : t3.relative_path).split(`/`), i2 = r2.shift();
    if (r2.length === 0) {
      e3.push({ label: i2, value: t3.relative_path, icon: `vscode-icons:file-type-${t3.relative_path === `main.css` ? `tailwind` : Y.default.extname(t3.relative_path).replace(`.`, ``)}`, slot: `tree-file`, entry: t3 });
      return;
    }
    let a3 = e3.find((e4) => e4.label === i2);
    a3 || (a3 = { label: i2, children: [], onSelect: (e4) => {
      e4.preventDefault();
    } }, e3.push(a3)), p2(a3.children || (a3.children = []), t3, n2 ? Y.default.join(n2, i2 || ``) : i2 || ``);
  }
  let h2 = m(() => {
    let e3 = [];
...
function Ve(e2, t2) {
  let n2 = e2.replace(X.COLOR, ``);
  return { name: Z(n2), slug: Q(n2), color: t2.trim() };
}
function He(e2, t2) {
  let n2 = e2.replace(X.FONT_FAMILY, ``);
  return $(n2, Re) ? { name: Z(n2), slug: Q(n2), fontFamily: t2.trim().replace(/['"]/g, ``) } : null;
}
function Ue(e2, t2) {
  let n2 = e2.replace(X.FONT_SIZE, ``);
  return $(n2, ze) ? { name: Z(n2), slug: Q(n2), size: t2.trim() } : null;
}
function We(e2, t2) {
  let n2 = e2.replace(X.BORDER_RADIUS, ``);
  return { name: Z(n2), slug: Q(n2), size: t2.trim() };
}
function Ge(e2, t2) {
  let n2, r2 = ``;
  return e2.startsWith(X.INSET_SHADOW) ? (n2 = e2.replace(X.INSET_SHADOW, ``), r2 = `inset-`) : e2.startsWith(X.DROP_SHADOW) ? (n2 = e2.replace(X.DROP_SHADOW, ``), r2 = `drop-`) : n2 = e2.replace(X.SHADOW, ``), { name: Z(`${r2}${n2}`), slug: Q(`${r2}${n2}`), shadow: t2.trim() };
}
function Ke(e2, t2) {
  let n2 = e2.replace(X.SPACING, ``);
  return { name: Z(n2), slug: Q(n2), size: t2.trim() };
}
function qe(e2) {
  ...
  return e2.forEach(({ key: e3, value: n2 }) => {
    if (n2) {
      if (e3.startsWith(X.COLOR)) {
        let r2 = Ve(e3, n2);
        t2.settings.color.palette.push(r2);
      } else if (e3.startsWith(X.FONT_FAMILY)) {
        let r2 = He(e3, n2);
        r2 && t2.settings.typography.fontFamilies.push(r2);
      } else if (e3.startsWith(X.FONT_SIZE)) {
        let r2 = Ue(e3, n2);
        r2 && t2.settings.typography.fontSizes.push(r2);
      } else if (e3.startsWith(X.BORDER_RADIUS)) {
        let r2 = We(e3, n2);
        t2.settings.border.radiusSizes.push(r2);
      } else if (e3.startsWith(X.INSET_SHADOW) || e3.startsWith(X.DROP_SHADOW) || e3.startsWith(X.SHADOW)) {
        let r2 = Ge(e3, n2);
        t2.settings.shadow.presets.push(r2);
      } else if (e3.startsWith(X.SPACING)) {
        let r2 = Ke(e3, n2);
        t2.settings.spacing.spacingSizes.push(r2);
      }
    }
  }), t2.settings.typography.fontSizes = Be(t2.settings.typography.fontSizes), t2;
}
var Je = { class: `text-xs opacity-60 font-normal` }, Ye = { class: `flex-1 overflow-y-auto relative` }, Xe = { key: 0, class: `absolute bottom-5 left-5 z-50` }, Ze = { key: `panel`, class: `bg-(--ui-bg)/30 backdrop-blur-md border border-error/20 rounded-lg p-4 shadow-xl min-w-80 max-w-96 origin-bottom-left` }, Qe = { class: `flex items-start gap-3` }, $e = { class: `flex-1` }, et = { class: `flex items-center justify-between mb-2` }, tt = { class: `font-medium text-error text-sm` }, nt = { class: `text-sm mb-2` }, rt = { key: 0, class: `text-xs text-muted` }, it = g({ __name: `FileEditor`, props: { entry: {} }, emits: [`close`, `save`, `delete`, `reset`], setup(e2, { emit: t2 }) {
  let i2 = V(), a2 = H(), c2 = ue(), d2 = ve(), f2 = e2, p2 = t2, m2 = { automaticLayout: true, formatOnType: false, formatOnPaste: false, fontSize: 14 }, g2 = E(), v2 = S(false), C2 = S([]), w2 = null, T2 = /* @__PURE__ */ new Set(), D2 = S({ hasErrors: false, errors: [] }), k2 = S(false);
  async function j2(e3, t3) {
    if (g2.value = e3, v2.value = true, Number(a2.virtualOptions(`general.tailwindcss.version`, 4).value) === 4) {
      let n2 = null, r2 = null, a3 = 0, o2 = 3e4, s2 = async () => {
        ...
        try {
          let e4 = await G({ volume: i2.getKVEntries() }), t4 = await we(e4);
          n2 = { designSystem: e4, variablesList: t4, classList: Te(e4) }, d2.themeJson = qe(t4), a3 = Date.now();
        } catch (e4) {
        ...
        var _a;
        try {
          await G({ volume: i2.getKVEntries(), strict: true }), D2.value = { hasErrors: false, errors: [] };
        } catch (e4) {
          D2.value = { hasErrors: true, errors: [{ message: e4.message || `Unknown CSS error`, line: e4.line, column: e4.column, file: ((_a = e4.input) == null ? void 0 : _a.from) || `main.css` }] };
        }
            ...
            if (o3 && o3.groups) {
              ...
              try {
                return { suggestions: await m3(a5, async () => {
                  ...
                  let a6 = (e7) => {
                    var _a;
                    return ((_a = e7 == null ? void 0 : e7.find((e8) => e8.property && e8.property.includes(`color`))) == null ? void 0 : _a.value) || null;
                  };
                  return e6.filter((e7) => !(e7.kind !== `utility` || e7.selector.includes(`:`))).map((e7, o4) => {
                    ...
                    let l3 = { label: e7.selector, kind: c4, insertText: e7.selector, range: { startLineNumber: n3.lineNumber, startColumn: Math.max(1, n3.column - i4.length), endLineNumber: n3.lineNumber, endColumn: n3.column }, sortText: W(o4), documentation: s3 ? `Color: ${s3}` : e7.css || void 0, detail: e7.css || void 0 };
                    if (s3) try {
...
\`\`\`` }] };
          ...
          let { red: n3, green: r3, blue: i3, alpha: a4 } = t4.color, o3 = new J(`srgb`, [n3, r3, i3], a4), s3 = e4.getLineContent(t4.range.startLineNumber), c4 = s3.match(/@apply\s+([^;}]+)/);
          if (c4) {
...
`), o4 = null;
        ...
        let a4 = false, o3 = i3.filter((e4) => {
          var _a;
          let t4 = typeof e4.code == `string` ? e4.code : (_a = e4.code) == null ? void 0 : _a.value;
  ...
  return h(() => {
    ...
    let h2 = F, g3 = z, v3 = I, S2 = xe, C3 = ne, w3 = De, T3 = s(`vue-monaco-editor`), E2 = Ee;
    return _(), x(E2, { id: `explorer-2`, class: `min-h-[calc(100svh-var(--wp-admin--admin-bar--height))]` }, { default: y(() => {
      var _a;
      return [n(w3, { title: (_a = e2.entry) == null ? void 0 : _a.relative_path, toggle: false, ui: { title: `text-sm` } }, { leading: y(() => [n(g3, { text: t3.i18n.__(`Close`, `windpress`) }, { default: y(() => [n(h2, { icon: `i-lucide-x`, color: `neutral`, variant: `ghost`, class: `-ms-1.5`, onClick: d3[0] || (d3[0] = (e3) => p2(`close`)) })]), _: 1 }, 8, [`text`])]), title: y(() => {
        var _a2, _b, _c, _d, _e2;
        return [n(v3, { name: `vscode-icons:file-type-${((_a2 = e2.entry) == null ? void 0 : _a2.relative_path) === `main.css` ? `tailwind` : o(Y.default).extname(((_b = e2.entry) == null ? void 0 : _b.relative_path) ?? ``).replace(`.`, ``)}`, class: `size-5` }, null, 8, [`name`]), r(` ` + b((_c = e2.entry) == null ? void 0 : _c.relative_path) + ` `, 1), f2.entry.readonly ? (_(), x(S2, { key: 0, label: t3.i18n.__(`read-only`, `windpress`), color: `warning`, variant: `outline` }, null, 8, [`label`])) : O(``, true), ((_d = e2.entry) == null ? void 0 : _d.path_on_disk) ? (_(), x(g3, { key: 1, text: `${t3.i18n.__(`Path on disk`, `windpress`)}: ${(_e2 = e2.entry) == null ? void 0 : _e2.path_on_disk}` }, { default: y(() => {
          var _a3;
          return [l(`span`, Je, [d3[8] || (d3[8] = r(` [ `, -1)), n(v3, { name: `i-lucide-hard-drive`, class: `inline-block align-middle me-1` }), r(` ` + b((_a3 = e2.entry) == null ? void 0 : _a3.path_on_disk) + ` ] `, 1)])];
        }), _: 1 }, 8, [`text`])) : O(``, true)];
      }), right: y(() => {
        var _a2, _b, _c, _d, _e2, _f, _g;
        return [((_a2 = e2.entry) == null ? void 0 : _a2.relative_path) !== `main.css` && !(Number(o(a2).virtualOptions(`general.tailwindcss.version`, 4).value) === 3 && (((_b = e2.entry) == null ? void 0 : _b.relative_path) === `tailwind.config.js` || ((_c = e2.entry) == null ? void 0 : _c.relative_path) === `wizard.js`)) ? (_(), x(g3, { key: 0, text: t3.i18n.__(`Delete`, `windpress`) }, { default: y(() => [n(h2, { icon: `i-lucide-trash`, color: `neutral`, variant: `ghost`, onClick: d3[1] || (d3[1] = (t4) => p2(`delete`, e2.entry)) })]), _: 1 }, 8, [`text`])) : O(``, true), ((_d = e2.entry) == null ? void 0 : _d.relative_path) === `main.css` || ((_e2 = e2.entry) == null ? void 0 : _e2.relative_path) === `wizard.css` || Number(o(a2).virtualOptions(`general.tailwindcss.version`, 4).value) === 3 && (((_f = e2.entry) == null ? void 0 : _f.relative_path) === `tailwind.config.js` || ((_g = e2.entry) == null ? void 0 : _g.relative_path) === `wizard.js`) ? (_(), x(g3, { key: 1, text: t3.i18n.__(`Reset to default`, `windpress`) }, { default: y(() => [n(h2, { icon: `lucide:file-minus-2`, color: `neutral`, variant: `ghost`, onClick: d3[2] || (d3[2] = (t4) => p2(`reset`, e2.entry)) })]), _: 1 }, 8, [`text`])) : O(``, true), n(g3, { text: t3.i18n.__(`Save`, `windpress`) }, { default: y(() => {
          var _a3;
          return [o(i2).entryHasChanged((_a3 = e2.entry) == null ? void 0 : _a3.relative_path) ? (_(), x(C3, { key: 0, color: `warning`, size: `md` }, { default: y(() => [n(h2, { icon: `i-lucide-save`, color: `primary`, variant: `subtle`, onClick: d3[3] || (d3[3] = (e3) => p2(`save`)) })]), _: 1 })) : (_(), x(h2, { key: 1, icon: `i-lucide-save`, color: `primary`, variant: `subtle`, onClick: d3[4] || (d3[4] = (e3) => p2(`save`)) }))];
        }), _: 1 }, 8, [`text`])];
      }), _: 1 }, 8, [`title`]), l(`div`, Ye, [n(A, { "enter-active-class": `transition-all duration-500 ease-out`, "leave-active-class": `transition-all duration-300 ease-in`, "enter-from-class": `scale-50 opacity-0 translate-y-4`, "enter-to-class": `scale-100 opacity-100 translate-y-0`, "leave-from-class": `scale-100 opacity-100 translate-y-0`, "leave-to-class": `scale-50 opacity-0 translate-y-4` }, { default: y(() => [D2.value.hasErrors ? (_(), u(`div`, Xe, [n(A, { "enter-active-class": `transition-all duration-300 ease-out`, "leave-active-class": `transition-all duration-200 ease-in`, "enter-from-class": `scale-75 opacity-0`, "enter-to-class": `scale-100 opacity-100`, "leave-from-class": `scale-100 opacity-100`, "leave-to-class": `scale-75 opacity-0`, mode: `out-in` }, { default: y(() => {
        var _a2, _b, _c;
        return [k2.value ? (_(), u(`div`, Ze, [l(`div`, Qe, [n(v3, { name: `lucide:alert-triangle`, class: `size-4 text-error mt-0.5 flex-shrink-0` }), l(`div`, $e, [l(`div`, et, [l(`p`, tt, b(t3.i18n.__(`CSS Validation Error`, `windpress`)), 1), n(h2, { variant: `ghost`, size: `xs`, icon: `i-lucide-x`, color: `neutral`, onClick: d3[6] || (d3[6] = (e3) => k2.value = false) })]), l(`p`, nt, b((_a2 = D2.value.errors[0]) == null ? void 0 : _a2.message), 1), ((_b = D2.value.errors[0]) == null ? void 0 : _b.line) ? (_(), u(`div`, rt, b(t3.i18n.__(`Line`, `windpress`)) + ` ` + b(D2.value.errors[0].line) + b(((_c = D2.value.errors[0]) == null ? void 0 : _c.column) ? `, ${t3.i18n.__(`Column`, `windpress`)} ${D2.value.errors[0].column}` : ``), 1)) : O(``, true)])])])) : (_(), u(`div`, { key: `icon`, class: `bg-(--ui-bg)/30 backdrop-blur-md border border-error/20 rounded-lg p-3 shadow-xl hover:scale-110 transition-transform origin-bottom-left cursor-pointer`, onClick: d3[5] || (d3[5] = (e3) => k2.value = true) }, [n(v3, { name: `lucide:alert-triangle`, class: `size-4 text-error flex-shrink-0` })]))];
      }), _: 1 })])) : O(``, true)]), _: 1 }), n(T3, { value: f2.entry.content, "onUpdate:value": d3[7] || (d3[7] = (e3) => f2.entry.content = e3), language: f2.entry.relative_path.endsWith(`.css`) ? `css` : `javascript`, saveViewState: false, options: { ...m2, readOnly: f2.entry.readonly }, onMount: j2, theme: o(c2) === `dark` ? `vs-dark` : `vs` }, null, 8, [`value`, `language`, `options`, `theme`])])];
    }), _: 1 });
  };
} }), at = { key: 1, class: `hidden lg:flex flex-1 items-center justify-center` }, ot = g({ __name: `File`, setup(e2) {
  let t2 = V(), r2 = ye(), i2 = S(null), a2 = m({ get() {

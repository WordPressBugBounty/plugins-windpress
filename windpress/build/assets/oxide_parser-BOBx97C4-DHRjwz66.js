...
function t() {
  return { __proto__: null, "./oxide_parser_bg.js": { __proto__: null, __wbg___wbindgen_string_get_7ed5322991caaec5: function(e2, t2) {
  ...
  }, __wbg___wbindgen_throw_6b64449b9b9ed33c: function(e2, t2) {
    throw Error(o(e2, t2));
  }, __wbg_from_0dbf29f09e7fb200: function(e2) {
    return n(Array.from(l(e2)));
  }, __wbg_get_8360291721e2339f: function(e2, t2) {
    let r2 = l(e2)[t2 >>> 0];
    return n(r2);
  }, __wbg_isArray_c3109d14ffc06469: function(e2) {
    return Array.isArray(l(e2));
  }, __wbg_length_3d4ecd04bd8d22f1: function(e2) {
    return l(e2).length;
  }, __wbg_new_682678e2f47e32bc: function() {
    return n([]);
  }, __wbg_new_with_length_223c4ea248649e55: function(e2) {
    return n(Array(e2 >>> 0));
  }, __wbg_set_3bf1de9fab0cd644: function(e2, t2, n2) {
    l(e2)[t2 >>> 0] = m(n2);
...
async function T(e2) {
  if (x !== void 0) return x;
  e2 !== void 0 && (Object.getPrototypeOf(e2) === Object.prototype ? { module_or_path: e2 } = e2 : console.warn(`using deprecated parameters for the initialization function; pass a single object instead`)), e2 === void 0 && (e2 = new URL(`` + new URL(`oxide_parser_bg-Ny-XIVaW.wasm`, import.meta.url).href, `` + import.meta.url));
  let n2 = t();

import { D as e, E as t, On as n, St as r, _ as i, b as a, g as o, gt as s, k as c, mt as l, o as u, qt as d, rt as f, tr as p, v as m, vn as h } from "./runtime-core.esm-bundler-CahM68iJ.js";
import { n as g, t as _, v } from "./Button-DpvhuBJO.js";
import { i as y, o as b } from "./vue-router-B3IuXUyS.js";
import { t as x } from "./Tooltip-CZRNrufK.js";
import { t as S } from "./NavigationMenu-DB3DLsvS.js";
import { r as C, t as w } from "./useFileAction-BM3bbZfF.js";
import { t as T } from "./settings-B68hC1Sq.js";
import { n as E, t as D } from "./adobe-css-tools-DPH8i0dL.js";
import { n as O, t as k } from "./DashboardNavbar-DDpWxmFn.js";
import { t as A } from "./DashboardSidebarCollapse-1SyUPjQc.js";
...
function I(e2, t2) {
  var _a;
  let n2 = j[e2];
  return !n2 || !(`excludePatterns` in n2) ? false : ((_a = n2.excludePatterns) == null ? void 0 : _a.some((e3) => t2.startsWith(e3))) ?? false;
}
function L() {
...
function R(e2) {
  ...
  try {
    let n2 = E(e2);
    if (t2.ast = n2, (_a = n2.stylesheet) == null ? void 0 : _a.rules) {
...
function H(e2) {
  ...
  if ((_a = t2.stylesheet) == null ? void 0 : _a.rules) {
...
var G = { class: `flex flex-col items-center justify-center h-full p-8 text-center` }, K = { class: `max-w-md mx-auto` }, q = { class: `text-2xl font-bold text-highlighted mb-4` }, J = { class: `text-dimmed mb-6 leading-relaxed` }, Y = { class: `space-y-4` }, X = { class: `text-sm text-dimmed` }, Z = c({ __name: `VersionRequirement`, setup(r2) {
  ...
  f(async () => {
    ...
    if (await Promise.all([n2.initPull(), g2.initPull()]), E2.value) {
      let e2 = ((_a = n2.data.entries.find((e3) => e3.relative_path === `wizard.css`)) == null ? void 0 : _a.content) || ``;

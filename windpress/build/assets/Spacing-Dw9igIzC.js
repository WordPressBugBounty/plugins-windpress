import { D as e, E as t, Ht as n, J as r, On as i, _ as a, b as o, k as s, mt as c, qt as l, rt as u, tr as d, v as f } from "./runtime-core.esm-bundler-Ci9kEgM7.js";
import { t as p, y as m } from "./Button-CzGEASGR.js";
import { i as h } from "./vue-router-Ds7Bu_8X.js";
import { t as g } from "./Tooltip-CmrGYuQV.js";
import { t as _ } from "./useOverlay-D6IDAxlU.js";
import { n as v, t as y } from "./FluidCalculatorSlideover-DCecaGNy.js";
import { t as b } from "./Tree-B0rB3fqE.js";
import { n as x } from "./useToast-BvjG-lga.js";
import { t as S } from "./Badge-Dw196kvM.js";
import { n as C } from "./index.browser-BEODCD8T.js";
import { n as w, t as ee } from "./DashboardNavbar-BjpmTDcR.js";
import { n as T, r as E, t as D } from "./WizardTreeItem-_60OpT8s.js";
var O = { class: `text-xs opacity-60 font-normal` }, k = { class: `flex-1 overflow-y-auto p-4` }, A = { key: 0, class: `flex flex-col items-center justify-center h-full text-center` }, j = { class: `text-lg font-semibold text-highlighted mb-2` }, M = { class: `text-dimmed mb-6 max-w-sm` }, N = { class: `flex gap-2` }, P = s({ __name: `Spacing`, setup(s2) {
  let P2 = _(), F = x(), I = r(`theme`), { expandedTree: L, items: R, updateThemeFromItems: z, findItemByUid: B, addChild: V, addNext: H, deleteItem: U, initializeItems: W, findOrCreateItemByKey: G } = E(`spacing`, I), { shouldBeDimmed: K, wasRecentlyMoved: q, isDescendantOf: J } = T(R, z, B);
  ...
  function Q(e2) {
    ...
    for (let t3 = 1; t3 <= e2.stepsSmaller; t3++) {
      ...
      n2.push({ key: r3, value: v(i3, a2, e2.minViewport, e2.maxViewport) });
    }
    n2.push({ key: `base`, value: v(e2.minSize, e2.maxSize, e2.minViewport, e2.maxViewport) });
  ...
  async function $() {
    let e2 = await P2.create(y, { destroyOnClose: true }).open().result;
    if (!e2) {

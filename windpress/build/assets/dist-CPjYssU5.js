...
import { n as t, t as n } from "./dist-DkW5GlYv.js";
import { n as r, t as i } from "./dist-YmA3yiKr.js";
...
var C = class {
  ...
  compile(e12) {
    return this._cached || (this._cached = new He(e12, this._items.map((e13) => e13.source), this._items.map((e13) => e13.ruleId))), this._cached;
  }
  compileAG(e12, t2, n2) {
...
var O = class e8 {
  ...
  static pushFrame(t2, n2) {
    let r2 = O.fromExtension((t2 == null ? void 0 : t2.nameScopesList) ?? null, n2.nameScopesList);
...
function xt(e12) {
  ...
  if (e12 == null ? void 0 : e12[bt]) return e12;
  let t2 = { ...e12 };
  ...
  if (!n2 || !r2) {
    ...
    ((_a2 = e13 == null ? void 0 : e13.settings) == null ? void 0 : _a2.foreground) && (r2 = e13.settings.foreground), ((_b2 = e13 == null ? void 0 : e13.settings) == null ? void 0 : _b2.background) && (n2 = e13.settings.background), !r2 && ((_c = t2 == null ? void 0 : t2.colors) == null ? void 0 : _c[`editor.foreground`]) && (r2 = t2.colors[`editor.foreground`]), !n2 && ((_d = t2 == null ? void 0 : t2.colors) == null ? void 0 : _d[`editor.background`]) && (n2 = t2.colors[`editor.background`]), r2 || (r2 = t2.type === `light` ? vt.light : vt.dark), n2 || (n2 = t2.type === `light` ? yt.light : yt.dark), t2.fg = r2, t2.bg = n2;
  }
  ...
  loadLanguages(e12) {
    ...
    if (n2.length) {
      let e13 = t2.filter(([e14, t3]) => {
        var _a2;
        return t3 ? (_a2 = t3.embeddedLanguages || t3.embeddedLangs) == null ? void 0 : _a2.some((e15) => n2.map(([e16]) => e16).includes(e15)) : false;
...
function Tr(e12, t2, n2) {
  let r2 = un(e12.schema, t2), i2 = e12.settings.allowParseErrors && e12.schema.space === `html` ? 0 : 1, a2 = e12.settings.allowDangerousCharacters ? 0 : 1, o2 = e12.quote, s2;
...
function Jr() {
  ...
  return { name: `shiki:decorations`, tokens(e13) {
    var _a2;
    if ((_a2 = this.options.decorations) == null ? void 0 : _a2.length) return Wr(e13, t2(this).decorations.flatMap((e14) => [e14.start.offset, e14.end.offset]));
  }, code(e13) {
    var _a2;
    ...
    function s2(e14, t3, n3) {
      ...
      return e14.tagName = t3.tagName || `span`, e14.properties = { ...e14.properties, ...r3, class: e14.properties.class }, ((_a3 = t3.properties) == null ? void 0 : _a3.class) && zr(e14, t3.properties.class), e14 = i3(e14, n3) || e14, e14;
    }
...
function ci(e12, t2, n2) {
  let r2 = k(e12, n2), i2 = N(t2), a2 = oi(Object.fromEntries(X.map((t3) => {
    ...
    return [t3, ((_a2 = e12.colors) == null ? void 0 : _a2[n3]) || si[t3]];
  }))), o2 = ii();
...
function Z(e12, t2, n2) {
  ...
  if (`themes` in n2) {
    let { defaultColor: u2 = `light`, cssVariablePrefix: d2 = `--shiki-`, colorsRendering: f2 = `css-vars` } = n2, p2 = Object.entries(n2.themes).filter((e13) => e13[1]).map((e13) => ({ color: e13[0], theme: e13[1] })).sort((e13, t3) => e13.color === u2 ? -1 : t3.color === u2 ? 1 : 0);
...
function fi(e12, t2, n2, r2 = { meta: {}, options: n2, codeToHast: (t3, n3) => fi(e12, t3, n3), codeToTokens: (t3, n3) => Z(e12, t3, n3) }) {
  var _a2, _b2;
  let i2 = t2;
  for (let e13 of Qr(n2)) i2 = ((_a2 = e13.preprocess) == null ? void 0 : _a2.call(r2, i2, n2)) || i2;
  ...
  for (let e13 of Qr(n2)) a2 = ((_b2 = e13.tokens) == null ? void 0 : _b2.call(p2, a2)) || a2;
...
` }));
    ...
    for (let a3 of e13) {
      ...
      for (let o3 of i2) e14 = ((_a3 = o3 == null ? void 0 : o3.span) == null ? void 0 : _a3.call(p2, e14, t3 + 1, r3, n3, a3)) || e14;
      s2 === `inline` ? o2.children.push(e14) : s2 === `classic` && n3.children.push(e14), r3 += a3.content.length;
    }
    if (s2 === `classic`) {
      for (let e14 of i2) n3 = ((_b3 = e14 == null ? void 0 : e14.line) == null ? void 0 : _b3.call(p2, n3, t3 + 1)) || n3;
      f2.push(n3), a2.push(n3);
    } else s2 === `inline` && f2.push(n3);
  }), s2 === `classic`) {
    for (let e13 of i2) d2 = ((_a2 = e13 == null ? void 0 : e13.code) == null ? void 0 : _a2.call(p2, d2)) || d2;
    u2.children.push(d2);
    for (let e13 of i2) u2 = ((_b2 = e13 == null ? void 0 : e13.pre) == null ? void 0 : _b2.call(p2, u2)) || u2;
    o2.children.push(u2);
  } else if (s2 === `inline`) {
    ...
    for (let e14 of i2) n3 = ((_c = e14 == null ? void 0 : e14.code) == null ? void 0 : _c.call(p2, n3)) || n3;
    o2.children = [];
  ...
  let m2 = o2;
  for (let e13 of i2) m2 = ((_d = e13 == null ? void 0 : e13.root) == null ? void 0 : _d.call(p2, m2)) || m2;
...
function vi(e12, t2, n2) {
  ...
  for (let e13 of Qr(n2)) i2 = ((_a2 = e13.postprocess) == null ? void 0 : _a2.call(r2, i2, n2)) || i2;
  return i2;
}
...
function Ii(e12) {
  var _a2, _b2;
  return typeof ArrayBuffer < `u` && (e12 instanceof ArrayBuffer || ArrayBuffer.isView(e12)) || n !== void 0 && ((_b2 = (_a2 = n).isBuffer) == null ? void 0 : _b2.call(_a2, e12)) || typeof SharedArrayBuffer < `u` && e12 instanceof SharedArrayBuffer || typeof Uint32Array < `u` && e12 instanceof Uint32Array;
}
var Li;
function Ri(e12) {
  if (Li) return Li;

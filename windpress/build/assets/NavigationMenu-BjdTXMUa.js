import { D as e, E as t, Ht as n, Lt as r, On as i, Tn as a, Ut as o, Zn as s, _ as c, b as l, bt as u, ct as d, et as f, g as p, k as m, mt as h, o as g, qt as _, tr as v, tt as y, u as b, v as x, vn as S, wn as C, wt as w, xt as T, y as E } from "./runtime-core.esm-bundler-Twwq1XF8.js";
import { C as D } from "./runtime-dom.esm-bundler-Owfape5M.js";
import { C as O, b as k, d as A, g as j, h as M, p as N, t as ee, v as te, y as P } from "./Tooltip-CPUUajce.js";
import { B as F, C as I, H as ne, I as re, N as L, O as R, S as ie, V as ae, _ as oe, b as se, i as z, n as B, r as V, v as ce, x as le, y as H } from "./Button-DbU2pTtV.js";
import { b as U, c as ue, k as de, v as fe, y as pe } from "./dist-Bw8ba7To.js";
import { b as W, f as me, o as he, r as ge, v as G } from "./dist-ChpmCc7n.js";
import { H as K, O as q, U as J } from "./namespaced-CFCft_Em.js";
import { t as _e } from "./Badge-amSaWZqG.js";
import { t as ve } from "./Popover-QUjyVXG4.js";
function ye(e2, t2) {
  return O(e2) ? false : Array.isArray(e2) ? e2.some((e3) => F(e3, t2)) : F(e2, t2);
}
var [be, xe] = R(`CollapsibleRoot`), Se = m({ __name: `CollapsibleRoot`, props: { defaultOpen: { type: Boolean, required: false, default: false }, open: { type: Boolean, required: false, default: void 0 }, disabled: { type: Boolean, required: false }, unmountOnHide: { type: Boolean, required: false, default: true }, asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, emits: [`update:open`], setup(e2, { expose: t2, emit: n2 }) {
  let r2 = e2, o2 = W(r2, `open`, n2, { defaultValue: r2.defaultOpen, passive: r2.open === void 0 }), { disabled: s2, unmountOnHide: c2 } = a(r2);
  return xe({ contentId: ``, disabled: s2, open: o2, unmountOnHide: c2, onOpenToggle: () => {
    s2.value || (o2.value = !o2.value);
  } }), t2({ open: o2 }), P(), (e3, t3) => (h(), x(i(I), { as: e3.as, "as-child": r2.asChild, "data-state": i(o2) ? `open` : `closed`, "data-disabled": i(s2) ? `` : void 0 }, { default: _(() => [T(e3.$slots, `default`, { open: i(o2) })]), _: 3 }, 8, [`as`, `as-child`, `data-state`, `data-disabled`]));
} }), Ce = m({ inheritAttrs: false, __name: `CollapsibleContent`, props: { forceMount: { type: Boolean, required: false }, asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, emits: [`contentFound`], setup(t2, { emit: r2 }) {
  let a2 = t2, o2 = r2, s2 = be();
  s2.contentId || (s2.contentId = j(void 0, `reka-collapsible-content`));
  let c2 = S(), { forwardRef: l2, currentElement: u2 } = P(), m2 = S(0), g2 = S(0), v2 = p(() => s2.open.value), b2 = S(v2.value), C2 = S();
  ...
  }), me(u2, `beforematch`, (e2) => {
    requestAnimationFrame(() => {
      s2.onOpenToggle(), o2(`contentFound`);
    });
  }), (t3, n2) => (h(), x(i(M), { ref_key: `presentRef`, ref: c2, present: t3.forceMount || i(s2).open.value, "force-mount": true }, { default: _(({ present: n3 }) => [e(i(I), f(t3.$attrs, { id: i(s2).contentId, ref: i(l2), "as-child": a2.asChild, as: t3.as, hidden: n3 ? void 0 : i(s2).unmountOnHide.value ? `` : `until-found`, "data-state": w2.value ? void 0 : i(s2).open.value ? `open` : `closed`, "data-disabled": i(s2).disabled?.value ? `` : void 0, style: { "--reka-collapsible-content-height": `${g2.value}px`, "--reka-collapsible-content-width": `${m2.value}px` } }), { default: _(() => [!i(s2).unmountOnHide.value || n3 ? T(t3.$slots, `default`, { key: 0 }) : E(`v-if`, true)]), _: 2 }, 1040, [`id`, `as-child`, `as`, `hidden`, `data-state`, `data-disabled`, `style`])]), _: 3 }, 8, [`present`]));
} }), we = m({ __name: `CollapsibleTrigger`, props: { asChild: { type: Boolean, required: false }, as: { type: null, required: false, default: `button` } }, setup(e2) {
  let t2 = e2;
  P();
  let n2 = be();
  return (e3, r2) => (h(), x(i(I), { type: e3.as === `button` ? `button` : void 0, as: e3.as, "as-child": t2.asChild, "aria-controls": i(n2).contentId, "aria-expanded": i(n2).open.value, "data-state": i(n2).open.value ? `open` : `closed`, "data-disabled": i(n2).disabled?.value ? `` : void 0, disabled: i(n2).disabled?.value, onClick: i(n2).onOpenToggle }, { default: _(() => [T(e3.$slots, `default`)]), _: 3 }, 8, [`type`, `as`, `as-child`, `aria-controls`, `aria-expanded`, `data-state`, `data-disabled`, `disabled`, `onClick`]));
} });
...
function Oe(e2, t2) {
  let n2 = p(() => Ee(e2)), r2 = W(e2, `modelValue`, t2, { defaultValue: De(e2), passive: e2.modelValue === void 0, deep: true });
  function i2(e3) {
    if (n2.value === `single`) r2.value = F(e3, r2.value) ? void 0 : e3;
    else {
      let t3 = Array.isArray(r2.value) ? [...r2.value || []] : [r2.value].filter(Boolean);
      if (ye(t3, e3)) {
        let n3 = t3.findIndex((t4) => F(t4, e3));
        t3.splice(n3, 1);
      } else t3.push(e3);
      r2.value = t3;
    }
...
var [Y, ke] = R(`AccordionRoot`), Ae = m({ __name: `AccordionRoot`, props: { collapsible: { type: Boolean, required: false, default: false }, disabled: { type: Boolean, required: false, default: false }, dir: { type: String, required: false }, orientation: { type: String, required: false, default: `vertical` }, unmountOnHide: { type: Boolean, required: false, default: true }, asChild: { type: Boolean, required: false }, as: { type: null, required: false }, type: { type: String, required: false }, modelValue: { type: null, required: false }, defaultValue: { type: null, required: false } }, emits: [`update:modelValue`], setup(e2, { emit: t2 }) {
  let n2 = e2, r2 = t2, { dir: o2, disabled: s2, unmountOnHide: c2 } = a(n2), l2 = k(o2), { modelValue: u2, changeModelValue: d2, isSingle: f2 } = Oe(n2, r2), { forwardRef: p2, currentElement: m2 } = P();
  return ke({ disabled: s2, direction: l2, orientation: n2.orientation, parentElement: m2, isSingle: f2, collapsible: n2.collapsible, modelValue: u2, changeModelValue: d2, unmountOnHide: c2 }), (e3, t3) => (h(), x(i(I), { ref: i(p2), "as-child": e3.asChild, as: e3.as }, { default: _(() => [T(e3.$slots, `default`, { modelValue: i(u2) })]), _: 3 }, 8, [`as-child`, `as`]));
} }), X = (function(e2) {
  return e2.Open = `open`, e2.Closed = `closed`, e2;
})(X || {}), [je, Me] = R(`AccordionItem`), Ne = m({ __name: `AccordionItem`, props: { disabled: { type: Boolean, required: false }, value: { type: String, required: true }, unmountOnHide: { type: Boolean, required: false, default: void 0 }, asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, setup(e2, { expose: t2 }) {
  ...
  let { currentRef: l2, currentElement: u2 } = P();
...
var [$, Ue] = R([`NavigationMenuRoot`, `NavigationMenuSub`], `NavigationMenuContext`), We = m({ __name: `NavigationMenuRoot`, props: { modelValue: { type: String, required: false, default: void 0 }, defaultValue: { type: String, required: false }, dir: { type: String, required: false }, orientation: { type: String, required: false, default: `horizontal` }, delayDuration: { type: Number, required: false, default: 200 }, skipDelayDuration: { type: Number, required: false, default: 300 }, disableClickTrigger: { type: Boolean, required: false, default: false }, disableHoverTrigger: { type: Boolean, required: false, default: false }, disablePointerLeaveClose: { type: Boolean, required: false }, unmountOnHide: { type: Boolean, required: false, default: true }, asChild: { type: Boolean, required: false }, as: { type: null, required: false, default: `nav` } }, emits: [`update:modelValue`], setup(t2, { emit: n2 }) {
  ...
  o(() => {
    if (!s2.value) return;
    let e2 = g2().map((e3) => e3.ref);
    m2.value = e2.find((e3) => e3.id.includes(s2.value));
  }), me(u2, Q, ee2), Ue({ isRootMenu: true, modelValue: s2, previousValue: c2, baseId: j(void 0, `reka-navigation-menu`), disableClickTrigger: w2, disableHoverTrigger: E2, dir: O2, unmountOnHide: D2, orientation: r2.orientation, rootNavigationMenu: u2, indicatorTrack: d2, activeTrigger: m2, onIndicatorTrackChange: (e2) => {
    d2.value = e2;
  }, viewport: f2, onViewportChange: (e2) => {
    f2.value = e2;
  }, onTriggerEnter: (e2) => {
    s2.value === `` ? N2(e2) : (M2.value = true, c2.value = s2.value, s2.value = e2);
  }, onTriggerLeave: () => {
    M2.value = false, N2(``);
  }, onContentEnter: () => {
    N2();
  }, onContentLeave: () => {
    r2.disablePointerLeaveClose || (M2.value = false, N2(``));
  }, onItemSelect: (e2) => {
  ...
  return (t3, n3) => (h(), x(i(v2), null, { default: _(() => [e(i(I), { ref: i(l2), as: t3.as, "as-child": t3.asChild, "data-orientation": t3.orientation, dir: i(O2), "data-reka-navigation-menu": `` }, { default: _(() => [T(t3.$slots, `default`, { modelValue: i(s2) })]), _: 3 }, 8, [`as`, `as-child`, `data-orientation`, `dir`])]), _: 3 }));
} }), [Ge, Ke] = R(`NavigationMenuItem`), qe = m({ __name: `NavigationMenuItem`, props: { value: { type: String, required: false }, asChild: { type: Boolean, required: false }, as: { type: null, required: false, default: `li` } }, setup(e2) {
  let t2 = e2;
  P();
  let { getItems: n2 } = q({ key: `NavigationMenu` }), r2 = $(), a2 = j(t2.value), o2 = S(), s2 = S(), c2 = Le(r2.baseId, a2), l2 = () => ({}), u2 = S(false);
  ...
  return (e3, t3) => (h(), x(i(I), { "as-child": e3.asChild, as: e3.as, "data-menu-item": ``, onKeydown: D(m2, [`up`, `down`, `left`, `right`, `home`, `end`, `space`]) }, { default: _(() => [T(e3.$slots, `default`)]), _: 3 }, 8, [`as-child`, `as`]));
  ...
  let n2 = e2, r2 = t2, { getItems: a2 } = q({ key: `NavigationMenu` }), { forwardRef: s2, currentElement: c2 } = P(), l2 = $(), u2 = Ge(), d2 = Ie(l2.baseId, u2.value), m2 = Le(l2.baseId, u2.value), g2 = S(null), v2 = p(() => {
  ...
  function w2(e3) {
    ...
    K(e3, J(), void 0, { itemsArray: r3, loop: false, enableIgnoredElement: true })?.focus();
  }
  function E2() {
  ...
  let r2 = t2, a2 = n2, o2 = te(fe(r2, `forceMount`), a2), { forwardRef: s2 } = P(), c2 = $(), l2 = Ge(), u2 = p(() => l2.value === c2.modelValue.value), d2 = p(() => c2.viewport.value && !c2.modelValue.value && c2.previousValue.value ? c2.previousValue.value === l2.value : false);
  return (t3, n3) => (h(), x(b, { to: i(ue) && i(c2).viewport.value ? i(c2).viewport.value : `body`, disabled: i(ue) && i(c2).viewport.value ? !i(c2).viewport.value : true }, [e(i(M), { present: t3.forceMount || u2.value || d2.value, "force-mount": !i(c2).unmountOnHide.value }, { default: _(({ present: r3 }) => [e(Je, f({ ref: i(s2), "data-state": i(Z)(u2.value), style: { pointerEvents: !u2.value && i(c2).isRootMenu ? `none` : void 0 } }, { ...t3.$attrs, ...i(o2) }, { hidden: !r3, onPointerenter: n3[0] || (n3[0] = (e2) => i(c2).onContentEnter(i(l2).value)), onPointerleave: n3[1] || (n3[1] = (e2) => i(He)(() => i(c2).onContentLeave())(e2)), onPointerDownOutside: n3[2] || (n3[2] = (e2) => a2(`pointerDownOutside`, e2)), onFocusOutside: n3[3] || (n3[3] = (e2) => a2(`focusOutside`, e2)), onInteractOutside: n3[4] || (n3[4] = (e2) => a2(`interactOutside`, e2)) }), { default: _(() => [T(t3.$slots, `default`)]), _: 2 }, 1040, [`data-state`, `style`, `hidden`])]), _: 3 }, 8, [`present`, `force-mount`])], 8, [`to`, `disabled`]));
  ...
  let n2 = t2, { forwardRef: r2 } = P(), a2 = $(), s2 = S(), c2 = p(() => a2.orientation === `horizontal`), l2 = p(() => !!a2.modelValue.value), { activeTrigger: u2 } = a2;
  function d2() {
  ...
  let r2 = t2, a2 = n2, { CollectionItem: o2 } = q({ key: `NavigationMenu` });
  P();
  ...
  return (t3, n3) => (h(), x(i(o2), null, { default: _(() => [e(i(I), { as: t3.as, "data-active": t3.active ? `` : void 0, "aria-current": t3.active ? `page` : void 0, "as-child": r2.asChild, onClick: s2 }, { default: _(() => [T(t3.$slots, `default`)]), _: 3 }, 8, [`as`, `data-active`, `aria-current`, `as-child`])]), _: 3 }));
  ...
  let n2 = t2, r2 = $(), { forwardRef: a2, currentElement: o2 } = P();
  return d(() => {
    r2.onIndicatorTrackChange(o2.value);
  }), (t3, o3) => (h(), x(i(I), { ref: i(a2), style: { position: `relative` } }, { default: _(() => [e(i(I), f(t3.$attrs, { "as-child": n2.asChild, as: t3.as, "data-orientation": i(r2).orientation }), { default: _(() => [T(t3.$slots, `default`)]), _: 3 }, 16, [`as-child`, `as`, `data-orientation`])]), _: 3 }, 512));
  ...
  let n2 = t2, r2 = $(), a2 = Ge(), { CollectionItem: o2 } = q({ key: `NavigationMenu` }), { forwardRef: s2, currentElement: c2 } = P(), u2 = S(``), m2 = S(``), v2 = U(false, 300), y2 = S(false), b2 = p(() => a2.value === r2.modelValue.value);
  d(() => {
  ...
  function k2(e2) {
    e2 && (a2.focusProxyRef.value = he(e2));
  }
  function j2(e2) {
  ...
  return (t3, a3) => (h(), l(g, null, [e(i(o2), null, { default: _(() => [e(i(I), f({ id: u2.value, ref: i(s2), disabled: t3.disabled, "data-disabled": t3.disabled ? `` : void 0, "data-state": i(Z)(b2.value), "data-navigation-menu-trigger": ``, "aria-expanded": b2.value, "aria-controls": m2.value, "as-child": n2.asChild, as: t3.as }, t3.$attrs, { onPointerenter: x2, onPointermove: C2, onPointerleave: w2, onClick: D2, onKeydown: O2 }), { default: _(() => [T(t3.$slots, `default`)]), _: 3 }, 16, [`id`, `disabled`, `data-disabled`, `data-state`, `aria-expanded`, `aria-controls`, `as-child`, `as`])]), _: 3 }), b2.value ? (h(), l(g, { key: 0 }, [e(i(A), { ref: k2, "aria-hidden": `true`, tabindex: 0, onFocus: j2 }), i(r2).viewport ? (h(), l(`span`, { key: 0, "aria-owns": m2.value }, null, 8, $e)) : E(`v-if`, true)], 64)) : E(`v-if`, true)], 64));
  ...
  let r2 = t2, { forwardRef: a2, currentElement: o2 } = P(), s2 = $(), { activeTrigger: c2, rootNavigationMenu: l2, modelValue: u2 } = s2, d2 = S(), m2 = S(), g2 = p(() => !!s2.modelValue.value);
  n(o2, () => {
  ...
  n([u2, g2], () => {
    y(() => {
      o2.value && requestAnimationFrame(() => {
        let e2 = o2.value?.querySelector(`[data-state=open]`);
        v2.value = e2;
      });
    });
  }, { immediate: true });
  ...
  return (n3, r2) => (h(), l(g, null, [e(i(j2), null, { default: _(({ item: r3, active: a3, index: o3 }) => [T(n3.$slots, r3.slot || `item`, { item: r3, index: o3, active: a3, ui: P2.value }, () => [T(n3.$slots, r3.slot ? `${r3.slot}-leading` : `item-leading`, { item: r3, active: a3, index: o3, ui: P2.value }, () => [r3.avatar ? (h(), x(oe, f({ key: 0, size: r3.ui?.linkLeadingAvatarSize || i(y2).ui?.linkLeadingAvatarSize || P2.value.linkLeadingAvatarSize() }, r3.avatar, { "data-slot": `linkLeadingAvatar`, class: P2.value.linkLeadingAvatar({ class: [i(y2).ui?.linkLeadingAvatar, r3.ui?.linkLeadingAvatar], active: a3, disabled: !!r3.disabled }) }), null, 16, [`size`, `class`])) : r3.icon && r3.chip ? (h(), x(ce, f({ key: 1, size: r3.ui?.linkLeadingChipSize || i(y2).ui?.linkLeadingChipSize || P2.value.linkLeadingChipSize(), inset: `` }, typeof r3.chip == `object` ? r3.chip : {}, { "data-slot": `linkLeadingChip` }), { default: _(() => [e(H, { name: r3.icon, "data-slot": `linkLeadingIcon`, class: s(P2.value.linkLeadingIcon({ class: [i(y2).ui?.linkLeadingIcon, r3.ui?.linkLeadingIcon], active: a3, disabled: !!r3.disabled })) }, null, 8, [`name`, `class`])]), _: 2 }, 1040, [`size`])) : r3.icon ? (h(), x(H, { key: 2, name: r3.icon, "data-slot": `linkLeadingIcon`, class: s(P2.value.linkLeadingIcon({ class: [i(y2).ui?.linkLeadingIcon, r3.ui?.linkLeadingIcon], active: a3, disabled: !!r3.disabled })) }, null, 8, [`name`, `class`])) : E(``, true)]), i(L)(r3, i(y2).labelKey) || m2[r3.slot ? `${r3.slot}-label` : `item-label`] ? (h(), l(`span`, { key: 0, "data-slot": `linkLabel`, class: s(P2.value.linkLabel({ class: [i(y2).ui?.linkLabel, r3.ui?.linkLabel] })) }, [T(n3.$slots, r3.slot ? `${r3.slot}-label` : `item-label`, { item: r3, active: a3, index: o3 }, () => [t(v(i(L)(r3, i(y2).labelKey)), 1)]), r3.target === `_blank` && i(y2).externalIcon !== false ? (h(), x(H, { key: 0, name: typeof i(y2).externalIcon == `string` ? i(y2).externalIcon : i(b2).ui.icons.external, "data-slot": `linkLabelExternalIcon`, class: s(P2.value.linkLabelExternalIcon({ class: [i(y2).ui?.linkLabelExternalIcon, r3.ui?.linkLabelExternalIcon], active: a3 })) }, null, 8, [`name`, `class`])) : E(``, true)], 2)) : E(``, true), r3.badge || r3.badge === 0 || i(y2).orientation === `horizontal` && (r3.children?.length || m2[r3.slot ? `${r3.slot}-content` : `item-content`]) || i(y2).orientation === `vertical` && r3.children?.length || r3.trailingIcon || m2[r3.slot ? `${r3.slot}-trailing` : `item-trailing`] ? (h(), x(w(i(y2).orientation === `vertical` && r3.children?.length && !i(y2).collapsed ? i(Fe) : `span`), { key: 1, as: i(y2).orientation === `vertical` && r3.children?.length && !i(y2).collapsed ? `span` : void 0, "data-slot": `linkTrailing`, class: s(P2.value.linkTrailing({ class: [i(y2).ui?.linkTrailing, r3.ui?.linkTrailing] })), onClick: (e2) => U2(e2, r3) }, { default: _(() => [T(n3.$slots, r3.slot ? `${r3.slot}-trailing` : `item-trailing`, { item: r3, active: a3, index: o3, ui: P2.value }, () => [r3.badge || r3.badge === 0 ? (h(), x(_e, f({ key: 0, color: `neutral`, variant: `outline`, size: r3.ui?.linkTrailingBadgeSize || i(y2).ui?.linkTrailingBadgeSize || P2.value.linkTrailingBadgeSize() }, typeof r3.badge == `string` || typeof r3.badge == `number` ? { label: r3.badge } : r3.badge, { "data-slot": `linkTrailingBadge`, class: P2.value.linkTrailingBadge({ class: [i(y2).ui?.linkTrailingBadge, r3.ui?.linkTrailingBadge] }) }), null, 16, [`size`, `class`])) : E(``, true), i(y2).orientation === `horizontal` && (r3.children?.length || m2[r3.slot ? `${r3.slot}-content` : `item-content`]) || i(y2).orientation === `vertical` && r3.children?.length ? (h(), x(H, { key: 1, name: r3.trailingIcon || i(y2).trailingIcon || i(b2).ui.icons.chevronDown, "data-slot": `linkTrailingIcon`, class: s(P2.value.linkTrailingIcon({ class: [i(y2).ui?.linkTrailingIcon, r3.ui?.linkTrailingIcon], active: a3 })) }, null, 8, [`name`, `class`])) : r3.trailingIcon ? (h(), x(H, { key: 2, name: r3.trailingIcon, "data-slot": `linkTrailingIcon`, class: s(P2.value.linkTrailingIcon({ class: [i(y2).ui?.linkTrailingIcon, r3.ui?.linkTrailingIcon], active: a3 })) }, null, 8, [`name`, `class`])) : E(``, true)])]), _: 2 }, 1032, [`as`, `class`, `onClick`])) : E(``, true)])]), _: 3 }), e(i(N2), null, { default: _(({ item: r3, index: a3, level: o3 = 0, listIndex: d3 = 0 }) => [(h(), x(w(i(y2).orientation === `vertical` && !i(y2).collapsed ? i(Ne) : i(qe)), f({ as: `li` }, i(y2).orientation === `vertical` && !i(y2).collapsed ? { disabled: !!r3.disabled } : {}, { value: I2(r3, a3, o3, d3) }), { default: _(() => [i(y2).orientation === `vertical` && r3.type === `label` && !i(y2).collapsed ? (h(), l(`div`, { key: 0, "data-slot": `label`, class: s(P2.value.label({ class: [i(y2).ui?.label, r3.ui?.label, r3.class] })) }, [e(i(M2), { item: r3, index: a3 }, null, 8, [`item`, `index`])], 2)) : r3.type === `label` ? E(``, true) : (h(), x(B, f({ key: 1 }, i(y2).orientation === `vertical` && r3.children?.length && !i(y2).collapsed && r3.type === `trigger` ? {} : i(z)(r3), { custom: `` }), { default: _(({ active: d4, ...p2 }) => [(h(), x(w(i(y2).orientation === `horizontal` && (r3.children?.length || m2[r3.slot ? `${r3.slot}-content` : `item-content`]) ? i(et) : i(y2).orientation === `vertical` && r3.children?.length && !i(y2).collapsed && !p2.href ? i(Fe) : i(Ze)), { "as-child": ``, active: d4 || r3.active, disabled: r3.disabled, onSelect: r3.onSelect }, { default: _(() => [i(y2).orientation === `vertical` && i(y2).collapsed && r3.children?.length && (i(y2).popover || r3.popover) ? (h(), x(ve, f({ key: 0 }, { ...A2.value, ...typeof r3.popover == `boolean` ? {} : r3.popover || {} }, { ui: { content: P2.value.content({ class: [i(y2).ui?.content, r3.ui?.content] }) } }), { content: _(({ close: o4 }) => [T(n3.$slots, r3.slot ? `${r3.slot}-content` : `item-content`, { item: r3, active: d4 || r3.active, index: a3, ui: P2.value, close: o4 }, () => [c(`ul`, { "data-slot": `childList`, class: s(P2.value.childList({ class: [i(y2).ui?.childList, r3.ui?.childList] })) }, [c(`li`, { "data-slot": `childLabel`, class: s(P2.value.childLabel({ class: [i(y2).ui?.childLabel, r3.ui?.childLabel] })) }, v(i(L)(r3, i(y2).labelKey)), 3), (h(true), l(g, null, u(r3.children, (n4, a4) => (h(), l(`li`, { key: a4, "data-slot": `childItem`, class: s(P2.value.childItem({ class: [i(y2).ui?.childItem, r3.ui?.childItem] })) }, [e(B, f({ ref_for: true }, i(z)(n4), { custom: `` }), { default: _(({ active: a5, ...o5 }) => [e(i(Ze), { "as-child": ``, active: a5, onSelect: n4.onSelect }, { default: _(() => [e(V, f({ ref_for: true }, o5, { "data-slot": `childLink`, class: P2.value.childLink({ class: [i(y2).ui?.childLink, r3.ui?.childLink, n4.class], active: a5 }) }), { default: _(() => [n4.icon ? (h(), x(H, { key: 0, name: n4.icon, "data-slot": `childLinkIcon`, class: s(P2.value.childLinkIcon({ class: [i(y2).ui?.childLinkIcon, r3.ui?.childLinkIcon], active: a5 })) }, null, 8, [`name`, `class`])) : E(``, true), c(`span`, { "data-slot": `childLinkLabel`, class: s(P2.value.childLinkLabel({ class: [i(y2).ui?.childLinkLabel, r3.ui?.childLinkLabel], active: a5 })) }, [t(v(i(L)(n4, i(y2).labelKey)) + ` `, 1), n4.target === `_blank` && i(y2).externalIcon !== false ? (h(), x(H, { key: 0, name: typeof i(y2).externalIcon == `string` ? i(y2).externalIcon : i(b2).ui.icons.external, "data-slot": `childLinkLabelExternalIcon`, class: s(P2.value.childLinkLabelExternalIcon({ class: [i(y2).ui?.childLinkLabelExternalIcon, r3.ui?.childLinkLabelExternalIcon], active: a5 })) }, null, 8, [`name`, `class`])) : E(``, true)], 2)]), _: 2 }, 1040, [`class`])]), _: 2 }, 1032, [`active`, `onSelect`])]), _: 2 }, 1040)], 2))), 128))], 2)])]), default: _(() => [e(V, f(p2, { "data-slot": `link`, class: P2.value.link({ class: [i(y2).ui?.link, r3.ui?.link, r3.class], active: d4 || r3.active, disabled: !!r3.disabled, level: o3 > 0 }) }), { default: _(() => [e(i(M2), { item: r3, active: d4 || r3.active, index: a3 }, null, 8, [`item`, `active`, `index`])]), _: 2 }, 1040, [`class`])]), _: 2 }, 1040, [`ui`])) : i(y2).orientation === `vertical` && i(y2).collapsed && (i(y2).tooltip || r3.tooltip) || i(y2).orientation === `horizontal` && r3.tooltip ? (h(), x(ee, f({ key: 1, text: i(L)(r3, i(y2).labelKey) }, { ...k2.value, ...typeof r3.tooltip == `boolean` ? {} : r3.tooltip || {} }), { default: _(() => [e(V, f(p2, { "data-slot": `link`, class: P2.value.link({ class: [i(y2).ui?.link, r3.ui?.link, r3.class], active: d4 || r3.active, disabled: !!r3.disabled, level: o3 > 0 }) }), { default: _(() => [e(i(M2), { item: r3, active: d4 || r3.active, index: a3 }, null, 8, [`item`, `active`, `index`])]), _: 2 }, 1040, [`class`])]), _: 2 }, 1040, [`text`])) : (h(), x(V, f({ key: 2 }, p2, { "data-slot": `link`, class: P2.value.link({ class: [i(y2).ui?.link, r3.ui?.link, r3.class], active: d4 || r3.active, disabled: !!r3.disabled, level: i(y2).orientation === `horizontal` || o3 > 0 }) }), { default: _(() => [e(i(M2), { item: r3, active: d4 || r3.active, index: a3 }, null, 8, [`item`, `active`, `index`])]), _: 2 }, 1040, [`class`]))]), _: 2 }, 1064, [`active`, `disabled`, `onSelect`])), i(y2).orientation === `horizontal` && (r3.children?.length || m2[r3.slot ? `${r3.slot}-content` : `item-content`]) ? (h(), x(i(Ye), f({ key: 0 }, O2.value, { "data-slot": `content`, class: P2.value.content({ class: [i(y2).ui?.content, r3.ui?.content] }) }), { default: _(() => [T(n3.$slots, r3.slot ? `${r3.slot}-content` : `item-content`, { item: r3, active: d4 || r3.active, index: a3, ui: P2.value }, () => [c(`ul`, { "data-slot": `childList`, class: s(P2.value.childList({ class: [i(y2).ui?.childList, r3.ui?.childList] })) }, [(h(true), l(g, null, u(r3.children, (n4, a4) => (h(), l(`li`, { key: a4, "data-slot": `childItem`, class: s(P2.value.childItem({ class: [i(y2).ui?.childItem, r3.ui?.childItem] })) }, [e(B, f({ ref_for: true }, i(z)(n4), { custom: `` }), { default: _(({ active: a5, ...o4 }) => [e(i(Ze), { "as-child": ``, active: a5, onSelect: n4.onSelect }, { default: _(() => [e(V, f({ ref_for: true }, o4, { "data-slot": `childLink`, class: P2.value.childLink({ class: [i(y2).ui?.childLink, r3.ui?.childLink, n4.class], active: a5 }) }), { default: _(() => [n4.icon ? (h(), x(H, { key: 0, name: n4.icon, "data-slot": `childLinkIcon`, class: s(P2.value.childLinkIcon({ class: [i(y2).ui?.childLinkIcon, r3.ui?.childLinkIcon], active: a5 })) }, null, 8, [`name`, `class`])) : E(``, true), c(`div`, { "data-slot": `childLinkWrapper`, class: s(P2.value.childLinkWrapper({ class: [i(y2).ui?.childLinkWrapper, r3.ui?.childLinkWrapper] })) }, [c(`p`, { "data-slot": `childLinkLabel`, class: s(P2.value.childLinkLabel({ class: [i(y2).ui?.childLinkLabel, r3.ui?.childLinkLabel], active: a5 })) }, [t(v(i(L)(n4, i(y2).labelKey)) + ` `, 1), n4.target === `_blank` && i(y2).externalIcon !== false ? (h(), x(H, { key: 0, name: typeof i(y2).externalIcon == `string` ? i(y2).externalIcon : i(b2).ui.icons.external, "data-slot": `childLinkLabelExternalIcon`, class: s(P2.value.childLinkLabelExternalIcon({ class: [i(y2).ui?.childLinkLabelExternalIcon, r3.ui?.childLinkLabelExternalIcon], active: a5 })) }, null, 8, [`name`, `class`])) : E(``, true)], 2), n4.description ? (h(), l(`p`, { key: 0, "data-slot": `childLinkDescription`, class: s(P2.value.childLinkDescription({ class: [i(y2).ui?.childLinkDescription, r3.ui?.childLinkDescription], active: a5 })) }, v(n4.description), 3)) : E(``, true)], 2)]), _: 2 }, 1040, [`class`])]), _: 2 }, 1032, [`active`, `onSelect`])]), _: 2 }, 1040)], 2))), 128))], 2)])]), _: 2 }, 1040, [`class`])) : E(``, true)]), _: 2 }, 1040)), i(y2).orientation === `vertical` && r3.children?.length && !i(y2).collapsed ? (h(), x(i(Pe), { key: 2, "data-slot": `content`, class: s(P2.value.content({ class: [i(y2).ui?.content, r3.ui?.content] })) }, { default: _(() => [e(i(Ae), f({ ...i(D2), defaultValue: R2(r3.children, o3 + 1, d3) }, { as: `ul`, "data-slot": `childList`, class: P2.value.childList({ class: [i(y2).ui?.childList, r3.ui?.childList] }) }), { default: _(() => [(h(true), l(g, null, u(r3.children, (e2, t2) => (h(), x(i(te2), { key: t2, item: e2, index: t2, level: o3 + 1, "list-index": d3, "data-slot": `childItem`, class: s(P2.value.childItem({ class: [i(y2).ui?.childItem, e2.ui?.childItem] })) }, null, 8, [`item`, `index`, `level`, `list-index`, `class`]))), 128))]), _: 2 }, 1040, [`class`])]), _: 2 }, 1032, [`class`])) : E(``, true)]), _: 2 }, 1040, [`value`]))]), _: 3 }), e(i(We), f({ "data-slot": `root` }, { ...i(S2), ...i(y2).orientation === `horizontal` ? { modelValue: i(y2).modelValue, defaultValue: i(y2).defaultValue } : {}, ...n3.$attrs }, { "data-collapsed": i(y2).collapsed, class: P2.value.root({ class: [i(y2).ui?.root, i(y2).class] }) }), { default: _(() => [T(n3.$slots, `list-leading`), (h(true), l(g, null, u(F2.value, (e2, t2) => (h(), l(g, { key: `list-${t2}` }, [(h(), x(w(i(y2).orientation === `vertical` ? i(Ae) : i(Qe)), f({ ref_for: true }, i(y2).orientation === `vertical` && !i(y2).collapsed ? { ...i(D2), modelValue: i(y2).modelValue, defaultValue: i(y2).defaultValue ?? R2(e2, 0, t2) } : {}, { as: `ul`, "data-slot": `list`, class: P2.value.list({ class: i(y2).ui?.list }) }), { default: _(() => [(h(true), l(g, null, u(e2, (e3, n4) => (h(), x(i(te2), { key: `list-${t2}-${n4}`, item: e3, index: n4, "list-index": t2, "data-slot": `item`, class: s(P2.value.item({ class: [i(y2).ui?.item, e3.ui?.item] })) }, null, 8, [`item`, `index`, `list-index`, `class`]))), 128))]), _: 2 }, 1040, [`class`])), i(y2).orientation === `vertical` && t2 < F2.value.length - 1 ? (h(), l(`div`, { key: 0, "data-slot": `separator`, class: s(P2.value.separator({ class: i(y2).ui?.separator })) }, null, 2)) : E(``, true)], 64))), 128)), T(n3.$slots, `list-trailing`), i(y2).orientation === `horizontal` ? (h(), l(`div`, { key: 0, "data-slot": `viewportWrapper`, class: s(P2.value.viewportWrapper({ class: i(y2).ui?.viewportWrapper })) }, [i(y2).arrow ? (h(), x(i(Xe), { key: 0, "data-slot": `indicator`, class: s(P2.value.indicator({ class: i(y2).ui?.indicator })) }, { default: _(() => [c(`div`, { "data-slot": `arrow`, class: s(P2.value.arrow({ class: i(y2).ui?.arrow })) }, null, 2)]), _: 1 }, 8, [`class`])) : E(``, true), e(i(tt), { "data-slot": `viewport`, class: s(P2.value.viewport({ class: i(y2).ui?.viewport })) }, null, 8, [`class`])], 2)) : E(``, true)]), _: 3 }, 16, [`data-collapsed`, `class`])], 64));
} });
export {
  rt as t
};

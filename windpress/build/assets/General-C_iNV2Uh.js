import { D as e, E as t, Ht as n, On as r, Yt as i, Zn as a, _ as o, b as s, g as c, gn as l, k as u, mt as d, o as f, qt as p, rt as m, tr as h, v as g, vn as _, w as v } from "./runtime-core.esm-bundler-Twwq1XF8.js";
import { y } from "./runtime-dom.esm-bundler-Owfape5M.js";
import { t as b } from "./Tooltip-CPUUajce.js";
import { i as x } from "./log-Dd9BHdsz.js";
import { H as S, n as C, t as w } from "./Button-DbU2pTtV.js";
import { n as T } from "./useToast-Bh4s-mFR.js";
import { t as E } from "./Input-DpfLwGJa.js";
import { t as D } from "./Badge-amSaWZqG.js";
import { t as O } from "./api-DL2Um68W.js";
import { n as k, r as A, t as j } from "./settings-DsLgXECG.js";
import { t as M } from "./get-CeeabU_j.js";
import { t as N } from "./package-q3qef6Zq.js";
import { t as P } from "./package-DyXNJo-C.js";
import { t as F } from "./FormField-BHNa1m0b.js";
import { n as I, t as L } from "./PageCard-BsZd5kYv.js";
var R = x(`license`, () => {
  ...
  let u2 = S(), x2 = T(), O2 = R(), k2 = j(), M2 = A(), G2 = _(false), K = l({ key: `` });
  n(() => K.key, () => {
    G2.value = false;
  });
  function q() {
    G2.value = false, x2.add({ id: `license.change`, title: O2.license.key && O2.isActivated ? wp.i18n.__(`Deactivating license...`, `windprees`) : wp.i18n.__(`Activating license...`, `windpress`), description: O2.license.key && O2.isActivated ? wp.i18n.__(`Please wait while we deactivate your license key.`, `windpress`) : wp.i18n.__(`Please wait while we activate your license key.`, `windpress`), icon: `lucide:loader-circle`, close: false, duration: 0, color: `neutral`, ui: { icon: `animate-spin` } }), (O2.license.key && O2.isActivated ? O2.doDeactivate() : O2.doActivate(K.key)).then(() => {
      K.key = O2.license.key, x2.update(`license.change`, { title: wp.i18n.__(`License updated`, `windpress`), description: O2.isActivated ? wp.i18n.__(`Your license key has been activated.`, `windpress`) : wp.i18n.__(`Your license key has been deactivated.`, `windpress`), icon: `lucide:key-round`, color: `success`, duration: void 0, close: true, ui: { icon: void 0 } });
    }).catch((e2) => {
      x2.update(`license.change`, { title: wp.i18n.__(`License update failed`, `windpress`), description: e2 instanceof Error ? e2.message : wp.i18n.__(`An unknown error occurred`, `windpress`), icon: `lucide:key-round`, color: `error`, close: true, duration: void 0, ui: { icon: void 0 } }), G2.value = wp.i18n.__(`Invalid license key`, `windpress`);
    });
  }
  return m(() => {
    O2.doPull().then(() => {

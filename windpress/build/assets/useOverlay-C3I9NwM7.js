import { $n as e, D as t, On as n, Tn as r, ct as i, et as a, fn as o, gn as s, k as c, mt as l, qt as u, v as d, vn as f, xt as p, y as m, yn as h, z as g } from "./runtime-core.esm-bundler-CahM68iJ.js";
import { T as _, x as v } from "./Button-DpvhuBJO.js";
import { b as y, w as b } from "./dist-BKF-Yqo1.js";
import { A as x, F as S, V as C, k as w, z as T } from "./namespaced-BdQ8WLes.js";
import { b as E, f as D, g as O, h as k, p as A, y as j } from "./Tooltip-CZRNrufK.js";
var [M, N] = _(`DialogRoot`), P = c({ inheritAttrs: false, __name: `DialogRoot`, props: { open: { type: Boolean, required: false, default: void 0 }, defaultOpen: { type: Boolean, required: false, default: false }, modal: { type: Boolean, required: false, default: true } }, emits: [`update:open`], setup(e2, { emit: t2 }) {
  ...
  return S(f2), (e3, t3) => (l(), d(I, a({ ...r2, ...n(s2) }, { ref: n(c2), "trap-focus": n(o2).open.value, "disable-outside-pointer-events": true, onCloseAutoFocus: t3[0] || (t3[0] = (e4) => {
    var _a;
    e4.defaultPrevented || (e4.preventDefault(), (_a = n(o2).triggerElement.value) == null ? void 0 : _a.focus());
  ...
  return (e3, t3) => (l(), d(I, a({ ...r2, ...n(i2) }, { "trap-focus": false, "disable-outside-pointer-events": false, onCloseAutoFocus: t3[0] || (t3[0] = (e4) => {
    var _a;
    e4.defaultPrevented || (s2.value || ((_a = n(o2).triggerElement.value) == null ? void 0 : _a.focus()), e4.preventDefault()), s2.value = false, c2.value = false;
  }), onInteractOutside: t3[1] || (t3[1] = (e4) => {
    var _a;
    e4.defaultPrevented || (s2.value = true, e4.detail.originalEvent.type === `pointerdown` && (c2.value = true));
    let t4 = e4.target;
    ((_a = n(o2).triggerElement.value) == null ? void 0 : _a.contains(t4)) && e4.preventDefault(), e4.detail.originalEvent.type === `focusin` && c2.value && e4.preventDefault();
  ...
  let t2 = M();
  return T(true), j(), (e3, r2) => (l(), d(n(v), { as: e3.as, "as-child": e3.asChild, "data-state": n(t2).open.value ? `open` : `closed`, style: { "pointer-events": `auto` } }, { default: u(() => [p(e3.$slots, `default`)]), _: 3 }, 8, [`as`, `as-child`, `data-state`]));
  ...
  return (e3, o2) => {
    var _a;
    return ((_a = n(r2)) == null ? void 0 : _a.modal.value) ? (l(), d(n(k), { key: 0, present: e3.forceMount || n(r2).open.value }, { default: u(() => [t(V, a(e3.$attrs, { ref: n(i2), as: e3.as, "as-child": e3.asChild }), { default: u(() => [p(e3.$slots, `default`)]), _: 3 }, 16, [`as`, `as-child`])]), _: 3 }, 8, [`present`])) : m(`v-if`, true);
  };

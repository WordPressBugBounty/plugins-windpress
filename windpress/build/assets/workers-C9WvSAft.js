import { p as e } from "./toggleHighContrast-CKTWexjN.js";
function t(e2, t2) {
  var _a;
  let n2 = globalThis.MonacoEnvironment;
  if (n2 == null ? void 0 : n2.createTrustedTypesPolicy) try {
  ...
  try {
    return (_a = globalThis.trustedTypes) == null ? void 0 : _a.createPolicy(e2, t2);
  } catch (e3) {
    console.error(e3);
    return;
  }

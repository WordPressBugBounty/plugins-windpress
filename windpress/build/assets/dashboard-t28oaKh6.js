...
import { t as Xt, __tla as __tla_0 } from "./worker-BOuOBU9S.js";
Promise.all([
  (() => {
    try {
      return __tla_0;
  ...
  var Mi = {
    ...
    routes: [
      ...
      },
      {
        path: `/files`,
        name: `files`,
        component: () => X(() => import("./File-vDawmsxs.js").then(async (m2) => {
          await m2.__tla;
          return m2;
      ...
      },
      {
        ...
        component: () => X(() => import("./Wizard-MDPkAfeH.js").then(async (m2) => {
          await m2.__tla;
          return m2;
        }), [], import.meta.url),
        children: [

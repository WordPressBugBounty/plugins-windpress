...
function t() {
  return { __proto__: null, "./oxide_parser_bg.js": { __proto__: null, __wbg___wbindgen_string_get_914df97fcfa788f2: function(e2, t2) {
  ...
  }, __wbg___wbindgen_throw_81fc77679af83bc6: function(e2, t2) {
    throw Error(o(e2, t2));
  }, __wbg_from_741da0f916ab74aa: function(e2) {
    return n(Array.from(l(e2)));
  }, __wbg_get_4848e350b40afc16: function(e2, t2) {
    let r2 = l(e2)[t2 >>> 0];
    return n(r2);
  }, __wbg_isArray_db61795ad004c139: function(e2) {
    return Array.isArray(l(e2));
  }, __wbg_length_6e821edde497a532: function(e2) {
    return l(e2).length;
  }, __wbg_new_f3c9df4f38f3f798: function() {
    return n([]);
  }, __wbg_new_with_length_1c0fb14ea44d1c09: function(e2) {
    return n(Array(e2 >>> 0));
  }, __wbg_set_6c60b2e8ad0e9383: function(e2, t2, n2) {
    l(e2)[t2 >>> 0] = m(n2);
...
async function T(e2) {
  if (x !== void 0) return x;
  e2 !== void 0 && (Object.getPrototypeOf(e2) === Object.prototype ? { module_or_path: e2 } = e2 : console.warn(`using deprecated parameters for the initialization function; pass a single object instead`)), e2 === void 0 && (e2 = new URL(`` + new URL(`oxide_parser_bg-CJ8CgqJD.wasm`, import.meta.url).href, `` + import.meta.url));
  let n2 = t();

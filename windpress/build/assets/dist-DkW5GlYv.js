import { n as e } from "./chunk-DlkHe4MQ.js";
function t(e2) {
  var t2 = e2.length;
...
var c, l, u, d, f, p, m, h, g, _, v = e((() => {
  ...
  d[45] = 62, d[95] = 63, g = {}, g.read = function(e2, t2, n2, r2, i2) {
    ...
    var o2, s2, c2, l2 = a2 * 8 - i2 - 1, u2 = (1 << l2) - 1, d2 = u2 >> 1, f2 = i2 === 23 ? 2 ** -24 - 2 ** -77 : 0, p2 = r2 ? 0 : a2 - 1, m2 = r2 ? 1 : -1, h2 = t2 < 0 || t2 === 0 && 1 / t2 < 0 ? 1 : 0;
    for (t2 = Math.abs(t2), isNaN(t2) || t2 === 1 / 0 ? (s2 = isNaN(t2) ? 1 : 0, o2 = u2) : (o2 = Math.floor(Math.log(t2) / Math.LN2), t2 * (c2 = 2 ** -o2) < 1 && (o2--, c2 *= 2), o2 + d2 >= 1 ? t2 += f2 / c2 : t2 += f2 * 2 ** (1 - d2), t2 * c2 >= 2 && (o2++, c2 /= 2), o2 + d2 >= u2 ? (s2 = 0, o2 = u2) : o2 + d2 >= 1 ? (s2 = (t2 * c2 - 1) * 2 ** i2, o2 += d2) : (s2 = t2 * 2 ** (d2 - 1) * 2 ** i2, o2 = 0)); i2 >= 8; e2[n2 + p2] = s2 & 255, p2 += m2, s2 /= 256, i2 -= 8) ;
    ...
    function H(e3) {
      let t3 = ``, n3 = e3.length, r3 = e3[0] === `-` ? 1 : 0;
    ...
    function K(e3, t3, n3) {
      throw Math.floor(e3) === e3 ? t3 < 0 ? new B.ERR_BUFFER_OUT_OF_BOUNDS() : new B.ERR_OUT_OF_RANGE(n3 || `offset`, `>= ${n3 ? 1 : 0} and <= ${t3}`, e3) : (G(e3, n3), new B.ERR_OUT_OF_RANGE(n3 || `offset`, `an integer`, e3));
    }

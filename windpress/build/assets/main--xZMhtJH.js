...
import { n, t as r } from "./dist-CnmMLal_.js";
...
(async () => {
  ...
  (async () => {
    a = await n({
      themes: [
        e(() => import("./dark-plus-DFfF31dX.js").then(async (m2) => {
          await m2.__tla;
          return m2;
        }), [], import.meta.url),
        e(() => import("./light-plus-CPnO7ha4.js").then(async (m2) => {
          await m2.__tla;
          return m2;
        }), [], import.meta.url)
      ],
      langs: [
        e(() => import("./css-CfUXbuaZ.js").then(async (m2) => {
          await m2.__tla;
          return m2;
        }), [], import.meta.url)
      ],
      engine: r(e(() => import("./wasm-DB77wBvQ.js").then(async (m2) => {
        await m2.__tla;
        return m2;
      }), [], import.meta.url))
    });

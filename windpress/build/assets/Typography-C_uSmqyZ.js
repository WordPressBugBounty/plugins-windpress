import { D as e, E as t, Ht as n, J as r, Lt as i, On as a, Tn as o, Wt as s, Zn as c, _ as l, b as u, bt as d, ct as f, er as p, et as m, g as h, it as g, k as _, mt as v, o as y, qt as b, rt as x, tr as S, v as C, vn as w, xn as T, xt as E, y as D } from "./runtime-core.esm-bundler-C_RgxGrN.js";
import { c as O, l as k } from "./vue.runtime.esm-bundler-CFaGDlW9.js";
import { F as A, T as j, b as M, g as N, q as P, t as ee, v as F, x as I, y as L } from "./Button-C1y42oVo.js";
import { A as te, b as R, v as ne } from "./dist-BVQ2eZ4j.js";
import { i as re } from "./vue-router-duOdSZkK.js";
import { R as z, f as B } from "./namespaced-DqTNyUG4.js";
import { g as V, h as H, t as ie, v as U, y as W } from "./Tooltip-C9kG7ywk.js";
import { n as G, t as ae } from "./FluidCalculatorSlideover-D-zykvex.js";
import { n as K, t as oe } from "./Tree-QzPGLXzO.js";
import { t as se } from "./useOverlay-Db99omlQ.js";
import { n as ce } from "./useToast-CD4zU2hG.js";
import { t as q } from "./Badge-fqhIT_bK.js";
import { n as le } from "./index.browser-DL6dchOu.js";
import { n as ue, t as de } from "./DashboardNavbar-VPOKQJSH.js";
import { n as J, r as Y, t as X } from "./WizardTreeItem-B6588uiL.js";
...
var me = _({ __name: `TabsContent`, props: { value: { type: [String, Number], required: true }, forceMount: { type: Boolean, required: false }, asChild: { type: Boolean, required: false }, as: { type: null, required: false } }, setup(t2) {
  ...
  let s2 = n2, l2 = o2, f2 = i(), p2 = P(), g2 = M(`tabs`, s2), _2 = U(te(s2, `as`, `unmountOnHide`), l2), x2 = h(() => L({ extend: L(ve), ...p2.ui?.tabs || {} })({ color: s2.color, variant: s2.variant, size: s2.size, orientation: s2.orientation })), T2 = w([]);
  function O2(e2, t2) {
    T2.value[e2] = t2;
  }
  return r2({ triggersRef: T2 }), (r3, i2) => (v(), C(a(pe), m(a(_2), { "model-value": n2.modelValue, "default-value": n2.defaultValue, orientation: n2.orientation, "activation-mode": n2.activationMode, "data-slot": `root`, class: x2.value.root({ class: [a(g2)?.root, s2.class] }) }), { default: b(() => [e(a(ge), { "data-slot": `list`, class: c(x2.value.list({ class: a(g2)?.list })) }, { default: b(() => [e(a(he), { "data-slot": `indicator`, class: c(x2.value.indicator({ class: a(g2)?.indicator })) }, null, 8, [`class`]), E(r3.$slots, `list-leading`), (v(true), u(y, null, d(n2.items, (e2, n3) => (v(), C(a(_e), { key: n3, ref_for: true, ref: (e3) => O2(n3, e3), value: a(A)(e2, s2.valueKey) ?? String(n3), disabled: e2.disabled, "data-slot": `trigger`, class: c(x2.value.trigger({ class: [a(g2)?.trigger, e2.ui?.trigger] })) }, { default: b(() => [E(r3.$slots, `leading`, { item: e2, index: n3, ui: x2.value }, () => [e2.icon ? (v(), C(F, { key: 0, name: e2.icon, "data-slot": `leadingIcon`, class: c(x2.value.leadingIcon({ class: [a(g2)?.leadingIcon, e2.ui?.leadingIcon] })) }, null, 8, [`name`, `class`])) : e2.avatar ? (v(), C(N, m({ key: 1, size: e2.ui?.leadingAvatarSize || a(g2)?.leadingAvatarSize || x2.value.leadingAvatarSize() }, { ref_for: true }, e2.avatar, { "data-slot": `leadingAvatar`, class: x2.value.leadingAvatar({ class: [a(g2)?.leadingAvatar, e2.ui?.leadingAvatar] }) }), null, 16, [`size`, `class`])) : D(``, true)]), a(A)(e2, s2.labelKey) || f2.default ? (v(), u(`span`, { key: 0, "data-slot": `label`, class: c(x2.value.label({ class: [a(g2)?.label, e2.ui?.label] })) }, [E(r3.$slots, `default`, { item: e2, index: n3 }, () => [t(S(a(A)(e2, s2.labelKey)), 1)])], 2)) : D(``, true), E(r3.$slots, `trailing`, { item: e2, index: n3, ui: x2.value }, () => [e2.badge || e2.badge === 0 ? (v(), C(q, m({ key: 0, color: `neutral`, variant: `outline`, size: e2.ui?.trailingBadgeSize || a(g2)?.trailingBadgeSize || x2.value.trailingBadgeSize() }, { ref_for: true }, typeof e2.badge == `string` || typeof e2.badge == `number` ? { label: e2.badge } : e2.badge, { "data-slot": `trailingBadge`, class: x2.value.trailingBadge({ class: [a(g2)?.trailingBadge, e2.ui?.trailingBadge] }) }), null, 16, [`size`, `class`])) : D(``, true)])]), _: 2 }, 1032, [`value`, `disabled`, `class`]))), 128)), E(r3.$slots, `list-trailing`)]), _: 3 }, 8, [`class`]), n2.content ? (v(true), u(y, { key: 0 }, d(n2.items, (e2, n3) => (v(), C(a(me), { key: n3, value: a(A)(e2, s2.valueKey) ?? String(n3), "data-slot": `content`, class: c(x2.value.content({ class: [a(g2)?.content, e2.ui?.content, e2.class] })) }, { default: b(() => [E(r3.$slots, e2.slot || `content`, { item: e2, index: n3, ui: x2.value }, () => [t(S(e2.content), 1)])]), _: 2 }, 1032, [`value`, `class`]))), 128)) : D(``, true)]), _: 3 }, 16, [`model-value`, `default-value`, `orientation`, `activation-mode`, `class`]));

...
}(), b = { gamut_mapping: `css`, precision: 5, deltaE: `76`, verbose: true, warn: function(e4) {
...
var Te = 203, Ee = new N({ id: `xyz-abs-d65`, cssId: `--xyz-abs-d65`, name: `Absolute XYZ D65`, coords: { x: { refRange: [0, 9504.7], name: `Xa` }, y: { refRange: [0, 1e4], name: `Ya` }, z: { refRange: [0, 10888.3], name: `Za` } }, base: P, fromBase(e4) {
  ...
  return [0.43999999999999995 * a2 / (1 + Ie * a2) - Le, o2, s2];
}, toBase(e4) {
  let [t2, r2, i2] = e4, [a2, o2, s2] = n(n([(t2 + Le) / (0.43999999999999995 - Ie * (t2 + Le)), r2, i2], Ve).map(function(e5) {

...
import { n } from "./index.browser-Du-ZzVpY.js";
import { t as r } from "./get-CeeabU_j.js";
import { t as i } from "./preload-helper-CtT0-S4g.js";
import { n as a } from "./base64-oxnRbpjD.js";
import { t as o } from "./dist-CZ-jfRok.js";
let hn;
let __tla = (async () => {
  var s = [
    [
...
|$)`, `g`);
  ...
  function Pe({ comment: e2, type: t2, value: n2 }, r2, i2, a2) {
    ...
    let l2 = r2.indent || (r2.forceBlockIndent || ke(n2) ? `  ` : ``), u2 = o2 === `literal` ? true : o2 === `folded` || t2 === z.BLOCK_FOLDED ? false : t2 === z.BLOCK_LITERAL || !Ae(n2, c2, l2.length);
    if (!n2) return u2 ? `|
` : `>
`;
    let d2, f2;
...
${i2}${p2}`;
  ...
  var J = class extends xe {
    ...
    delete(e2) {
      let t2 = tt(e2);
      return typeof t2 == `number` && this.items.splice(t2, 1).length > 0;
    }
    get(e2, t2) {
      let n2 = tt(e2);
  ...
  async function pn(s2 = {}) {
    ...
    if (u2.tailwindcss_version === 4) {
      let { compile: e2, getCandidates: t2, optimize: n2, loadSource: r2 } = await i(async () => {
        let { compile: e3, getCandidates: t3, optimize: n3, loadSource: r3 } = await import("./tailwindcss-CRYP5HXK.js").then(async (m3) => {
          await m3.__tla;
          return m3;
        });
        return {
      ...
      let { build: e2, optimize: t2 } = await i(async () => {
        let { build: e3, optimize: t3 } = await import("./tailwindcss-v3-BR1S6hW_.js").then(async (m3) => {
          await m3.__tla;
          return m3;
        });
        return {

...
import { n as t } from "./es-C_BjvTxc.js";
import { t as n } from "./preload-helper-Cb81DA_d.js";
import { a as r, c as i, d as a, f as o, h as s, i as c, l, n as u, o as d, p as f, r as p, s as m, t as h, u as g } from "./toggleHighContrast-CKTWexjN.js";
import { n as _, t as v } from "./editor.worker-CizeyoWA.js";
import { __tla as __tla_0 } from "./monaco.contribution-g3sH6BoO.js";
import { __tla as __tla_1 } from "./monaco.contribution-ZvOQcqJJ.js";
Promise.all([
  (() => {
    try {
      return __tla_0;
  ...
  _({
    ...
    loader: () => n(() => import("./javascript-At4aEefn.js").then(async (m2) => {
      await m2.__tla;
      return m2;
  ...
  var y = e({
    ...
    editor: () => f,
    languages: () => s
  }), b = `` + new URL(`css.worker-BtW9exzf.js`, import.meta.url).href, x = `` + new URL(`ts.worker-DI5g4t5j.js`, import.meta.url).href;
  function S(e2) {

...
(async () => {
  ...
  (async () => {
    ...
    const { brxIframe } = await __vitePreload(async () => {
      const { brxIframe: brxIframe2 } = await import("../constant-DIw596pF.js");
      return {
        brxIframe: brxIframe2
      };
    }, true ? [] : void 0, import.meta.url);
    logger("Loading modules...");
    await __vitePreload(() => import("../main-x6KbVhLJ.js"), true ? __vite__mapDeps([0]) : void 0, import.meta.url);
    if (window.bricksData.version.startsWith("1")) {
      await __vitePreload(() => import("../main-1.x-CSm0hDNP.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? __vite__mapDeps([1]) : void 0, import.meta.url);
    } else {
      await __vitePreload(() => import("../main-CAi5So-t.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? __vite__mapDeps([1]) : void 0, import.meta.url);
    }
    await __vitePreload(() => import("../main-CkCUzzFN.js"), true ? [] : void 0, import.meta.url);
    await __vitePreload(() => import("../main-BW2Gxciv.js"), true ? [] : void 0, import.meta.url);
    if (Number((_d = brxIframe.contentWindow.windpress) == null ? void 0 : _d._tailwindcss_version) === 4) {
      await __vitePreload(() => import("../main-C3s7ZMFL.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../main-DUhS-GkY.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../main-DEiEriLO.js").then(async (m) => {
        await m.__tla;
        return m;

...
(async () => {
  ...
  (async () => {
    ...
    await __vitePreload(() => import("../main-BFO-j3jr.js").then(async (m) => {
      await m.__tla;
      return m;
    ...
    if (Number((_c = bdeIframe.contentWindow.windpress) == null ? void 0 : _c._tailwindcss_version) === 4) {
      await __vitePreload(() => import("../main-BSHSQ_Yr.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../main-CpUXaU1r.js").then(async (m) => {
        await m.__tla;
        return m;

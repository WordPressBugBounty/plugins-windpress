...
(async () => {
  ...
  (async () => {
    ...
    const { brxIframe } = await __vitePreload(async () => {
      const { brxIframe: brxIframe2 } = await import("../constant-Cbl61Ovh.js");
      return {
        brxIframe: brxIframe2
      };
    }, true ? [] : void 0, import.meta.url);
    logger("Loading modules...");
    await __vitePreload(() => import("../main-B2Lpkaig.js"), true ? __vite__mapDeps([0]) : void 0, import.meta.url);
    if (window.bricksData.version.startsWith("1")) {
      await __vitePreload(() => import("../main-1.x-ARM1MRY5.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? __vite__mapDeps([1]) : void 0, import.meta.url);
    } else {
      await __vitePreload(() => import("../main-DgkeRMIy.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? __vite__mapDeps([1]) : void 0, import.meta.url);
    }
    await __vitePreload(() => import("../main-X6zTsBxQ.js"), true ? [] : void 0, import.meta.url);
    await __vitePreload(() => import("../main-D95LVTzA.js"), true ? [] : void 0, import.meta.url);
    if (Number((_d = brxIframe.contentWindow.windpress) == null ? void 0 : _d._tailwindcss_version) === 4) {
      await __vitePreload(() => import("../main-DR2ZwiEM.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../main-Ctr-Jf_H.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../main-8NMq8UNF.js").then(async (m) => {
        await m.__tla;
        return m;

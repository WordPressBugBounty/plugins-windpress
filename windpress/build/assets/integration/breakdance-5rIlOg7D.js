...
(async () => {
  ...
  (async () => {
    ...
    await __vitePreload(() => import("../main-DSmPRJNP.js").then(async (m) => {
      await m.__tla;
      return m;
    ...
    if (Number((_c = bdeIframe.contentWindow.windpress) == null ? void 0 : _c._tailwindcss_version) === 4) {
      await __vitePreload(() => import("../main-akWhxuG8.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../main-RgIQ8P2r.js").then(async (m) => {
        await m.__tla;
        return m;

...
(async () => {
  t(`Loading...`), (async () => {
    ...
    t(`Loading modules...`), await e(() => import("../main-DOsqKfuG2.js").then(async (m) => {
      await m.__tla;
      return m;
      ...
      await m.__tla;
      return m;
    }), [], import.meta.url), await e(() => import("../main-BsALIQKe.js").then(async (m) => {
      await m.__tla;
      return m;
    }), __vite__mapDeps([0]), import.meta.url), await e(() => import("../main-B3Usor6i.js").then(async (m) => {
      await m.__tla;
      return m;

...
(async () => {
  ...
  (async () => {
    ...
    await __vitePreload(() => import("../main-CBS1AsjV.js"), true ? __vite__mapDeps([0]) : void 0, import.meta.url);
    ...
    if (Number((_b = uniIframe.contentWindow.windpress) == null ? void 0 : _b._tailwindcss_version) === 4) {
      await __vitePreload(() => import("../main-BtxOS6zZ.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../main-io-nS1_Z.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../main-TOOyQsJW.js").then(async (m) => {
        await m.__tla;
        return m;

...
(async () => {
  ...
  (async () => {
    ...
    await __vitePreload(() => import("../main-DTIjiEIE.js"), true ? __vite__mapDeps([0]) : void 0, import.meta.url);
    ...
    if (Number((_b = uniIframe.contentWindow.windpress) == null ? void 0 : _b._tailwindcss_version) === 4) {
      await __vitePreload(() => import("../main-Br4UpfWg.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../main-BSnqjgVg.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../main-VI8QTAhj.js").then(async (m) => {
        await m.__tla;
        return m;

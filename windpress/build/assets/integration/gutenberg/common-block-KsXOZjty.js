...
import { n as e } from "../../index.browser-DL6dchOu.js";
import { t } from "../../debounce-2SSeCGpK.js";
import { t as n } from "../../isEqual-C0zJMsQ0.js";
...
import { p as o } from "../../toggleHighContrast-CKTWexjN.js";
import { n as s, t as c } from "../../editor.worker-CizeyoWA.js";
(async () => {
  ...
  function h({ attributes: e2 = {}, onChange: n2 }) {
    ...
    let d2 = wp.element.useCallback((e3, t2) => {
      ...
      (e3 == null ? void 0 : e3.url) && (t2.href = e3.url, e3.opensInNewTab ? (t2.target = `_blank`, t2.rel = `noopener noreferrer`) : (delete t2.target, delete t2.rel)), c2.current(t2), s2(false);
  ...
  s({
    ...
    loader: () => r(() => import("../../html-DXeHj_4O.js").then(async (m2) => {
      await m2.__tla;
      return m2;
    }), __vite__mapDeps([0]), import.meta.url)
  });
  var v = `` + new URL(`../../html.worker-Dg1SpGQ4.js`, import.meta.url).href;
  ...
  function w({ attributes: e2, setAttributes: t2, clientId: n2 }) {
    ...
    }, []), T2 = wp.element.useRef(r2), E2 = wp.element.useRef(o2 == null ? void 0 : o2.id);
    wp.element.useEffect(() => {
      let t3 = o2 == null ? void 0 : o2.id;
      ...
      onImport: (e3) => {
        ...
        try {
          ...
          if (u2) if (l2.length > 0 && a2(l2[0].name, u2)) p2 = u2, f2 = void 0;
            ...
            l2.forEach((t3) => {
              var _a;
              t3.name === `windpress/common-block` && !e4.has((_a = t3.attributes) == null ? void 0 : _a.tagName) && (t3.attributes.align = `full`);
            });
          }

...
(async () => {
  ...
  function A() {
    let e2 = document.querySelector(`iframe[name="editor-canvas"]`), t2 = (e2 == null ? void 0 : e2.contentWindow) || e2;
    return (e2 == null ? void 0 : e2.contentDocument) || (t2 == null ? void 0 : t2.document);
  }
  function j(e2) {
    let t2 = A();
    if (!t2) return;

...
import { n as e } from "../../index.browser-Du-ZzVpY.js";
import { t } from "../../debounce-yqYF8y1Y.js";
import { t as n } from "../../isEqual-DXB6Fb6V.js";
import { t as r } from "../../preload-helper-CtT0-S4g.js";
import { t as i } from "../../windpress-D9qoLY9s.js";
import { t as a } from "../../useDarkMode-751yatJ3.js";
import { p as o } from "../../toggleHighContrast-CaKI0Gua.js";
import { n as s, t as c } from "../../editor.worker-Dgp1eTza.js";
(async () => {
  ...
  s({
    ...
    loader: () => r(() => import("../../html-BtuNdz6_.js").then(async (m2) => {
      await m2.__tla;
      return m2;
    }), __vite__mapDeps([0]), import.meta.url)
  });
  var v = `` + new URL(`../../html.worker-QLkqJfke.js`, import.meta.url).href;
    ...
    let D2 = wp.element.useMemo(() => {
      ...
      try {
        let t3 = {
          ...
          attributes: e2,
          innerBlocks: y2 || []
        }, n3 = window.windpressCommonBlock.blocks2html([
          t3
        ]);
        f2(n3), l2(true);
      } catch (e3) {
  ...
  function T(e2, t2) {
    return e2.clientId === t2.clientId && n(e2.attributes, t2.attributes);
  }

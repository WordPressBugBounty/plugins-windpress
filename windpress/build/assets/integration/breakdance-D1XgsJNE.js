...
(async () => {
  ...
  (async () => {
    ...
    await __vitePreload(() => import("../main-D80WAHWE.js").then(async (m) => {
      await m.__tla;
      return m;
    ...
    if (Number((_c = bdeIframe.contentWindow.windpress) == null ? void 0 : _c._tailwindcss_version) === 4) {
      await __vitePreload(() => import("../main-CXlbB3wi.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../main-Dz10Prtn.js").then(async (m) => {
        await m.__tla;
        return m;

...
(async () => {
  t(`Loading...`), (async () => {
    ...
    t(`Loading modules...`), await e(() => import("../../main-C6nin6dY2.js").then(async (m) => {
      ...
      await m.__tla;
      return m;
    }), [], import.meta.url), Number(n.contentWindow.windpress?._tailwindcss_version) === 4 && (await e(() => import("../../main-WEI0UgFw2.js").then(async (m) => {
      await m.__tla;
      return m;
    }), [], import.meta.url), await e(() => import("../../main-Imc5OHPR.js").then(async (m) => {
      await m.__tla;
      return m;

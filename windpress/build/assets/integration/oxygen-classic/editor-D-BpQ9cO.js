...
(async () => {
  ...
  (async () => {
    ...
    await __vitePreload(() => import("../../main-C_aq8kCp.js"), true ? __vite__mapDeps([0]) : void 0, import.meta.url);
    await __vitePreload(() => import("../../main-CR_wD4J7.js").then(async (m) => {
      await m.__tla;
      return m;
    ...
    if (Number((_a = oxyIframe.contentWindow.windpress) == null ? void 0 : _a._tailwindcss_version) === 4) {
      await __vitePreload(() => import("../../main-C3txeulW.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../../main-DoKjDlqt.js").then(async (m) => {
        await m.__tla;
        return m;

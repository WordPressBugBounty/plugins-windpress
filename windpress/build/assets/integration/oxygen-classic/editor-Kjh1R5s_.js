...
(async () => {
  ...
  (async () => {
    ...
    await __vitePreload(() => import("../../main-Ci68wwt5.js"), true ? __vite__mapDeps([0]) : void 0, import.meta.url);
    await __vitePreload(() => import("../../main-B1mZ_t12.js").then(async (m) => {
      await m.__tla;
      return m;
    ...
    if (Number((_a = oxyIframe.contentWindow.windpress) == null ? void 0 : _a._tailwindcss_version) === 4) {
      await __vitePreload(() => import("../../main-nJ0Xzs0x.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../../main-D7nMnpl2.js").then(async (m) => {
        await m.__tla;
        return m;

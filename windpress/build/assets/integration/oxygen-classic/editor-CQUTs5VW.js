...
(async () => {
  ...
  (async () => {
    ...
    await __vitePreload(() => import("../../main-Bp03sy_C.js"), true ? __vite__mapDeps([0]) : void 0, import.meta.url);
    await __vitePreload(() => import("../../main-psslTP8f.js").then(async (m) => {
      await m.__tla;
      return m;
    ...
    if (Number((_a = oxyIframe.contentWindow.windpress) == null ? void 0 : _a._tailwindcss_version) === 4) {
      await __vitePreload(() => import("../../main-DXGIWTGP.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../../main-D190XHqH.js").then(async (m) => {
        await m.__tla;
        return m;

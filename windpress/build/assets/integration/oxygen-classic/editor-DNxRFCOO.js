...
(async () => {
  ...
  (async () => {
    ...
    await __vitePreload(() => import("../../main-HFzKi_gA.js"), true ? __vite__mapDeps([0]) : void 0, import.meta.url);
    await __vitePreload(() => import("../../main-CHgzdkVM.js").then(async (m) => {
      await m.__tla;
      return m;
    ...
    if (Number((_a = oxyIframe.contentWindow.windpress) == null ? void 0 : _a._tailwindcss_version) === 4) {
      await __vitePreload(() => import("../../main-C-3DuDnq.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../../main-Dg32MSHh.js").then(async (m) => {
        await m.__tla;
        return m;

...
(async () => {
  t(`Loading...`), (async () => {
    ...
    t(`Loading modules...`), await e(() => import("../main-iQs_e4Ol.js").then(async (m) => {
      await m.__tla;
      return m;
    }), __vite__mapDeps([0]), import.meta.url), await e(() => import("../main-CLvNZTGX.js").then(async (m) => {
      await m.__tla;
      return m;
    }), [], import.meta.url), Number(n.contentWindow.windpress?._tailwindcss_version) === 4 && (await e(() => import("../main-CduLdK_j.js").then(async (m) => {
      await m.__tla;
      return m;
    }), [], import.meta.url), await e(() => import("../main-C7ZVPE9-.js").then(async (m) => {
      await m.__tla;
      return m;
    }), [], import.meta.url), await e(() => import("../main-3RCaMJkc.js").then(async (m) => {
      await m.__tla;
      return m;

...
(async () => {
  t(`Loading...`), (async () => {
    ...
    t(`Loading modules...`), await e(() => import("../observer-CiuVMV3b.js").then(async (m) => {
      await m.__tla;
      return m;
    }), [], import.meta.url), await e(() => import("../classname-to-css-BogTFZc1.js").then(async (m) => {
      await m.__tla;
      return m;
    }), __vite__mapDeps([0]), import.meta.url), await e(() => import("../element-attribute-panel-CxfUe-kF.js").then(async (m) => {
      await m.__tla;
      return m;
    }), [], import.meta.url);
  })();

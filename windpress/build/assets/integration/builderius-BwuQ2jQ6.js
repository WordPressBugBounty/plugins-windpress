...
(async () => {
  ...
  (async () => {
    ...
    await __vitePreload(() => import("../main-X4Qac1K4.js"), true ? __vite__mapDeps([0]) : void 0, import.meta.url);
    ...
    if (Number((_b = uniIframe.contentWindow.windpress) == null ? void 0 : _b._tailwindcss_version) === 4) {
      await __vitePreload(() => import("../main-Gi21uKqG.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../main-D1VDLpQp.js").then(async (m) => {
        await m.__tla;
        return m;
      }), true ? [] : void 0, import.meta.url);
      await __vitePreload(() => import("../main-DrEcXPhN.js").then(async (m) => {
        await m.__tla;
        return m;

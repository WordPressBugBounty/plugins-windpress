...
(async () => {
  t(`Loading...`), (async () => {
    ...
    t(`Loading modules...`), await e(() => import("../main-CZMjkP6j.js").then(async (m) => {
      await m.__tla;
      return m;
    }), __vite__mapDeps([0]), import.meta.url), await e(() => import("../main-Bk4FxGJh.js").then(async (m) => {
      await m.__tla;
      return m;
    }), [], import.meta.url), Number(n.contentWindow.windpress?._tailwindcss_version) === 4 && (await e(() => import("../main-D4bKPzvs.js").then(async (m) => {
      await m.__tla;
      return m;
    }), [], import.meta.url), await e(() => import("../main-DtwsoP_V.js").then(async (m) => {
      await m.__tla;
      return m;

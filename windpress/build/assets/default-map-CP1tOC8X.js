...
import { n as r } from "./lib-SBX7jFNp.js";
import { t as i } from "./path-browserify-CWnXpqR1.js";
import { n as a, r as o, t as s, u as c } from "./cssesc-BlGGmlzH.js";
...
function v(e3, t2) {
  ...
  for (let n2 of t2) if ((_a3 = _[n2]) == null ? void 0 : _a3.call(_, e3)) return n2;
  return null;
}
var y = /^url\(.*\)$/;
function b(e3) {
...
function Ye(e3, t2) {
  let n2 = (t2 == null ? void 0 : t2.from) ? { file: t2.from, code: e3 } : null;
  e3[0] === `\uFEFF` && (e3 = ` ` + e3.slice(1));
...
var rt = (_a2 = class {
  ...
  getOptions(e3) {
    var _a3;
    return e3 = et(__privateMethod(this, _rt_instances, e_fn).call(this, e3)), ((_a3 = this.values.get(e3)) == null ? void 0 : _a3.options) ?? 0;
  }
  entries() {
  ...
  for (let o2 = 0; o2 < e3.length; o2++) {
    ...
    switch (s2) {
      ...
      case st: {
        ...
        if (i2.length > 0) {
          let t3 = N(i2);
          e4 == null ? void 0 : e4.nodes.push(t3), i2 = ``;
        }
...
`, t2) {
        n2 += s2.length;
        let t3 = n2;
        n2 += e4.property.length, n2 += 2, n2 += ((_a3 = e4.value) == null ? void 0 : _a3.length) ?? 0, e4.important && (n2 += 11);
        let i3 = n2;
  ...
  for (let [t3, n3] of u2) {
    ...
    }
    {
      ...
      if (e4 !== -1) {
        ...
        let e5 = s2 === null || ((_a3 = r3.modifier) == null ? void 0 : _a3.kind) === `arbitrary` ? null : `${n3}/${s2}`;
...
var dn = `0,0.5,1,1.5,2,2.5,3,3.5,4,5,6,7,8,9,10,11,12,14,16,20,24,28,32,36,40,44,48,52,56,60,64,72,80,96`.split(`,`), fn = class {
  ...
  getCompletions(e3) {
    var _a3, _b;
    return this.has(e3, `static`) ? ((_a3 = this.completions.get(e3)) == null ? void 0 : _a3()) ?? [{ supportsNegative: false, values: [], modifiers: [] }] : ((_b = this.completions.get(e3)) == null ? void 0 : _b()) ?? [];
  }
  suggest(e3, t2) {
    let n2 = this.completions.get(e3);
    n2 ? this.completions.set(e3, () => [...n2 == null ? void 0 : n2(), ...t2 == null ? void 0 : t2()]) : this.completions.set(e3, t2);
  }
  keys(e3) {
    let t2 = [];
...
function hn(e3) {
  ...
  } }), r2(`bg-repeat`, [[`background-repeat`, `repeat`]]), r2(`bg-no-repeat`, [[`background-repeat`, `no-repeat`]]), r2(`bg-repeat-x`, [[`background-repeat`, `repeat-x`]]), r2(`bg-repeat-y`, [[`background-repeat`, `repeat-y`]]), r2(`bg-repeat-round`, [[`background-repeat`, `round`]]), r2(`bg-repeat-space`, [[`background-repeat`, `space`]]), r2(`bg-none`, [[`background-image`, `none`]]);
  {
    let e4 = function(e5) {
      let t3 = `in oklab`;
      if ((e5 == null ? void 0 : e5.kind) === `named`) switch (e5.value) {
        case `longer`:
        case `shorter`:
        case `increasing`:
        case `decreasing`:
      ...
      else (e5 == null ? void 0 : e5.kind) === `arbitrary` && (t3 = e5.value);
      return t3;
      ...
      return (n3) => {
        var _a3;
        if (((_a3 = n3.value) == null ? void 0 : _a3.kind) === `arbitrary`) {
          if (n3.modifier) return;
          let e5 = n3.value.value;
...
`);
      ...
      if (L([r3], (e4, t4) => {
        let r4 = t4.parent;
        if ((r4 == null ? void 0 : r4.kind) !== `rule` && (r4 == null ? void 0 : r4.kind) !== `at-rule` || e4.kind !== `declaration` || !e4.value) return;
...
var ir = /^(?<value>[-+]?(?:\d*\.)?\d+)(?<unit>[a-z]+|%)?$/i, ar = new M((e3) => {
  ...
  let t2 = ir.exec(e3);
  if (!t2) return null;
  let n2 = (_a3 = t2.groups) == null ? void 0 : _a3.value;
...
function or(e3, t2 = null) {
  ...
  return L(r2, { exit(e4) {
    if (e4.kind === `word` && e4.value !== `0`) {
      ...
      if (r3 === `*` && ((t3 == null ? void 0 : t3[0]) === 0 && (t3 == null ? void 0 : t3[1]) === null || (i2 == null ? void 0 : i2[0]) === 0 && (i2 == null ? void 0 : i2[1]) === null)) return n2 = true, I.ReplaceSkip(N(`0`));
...
function mr(e3, t2) {
  ...
  if (t2 & 2) {
    if (e3.property in fr) {
      let t3 = g(e3.value, ` `);
      return (_a3 = fr[e3.property][t3.length]) == null ? void 0 : _a3.map(([n2, r2]) => V(n2, t3[r2], e3.important));
    }
    if (e3.property in pr) return (_b = pr[e3.property]) == null ? void 0 : _b.map((t3) => V(t3, e3.value, e3.important));
  }
  if (e3.property in dr) {
    let t3 = g(e3.value, ` `);
    return (_c = dr[e3.property][t3.length]) == null ? void 0 : _c.map(([n2, r2]) => V(n2, t3[r2], e3.important));
  }
  return null;
}
function hr(e3) {
...
function Gr(e3, t2) {
  let n2 = 0;
  return (t2 == null ? void 0 : t2.collapse) && (n2 |= 1), (t2 == null ? void 0 : t2.logicalToPhysical) && (n2 |= 2), Hr(e3, t2).storage[Ur].get((t2 == null ? void 0 : t2.rem) ?? null).get(n2);
}
...
function Jr(e3, t2, n2) {
  let r2 = 0;
  return (n2 == null ? void 0 : n2.collapse) && (r2 |= 1), Hr(e3).storage[Kr].get(t2).get(r2);
}
...
function Xr(e3, t2) {
  ...
  function o2(t3) {
    ...
    if (o3.some((e4) => e4.has(`line-height`))) {
      ...
      if (e4.length > 0) {
        ...
        for (let a5 of o3) if (a5.has(`line-height`)) for (let o4 of a5.get(`line-height`)) {
          ...
          r4.add(o4);
          let a6 = ((_a3 = n2.storage[_i]) == null ? void 0 : _a3.get(o4)) ?? null;
          if (a6 !== null) if (O(a6)) {
            t4.add(a6);
    ...
    let s2 = new M((e4) => {
      ...
      for (let a4 of X(n2, e4)) if (!(a4.kind !== `functional` || ((_a4 = a4.value) == null ? void 0 : _a4.kind) !== `named`)) {
...
function si(e3, t2) {
  ...
  if (e3.kind === `arbitrary`) {
    let [t3, r2] = n2(e3.value, e3.modifier === null ? 1 : 0);
    t3 !== e3.value && (e3.value = t3, r2 !== null && (e3.modifier = r2));
  } else if (e3.kind === `functional` && ((_a3 = e3.value) == null ? void 0 : _a3.kind) === `arbitrary`) {
    let [t3, r2] = n2(e3.value.value, e3.modifier === null ? 1 : 0);
...
function ci(e3, t2) {
  ...
  } else if (e4.kind === `functional` && ((_a3 = e4.value) == null ? void 0 : _a3.kind) === `arbitrary`) {
...
function li(e3, t2) {
  var _a3;
  return e3.kind === `arbitrary` ? e3.value = ui(e3.value, t2.designSystem) : e3.kind === `functional` && ((_a3 = e3.value) == null ? void 0 : _a3.kind) === `arbitrary` && (e3.value.value = ui(e3.value.value, t2.designSystem)), e3;
}
function ui(e3, t2) {
...
function vi(e3, t2) {
  ...
  if (n2 === void 0) return null;
  n2 = or(n2, (t2 == null ? void 0 : t2.rem) ?? null);
  let r2 = ar.get(n2);
  if (!r2) return null;
  let [i2, a2] = r2;
  return new M((e4) => {
    if (i2 === 0) return null;
    let n3 = ar.get(or(e4, (t2 == null ? void 0 : t2.rem) ?? null));
    if (!n3) return null;
    let [r3, o2] = n3;
...
function yi(e3, t2) {
  var _a3;
  if (e3.kind !== `arbitrary` && !(e3.kind === `functional` && ((_a3 = e3.value) == null ? void 0 : _a3.kind) === `arbitrary`)) return e3;
  ...
  function* s2(e4, a3) {
    ...
    if (!(o3.length > 1)) {
      ...
      if (o3.length === 1) for (let e5 of X(n2, o3[0])) yield e5;
        ...
        let e5 = a3.kind === `arbitrary` ? a3.value : ((_a4 = a3.value) == null ? void 0 : _a4.value) ?? null;
        if (e5 === null) return;
        if (t2.signatureOptions.rem !== null && a3.kind === `functional` && ((_b = a3.value) == null ? void 0 : _b.kind) === `arbitrary`) {
          let t3 = ((_c = n2.storage[_i]) == null ? void 0 : _c.get(e5)) ?? null;
          t3 !== null && O(t3) && (yield Object.assign({}, a3, { value: { kind: `named`, value: t3, fraction: null } }));
        }
        let r3 = ((_d = n2.storage[_i]) == null ? void 0 : _d.get(e5)) ?? null, i3 = ``;
...
function bi(e3, t2, n2) {
  var _a3;
  let r2 = null;
  if (t2.kind === `functional` && ((_a3 = t2.value) == null ? void 0 : _a3.kind) === `arbitrary` && t2.value.value.includes(`var(--`) ? r2 = t2.value.value : t2.kind === `arbitrary` && t2.value.includes(`var(--`) && (r2 = t2.value), r2 === null) return true;
...
function xi(e3, t2) {
  var _a3;
  if (e3.kind !== `functional` || ((_a3 = e3.value) == null ? void 0 : _a3.kind) !== `named`) return e3;
  let n2 = t2.designSystem, r2 = n2.storage[Bi].get(t2.signatureOptions), i2 = n2.storage[Z].get(t2.signatureOptions), a2 = n2.printCandidate(e3), o2 = i2.get(a2);
  if (typeof o2 != `string`) return e3;
  for (let t3 of s2(o2, e3)) {
...
function Ti(e3, t2) {
  ...
  if (e3.kind === `functional` && ((_a3 = e3.value) == null ? void 0 : _a3.kind) === `arbitrary` && e3.value.dataType !== null) {
...
function Ei(e3, t2) {
  var _a3;
  if (e3.kind !== `functional` || ((_a3 = e3.value) == null ? void 0 : _a3.kind) !== `arbitrary`) return e3;
...
function Di(e3) {
  var _a3, _b, _c;
  let t2 = hi(e3);
  for (let [e4] of t2) if (e4.kind === `functional` && e4.root === `data` && ((_a3 = e4.value) == null ? void 0 : _a3.kind) === `arbitrary` && !e4.value.value.includes(`=`)) e4.value = { kind: `named`, value: e4.value.value };
  else if (e4.kind === `functional` && e4.root === `aria` && ((_b = e4.value) == null ? void 0 : _b.kind) === `arbitrary` && (e4.value.value.endsWith(`=true`) || e4.value.value.endsWith(`="true"`) || e4.value.value.endsWith(`='true'`))) {
  ...
  } else e4.kind === `functional` && e4.root === `supports` && ((_c = e4.value) == null ? void 0 : _c.kind) === `arbitrary` && /^[a-z-][a-z0-9-]*$/i.test(e4.value.value) && (e4.value = { kind: `named`, value: e4.value.value });
  return e3;
}
function* Oi(e3, t2 = ((_b) => (_b = e3.value) == null ? void 0 : _b.value)() ?? ``, n2 = /* @__PURE__ */ new Set()) {
  if (n2.has(t2)) return;
...
function Pi(e3, t2, n2) {
  ...
  return L(t2, { enter(t3, i2) {
    ...
    if (t3.kind === `declaration`) {
      if (t3.value === void 0 || t3.property === `--tw-sort` || t3.property.startsWith(`--tw-`) && (((_a3 = i2.parent) == null ? void 0 : _a3.nodes) ?? []).some((e4) => e4.kind === `declaration` && t3.value === e4.value && t3.important === e4.important && !e4.property.startsWith(`--tw-`))) return I.Replace([]);
      if (n2.features & 1) {
      ...
      return ga(n2, e3), L(n2, (e4) => {
        if (e4.kind === `at-rule` && e4.params.includes(` `)) e4.params = e4.params.replaceAll(` `, ``);
          ...
          L(t3, (e5) => {
            ...
            } else e5.kind === `function` && e5.value[0] === `:` && ((_a3 = e5.nodes[0]) == null ? void 0 : _a3.kind) === `selector` && ((_b = e5.nodes[0]) == null ? void 0 : _b.value[0]) === `:` && (n3 = true, e5.nodes.unshift({ kind: `selector`, value: `*` }));
...
function $i(e3, t2) {
  ...
  for (let e4 of n2) {
    let t3 = (_a3 = r2.get(e4)) == null ? void 0 : _a3.candidate;
    t3 && i2.set(t3, i2.get(t3) ?? a2++);
  }
  return t2.map((e4) => [e4, i2.get(e4) ?? null]);
}
var ea = new RegExp("^@?[a-z0-9][a-zA-Z0-9_-]*(?<![_-])$"), ta = class {
  constructor() {
  ...
  kind(e3) {
    var _a3;
    return (_a3 = this.variants.get(e3)) == null ? void 0 : _a3.kind;
  }
  compoundsWith(e3, t2) {
  ...
  getCompletions(e3) {
    var _a3;
    return ((_a3 = this.completions.get(e3)) == null ? void 0 : _a3()) ?? [];
  }
  compare(e3, t2) {
    if (e3 === t2) return 0;
    if (e3 === null) return -1;
...
function sa(e3, t2) {
  ...
  let u2 = { theme: e3, utilities: n2, variants: r2, invalidCandidates: /* @__PURE__ */ new Set(), important: false, candidatesToCss: l2, candidatesToAst: c2, getClassOrder(e4) {
    ...
    let a3 = e3.resolve(null, [t3], n3 ? 1 : 0) ?? void 0;
...
function fa(e3) {
  var _a3;
  let t2 = ((_a3 = e3.options) == null ? void 0 : _a3.types) ?? [];
  ...
  for (let e4 of c2) `nodes` in e4 && L(e4.nodes, (e5) => {
    ...
    for (let [e6, t3] of n3.entries()) e6 % 2 == 0 && (r3[t3] = i3), i3 += t3.length;
    {
      let n4 = la(Object.keys(r3), t2, { respectImportant: false, onInvalidCandidate: (e6) => {
        ...
        var _a3;
        let t3 = (_a3 = n4.nodeSorting.get(e6)) == null ? void 0 : _a3.candidate, a4 = t3 ? r3[t3] : void 0;
  ...
  return function(r2, i2) {
    ...
    let s2 = (() => {
      ...
      if (typeof s3 == `object` && s3 && !Array.isArray(s3)) {
        ...
        for (let t3 in a3) t3 !== `__CSS_VALUES__` && (((_a3 = s3 == null ? void 0 : s3.__CSS_VALUES__) == null ? void 0 : _a3[t3]) & 4 && Ta(e4, t3.split(`-`)) !== void 0 || (e4[et(t3)] = a3[t3]));
        return e4;
      }
...
function Oa({ designSystem: e3, ast: t2, resolvedConfig: n2, featuresRef: r2, referenceMode: i2, src: a2 }) {
  let o2 = { addBase(n3) {
    ...
    function i3(e4, t4, r4) {
      return Aa(n3(e4, { modifier: (t4 == null ? void 0 : t4.value) ?? null }), r4);
    }
    try {
    ...
    e3.variants.group(() => {
      ...
      let n4 = e4.value ? e4.value.value : `DEFAULT`, i4 = t4.value ? t4.value.value : `DEFAULT`, o3 = ((r3 == null ? void 0 : r3.values) && Object.hasOwn(r3.values, n4) ? r3.values[n4] : void 0) ?? n4, s2 = ((r3 == null ? void 0 : r3.values) && Object.hasOwn(r3.values, i4) ? r3.values[i4] : void 0) ?? i4;
      if (r3 && typeof r3.sort == `function`) return r3.sort({ value: o3, modifier: ((_a3 = e4.modifier) == null ? void 0 : _a3.value) ?? null }, { value: s2, modifier: ((_b = t4.modifier) == null ? void 0 : _b.value) ?? null });
      let c2 = a3.indexOf(n4), l2 = a3.indexOf(i4);
      return c2 = c2 === -1 ? a3.length : c2, l2 = l2 === -1 ? a3.length : l2, c2 === l2 ? o3 < s2 ? -1 : 1 : c2 - l2;
    }), e3.variants.suggest(t3, () => Object.keys((r3 == null ? void 0 : r3.values) ?? {}).filter((e4) => e4 !== `DEFAULT`));
  }, addUtilities(n3) {
    ...
    for (let [a3, o3] of Object.entries(t3)) {
      let t4 = function({ negative: t5 }) {
        return (s2) => {
          var _a3, _b;
          if (((_a3 = s2.value) == null ? void 0 : _a3.kind) === `arbitrary` && i3.length > 0 && !i3.includes(`any`) && (s2.value.dataType && !i3.includes(s2.value.dataType) || !s2.value.dataType && !v(s2.value.value, i3))) return;
          let c2 = i3.includes(`color`), l2 = null, u2 = false;
          {
            let e4 = (n3 == null ? void 0 : n3.values) ?? {};
            c2 && (e4 = Object.assign({ inherit: `inherit`, transparent: `transparent`, current: `currentcolor` }, e4)), s2.value ? s2.value.kind === `arbitrary` ? l2 = s2.value.value : s2.value.fraction && Object.hasOwn(e4, s2.value.fraction) ? (l2 = e4[s2.value.fraction], u2 = true) : Object.hasOwn(e4, s2.value.value) ? l2 = e4[s2.value.value] : e4.__BARE_VALUE__ && (l2 = e4.__BARE_VALUE__(s2.value) ?? null, u2 = (s2.value.fraction !== null && (l2 == null ? void 0 : l2.includes(`/`))) ?? false) : l2 = e4.DEFAULT ?? null;
          }
          if (l2 === null) return;
          let d2;
          {
            let e4 = (n3 == null ? void 0 : n3.modifiers) ?? null;
          ...
          if (s2.modifier && d2 === null && !u2) return ((_b = s2.value) == null ? void 0 : _b.kind) === `arbitrary` ? null : void 0;
      ...
      (n3 == null ? void 0 : n3.supportsNegativeValues) && e3.utilities.functional(`-${a3}`, t4({ negative: true }), { types: i3 }), e3.utilities.functional(a3, t4({ negative: false }), { types: i3 }), e3.utilities.suggest(a3, () => {
        let e4 = (n3 == null ? void 0 : n3.values) ?? {}, t5 = new Set(Object.keys(e4));
...
function Wa(e3, t2) {
  var _a3;
  let n2 = e3.theme.screens || {}, r2 = ((_a3 = t2.variants.get(`min`)) == null ? void 0 : _a3.order) ?? 0, i2 = [];
...
function Ka(e3, t2) {
  ...
  if (Object.keys(n2).length > 0) {
    let e4 = t2.variants.get(`aria`), r3 = e4 == null ? void 0 : e4.applyFn, i3 = e4 == null ? void 0 : e4.compounds;
    t2.variants.functional(`aria`, (e5, t3) => {
      let i4 = t3.value;
      return i4 && i4.kind === `named` && i4.value in n2 ? r3 == null ? void 0 : r3(e5, { ...t3, value: { kind: `arbitrary`, value: n2[i4.value] } }) : r3 == null ? void 0 : r3(e5, t3);
    }, { compounds: i3 });
  }
  if (Object.keys(r2).length > 0) {
    let e4 = t2.variants.get(`supports`), n3 = e4 == null ? void 0 : e4.applyFn, i3 = e4 == null ? void 0 : e4.compounds;
    t2.variants.functional(`supports`, (e5, t3) => {
      let i4 = t3.value;
      return i4 && i4.kind === `named` && i4.value in r2 ? n3 == null ? void 0 : n3(e5, { ...t3, value: { kind: `arbitrary`, value: r2[i4.value] } }) : n3 == null ? void 0 : n3(e5, t3);
    }, { compounds: i3 });
  }
  if (Object.keys(i2).length > 0) {
    let e4 = t2.variants.get(`data`), n3 = e4 == null ? void 0 : e4.applyFn, r3 = e4 == null ? void 0 : e4.compounds;
    t2.variants.functional(`data`, (e5, t3) => {
      let r4 = t3.value;
      return r4 && r4.kind === `named` && r4.value in i2 ? n3 == null ? void 0 : n3(e5, { ...t3, value: { kind: `arbitrary`, value: i2[r4.value] } }) : n3 == null ? void 0 : n3(e5, t3);
    }, { compounds: r3 });
  }
}
var qa = /^[a-z]+$/;
...
function Ya({ designSystem: e3, base: t2, ast: n2, sources: r2, configs: i2, pluginDetails: a2 }) {
  ...
  if (!e3.important && c2.important === true && (e3.important = true), typeof c2.important == `string`) {
    ...
    L(n2, (t3, n3) => {
      ...
      let r3 = Et(n3);
      return ((_a3 = r3.parent) == null ? void 0 : _a3.kind) === `rule` && r3.parent.selector === e4 ? I.Stop : I.ReplaceStop(R(e4, [t3]));
    });
  }
...
`)) {
  ...
  return r2.mappings.sort((e4, t3) => {
    var _a3, _b, _c, _d;
    return e4.generatedPosition.line - t3.generatedPosition.line || e4.generatedPosition.column - t3.generatedPosition.column || (((_a3 = e4.originalPosition) == null ? void 0 : _a3.line) ?? 0) - (((_b = t3.originalPosition) == null ? void 0 : _b.line) ?? 0) || (((_c = e4.originalPosition) == null ? void 0 : _c.column) ?? 0) - (((_d = t3.originalPosition) == null ? void 0 : _d.column) ?? 0);
  }), r2;
}
var Za = /^(-?\d+)\.\.(-?\d+)(?:\.\.(-?\d+))?$/;
function Qa(e3) {
...
function to(e3, t2) {
  ...
  function a2(o2, s2 = []) {
    ...
    if (e3.has(o2) && !n2.has(o2)) {
      r2.has(o2) && ((_a3 = t2.onCircularDependency) == null ? void 0 : _a3.call(t2, s2, o2)), r2.add(o2);
...
${r4}`);
  ...
  let y2 = sa(s2, f2 == null ? void 0 : f2.src);
...
${n3}`);
  } })) (_a3 = c2.get(e4)) == null ? void 0 : _a3(y2);
...
`, ho = `@tailwind utilities;
`, go = `@layer theme, base, components, utilities;
...
`, Q = e(i(), 1), _o = { "/tailwindcss": `@import './tailwindcss/index.css';`, "/tailwindcss/index.css": go, "/tailwindcss/theme.css": po, "/tailwindcss/preflight.css": mo, "/tailwindcss/utilities.css": ho };
...
async function yo(e3, t2 = `/`, n2 = {}) {
  t2 || (t2 = `/`);
  let r2 = e3;
  if (e3.startsWith(`fetch:`) && c(e3.substring(6))) return { base: Q.default.dirname(e3), content: await vo(new URL(e3.substring(6)).toString()), path: e3 };
  {
    for (let [e4, t3] of Object.entries(_o)) Object.keys(n2).includes(e4) || (n2[e4] = t3);
    !e3.startsWith(`/`) && (Object.keys(_o).includes(Q.default.resolve(e3)) || Object.keys(_o).includes(Q.default.resolve(e3).concat(`.css`))) && (t2 = `/`, e3 = Q.default.resolve(e3)), e3.startsWith(`.`) && (e3 = Q.default.resolve(t2, e3)), e3.startsWith(`/`) && (e3.endsWith(`.css`) || (Object.keys(n2).some((t3) => t3.includes(e3.concat(`.css`))) ? e3 = e3.concat(`.css`) : Object.keys(n2).some((t3) => t3.includes(e3.concat(`/index.css`))) && (e3 = e3.concat(`/index.css`))));
...
var bo = t(((e3, t2) => {
  ...
  e3.__esModule = true, e3.unesc = e3.stripComments = e3.getProp = e3.ensureObject = void 0, e3.unesc = t2(bo()).default, e3.getProp = t2(xo()).default, e3.ensureObject = t2(So()).default, e3.stripComments = t2(Co()).default;
  function t2(e4) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var t2 = c2(s()), n2 = c2(bo()), i2 = c2(Mo()), a2 = $(), o2;
  function c2(e4) {
    return e4 && e4.__esModule ? e4 : { default: e4 };
  }
  function l2(e4, t3) {
...
`), g2 = _2.length - 1, g2 > 0 ? (y2 = o3 + g2, b2 = v2 - _2[g2].length) : (y2 = o3, b2 = a3), S2 = t2.comment, o3 = y2, p3 = y2, f3 = v2 - b2) : l3 === t2.slash ? (v2 = s3, S2 = l3, p3 = o3, f3 = s3 - a3, c3 = v2 + 1) : (v2 = d2(r3, s3), S2 = t2.word, p3 = o3, f3 = v2 - a3), c3 = v2 + 1;
  ...
  e3.__esModule = true, e3.default = void 0;
  var n2 = C2(Do()), r2 = C2(Oo()), i2 = C2(ko()), a2 = C2(Ao()), o2 = C2(jo()), s2 = C2(No()), c2 = C2(Po()), l2 = C2(Fo()), u2 = S2(Io()), d2 = C2(Lo()), f2 = C2(Ro()), p2 = C2(zo()), m2 = C2(Bo()), h2 = S2(Ho()), g2 = S2(Vo()), _2 = S2($()), v2 = wo(), y2, b2;
  function x2(e4) {
    if (typeof WeakMap != `function`) return null;
    var t3 = /* @__PURE__ */ new WeakMap(), n3 = /* @__PURE__ */ new WeakMap();
  ...
  var t2 = p2(Io()), n2 = p2(ko()), r2 = p2(Ro()), i2 = p2(Ao()), a2 = p2(jo()), o2 = p2(zo()), s2 = p2(Fo()), c2 = p2(Do()), l2 = p2(Oo()), u2 = p2(Po()), d2 = p2(No()), f2 = p2(Lo());
  function p2(e4) {
    return e4 && e4.__esModule ? e4 : { default: e4 };
  }
  ...
  function l2(e4, t3) {
    var _a3;
    if (((_a3 = e4.prev()) == null ? void 0 : _a3.type) !== `comment`) return t3.after(e4), e4;
    let n3 = e4.prev();
...
async function Xo({ entrypoint: e3 = `/main.css`, volume: t2 = {}, ...n2 } = {}) {
  return n2 = { entrypoint: e3, volume: t2, ...n2 }, { css: (await a().use((0, Yo.default)()).process(n2.volume[n2.entrypoint], { from: n2.entrypoint, parser: n2.parser || null })).css };
}

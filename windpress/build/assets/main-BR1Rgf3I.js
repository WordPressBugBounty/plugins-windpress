...
import { t as re } from "./vfs-DGZNrgMJ.js";
import { c as ie, i as ae } from "./intellisense-BqSPmEm7.js";
import "./tailwindcss-CdApilZd.js";
import { t as T } from "./logger-CvF98D4V.js";
import { t as E } from "./_plugin-vue_export-helper-BDNMzG2s.js";
import { a as oe, i as se, n as ce, r as le, t as ue } from "./chevron-right-BCavwTU8.js";
import { n as de, t as D } from "./constant-BRHMowQF.js";
var O = { id: `windpressbuilderius-variable-app-header`, class: `header-container bg:$(primary-1) cursor:grab bb:1|solid|$(primary-3)` }, k = { class: `header-content flex gap:10 align-items:center fg:$(base-2)` }, A = { class: `header-logo flex px:12 py:2 align-items:center` }, j = { class: `header-title text-transform:none font:medium text:center flex-grow:1 gap:10 align-items:center cursor:default px:12 py:2` }, M = E({ __name: `PanelHeader`, setup(c2) {
  ...
  function v2(e3, t2) {
    let n3 = Object.getOwnPropertyDescriptor(e3, `value`).set, r2 = Object.getPrototypeOf(e3), i2 = Object.getOwnPropertyDescriptor(r2, `value`).set;
    n3 && n3 !== i2 ? i2.call(e3, t2) : n3.call(e3, t2);
    let a3 = new Event(`input`, { bubbles: true });
    e3.dispatchEvent(a3);
  }
  function y2(e3, t2) {
  ...
  let n2 = i(`isOpen`);
  return (e3, r2) => s((h(), u(`div`, be, [t(M), (h(), y(m, null, { default: _(() => [t(ye)]), _: 1 }))], 512)), [[ee, a(n2)]]);

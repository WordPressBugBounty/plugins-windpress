...
import { t as e } from "./log-DL0EGD80.js";
import { t } from "./api-nCMUpdHx.js";
import { t as n } from "./preload-helper-DYZqtPCf.js";
import { n as r, t as i } from "./dist-Bz0oLIIB.js";
import { __tla as __tla_0 } from "./cssesc-CvrAc3yE.js";
import "./build-BSzNLc6D.js";
import "./vfs-KtILWHuN.js";
import "./intellisense-vnvYUoFs.js";
let l, c, Je;
let __tla = Promise.all([
  ...
  c = async function(e2) {
    if (!o) return s || (s = (async () => {
      try {
        let t2 = await n(() => import("./oxide_parser-BKF4Q4MQ-CUymZoKb.js").then(async (m2) => {
          await m2.__tla;
          return m2;
        }), [], import.meta.url);
  ...
  function T(e2, t2, n2) {
    ...
    if (/\$$/.test(i2.pre)) for (let e3 = 0; e3 < o2.length && e3 < t2; e3++) {
      ...
      if (l2 && d2[0] !== void 0 && d2[1] !== void 0) {
        let e3 = x(d2[0]), n3 = x(d2[1]), r3 = Math.max(d2[0].length, d2[1].length), i3 = d2.length === 3 && d2[2] !== void 0 ? Math.max(Math.abs(x(d2[2])), 1) : 1, a3 = w;
        n3 < e3 && (i3 *= -1, a3 = fe);
        let o3 = d2.some(C);
        f2 = [];

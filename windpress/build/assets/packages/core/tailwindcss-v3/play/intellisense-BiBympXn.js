import { i as e, o as t, t as n } from "../../../../chunk-DlkHe4MQ.js";
import { n as r, t as i } from "../../../../dist-BdGzUZX_.js";
import { t as a } from "../../../../set-Re2vSVSO.js";
import { t as o } from "../../../../fuse-Bga3a1fX.js";
import { r as s, t as c } from "../../../../lib-SBX7jFNp.js";
import { n as l, t as u } from "../../../../dist-YmA3yiKr.js";
import { t as d } from "../../../../path-browserify-CWnXpqR1.js";
import { r as f } from "../../../../default-map-CP1tOC8X.js";
import { n as p, t as m, __tla as __tla_0 } from "../../../../cssesc-BlGGmlzH.js";
import { t as h } from "../../../../vfs-DziqLF6T.js";
import { s as g, t as _ } from "../../../../intellisense-CtRsPNrz.js";
import { n as v, t as y } from "../../../../dlv.umd-DTG8-zoP.js";
import { _ as b, a as x, i as S, n as C, r as w, t as T } from "../../../../resolve-config-Jt3ENbIk.js";
import { __tla as __tla_1 } from "../../../../tailwindcss-DNCLGH_x.js";
Promise.all([
  (() => {
    try {
      return __tla_0;
  ...
  var E = n(((e2, t2) => {
    ...
    (function(n2, r2) {
      ...
      var t3 = function(e4, t4) {
        ...
        var t4 = ee2(e4.r), n3 = ee2(e4.g), r3 = ee2(e4.b), i3 = {
          mode: `xyz65`,
        ...
        var t4 = e4.x, n3 = e4.y, r3 = e4.z, i3 = e4.alpha, a3 = {
          mode: `a98`,
          r: N2(2.0415879038107465 * t4 - 0.5650069742788596 * n3 - 0.34473135077832956 * r3),
          g: N2(-0.9692436362808795 * t4 + 1.8759675015077202 * n3 + 0.04155505740717557 * r3),
          b: N2(0.013444280632031142 * t4 - 0.11836239223101838 * n3 + 1.0151749943912054 * r3)
        };
        return i3 !== void 0 && (a3.alpha = i3), a3;
      }, ne2 = function(e4) {
        ...
        var t4 = e4.x, n3 = e4.y, r3 = e4.z, i3 = e4.alpha, a3 = {
          mode: `prophoto`,
          r: se2(1.3457989731028281 * t4 - 0.25558010007997534 * n3 - 0.05110628506753401 * r3),
          g: se2(-0.5446224939028347 * t4 + 1.5082327413132781 * n3 + 0.02053603239147973 * r3),
          b: se2(0 * t4 + 0 * n3 + 1.2119675456389454 * r3)
        };
        return i3 !== void 0 && (a3.alpha = i3), a3;
      }, le2 = function(e4) {
        var t4 = Math.abs(e4);
        ...
        var t4 = le2(e4.r), n3 = le2(e4.g), r3 = le2(e4.b), i3 = {
          mode: `xyz65`,
      ...
      }), me2 = 1.09929682680944, he2 = function(e4) {
        var t4 = Math.abs(e4);
        return t4 > 0.018053968510807 ? (Math.sign(e4) || 1) * (me2 * t4 ** 0.45 - (me2 - 1)) : 4.5 * e4;
      }, ge2 = function(e4) {
        var t4 = e4.x, n3 = e4.y, r3 = e4.z, i3 = e4.alpha, a3 = {
          mode: `rec2020`,
          r: he2(1.7166511879712674 * t4 - 0.35567078377639233 * n3 - 0.25336628137365974 * r3),
          g: he2(-0.6666843518324892 * t4 + 1.6164812366349395 * n3 + 0.01576854581391113 * r3),
          b: he2(0.017639857445310783 * t4 - 0.042770613257808524 * n3 + 0.9421031212354738 * r3)
        };
        return i3 !== void 0 && (a3.alpha = i3), a3;
      }, _e2 = 1.09929682680944, ve2 = function(e4) {
        var t4 = Math.abs(e4);
        return t4 < 0.08124285829863151 ? e4 / 4.5 : (Math.sign(e4) || 1) * ((t4 + _e2 - 1) / _e2) ** (1 / 0.45);
      }, ye2 = function(e4) {
        var t4 = ve2(e4.r), n3 = ve2(e4.g), r3 = ve2(e4.b), i3 = {
          mode: `xyz65`,
        ...
        return e4.map((function(n3, r3, i3) {
          ...
          var a3 = F2(n3);
          return r3 === 0 || e4[r3 - 1] === void 0 ? a3 : t4(a3 - F2(i3[r3 - 1]));
      ...
      }, R2 = {}, Se2 = {}, Ce2 = [], z2 = {}, we2 = function(e4) {
        return e4;
      }, B2 = function(e4) {
        R2[e4.mode] = Object.assign(R2[e4.mode] || {}, e4.output), Object.keys(e4.input || {}).forEach((function(t4) {
          R2[t4] || (R2[t4] = {}), R2[t4][e4.mode] = e4.input[t4];
          ...
          }), e4.interpolate[t4].fixup || (e4.interpolate[t4].fixup = we2);
        })), Se2[e4.mode] = e4, (e4.parsers || []).forEach((function(t4) {
          typeof t4 == `function` ? Ce2.push(t4) : typeof t4 == `string` && (z2[t4] = e4.mode);
        }));
      }, V2 = function(e4) {
        return Se2[e4];
      }, Te2 = function(e4) {
        if (typeof e4 == `string`) {
          for (var t4 = void 0, n3 = 0, r3 = Ce2.length; n3 < r3 && (t4 = Ce2[n3++](e4)) === void 0; ) ;
          return t4 || (function(e5) {
            ...
            if (t5) {
              ...
              if (n4) {
                ...
                return V2(n4).channels.forEach((function(e6) {
        ...
        return e4 === void 0 && (e4 = `rgb`), function(t4) {
          return (t4 = Ee2(t4, e4)) === void 0 ? void 0 : t4.mode === e4 ? t4 : R2[t4.mode][e4] ? R2[t4.mode][e4](t4) : e4 === `rgb` ? R2[t4.mode].rgb(t4) : R2.rgb[e4](R2[t4.mode].rgb(t4));
        };
      }, U2 = function(e4, t4) {
        if (e4.h === void 0 || t4.h === void 0 || !e4.s || !t4.s) return 0;
        var n3 = F2(e4.h), r3 = F2(t4.h), i3 = Math.sin((r3 - n3 + 360) / 2 * Math.PI / 180);
        return 2 * Math.sqrt(e4.s * t4.s) * i3;
      }, De2 = function(e4, t4) {
        if (e4.h === void 0 || t4.h === void 0) return 0;
        var n3 = F2(e4.h), r3 = F2(t4.h);
        ...
        var n3 = V2(e4), r3 = n3.channels, i3 = n3.difference, a3 = H2(e4);
        ...
        parsers: [
          function(e4) {
            ...
            if (t4) {
              var n3 = {
                mode: `hsl`,
                h: t4[3] === void 0 ? xe2(t4[1], t4[2]) : +t4[3],
      ...
      var Pe2 = {
        ...
        t4 = Re2(t4), n3 = Re2(n3);
        var a3 = 1.15 * t4 - 0.15 * (r3 = Re2(r3)), o3 = 0.66 * n3 + 0.34 * t4, s3 = K2(0.41478972 * a3 + 0.579999 * o3 + 0.014648 * r3), c3 = K2(-0.20151 * a3 + 1.120649 * o3 + 0.0531008 * r3), l3 = K2(-0.0166008 * a3 + 0.2648 * o3 + 0.6684799 * r3), u3 = (s3 + c3) / 2, d3 = {
          mode: `jab`,
      ...
      }, ze2 = 16295499532821565e-27, Be2 = function(e4) {
        var t4 = e4 ** 0.007460772656268216;
        return 1e4 * ((0.8359375 - t4) / (18.6875 * t4 - 18.8515625)) ** 6.277394636015326 || 0;
      }, Ve2 = function(e4) {
        return e4 / 203;
      }, He2 = function(e4) {
        var t4 = e4.j, n3 = e4.a, r3 = e4.b, i3 = e4.alpha, a3 = (t4 + ze2) / (0.44 + 0.56 * (t4 + ze2)), o3 = Be2(a3 + 0.13860504 * n3 + 0.058047316 * r3), s3 = Be2(a3 - 0.13860504 * n3 - 0.058047316 * r3), c3 = Be2(a3 - 0.096019242 * n3 - 0.8118919 * r3), l3 = {
          mode: `xyz65`,
          x: Ve2(1.661373024652174 * o3 - 0.914523081304348 * s3 + 0.23136208173913045 * c3),
          y: Ve2(-0.3250758611844533 * o3 + 1.571847026732543 * s3 - 0.21825383453227928 * c3),
          z: Ve2(-0.090982811 * o3 - 0.31272829 * s3 + 1.5227666 * c3)
        };
        ...
        return a3 && (o3.h = F2(180 * Math.atan2(r3, n3) / Math.PI)), i3 !== void 0 && (o3.alpha = i3), o3;
      }, Ke2 = function(e4) {
      ...
      }, Je2 = 0.96422, Ye2 = 0.82521, Y2 = 29 ** 3 / 3 ** 3, X2 = 6 ** 3 / 29 ** 3, Z2 = function(e4) {
        return e4 ** 3 > X2 ? e4 ** 3 : (116 * e4 - 16) / Y2;
      }, Xe2 = function(e4) {
        ...
        return e4 > X2 ? Math.cbrt(e4) : (Y2 * e4 + 16) / 116;
      }, $e2 = function(e4) {
        var t4 = e4.x, n3 = e4.y, r3 = e4.z, i3 = e4.alpha, a3 = Qe2(t4 / Je2), o3 = Qe2(n3 / 1), s3 = {
          mode: `lab`,
          l: 116 * o3 - 16,
          a: 500 * (a3 - o3),
          b: 200 * (o3 - Qe2(r3 / Ye2))
      ...
      }, nt2 = 0.95047, Q2 = 1.08883, rt2 = 29 ** 3 / 3 ** 3, it2 = 6 ** 3 / 29 ** 3, at = function(e4) {
        ...
        var t4 = e4.x, n3 = e4.y, r3 = e4.z, i3 = e4.alpha, a3 = ct(t4 / nt2), o3 = ct(n3 / 1), s3 = {
          mode: `lab65`,
          l: 116 * o3 - 16,
          a: 500 * (a3 - o3),
          b: 200 * (o3 - ct(r3 / Q2))
        ...
        return o3 && (s3.h = F2(180 * Math.atan2(i3, r3) / Math.PI)), a3 !== void 0 && (s3.alpha = a3), s3;
      }, pt = function(e4, t4) {
          ...
          function(e4) {
            ...
            if (t4) {
              var n3 = {
                ...
                l: +t4[1],
                c: Math.max(0, +t4[2]),
                h: t4[5] === void 0 ? xe2(t4[3], t4[4]) : +t4[5]
              };
              return t4[6] === void 0 ? t4[7] !== void 0 && (n3.alpha = +t4[7]) : n3.alpha = t4[6] / 100, n3;
            }
          }
      ...
      }, vt = gt(Je2, 1, Ye2), yt = _t(Je2, 1, Ye2), bt = function(e4) {
        var t4, n3 = e4.x, r3 = e4.y, i3 = e4.z, a3 = e4.alpha, o3 = (t4 = r3 / 1) <= X2 ? Y2 * t4 : 116 * Math.cbrt(t4) - 16, s3 = gt(n3, r3, i3), c3 = _t(n3, r3, i3);
        ...
        return bt(fe2(e4));
      }, St = 4 * (Ie2 = Je2) / (Ie2 + 15 + 3 * Ye2), Ct = (function(e4, t4, n3) {
        return 9 * t4 / (e4 + 15 * t4 + 3 * n3);
      })(Je2, 1, Ye2), wt = function(e4) {
        var t4 = e4.l, n3 = e4.u, r3 = e4.v, i3 = e4.alpha, a3 = n3 / (13 * t4) + St, o3 = r3 / (13 * t4) + Ct, s3 = 1 * (t4 <= 8 ? t4 / Y2 : ((t4 + 16) / 116) ** 3), c3 = {
          mode: `xyz`,
          x: 9 * a3 * s3 / (4 * o3),
          y: s3,
        ...
        return c3.c && (c3.h = F2((Math.atan2(o3, a3) + Lt) / Math.PI * 180)), i3 !== void 0 && (c3.alpha = i3), c3;
      }, Wt = function(e4) {
        var t4 = e4.l, n3 = e4.c, r3 = e4.h, i3 = e4.alpha, a3 = {
          mode: `dlab`,
          l: t4,
      ...
      }, an = H2(`rgb`), on = H2(`hsl`), sn = rn(2), cn = function(e4) {
        ...
        var r3 = t4 ? V2(t4).channels : null, i3 = t4 ? H2(t4) : Ee2;
        return function(a3) {
          var o3 = i3(a3), s3 = (r3 || V2(a3.mode).channels).reduce((function(n4, r4) {
          ...
          if (!n3) return s3;
          var c3 = Ee2(a3);
          return c3 && c3.mode !== s3.mode ? H2(c3.mode)(s3) : s3;
        };
        ...
        t4 === void 0 && (t4 = `rgb`);
        var i3 = V2(t4), a3 = H2(t4), o3 = [], s3 = [], c3 = {};
        ...
        for (var i3, a3 = 0, o3 = e4.c, s3 = V2(t4).ranges.c, c3 = (s3[1] - s3[0]) / 2 ** 13; o3 - a3 > c3; ) r3.c = a3 + 0.5 * (o3 - a3), zn(r3) ? (i3 = r3.c, a3 = r3.c) : o3 = r3.c;
      ...
      var Kn = H2(`rgb`), qn = [
        ...
        return function(e5) {
          ...
          if (t5 !== void 0) {
            ...
            return t5.alpha !== void 0 && (s3.alpha = t5.alpha), H2(t5.mode)(s3);
          }
        };
      }, Zn = function(e4) {
        ...
        n3 === void 0 && (n3 = false);
        var r3 = H2(t4), i3 = V2(t4).channels;
        return function(a3) {
          var o3 = r3(a3);
          if (o3) {
            for (var s3, c3 = {
            ...
            if (!n3) return c3;
            var d3 = Ee2(a3);
            return d3 && c3.mode !== d3.mode ? H2(d3.mode)(c3) : c3;
          }
        };
      };
      B2(ie2), B2(Ft), B2(Kt), B2(qt), B2(Fe2), B2(je2), B2(Pe2), B2(Le2), B2(We2), B2(qe2), B2(tt2), B2(dt), B2(mt), B2(ht), B2(kt), B2(j2), B2(Et), B2(oe2), B2(pe2), B2(be2), B2(E2), B2(Yt), B2(Jt), B2(Xt), B2(tn), B2(nn);
      var rr = H2(`a98`), ir = H2(`cubehelix`), ar = H2(`dlab`), or = H2(`dlch`), sr = H2(`hsi`), cr = H2(`hsl`), lr = H2(`hsv`), ur = H2(`hwb`), dr = H2(`jab`), fr = H2(`jch`), pr = H2(`lab`), mr = H2(`lab65`), hr = H2(`lch`), gr = H2(`lch65`), _r = H2(`lchuv`), vr = H2(`lrgb`), yr = H2(`luv`), br = H2(`p3`), xr = H2(`prophoto`), Sr = H2(`rec2020`), Cr = H2(`rgb`), wr = H2(`xyz`), Tr = H2(`xyz65`), Er = H2(`yiq`), Dr = H2(`oklab`), Or = H2(`oklch`);
      e3.a98 = rr, e3.average = function(e4, t4, n3) {
        t4 === void 0 && (t4 = `rgb`);
        var r3 = V2(t4), i3 = e4.map(H2(t4));
        return r3.channels.reduce((function(e5, t5) {
          ...
          return o3.length && (a3 = Ae2(n3) ? n3 : n3 && Ae2(n3[t5]) ? n3[t5] : r3.average && Ae2(r3.average[t5]) ? r3.average[t5] : ke2, e5[t5] = a3(o3, t5)), e5;
        }), {
          mode: t4
        });
      }, e3.averageAngle = G2, e3.averageNumber = ke2, e3.blend = function(e4, t4, n3) {
        t4 === void 0 && (t4 = `normal`), n3 === void 0 && (n3 = `rgb`);
        var r3 = typeof t4 == `function` ? t4 : Wn[t4], i3 = H2(n3), a3 = V2(n3).channels;
      ...
      }, e3.clampChroma = Un, e3.clampRgb = Hn, e3.colorsNamed = n2, e3.converter = H2, e3.cubehelix = ir, e3.deficiencyDeuter = Qn, e3.deficiencyProt = Zn, e3.deficiencyTrit = $n, e3.defineMode = B2, e3.differenceCie76 = function() {
        return W2(`lab65`);
        ...
        return function(i3, a3) {
          ...
          var A3 = (O3 - 50) ** 2, j3 = 1 - 0.17 * Math.cos(E3 - Math.PI / 6) + 0.24 * Math.cos(2 * E3) + 0.32 * Math.cos(3 * E3 + Math.PI / 30) - 0.2 * Math.cos(4 * E3 - 63 * Math.PI / 180), ee3 = 1 + 0.015 * A3 / Math.sqrt(20 + A3), M3 = 1 + 0.045 * k3, N3 = 1 + 0.015 * k3 * j3, te3 = 30 * Math.PI / 180 * Math.exp(-1 * ((180 / Math.PI * E3 - 275) / 25) ** 2), ne3 = 2 * Math.sqrt(k3 ** 7 / (k3 ** 7 + 25 ** 7)), re3 = -1 * Math.sin(2 * te3) * ne3;
          return Math.sqrt((C3 / (e4 * ee3)) ** 2 + (w3 / (t4 * M3)) ** 2 + (D3 / (n3 * N3)) ** 2 + re3 * w3 / (t4 * M3) * D3 / (n3 * N3));
        };
        ...
        return W2(`dlab`);
      }, e3.differenceEuclidean = W2, e3.differenceHueChroma = Oe2, e3.differenceHueNaive = De2, e3.differenceHueSaturation = U2, e3.differenceHyab = function() {
        var e4 = H2(`lab65`);
      ...
      }, e3.fixupHueShorter = L2, e3.formatCss = function(e4) {
        var t4 = Ee2(e4);
        if (t4) {
          var n3 = V2(t4.mode);
      ...
      }, e3.getModeDefinition = V2, e3.hsi = sr, e3.hsl = cr, e3.hsv = lr, e3.hwb = ur, e3.interpolate = function(e4, t4, n3) {
      ...
      }, e3.interpolateHue = L2, e3.interpolateLinear = function(e4, t4) {
        return t4 === void 0 && (t4 = 1), function(n3) {
          var r3 = S2(t4);
          return function(t5) {
        ...
        t4 === void 0 && (t4 = W2()), n3 === void 0 && (n3 = function(e5) {
          return e5;
        });
      ...
      }, e3.oklab = Dr, e3.oklch = Or, e3.p3 = br, e3.parse = Te2, e3.prophoto = xr, e3.random = function(e4, t4) {
        e4 === void 0 && (e4 = `rgb`), t4 === void 0 && (t4 = {});
        var n3 = V2(e4), r3 = (function(e5) {
    ...
    n2.exports = (function(e2, t3) {
      ...
      34: function(e2, t3) {
        (function(e3, n3) {
          ...
          function j2(e4) {
            return e4.start = e4.pos, e4.eatWhile(ee2), e4.current();
          }
          function ee2(e4) {
          ...
          function te2(e4) {
            ...
            for (let r3 = 0; r3 < e4.repeat.count; r3++) {
              ...
              if (i3.repeat.value = r3 + 1, i3.walk(te2), i3.isGroup) for (; i3.children.length > 0; ) i3.firstChild.repeat = i3.repeat, t5.insertAt(i3.firstChild, n4++);
              else t5.insertAt(i3, n4++);
            }
            e4.parent.removeChild(e4);
          }
          var ne2 = function(e4, t5) {
            return e4.walk((e5) => re2(e5, t5)), e4;
          };
          function re2(e4, t5) {
            let n4 = /* @__PURE__ */ new Set(), r3 = (e5) => {
              ...
              let o3 = oe2(a3);
              for (ie2(o3, e5); a3.firstChild; ) e5.parent.insertBefore(a3.firstChild, e5);
              o3.parent.insertBefore(e5, o3), o3.remove();
            };
            r3(e4);
          }
          function ie2(e4, t5) {
            return t5.name = e4.name, e4.selfClosing && (t5.selfClosing = true), e4.value != null && (t5.value = e4.value), e4.repeat && (t5.repeat = Object.assign({}, e4.repeat)), P2(e4, t5);
          }
          function P2(e4, t5) {
            ae2(e4, t5);
          ...
          let se2 = new Set(`a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,iframe,img,input,ins,kbd,label,map,object,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var`.split(`,`)), ce2 = {
            p: `span`,
            ul: `li`,
            ol: `li`,
            table: `tr`,
          ...
          function le2(e4) {
            return e4 = (e4 || ``).toLowerCase(), ce2[e4] || (se2.has(e4) ? `span` : `div`);
          }
          var ue2 = function(e4) {
            return e4.walk((e5) => {
              e5.name == null && e5.attributes.length && (e5.name = le2(e5.parent.name));
            }), e4;
          };
          function de2(e4, t5) {
            ...
            return Array.from(n4).map((e5) => pe2(e5, r3));
          }
          function fe2(e4, t5, n4) {
          ...
          var me2 = function(e4) {
            return e4.walk(he2), e4;
          };
          function he2(e4) {
            let t5 = ge2(e4);
            if (t5 && t5.value != null) {
              let n4 = t5.value;
              e4.name = _e2(e4.name, n4), e4.value = _e2(e4.value, n4), e4.attributes.forEach((t6) => {
                let r3 = e4.getAttribute(t6.name).clone();
                r3.name = _e2(t6.name, n4), r3.value = _e2(t6.value, n4), e4.replaceAttribute(t6.name, r3);
              });
            }
            return e4;
          }
          ...
          function _e2(e4, t5) {
            return typeof e4 == `string` ? ye2(e4, ve2(e4), t5) : e4;
          }
          function ve2(e4) {
            return de2(e4 || ``, `$`).reduce((t5, n4) => {
              if (!/[#{]/.test(e4[n4[0] + 1] || ``)) {
          ...
          function ye2(e4, t5, n4) {
            return be2(fe2(e4, t5, (e5, t6) => {
              let r3 = String(n4 + t6);
          ...
          let F2 = /^((?:https?|ftp|file):\/\/)?([\da-z\.-]+)\.([a-z\.]{2,6})([\/\w \.-]*)*\/?$/, xe2 = /^([a-z0-9_\.-]+)@([\da-z\.-]+)\.([a-z\.]{2,6})$/, I2 = /^([a-z]+:)?\/\//i;
          function L2(e4, t5) {
          ...
          function R2(e4, t5) {
            if (Array.isArray(t5) && t5.length) {
              let n4 = false;
              e4.walk((e5) => {
                e5.repeat && e5.repeat.implicit && (n4 = true, Se2(e5, t5[e5.repeat.index]));
              }), n4 || B2(we2(e4), t5.join(`
`));
            }
            return e4;
          }
          function Se2(e4, t5) {
            let n4 = Ce2(e4, t5);
            return e4.walk((e5) => n4 |= Ce2(e5, t5)), n4 || B2(we2(e4), t5), e4;
          }
          function Ce2(e4, t5) {
            let n4 = {
              replaced: false
            };
            return e4.value = z2(e4.value, t5, n4), e4.attributes.forEach((r3) => {
              r3.value && e4.setAttribute(r3.name, z2(r3.value, t5, n4));
            }), n4.replaced;
          }
          function z2(e4, t5, n4) {
            if (typeof e4 == `string`) {
              let r3 = de2(e4, `$#`);
              r3.length && (n4 && (n4.replaced = true), e4 = fe2(e4, r3, t5));
            }
            return e4;
          }
          function we2(e4) {
          ...
          function B2(e4, t5) {
            if (e4.value) {
              let n4 = de2(e4.value, `|`);
              if (n4.length) {
                e4.value = fe2(e4.value, n4, t5);
                return;
              }
            }
            (e4.name.toLowerCase() === `a` || e4.hasAttribute(`href`)) && (F2.test(t5) ? e4.setAttribute(`href`, (I2.test(t5) ? `` : `http://`) + t5) : xe2.test(t5) && e4.setAttribute(`href`, `mailto:` + t5)), e4.value = t5;
          }
          let V2 = {
            element: `__`,
            modifier: `_`
          }, Te2 = /^(-+)([a-z0-9]+[a-z0-9-]*)/i, Ee2 = /^(_+)([a-z0-9]+[a-z0-9-]*)/i, H2 = (e4) => /^[a-z]\-/i.test(e4), U2 = (e4) => /^[a-z]/i.test(e4);
          var De2 = function(e4, t5) {
            t5 = Object.assign({}, V2, t5), e4.walk((e5) => Oe2(e5, t5));
            let n4 = G2(e4);
            return e4.walk((e5) => W2(e5, n4, t5)), e4;
          };
          function Oe2(e4, t5) {
          ...
          function W2(e4, t5, n4) {
            let r3 = e4.classList.reduce((r4, i4) => {
              let a3, o3, s3 = i4;
              for ((o3 = i4.match(Te2)) && (a3 = ke2(e4, t5, o3[1]) + n4.element + o3[2], r4.add(a3), i4 = i4.slice(o3[0].length)); o3 = i4.match(Ee2); ) a3 || (a3 = ke2(e4, t5, o3[1]), r4.add(a3)), r4.add(`${a3}${n4.modifier}${o3[2]}`), i4 = i4.slice(o3[0].length);
          ...
          function G2(e4) {
            ...
            return e4.walk((e5) => {
              let n4 = e5.classList;
              n4.length && t5.set(e5, Ae2(n4, H2) || Ae2(n4, U2) || t5.get(e5.parent));
            }), t5;
          }
          function ke2(e4, t5, n4) {
          ...
          var je2 = function(e4) {
            return e4.walk((e5) => {
              Me2(e5, `class`, `className`), Me2(e5, `for`, `htmlFor`);
            }), e4;
          };
          function Me2(e4, t5, n4) {
            let r3 = e4.getAttribute(t5);
            r3 && (r3.name = n4);
          }
          let Ne2 = /^xsl:(variable|with\-param)$/i, Pe2 = {
            bem: De2,
            jsx: je2,
            xsl: function(e4) {
              return e4.walk((e5) => {
                Ne2.test(e5.name || ``) && (e5.children.length || e5.value) && e5.removeAttribute(`select`);
              }), e4;
            }
          };
          var Fe2 = function(e4, t5) {
          ...
          }, Ie2 = function(e4, t5, n4) {
            return typeof t5 == `string` ? t5 = [
              t5
            ] : t5 && typeof t5 == `object` && !Array.isArray(t5) && (n4 = t5, t5 = null), e4.use(ue2).use(L2, Array.isArray(t5) ? t5.length : null).use(me2).use(R2, t5).use(Fe2, n4);
          };
          function Le2(e4, t5) {
            return t5 || (t5 = {}), e4.walk((e5) => K2(e5, t5)), e4;
          }
          function K2(e4, t5) {
            let n4 = e4.attributes;
            for (let r3 = 0, i3 = n4.length; r3 < i3; r3++) {
              let i4 = n4[r3];
              typeof i4.value == `string` && e4.setAttribute(i4.name, Re2(i4.value, t5));
            }
            return e4.value != null && (e4.value = Re2(e4.value, t5)), e4;
          }
          function Re2(e4, t5) {
            let n4 = q2(e4), r3 = 0, i3 = ``;
          ...
          function ze2(e4) {
            ...
            for (; !t5.eof(); ) o3 = t5.peek(), a3 = t5.pos, o3 === 92 ? (t5.next(), t5.next()) : (s3 = He2(t5, r3.length + a3 - i3)) ? (n4.push(s3), r3 += t5.string.slice(i3, a3) + s3.placeholder, i3 = t5.pos) : t5.next();
            return new Ge2(r3 + t5.string.slice(i3), n4);
          }
          function Be2(e4, t5, n4) {
            n4 || (n4 = Ve2);
            let r3 = t5.map((e5, t6) => ({
              order: t6,
              field: e5,
          ...
          function He2(e4, t5) {
            ...
            if (e4.eat(36)) {
              let n5 = J2(e4), r3 = ``;
              if (n5 != null || e4.eat(123) && (n5 = J2(e4), n5 != null && (e4.eat(58) && (r3 = Ue2(e4)), e4.eat(125)))) return new We2(n5, r3, t5);
            }
            e4.pos = n4;
          }
          function Ue2(e4) {
          ...
          class Ge2 {
            ...
            mark(e4) {
              return Be2(this.string, this.fields, e4);
            }
            toString() {
              return string;
            }
          ...
          class qe2 {
            constructor(e4, t5, n4) {
              typeof t5 == `object` && (n4 = t5, t5 = null), this.node = e4, this._fieldsRenderer = t5 || Ke2, this.open = null, this.beforeOpen = ``, this.afterOpen = ``, this.close = null, this.beforeClose = ``, this.afterClose = ``, this.text = null, this.beforeText = ``, this.afterText = ``, this.indent = ``, this.newline = ``, n4 && Object.assign(this, n4);
            }
            clone() {
          ...
          let Ye2 = (e4, t5) => t5 || ``;
          function Y2(e4, t5, n4) {
            n4 === void 0 && (n4 = t5, t5 = null), t5 || (t5 = Ye2);
            let r3 = {
              index: 1
            };
            return X2(e4.children, n4, (e5) => e5 == null ? t5(r3.index++) : Z2(e5, r3).mark(t5));
          }
          function X2(e4, t5, n4) {
            return e4.map((e5) => {
              let r3 = t5(new qe2(e5, n4));
              return r3 ? r3.toString(X2(e5.children, t5, n4)) : ``;
            }).join(``);
          }
          function Z2(e4, t5) {
            let n4 = typeof e4 == `object` ? e4 : ze2(e4), r3 = -1;
          ...
          function Ze2(e4, t5) {
            ...
            for (; o3 < e4.length; ) s3 = e4.charCodeAt(o3), s3 === 91 ? n4.push(o3) : s3 === 93 && (c3 = n4.pop(), n4.length || (i3 += e4.slice(a3, c3) + e4.slice(c3 + 1, o3).replace(Xe2, r3), a3 = o3 + 1)), o3++;
...
<!-- /[#ID][.CLASS] -->`
          ...
          function at(e4, t5, n4) {
            return n4 = Object.assign({}, n4), n4.comment = Object.assign({}, it2, n4.comment), Y2(e4, n4.field, (e5) => {
              if (e5 = ot(e5, t5), !nt2(e5)) {
                let r3 = e5.node;
                if (r3.name) {
...
`;
              ...
              (!et2(n4.parent) || !$e2(n4)) && (e4.beforeOpen = r3, n4.isTextOnly && (e4.beforeText = r3)), lt(n4, t5) && (n4.isTextOnly || (e4.beforeText = r3 + t5.indent(1)), e4.beforeClose = r3);
            }
            return e4;
          }
          function st(e4, t5) {
            return !t5.get(`format`) || e4.parent.isTextOnly && e4.parent.children.length === 1 && ze2(e4.parent.value).fields.length ? false : dt(e4, t5) ? ct(e4, t5) : true;
          }
          function ct(e4, t5) {
            if (!dt(e4, t5)) return false;
            if (tt2(e4)) return true;
            if (e4.childIndex === 0) {
              let n4 = e4;
          ...
          function mt(e4, t5) {
            ...
            for (let n5 = 0, i3 = t5.trigger.length; n5 < i3; n5++) if (t5.trigger[n5].toUpperCase() in r3) {
              e4.open = Ze2(t5.before, r3) + e4.open, e4.close && (e4.close += Ze2(t5.after, r3));
              break;
            }
          }
...
`, (!et2(r3.parent) || !$e2(r3)) && (e4.beforeOpen = e4.newline + e4.indent), r3.name) {
              let i3 = Object.assign({
                NAME: t5.name(r3.name),
                SELF_CLOSE: r3.selfClosing ? n4.selfClose : null
              }, bt(e4, t5, n4.attributes));
              n4.omitName && n4.omitName.test(i3.NAME) && i3.PRIMARY_ATTRS && (i3.NAME = null), n4.open != null && (e4.open = Ze2(n4.open, i3)), n4.close != null && (e4.close = Ze2(n4.close, i3));
            }
            return e4;
          }
          ...
          function Ct(e4, t5, n4) {
            ...
            return Y2(e4, n4.field, (e5) => {
              if (e5 = yt(e5, t5, r3), e5 = wt(e5, t5), !nt2(e5)) {
                let n5 = e5.node;
          ...
          function Tt(e4, t5) {
            if (e4.value != null && St.test(e4.value)) {
              let n4 = Qe2(e4.value), r3 = t5.indent(1), i3 = n4.reduce((e5, t6) => Math.max(e5, t6.length), 0);
...
`);
          ...
          function kt(e4, t5, n4) {
            ...
            return Y2(e4, n4.field, (e5, n5) => {
              if (e5 = yt(e5, t5, a3), e5 = $(e5, t5), !nt2(e5)) {
                let n6 = e5.node;
          ...
          function $(e4, t5) {
            ...
            return t5.get(`inlineBreak`) === 0 && jt(n4, t5) && !et2(r3) && r3.value == null && r3.children.length === 1 && (e4.beforeOpen = `: `), !n4.isTextOnly && n4.value && (e4.beforeText = Dt.test(n4.value) ? e4.newline + e4.indent + t5.indent(1) : ` `), e4;
          }
          function At(e4, t5) {
            if (e4.value != null && Dt.test(e4.value)) {
              let n4 = t5.indent(1);
              return Qe2(e4.value).map((e5, t6) => `${n4}${t6 ? ` ` : `|`} ${e5}`).join(`
`);
            }
            return e4.value;
          }
          ...
          function Nt(e4, t5, n4) {
            ...
            return Y2(e4, n4.field, (e5) => {
              if (e5 = yt(e5, t5, r3), e5 = Pt(e5, t5), !nt2(e5)) {
                let n5 = e5.node;
          ...
          function Ft(e4, t5) {
            if (e4.value != null && Mt.test(e4.value)) {
              let n4 = t5.indent(1);
              return Qe2(e4.value).map((e5) => `${n4}| ${e5}`).join(`
`);
            }
            return e4.value;
          }
          ...
          function Bt(e4, t5) {
            return N2(e4).use(ne2, t5.snippets).use(Le2, t5.variables).use(Ie2, t5.text, t5.addons);
          }
          class Vt {
            constructor() {
          ...
          function Un(e4, t5, n4) {
            return n4 = Object.assign({}, Hn, n4), Y2(e4, n4.field, (r3) => {
...
`, e4.lastChild !== i3 && (r3.afterText += r3.newline)), r3;
          ...
          function Wn(e4, t5) {
            let n4 = ze2(e4), r3 = n4.fields.length;
...
|}`,
          ...
          var tr = function(e4, t5) {
            ...
            return !e4.repeat && !nr(e4.parent) ? (e4.parent.value = lr(n4, t5.wordCount, r3), e4.remove()) : (e4.value = lr(n4, t5.wordCount, r3), e4.name = e4.parent.name ? le2(e4.parent.name) : null), e4;
          };
          function nr(e4) {
            return !e4.parent;
          }
      ...
      183: function(e2, t3, n3) {
        ...
        function S2(e3, t4, n4, a3) {
          if (a3.showExpandedAbbreviation === `never` || !he2(n4, a3.excludeLanguages)) return;
          if (!M2(n4)) {
          ...
          let g3 = P2(n4, a3, l3), _3 = g3.preferences;
          ...
          let v3, b3, x3 = [], S3 = (e4, t5) => {
            if (re2(e4, c3)) {
              ...
              !v3 || ie2(e4, t5, v3) || (b3 = r2.CompletionItem.create(t5), b3.textEdit = r2.TextEdit.replace(s3, D2(O2(v3))), b3.documentation = T2(v3), b3.insertTextFormat = r2.InsertTextFormat.Snippet, b3.detail = `Emmet Abbreviation`, b3.label = c3, b3.label += l3 ? `|` + l3.replace(`,`, `|`) : ``, x3 = [
                b3
              ]);
            }
          };
          if (M2(n4)) {
            let { prefixOptions: e4, abbreviationWithoutPrefix: t5 } = ae2(c3);
...
`) {
        ...
        function te2(e3, t4, n4) {
          let i3 = k2(e3, t4), { pos: o3, filter: s3 } = N2(i3.substr(0, t4.character), t4.character), c3 = s3 ? s3.length + 1 : 0;
          try {
            let e4 = n4;
            typeof e4 != `boolean` && (e4 || (e4 = {}), e4 = {
              syntax: M2(e4.syntax) || e4.syntax === `stylesheet` ? `stylesheet` : `markup`,
        ...
        t3.extractAbbreviation = te2;
        function ne2(e3, t4) {
          if (!e3) return;
          let { pos: n4, filter: r3 } = N2(e3, e3.length);
          try {
            return {
              abbreviation: a2(e3, n4, M2(t4) || t4 === `stylesheet` ? {
                syntax: `stylesheet`,
                lookAhead: false
              } : true).abbreviation,
              filter: r3
        ...
        t3.extractAbbreviationFromText = ne2;
        function re2(e3, t4) {
          if (!t4) return false;
          if (M2(e3)) return t4.endsWith(`:`) ? false : t4.indexOf(`#`) > -1 ? _e2.test(t4) || ge2.test(t4) : g2.test(t4);
        ...
        t3.isAbbreviationValid = re2;
        function ie2(e3, t4, n4) {
          if (M2(e3)) {
        ...
        function P2(e3, n4, r3) {
          n4 || (n4 = {}), n4.preferences = n4.preferences || {};
          let i3 = M2(e3) ? `css` : `html`;
          !A2[e3] && A2[i3] && (A2[e3] = A2[i3]);
          let a3 = le2(e3, n4.syntaxProfiles), o3 = a3 && a3.filters ? a3.filters.split(`,`) : [];
          ...
          return {
            ...
            profile: a3,
            addons: s3,
            variables: ue2(n4.variables),
            snippets: A2[e3],
            format: c3,
            preferences: l3
          };
        }
        t3.getExpandOptions = P2;
        function ae2(e3) {
...
`;
        ...
        t3.parseAbbreviation = se2;
        function ce2(e3, t4) {
          let n4, r3 = t4.preferences;
          if (delete t4.preferences, M2(t4.syntax) && typeof e3 == `string`) {
            let { prefixOptions: a3, abbreviationWithoutPrefix: o3 } = ae2(e3);
            n4 = i2.expand(o3, t4), n4 = oe2(n4, a3, r3);
          } else n4 = i2.expand(e3, t4);
          return D2(O2(n4));
        }
        t3.expandAbbreviation = ce2;
        function le2(e3, t4) {
          t4 || (t4 = {});
          let n4 = Object.assign({}, ee2, t4)[e3];
        ...
        function fe2(e3, t4) {
          if (!e3 || !e3.trim()) return me2(), Promise.resolve();
          if (e3 = e3.trim(), t4 = t4 ? t4.trim() : ``, e3[0] === `~` ? e3 = o2.join(l2.homedir(), e3.substr(1)) : !o2.isAbsolute(e3) && t4 && (e3 = o2.join(t4, e3)), !o2.isAbsolute(e3)) return me2(), Promise.reject(`The path provided in emmet.extensionsPath setting should be absoulte path`);
          if (!pe2(e3)) return me2(), Promise.reject(`The directory ${e3} doesnt exist. Update emmet.extensionsPath setting`);
            ...
            s2.readFile(r3, (n5, a4) => {
              ...
              try {
                ...
                j2 = n6.variables, A2 = {}, d2.clear(), Object.keys(n6).forEach((e6) => {
                  ...
                  let t6 = M2(e6) ? `css` : `html`, r4 = n6[e6].snippets;
                  if (n6[t6] && n6[t6].snippets && t6 !== e6 && (r4 = Object.assign({}, n6[t6].snippets, n6[e6].snippets)), M2(e6)) m2.set(e6, Object.keys(r4));
        ...
        t3.getEmmetMode = he2;
        let ge2 = /^[a-zA-Z]+:?#[\d.a-fA-F]{0,6}$/, _e2 = /^#[\d,a-f,A-F]{1,6}$/, ve2 = /^[a-z,A-Z]+$/;
        function ye2(e3, t4, n4, r3, i3) {
          return {
            getId: () => `emmet`,
            onCssProperty: (a3) => {
            ...
            onCssPropertyValue: (a3) => {
              if (a3 && a3.propertyValue) {
                ...
                if (!o3) return;
                if (o3.abbreviation === `${a3.propertyName}:${a3.propertyValue}` && ve2.test(a3.propertyValue) || _e2.test(o3.abbreviation) || o3.abbreviation === `!`) {
                  let a4 = S2(e3, t4, n4, r3);
                  i3 && a4 && (i3.items = a4.items, i3.isIncomplete = true);
                }
              }
        ...
        t3.getEmmetCompletionParticipants = ye2;
      },
      233: function(e2, t3) {
        Object.defineProperty(t3, `__esModule`, {
          value: true
...
`), d3 = a2.LineBreakTrivia;
    ...
    var { MAX_SAFE_COMPONENT_LENGTH: n2 } = ae(), r2 = P();
    e2 = t2.exports = {};
    ...
    var n2 = P(), { MAX_LENGTH: r2, MAX_SAFE_INTEGER: i2 } = ae(), { re: a2, t: o2 } = oe(), s2 = se(), { compareIdentifiers: c2 } = ce();
    t2.exports = class e3 {
      constructor(t3, c3) {
    ...
    e2.__esModule = true, e2.stripComments = e2.ensureObject = e2.getProp = e2.unesc = void 0, e2.unesc = t2(ve()).default, e2.getProp = t2(ye()).default, e2.ensureObject = t2(be()).default, e2.stripComments = t2(F()).default;
    function t2(e3) {
    ...
    e2.__esModule = true, e2.default = void 0;
    var n2 = o2(m()), r2 = xe(), i2 = o2(I()), a2 = L();
    function o2(e3) {
      return e3 && e3.__esModule ? e3 : {
        default: e3
      };
    ...
    var t2 = o2(m()), n2 = o2(ve()), r2 = o2(V()), i2 = L(), a2;
    function o2(e3) {
      return e3 && e3.__esModule ? e3 : {
        default: e3
      };
...
`), g2 = _2.length - 1, g2 > 0 ? (y2 = o3 + g2, b2 = v2 - _2[g2].length) : (y2 = o3, b2 = a3), S2 = t2.comment, o3 = y2, p2 = y2, f3 = v2 - b2) : l3 === t2.slash ? (v2 = s3, S2 = l3, p2 = o3, f3 = s3 - a3, c3 = v2 + 1) : (v2 = u2(r3, s3), S2 = t2.word, p2 = o3, f3 = v2 - a3), c3 = v2 + 1;
    ...
    e2.__esModule = true, e2.default = void 0;
    var n2 = w2(ge()), r2 = w2(_e()), i2 = w2(Se()), a2 = w2(Ce()), o2 = w2(z()), s2 = w2(we()), c2 = w2(B()), l2 = w2(Te()), u2 = w2(Ee()), d2 = w2(H()), f2 = C2(U()), p2 = w2(De()), m2 = w2(Oe()), h2 = w2(W()), g2 = w2(G()), _2 = C2(Ae()), v2 = C2(ke()), y2 = C2(L()), b2 = xe(), x2, S2;
    function C2(e3) {
      if (e3 && e3.__esModule) return e3;
      var t3 = {};
      if (e3 != null) {
    ...
    e2.default = (function() {
      function e3(e4, t4) {
        ...
        var n3 = M2(this.tokens[0], this.tokens[this.tokens.length - 1]);
      ...
      return t3._errorGenerator = function() {
        ...
        N2(r3, `attribute`), N2(r3, `namespace`), this.newNode(new f2.default(r3)), this.position++;
        ...
        if (this.isNamedCombinator() ? l3 = this.namedCombinator() : this.currToken[_2.FIELDS.TYPE] === v2.combinator ? (l3 = new m2.default({
          ...
          h3.endsWith(` `) && g3.endsWith(` `) ? (y3.before = h3.slice(0, h3.length - 1), b3.spaces.before = g3.slice(0, g3.length - 1)) : h3.startsWith(` `) && g3.startsWith(` `) ? (y3.after = h3.slice(1), b3.spaces.after = g3.slice(1)) : b3.value = g3, l3 = new m2.default({
            value: ` `,
            source: M2(s3, this.tokens[this.position - 1]),
        ...
        h3.forEach(function(n3, r3) {
          ...
          if (~f3.indexOf(n3)) {
            ...
            N2(x3, `value`), d4 = new l2.default(x3);
          }
        ...
        return t4 && (/^ +$/.test(t4) && (this.options.lossy || (this.spaces = (this.spaces || ``) + t4), t4 = true), e4.namespace = t4, N2(e4, `namespace`)), this.spaces && (this.spaces = (e4.spaces.before = this.spaces, ``)), this.current.append(e4);
    ...
    var t2 = p2(U()), n2 = p2(z()), r2 = p2(Oe()), i2 = p2(we()), a2 = p2(B()), o2 = p2(W()), s2 = p2(H()), c2 = p2(Se()), l2 = p2(Ce()), u2 = p2(Ee()), d2 = p2(Te()), f2 = p2(De());
    function p2(e3) {
      return e3 && e3.__esModule ? e3 : {
        default: e3
      };
    ...
    var t2 = L(), n2, r2 = (n2 = {}, n2[t2.ATTRIBUTE] = true, n2[t2.CLASS] = true, n2[t2.COMBINATOR] = true, n2[t2.COMMENT] = true, n2[t2.ID] = true, n2[t2.NESTING] = true, n2[t2.PSEUDO] = true, n2[t2.ROOT] = true, n2[t2.SELECTOR] = true, n2[t2.STRING] = true, n2[t2.TAG] = true, n2[t2.UNIVERSAL] = true, n2);
    function i2(e3) {
    ...
    var n2 = t2(y()), r2 = D(), i2 = t2(g()), a2 = t2(k()), o2 = t2(A()), s2 = t2(j()), c2 = t2(ee()), l2 = t2(M()), u2 = t2(re()), d2 = ie(), f2 = t2(de());
    fe();
    var p2 = t2(pe()), m2 = t2(me()), h2 = he(), _2 = t2(Ie());
    function v2(e3) {
    ...
    function se2(e3, t3, n3) {
      let r3 = [
        oe2(e3, t3.selector, n3, `__placeholder__`)
      ], i3 = t3;
    ...
    var ue2 = RegExp(`(?:^|\\s|\\(|,)(#(?:[0-9a-f]{2}){2,4}|(#[0-9a-f]{3})|(rgb|hsl)a?\\(\\s*(-?[\\d.]+%?(\\s*[,/]\\s*|\\s+)+){2,3}\\s*([\\d.]+%?|var\\([^)]+\\))?\\)|transparent|currentColor|${Object.keys(i2).join(`|`)})(?:$|\\s|\\)|,)`, `gi`);
    function ge2(e3) {
      return /(?:box|drop)-shadow/.test(e3) ? [] : Array.from((function(e4) {
        return e4.replace(/((?:rgb|hsl)a?\(\s*)var\([^,]+,\s*([^)]+)\)/gi, `$1$2`);
      })(e3).matchAll(ue2), (e4) => {
        let t3 = e4[1].replace(/var\([^)]+\)/, `1`);
        return le2(t3) ?? r2.parse(t3);
      }).filter(Boolean);
    }
    function _e2(e3) {
      ...
      if (!i3 && n3.some((e4) => !ce2.includes(e4))) return null;
      let a3 = (i3 ? t3 : n3).flatMap((t4) => w2(e3[t4]).flatMap(ge2)), o3 = S2(a3.map((e4) => typeof e4 == `string` ? e4 : r2.formatRgb({
        ...e4,
        alpha: void 0
      })));
    ...
    function ve2(e3, t3) {
      if (e3.jit) {
        if (e3.classNames) {
          ...
          if (r5 && r5.__rule) return _e2(b2(r5));
        }
        let { root: r4, rules: i4 } = P2(e3, [
          t3
        ]);
      ...
      return i3.__rule ? _e2(b2(i3)) : null;
    }
    function ye2(e3) {
      if (typeof e3 != `string`) return null;
      let t3 = e3.trim();
    ...
    var xe2 = `aspnetcorerazor.astro.astro-markdown.blade.django-html.edge.ejs.erb.gohtml.GoHTML.gohtmltmpl.haml.handlebars.hbs.html.HTML (Eex).HTML (EEx).html-eex.htmldjango.jade.leaf.liquid.markdown.mdx.mustache.njk.nunjucks.phoenix-heex.php.razor.slim.surface.twig`.split(`.`), I2 = [
      `css`,
      `less`,
      `postcss`,
      `sass`,
    ...
    function Ce2(e3, t3) {
      let n3 = Object.keys(e3.editor.userLanguages).filter((t4) => I2.includes(e3.editor.userLanguages[t4]));
      return [
        ...I2,
        ...n3
      ].indexOf(t3.languageId) !== -1;
    ...
    function z2(e3, t3, n3) {
      if (Ce2(e3, t3)) return true;
      if (We2(e3, t3) || Ge2(t3) || Ke2(t3) || R2(e3, t3)) {
        let r3 = J2(e3, t3, t3.getText({
          start: {
            line: 0,
            character: 0
    ...
    function H2(e3, t3) {
      return {
        start: {
          line: ((t3 == null ? void 0 : t3.start.line) || 0) + e3.start.line,
          character: (e3.end.line === 0 && (t3 == null ? void 0 : t3.start.character) || 0) + e3.start.character
        },
        end: {
          line: ((t3 == null ? void 0 : t3.start.line) || 0) + e3.end.line,
          character: (e3.end.line === 0 && (t3 == null ? void 0 : t3.start.character) || 0) + e3.end.character
        }
      };
    }
    function U2(e3, t3, n3) {
      ...
      return t3 === `js` || t3 === `jsx` ? (function(e4) {
        ...
        let t4 = ``;
        Oe2.reset(e4);
        for (let e5 of Oe2) t4 += e5.type === `commentLine` ? ` `.repeat(e5.value.length) : e5.type === `commentBlock` ? e5.value.replace(/./g, ` `) : e5.value;
        return t4;
      })(r3) : r3.replace(t3 === `css` ? /\/\*.*?\*\//gs : /<!--.*?-->/gs, De2);
    }
    function De2(e3) {
...
` : ` `);
    ...
    function G2(e3) {
      ...
      for (let e4 = 0; e4 < i3.length; e4++) {
        if (e4 % 2 == 0) {
          let s3 = K2(t3, o3), c3 = K2(t3, o3 + i3[e4].length);
          a3.push({
            className: i3[e4],
            classList: {
              classList: t3,
    ...
    async function ke2(e3, t3, n3, r3, i3) {
      return i3 === void 0 && (i3 = true), T2((await (async function(e4, t4, n4, r4, i4) {
        let a3;
        return i4 === void 0 && (i4 = true), a3 = r4 === `css` ? Ae2(t4, n4) : await Ne2(e4, t4, r4, n4), C2([
          ...a3,
          ...i4 ? await je2(e4, t4, n4) : []
        ]);
      })(e3, t3, n3, r3, i3)).map(G2));
    }
    function Ae2(e3, t3) {
      let n3 = U2(e3, `css`, t3), r3 = W2(/(@apply\s+)(?<classList>[^;}]+?)(?<important>\s*!important)?\s*[;}]/g, n3), i3 = t3 ? t3.start : {
        line: 0,
        character: 0
      };
      return r3.map((e4) => {
        let t4 = K2(n3, e4.index + e4[1].length), r4 = K2(n3, e4.index + e4[1].length + e4.groups.classList.length);
        return {
    ...
    async function je2(e3, t3, n3) {
      ...
      for (let e4 = 0; e4 < r3.length; e4++) try {
        ...
        for (; (o3 = u3.exec(i3)) !== null; ) {
          let e5 = t3.offsetAt((n3 == null ? void 0 : n3.start) || {
            line: 0,
            character: 0
    ...
    function Me2(e3, t3) {
      ...
      return W2(new RegExp(`(?:\\s|:|\\()(ATTRS)\\s*=\\s*['"\`{]`.replace(`ATTRS`, n3.join(`|`)), `gi`), e3);
    }
    async function Ne2(e3, t3, n3, r3) {
      let i3 = U2(t3, n3, r3), a3 = Me2(i3, (await e3.editor.getConfiguration(t3.uri)).tailwindCSS.classAttributes), o3 = [];
      return a3.forEach((e4) => {
        let t4 = i3.substr(e4.index + e4[0].length - 1), n4 = e4[0][0] === `:` || e4[1].startsWith(`[`) && e4[1].endsWith(`]`) ? Ee2() : Te2();
        n4.reset(t4);
        let a4, s3 = [];
        try {
        ...
        a4 && s3.push({
          ...
          let o4 = n5.match(/^\s*/), s4 = o4 === null ? 0 : o4[0].length, c3 = n5.match(/\s*$/), l3 = c3 === null ? 0 : -c3[0].length, u3 = K2(i3, e4.index + e4[0].length - 1 + a5 + s4), d3 = K2(i3, e4.index + e4[0].length - 1 + a5 + n5.length + l3);
          return {
            classList: n5.substr(s4, n5.length + l3),
            range: {
              start: {
                line: ((r3 == null ? void 0 : r3.start.line) || 0) + u3.line,
                character: (d3.line === 0 && (r3 == null ? void 0 : r3.start.character) || 0) + u3.character
              },
              end: {
                line: ((r3 == null ? void 0 : r3.start.line) || 0) + d3.line,
                character: (d3.line === 0 && (r3 == null ? void 0 : r3.start.character) || 0) + d3.character
              }
            }
          };
        }).filter((e5) => e5 !== null));
    ...
    async function Pe2(e3, t3) {
      if (Ce2(e3, t3)) return Ae2(t3);
      let n3 = J2(e3, t3);
      return n3 ? C2(T2([
        ...await Promise.all(n3.filter((e4) => e4.type === `html` || e4.type === `jsx`).map((n4) => {
          let { type: r3, range: i3 } = n4;
          return Ne2(e3, t3, r3 === `html` ? `html` : `jsx`, i3);
        })),
    ...
    function Le2(e3, t3) {
      let n3 = U2(e3, `css`, t3);
      return W2(/(?<prefix>[\s:;/*(){}])(?<helper>config|theme)(?<innerPrefix>\(\s*)(?<path>[^)]*?)\s*\)/g, n3).map((e4) => {
        ...
        return {
          ...
          ranges: {
            full: H2({
              start: K2(n3, o3),
              end: K2(n3, o3 + e4.groups.path.length)
            }, t3),
            path: H2({
              start: K2(n3, o3 + r3.length),
              end: K2(n3, o3 + r3.length + i3.length)
            }, t3)
          }
        };
      });
...
`, t3);
    ...
    }, Ve2 = o2.states(ze2), He2 = o2.states(Be2), Ue2 = new c2({
      max: 25,
      maxAge: 1e3
    });
    function J2(e3, t3, n3) {
      n3 === void 0 && (n3 = t3.getText());
      let r3 = `${t3.languageId}:${n3}`, i3 = Ue2.get(r3);
      if (i3 !== void 0) return i3;
      let a3 = R2(e3, t3), o3 = Ge2(t3) ? `none` : We2(e3, t3) || Ke2(t3) ? `html` : a3 ? `jsx` : null;
      if (o3 === null) return Ue2.set(r3, null), null;
      n3 = U2(n3, a3 ? `js` : `html`);
      let s3 = o3 === `none` ? He2 : Ve2;
      s3.reset(n3);
      let c3 = o3, l3 = [
        {
          type: o3,
      ...
      try {
        for (let e4 of s3) {
          ...
          } else e4.type === `lang` ? l3[l3.length - 1].type = e4.text : e4.type === `type` && Re2.includes(e4.text) && (l3[l3.length - 1].type = `html`);
          u3 += e4.text.length;
        }
      } catch {
        return Ue2.set(r3, null), null;
      }
      return l3[l3.length - 1].range.end || (l3[l3.length - 1].range.end = K2(n3, u3)), Ue2.set(r3, l3), l3;
    }
    function We2(e3, t3) {
      let n3 = Object.keys(e3.editor.userLanguages).filter((t4) => xe2.includes(e3.editor.userLanguages[t4]));
      return [
        ...xe2,
        ...n3
      ].indexOf(t3.languageId) !== -1;
    ...
    function Ye2(e3, t3, r3) {
      if (true !== t3.__rule && !Array.isArray(t3)) return null;
      if (Array.isArray(t3)) {
        let n3 = t3.map((t4) => Ye2(e3, t4, r3)).filter(Boolean);
...
`}${w2(t3[n3]).map((e5) => {
        let t4 = r3.tailwindCSS.showPixelEquivalents ? te2(e5, r3.tailwindCSS.rootFontSize) : void 0;
...
${c3}}`;
    ...
    function Z2(e3, t3) {
      ...
      return X2(e3, `0.99.0`) && (n3 = 1, r3 = `https://v1.tailwindcss.com/docs/`), X2(e3, `1.99.0`) && (n3 = 2, r3 = `https://tailwindcss.com/docs/`), `${r3}${Array.isArray(t3) ? t3[n3] || t3[t3.length - 1] : t3}`;
    }
    function Xe2(e3, t3) {
      let r3 = Array.isArray(t3) ? t3 : N2(e3, t3);
      if (!r3) return null;
      let i3 = n2(e3.classNames.classNames, [
        ...r3,
        `__info`
    ...
    function Qe2(e3, t3) {
      ...
      let n3 = Xe2(e3, t3);
      if (!n3) return null;
      if (X2(e3.version, `2.0.0-alpha.1`) || Ze2(e3, `applyComplexClasses`)) return {
        isApplyable: true
      };
    ...
    function $e2(e3, t3) {
      ...
      for (let t4 of a3) {
        if (!(n3.includes(t4) || e3.jit && (t4.includes(`[`) && t4.endsWith(`]`) || t4.includes(`/`)) && P2(e3, [
    ...
    function et2(e3, t3, i3, a3, o3) {
      ...
      if (e3.jit) {
        let { variants: t4, offset: s4 } = $e2(e3, c3);
        if (o3 && (o3.triggerKind === 1 || o3.triggerKind === 2 && o3.triggerCharacter === `/`) && c3.includes(`/`)) {
          ...
          if (t5) return Q2({
            isIncomplete: false,
            items: t5.map((t6, n3) => {
              let a4, o4 = `${i4}/${t6}`, s5 = 21, c4 = ve2(e3, o4);
        ...
        if (!l4) {
          ...
          d4.push(...e3.variants.flatMap((n4) => {
            ...
            if (n4.isArbitrary) a4.push(r3({
              ...
              let o4 = !X2(e3.version, `2.99.0`), s5 = [
                ...t4,
                n4.name
              ];
              if (o4) {
        ...
        return e3.classList ? Q2({
          ...
          items: d4.concat(e3.classList.map((t5, n3) => {
            ...
            return o4 && typeof o4 != `string` && (i4 = r2.formatRgb(o4)), {
              ...
              sortText: Y2(n3, e3.classList.length)
            };
          }))
        }, {
          data: {
          ...
          range: m3
        }, e3.editor.capabilities.itemDefaults) : Q2({
          isIncomplete: false,
    ...
    async function pt(t3, n3, r3) {
      ...
      if (i3 === `ignore`) return [];
      let a3 = [];
      return (await Pe2(t3, n3)).forEach((r4) => {
        let o3 = G2(r4);
        o3.forEach((r5, s3) => {
          if (t3.jit) {
            let { rules: c4 } = P2(t3, [
            ...
            let l4 = c4.map((e3) => {
              ...
              return e3.walkDecls((e4) => {
                ...
                context: se2(t3, e3, r5.className),
                properties: n4
              };
          ...
          if (!c3) return;
          let l3 = Object.keys(c3), u3 = Xe2(t3, r5.className), d3 = o3.filter((e3, t4) => t4 !== s3).filter((e3) => {
            let n4 = ft(t3, e3.className);
            if (!n4) return false;
            let r6 = Xe2(t3, e3.className);
    ...
    async function mt(t3, n3, r3) {
      ...
      return i3 === `ignore` ? [] : (await ke2(t3, n3, void 0, `css`, false)).map((n4) => {
        let r4 = Qe2(t3, n4.className);
    ...
    function _t(t3, n3, r3) {
      ...
      return o3.forEach((r4) => {
        let o4 = U2(n3, `css`, r4);
        W2(/(?:\s|^)@screen\s+(?<screen>[^\s{]+)/g, o4).forEach((n4) => {
          ...
          l3 && (c3.push(l3), s3 += ` Did you mean '${l3}'?`), a3.push({
            ...
            range: gt({
              start: K2(o4, n4.index + n4[0].length - n4.groups.screen.length),
              end: K2(o4, n4.index + n4[0].length)
            }, r4),
            severity: i3 === `error` ? 1 : 2,
            message: s3,
            suggestions: c3
    ...
    function vt(t3, n3, r3) {
      ...
      if (i3 === `ignore` || X2(t3.version, `2.99.0`)) return [];
      let a3 = [], o3 = [];
      if (Ce2(t3, n3)) o3.push(void 0);
      else {
        let e3 = J2(t3, n3);
      ...
      return t3.jit && (s3.unshift(`responsive`), s3 = s3.filter((e3) => !t3.screens.includes(e3))), o3.forEach((t4) => {
        let r4 = U2(n3, `css`, t4);
        W2(/(?:\s|^)@variants\s+(?<variants>[^{]+)/g, r4).forEach((n4) => {
    ...
    function Tt(t3, n3, r3) {
      ...
      let l3 = t3.jit && X2(t3.version, `2.1.99`);
      return o3.forEach((r4) => {
        let o4 = U2(n3, `css`, r4), c4 = W2(s3, o4), u3 = [
          `utilities`,
          `components`,
          `screens`,
          X2(t3.version, `1.0.0-beta.1`) ? `base` : `preflight`,
          l3 && `variants`
        ...
        l3 && (d3 = d3.filter((e3) => e3 !== `screens`)), c4.forEach((t4) => {
          ...
          a3.push({
            ...
            range: gt({
              start: K2(o4, t4.index + t4[0].length - t4.groups.value.length),
              end: K2(o4, t4.index + t4[0].length)
            }, r4),
            severity: i3 === `error` ? 1 : 2,
            message: n4,
            suggestions: s4
    ...
    async function Et(t3, n3, r3) {
      if (!t3.jit || X2(t3.version, `2.99.0`)) return [];
      let i3 = r3.tailwindCSS.lint.recommendedVariantOrder;
      if (i3 === `ignore`) return [];
      let a3 = [];
      return (await Pe2(t3, n3)).forEach((n4) => {
        G2(n4).forEach((n5) => {
          let { rules: r4 } = P2(t3, [
            n5.className
          ]);
          if (r4.length === 0) return;
          let { variants: o3, offset: s3 } = $e2(t3, n5.className), c3 = [
            ...o3
          ].sort((e3, n6) => ne2(t3.jitContext.variantOrder.get(n6) - t3.jitContext.variantOrder.get(e3)));
          (function(e3, t4) {
...
`, {
    ...
    e2.completionsFromClassList = et2, e2.culoriColorToVscodeColor = F2, e2.doCodeActions = async function(e3, t3) {
      ...
      return Promise.all(r3.map((r4) => at(r4) ? (async function(e4, t4, r5) {
        var _a;
        let i3 = e4.editor.documents.get(t4.textDocument.uri);
        if (!i3) return [];
        let a3, o3 = U2(i3, `css`), { postcss: s3 } = e4.modules, c3 = [], l3 = r5.className.classList.classList.split(/\s+/).length, u3 = N2(e4, r5.className.className), d3 = n2(e4.classNames.classNames, u3);
        if (Array.isArray(d3)) return [];
        if (!Ce2(e4, i3)) {
          let t5 = J2(e4, i3);
          if (!t5 || (a3 = (_a = t5.filter((e5) => e5.type === `css`).find((e5) => {
            let { range: t6 } = e5;
            return we2(r5.range.start, t6);
          })) == null ? void 0 : _a.range, !a3)) return [];
          o3 = U2(i3, `css`, a3);
        }
        try {
          await s3.module([
              ...
              return t5 === void 0 && (t5 = {}), (t6) => {
                t6.walkRules((t7) => {
                  ...
                  t7.walkAtRules(`apply`, (n3) => {
                    let i4 = Nt(n3.source);
                    if (a3 && (i4 = gt(i4, a3)), !we2(r5.range.start, i4)) return;
                    let s4 = (function(e5, t8, n4, r6) {
                      r6 === void 0 && (r6 = false);
                      let i5 = t8[t8.length - 1], a4 = Qe2(e5, [
                        i5
                      ]);
...
`).replace(/(@apply [^;\n]+)$/gm, `$1;`).replace(/([^\s^]){$/gm, `$1 {`).replace(/^\s+/gm, (e5) => (f3 === void 0 && (f3 = e5), e5.replace(new RegExp(f3, `g`), g2.indent))).replace(/^(\s+)(.*?[^{}]\n)([^\s}])/gm, `$1$2$1$3`)
      ...
      return e3 === null ? {
        ...
        return z2(e4, t4, n3) ? (function(e5, t5, n4, r4) {
          let i4 = (function(e6, t6) {
            let n5 = W2(/@apply\s+(?<classList>[^;}]*)$/gi, t6);
          ...
          return et2(e5, a4, {
            ...
            var _a, _b;
            if (t6.kind === 9) return X2(e5.version, `2.0.0-alpha.1`) || Ze2(e5, `applyComplexClasses`);
            let n5 = ((_a = t6.data) == null ? void 0 : _a.variants) ?? [], r5 = ((_b = t6.data) == null ? void 0 : _b.className) ?? t6.label, i5 = Qe2(e5, [
              ...n5,
              r5
            ]);
            return i5 !== null && true === i5.isApplyable;
          }, r4);
        })(e4, t4, n3, r3) : qe2(e4, t4, n3) || Se2(e4, t4, n3) ? (async function(e5, t5, n4, r4) {
          let i4 = t5.getText({
            start: t5.positionAt(Math.max(0, t5.offsetAt(n4) - 1e3)),
            end: n4
          }), a4 = Me2(i4, (await e5.editor.getConfiguration(t5.uri)).tailwindCSS.classAttributes);
          if (a4.length === 0) return null;
          let o3 = a4[a4.length - 1], s3 = o3[0][0] === `:` || o3[1].startsWith(`[`) && o3[1].endsWith(`]`) ? Ee2() : Te2();
        ...
        return Q2({
          ...
          items: Object.keys(u3).sort((e5, t5) => {
            let n3 = nt2(e5), r3 = nt2(t5);
            return n3 && !r3 ? -1 : !n3 && r3 ? 1 : n3 && r3 ? parseFloat(e5) - parseFloat(t5) : 0;
          }).map((e5, t5, n3) => {
            let i5 = ye2(u3[e5]), o4 = e5.indexOf(`.`) !== -1 && g2 && g2.endsWith(`.`), s4 = a4.charAt(a4.length - 1) !== `]` && (o4 || g2 && g2.endsWith(`[`)), c4 = Je2(u3[e5]);
            return {
              label: e5,
              sortText: Y2(t5, n3.length),
              commitCharacters: [
                !e5.includes(`.`) && `.`,
                !e5.includes(`[`) && `[`
              ].filter(Boolean),
          ...
          items: [
            {
              ...
              documentation: {
                kind: `markdown`,
                value: `Use the \`@tailwind\` directive to insert Tailwind\u2019s \`base\`, \`components\`, \`utilities\` and \`${e4.jit && X2(e4.version, `2.1.99`) ? `variants` : `screens`}\` styles into your CSS.

[Tailwind CSS Documentation](${Z2(e4.version, `functions-and-directives/#tailwind`)})`
              }
            },
            {
              label: `@screen`,
...
[Tailwind CSS Documentation](${Z2(e4.version, `functions-and-directives/#screen`)})`
              }
            },
            {
              label: `@apply`,
...
[Tailwind CSS Documentation](${Z2(e4.version, `functions-and-directives/#apply`)})`
              }
            },
            ...X2(e4.version, `1.8.0`) ? [
              {
...
[Tailwind CSS Documentation](${Z2(e4.version, `functions-and-directives/#layer`)})`
                }
              }
            ] : [],
            ...X2(e4.version, `2.99.0`) ? [] : [
              {
                label: `@variants`,
                documentation: {
                  kind: `markdown`,
...
[Tailwind CSS Documentation](${Z2(e4.version, `functions-and-directives/#variants`)})`
                }
              },
              {
                label: `@responsive`,
...
[Tailwind CSS Documentation](${Z2(e4.version, `functions-and-directives/#responsive`)})`
                }
              }
            ],
            ...X2(e4.version, `3.2.0`) ? [
...
[Tailwind CSS Documentation](${Z2(e4.version, `functions-and-directives/#config`)})`
                }
              }
            ] : []
          ].map((e5) => ({
        ...
        if (!z2(e4, t4, n3) || X2(e4.version, `2.99.0`)) return null;
        let r3 = t4.getText({
          start: {
            line: n3.line,
            character: 0
        ...
        return e4.jit && (a4.unshift(`responsive`), a4 = a4.filter((t5) => !e4.screens.includes(t5))), Q2({
          isIncomplete: false,
          items: a4.filter((e5) => o3.indexOf(e5) === -1).map((e5, t5, n4) => ({
            label: e5,
            kind: 21,
            sortText: Y2(t5, n4.length)
          }))
        }, {
          data: {
            ...e4.completionItemData ?? {},
...
[Tailwind CSS Documentation](${Z2(e4.version, `just-in-time-mode#variants-are-inserted-at-tailwind-variants`)})`
              }
            } : {
              label: `screens`,
              documentation: {
...
[Tailwind CSS Documentation](${Z2(e4.version, `functions-and-directives/#tailwind`)})`
        ...
        if (!z2(e4, t4, n3) || !X2(e4.version, `3.2.0`)) return null;
        let r3 = t4.getText({
          start: {
            line: n3.line,
            character: 0
        ...
        let r3 = !R2(e4, t4) && qe2(e4, t4, n3), i4 = R2(e4, t4) || Se2(e4, t4, n3), a4 = r3 ? `html` : i4 ? `jsx` : null;
        ...
        return c3.length < 2 ? null : et2(e4, c3[c3.length - 1], {
          start: {
            line: n3.line,
      ...
      return await (async function(e4, t4, r4) {
        let i3 = await (async function(e5, t5, n3) {
          ...
          return z2(e5, t5, n3) ? r5 = await ke2(e5, t5, a4, `css`) : qe2(e5, t5, n3) ? r5 = await ke2(e5, t5, a4, `html`) : Se2(e5, t5, n3) && (r5 = await ke2(e5, t5, a4, `jsx`)), r5.length === 0 ? null : r5.find((e6) => {
            let { range: t6 } = e6;
            return we2(n3, t6);
          }) || null;
        })(e4, t4, r4);
        ...
        if (e4.jit) {
          let { root: n3, rules: r5 } = P2(e4, [
            i3.className
          ]);
          return r5.length === 0 ? null : {
            contents: {
              language: `css`,
              value: await ae2(e4, n3, t4.uri)
            },
            range: i3.range
          };
        }
        let a3 = N2(e4, i3.className);
        if (!a3) return null;
        if (z2(e4, t4, r4)) {
          let t5 = Qe2(e4, a3);
          if (t5 === null || false === t5.isApplyable) return null;
        }
        let o3 = await e4.editor.getConfiguration(t4.uri), s3 = Ye2(i3.className, n2(e4.classNames.classNames, [
          ...a3,
          `__info`
        ]), o3);
        return s3 ? {
        ...
        for (let t5 of r4) if (we2(n3, t5.ranges.path)) {
          let n4 = Ct(e4, t5.path, t5.helper === `theme` ? [
            `theme`
          ] : []), r5 = n4.isValid ? Je2(n4.value) : null;
          return r5 === null ? null : {
            contents: {
              kind: `markdown`,
              value: [
...
`)
    ...
    }, e2.doValidate = Dt, e2.getColor = ve2, e2.getColorFromValue = ye2, e2.getDocumentColors = async function(e3, t3) {
      let r3 = [];
      return e3.enabled ? false === (await e3.editor.getConfiguration(t3.uri)).tailwindCSS.colorDecorators ? r3 : ((await Pe2(e3, t3)).forEach((t4) => {
        G2(t4).forEach((t5) => {
          let n3 = ve2(e3, t5.className);
          n3 !== null && typeof n3 != `string` && (n3.alpha ?? 1) !== 0 && r3.push({
            range: t5.range,
            color: F2(n3)
          });
        });
      }), Fe2(e3, t3).forEach((t4) => {
        let i3 = xt(t4.path), a3 = ye2(n2(e3.config, [
          ...t4.helper === `theme` ? [
            `theme`
          ] : [],
          ...i3
    ...
    }, e2.isCssConflictDiagnostic = it2, e2.isInvalidApplyDiagnostic = at, e2.isInvalidConfigPathDiagnostic = ct, e2.isInvalidScreenDiagnostic = ot, e2.isInvalidTailwindDirectiveDiagnostic = lt, e2.isInvalidVariantDiagnostic = st, e2.isRecommendedVariantOrderDiagnostic = ut, e2.resolveCompletionItem = async function(e3, t3) {
      var _a, _b, _c, _d;
      var r3;
      if ([
        `helper`,
        ...
        `@tailwind`,
        `filesystem`
      ].includes((_a = t3.data) == null ? void 0 : _a._type)) return t3;
      if (((_b = t3.data) == null ? void 0 : _b._type) === `screen`) {
        let r4 = n2(e3.config, [
          `theme`,
          `screens`
        ], n2(e3.config, [
      ...
      let i3 = ((_c = t3.data) == null ? void 0 : _c.className) ?? t3.label;
      (r3 = t3.data) != null && r3.important && (i3 = `!` + i3);
      let a3 = ((_d = t3.data) == null ? void 0 : _d.variants) ?? [];
      if (e3.jit) {
        if (t3.kind === 9 || t3.detail && t3.documentation) return t3;
        let { root: n3, rules: r4 } = P2(e3, [
          [
            ...a3,
            i3
          ].join(e3.separator)
        ...
        return r4.length === 0 || (t3.detail || (t3.detail = r4.length === 1 ? await (async function(e4, t4, n4) {
          ...
          return t4.walkDecls((e5) => {
            let { prop: t5, value: n5 } = e5, a4 = r5.tailwindCSS.showPixelEquivalents ? te2(n5, r5.tailwindCSS.rootFontSize) : void 0;
            i4.push(`${t5}: ${n5}${a4 ? `/* ${a4} */` : ``};`);
          }), i4.join(` `);
...
`)
      ...
      if (t3.kind === 9) t3.detail = e3.classNames.context[i3].join(`, `);
        ...
        if (true === t4.__rule) {
          ...
          return (function(e5, t5) {
            ...
            return n4.length !== r4.length && r4.length !== 0 && (n4 = r4), n4.map((n5) => w2(e5[n5]).map((e6) => {
              let r5 = t5.tailwindCSS.showPixelEquivalents ? te2(e6, t5.tailwindCSS.rootFontSize) : void 0;
              return `${n5}: ${e6}${r5 ? `/* ${r5} */` : ``};`;
            }).join(` `)).join(` `);
          })(b2(t4), n3);
        }
        ...
        let n3 = await e3.editor.getConfiguration(), r4 = Ye2([
          ...a3,
          i3
        ].join(`:`), o3, n3);
        r4 && (t3.documentation = {
...
`)
    ...
    update(t2, n2) {
      for (let n3 of t2) if (e2.isIncremental(n3)) {
        let e3 = J(n3.range), t3 = this.offsetAt(e3.start), r2 = this.offsetAt(e3.end);
    ...
    ensureBeforeEOL(e3, t2) {
      for (; e3 > t2 && Ue(this._content.charCodeAt(e3 - 1)); ) e3--;
      return e3;
    }
    get lineCount() {
      return this.getLineOffsets().length;
  ...
  function He(e2, t2, n2 = 0) {
    ...
    for (let t3 = 0; t3 < e2.length; t3++) {
      ...
      Ue(i2) && (i2 === 13 && t3 + 1 < e2.length && e2.charCodeAt(t3 + 1) === 10 && t3++, r2.push(n2 + t3 + 1));
    }
    return r2;
  }
  function Ue(e2) {
  ...
  function Je(e2, t2 = `3.0.0`) {
    ...
    let n2 = x(e2), r2 = {
      ...
      screens: ((_a = e2.theme) == null ? void 0 : _a.screens) ? Object.keys(e2.theme.screens) : [],
  ...
  function Ye(e2, t2) {
    ...
    let n2 = [];
    (0, Re.default)(e2).walk((e3) => {
      if (e3.type !== `word`) return true;
      let r3 = Re.default.unit(e3.value);
  ...
  var Y = [], X = new BroadcastChannel(`windpress`), Z = document.querySelector(`script#windpress\\:vfs[type="text/plain"]`);
  Z && (Ze(), new MutationObserver(async () => {
    await Xe();
  }).observe(Z, {
    characterData: true,
    subtree: true
  ...
  async function Xe() {
    let e2 = await T(h(Z.textContent)), t2 = qe(`<div class=""></div>`);
    Y = (await (0, K.doComplete)(Je(e2), t2, {
      character: 12,
      line: 0
    })).items.map((e3) => ({
      value: e3.label,
  ...
  await Xe();
  function Ze() {
    X.addEventListener(`message`, async (e2) => {
      let t2 = e2.data;
  ...
  async function Qe(e2) {
    ...
    let s2 = Y.filter((e3) => e3.value.includes(r2));
    if (a2 !== false) {
  ...
  async function $e(e2) {
    let t2 = e2.split(/\s+/).filter((e3) => e3 !== `` && e3 !== `|`), n2 = x(await T(h(Z.textContent))), r2 = t2.map((e3) => et(e3, n2)).filter((e3) => e3 !== null).map((e3) => Ye(e3, 16));
  ...
  function rt(e2, t2) {
    ...
    for (let i2 of e2) {
      let e3 = ((_a = S(/* @__PURE__ */ new Set([
        i2
      ]), t2).sort(([e4], [t3]) => _(t3 - e4))[0]) == null ? void 0 : _a[0]) ?? null;
  ...
  async function it(e2) {
    let t2 = h(Z.textContent), n2 = e2.split(/\s+/).filter((e3) => e3 !== `` && e3 !== `|`), r2 = [], i2 = x(await T(t2)), a2 = (i2.getClassOrder ? i2.getClassOrder(n2) : rt(n2, i2)).sort(([, e3], [, t3]) => e3 === t3 ? 0 : e3 === null ? -1 : t3 === null ? 1 : _(e3 - t3)).map(([e3]) => e3);
    return [
      ...r2,
      ...a2
    ].join(` `);
  }
  a(window, `windpress.module.classSorter.sort`, async (e2) => it(e2)), a(window, `windpress.module.classnameToCss.generate`, async (e2) => $e(e2)), a(window, `windpress.module.autocomplete.query`, (e2) => Qe(e2));
});

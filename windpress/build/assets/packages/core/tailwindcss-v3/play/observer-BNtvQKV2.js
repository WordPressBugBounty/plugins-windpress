import { t as e } from "../../../../build-BV_YydjA.js";
import { t } from "../../../../vfs-DGZNrgMJ.js";
import { t as n } from "../../../../instrumentation-smLkDHlJ.js";
...
var a = Promise.resolve(), o = 1, s = new n(), c = ``;
async function l() {
...
async function u(n2) {
  ...
  for (let e2 of document.querySelectorAll(`[class]`)) for (let t2 of e2.classList) r.has(t2) || (r.add(t2), a2.add(t2));
  s.end(`Collect classes`, { count: a2.size }), s.start(`Build utilities`), i.textContent = await e({ entrypoint: { css: `/main.css`, config: `/tailwind.config.js` }, contents: Array.from(r), volume: t(c || `e30=`) }), s.end(`Build utilities`);
}
function d(e2) {
  async function t2() {
    if (e2 !== `full`) return;

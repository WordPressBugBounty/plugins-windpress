import { i as e, r as t } from "../../../../lib-mImIBqnW.js";
import { t as n } from "../../../../set-Re2vSVSO.js";
import { t as r } from "../../../../fuse-Bga3a1fX.js";
import { t as i } from "../../../../vfs-DziqLF6T.js";
import { c as a, n as o, o as s, r as c } from "../../../../intellisense-CtRsPNrz.js";
...
function m(e2) {
  var _a;
  return ((_a = e2 == null ? void 0 : e2.find((e3) => e3.property.includes(`color`))) == null ? void 0 : _a.value) || null;
}
function h(n2) {
...
var _ = new BroadcastChannel(`windpress`), v = document.querySelector(`script#windpress\\:vfs[type="text/plain"]`), y, b;
async function x() {
  let e2 = i((v == null ? void 0 : v.textContent) || `e30=`);
  JSON.stringify(b) !== JSON.stringify(e2) && p(), b = e2, y = await a({ volume: b }), _.postMessage({ source: `windpress/intellisense`, target: `any`, task: `windpress.code-editor.saved.done` });
}
x(), _.addEventListener(`message`, async (e2) => {
  let t2 = e2.data;
  t2.source === `windpress/dashboard` && t2.target === `windpress/intellisense` && t2.task === `windpress.code-editor.saved` && x();
}), n(window, `windpress.module.autocomplete.query`, (e2) => g(b, y, e2)), n(window, `windpress.module.classnameToCss.generate`, async (e2) => l(y, e2)), n(window, `windpress.module.classSorter.sort`, async (e2) => u(y, e2));

...
let __tla = (async () => {
  ...
  M = {
    ...
    napi_delete_property(e2, t2, n2, i2) {
      ...
      return i2 && (a2.memory[i2] = c2 ? 1 : 0), r;
    },
    napi_has_property(e2, t2, n2, i2) {
      let a2 = y[e2], o2 = a2.get(t2), s2 = a2.get(n2);
      return a2.memory[i2] = s2 in o2 ? 1 : 0, r;
    },
    napi_has_own_property(e2, t2, n2, i2) {
      let a2 = y[e2], o2 = a2.get(t2), s2 = a2.get(n2);
      return a2.memory[i2] = o2.hasOwnProperty(s2) ? 1 : 0, r;
    },
    ...
    napi_get_value_bool(e2, t2, n2) {
      ...
      return typeof a2 == `boolean` ? (i2.memory[n2] = a2 ? 1 : 0, r) : s;
    },
    ...
    napi_get_value_bigint_int64(e2, t2, n2, i2) {
      ...
      return typeof o2 == `bigint` ? (a2.i64[n2 >> 3] = o2, i2 && (a2.memory[i2] = BigInt.asIntN(64, o2) === o2 ? 1 : 0), r) : f;
    },
    ...
    napi_get_value_bigint_uint64(e2, t2, n2, i2) {
      let a2 = y[e2], o2 = a2.get(t2);
      return typeof o2 == `bigint` ? (a2.u64[n2 >> 3] = o2, i2 && (a2.memory[i2] = BigInt.asUintN(64, o2) === o2 ? 1 : 0), r) : f;
    },
    ...
    napi_has_element(e2, t2, n2, i2) {
      let a2 = y[e2], o2 = a2.get(t2);
      return a2.memory[i2] = o2.hasOwnProperty(n2) ? 1 : 0, r;
    },
    napi_delete_element(e2, t2, n2, i2) {
      ...
      return i2 && (a2.memory[i2] = s2 ? 1 : 0), r;
    },
    ...
    napi_is_exception_pending(e2, t2) {
      let n2 = y[e2];
      return n2.memory[t2] = n2.pendingException ? 1 : 0, r;
    },
    ...
    napi_is_detached_arraybuffer(e2, t2, n2) {
      let i2 = y[e2], a2 = i2.get(t2);
      return i2.memory[n2] = a2.byteLength === 0 ? 1 : 0, r;
    },
    ...
    napi_instanceof(e2, t2, n2, i2) {
      let a2 = y[e2], o2 = a2.get(t2), s2 = a2.get(n2);
      return a2.memory[i2] = o2 instanceof s2 ? 1 : 0, r;
    },
    napi_is_array(e2, t2, n2) {
      let i2 = y[e2], a2 = i2.get(t2);
      return i2.memory[n2] = Array.isArray(a2) ? 1 : 0, r;
    },
    ...
    napi_is_date(e2, t2, n2) {
      let i2 = y[e2], a2 = i2.get(t2);
      return i2.memory[n2] = a2 instanceof Date ? 1 : 0, r;
    },
    napi_is_error(e2, t2, n2) {
      let i2 = y[e2], a2 = i2.get(t2);
      return i2.memory[n2] = a2 instanceof Error ? 1 : 0, r;
    },
    ...
    napi_is_dataview(e2, t2, n2) {
      let i2 = y[e2], a2 = i2.get(t2);
      return i2.memory[n2] = a2 instanceof DataView ? 1 : 0, r;
    },
    napi_strict_equals(e2, t2, n2, i2) {
      let a2 = y[e2];
      return a2.memory[i2] = a2.get(t2) === a2.get(n2) ? 1 : 0, r;
    },
    ...
    napi_is_promise(e2, t2, n2) {
      let i2 = y[e2], a2 = i2.get(t2);
      return i2.memory[n2] = a2 instanceof Promise ? 1 : 0, r;
    },
  ...
  async function Y(n2) {
    try {
      return (await t(() => import("./lib-CMyM_l5W.js").then(async (m2) => {
        await m2.__tla;
        return m2;

...
import { Ht as t, tt as n, vn as r } from "./runtime-core.esm-bundler-Ci9kEgM7.js";
import { t as i } from "./set-HZS68aKk.js";
import { t as a } from "./debounce-BMzMU_Rn.js";
import { t as o } from "./preload-helper-CwQZjUKM.js";
import { t as s } from "./logger-CvF98D4V.js";
import { n as c, t as l } from "./tippy.esm-xwih-lH8.js";
import { n as u, t as d } from "./dist-CCcGKf8W.js";
import { n as f, t as p } from "./highlight-in-textarea-Dumnq8Ln.js";
import { t as m } from "./tribute.min-C_Ysp1ge.js";
import { a as h, i as g, n as _, r as v } from "./constant-Bodr-Y8K.js";
(async () => {
  var y = e(m(), 1), b = null;
  (async () => {
    b = await u({
      themes: [
        o(() => import("./dark-plus-Cs2F2srj.js").then(async (m2) => {
          await m2.__tla;
          return m2;
        }), [], import.meta.url),
        o(() => import("./light-plus-DVQuIRkW.js").then(async (m2) => {
          await m2.__tla;
          return m2;
        }), [], import.meta.url)
      ],
      langs: [
        o(() => import("./css-BsVw1vtW.js").then(async (m2) => {
          await m2.__tla;
          return m2;
        }), [], import.meta.url)
      ],
      engine: d(o(() => import("./wasm-BnjxR4X6.js").then(async (m2) => {
        await m2.__tla;
        return m2;
      }), [], import.meta.url))
    });
...
`).querySelector(`#windpressbreakdance-plc-class-sort`);
  ...
  async function P() {
    ...
    x.focus(), i(h.$store.getters[`ui/activeElement`].data, `properties.settings.advanced.classes`, x.value.trim().split(` `).filter((e2) => e2.trim() !== ``) || []);
  }
  ...
  function U() {
    ...
    let i2 = r(null), o2 = a(function(e3) {
      let t2 = e3.clientX, n3 = e3.clientY;
      i2.value = document.elementsFromPoint(t2, n3).find((e4) => e4.matches(`mark[class="word"]`)) || null;
    }, 10);
    e2.addEventListener(`mousemove`, o2), e2.addEventListener(`mouseleave`, function(e3) {
      o2.cancel(), i2.value = null;
    }), t(i2, (e3, t2) => {

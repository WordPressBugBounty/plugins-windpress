...
var _Me_instances, e_fn, t_fn, n_fn, _a2;
...
var _ = { color: d, length: de, percentage: se, ratio: le, number: ae, integer: E, url: b, position: fe, "bg-size": pe, "line-width": x, image: ee, "family-name": w, "generic-name": te, "absolute-size": ne, "relative-size": re, angle: he, vector: _e };
function v(e3, t2) {
...
var Ae = /* @__PURE__ */ new Map([[`--font`, [`--font-weight`, `--font-size`]], [`--inset`, [`--inset-shadow`, `--inset-ring`]], [`--text`, [`--text-color`, `--text-decoration-color`, `--text-decoration-thickness`, `--text-indent`, `--text-shadow`, `--text-underline-offset`]], [`--grid-column`, [`--grid-column-start`, `--grid-column-end`]], [`--grid-row`, [`--grid-row-start`, `--grid-row-end`]]]);
function je(e3, t2) {
  return (Ae.get(t2) ?? []).some((t3) => e3 === t3 || e3.startsWith(`${t3}-`));
}
var Me = (_a2 = class {
  ...
  keysInNamespaces(e3) {
    ...
    for (let n2 of e3) {
      let e4 = `${n2}-`;
      for (let r2 of this.values.keys()) r2.startsWith(e4) && r2.indexOf(`--`, 2) === -1 && (je(r2, n2) || t2.push(r2.slice(e4.length)));
    }
    return t2;
  }
  get(e3) {
  ...
  getOptions(e3) {
    return e3 = ke(__privateMethod(this, _Me_instances, e_fn).call(this, e3)), this.values.get(e3)?.options ?? 0;
  }
  entries() {
  ...
  markUsedVariable(e3) {
    let t2 = ke(__privateMethod(this, _Me_instances, e_fn).call(this, e3)), n2 = this.values.get(t2);
    if (!n2) return false;
    let r2 = n2.options & 16;
    return n2.options |= 16, !r2;
  }
  resolve(e3, t2, n2 = 0) {
    let r2 = __privateMethod(this, _Me_instances, t_fn).call(this, e3, t2);
    if (!r2) return null;
    let i2 = this.values.get(r2);
    return (n2 | i2.options) & 1 ? i2.value : __privateMethod(this, _Me_instances, n_fn).call(this, r2);
  }
  resolveValue(e3, t2) {
    let n2 = __privateMethod(this, _Me_instances, t_fn).call(this, e3, t2);
  ...
  resolveWith(e3, t2, n2 = []) {
    ...
    for (let e4 of n2) {
      ...
      n3 && (n3.options & 1 ? i2[e4] = n3.value : i2[e4] = __privateMethod(this, _Me_instances, n_fn).call(this, t3));
    }
    let a2 = this.values.get(r2);
    return a2.options & 1 ? [a2.value, i2] : [__privateMethod(this, _Me_instances, n_fn).call(this, r2), i2];
  }
  namespace(e3) {
...
}, _Me_instances = new WeakSet(), e_fn = function(e3) {
  ...
  if (!t2) return null;
  let n2 = null;
  return t2.options & 2 && (n2 = t2.value), `var(${Oe(this.prefixKey(e3))}${n2 ? `, ${n2}` : ``})`;
}, _a2), Ne = `4.3.0`;
function Pe(e3) {
  let t2 = [0];
...
var Fe = 92, Ie = 47, Le = 42, Re = 34, ze = 39, Be = 58, Ve = 59, A = 10, He = 13, Ue = 32, We = 9, Ge = 123, Ke = 125, qe = 40, Je = 41, Ye = 91, Xe = 93, Ze = 45, Qe = 64, $e = 33, et = class e2 extends Error {
  constructor(t2, n2) {
    if (n2) {
      let e3 = n2[0], r2 = Pe(e3.code).find(n2[1]);
...
function tt(e3, t2) {
  ...
  for (let t3 = 0; t3 < e3.length; t3++) {
    ...
    if (!(f2 === He && (d2 = e3.charCodeAt(t3 + 1), d2 === A))) if (f2 === Fe) c2 === `` && (u2 = t3), c2 += e3.slice(t3, t3 + 2), t3 += 1;
    else if (f2 === Ie && e3.charCodeAt(t3 + 1) === Le) {
      let r3 = t3;
      for (let n3 = t3 + 2; n3 < e3.length; n3++) if (d2 = e3.charCodeAt(n3), d2 === Fe) n3 += 1;
      else if (d2 === Le && e3.charCodeAt(n3 + 1) === Ie) {
        t3 = n3 + 1;
        break;
      }
      let a3 = e3.slice(r3, t3 + 1);
      if (a3.charCodeAt(2) === $e) {
        let e4 = Tt(a3.slice(2, -2));
        i2.push(e4), n2 && (e4.src = [n2, r3, t3 + 1], e4.dst = [n2, r3, t3 + 1]);
      }
    } else if (f2 === ze || f2 === Re) {
      let r3 = it(e3, t3, f2, n2);
      c2 += e3.slice(t3, r3 + 1), t3 = r3;
    } else {
      if ((f2 === Ue || f2 === A || f2 === We) && (d2 = e3.charCodeAt(t3 + 1)) && (d2 === Ue || d2 === A || d2 === We || d2 === He && (d2 = e3.charCodeAt(t3 + 2)) && d2 == A)) continue;
      if (f2 === A) {
        if (c2.length === 0) continue;
        d2 = c2.charCodeAt(c2.length - 1), d2 !== Ue && d2 !== A && d2 !== We && (c2 += ` `);
      } else if (f2 === Ze && e3.charCodeAt(t3 + 1) === Ze && c2.length === 0) {
        let i3 = ``, a3 = t3, s3 = -1;
        for (let r3 = t3 + 2; r3 < e3.length; r3++) if (d2 = e3.charCodeAt(r3), d2 === Fe) r3 += 1;
        else if (d2 === ze || d2 === Re) r3 = it(e3, r3, d2, n2);
        else if (d2 === Ie && e3.charCodeAt(r3 + 1) === Le) {
          for (let t4 = r3 + 2; t4 < e3.length; t4++) if (d2 = e3.charCodeAt(t4), d2 === Fe) t4 += 1;
          else if (d2 === Le && e3.charCodeAt(t4 + 1) === Ie) {
            r3 = t4 + 1;
            break;
          }
        } else if (s3 === -1 && d2 === Be) s3 = c2.length + r3 - a3;
        else if (d2 === Ve && i3.length === 0) {
          c2 += e3.slice(a3, r3), t3 = r3;
          break;
        } else if (d2 === qe) i3 += `)`;
        else if (d2 === Ye) i3 += `]`;
        else if (d2 === Ge) i3 += `}`;
        else if ((d2 === Ke || e3.length - 1 === r3) && i3.length === 0) {
          t3 = r3 - 1, c2 += e3.slice(a3, r3);
          break;
        } else (d2 === Je || d2 === Xe || d2 === Ke) && i3.length > 0 && e3[r3] === i3[i3.length - 1] && (i3 = i3.slice(0, -1));
        let l3 = rt(c2, s3);
        if (!l3) throw new et(`Invalid custom property, expected a value`, n2 ? [n2, a3, t3] : null);
        n2 && (l3.src = [n2, a3, t3], l3.dst = [n2, a3, t3]), o2 ? o2.nodes.push(l3) : r2.push(l3), c2 = ``;
      } else if (f2 === Ve && c2.charCodeAt(0) === Qe) s2 = nt(c2), n2 && (s2.src = [n2, u2, t3], s2.dst = [n2, u2, t3]), o2 ? o2.nodes.push(s2) : r2.push(s2), c2 = ``, s2 = null;
      else if (f2 === Ve && l2[l2.length - 1] !== `)`) {
        let e4 = rt(c2);
        if (!e4) {
          if (c2.length === 0) continue;
          throw new et(`Invalid declaration: \`${c2.trim()}\``, n2 ? [n2, u2, t3] : null);
        }
        n2 && (e4.src = [n2, u2, t3], e4.dst = [n2, u2, t3]), o2 ? o2.nodes.push(e4) : r2.push(e4), c2 = ``;
      } else if (f2 === Ge && l2[l2.length - 1] !== `)`) l2 += `}`, s2 = z(c2.trim()), n2 && (s2.src = [n2, u2, t3], s2.dst = [n2, u2, t3]), o2 && o2.nodes.push(s2), a2.push(o2), o2 = s2, c2 = ``, s2 = null;
      else if (f2 === Ke && l2[l2.length - 1] !== `)`) {
        if (l2 === ``) throw new et(`Missing opening {`, n2 ? [n2, t3, t3] : null);
        if (l2 = l2.slice(0, -1), c2.length > 0) if (c2.charCodeAt(0) === Qe) s2 = nt(c2), n2 && (s2.src = [n2, u2, t3], s2.dst = [n2, u2, t3]), o2 ? o2.nodes.push(s2) : r2.push(s2), c2 = ``, s2 = null;
        else {
          let e5 = c2.indexOf(`:`);
          if (o2) {
            let r3 = rt(c2, e5);
            if (!r3) throw new et(`Invalid declaration: \`${c2.trim()}\``, n2 ? [n2, u2, t3] : null);
        ...
        if (l2[l2.length - 1] !== `)`) throw new et(`Missing opening (`, n2 ? [n2, t3, t3] : null);
        l2 = l2.slice(0, -1), c2 += `)`;
      } else {
        if (c2.length === 0 && (f2 === Ue || f2 === A || f2 === We)) continue;
  ...
  if (l2.length > 0 && o2) {
    if (o2.kind === `rule`) throw new et(`Missing closing } at ${o2.selector}`, o2.src ? [o2.src[0], o2.src[1], o2.src[1]] : null);
    if (o2.kind === `at-rule`) throw new et(`Missing closing } at ${o2.name} ${o2.params}`, o2.src ? [o2.src[0], o2.src[1], o2.src[1]] : null);
  }
...
function rt(e3, t2 = e3.indexOf(`:`)) {
  if (t2 === -1) return null;
  let n2 = e3.indexOf(`!important`, t2 + 1);
  return B(e3.slice(0, t2).trim(), e3.slice(t2 + 1, n2 === -1 ? e3.length : n2).trim(), n2 !== -1);
}
function it(e3, t2, n2, r2 = null) {
  let i2;
  for (let a2 = t2 + 1; a2 < e3.length; a2++) if (i2 = e3.charCodeAt(a2), i2 === Fe) a2 += 1;
  else {
    if (i2 === n2) return a2;
    if (i2 === Ve && (e3.charCodeAt(a2 + 1) === A || e3.charCodeAt(a2 + 1) === He && e3.charCodeAt(a2 + 2) === A)) throw new et(`Unterminated string: ${e3.slice(t2, a2 + 1) + String.fromCharCode(n2)}`, r2 ? [r2, t2, a2 + 1] : null);
    if (i2 === A || i2 === He && e3.charCodeAt(a2 + 1) === A) throw new et(`Unterminated string: ${e3.slice(t2, a2) + String.fromCharCode(n2)}`, r2 ? [r2, t2, a2 + 1] : null);
  }
  return t2;
}
...
function z(e3, t2 = []) {
  return e3.charCodeAt(0) === wt ? nt(e3, t2) : L(e3, t2);
}
...
var Qt = new j((e3) => {
  ...
  return I(t2, (e4, i2) => {
    ...
    if (e4.kind === `word` && r2.has(e4.value)) {
      ...
      n2.add(i3), n2.add(o2);
    } else if (e4.kind === `separator` && e4.value.length > 0 && e4.value.trim() === ``) (a2[0] === e4 || a2[a2.length - 1] === e4) && n2.add(e4);
      ...
      let i3 = a2[t3 - 2];
      return i3 && !r2.has(i3.value) ? void 0 : F.ReplaceSkip({ kind: `function`, value: ``, nodes: [e4] });
    }
  }), n2.size > 0 && I(t2, (e4) => {
...
function gn(e3) {
  ...
  function i2(r3, i3) {
    ...
    function a3({ negative: t3 }) {
      return (n3) => {
        ...
        if (r4 !== null) return i3.handle(t3 ? m(`calc(${r4} * -1)`) : r4, a4);
      };
    }
  ...
  let h2 = () => V([W(`--tw-gradient-position`), W(`--tw-gradient-from`, `#0000`, `<color>`), W(`--tw-gradient-via`, `#0000`, `<color>`), W(`--tw-gradient-to`, `#0000`, `<color>`), W(`--tw-gradient-stops`), W(`--tw-gradient-via-stops`), W(`--tw-gradient-from-position`, `0%`, `<length-percentage>`), W(`--tw-gradient-via-position`, `50%`, `<length-percentage>`), W(`--tw-gradient-to-position`, `100%`, `<length-percentage>`)]);
  function _2(r3, i3) {
    t2.functional(r3, (t3) => {
      if (t3.value) {
        if (t3.value.kind === `arbitrary`) {
  ...
  _2(`from`, { color: (e4) => [h2(), B(`--tw-sort`, `--tw-gradient-from`), B(`--tw-gradient-from`, e4), B(`--tw-gradient-stops`, `var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))`)], position: (e4) => [h2(), B(`--tw-gradient-from-position`, e4)] }), r2(`via-none`, [[`--tw-gradient-via-stops`, `initial`]]), _2(`via`, { color: (e4) => [h2(), B(`--tw-sort`, `--tw-gradient-via`), B(`--tw-gradient-via`, e4), B(`--tw-gradient-via-stops`, `var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-via) var(--tw-gradient-via-position), var(--tw-gradient-to) var(--tw-gradient-to-position)`), B(`--tw-gradient-stops`, `var(--tw-gradient-via-stops)`)], position: (e4) => [h2(), B(`--tw-gradient-via-position`, e4)] }), _2(`to`, { color: (e4) => [h2(), B(`--tw-sort`, `--tw-gradient-to`), B(`--tw-gradient-to`, e4), B(`--tw-gradient-stops`, `var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))`)], position: (e4) => [h2(), B(`--tw-gradient-to-position`, e4)] }), r2(`mask-none`, [[`mask-image`, `none`]]), t2.functional(`mask`, (e4) => {
  ...
  let y2 = () => V([W(`--tw-mask-linear`, `linear-gradient(#fff, #fff)`), W(`--tw-mask-radial`, `linear-gradient(#fff, #fff)`), W(`--tw-mask-conic`, `linear-gradient(#fff, #fff)`)]);
  function b2(r3, i3) {
    t2.functional(r3, (t3) => {
      if (t3.value) {
        if (t3.value.kind === `arbitrary`) {
  ...
  let x2 = () => V([W(`--tw-mask-left`, `linear-gradient(#fff, #fff)`), W(`--tw-mask-right`, `linear-gradient(#fff, #fff)`), W(`--tw-mask-bottom`, `linear-gradient(#fff, #fff)`), W(`--tw-mask-top`, `linear-gradient(#fff, #fff)`)]);
  function S2(e4, t3, n3) {
    b2(e4, { color(e5) {
      let r3 = [y2(), x2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-linear`, `var(--tw-mask-left), var(--tw-mask-right), var(--tw-mask-bottom), var(--tw-mask-top)`)];
  ...
  let C2 = () => V([W(`--tw-mask-linear-position`, `0deg`), W(`--tw-mask-linear-from-position`, `0%`), W(`--tw-mask-linear-to-position`, `100%`), W(`--tw-mask-linear-from-color`, `black`), W(`--tw-mask-linear-to-color`, `transparent`)]);
  i2(`mask-linear`, { defaultValue: null, supportsNegative: true, supportsFractions: false, handleBareValue(e4) {
    ...
    return E(e4.value) ? `calc(1deg * -${e4.value})` : null;
  }, handle: (e4) => [y2(), C2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-linear`, `linear-gradient(var(--tw-mask-linear-stops, var(--tw-mask-linear-position)))`), B(`--tw-mask-linear-position`, e4)] }), n2(`mask-linear`, () => [{ supportsNegative: true, values: [`0`, `1`, `2`, `3`, `6`, `12`, `45`, `90`, `180`] }]), b2(`mask-linear-from`, { color: (e4) => [y2(), C2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-linear-stops`, `var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)`), B(`--tw-mask-linear`, `linear-gradient(var(--tw-mask-linear-stops))`), B(`--tw-mask-linear-from-color`, e4)], position: (e4) => [y2(), C2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-linear-stops`, `var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)`), B(`--tw-mask-linear`, `linear-gradient(var(--tw-mask-linear-stops))`), B(`--tw-mask-linear-from-position`, e4)] }), b2(`mask-linear-to`, { color: (e4) => [y2(), C2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-linear-stops`, `var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)`), B(`--tw-mask-linear`, `linear-gradient(var(--tw-mask-linear-stops))`), B(`--tw-mask-linear-to-color`, e4)], position: (e4) => [y2(), C2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-linear-stops`, `var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)`), B(`--tw-mask-linear`, `linear-gradient(var(--tw-mask-linear-stops))`), B(`--tw-mask-linear-to-position`, e4)] });
  let ee2 = () => V([W(`--tw-mask-radial-from-position`, `0%`), W(`--tw-mask-radial-to-position`, `100%`), W(`--tw-mask-radial-from-color`, `black`), W(`--tw-mask-radial-to-color`, `transparent`), W(`--tw-mask-radial-shape`, `ellipse`), W(`--tw-mask-radial-size`, `farthest-corner`), W(`--tw-mask-radial-position`, `center`)]);
  r2(`mask-circle`, [[`--tw-mask-radial-shape`, `circle`]]), r2(`mask-ellipse`, [[`--tw-mask-radial-shape`, `ellipse`]]), r2(`mask-radial-closest-side`, [[`--tw-mask-radial-size`, `closest-side`]]), r2(`mask-radial-farthest-side`, [[`--tw-mask-radial-size`, `farthest-side`]]), r2(`mask-radial-closest-corner`, [[`--tw-mask-radial-size`, `closest-corner`]]), r2(`mask-radial-farthest-corner`, [[`--tw-mask-radial-size`, `farthest-corner`]]), r2(`mask-radial-at-top`, [[`--tw-mask-radial-position`, `top`]]), r2(`mask-radial-at-top-left`, [[`--tw-mask-radial-position`, `top left`]]), r2(`mask-radial-at-top-right`, [[`--tw-mask-radial-position`, `top right`]]), r2(`mask-radial-at-bottom`, [[`--tw-mask-radial-position`, `bottom`]]), r2(`mask-radial-at-bottom-left`, [[`--tw-mask-radial-position`, `bottom left`]]), r2(`mask-radial-at-bottom-right`, [[`--tw-mask-radial-position`, `bottom right`]]), r2(`mask-radial-at-left`, [[`--tw-mask-radial-position`, `left`]]), r2(`mask-radial-at-right`, [[`--tw-mask-radial-position`, `right`]]), r2(`mask-radial-at-center`, [[`--tw-mask-radial-position`, `center`]]), i2(`mask-radial-at`, { defaultValue: null, supportsNegative: false, supportsFractions: false, handle: (e4) => [B(`--tw-mask-radial-position`, e4)] }), i2(`mask-radial`, { defaultValue: null, supportsNegative: false, supportsFractions: false, handle: (e4) => [y2(), ee2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-radial`, `radial-gradient(var(--tw-mask-radial-stops, var(--tw-mask-radial-size)))`), B(`--tw-mask-radial-size`, e4)] }), b2(`mask-radial-from`, { color: (e4) => [y2(), ee2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-radial-stops`, `var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)`), B(`--tw-mask-radial`, `radial-gradient(var(--tw-mask-radial-stops))`), B(`--tw-mask-radial-from-color`, e4)], position: (e4) => [y2(), ee2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-radial-stops`, `var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)`), B(`--tw-mask-radial`, `radial-gradient(var(--tw-mask-radial-stops))`), B(`--tw-mask-radial-from-position`, e4)] }), b2(`mask-radial-to`, { color: (e4) => [y2(), ee2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-radial-stops`, `var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)`), B(`--tw-mask-radial`, `radial-gradient(var(--tw-mask-radial-stops))`), B(`--tw-mask-radial-to-color`, e4)], position: (e4) => [y2(), ee2(), B(`mask-image`, `var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)`), B(`mask-composite`, `intersect`), B(`--tw-mask-radial-stops`, `var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)`), B(`--tw-mask-radial`, `radial-gradient(var(--tw-mask-radial-stops))`), B(`--tw-mask-radial-to-position`, e4)] });
...
function lr(e3, t2 = null, n2 = true) {
  let [r2, i2] = ur(P(e3), t2, n2);
  return r2 ? N(i2) : e3;
}
function ur(e3, t2 = null, n2 = true) {
  let r2 = false;
  return I(e3, { exit(e4) {
    if (e4.kind === `word` && e4.value !== `0`) {
      let i2 = dr(e4.value, t2, n2);
      return i2 === null || i2 === e4.value ? void 0 : (r2 = true, F.ReplaceSkip(M(i2)));
    } else if (e4.kind === `function` && (e4.value === `calc` || e4.value === ``)) {
      if (e4.nodes.length !== 5 || e4.nodes[2].kind !== `word`) return;
      let t3 = e4.nodes[0], n3 = e4.nodes[2].value, i2 = e4.nodes[4], a2 = t3.kind === `word` ? Xn.get(t3.value) : null, o2 = i2.kind === `word` ? Xn.get(i2.value) : null;
      if (n3 === `*` && (a2?.[0] === 0 && a2?.[1] === null || o2?.[0] === 0 && o2?.[1] === null)) return r2 = true, F.ReplaceSkip(M(`0`));
      if (n3 === `*`) {
        if (a2?.[0] === 1 && a2?.[1] === null) return r2 = true, F.ReplaceSkip(i2);
        if (o2?.[0] === 1 && o2?.[1] === null) return r2 = true, F.ReplaceSkip(t3);
      }
      if (n3 === `*` || n3 === `+`) {
        let s2 = a2 ?? o2, c2 = a2 === null ? t3 : o2 === null ? i2 : null;
        if (s2 !== null && c2 !== null && c2.kind === `function` && (c2.value === `calc` || c2.value === ``) && c2.nodes.length === 5 && c2.nodes[2].kind === `word` && c2.nodes[2].value === n3) {
          ...
          if (l2 !== null && u2 !== null) {
            if (n3 === `*` && !(s2[1] === null && l2[1] === null || s2[1] === null && l2[1] !== null || s2[1] !== null && l2[1] === null) || n3 === `+` && s2[1] !== l2[1]) return;
            let t5;
            switch (n3) {
              case `*`:
      ...
      switch (n3) {
        case `*`:
          if (a2[1] === o2[1] || a2[1] === null && o2[1] !== null || a2[1] !== null && o2[1] === null) return r2 = true, F.ReplaceSkip(M(`${a2[0] * o2[0]}${a2[1] ?? o2[1] ?? ``}`));
          break;
        case `+`:
          if (a2[1] === o2[1]) return r2 = true, F.ReplaceSkip(M(`${a2[0] + o2[0]}${a2[1] ?? ``}`));
          break;
        case `-`:
          if (a2[1] === o2[1]) return r2 = true, F.ReplaceSkip(M(`${a2[0] - o2[0]}${a2[1] ?? ``}`));
          break;
        case `/`:
          if (o2[0] !== 0 && (a2[1] === null && o2[1] === null || a2[1] !== null && o2[1] === null)) return r2 = true, F.ReplaceSkip(M(`${a2[0] / o2[0]}${a2[1] ?? ``}`));
          break;
      }
    }
  } }), [r2, e3];
}
function dr(e3, t2 = null, n2 = true) {
  let r2 = Xn.get(e3);
  if (r2 === null) return null;
  let [i2, a2] = r2;
  if (a2 === null) return `${i2}`;
  if (i2 === 0 && de(e3)) return `0`;
  if (!n2) return `${e3}`;
...
function Ri(e3, t2) {
  ...
  for (let [e4, t3] of a2) if (e4.kind === `compound` && (e4.root === `has` || e4.root === `not` || e4.root === `in`) && e4.modifier !== null && `modifier` in e4.variant && (e4.variant.modifier = e4.modifier, e4.modifier = null), e4.kind === `arbitrary`) {
    ...
    if (t3 === null && n3.length === 2 && n3[0].kind === `selector` && n3[0].value === `&` && n3[1].kind === `function` && n3[1].value === `:has` && n3[1].nodes.length === 1 && n3[1].nodes[0].kind === `selector`) {
      Y(e4, r2.parseVariant(`has-[${Cr(n3[1].nodes)}]`));
      continue;
    }
...
function zi(e3, t2) {
  ...
  if (e3.root[0] === `-`) {
    ...
    let [t3, i2] = ur(P(`calc(${e3.value.value} * -1)`), null, false);
    if (t3) {
      let t4 = Ut(e3);
...
function ma(e3, t2) {
  ...
  return I(e3, (e4) => {
    ...
    let r2 = [], i2 = g(e4.params, `,`);
    for (let [n3, a2] of i2.entries()) {
      let o2 = L(`&`, n3 === i2.length - 1 ? e4.nodes : e4.nodes.map(H)), s2 = g(a2, `:`);
      for (let e5 = s2.length - 1; e5 >= 0; --e5) {
        ...
        if (ya(o2, r3, t2.variants) === null) throw Error(`Cannot use \`@variant\` with variant: ${n4}`);
      }
      r2.push(o2);
    }
...
function va(e3, t2, n2) {
  ...
  let i2 = t2.important && !!(n2 & 1), a2 = [], o2 = `.${Oe(e3.raw)}`;
  for (let n3 of r2) {
    let r3 = Ca(n3);
  ...
  return I(e3, (e4) => {
    if (e4.kind === `at-rule` && (e4.name === `@import` || e4.name === `@reference`)) {
      ...
      return o2.push((async () => {
        ...
        let a3 = await n2(c2, t2), o3 = tt(a3.content, { from: i2 ? a3.path : void 0 });
  ...
  return function(r2, i2) {
    ...
    let s2 = (() => {
      ...
      if (typeof s3 == `object` && s3 && !Array.isArray(s3)) {
        ...
        for (let t3 in a3) t3 !== `__CSS_VALUES__` && (s3?.__CSS_VALUES__?.[t3] & 4 && Na(e4, t3.split(`-`)) !== void 0 || (e4[ke(t3)] = a3[t3]));
        return e4;
      }
...
function za(e3, t2, n2) {
  I(e3, (e4) => {
    if (e4.kind === `rule`) {
      ...
      I(r2, (e5) => {
        e5.kind === `selector` && e5.value === `.${t2}` && (e5.value = `.${Oe(n2)}`);
      }), e4.selector = Cr(r2);
    }
  });
}
...
function io({ ast: e3 }) {
  let t2 = new j((e4) => Pe(e4.code)), n2 = new j((e4) => ({ url: e4.file, content: e4.code, ignore: false })), r2 = { file: null, sources: [], mappings: [] };
  I(e3, (e4) => {
...
async function _o(e3, { base: t2 = ``, from: n2, loadModule: r2 = po, loadStylesheet: i2 = mo } = {}) {
  ...
  let o2 = null, s2 = new Me(), c2 = /* @__PURE__ */ new Map(), l2 = /* @__PURE__ */ new Map(), u2 = [], d2 = null, f2 = null, p2 = [], m2 = [], h2 = [], _2 = [], v2 = null;
  I(e3, (e4, t3) => {
    if (e4.kind !== `at-rule`) return;
    let n3 = Dt(t3);
    ...
    if (e4.name === `@theme`) {
      ...
      return I(e4.nodes, (n4) => {
        ...
        if (n4.kind === `declaration` && n4.property.startsWith(`--`)) {
          s2.add(ke(n4.property), n4.value ?? ``, t4, n4.src);
          return;
        }
...
async function vo(e3, t2 = {}) {
  ...
  r2.unshift(Tt(`! tailwindcss v${Ne} | MIT License | https://tailwindcss.com `));
  function l2(e4) {
...
async function yo(e3, t2 = {}) {
  let n2 = tt(e3, { from: t2.from }), r2 = await vo(n2, t2), i2 = n2, a2 = e3;
  return { ...r2, build(e4) {
    let n3 = r2.build(e4);
...
async function bo(e3, t2 = {}) {
  return (await _o(tt(e3, { from: t2.from }), t2)).designSystem;
}
...
`), g2 = _2.length - 1, g2 > 0 ? (y2 = o3 + g2, b2 = v2 - _2[g2].length) : (y2 = o3, b2 = a3), S2 = t2.comment, o3 = y2, p3 = y2, f3 = v2 - b2) : l3 === t2.slash ? (v2 = s3, S2 = l3, p3 = o3, f3 = s3 - a3, c3 = v2 + 1) : (v2 = d2(r3, s3), S2 = t2.word, p3 = o3, f3 = v2 - a3), c3 = v2 + 1;
  ...
  function te2(e4, t3, n3) {
    return t3 && ee2(e4.prototype, t3), n3 && ee2(e4, n3), Object.defineProperty(e4, `prototype`, { writable: false }), e4;
  }
  var w2 = (y2 = {}, y2[g2.space] = true, y2[g2.cr] = true, y2[g2.feed] = true, y2[g2.newline] = true, y2[g2.tab] = true, y2), ne2 = Object.assign({}, w2, (b2 = {}, b2[g2.comment] = true, b2));
  function re2(e4) {
  ...
  e3.default = (function() {
    ...
    return t3._errorGenerator = function() {
        ...
        switch (l3[h2.FIELDS.TYPE]) {
          ...
          case g2.comment:
            if (s3) if (c3 || f3 && f3[h2.FIELDS.TYPE] === g2.space || s3 === `insensitive`) {
              var w3 = (0, v2.getProp)(r3, `spaces`, s3, `after`) || ``, ne3 = (0, v2.getProp)(r3, `raws`, `spaces`, s3, `after`) || w3;
      ...
      do
        if (w2[this.currToken[h2.FIELDS.TYPE]]) this.options.lossy || (r3 += this.content());
      ...
      var l3;
      if (this.isNamedCombinator() ? l3 = this.namedCombinator() : this.currToken[h2.FIELDS.TYPE] === g2.combinator ? (l3 = new f2.default({ value: this.content(), source: ae2(this.currToken), sourceIndex: this.currToken[h2.FIELDS.START_POS] }), this.position++) : w2[this.currToken[h2.FIELDS.TYPE]] || c3 || this.unexpected(), l3) {
        if (c3) {
      ...
      return -1;
    }, te2(e4, [{ key: `currToken`, get: function() {

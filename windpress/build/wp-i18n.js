(() => {
	...
	__('In Development', 'windpress');
	__('Dedicated settings for', 'windpress');
	__('are currently being developed. They will be available in a future update.', 'windpress');
	__('Integration Status', 'windpress');
	__('Current Status:', 'windpress');
	__('Integration:', 'windpress');
	__('Enabled:', 'windpress');
	__('Yes', 'windpress');
	__('No', 'windpress');
	__('Settings Available:', 'windpress');
	__('Coming Soon', 'windpress');
	...
	__('Generate and load a theme.json file based on your Tailwind CSS configuration. This enables Full Site Editing features and provides better integration with the block editor.', 'windpress');
	__('What does this do?', 'windpress');
	__('Generates a theme.json file with your Tailwind colors, spacing, and typography', 'windpress');
	__('Loads the generated theme.json on the Gutenberg editor', 'windpress');

...
import { u as requireCssesc, t as requireBrowser, d as requirePostcss, g as getDefaultExportFromCjs } from "../assets/cssesc-Du71EH2f.js";
...
function me(r, t) {
  ...
  for (let m = 0; m < r.length; m++) {
    ...
    if (!(w2 === Me && (p2 = r.charCodeAt(m + 1), p2 === ie))) if (w2 === Ve) u2 === "" && (g2 = m), u2 += r.slice(m, m + 2), m += 1;
      ...
      for (let x = m + 1; x < r.length; x++) if (p2 = r.charCodeAt(x), p2 === Ve) x += 1;
        ...
        if (p2 === Le && (r.charCodeAt(x + 1) === ie || r.charCodeAt(x + 1) === Me && r.charCodeAt(x + 2) === ie)) throw new Error(`Unterminated string: ${r.slice(v2, x + 1) + String.fromCharCode(w2)}`);
        if (p2 === ie || p2 === Me && r.charCodeAt(x + 1) === ie) throw new Error(`Unterminated string: ${r.slice(v2, x) + String.fromCharCode(w2)}`);
      }
      u2 += r.slice(v2, m + 1);
    } else {
      if ((w2 === Ne || w2 === ie || w2 === ze) && (p2 = r.charCodeAt(m + 1)) && (p2 === Ne || p2 === ie || p2 === ze || p2 === Me && (p2 = r.charCodeAt(m + 2)) && p2 == ie)) continue;
      if (w2 === ie) {
        if (u2.length === 0) continue;
        p2 = u2.charCodeAt(u2.length - 1), p2 !== Ne && p2 !== ie && p2 !== ze && (u2 += " ");
        ...
        if (u2.length === 0 && (w2 === Ne || w2 === ie || w2 === ze)) continue;
  ...
  for (let a = 0; a < r.length; a++) {
    ...
    switch (c) {
      ...
      case Gt: {
        ...
        let u2 = a, f2 = a + 1;
        for (; f2 < r.length && (s2 = r.charCodeAt(f2), !(s2 !== It && s2 !== Ft && s2 !== Lt && s2 !== Mt && s2 !== zt && s2 !== Wt && s2 !== Bt && s2 !== qt && s2 !== Gt)); f2++) ;
        a = f2 - 1;
...
function ve(r, t, i = 3) {
  ...
  if (i & 1) {
    ...
    if (v2.length > 0) {
      let x = w2.findIndex((b2) => !(b2.kind === "comment" || b2.kind === "at-rule" && (b2.name === "@charset" || b2.name === "@import"))), k2 = M("@layer", "properties", []);
      k2.src = v2[0].src, w2.splice(x < 0 ? w2.length : x, 0, k2);
      let N2 = H("@layer properties", [M("@supports", "((-webkit-hyphens: none) and (not (margin-trim: inline))) or ((-moz-orient: inline) and (not (color:rgb(from red r g b))))", v2)]);
...
function $(r, t, i) {
  return M("@property", r, [l("syntax", i ? `"${i}"` : '"*"'), l("inherits", "false"), ...t ? [l("initial-value", t)] : []]);
}
function Z(r, t) {
  if (t === null) return r;
  let i = Number(t);
...
function sr(r) {
  ...
  t.static("container", () => {
    ...
    for (let h2 of o) d2.push(M("@media", `(width >= ${h2})`, [l("max-width", h2)]));
    return d2;
  ...
  function p$1({ negative: o }) {
    return (d2) => {
      ...
      if (d2.value.kind === "arbitrary") {
        ...
        if (A2 !== "angle") return [l("rotate", h2)];
  ...
  }
  {
    ...
    t.static("outline-hidden", () => [l("--tw-outline-style", "none"), l("outline-style", "none"), M("@media", "(forced-colors: active)", [l("outline", "2px solid transparent"), l("outline-offset", "2px")])]), e("outline-none", [["--tw-outline-style", "none"], ["outline-style", "none"]]), e("outline-solid", [["--tw-outline-style", "solid"], ["outline-style", "solid"]]), e("outline-dashed", [["--tw-outline-style", "dashed"], ["outline-style", "dashed"]]), e("outline-dotted", [["--tw-outline-style", "dotted"], ["outline-style", "dotted"]]), e("outline-double", [["--tw-outline-style", "double"], ["outline-style", "double"]]), t.functional("outline", (d2) => {
      if (d2.value === null) {
...
function dr(r) {
  ...
  for (let e of r.utilities.keys("functional")) {
    ...
    for (let s2 of n) for (let a of s2.values) {
      let c = a !== null && Pi.test(a), u2 = a === null ? e : `${e}-${a}`;
      t.push({ name: u2, utility: e, fraction: c, modifiers: s2.modifiers }), s2.supportsNegative && t.push({ name: `-${u2}`, utility: `-${e}`, fraction: c, modifiers: s2.modifiers });
    }
  }
...
function hr(r) {
  ...
  function s2(f2) {
    for (let g$1 of n) {
      ...
      let p2 = g(f2.params, ",");
      return p2.length > 1 ? null : (p2 = e(f2.name, p2), M(f2.name, p2.join(", ")));
    }
    return null;
  }
  function a(f2) {
  ...
  t.compound("not", 3, (f2, g2) => {
    ...
    if (D([f2], (m, { path: w2 }) => {
      ...
      return Object.assign(f2, z("&", k2)), p2 = true, 1;
  ...
  {
    let f2 = function() {
      return I([M("@property", "--tw-content", [l("syntax", '"*"'), l("initial-value", '""'), l("inherits", "false")])]);
    };
    t.static("before", (g2) => {
      g2.nodes = [z("&::before", [f2(), l("content", "var(--tw-content)"), ...g2.nodes])];
    }, { compounds: 0 }), t.static("after", (g2) => {
      g2.nodes = [z("&::after", [f2(), l("content", "var(--tw-content)"), ...g2.nodes])];
    }, { compounds: 0 });
  }
  i("first", ["&:first-child"]), i("last", ["&:last-child"]), i("only", ["&:only-child"]), i("odd", ["&:nth-child(odd)"]), i("even", ["&:nth-child(even)"]), i("first-of-type", ["&:first-of-type"]), i("last-of-type", ["&:last-of-type"]), i("only-of-type", ["&:only-of-type"]), i("visited", ["&:visited"]), i("target", ["&:target"]), i("open", ["&:is([open], :popover-open, :open)"]), i("default", ["&:default"]), i("checked", ["&:checked"]), i("indeterminate", ["&:indeterminate"]), i("placeholder-shown", ["&:placeholder-shown"]), i("autofill", ["&:autofill"]), i("optional", ["&:optional"]), i("required", ["&:required"]), i("valid", ["&:valid"]), i("invalid", ["&:invalid"]), i("user-valid", ["&:user-valid"]), i("user-invalid", ["&:user-invalid"]), i("in-range", ["&:in-range"]), i("out-of-range", ["&:out-of-range"]), i("read-only", ["&:read-only"]), i("empty", ["&:empty"]), i("focus-within", ["&:focus-within"]), t.static("hover", (f2) => {
    f2.nodes = [z("&:hover", [M("@media", "(hover: hover)", f2.nodes)])];
    ...
    g2.value.kind === "arbitrary" ? f2.nodes = [z(`&[aria-${gr(g2.value.value)}]`, f2.nodes)] : f2.nodes = [z(`&[aria-${g2.value.value}="true"]`, f2.nodes)];
  }), t.suggest("aria", () => ["busy", "checked", "disabled", "expanded", "hidden", "pressed", "readonly", "required", "selected"]), t.functional("data", (f2, g2) => {
    if (!g2.value || g2.modifier) return null;
    f2.nodes = [z(`&[data-${gr(g2.value.value)}]`, f2.nodes)];
  }), t.functional("nth", (f2, g2) => {
    if (!g2.value || g2.modifier || g2.value.kind === "named" && !p(g2.value.value)) return null;
    f2.nodes = [z(`&:nth-child(${g2.value.value})`, f2.nodes)];
  }), t.functional("nth-last", (f2, g2) => {
    if (!g2.value || g2.modifier || g2.value.kind === "named" && !p(g2.value.value)) return null;
    f2.nodes = [z(`&:nth-last-child(${g2.value.value})`, f2.nodes)];
  }), t.functional("nth-of-type", (f2, g2) => {
    if (!g2.value || g2.modifier || g2.value.kind === "named" && !p(g2.value.value)) return null;
    f2.nodes = [z(`&:nth-of-type(${g2.value.value})`, f2.nodes)];
  }), t.functional("nth-last-of-type", (f2, g2) => {
    if (!g2.value || g2.modifier || g2.value.kind === "named" && !p(g2.value.value)) return null;
    f2.nodes = [z(`&:nth-last-of-type(${g2.value.value})`, f2.nodes)];
    ...
    if (/^[\w-]*\s*\(/.test(p2)) {
      ...
      f2.nodes = [M("@supports", m, f2.nodes)];
      return;
    }
    p2.includes(":") || (p2 = `${p2}: var(--tw)`), (p2[0] !== "(" || p2[p2.length - 1] !== ")") && (p2 = `(${p2})`), f2.nodes = [M("@supports", p2, f2.nodes)];
    ...
    };
    {
      ...
      t.group(() => {
        t.functional("max", (m, w2) => {
          ...
          m.nodes = [M("@media", `(width < ${v2})`, m.nodes)];
        }, { compounds: 1 });
        ...
        for (let [m, w2] of r.namespace("--breakpoint")) m !== null && t.static(m, (v2) => {
          v2.nodes = [M("@media", `(width >= ${w2})`, v2.nodes)];
        }, { compounds: 1 });
    ...
    }
    {
      ...
      t.group(() => {
        t.functional("@max", (m, w2) => {
          let v2 = p2.get(w2);
          if (v2 === null) return null;
          m.nodes = [M("@container", w2.modifier ? `${w2.modifier.value} (width < ${v2})` : `(width < ${v2})`, m.nodes)];
        }, { compounds: 1 });
      }, (m, w2) => f2(m, w2, "desc", p2)), t.suggest("@max", () => Array.from(g2.keys()).filter((m) => m !== null)), t.group(() => {
        t.functional("@", (m, w2) => {
          let v2 = p2.get(w2);
...
function At(r, t) {
  D(r, (i, { replaceWith: e }) => {
    ...
    else if (i.kind === "at-rule" && (i.name === "@keyframes" || i.name === "@property")) return Object.assign(i, I([M(i.name, i.params, i.nodes)])), 1;
  });
}
function vr(r) {
  ...
  for (let a = 0; a < r.length; a++) {
    ...
    switch (c) {
      ...
      case jr: {
        ...
        a = f2 - 1;
        let g2 = r.slice(u2, f2), p2 = g2.trim() === "," ? Wi(g2) : Mi(g2);
...
function Vt({ designSystem: r, ast: t, resolvedConfig: i, featuresRef: e, referenceMode: n }) {
  let s2 = { addBase(a) {
    ...
    typeof c == "string" || Array.isArray(c) ? r.variants.static(a, (u2) => {
      u2.nodes = Ur(c, u2.nodes);
...
function nn({ center: r, padding: t, screens: i }, e) {
  ...
  if (r && n.push(l("margin-inline", "auto")), (typeof t == "string" || typeof t == "object" && t !== null && "DEFAULT" in t) && n.push(l("padding-inline", typeof t == "string" ? t : t.DEFAULT)), typeof i == "object" && i !== null) {
    ...
    if (a.sort((c, u2) => we(c[1], u2[1], "asc")), a.length > 0) {
      let [c] = a[0];
      n.push(M("@media", `(width >= --theme(--breakpoint-${c}))`, [l("max-width", "none")]));
    }
    for (let [c, u2] of Object.entries(i)) {
      if (typeof u2 == "object") if ("min" in u2) u2 = u2.min;
      else continue;
      s2.set(c, M("@media", `(width >= ${u2})`, [l("max-width", u2)]));
    }
  }
  if (typeof t == "object" && t !== null) {
    ...
    for (let [c, , u2] of a) if (s2 && s2.has(c)) s2.get(c).nodes.push(l("padding-inline", u2));
      ...
      if (s2) continue;
      n.push(M("@media", `(width >= theme(--breakpoint-${c}))`, [l("padding-inline", u2)]));
    }
  }
...
function Gr({ designSystem: r, base: t, ast: i, sources: e, configs: n, pluginDetails: s2 }) {
  ...
  }), ...n], { resolvedConfig: f2 } = St(r, [{ config: Lr(r.theme), base: t, reference: true }, ...u2, { config: { plugins: [zr] }, base: t, reference: true }]), { resolvedConfig: g2, replacedThemeKeys: p2 } = St(r, u2), m = r.resolveThemeValue;
  ...
  if (xr(r, g2, p2), Fr(r, g2), qr(g2, r), Br(g2, r), Mr(g2, r), !r.theme.prefix && f2.prefix) {
  ...
  if (!r.important && f2.important === true && (r.important = true), typeof f2.important == "string") {
    ...
    D(i, (N2, { replaceWith: b2, parent: S }) => {
      if (N2.kind === "at-rule" && !(N2.name !== "@tailwind" || N2.params !== "utilities")) return (S == null ? void 0 : S.kind) === "rule" && S.selector === k2 ? 2 : (b2(z(k2, [N2])), 2);
    });
  }
    ...
    if (b2.kind === "at-rule") {
        ...
        if (b2.nodes.length === 0) {
          ...
          u2.push((q2) => {
            q2.variants.static(K2, (X2) => {
              let re2 = [];
              L2.length > 0 && re2.push(z(L2.join(", "), X2.nodes));
      ...
      if (b2.name === "@theme") {
        ...
        return D(b2.nodes, (O2) => {
          ...
          let G2 = ne([M(b2.name, b2.params, [O2])]).split(`
`).map((L2, q2, X2) => `${q2 === 0 || q2 >= X2.length - 2 ? " " : ">"} ${L2}`).join(`
`);
          throw new Error(`\`@theme\` blocks must only contain custom properties or \`@keyframes\`.

${G2}`);
        }), g$1 ? P2([]) : (g$1 = z(":root, :host", []), g$1.src = b2.src, P2([g$1])), 1;
      }
    }
  });
  let N2 = vr(c);
  ...
  if (m.length > 0) {
    for (let b2 of m) {
      let S = z("&", b2.nodes), P2 = b2.params, j2 = N2.parseVariant(P2);

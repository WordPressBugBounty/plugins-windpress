...
import { u as requireCssesc, t as requireBrowser, d as requirePostcss, g as getDefaultExportFromCjs } from "../assets/cssesc-B11S6O1g.js";
...
var _ = { color: v, length: w, percentage: C$1, ratio: j, number: N, integer: p, url: z, position: Q$1, "bg-size": X, "line-width": I$1, image: H, "family-name": q$1, "generic-name": P, "absolute-size": B$1, "relative-size": W, angle: ee$1, vector: re$1 };
function pe$1(e, r) {
  var _a2;
...
var J$1 = ["deg", "rad", "grad", "turn"], Z$1 = new RegExp(`^${u.source}(${J$1.join("|")})$`);
function ee$1(e) {
  return Z$1.test(e);
}
  ...
  for (let c = 0; c < r.length; c++) {
    ...
    if (m === $e) l2 += r.slice(c, c + 2), c += 1;
      ...
      for (let h2 = c + 1; h2 < r.length; h2++) if (u2 = r.charCodeAt(h2), u2 === $e) h2 += 1;
        ...
        if (u2 === Ie && r.charCodeAt(h2 + 1) === pe) throw new Error(`Unterminated string: ${r.slice(g2, h2 + 1) + String.fromCharCode(m)}`);
        if (u2 === pe) throw new Error(`Unterminated string: ${r.slice(g2, h2) + String.fromCharCode(m)}`);
      }
      l2 += r.slice(g2, c + 1);
    } else {
      if ((m === Ne || m === pe || m === Fe) && (u2 = r.charCodeAt(c + 1)) && (u2 === Ne || u2 === pe || u2 === Fe)) continue;
      if (m === pe) {
        if (l2.length === 0) continue;
        u2 = l2.charCodeAt(l2.length - 1), u2 !== Ne && u2 !== pe && u2 !== Fe && (l2 += " ");
      } else if (m === St && r.charCodeAt(c + 1) === St && l2.length === 0) {
        let g2 = "", h2 = c, w2 = -1;
        ...
        } else if (w2 === -1 && u2 === Br) w2 = l2.length + A2 - h2;
        else if (u2 === Ie && g2.length === 0) {
          l2 += r.slice(h2, A2), c = A2;
          break;
        } else if (u2 === at) g2 += ")";
        else if (u2 === qr) g2 += "]";
        else if (u2 === Vt) g2 += "}";
        else if ((u2 === it || r.length - 1 === A2) && g2.length === 0) {
          c = A2 - 1, l2 += r.slice(h2, A2);
          break;
        ...
        o ? o.nodes.push(v2) : t.push(v2), l2 = "";
      } else if (m === Ie && l2.charCodeAt(0) === nt) s2 = Ve(l2), o ? o.nodes.push(s2) : t.push(s2), l2 = "", s2 = null;
      else if (m === Ie && d2[d2.length - 1] !== ")") {
        let g2 = ot(l2);
        if (!g2) throw l2.length === 0 ? new Error("Unexpected semicolon") : new Error(`Invalid declaration: \`${l2.trim()}\``);
        o ? o.nodes.push(g2) : t.push(g2), l2 = "";
      } else if (m === Vt && d2[d2.length - 1] !== ")") d2 += "}", s2 = B(l2.trim()), o && o.nodes.push(s2), e.push(o), o = s2, l2 = "", s2 = null;
      else if (m === it && d2[d2.length - 1] !== ")") {
        if (d2 === "") throw new Error("Missing opening {");
        if (d2 = d2.slice(0, -1), l2.length > 0) if (l2.charCodeAt(0) === nt) s2 = Ve(l2), o ? o.nodes.push(s2) : t.push(s2), l2 = "", s2 = null;
        else {
          let h2 = l2.indexOf(":");
          if (o) {
            let w2 = ot(l2, h2);
            if (!w2) throw new Error(`Invalid declaration: \`${l2.trim()}\``);
            o.nodes.push(w2);
          }
        }
        let g2 = e.pop() ?? null;
        g2 === null && o && t.push(o), o = g2, l2 = "", s2 = null;
      } else if (m === at) d2 += ")", l2 += "(";
      else if (m === Tt) {
        if (d2[d2.length - 1] !== ")") throw new Error("Missing opening (");
        d2 = d2.slice(0, -1), l2 += ")";
      } else {
        if (l2.length === 0 && (m === Ne || m === pe || m === Fe)) continue;
        l2 += String.fromCharCode(m);
      }
    }
  }
  if (l2.charCodeAt(0) === nt && t.push(Ve(l2)), d2.length > 0 && o) {
...
var Le = (_a = class {
  ...
  getOptions(t) {
    var _a2;
    return t = ge(__privateMethod(this, _Le_instances, r_fn).call(this, t)), ((_a2 = this.values.get(t)) == null ? void 0 : _a2.options) ?? 0;
  }
  entries() {
  ...
  markUsedVariable(t) {
    let i = ge(__privateMethod(this, _Le_instances, r_fn).call(this, t)), e = this.values.get(i);
    if (!e) return false;
    let o = e.options & 16;
  ...
  resolveWith(t, i, e = []) {
    ...
    return l2.options & 1 ? [l2.value, s2] : [__privateMethod(this, _Le_instances, t_fn).call(this, o), s2];
  }
  namespace(t) {
...
function ee(r, t, i = null) {
  for (let e = 0; e < r.length; e++) {
    ...
    if (d2 === 2) return 2;
    if (d2 !== 1 && o.kind === "function" && ee(o.nodes, t, o) === 2) return 2;
  }
}
function Y(r) {
  let t = "";
...
`);
  ...
  for (let l2 = 0; l2 < r.length; l2++) {
    ...
    switch (d2) {
      ...
      case Qr: {
        let u2 = l2;
        for (let c = l2 + 1; c < r.length; c++) if (s2 = r.charCodeAt(c), s2 === Kt) c += 1;
        else if (s2 === d2) {
          l2 = c;
          break;
        }
...
function F(r, t, i = [], e = {}) {
  for (let o = 0; o < r.length; o++) {
    ...
    i.push(s2);
    let d2 = false, u2 = 0, c = t(s2, { parent: l2, context: e, path: i, replaceWith(m) {
...
function he(r, t, i = 3) {
  let e = [], o = /* @__PURE__ */ new Set(), s2 = new q(() => /* @__PURE__ */ new Set()), l2 = new q(() => /* @__PURE__ */ new Set()), d2 = /* @__PURE__ */ new Set(), u2 = /* @__PURE__ */ new Set(), c = [], m = [], g2 = new q(() => /* @__PURE__ */ new Set());
  function h2(v2, A2, k2 = {}, b2 = 0) {
    if (v2.kind === "declaration") {
      ...
      i & 2 && v2.value.includes("color-mix(") && l2.get(A2).add(v2), A2.push(v2);
  ...
  if (w2 = w2.concat(e), i & 2) for (let [v2, A2] of l2) for (let k2 of A2) {
    let b2 = v2.indexOf(k2);
    if (b2 === -1 || k2.value == null) continue;
    let V2 = G(k2.value), S = false;
    if (ee(V2, (U2, { replaceWith: P2 }) => {
      if (U2.kind !== "function" || U2.value !== "color-mix") return;
      let H2 = false, M2 = false;
      if (ee(U2.nodes, (z2, { replaceWith: te2 }) => {
        ...
        do {
          ...
          ae.startsWith("var(") ? X2 = G(ae)[0] : X2 = null;
        } while (X2);
    ...
    let K2 = { ...k2, value: Y(V2) }, O2 = B("@supports (color: color-mix(in lab, red, red))", [k2]);
    v2.splice(b2, 1, K2, O2);
  }
  if (i & 1) {
    let v2 = [];
    if (c.length > 0 && v2.push(B(":root, :host", c)), m.length > 0 && v2.push(B("*, ::before, ::after, ::backdrop", m)), v2.length > 0) {
      let A2 = w2.findIndex((k2) => !(k2.kind === "comment" || k2.kind === "at-rule" && (k2.name === "@charset" || k2.name === "@import")));
      w2.splice(A2 < 0 ? w2.length : A2, 0, I("@layer", "properties", [])), w2.push(B("@layer properties", [I("@supports", "((-webkit-hyphens: none) and (not (margin-trim: inline))) or ((-moz-orient: inline) and (not (color:rgb(from red r g b))))", v2)]));
    }
  }
  return w2;
}
...
function* Gt(r, t) {
  ...
  if (l2[0] === "[") {
    ...
    let g2 = l2.charCodeAt(1);
    if (g2 !== Wt && !(g2 >= Bt && g2 <= qt)) return;
    l2 = l2.slice(1, -1);
    let h2 = l2.indexOf(":");
    if (h2 === -1 || h2 === 0 || h2 === l2.length - 1) return;
    let w2 = l2.slice(0, h2), v2 = ue(l2.slice(h2 + 1));
    if (!fe(v2)) return;
  ...
  if (l2[l2.length - 1] === "]") {
    let g2 = l2.indexOf("-[");
    if (g2 === -1) return;
    let h2 = l2.slice(0, g2);
    if (!t.utilities.has(h2, "functional")) return;
    let w2 = l2.slice(g2 + 1);
    m = [[h2, w2]];
  } else if (l2[l2.length - 1] === ")") {
    let g$1 = l2.indexOf("-(");
    if (g$1 === -1) return;
    let h2 = l2.slice(0, g$1);
    if (!t.utilities.has(h2, "functional")) return;
    let w2 = l2.slice(g$1 + 2, -1), v2 = g(w2, ":"), A2 = null;
    if (v2.length === 2 && (A2 = v2[0], w2 = v2[1]), w2[0] !== "-" && w2[1] !== "-") return;
    m = [[h2, A2 === null ? `[var(${w2})]` : `[${A2}:var(${w2})]`]];
  } else m = Ht(l2, (g2) => t.utilities.has(g2, "functional"));
  for (let [g2, h2] of m) {
...
function Jt(r, t) {
  ...
  }
  {
    let [i, e = null, o] = g(r, "/");
    if (o) return null;
    let s2 = Ht(i, (l2) => t.variants.has(l2));
    for (let [l2, d2] of s2) switch (t.variants.kind(l2)) {
      ...
      case "functional": {
        ...
        if (d2[d2.length - 1] === "]") {
          if (d2[0] !== "[") continue;
          let c = ue(d2.slice(1, -1));
          return !fe(c) || c.length === 0 || c.trim().length === 0 ? null : { kind: "functional", root: l2, modifier: u2, value: { kind: "arbitrary", value: c } };
        }
        if (d2[d2.length - 1] === ")") {
          if (d2[0] !== "(") continue;
          let c = ue(d2.slice(1, -1));
          return !fe(c) || c.length === 0 || c.trim().length === 0 || c[0] !== "-" && c[1] !== "-" ? null : { kind: "functional", root: l2, modifier: u2, value: { kind: "arbitrary", value: `var(${c})` } };
        }
      ...
      case "compound": {
        ...
        return e !== null && c === null ? null : { kind: "compound", root: l2, modifier: c, variant: u2 };
      }
    }
  }
  return null;
...
var ai = /* @__PURE__ */ new Set(["inset", "inherit", "initial", "revert", "unset"]), Yt = /^-?(\d+|\.\d+)(.*?)$/g;
function Te(r, t) {
  return g(r, ",").map((e) => {
    e = e.trim();
    let o = g(e, " ").filter((c) => c.trim() !== ""), s2 = null, l2 = null, d2 = null;
    for (let c of o) ai.has(c) || (Yt.test(c) ? (l2 === null ? l2 = c : d2 === null && (d2 = c), Yt.lastIndex = 0) : s2 === null && (s2 = c));
    if (l2 === null || d2 === null) return e;
    let u2 = t(s2 ?? "currentcolor");
    return s2 !== null ? e.replace(s2, u2) : `${e} ${u2}`;
  }).join(", ");
}
var li = /^-?[a-z][a-zA-Z0-9/%._-]*$/, si = /^-?[a-z][a-zA-Z0-9/%._-]*-\*$/, Ge = ["0", "0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4", "5", "6", "7", "8", "9", "10", "11", "12", "14", "16", "20", "24", "28", "32", "36", "40", "44", "48", "52", "56", "60", "64", "72", "80", "96"], pt = class {
  constructor() {
...
function C(r, t, i) {
  return I("@property", r, [a("syntax", i ? `"${i}"` : '"*"'), a("inherits", "false"), ...t ? [a("initial-value", t)] : []]);
}
function J(r, t) {
  if (t === null) return r;
  let i = Number(t);
...
function Z(r, t, i) {
  ...
  return e ? J(r, e) : de(t.value) ? J(r, `${t.value}%`) : null;
}
function Q(r, t, i) {
  let e = null;
...
function Xt(r) {
  ...
  function o(n, f2) {
    ...
    f2.supportsNegative && t.functional(`-${n}`, p$1({ negative: true })), t.functional(n, p$1({ negative: false })), i(n, () => [{ supportsNegative: f2.supportsNegative, valueThemeKeys: f2.themeKeys ?? [], hasDefaultValue: f2.defaultValue !== void 0 && f2.defaultValue !== null, supportsFractions: f2.supportsFractions }]);
  }
  function s2(n, f2) {
    t.functional(n, (p2) => {
      if (!p2.value) return;
      let x = null;
      if (p2.value.kind === "arbitrary" ? (x = p2.value.value, x = Z(x, p2.modifier, r)) : x = Q(p2, r, f2.themeKeys), x !== null) return f2.handle(x);
    }), i(n, () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: f2.themeKeys, modifiers: Array.from({ length: 21 }, (p2, x) => `${x * 5}`) }]);
  }
  function l2(n, f2, p2, { supportsNegative: x = false, supportsFractions: y2 = false } = {}) {
    x && t.static(`-${n}-px`, () => p2("-1px")), t.static(`${n}-px`, () => p2("1px")), o(n, { themeKeys: f2, supportsFractions: y2, supportsNegative: x, defaultValue: null, handleBareValue: ({ value: $2 }) => {
      ...
      return !R2 || !ue$1($2) ? null : `calc(${R2} * ${$2})`;
  ...
  for (let [n, f2] of [["inset", "inset"], ["inset-x", "inset-inline"], ["inset-y", "inset-block"], ["start", "inset-inline-start"], ["end", "inset-inline-end"], ["top", "top"], ["right", "right"], ["bottom", "bottom"], ["left", "left"]]) e(`${n}-auto`, [[f2, "auto"]]), e(`${n}-full`, [[f2, "100%"]]), e(`-${n}-full`, [[f2, "-100%"]]), l2(n, ["--inset", "--spacing"], (p2) => [a(f2, p2)], { supportsNegative: true, supportsFractions: true });
  ...
  for (let [n, f2] of [["m", "margin"], ["mx", "margin-inline"], ["my", "margin-block"], ["ms", "margin-inline-start"], ["me", "margin-inline-end"], ["mt", "margin-top"], ["mr", "margin-right"], ["mb", "margin-bottom"], ["ml", "margin-left"]]) e(`${n}-auto`, [[f2, "auto"]]), l2(n, ["--margin", "--spacing"], (p2) => [a(f2, p2)], { supportsNegative: true });
  ...
  for (let [n, f2, p2] of [["w", ["--width", "--spacing", "--container"], "width"], ["min-w", ["--min-width", "--spacing", "--container"], "min-width"], ["max-w", ["--max-width", "--spacing", "--container"], "max-width"], ["h", ["--height", "--spacing"], "height"], ["min-h", ["--min-height", "--height", "--spacing"], "min-height"], ["max-h", ["--max-height", "--height", "--spacing"], "max-height"]]) l2(n, f2, (x) => [a(p2, x)], { supportsFractions: true });
  t.static("container", () => {
    let n = [...r.namespace("--breakpoint").values()];
    n.sort((p2, x) => ve(p2, x, "asc"));
    let f2 = [a("--tw-sort", "--tw-container-component"), a("width", "100%")];
    for (let p2 of n) f2.push(I("@media", `(width >= ${p2})`, [a("max-width", p2)]));
    return f2;
    ...
    if (n.value) {
      ...
      if (n.value.fraction) {
        let [f2, p$1] = g(n.value.fraction, "/");
        return !p(f2) || !p(p$1) ? void 0 : [a("flex", `calc(${n.value.fraction} * 100%)`)];
      }
  ...
  for (let n of ["x", "y"]) e(`-translate-${n}-full`, [u2, [`--tw-translate-${n}`, "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), e(`translate-${n}-full`, [u2, [`--tw-translate-${n}`, "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), l2(`translate-${n}`, ["--translate", "--spacing"], (f2) => [u2(), a(`--tw-translate-${n}`, f2), a("translate", "var(--tw-translate-x) var(--tw-translate-y)")], { supportsNegative: true, supportsFractions: true });
  ...
  let c = () => D([C("--tw-scale-x", "1"), C("--tw-scale-y", "1"), C("--tw-scale-z", "1")]);
  e("scale-none", [["scale", "none"]]);
  function m({ negative: n }) {
    return (f2) => {
      if (!f2.value || f2.modifier) return;
      let p$1;
      return f2.value.kind === "arbitrary" ? (p$1 = f2.value.value, [a("scale", p$1)]) : (p$1 = r.resolve(f2.value.value, ["--scale"]), !p$1 && p(f2.value.value) && (p$1 = `${f2.value.value}%`), p$1 ? (p$1 = n ? `calc(${p$1} * -1)` : p$1, [c(), a("--tw-scale-x", p$1), a("--tw-scale-y", p$1), a("--tw-scale-z", p$1), a("scale", "var(--tw-scale-x) var(--tw-scale-y)")]) : void 0);
    };
  }
  ...
  function g$1({ negative: n }) {
    return (f2) => {
      ...
      if (f2.value.kind === "arbitrary") {
        p$1 = f2.value.value;
        let x = f2.value.dataType ?? pe$1(p$1, ["angle", "vector"]);
        if (x === "vector") return [a("rotate", `${p$1} var(--tw-rotate)`)];
        if (x !== "angle") return [a("rotate", p$1)];
      } else if (p$1 = r.resolve(f2.value.value, ["--rotate"]), !p$1 && p(f2.value.value) && (p$1 = `${f2.value.value}deg`), !p$1) return;
      return [a("rotate", n ? `calc(${p$1} * -1)` : p$1)];
    };
  }
  t.functional("-rotate", g$1({ negative: true })), t.functional("rotate", g$1({ negative: false })), i("rotate", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"], valueThemeKeys: ["--rotate"] }]);
  {
    let n = ["var(--tw-rotate-x,)", "var(--tw-rotate-y,)", "var(--tw-rotate-z,)", "var(--tw-skew-x,)", "var(--tw-skew-y,)"].join(" "), f2 = () => D([C("--tw-rotate-x"), C("--tw-rotate-y"), C("--tw-rotate-z"), C("--tw-skew-x"), C("--tw-skew-y")]);
    for (let p$1 of ["x", "y", "z"]) o(`rotate-${p$1}`, { supportsNegative: true, themeKeys: ["--rotate"], handleBareValue: ({ value: x }) => p(x) ? `${x}deg` : null, handle: (x) => [f2(), a(`--tw-rotate-${p$1}`, `rotate${p$1.toUpperCase()}(${x})`), a("transform", n)] }), i(`rotate-${p$1}`, () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"], valueThemeKeys: ["--rotate"] }]);
    o("skew", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: p$1 }) => p(p$1) ? `${p$1}deg` : null, handle: (p2) => [f2(), a("--tw-skew-x", `skewX(${p2})`), a("--tw-skew-y", `skewY(${p2})`), a("transform", n)] }), o("skew-x", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: p$1 }) => p(p$1) ? `${p$1}deg` : null, handle: (p2) => [f2(), a("--tw-skew-x", `skewX(${p2})`), a("transform", n)] }), o("skew-y", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: p$1 }) => p(p$1) ? `${p$1}deg` : null, handle: (p2) => [f2(), a("--tw-skew-y", `skewY(${p2})`), a("transform", n)] }), i("skew", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), i("skew-x", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), i("skew-y", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), t.functional("transform", (p2) => {
  ...
  let w2 = () => D([C("--tw-scroll-snap-strictness", "proximity", "*")]);
    ...
    let p$1 = function($2) {
      ...
      return (R2) => {
        ...
        if (R2.value.kind === "arbitrary") {
          ...
          switch (R2.value.dataType ?? pe$1(j2, ["angle"])) {
            case "angle":
        ...
        let T2 = p$1(R2.modifier);
        return [a("--tw-gradient-position", `${N2}`), B("@supports (background-image: linear-gradient(in lab, red, red))", [a("--tw-gradient-position", `${N2} ${T2}`)]), a("background-image", "linear-gradient(var(--tw-gradient-stops))")];
      };
  ...
  t.functional("bg", (n) => {
    if (n.value) {
      if (n.value.kind === "arbitrary") {
        ...
        switch (n.value.dataType ?? pe$1(f2, ["image", "color", "percentage", "position", "bg-size", "length", "url"])) {
          case "percentage":
          case "position":
          ...
          default:
            return f2 = Z(f2, n.modifier, r), f2 === null ? void 0 : [a("background-color", f2)];
        }
      }
      {
        let f2 = Q(n, r, ["--background-color", "--color"]);
  ...
  let v2 = () => D([C("--tw-gradient-position"), C("--tw-gradient-from", "#0000", "<color>"), C("--tw-gradient-via", "#0000", "<color>"), C("--tw-gradient-to", "#0000", "<color>"), C("--tw-gradient-stops"), C("--tw-gradient-via-stops"), C("--tw-gradient-from-position", "0%", "<length-percentage>"), C("--tw-gradient-via-position", "50%", "<length-percentage>"), C("--tw-gradient-to-position", "100%", "<length-percentage>")]);
  function A2(n, f2) {
    t.functional(n, (p$1) => {
      if (p$1.value) {
        if (p$1.value.kind === "arbitrary") {
          ...
          switch (p$1.value.dataType ?? pe$1(x, ["color", "length", "percentage"])) {
            case "length":
            case "percentage":
              return p$1.modifier ? void 0 : f2.position(x);
            default:
              return x = Z(x, p$1.modifier, r), x === null ? void 0 : f2.color(x);
          }
        }
        {
        ...
        }
        {
          ...
          if (p$1.value.value[p$1.value.value.length - 1] === "%" && p(p$1.value.value.slice(0, -1))) return f2.position(p$1.value.value);
        }
      }
  ...
  A2("from", { color: (n) => [v2(), a("--tw-sort", "--tw-gradient-from"), a("--tw-gradient-from", n), a("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")], position: (n) => [v2(), a("--tw-gradient-from-position", n)] }), e("via-none", [["--tw-gradient-via-stops", "initial"]]), A2("via", { color: (n) => [v2(), a("--tw-sort", "--tw-gradient-via"), a("--tw-gradient-via", n), a("--tw-gradient-via-stops", "var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-via) var(--tw-gradient-via-position), var(--tw-gradient-to) var(--tw-gradient-to-position)"), a("--tw-gradient-stops", "var(--tw-gradient-via-stops)")], position: (n) => [v2(), a("--tw-gradient-via-position", n)] }), A2("to", { color: (n) => [v2(), a("--tw-sort", "--tw-gradient-to"), a("--tw-gradient-to", n), a("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")], position: (n) => [v2(), a("--tw-gradient-to-position", n)] }), e("mask-none", [["mask-image", "none"]]), t.functional("mask", (n) => {
    ...
    let f2 = n.value.value;
    switch (n.value.dataType ?? pe$1(f2, ["image", "percentage", "position", "bg-size", "length", "url"])) {
      case "percentage":
      case "position":
  ...
  let k2 = () => D([C("--tw-mask-linear", "linear-gradient(#fff, #fff)"), C("--tw-mask-radial", "linear-gradient(#fff, #fff)"), C("--tw-mask-conic", "linear-gradient(#fff, #fff)")]);
  function b2(n, f2) {
    t.functional(n, (p$1) => {
      if (p$1.value) {
        if (p$1.value.kind === "arbitrary") {
          ...
          switch (p$1.value.dataType ?? pe$1(x, ["length", "percentage", "color"])) {
            case "color":
              return x = Z(x, p$1.modifier, r), x === null ? void 0 : f2.color(x);
            case "percentage":
              return p$1.modifier || !p(x.slice(0, -1)) ? void 0 : f2.position(x);
            default:
              return p$1.modifier ? void 0 : f2.position(x);
          }
        }
        ...
        }
        {
          ...
          switch (x) {
            case "number": {
              ...
              return !y2 || !ue$1(p$1.value.value) ? void 0 : f2.position(`calc(${y2} * ${p$1.value.value})`);
            }
            case "percentage":
              return p(p$1.value.value.slice(0, -1)) ? f2.position(p$1.value.value) : void 0;
            default:
              return;
          }
        }
  ...
  let V2 = () => D([C("--tw-mask-left", "linear-gradient(#fff, #fff)"), C("--tw-mask-right", "linear-gradient(#fff, #fff)"), C("--tw-mask-bottom", "linear-gradient(#fff, #fff)"), C("--tw-mask-top", "linear-gradient(#fff, #fff)")]);
  function S(n, f2, p2) {
    b2(n, { color(x) {
  ...
  let K2 = () => D([C("--tw-mask-linear-position", "0deg"), C("--tw-mask-linear-from-position", "0%"), C("--tw-mask-linear-to-position", "100%"), C("--tw-mask-linear-from-color", "black"), C("--tw-mask-linear-to-color", "transparent")]);
  ...
  let O2 = () => D([C("--tw-mask-radial-from-position", "0%"), C("--tw-mask-radial-to-position", "100%"), C("--tw-mask-radial-from-color", "black"), C("--tw-mask-radial-to-color", "transparent"), C("--tw-mask-radial-shape", "ellipse"), C("--tw-mask-radial-size", "farthest-corner"), C("--tw-mask-radial-position", "center")]);
  ...
  let U2 = () => D([C("--tw-mask-conic-position", "0deg"), C("--tw-mask-conic-from-position", "0%"), C("--tw-mask-conic-to-position", "100%"), C("--tw-mask-conic-from-color", "black"), C("--tw-mask-conic-to-color", "transparent")]);
  ...
  e("mix-blend-plus-darker", [["mix-blend-mode", "plus-darker"]]), e("mix-blend-plus-lighter", [["mix-blend-mode", "plus-lighter"]]), e("fill-none", [["fill", "none"]]), t.functional("fill", (n) => {
    ...
    if (n.value) {
      if (n.value.kind === "arbitrary") {
        let f2 = n.value.value;
        switch (n.value.dataType ?? pe$1(f2, ["color", "number", "length", "percentage"])) {
          case "number":
          case "length":
          case "percentage":
            return n.modifier ? void 0 : [a("stroke-width", f2)];
          default:
            return f2 = Z(n.value.value, n.modifier, r), f2 === null ? void 0 : [a("stroke", f2)];
        }
      }
      {
        let f2 = Q(n, r, ["--stroke", "--color"]);
  ...
  for (let [n, f2] of [["p", "padding"], ["px", "padding-inline"], ["py", "padding-block"], ["ps", "padding-inline-start"], ["pe", "padding-inline-end"], ["pt", "padding-top"], ["pr", "padding-right"], ["pb", "padding-bottom"], ["pl", "padding-left"]]) l2(n, ["--padding", "--spacing"], (p2) => [a(f2, p2)]);
  e("text-left", [["text-align", "left"]]), e("text-center", [["text-align", "center"]]), e("text-right", [["text-align", "right"]]), e("text-justify", [["text-align", "justify"]]), e("text-start", [["text-align", "start"]]), e("text-end", [["text-align", "end"]]), l2("indent", ["--text-indent", "--spacing"], (n) => [a("text-indent", n)], { supportsNegative: true }), e("align-baseline", [["vertical-align", "baseline"]]), e("align-top", [["vertical-align", "top"]]), e("align-middle", [["vertical-align", "middle"]]), e("align-bottom", [["vertical-align", "bottom"]]), e("align-text-top", [["vertical-align", "text-top"]]), e("align-text-bottom", [["vertical-align", "text-bottom"]]), e("align-sub", [["vertical-align", "sub"]]), e("align-super", [["vertical-align", "super"]]), o("align", { themeKeys: [], handle: (n) => [a("vertical-align", n)] }), t.functional("font", (n) => {
    if (!(!n.value || n.modifier)) {
      if (n.value.kind === "arbitrary") {
        let f2 = n.value.value;
        switch (n.value.dataType ?? pe$1(f2, ["number", "generic-name", "family-name"])) {
          case "generic-name":
          case "family-name":
            return [a("font-family", f2)];
          default:
            return [D([C("--tw-font-weight")]), a("--tw-font-weight", f2), a("font-weight", f2)];
        }
      }
      {
      ...
      }
      {
        ...
        if (f2) return [D([C("--tw-font-weight")]), a("--tw-font-weight", f2), a("font-weight", f2)];
      }
    }
    ...
    if (n.value) {
      if (n.value.kind === "arbitrary") {
        let f2 = n.value.value;
        switch (n.value.dataType ?? pe$1(f2, ["color", "length", "percentage"])) {
          case "length":
          case "percentage":
            return n.modifier ? void 0 : [a("text-decoration-thickness", f2)];
          default:
            return f2 = Z(f2, n.modifier, r), f2 === null ? void 0 : [a("text-decoration-color", f2)];
        }
      }
      {
      ...
      {
        let f2 = Q(n, r, ["--text-decoration-color", "--color"]);
  ...
  }), i("decoration", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--text-decoration-color", "--color"], modifiers: Array.from({ length: 21 }, (n, f2) => `${f2 * 5}`) }, { values: ["0", "1", "2"], valueThemeKeys: ["--text-decoration-thickness"] }]), e("animate-none", [["animation", "none"]]), o("animate", { themeKeys: ["--animate"], handle: (n) => [a("animation", n)] });
  {
    ...
    t.functional("filter", (y2) => {
      ...
      if (y2.modifier && (y2.modifier.kind === "arbitrary" ? $2 = y2.modifier.value : p(y2.modifier.value) && ($2 = `${y2.modifier.value}%`)), !y2.value) {
        ...
        return R2 === null || N2 === null ? void 0 : [p$1(), a("--tw-drop-shadow-alpha", $2), ...qe("--tw-drop-shadow-size", R2, $2, (T2) => `var(--tw-drop-shadow-color, ${T2})`), a("--tw-drop-shadow", g(N2, ",").map((T2) => `drop-shadow(${T2})`).join(" ")), a("filter", n)];
      }
      if (y2.value.kind === "arbitrary") {
        let R2 = y2.value.value;
        switch (y2.value.dataType ?? pe$1(R2, ["color"])) {
          case "color":
            return R2 = Z(R2, y2.modifier, r), R2 === null ? void 0 : [p$1(), a("--tw-drop-shadow-color", J(R2, "var(--tw-drop-shadow-alpha)")), a("--tw-drop-shadow", "var(--tw-drop-shadow-size)")];
          default:
            return y2.modifier && !$2 ? void 0 : [p$1(), a("--tw-drop-shadow-alpha", $2), ...qe("--tw-drop-shadow-size", R2, $2, (T2) => `var(--tw-drop-shadow-color, ${T2})`), a("--tw-drop-shadow", "var(--tw-drop-shadow-size)"), a("filter", n)];
        }
      }
      {
        let R2 = r.get([`--drop-shadow-${y2.value.value}`]), N2 = r.resolve(y2.value.value, ["--drop-shadow"]);
        if (R2 && N2) return y2.modifier && !$2 ? void 0 : $2 ? [p$1(), a("--tw-drop-shadow-alpha", $2), ...qe("--tw-drop-shadow-size", R2, $2, (T2) => `var(--tw-drop-shadow-color, ${T2})`), a("--tw-drop-shadow", "var(--tw-drop-shadow-size)"), a("filter", n)] : [p$1(), a("--tw-drop-shadow-alpha", $2), ...qe("--tw-drop-shadow-size", R2, $2, (T2) => `var(--tw-drop-shadow-color, ${T2})`), a("--tw-drop-shadow", g(N2, ",").map((T2) => `drop-shadow(${T2})`).join(" ")), a("filter", n)];
      }
      {
        let R2 = Q(y2, r, ["--drop-shadow-color", "--color"]);
        if (R2) return R2 === "inherit" ? [p$1(), a("--tw-drop-shadow-color", "inherit"), a("--tw-drop-shadow", "var(--tw-drop-shadow-size)")] : [p$1(), a("--tw-drop-shadow-color", J(R2, "var(--tw-drop-shadow-alpha)")), a("--tw-drop-shadow", "var(--tw-drop-shadow-size)")];
      }
  ...
  {
    let n = "var(--tw-contain-size,) var(--tw-contain-layout,) var(--tw-contain-paint,) var(--tw-contain-style,)", f2 = () => D([C("--tw-contain-size"), C("--tw-contain-layout"), C("--tw-contain-paint"), C("--tw-contain-style")]);
  ...
  {
    let n = "var(--tw-ordinal,) var(--tw-slashed-zero,) var(--tw-numeric-figure,) var(--tw-numeric-spacing,) var(--tw-numeric-fraction,)", f2 = () => D([C("--tw-ordinal"), C("--tw-slashed-zero"), C("--tw-numeric-figure"), C("--tw-numeric-spacing"), C("--tw-numeric-fraction")]);
  ...
  }
  {
    ...
    t.static("outline-hidden", () => [a("--tw-outline-style", "none"), a("outline-style", "none"), I("@media", "(forced-colors: active)", [a("outline", "2px solid transparent"), a("outline-offset", "2px")])]), e("outline-none", [["--tw-outline-style", "none"], ["outline-style", "none"]]), e("outline-solid", [["--tw-outline-style", "solid"], ["outline-style", "solid"]]), e("outline-dashed", [["--tw-outline-style", "dashed"], ["outline-style", "dashed"]]), e("outline-dotted", [["--tw-outline-style", "dotted"], ["outline-style", "dotted"]]), e("outline-double", [["--tw-outline-style", "double"], ["outline-style", "double"]]), t.functional("outline", (f2) => {
      if (f2.value === null) {
      ...
      if (f2.value.kind === "arbitrary") {
        ...
        switch (f2.value.dataType ?? pe$1(p2, ["color", "length", "number", "percentage"])) {
          case "length":
          case "number":
          case "percentage":
            return f2.modifier ? void 0 : [n(), a("outline-style", "var(--tw-outline-style)"), a("outline-width", p2)];
          default:
            return p2 = Z(p2, f2.modifier, r), p2 === null ? void 0 : [a("outline-color", p2)];
        }
      }
      {
        let p2 = Q(f2, r, ["--outline-color", "--color"]);
        if (p2) return [a("outline-color", p2)];
      }
      {
        if (f2.modifier) return;
        let p$1 = r.resolve(f2.value.value, ["--outline-width"]);
  ...
  o("opacity", { themeKeys: ["--opacity"], handleBareValue: ({ value: n }) => de(n) ? `${n}%` : null, handle: (n) => [a("opacity", n)] }), i("opacity", () => [{ values: Array.from({ length: 21 }, (n, f2) => `${f2 * 5}`), valueThemeKeys: ["--opacity"] }]), e("underline-offset-auto", [["text-underline-offset", "auto"]]), o("underline-offset", { supportsNegative: true, themeKeys: ["--text-underline-offset"], handleBareValue: ({ value: n }) => p(n) ? `${n}px` : null, handle: (n) => [a("text-underline-offset", n)] }), i("underline-offset", () => [{ supportsNegative: true, values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--text-underline-offset"] }]), t.functional("text", (n) => {
    if (n.value) {
      if (n.value.kind === "arbitrary") {
        let f2 = n.value.value;
        switch (n.value.dataType ?? pe$1(f2, ["color", "length", "percentage", "absolute-size", "relative-size"])) {
          case "size":
          case "length":
          case "percentage":
          case "absolute-size":
          ...
          default:
            return f2 = Z(f2, n.modifier, r), f2 === null ? void 0 : [a("color", f2)];
        }
      }
      {
        let f2 = Q(n, r, ["--text-color", "--color"]);
  ...
  let P2 = () => D([C("--tw-text-shadow-color"), C("--tw-text-shadow-alpha", "100%", "<percentage>")]);
  e("text-shadow-initial", [P2, ["--tw-text-shadow-color", "initial"]]), t.functional("text-shadow", (n) => {
    ...
    if (n.value.kind === "arbitrary") {
      ...
      switch (n.value.dataType ?? pe$1(p2, ["color"])) {
        case "color":
          return p2 = Z(p2, n.modifier, r), p2 === null ? void 0 : [P2(), a("--tw-text-shadow-color", J(p2, "var(--tw-text-shadow-alpha)"))];
        default:
    ...
    }
    {
      ...
      if (p2) return [P2(), a("--tw-text-shadow-color", J(p2, "var(--tw-text-shadow-alpha)"))];
    }
  }), i("text-shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--text-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (n, f2) => `${f2 * 5}`) }, { values: ["none"] }, { valueThemeKeys: ["--text-shadow"], modifiers: Array.from({ length: 21 }, (n, f2) => `${f2 * 5}`), hasDefaultValue: true }]);
  {
    ...
    let n = ["var(--tw-inset-shadow)", "var(--tw-inset-ring-shadow)", "var(--tw-ring-offset-shadow)", "var(--tw-ring-shadow)", "var(--tw-shadow)"].join(", "), f2 = "0 0 #0000", p$1 = () => D([C("--tw-shadow", f2), C("--tw-shadow-color"), C("--tw-shadow-alpha", "100%", "<percentage>"), C("--tw-inset-shadow", f2), C("--tw-inset-shadow-color"), C("--tw-inset-shadow-alpha", "100%", "<percentage>"), C("--tw-ring-color"), C("--tw-ring-shadow", f2), C("--tw-inset-ring-color"), C("--tw-inset-ring-shadow", f2), C("--tw-ring-inset"), C("--tw-ring-offset-width", "0px", "<length>"), C("--tw-ring-offset-color", "#fff"), C("--tw-ring-offset-shadow", f2)]);
    e("shadow-initial", [p$1, ["--tw-shadow-color", "initial"]]), t.functional("shadow", (N2) => {
      ...
      if (N2.modifier && (N2.modifier.kind === "arbitrary" ? T2 = N2.modifier.value : p(N2.modifier.value) && (T2 = `${N2.modifier.value}%`)), !N2.value) {
        let j2 = r.get(["--shadow"]);
        return j2 === null ? void 0 : [p$1(), a("--tw-shadow-alpha", T2), ...le("--tw-shadow", j2, T2, (ie2) => `var(--tw-shadow-color, ${ie2})`), a("box-shadow", n)];
      }
      if (N2.value.kind === "arbitrary") {
        let j2 = N2.value.value;
        switch (N2.value.dataType ?? pe$1(j2, ["color"])) {
          case "color":
            return j2 = Z(j2, N2.modifier, r), j2 === null ? void 0 : [p$1(), a("--tw-shadow-color", J(j2, "var(--tw-shadow-alpha)"))];
          default:
            return [p$1(), a("--tw-shadow-alpha", T2), ...le("--tw-shadow", j2, T2, (tt) => `var(--tw-shadow-color, ${tt})`), a("box-shadow", n)];
        }
      }
      switch (N2.value.value) {
        case "none":
          return N2.modifier ? void 0 : [p$1(), a("--tw-shadow", f2), a("box-shadow", n)];
        case "inherit":
          return N2.modifier ? void 0 : [p$1(), a("--tw-shadow-color", "inherit")];
      }
      {
        let j2 = r.get([`--shadow-${N2.value.value}`]);
        if (j2) return [p$1(), a("--tw-shadow-alpha", T2), ...le("--tw-shadow", j2, T2, (ie2) => `var(--tw-shadow-color, ${ie2})`), a("box-shadow", n)];
      }
      {
        let j2 = Q(N2, r, ["--box-shadow-color", "--color"]);
        if (j2) return [p$1(), a("--tw-shadow-color", J(j2, "var(--tw-shadow-alpha)"))];
      }
    }), i("shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--box-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (N2, T2) => `${T2 * 5}`) }, { values: ["none"] }, { valueThemeKeys: ["--shadow"], modifiers: Array.from({ length: 21 }, (N2, T2) => `${T2 * 5}`), hasDefaultValue: true }]), e("inset-shadow-initial", [p$1, ["--tw-inset-shadow-color", "initial"]]), t.functional("inset-shadow", (N2) => {
      let T2;
      if (N2.modifier && (N2.modifier.kind === "arbitrary" ? T2 = N2.modifier.value : p(N2.modifier.value) && (T2 = `${N2.modifier.value}%`)), !N2.value) {
        let j2 = r.get(["--inset-shadow"]);
        return j2 === null ? void 0 : [p$1(), a("--tw-inset-shadow-alpha", T2), ...le("--tw-inset-shadow", j2, T2, (ie2) => `var(--tw-inset-shadow-color, ${ie2})`), a("box-shadow", n)];
      }
      if (N2.value.kind === "arbitrary") {
        let j2 = N2.value.value;
        switch (N2.value.dataType ?? pe$1(j2, ["color"])) {
          case "color":
            return j2 = Z(j2, N2.modifier, r), j2 === null ? void 0 : [p$1(), a("--tw-inset-shadow-color", J(j2, "var(--tw-inset-shadow-alpha)"))];
          default:
            return [p$1(), a("--tw-inset-shadow-alpha", T2), ...le("--tw-inset-shadow", j2, T2, (tt) => `var(--tw-inset-shadow-color, ${tt})`, "inset "), a("box-shadow", n)];
        }
      }
      switch (N2.value.value) {
        case "none":
          return N2.modifier ? void 0 : [p$1(), a("--tw-inset-shadow", f2), a("box-shadow", n)];
        case "inherit":
          return N2.modifier ? void 0 : [p$1(), a("--tw-inset-shadow-color", "inherit")];
      }
      {
        let j2 = r.get([`--inset-shadow-${N2.value.value}`]);
        if (j2) return [p$1(), a("--tw-inset-shadow-alpha", T2), ...le("--tw-inset-shadow", j2, T2, (ie2) => `var(--tw-inset-shadow-color, ${ie2})`), a("box-shadow", n)];
      }
      {
        let j2 = Q(N2, r, ["--box-shadow-color", "--color"]);
        if (j2) return [p$1(), a("--tw-inset-shadow-color", J(j2, "var(--tw-inset-shadow-alpha)"))];
      }
    }), i("inset-shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--box-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (N2, T2) => `${T2 * 5}`) }, { values: ["none"] }, { valueThemeKeys: ["--inset-shadow"], modifiers: Array.from({ length: 21 }, (N2, T2) => `${T2 * 5}`), hasDefaultValue: true }]), e("ring-inset", [p$1, ["--tw-ring-inset", "inset"]]);
    let x = r.get(["--default-ring-color"]) ?? "currentcolor";
    t.functional("ring", (N2) => {
      if (!N2.value) {
        if (N2.modifier) return;
        let T2 = r.get(["--default-ring-width"]) ?? "1px";
        return [p$1(), a("--tw-ring-shadow", y2(T2)), a("box-shadow", n)];
      }
      if (N2.value.kind === "arbitrary") {
        let T2 = N2.value.value;
        switch (N2.value.dataType ?? pe$1(T2, ["color", "length"])) {
          case "length":
            return N2.modifier ? void 0 : [p$1(), a("--tw-ring-shadow", y2(T2)), a("box-shadow", n)];
          default:
            return T2 = Z(T2, N2.modifier, r), T2 === null ? void 0 : [a("--tw-ring-color", T2)];
        }
      }
      {
        let T2 = Q(N2, r, ["--ring-color", "--color"]);
        if (T2) return [a("--tw-ring-color", T2)];
      }
      {
        if (N2.modifier) return;
        let T2 = r.resolve(N2.value.value, ["--ring-width"]);
        if (T2 === null && p(N2.value.value) && (T2 = `${N2.value.value}px`), T2) return [p$1(), a("--tw-ring-shadow", y2(T2)), a("box-shadow", n)];
      }
      ...
      if (N2.value.kind === "arbitrary") {
        ...
        switch (N2.value.dataType ?? pe$1(T2, ["color", "length"])) {
          case "length":
            return N2.modifier ? void 0 : [p$1(), a("--tw-inset-ring-shadow", $2(T2)), a("box-shadow", n)];
          default:
            return T2 = Z(T2, N2.modifier, r), T2 === null ? void 0 : [a("--tw-inset-ring-color", T2)];
        }
      }
      {
        let T2 = Q(N2, r, ["--ring-color", "--color"]);
      ...
      }
      {
        if (N2.modifier) return;
        let T2 = r.resolve(N2.value.value, ["--ring-width"]);
        if (T2 === null && p(N2.value.value) && (T2 = `${N2.value.value}px`), T2) return [p$1(), a("--tw-inset-ring-shadow", $2(T2)), a("box-shadow", n)];
      }
      ...
      if (N2.value) {
        if (N2.value.kind === "arbitrary") {
          ...
          switch (N2.value.dataType ?? pe$1(T2, ["color", "length"])) {
            ...
            default:
              return T2 = Z(T2, N2.modifier, r), T2 === null ? void 0 : [a("--tw-ring-offset-color", T2)];
          }
        }
        {
        ...
        {
          let T2 = Q(N2, r, ["--ring-offset-color", "--color"]);
  ...
  return si.test(t) ? (i) => {
    ...
    F(r.nodes, (o) => {
      ...
      ee(s2, (l2) => {
        ...
        if (l2.value === "--spacing" && !(e["--modifier"].usedSpacingNumber && e["--value"].usedSpacingNumber)) return ee(l2.nodes, (u2) => {
          var _a2, _b;
...
`);
          let c = u2.value, m = structuredClone(l2), g2 = "\xB6";
          ee(m.nodes, (A2, { replaceWith: k2 }) => {
            A2.kind === "word" && A2.value === c && k2({ kind: "word", value: g2 });
          });
          let h2 = "^".repeat(Y([u2]).length), w2 = Y([m]).indexOf(g2), v2 = ["```css", Y([l2]), " ".repeat(w2) + h2, "```"].join(`
`);
          console.warn(v2);
        }
      }), o.value = Y(s2);
      ...
      let o = [], s2 = [];
      for (let [l2, { literals: d2, usedSpacingNumber: u2, usedSpacingInteger: c, themeKeys: m }] of [[o, e["--value"]], [s2, e["--modifier"]]]) {
        for (let g2 of d2) l2.push(g2);
        if (u2) l2.push(...Ge);
        else if (c) for (let g2 of Ge) p(g2) && l2.push(g2);
        for (let g2 of i.theme.keysInNamespaces(m)) l2.push(g2);
      }
...
function le(r, t, i, e, o = "") {
  let s2 = false, l2 = Te(t, (u2) => i == null ? e(u2) : u2.startsWith("current") ? e(J(u2, i)) : ((u2.startsWith("var(") || i.startsWith("var(")) && (s2 = true), e(Qt(u2, i))));
  function d2(u2) {
    return o ? g(u2, ",").map((c) => o + c).join(",") : u2;
  }
  return s2 ? [a(r, d2(Te(t, e))), B("@supports (color: lab(from red l a b))", [a(r, d2(l2))])] : [a(r, d2(l2))];
}
function qe(r, t, i, e, o = "") {
  let s2 = false, l2 = g(t, ",").map((d2) => Te(d2, (u2) => i == null ? e(u2) : u2.startsWith("current") ? e(J(u2, i)) : ((u2.startsWith("var(") || i.startsWith("var(")) && (s2 = true), e(Qt(u2, i))))).map((d2) => `drop-shadow(${d2})`).join(" ");
  return s2 ? [a(r, o + g(t, ",").map((d2) => `drop-shadow(${Te(d2, e)})`).join(" ")), B("@supports (color: lab(from red l a b))", [a(r, o + l2)])] : [a(r, o + l2)];
}
...
function rr(r, t, i) {
  let e = G(r);
  return ee(e, (o, { replaceWith: s2 }) => {
    if (o.kind === "function" && o.value in gt) {
      let l2 = g(Y(o.nodes).trim(), ",").map((u2) => u2.trim()), d2 = gt[o.value](i, t, ...l2);
      return s2(G(d2));
    }
  }), Y(e);
}
...
function Je(r, t) {
  ...
  for (let s2 = 0; s2 < o; s2++) {
    ...
    if (l2 >= 48 && l2 <= 57 && d2 >= 48 && d2 <= 57) {
      ...
      for (l2 = r.charCodeAt(c); l2 >= 48 && l2 <= 57; ) l2 = r.charCodeAt(++c);
...
function or(r, t) {
  var _a2;
  let { astNodes: i, nodeSorting: e } = ce(Array.from(t), r), o = new Map(t.map((l2) => [l2, null])), s2 = 0n;
  for (let l2 of i) {
...
function lr(r) {
  ...
  function i(c, m, { compounds: g2 } = {}) {
    g2 = g2 ?? we(m), t.static(c, (h2) => {
      h2.nodes = m.map((w2) => B(w2, h2.nodes));
    }, { compounds: g2 });
  }
  ...
  function e(c, m) {
    return m.map((g$1) => {
      g$1 = g$1.trim();
      let h2 = g(g$1, " ");
      return h2[0] === "not" ? h2.slice(1).join(" ") : c === "@container" ? h2[0][0] === "(" ? `not ${g$1}` : h2[1] === "not" ? `${h2[0]} ${h2.slice(2).join(" ")}` : `${h2[0]} not ${h2.slice(1).join(" ")}` : `not ${g$1}`;
    });
  }
  ...
  function s2(c) {
    for (let m of o) {
      ...
      let g$1 = g(c.params, ",");
      return g$1.length > 1 ? null : (g$1 = e(c.name, g$1), I(c.name, g$1.join(", ")));
    }
    return null;
  }
  function l2(c) {
  ...
  t.compound("not", 3, (c, m) => {
    ...
    if (F([c], (h2, { path: w2 }) => {
      ...
      return Object.assign(c, L("&", k2)), g2 = true, 1;
    ...
    let g$1 = m.modifier ? `:where(.${r.prefix ? `${r.prefix}\\:` : ""}group\\/${m.modifier.value})` : `:where(.${r.prefix ? `${r.prefix}\\:` : ""}group)`, h2 = false;
    if (F([c], (w2, { path: v2 }) => {
      if (w2.kind !== "rule") return 0;
      for (let k2 of v2.slice(0, -1)) if (k2.kind === "rule") return h2 = false, 2;
      let A2 = w2.selector.replaceAll("&", g$1);
    ...
    if (m.variant.kind === "arbitrary" && m.variant.relative) return null;
    let g$1 = m.modifier ? `:where(.${r.prefix ? `${r.prefix}\\:` : ""}peer\\/${m.modifier.value})` : `:where(.${r.prefix ? `${r.prefix}\\:` : ""}peer)`, h2 = false;
    if (F([c], (w2, { path: v2 }) => {
      if (w2.kind !== "rule") return 0;
      for (let k2 of v2.slice(0, -1)) if (k2.kind === "rule") return h2 = false, 2;
      let A2 = w2.selector.replaceAll("&", g$1);
  ...
  {
    let c = function() {
      return D([I("@property", "--tw-content", [a("syntax", '"*"'), a("initial-value", '""'), a("inherits", "false")])]);
    };
    t.static("before", (m) => {
      m.nodes = [L("&::before", [c(), a("content", "var(--tw-content)"), ...m.nodes])];
    }, { compounds: 0 }), t.static("after", (m) => {
      m.nodes = [L("&::after", [c(), a("content", "var(--tw-content)"), ...m.nodes])];
    }, { compounds: 0 });
  }
  i("first", ["&:first-child"]), i("last", ["&:last-child"]), i("only", ["&:only-child"]), i("odd", ["&:nth-child(odd)"]), i("even", ["&:nth-child(even)"]), i("first-of-type", ["&:first-of-type"]), i("last-of-type", ["&:last-of-type"]), i("only-of-type", ["&:only-of-type"]), i("visited", ["&:visited"]), i("target", ["&:target"]), i("open", ["&:is([open], :popover-open, :open)"]), i("default", ["&:default"]), i("checked", ["&:checked"]), i("indeterminate", ["&:indeterminate"]), i("placeholder-shown", ["&:placeholder-shown"]), i("autofill", ["&:autofill"]), i("optional", ["&:optional"]), i("required", ["&:required"]), i("valid", ["&:valid"]), i("invalid", ["&:invalid"]), i("user-valid", ["&:user-valid"]), i("user-invalid", ["&:user-invalid"]), i("in-range", ["&:in-range"]), i("out-of-range", ["&:out-of-range"]), i("read-only", ["&:read-only"]), i("empty", ["&:empty"]), i("focus-within", ["&:focus-within"]), t.static("hover", (c) => {
    c.nodes = [L("&:hover", [I("@media", "(hover: hover)", c.nodes)])];
    ...
    m.value.kind === "arbitrary" ? c.nodes = [L(`&[aria-${ar(m.value.value)}]`, c.nodes)] : c.nodes = [L(`&[aria-${m.value.value}="true"]`, c.nodes)];
  }), t.suggest("aria", () => ["busy", "checked", "disabled", "expanded", "hidden", "pressed", "readonly", "required", "selected"]), t.functional("data", (c, m) => {
    if (!m.value || m.modifier) return null;
    c.nodes = [L(`&[data-${ar(m.value.value)}]`, c.nodes)];
    ...
    if (/^[\w-]*\s*\(/.test(g2)) {
      ...
      c.nodes = [I("@supports", h2, c.nodes)];
      return;
    }
    g2.includes(":") || (g2 = `${g2}: var(--tw)`), (g2[0] !== "(" || g2[g2.length - 1] !== ")") && (g2 = `(${g2})`), c.nodes = [I("@supports", g2, c.nodes)];
  }, { compounds: 1 }), i("motion-safe", ["@media (prefers-reduced-motion: no-preference)"]), i("motion-reduce", ["@media (prefers-reduced-motion: reduce)"]), i("contrast-more", ["@media (prefers-contrast: more)"]), i("contrast-less", ["@media (prefers-contrast: less)"]);
  {
    ...
    {
      let m = r.namespace("--breakpoint"), g2 = new q((h2) => {
        switch (h2.kind) {
          case "static":
      ...
      t.group(() => {
        t.functional("max", (h2, w2) => {
          ...
          h2.nodes = [I("@media", `(width < ${v2})`, h2.nodes)];
        }, { compounds: 1 });
        ...
        for (let [h2, w2] of r.namespace("--breakpoint")) h2 !== null && t.static(h2, (v2) => {
          v2.nodes = [I("@media", `(width >= ${w2})`, v2.nodes)];
        }, { compounds: 1 });
    ...
    {
      let m = r.namespace("--container"), g2 = new q((h2) => {
        switch (h2.kind) {
          case "functional": {
      ...
      t.group(() => {
        t.functional("@max", (h2, w2) => {
          let v2 = g2.get(w2);
          if (v2 === null) return null;
          h2.nodes = [I("@container", w2.modifier ? `${w2.modifier.value} (width < ${v2})` : `(width < ${v2})`, h2.nodes)];
        }, { compounds: 1 });
      }, (h2, w2) => c(h2, w2, "desc", g2)), t.suggest("@max", () => Array.from(m.keys()).filter((h2) => h2 !== null)), t.group(() => {
        t.functional("@", (h2, w2) => {
          let v2 = g2.get(w2);
...
function vt(r, t) {
  F(r, (i, { replaceWith: e }) => {
    ...
    else if (i.kind === "at-rule" && (i.name === "@keyframes" || i.name === "@property")) return Object.assign(i, D([I(i.name, i.params, i.nodes)])), 1;
  });
}
function sr(r) {
  let t = Xt(r), i = lr(r), e = new q((u2) => Jt(u2, d2)), o = new q((u2) => Array.from(Gt(u2, d2))), s2 = new q((u2) => {
    ...
    for (let m of u2) {
      ...
      h2 = he(h2, d2, 0), h2.length === 0 || g2 ? c.push(null) : c.push(re(h2));
    }
    return c;
  }, getClassOrder(u2) {
    return or(this, u2);
    ...
    for (let m of u2) {
      ...
      if (g2.length !== 0) {
        ...
        for (let { node: h2, propertySort: w2 } of g2) {
          let v2 = 0n;
          for (let A2 of m.variants) v2 |= 1n << BigInt(l2.get(A2));
...
function xe(r, t, i, e = 0) {
  if (t.kind === "arbitrary") {
    ...
    r.nodes = [B(t.selector, r.nodes)];
    return;
  }
  let { applyFn: o } = i.get(t.root);
  if (t.kind === "compound") {
    let l2 = I("@slot");
    if (xe(l2, t.variant, i, e + 1) === null || t.root === "not" && l2.nodes.length > 1) return null;
...
function Re(r, t) {
  let i = 0, e = B("&", r), o = /* @__PURE__ */ new Set(), s2 = new q(() => /* @__PURE__ */ new Set()), l2 = new q(() => /* @__PURE__ */ new Set());
  F([e], (g2, { parent: h2 }) => {
    if (g2.kind === "at-rule") {
      if (g2.name === "@keyframes") return F(g2.nodes, (w2) => {
        if (w2.kind === "at-rule" && w2.name === "@apply") throw new Error("You cannot use `@apply` inside `@keyframes`.");
      }), 1;
      if (g2.name === "@utility") {
        let w2 = g2.params.replace(/-\*$/, "");
        l2.get(w2).add(g2), F(g2.nodes, (v2) => {
  ...
  function m(g2, h2 = []) {
    if (!d2.has(g2)) {
      if (c.has(g2)) {
        ...
        throw g2.kind === "at-rule" && g2.name === "@utility" && w2.kind === "at-rule" && w2.name === "@utility" && F(g2.nodes, (v2) => {
...
${re([w2])}`);
      ...
      c.add(g2);
      for (let w2 of s2.get(g2)) for (let v2 of l2.get(w2)) h2.push(g2), m(v2, h2), h2.pop();
  ...
  return F(r, (l2, { replaceWith: d2 }) => {
    if (l2.kind === "at-rule" && (l2.name === "@import" || l2.name === "@reference")) {
      ...
      return s2.push((async () => {
        ...
        await yt(A2, v2.base, i, e + 1), w2.nodes = ki([ne({ base: v2.base }, A2)], m, g2, h2);
      })()), d2(w2), 1;
    }
...
function ki(r, t, i, e) {
  let o = r;
  return t !== null && (o = [I("@layer", t, o)]), i !== null && (o = [I("@media", i, o)]), e !== null && (o = [I("@supports", e[0] === "(" ? e : `(${e})`, o)]), o;
}
...
function Ke(r, t, i, e = []) {
  for (let o of t) if (o != null) for (let s2 of Reflect.ownKeys(o)) {
    ...
    l2 !== void 0 ? r[s2] = l2 : !Ce(r[s2]) || !Ce(o[s2]) ? r[s2] = o[s2] : r[s2] = Ke({}, [r[s2], o[s2]], i, e), e.pop();
  }
  return r;
}
function Qe(r, t, i) {
  return function(o, s2) {
    ...
    let u2 = (() => {
      ...
      if (h2 !== null && typeof h2 == "object" && !Array.isArray(h2)) {
        ...
        for (let v2 in m) v2 !== "__CSS_VALUES__" && (((_a2 = h2 == null ? void 0 : h2.__CSS_VALUES__) == null ? void 0 : _a2[v2]) & 4 && gr(w2, v2.split("-")) !== void 0 || (w2[ge(v2)] = m[v2]));
        return w2;
      }
    ...
    return d2 && typeof u2 == "string" && (u2 = J(u2, d2)), u2 ?? s2;
  };
}
function $i(r, t) {
  ...
  for (let [m, g2] of s2) {
    if (!m || !m.includes("--")) {
      e.set(m, g2), l2.set(m, r.getOptions(m ? `--${i}-${m}` : `--${i}`));
      continue;
    }
  ...
  for (let [m, g2] of o) {
    ...
    e.set(m, [h2, w2]), l2.set(m, [d2, v2]);
  }
  let u2 = {}, c = {};
  for (let [m, g2] of e) hr(u2, [m ?? "DEFAULT"], g2);
  for (let [m, g2] of l2) hr(c, [m ?? "DEFAULT"], g2);
    ...
    switch (d2) {
      ...
      case Ar: {
        ...
        if (o = "", u2.value !== ":not" && u2.value !== ":where" && u2.value !== ":has" && u2.value !== ":is") {
          ...
          let g2 = l2;
          u2.nodes.push(Si(r.slice(c, g2))), o = "", l2 = g2, e ? e.nodes.push(u2) : t.push(u2);
          break;
        }
      ...
      case Ki: {
        let u2 = l2;
        for (let c = l2 + 1; c < r.length; c++) if (s2 = r.charCodeAt(c), s2 === vr) c += 1;
        else if (s2 === d2) {
          l2 = c;
          break;
        }
...
function kt({ designSystem: r, ast: t, resolvedConfig: i, featuresRef: e, referenceMode: o }) {
  let s2 = { addBase(l2) {
    if (o) return;
    let d2 = oe(l2);
    e.current |= be(d2, r), t.push(I("@layer", "base", d2));
  }, addVariant(l2, d2) {
    if (!He.test(l2)) throw new Error(`\`addVariant('${l2}')\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);
    typeof d2 == "string" || Array.isArray(d2) ? r.variants.static(l2, (u2) => {
      u2.nodes = Sr(d2, u2.nodes);
    }, { compounds: we(typeof d2 == "string" ? [d2] : d2) }) : typeof d2 == "object" && r.variants.fromAst(l2, oe(d2));
    ...
    r.variants.group(() => {
      r.variants.functional(l2, (g2, h2) => {
        if (!h2.value) {
    ...
    let d2 = l2.flatMap((c) => Object.entries(c));
    ...
    for (let [c, m] of d2) {
      ...
      if (Oe(g2, (w2) => {
        if (w2.kind === "selector" && w2.value[0] === "." && Tr.test(w2.value.slice(1))) {
          let v2 = w2.value;
          w2.value = "&";
          let A2 = je(g2), k2 = v2.slice(1), b2 = A2 === "&" ? oe(m) : [B(A2, oe(m))];
    ...
    for (let [c, m] of u2) r.theme.prefix && F(m, (g2) => {
      if (g2.kind === "rule") {
    ...
    for (let [m, g2] of Object.entries(l2)) {
      let h2 = function({ negative: w2 }) {
        return (v2) => {
          ...
          A2 && V2 !== null && (k2 = J(k2, V2)), w2 && (k2 = `calc(${k2} * -1)`);
  ...
  }, theme: Qe(r, () => i.theme ?? {}, (l2) => l2), prefix(l2) {
    return l2;
  }, config(l2, d2) {
    let u2 = i;
    if (!l2) return u2;
...
function oe(r) {
  ...
  for (let [e, o] of i) if (typeof o != "object") {
    ...
    t.push(a(e, String(o)));
  } else if (Array.isArray(o)) for (let s2 of o) typeof s2 == "string" ? t.push(a(e, s2)) : t.push(B(e, oe(s2)));
...
function Fi(r) {
  var _a2;
  let t = /* @__PURE__ */ new Set(), i = Qe(r.design, () => r.theme, o), e = Object.assign(i, { theme: i, colors: l$1 });
  function o(s2) {
...
function _r(r, t) {
  ...
  for (let [l2, d2] of Object.entries(i)) {
    let h2 = function(w2) {
      t.variants.static(l2, (v2) => {
        v2.nodes = [I("@media", g2, v2.nodes)];
      }, { order: w2 });
    };
    let u2 = t.variants.get(l2), c = t.theme.resolveValue(l2, ["--breakpoint"]);
    if (u2 && c && !t.theme.hasDefault(`--breakpoint-${l2}`)) continue;
    let m = true;
...
function Dr(r, t) {
  ...
  if (Object.keys(i).length > 0) {
    ...
    t.variants.functional("aria", (u2, c) => {
      let m = c.value;
      return m && m.kind === "named" && m.value in i ? l2 == null ? void 0 : l2(u2, { ...c, value: { kind: "arbitrary", value: i[m.value] } }) : l2 == null ? void 0 : l2(u2, c);
    }, { compounds: d2 });
  }
  if (Object.keys(e).length > 0) {
    ...
    t.variants.functional("supports", (u2, c) => {
      let m = c.value;
      return m && m.kind === "named" && m.value in e ? l2 == null ? void 0 : l2(u2, { ...c, value: { kind: "arbitrary", value: e[m.value] } }) : l2 == null ? void 0 : l2(u2, c);
    }, { compounds: d2 });
  }
  if (Object.keys(o).length > 0) {
    ...
    t.variants.functional("data", (u2, c) => {
      let m = c.value;
      return m && m.kind === "named" && m.value in o ? l2 == null ? void 0 : l2(u2, { ...c, value: { kind: "arbitrary", value: o[m.value] } }) : l2 == null ? void 0 : l2(u2, c);
    }, { compounds: d2 });
  }
}
var Mi = /^[a-z]+$/;
...
\`@plugin\` options must be a flat list of declarations.`);
          ...
          let V2 = b2.value, S = g(V2, ",").map((K2) => {
            ...
            if (Number.isNaN(Number(K2))) {
              ...
              if (K2[0] === "{" && K2[K2.length - 1] === "}") throw new Error(`Unexpected \`@plugin\` option: Value of declaration \`${re([b2]).trim()}\` is not supported.
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`);
        ...
        l2.push([{ id: A2, base: v2.base, reference: !!v2.reference }, Object.keys(k2).length > 0 ? k2 : null]), w2([]), s2 |= 4;
        return;
      }
      if (g$1.name === "@config") {
        if (g$1.nodes.length > 0) throw new Error("`@config` cannot have a body.");
        if (h2 !== null) throw new Error("`@config` cannot be nested.");
        d2.push({ id: g$1.params.slice(1, -1), base: v2.base, reference: !!v2.reference }), w2([]), s2 |= 4;
        return;
      }
    }
  }), jr(r);
  ...
  })), Promise.all(l2.map(async ([{ id: g2, base: h2, reference: w2 }, v2]) => {
...
function Ur({ designSystem: r, base: t, ast: i, sources: e, configs: o, pluginDetails: s2 }) {
  ...
  if (pr(r, m, g2), Rr(r, m), Dr(m, r), _r(m, r), Pr(m, r), !r.theme.prefix && c.prefix) {
  ...
  if (!r.important && c.important === true && (r.important = true), typeof c.important == "string") {
    let k2 = c.important;
    F(i, (b2, { replaceWith: V2, parent: S }) => {
      if (b2.kind === "at-rule" && !(b2.name !== "@tailwind" || b2.params !== "utilities")) return (S == null ? void 0 : S.kind) === "rule" && S.selector === k2 ? 2 : (V2(L(k2, [b2])), 2);
    });
  }
...
function et(r) {
  ...
  let d2 = o.slice(1, l2), u2 = o.slice(l2 + 1), c;
...
function Bi(r) {
  ...
  if (/^-?\d+$/.test(i) && /^-?\d+$/.test(e)) {
    ...
    for (let m = d2; c ? m <= u2 : m >= u2; m += s2) l2.push(m.toString());
  }
  return l2;
}
...
async function zr(r, { base: t = "", loadModule: i = Gi, loadStylesheet: e = Ji } = {}) {
  let o = 0;
  r = [ne({ base: t }, r)], o |= await yt(r, t, e);
  let s2 = null, l2 = new Le(), d2 = [], u2 = [], c = null, m = null, g$1 = [], h2 = [], w2 = [], v2 = [], A2 = null;
  F(r, (b2, { parent: V2, replaceWith: S, context: K2 }) => {
    if (b2.kind === "at-rule") {
      ...
      if (b2.name === "@variant" && (V2 === null ? b2.nodes.length === 0 ? b2.name = "@custom-variant" : (F(b2.nodes, (O2) => {
        if (O2.kind === "at-rule" && O2.name === "@slot") return b2.name = "@custom-variant", 2;
      }), b2.name === "@variant" && g$1.push(b2)) : g$1.push(b2)), b2.name === "@custom-variant") {
        ...
        if (b2.nodes.length === 0) {
          ...
          d2.push((z2) => {
            z2.variants.static(O2, (te2) => {
              let X2 = [];
              M2.length > 0 && X2.push(L(M2.join(", "), te2.nodes));
              for (let ae of H2) X2.push(B(ae, te2.nodes));
              te2.nodes = X2;
            }, { compounds: we([...M2, ...H2]) });
          });
          return;
      ...
      if (b2.name === "@media") {
        ...
        for (let P2 of O2) if (P2.startsWith("source(")) {
          let H2 = P2.slice(7, -1);
          F(b2.nodes, (M2, { replaceWith: z2 }) => {
            if (M2.kind === "at-rule" && M2.name === "@tailwind" && M2.params === "utilities") return M2.params += ` source(${H2})`, z2([ne({ sourceBase: K2.base }, [M2])]), 2;
          });
        ...
        } else P2 === "important" ? s2 = true : P2 === "reference" ? b2.nodes = [ne({ reference: true }, b2.nodes)] : U2.push(P2);
      ...
      if (b2.name === "@theme") {
        ...
        return F(b2.nodes, (P2) => {
          if (P2.kind === "at-rule" && P2.name === "@keyframes") return l2.addKeyframes(P2), 1;
          if (P2.kind === "comment") return;
          if (P2.kind === "declaration" && P2.property.startsWith("--")) {
            l2.add(ge(P2.property), P2.value ?? "", O2);
            return;
          }
          let H2 = re([I(b2.name, b2.params, [P2])]).split(`
`).map((M2, z2, te2) => `${z2 === 0 || z2 >= te2.length - 2 ? " " : ">"} ${M2}`).join(`
`);
          throw new Error(`\`@theme\` blocks must only contain custom properties or \`@keyframes\`.

${H2}`);
        }), c ? S([]) : (c = L(":root, :host", []), S([c])), 1;
      }
    }
  });
  let k2 = sr(l2);
  ...
  if (c) {
    ...
    for (let S of V2) r.push(ne({ theme: true }, [D([S])]));
    c.nodes = [ne({ theme: true }, b2)];
  }
  if (m) {
    let b2 = m;
  ...
  if (g$1.length > 0) {
    for (let b2 of g$1) {
      let V2 = L("&", b2.nodes), S = b2.params, K2 = k2.parseVariant(S);
  ...
  return o |= be(r, k2), o |= Re(r, k2), F(r, (b2, { replaceWith: V2 }) => {
...
async function Yi(r, t = {}) {
  ...
  return { sources: o, root: s2, features: d2, build(v2) {
    if (d2 === 0) return r;
    if (!l2) return g2 ?? (g2 = he(e, i, t.polyfills)), g2;
    let A2 = w2, k2 = false;
    w2 = false;
    let b2 = m.size;
    ...
    return !k2 && h2 === V2.length ? (g2 ?? (g2 = he(e, i, t.polyfills)), g2) : (h2 = V2.length, l2.nodes = V2, g2 = he(e, i, t.polyfills), g2);
  } };
}

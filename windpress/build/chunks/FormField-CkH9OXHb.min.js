import { X as useForwardExpose, P as Primitive, t as tv, s as useAppConfig, aj as formFieldInjectionKey, ak as inputIdInjectionKey, __tla as __tla_0 } from "../assets/dashboard-BV7BosO9.js";
import { d as defineComponent, D as createBlock, E as openBlock, G as withCtx, H as renderSlot, A as mergeProps, u as unref, a4 as useSlots, f as computed, a as inject, r as ref, M as useId, p as provide, a5 as createBaseVNode, a3 as normalizeClass, U as createElementBlock, O as createCommentVNode, N as createVNode, a0 as createTextVNode, a1 as toDisplayString } from "./runtime-core.esm-bundler-Lvl5fE5g.min.js";
  ...
  _sfc_main = {
    ...
    setup(__props) {
      ...
      const ui = computed(() => {
        ...
        return tv({
          extend: tv(theme),
          ...((_a = appConfig.ui) == null ? void 0 : _a.formField) || {}
        })({
          size: props.size,
            ...
            return [
              createBaseVNode("div", {
                class: normalizeClass(ui.value.wrapper({
                  class: (_a2 = props.ui) == null ? void 0 : _a2.wrapper
                }))
              }, [
              ...
              createBaseVNode("div", {
                class: normalizeClass([
                  (__props.label || !!slots.label || __props.description || !!slots.description) && ui.value.container({
                ...
                ], 10, _hoisted_3)) : __props.help || !!slots.help ? (openBlock(), createElementBlock("p", {
                  key: 1,

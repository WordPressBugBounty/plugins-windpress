...
import { B as useVModel, m as useForwardExpose, C as useFormControl, D as createContext, E as _sfc_main$5, P as Primitive, r as useForwardProps, F as useFormField, t as tv, h as useAppConfig, k as _sfc_main$6, G as formBusInjectionKey, H as formLoadingInjectionKey, I as formOptionsInjectionKey, J as formInputsInjectionKey, p as tv$1, K as getSlotChildrenText, j as _sfc_main$8 } from "../assets/dashboard-DFjbSBbe.js";
import { w as withKeys, d as withModifiers } from "./runtime-dom.esm-bundler-CDtJyD_r.min.js";
import { m as defineComponent, af as toRefs, ac as computed, X as createBlock, a1 as openBlock, Y as withCtx, am as renderSlot, $ as createCommentVNode, u as unref, an as mergeProps, aA as mergeModels, ao as useSlots, aB as useModel, ap as useId, Z as createBaseVNode, _ as createElementBlock, aj as normalizeClass, j as createVNode, F as Fragment, a3 as createTextVNode, a2 as toDisplayString, ab as inject, V as ref, r as onMounted, s as onUnmounted, n as nextTick, aq as provide, a7 as readonly, aC as resolveDynamicComponent, w as watch, au as normalizeStyle } from "./runtime-core.esm-bundler-hRyeZ98I.min.js";
import { a as _sfc_main$7 } from "./FormField-CM8zfsCf.min.js";
import { r as reactivePick, a as useEventBus, p as pausableFilter, b as useMouseInElement } from "./index-SE8wVPz0.min.js";
...
const _sfc_main$2 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => {
      var _a;
      return tv({ extend: tv(theme$2), ...((_a = appConfig.ui) == null ? void 0 : _a.switch) || {} })({
        size: size.value,
        color: color.value,
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(unref(Primitive), {
        ...
        default: withCtx(() => {
          ...
          return [
            createBaseVNode("div", {
              class: normalizeClass(ui.value.container({ class: (_a2 = props.ui) == null ? void 0 : _a2.container }))
            }, [
              createVNode(unref(_sfc_main$4), mergeProps({ id: unref(id) }, { ...unref(rootProps), ..._ctx.$attrs, ...unref(ariaAttrs) }, {
                ...
                default: withCtx(() => {
                  ...
                  return [
                    createVNode(unref(_sfc_main$3), {
                      class: normalizeClass(ui.value.thumb({ class: (_a3 = props.ui) == null ? void 0 : _a3.thumb }))
                    }, {
                      default: withCtx(() => {
                        var _a4, _b2, _c2;
                        return [
                          __props.loading ? (openBlock(), createBlock(_sfc_main$6, {
                            key: 0,
                            name: __props.loadingIcon || unref(appConfig).ui.icons.loading,
                            class: normalizeClass(ui.value.icon({ class: (_a4 = props.ui) == null ? void 0 : _a4.icon, checked: true, unchecked: true }))
                          }, null, 8, ["name", "class"])) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                            __props.checkedIcon ? (openBlock(), createBlock(_sfc_main$6, {
                              key: 0,
                              name: __props.checkedIcon,
                              class: normalizeClass(ui.value.icon({ class: (_b2 = props.ui) == null ? void 0 : _b2.icon, checked: true }))
                            }, null, 8, ["name", "class"])) : createCommentVNode("", true),
                            __props.uncheckedIcon ? (openBlock(), createBlock(_sfc_main$6, {
                              key: 1,
                              name: __props.uncheckedIcon,
                              class: normalizeClass(ui.value.icon({ class: (_c2 = props.ui) == null ? void 0 : _c2.icon, unchecked: true }))
                            }, null, 8, ["name", "class"])) : createCommentVNode("", true)
                          ], 64))
                        ];
                      }),
            ...
            __props.label || !!slots.label || (__props.description || !!slots.description) ? (openBlock(), createElementBlock("div", {
              key: 0,
              class: normalizeClass(ui.value.wrapper({ class: (_c = props.ui) == null ? void 0 : _c.wrapper }))
            }, [
              __props.label || !!slots.label ? (openBlock(), createBlock(unref(_sfc_main$7), {
                key: 0,
                for: unref(id),
                class: normalizeClass(ui.value.label({ class: (_d = props.ui) == null ? void 0 : _d.label }))
              }, {
                default: withCtx(() => [
...
const _sfc_main$1 = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const ui = computed(() => {
      var _a;
      return tv({ extend: tv(theme$1), ...((_a = appConfig.ui) == null ? void 0 : _a.form) || {} });
    });
    ...
    onMounted(async () => {
      bus.on(async (event) => {
        ...
        } else if (((_a = props.validateOn) == null ? void 0 : _a.includes(event.type)) && !loading.value) {
          if (event.type !== "input") {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(unref(parentBus) ? "div" : "form"), {
        ...
        onSubmit: withModifiers(onSubmitWrapper, ["prevent"])
      }, {
        default: withCtx(() => [
...
const _sfc_main = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      var _a;
      return tv$1({ extend: tv$1(theme), ...((_a = appConfig.uiPro) == null ? void 0 : _a.pageCard) || {} })({
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(unref(Primitive), {
        ...
        class: normalizeClass(ui.value.root({ class: [(_a = props.ui) == null ? void 0 : _a.root, props.class] })),
        style: normalizeStyle(spotlight.value && { "--spotlight-x": `${unref(elementX)}px`, "--spotlight-y": `${unref(elementY)}px` }),
        ...
        default: withCtx(() => {
          ...
          return [
            props.spotlight ? (openBlock(), createElementBlock("div", {
              key: 0,
              class: normalizeClass(ui.value.spotlight({ class: (_a2 = props.ui) == null ? void 0 : _a2.spotlight }))
            }, null, 2)) : createCommentVNode("", true),
            createBaseVNode("div", {
              class: normalizeClass(ui.value.container({ class: (_b = props.ui) == null ? void 0 : _b.container }))
            }, [
              !!slots.header || !!slots.body || (__props.icon || !!slots.leading) || (__props.title || !!slots.title) || (__props.description || !!slots.description) || !!slots.footer ? (openBlock(), createElementBlock("div", {
                key: 0,
                class: normalizeClass(ui.value.wrapper({ class: (_c = props.ui) == null ? void 0 : _c.wrapper }))
              }, [
                !!slots.header ? (openBlock(), createElementBlock("div", {
                  key: 0,
                  class: normalizeClass(ui.value.header({ class: (_d = props.ui) == null ? void 0 : _d.header }))
                }, [
                  renderSlot(_ctx.$slots, "header")
                ], 2)) : createCommentVNode("", true),
                __props.icon || !!slots.leading ? (openBlock(), createElementBlock("div", {
                  key: 1,
                  class: normalizeClass(ui.value.leading({ class: (_e = props.ui) == null ? void 0 : _e.leading }))
                }, [
                  renderSlot(_ctx.$slots, "leading", {}, () => {
                    ...
                    return [
                      __props.icon ? (openBlock(), createBlock(_component_UIcon, {
                        key: 0,
                        name: __props.icon,
                        class: normalizeClass(ui.value.leadingIcon({ class: (_a3 = props.ui) == null ? void 0 : _a3.leadingIcon }))
                      }, null, 8, ["name", "class"])) : createCommentVNode("", true)
                    ];
                  })
                ], 2)) : createCommentVNode("", true),
                !!slots.body || (__props.title || !!slots.title) || (__props.description || !!slots.description) ? (openBlock(), createElementBlock("div", {
                  key: 2,
                  class: normalizeClass(ui.value.body({ class: (_f = props.ui) == null ? void 0 : _f.body }))
                }, [
                  renderSlot(_ctx.$slots, "body", {}, () => {
                    var _a3, _b2;
                    return [
                      __props.title || !!slots.title ? (openBlock(), createElementBlock("div", {
                        key: 0,
                      ...
                      __props.description || !!slots.description ? (openBlock(), createElementBlock("div", {
                        key: 1,
                        class: normalizeClass(ui.value.description({ class: (_b2 = props.ui) == null ? void 0 : _b2.description }))
                      }, [
                ...
                !!slots.footer ? (openBlock(), createElementBlock("div", {
                  key: 3,
                  class: normalizeClass(ui.value.footer({ class: (_g = props.ui) == null ? void 0 : _g.footer }))
                }, [

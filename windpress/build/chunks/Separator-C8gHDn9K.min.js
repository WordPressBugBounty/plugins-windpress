import { P as Primitive, a4 as useForwardProps, t as tv, s as useAppConfig, v as _sfc_main$3, C as _sfc_main$4, __tla as __tla_0 } from "../assets/dashboard-BUV-duCh.js";
import { d as defineComponent, f as computed, D as createBlock, E as openBlock, G as withCtx, H as renderSlot, A as mergeProps, u as unref, _ as normalizeProps, $ as guardReactiveProps, a4 as useSlots, a7 as createBaseVNode, U as createElementBlock, O as createCommentVNode, a6 as normalizeClass, F as Fragment, a3 as toDisplayString } from "./runtime-core.esm-bundler-B3Nza2bI.min.js";
import { r as reactivePick } from "./index-BhzJUfF8.min.js";
let _sfc_main;
  ...
  _sfc_main = {
    ...
    setup(__props) {
      ...
      const ui = computed(() => {
        ...
        return tv({
          extend: tv(theme),
          ...((_a = appConfig.ui) == null ? void 0 : _a.separator) || {}
        })({
          color: props.color,
            ...
            return [
              createBaseVNode("div", {
                class: normalizeClass(ui.value.border({
                  class: (_a2 = props.ui) == null ? void 0 : _a2.border
                }))
              }, null, 2),
              __props.label || __props.icon || __props.avatar || !!slots.default ? (openBlock(), createElementBlock(Fragment, {
                key: 0
              }, [
                createBaseVNode("div", {
                  ...
                  renderSlot(_ctx.$slots, "default", {}, () => {
                    ...
                    return [
                      __props.label ? (openBlock(), createElementBlock("span", {
                        ...
                        "name",
                        "class"
                      ])) : __props.avatar ? (openBlock(), createBlock(_sfc_main$4, mergeProps({
                        key: 2,
